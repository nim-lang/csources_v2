...
{nimErr_ = nimErrorFlag();
	...
	LA17_: ;
	{
		...
		s = (FILE*)0;
		{
			...
			NI32 T28_;
			T25_ = (NIM_BOOL)0;
			T25_ = open__stdZsyncio_405(&s, source, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)0), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!!(T25_)) goto LA26_;
			T28_ = (NI32)0;
			T28_ = osLastError__stdZoserrors_73();
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			raiseOSError__stdZoserrors_70(T28_, source);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA26_: ;
		{
			...
			NI32 T34_;
			T31_ = (NIM_BOOL)0;
			T31_ = open__stdZsyncio_405(&d, dest, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)1), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!!(T31_)) goto LA32_;
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			raiseOSError__stdZoserrors_70(T34_, dest);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA32_: ;
			...
			while (1) {
				...
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				{
					...
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					{
						...
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						raiseOSError__stdZoserrors_70(T45_, dest);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					}
					LA43_: ;
				}
...
{nimErr_ = nimErrorFlag();
	...
	nimZeroMem((void*)(&a), sizeof(struct stat));
	{
		...
		T6_ = osLastError__stdZoserrors_73();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__stdZoserrors_70(T6_, filename);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA4_: ;
	result = 0;
