...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getApplHaiku__pureZos_190)(void);
...
static const NimStringV2 TM__yu6cxgKBBXbNsTkT9cyMd4g_19 = {4, (NimStrPayload*)&TM__yu6cxgKBBXbNsTkT9cyMd4g_16};
...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmpD__2 = substr__system_7560(path__BQBSuWQbOavg6W9czhl9bOhg, ((NI)2));
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		if (!T3_) goto LA5_;
		{
			...
			colontmp_ = getEnv__stdZenvvars_15(TM__yu6cxgKBBXbNsTkT9cyMd4g_17, TM__yu6cxgKBBXbNsTkT9cyMd4g_18);
			...
			splitsX60gensym36_ = ((NI)-1);
			{
				while (1) {
					...
					T20_ = substr__system_7548(colontmp_, firstX60gensym36_, (NI)(lastX60gensym36_ - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = getApplHaiku__pureZos_190();
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NimStringV2 T5_;
...
{nimErr_ = nimErrorFlag();
	...
	r = realpath(nimToCStringConv(filename__Osbcdz66AFDbHHT2HMk8MA), ((NCSTRING) NIM_NIL));
	{
		...
		if (!(r == 0)) goto LA3_;
		T5_ = (NI32)0;
		T5_ = osLastError__stdZoserrors_73();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__stdZoserrors_70(T5_, filename__Osbcdz66AFDbHHT2HMk8MA);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA1_;
	LA3_: ;
...
{nimErr_ = nimErrorFlag();
	...
	LA9_: ;
	path = getEnv__stdZenvvars_15(TM__yu6cxgKBBXbNsTkT9cyMd4g_19, TM__yu6cxgKBBXbNsTkT9cyMd4g_20);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		splitsX60gensym33_ = ((NI)-1);
		{
			while (1) {
				...
				T32_ = substr__system_7548(path, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI)1)));
										...
										while (1) {
											if (!followSymlinks__z0XlSXjpyTnE6lLYn1L17w) goto LA49											;
											{
												...
												len = readlink(nimToCStringConv(x_2), nimToCStringConv(r), ((NI)1024));
												{
													...
													raiseOSError__stdZoserrors_70(T60_, exe__dRWYTzcPyzItzdjJNsNwcQ);
													if (NIM_UNLIKELY(*nimErr_)) goto LA55_;
												}
												LA58_: ;
												{
...
{nimErr_ = nimErrorFlag();
	...
	nimZeroMem((void*)(&res), sizeof(struct stat));
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__stdZoserrors_70(T6_, file__b9cmnPwFs9b9cRCDVCbwqVFwA);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA4_: ;
