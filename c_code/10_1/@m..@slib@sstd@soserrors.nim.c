...
struct tySequence__uB9b75OUPRENsBAu4AnoePA_Content { NI cap; tyObject_StackTraceEntry__oLyohQ7O2XOvGnflOss8EA data[SEQ_DECL_SIZE];};
      ...
      N_LIB_PRIVATE N_NOINLINE(tyObject_OSError__PeQ9bR8XhClb9cp9cbW28aSyw*, newOSError__stdZoserrors_25)(NI32 errorCode, NimStringV2 additionalInfo);
...
{nimErr_ = nimErrorFlag();
	T1_ = NIM_NIL;
	T1_ = newOSError__stdZoserrors_25(errorCode, additionalInfo);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
