...
struct tySequence__uB9b75OUPRENsBAu4AnoePA_Content { NI cap; tyObject_StackTraceEntry__oLyohQ7O2XOvGnflOss8EA data[SEQ_DECL_SIZE];};
      ...
      N_LIB_PRIVATE N_NOINLINE(tyObject_OSError__PeQ9bR8XhClb9cp9cbW28aSyw*, newOSError__stdZoserrors_25)(NI32 errorCode__9aaFKZkWssWpF31NNXM9cITA, NimStringV2 additionalInfo__shwpArztq7IguYN5t5Yv3A);
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___stdZassertions_19((&(*e).Sup.Sup.message), T2_);
	{
		if (!(((NI)0) < additionalInfo__shwpArztq7IguYN5t5Yv3A.len)) goto LA5_;
		{
			...
			if (!(T9_)) goto LA10_;
			T11_ = (NIM_CHAR*)0;
			T11_ = X5BX5D___system_7076((&(*e).Sup.Sup.message), ((NI)1));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			T9_ = !(((NU8)((*T11_)) == (NU8)(10)));
			LA10_: ;
			if (!T9_) goto LA12_;
...
{nimErr_ = nimErrorFlag();
	T1_ = NIM_NIL;
	T1_ = newOSError__stdZoserrors_25(errorCode__pW4c9aJEinlYI1jZIvhGnmw, additionalInfo__B0aylqmo75KM1PZjhD2Ciw);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
