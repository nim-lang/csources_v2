...
N_LIB_PRIVATE N_NIMCALL(void, nossetFilePermissions)(NimStringV2 filename__AbxScOR5bFOJC9aDcW4AtpQ, tySet_tyEnum_FilePermission__9a5SPDJ9aL9aLJgb0TzciuflA permissions__xkP9bVS9abLKHyQ9aqcjEfk4g, NIM_BOOL followSymlinks__tjOT7doDcb9bHSErWpsCiqg);
...
N_LIB_PRIVATE N_NIMCALL(tySet_tyEnum_FilePermission__9a5SPDJ9aL9aLJgb0TzciuflA, nosgetFilePermissions)(NimStringV2 filename__dWTHPlpwFwY9csM33S0AvUg);
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__stdZoserrors_70(T6_, file__J7TxM2NvlX9btMhQD9bZz39bA);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA4_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		if (!(T7_)) goto LA8_;
		T9_ = (NIM_BOOL)0;
		T9_ = ((options__luhms5PVEQqqSFobm4FG3Q &((NU8)1<<((NU)((((tyEnum_CopyFlag__mhWURcDRsh0F1DeHBSFUVg)2)))&7U)))!=0);
		if (T9_) goto LA10_;
		T9_ = NIM_FALSE;
		LA10_: ;
		T7_ = T9_;
	...
	LA11_: ;
	{
		...
		T15_ = isSymlink;
		if (!(T15_)) goto LA16_;
		T15_ = ((options__luhms5PVEQqqSFobm4FG3Q &((NU8)1<<((NU)((((tyEnum_CopyFlag__mhWURcDRsh0F1DeHBSFUVg)0)))&7U)))!=0);
		LA16_: ;
		if (!T15_) goto LA17_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		colontmpD_ = expandSymlink__stdZprivateZossymlinks_19(source__eoCVFNpLZVLXwyKu7SJhzg);
		if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
		createSymlink__stdZprivateZossymlinks_13(colontmpD_, dest__C3yHuHrfbm8qUZjgenJyMA);
		if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
		{
			LA19_:;
		}
	...
	LA17_: ;
	{
		...
		s = (FILE*)0;
		{
			...
			NI32 T28_;
			T25_ = (NIM_BOOL)0;
			T25_ = open__stdZsyncio_405(&s, source__eoCVFNpLZVLXwyKu7SJhzg, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)0), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!!(T25_)) goto LA26_;
			T28_ = (NI32)0;
			T28_ = osLastError__stdZoserrors_73();
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			raiseOSError__stdZoserrors_70(T28_, source__eoCVFNpLZVLXwyKu7SJhzg);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA26_: ;
		{
			...
			NI32 T34_;
			T31_ = (NIM_BOOL)0;
			T31_ = open__stdZsyncio_405(&d, dest__C3yHuHrfbm8qUZjgenJyMA, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)1), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!!(T31_)) goto LA32_;
			close__stdZsyncio_243(s);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			T34_ = (NI32)0;
			T34_ = osLastError__stdZoserrors_73();
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			raiseOSError__stdZoserrors_70(T34_, dest__C3yHuHrfbm8qUZjgenJyMA);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA32_: ;
			...
			while (1) {
				...
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				{
					...
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					{
						...
						close__stdZsyncio_243(s);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						close__stdZsyncio_243(d);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						T45_ = (NI32)0;
						T45_ = osLastError__stdZoserrors_73();
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						raiseOSError__stdZoserrors_70(T45_, dest__C3yHuHrfbm8qUZjgenJyMA);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					}
					LA43_: ;
				}
...
{nimErr_ = nimErrorFlag();
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = tryMoveFSObject__stdZprivateZoscommon_71(source__PbhPTnLQrpW54wQ6Wx9cCwQ, dest__OatSPDCla4s5V9cfRdFrXig, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T3_)) goto LA4_;
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, dollar___stdZprivateZosfiles_30)(tyEnum_FilePermission__9a5SPDJ9aL9aLJgb0TzciuflA e__4VA7ovLqR3XU7ygSxLfX9aA) {
	NimStringV2 result;
	result.len = 0; result.p = NIM_NIL;
	switch (e__4VA7ovLqR3XU7ygSxLfX9aA) {
...
{nimErr_ = nimErrorFlag();
	p = ((mode_t)0);
	{
		if (!((permissions__xkP9bVS9abLKHyQ9aqcjEfk4g &((NU16)1<<((NU)((((tyEnum_FilePermission__9a5SPDJ9aL9aLJgb0TzciuflA)2)))&15U)))!=0)) goto LA3_;
		p = (NU32)(p | ((mode_t) (S_IRUSR)));
	}
	LA3_: ;
	{
		if (!((permissions__xkP9bVS9abLKHyQ9aqcjEfk4g &((NU16)1<<((NU)((((tyEnum_FilePermission__9a5SPDJ9aL9aLJgb0TzciuflA)1)))&15U)))!=0)) goto LA7_;
		p = (NU32)(p | ((mode_t) (S_IWUSR)));
	}
	LA7_: ;
	{
		if (!((permissions__xkP9bVS9abLKHyQ9aqcjEfk4g &((NU16)1<<((NU)((((tyEnum_FilePermission__9a5SPDJ9aL9aLJgb0TzciuflA)0)))&15U)))!=0)) goto LA11_;
		p = (NU32)(p | ((mode_t) (S_IXUSR)));
	}
	LA11_: ;
	{
		if (!((permissions__xkP9bVS9abLKHyQ9aqcjEfk4g &((NU16)1<<((NU)((((tyEnum_FilePermission__9a5SPDJ9aL9aLJgb0TzciuflA)5)))&15U)))!=0)) goto LA15_;
		p = (NU32)(p | ((mode_t) (S_IRGRP)));
	}
	LA15_: ;
	{
		if (!((permissions__xkP9bVS9abLKHyQ9aqcjEfk4g &((NU16)1<<((NU)((((tyEnum_FilePermission__9a5SPDJ9aL9aLJgb0TzciuflA)4)))&15U)))!=0)) goto LA19_;
		p = (NU32)(p | ((mode_t) (S_IWGRP)));
	}
	LA19_: ;
	{
		if (!((permissions__xkP9bVS9abLKHyQ9aqcjEfk4g &((NU16)1<<((NU)((((tyEnum_FilePermission__9a5SPDJ9aL9aLJgb0TzciuflA)3)))&15U)))!=0)) goto LA23_;
		p = (NU32)(p | ((mode_t) (S_IXGRP)));
	}
	LA23_: ;
	{
		if (!((permissions__xkP9bVS9abLKHyQ9aqcjEfk4g &((NU16)1<<((NU)((((tyEnum_FilePermission__9a5SPDJ9aL9aLJgb0TzciuflA)8)))&15U)))!=0)) goto LA27_;
		p = (NU32)(p | ((mode_t) (S_IROTH)));
	}
	LA27_: ;
	{
		if (!((permissions__xkP9bVS9abLKHyQ9aqcjEfk4g &((NU16)1<<((NU)((((tyEnum_FilePermission__9a5SPDJ9aL9aLJgb0TzciuflA)7)))&15U)))!=0)) goto LA31_;
		p = (NU32)(p | ((mode_t) (S_IWOTH)));
	}
	LA31_: ;
	{
		if (!((permissions__xkP9bVS9abLKHyQ9aqcjEfk4g &((NU16)1<<((NU)((((tyEnum_FilePermission__9a5SPDJ9aL9aLJgb0TzciuflA)6)))&15U)))!=0)) goto LA35_;
	...
	LA35_: ;
	{
		NIM_BOOL T39_;
		T39_ = (NIM_BOOL)0;
		T39_ = !(followSymlinks__tjOT7doDcb9bHSErWpsCiqg);
		if (!(T39_)) goto LA40_;
		T39_ = nossymlinkExists(filename__AbxScOR5bFOJC9aDcW4AtpQ);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		LA40_: ;
		if (!T39_) goto LA41_;
	}
	...
	{
		{
			...
			T46_ = (int)0;
			T46_ = chmod(nimToCStringConv(filename__AbxScOR5bFOJC9aDcW4AtpQ), ((mode_t) (p)));
			if (!!((T46_ == ((NI32)0)))) goto LA47_;
			colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
			T50_ = (NI32)0;
			T50_ = osLastError__stdZoserrors_73();
			if (NIM_UNLIKELY(*nimErr_)) goto LA49_;
			T51_.Field0 = filename__AbxScOR5bFOJC9aDcW4AtpQ;
			T51_.Field1 = permissions__xkP9bVS9abLKHyQ9aqcjEfk4g;
			colontmpD_ = dollar___stdZprivateZosfiles_127(T51_);
			if (NIM_UNLIKELY(*nimErr_)) goto LA49_;
			raiseOSError__stdZoserrors_70(T50_, colontmpD_);
			if (NIM_UNLIKELY(*nimErr_)) goto LA49_;
			{
				LA49_:;
			}
...
{nimErr_ = nimErrorFlag();
	...
	nimZeroMem((void*)(&a), sizeof(struct stat));
	{
		...
		NI32 T6_;
		T3_ = (int)0;
		T3_ = stat(nimToCStringConv(filename__dWTHPlpwFwY9csM33S0AvUg), (&a));
		if (!(T3_ < ((NI32)0))) goto LA4_;
		T6_ = (NI32)0;
		T6_ = osLastError__stdZoserrors_73();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__stdZoserrors_70(T6_, filename__dWTHPlpwFwY9csM33S0AvUg);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA4_: ;
	result = 0;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	noscopyFile(source__rYWwPL1l5kyl9bGMXacccWw, dest__fAOSBWZsWfGtG9crX4ZMBUA, options__9cwHb567JCUw9bnX1Fq9bKBIw);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T2_ = nosgetFilePermissions(source__rYWwPL1l5kyl9bGMXacccWw);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nossetFilePermissions(dest__fAOSBWZsWfGtG9crX4ZMBUA, T2_, ((options__9cwHb567JCUw9bnX1Fq9bKBIw &((NU8)1<<((NU)((((tyEnum_CopyFlag__mhWURcDRsh0F1DeHBSFUVg)1)))&7U)))!=0));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	if (NIM_UNLIKELY(*nimErr_)) {
		LA1_:;
		{
			*nimErr_ = NIM_FALSE;
			{
				if (!!(ignorePermissionErrors__O9bXXEtWQZEjV5G3x67H4Ow)) goto LA8_;
				reraiseException();
goto LA4_;
			}
			LA8_: ;
