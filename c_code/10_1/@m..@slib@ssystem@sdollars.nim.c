...
N_LIB_PRIVATE N_NIMCALL(void, addQuoted__vm_1563)(NimStringV2* s__d8B3TpF9a1plpybwEXyKm9ag_3, NI x__kt6yfm0b4lpCHeMHG9cT1rw_3);
N_LIB_PRIVATE N_NIMCALL(void, addQuoted__vm_1768)(NimStringV2* s__d8B3TpF9a1plpybwEXyKm9ag_4, tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ x__kt6yfm0b4lpCHeMHG9cT1rw_4);
...
appendString((&result), TM__n49a9aYp5BrbXv9a6OCpJYm0g_17);
	...
	LA23_: ;
	countX60gensym367_ += ((NI)1);
	addQuoted__vm_1563((&result), (*x__3gbgphmPr2YyFiVFGB9c3cA).Field5);
	{
...
appendString((&result), TM__n49a9aYp5BrbXv9a6OCpJYm0g_22);
	...
	LA7_: ;
	countX60gensym484_ += ((NI)1);
	addQuoted__vm_1768((&result), x__3gbgphmPr2YyFiVFGB9c3cA_2.Field1);
	{
