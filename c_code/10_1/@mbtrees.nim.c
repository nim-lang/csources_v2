...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___vm_8451)(tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA** dest__JMzYMBMJ9ajhotzGeBjMMkQ, tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA* src__8WAp9c9b4p8v5sBWLX7pQ9azg);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vm_8448)(tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA** dest__OahwVO03J49bbt9aibiQuYUQ);
N_LIB_PRIVATE N_NIMCALL(tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA*, insert__vm_10128)(tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA* h__kmyeGfve0PM77UJ9ap7GamA, NimStringV2 key__hoZORW5Kd47ZIDGGm7Em2Q, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* val__bqwxa1faLq7jEyiLPVDZVQ);
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___vm_8454)(tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA** dest__eAU3QjA0UBOxPQ9ceUjO64Q, tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA* src__L9coWlEikoLlvuHjt6nk5sQ);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA*, split__vm_10956)(tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA* h__F5leEQuJRkyulJsiB4YBsw);
N_LIB_PRIVATE N_NIMCALL(void, copyHalf__vm_10973)(tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA* h__2P6cgen7kbXjyFDD3mg2LQ, tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA* result__zS9bjpLvH5qLFqu440IuuMg);
N_LIB_PRIVATE N_NIMCALL(NI, countSubTree__vm_12705)(tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA* it__TbQToXYOGcPsOhRH8XfWXQ);
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	x = NIM_NIL;
	eqcopy___vm_8451(&x, b__aLdAdbAwMquttonx7YwOVA.root);
				...
				i = ((NI)0);
				{
					while (1) {
						...
						j = i;
						{
							...
							LA10_: ;
							if (!T9_) goto LA12_;
							eqcopy___vm_8451(&x, (*x)._isInternal_2.links[(j)- 0]);
							if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
							goto LA4;
						}
						LA12_: ;
		...
		if (!(*h__2P6cgen7kbXjyFDD3mg2LQ).isInternal) goto LA6_;
		{
			...
			i_2 = ((NI)0);
			{
				while (1) {
					...
					j_2 = i_2;
					eqcopy___vm_8451(&(*result__zS9bjpLvH5qLFqu440IuuMg)._isInternal_2.links[(j_2)- 0], (*h__2P6cgen7kbXjyFDD3mg2LQ)._isInternal_2.links[((NI)(((NI)256) + j_2))- 0]);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					i_2 += ((NI)1);
				} LA10: ;
			}
...
{nimErr_ = nimErrorFlag();
	...
	copyHalf__vm_10973(h__F5leEQuJRkyulJsiB4YBsw, result);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
		...
		newLink = ((tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA*) NIM_NIL);
		{
			while (1) {
				if (!(j < (*h__kmyeGfve0PM77UJ9ap7GamA).entries)) goto LA25				;
				{
					...
					if (!T28_) goto LA31_;
					u = NIM_NIL;
					u = insert__vm_10128((*h__kmyeGfve0PM77UJ9ap7GamA)._isInternal_2.links[(j)- 0], key__hoZORW5Kd47ZIDGGm7Em2Q, val__bqwxa1faLq7jEyiLPVDZVQ);
					if (NIM_UNLIKELY(*nimErr_)) goto LA33_;
					j += ((NI)1);
					{
						if (!(u == ((tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA*) NIM_NIL))) goto LA36_;
						eqsink___vm_8454(&result, ((tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA*) NIM_NIL));
						if (NIM_UNLIKELY(*nimErr_)) goto LA33_;
						eqdestroy___vm_8448(&u);
						if (NIM_UNLIKELY(*nimErr_)) goto LA23_;
						eqdestroy___vm_8448(&newLink);
						if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
						eqdestroy___stdZassertions_13((&newKey));
						goto BeforeRet_;
					}
		...
		} LA24: ;
		{
			...
			res_2 = (*h__kmyeGfve0PM77UJ9ap7GamA).entries;
			{
				while (1) {
					...
					i_2 = res_2;
					eqcopy___vm_8451(&(*h__kmyeGfve0PM77UJ9ap7GamA)._isInternal_2.links[(i_2)- 0], (*h__kmyeGfve0PM77UJ9ap7GamA)._isInternal_2.links[((NI)(i_2 - ((NI)1)))- 0]);
					if (NIM_UNLIKELY(*nimErr_)) goto LA23_;
					res_2 -= ((NI)1);
				} LA42: ;
			}
		}
		eqsink___vm_8454(&(*h__kmyeGfve0PM77UJ9ap7GamA)._isInternal_2.links[(j)- 0], newLink);
		if (NIM_UNLIKELY(*nimErr_)) goto LA23_;
		newLink = 0;
		{
			LA23_:;
	...
	LA51_: ;
	{
		result = split__vm_10956(h__kmyeGfve0PM77UJ9ap7GamA);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA49_: ;
	eqdestroy___stdZassertions_13((&newKey));
...
{nimErr_ = nimErrorFlag();
	u = NIM_NIL;
	t = NIM_NIL;
	u = insert__vm_10128((*b__5t2VeOW7OCYAj03FUBqrNA).root, key__JkpEpGMAQiUp9cghFRpzIZA, val__w1RpoCE53aiSWocRcMziug);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	(*b__5t2VeOW7OCYAj03FUBqrNA).entries += ((NI)1);
	{
		if (!(u == ((tyObject_NodecolonObjectType___mrvIQfKwBmbEEQo9c7zUoMA*) NIM_NIL))) goto LA4_;
		eqdestroy___vm_8448(&t);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqdestroy___vm_8448(&u);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		goto BeforeRet_;
	...
	eqcopy___vm_8451(&(*t)._isInternal_2.links[(((NI)0))- 0], (*b__5t2VeOW7OCYAj03FUBqrNA).root);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqcopy___stdZassertions_16((&(*t).keys[(((NI)1))- 0]), (*u).keys[(((NI)0))- 0]);
	eqsink___vm_8454(&(*t)._isInternal_2.links[(((NI)1))- 0], u);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	u = 0;
	eqsink___vm_8454(&(*b__5t2VeOW7OCYAj03FUBqrNA).root, t);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	t = 0;
	{
		LA1_:;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	x = NIM_NIL;
	eqcopy___vm_8451(&x, b__YEBfxW6Tloy69c3Q9cF5sQtg.root);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		while (1) {
			if (!(*x).isInternal) goto LA3			;
		...
		result = ((NI)0);
		{
			...
			i = ((NI)0);
			{
				while (1) {
					...
					k = i;
					T8_ = (NI)0;
					T8_ = countSubTree__vm_12705((*it__TbQToXYOGcPsOhRH8XfWXQ)._isInternal_2.links[(k)- 0]);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					result += T8_;
					i += ((NI)1);
				} LA7: ;
...
{nimErr_ = nimErrorFlag();
	...
	colontmp__2 = NIM_NIL;
	eqcopy___vm_8451(&it, b__U8vWxyMym3I9ckpyMBBA5TA.root);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			...
			sum = ((NI)0);
			{
				...
				i_2 = ((NI)0);
				{
					while (1) {
						...
						k = i_2;
						c = countSubTree__vm_12705((*it)._isInternal_2.links[(k)- 0]);
						if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
						sum += c;
						{
							if (!(i < sum)) goto LA9_;
							eqcopy___vm_8451(&it, (*it)._isInternal_2.links[(k)- 0]);
							if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
							i -= (NI)(sum - c);
							goto LA4;
						}
