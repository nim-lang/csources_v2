...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__Lhb9bT29cO9colfu9awEQRLNKg).body, ((NI)4));
	}
	LA4_: ;
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	...
	eqdestroy___dfa_1534((&(*dest__Lhb9bT29cO9colfu9awEQRLNKg_2).g));
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__Lhb9bT29cO9colfu9awEQRLNKg_2).graph, ((NI)4));
	}
	LA9_: ;
	{
		NIM_BOOL T13_;
	...
	LA19_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__Lhb9bT29cO9colfu9awEQRLNKg_2).body, ((NI)4));
	}
	LA24_: ;
	}BeforeRet_: ;
}
