...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TokType__FBGVnQ0tiQKJV9co2BPPhQQ)110):
	{
		...
		relevantChar = (*(*tok).ident).s.p->data[((NI)0)];
		{
			...
			if (!(T5_)) goto LA6_;
			T7_ = (NIM_CHAR*)0;
			T7_ = X5BX5D___system_7076((&(*(*tok).ident).s), ((NI)1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			T5_ = ((NU8)((*T7_)) == (NU8)(62));
			LA6_: ;
			T4_ = T5_;
			if (!(T4_)) goto LA8_;
			T9_ = (NIM_CHAR*)0;
			T9_ = X5BX5D___system_7076((&(*(*tok).ident).s), ((NI)2));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case 94:
		{
			...
			colontmpD__2 = (NI)0;
			{
				NIM_CHAR* T15_;
				T15_ = (NIM_CHAR*)0;
				T15_ = X5BX5D___system_7076((&(*(*tok).ident).s), ((NI)1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case 92:
		{
			...
			colontmpD__4 = (NI)0;
			{
				NIM_CHAR* T22_;
				T22_ = (NIM_CHAR*)0;
				T22_ = X5BX5D___system_7076((&(*(*tok).ident).s), ((NI)1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case 124:
		{
			...
			colontmpD__6 = (NI)0;
			{
				NIM_CHAR* T30_;
				T30_ = (NIM_CHAR*)0;
				T30_ = X5BX5D___system_7076((&(*(*tok).ident).s), ((NI)1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case 38:
		{
			...
			colontmpD__8 = (NI)0;
			{
				NIM_CHAR* T37_;
				T37_ = (NIM_CHAR*)0;
				T37_ = X5BX5D___system_7076((&(*(*tok).ident).s), ((NI)1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case 46:
		{
			...
			colontmpD__10 = (NI)0;
			{
				NIM_CHAR* T45_;
				T45_ = (NIM_CHAR*)0;
				T45_ = X5BX5D___system_7076((&(*(*tok).ident).s), ((NI)1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		{
			{
				NIM_CHAR* T53_;
				T53_ = (NIM_CHAR*)0;
				T53_ = X5BX5D___system_7076((&(*(*tok).ident).s), ((NI)1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		default:
		{
			...
			colontmpD__14 = (NI)0;
			{
				NIM_CHAR* T71_;
				T71_ = (NIM_CHAR*)0;
				T71_ = X5BX5D___system_7076((&(*(*tok).ident).s), ((NI)1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
