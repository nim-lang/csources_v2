...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T5_ = substr__system_7560(p__Kqv4F0bZMLYwGQlsJ69ai6w, (NI)(checksumSeparatorIndex + ((NI)1)));
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T16_ = substr__system_7548(p__Kqv4F0bZMLYwGQlsJ69ai6w, (NI)(versionSeparatorIndex + ((NI)1)), (NI)(checksumSeparatorIndex - ((NI)1)));
	...
	LA14_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			T22_ = substr__system_7548(p__Kqv4F0bZMLYwGQlsJ69ai6w, (NI)(versionSeparatorIndex + ((NI)1)), (NI)(checksumSeparatorIndex - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	...
	sVer2.len = 0; sVer2.p = NIM_NIL;
	{
		...
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		{
			...
			eqdestroy___system_3540((&sVer2));
			eqdestroy___system_3540((&sVer));
			goto BeforeRet_;
			{
				LA15_:;
			}
...
appendString((&T27_), p__y75I2yYwWHrxXLOAlxJn6Q);
		colontmpD__3 = T27_;
		liMessage__msgs_1172(conf__y9aqkh9aykYivc6NmBJ9bi0pA, info__ztgkWGYbJ7LdR7eSlaGs0A, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__Xve3Bgye29aQqSXx0rQYUzw_19, NIM_FALSE);
...
{nimErr_ = nimErrorFlag();
	...
	resultX60gensym40_.len = 0; resultX60gensym40_.p = NIM_NIL;
	{
		...
		colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
		colontmpD__2 = readFile__stdZsyncio_479(nimbleLinks.p->data[((NI)0)]);
		if (NIM_UNLIKELY(*nimErr_)) goto LA23_;
		...
		{
			eqdestroy___stdZassertions_13((&colontmpD__2));
			eqdestroy___system_3540((&nimbleLinkLines));
		}
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA21_: ;
	{
		...
		if (!!(T34_)) goto LA35_;
		liMessage__msgs_1172(conf__eRiC9aAtyASqyieqV0TXkpQ, info__d7DumG9cpw7zAgfrKC1afOQ, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)94), path, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__Xve3Bgye29aQqSXx0rQYUzw_23, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		blitTmp = path;
		path.len = 0; path.p = NIM_NIL;
	...
	{
		eqdestroy___system_3540((&resultX60gensym40_));
		eqdestroy___system_3540((&nimbleLinks));
	...
	LA4_: ;
	{
		...
		d = opendir(nimToCStringConv(dir__02xH7wml2JfdyIMtASF47Q));
		{
			if (!(d == ((DIR*) NIM_NIL))) goto LA10_;
			{
				...
				T16_ = (NI32)0;
				T16_ = osLastError__stdZoserrors_73();
				if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
				raiseOSError__stdZoserrors_70(T16_, dir__02xH7wml2JfdyIMtASF47Q);
				if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
			}
			LA14_: ;
		}
				...
				while (1) {
					{
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							k_2 = ((tyEnum_PathComponent__x9aIl9aBWoeZzD6AxCnUUcPQ)0);
							{
								int T40_;
								T40_ = (int)0;
								T40_ = lstat(nimToCStringConv(path), (&s));
							...
							y.len = 0; y.p = NIM_NIL;
							{
								NIM_BOOL T65_;
								T65_ = (NIM_BOOL)0;
								T65_ = (k == ((tyEnum_PathComponent__x9aIl9aBWoeZzD6AxCnUUcPQ)2));
								if (!(T65_)) goto LA66_;
								T65_ = !(((NU8)(p.p->data[pos]) == (NU8)(46)));
								LA66_: ;
								if (!T65_) goto LA67_;
				...
				res = ((NI)0);
				{
					while (1) {
						...
						h = res;
						{
							...
							NimStringV2 res_2;
							T87_ = (NIM_BOOL)0;
							T87_ = isFilled__pureZcollectionsZtables_33(packages.data.p->data[h].Field0);
							if (NIM_UNLIKELY(*nimErr_)) goto LA80_;
							if (!T87_) goto LA88_;
							...
							key.len = 0; key.p = NIM_NIL;
							{
								if (!!((val.Field0.len == ((NI)0)))) goto LA93_;
...
appendString((&res_2), val.Field0);
							...
							LA93_: ;
							{
								if (!!((val.Field1.len == ((NI)0)))) goto LA97_;
								nimAddCharV1((&res_2), 45);
