...
static N_INLINE(NimStringV2, getCurrentExceptionMsg__system_6867)(void);
...
N_LIB_PRIVATE N_NIMCALL(void, moveDir__stdZprivateZosdirs_465)(NimStringV2 source__D77IWrk8kTTXv5bgij9cFJQ, NimStringV2 dest__KLDvRS3yUtqspPGxZ9bPjZw);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, readAll__stdZsyncio_363)(FILE* file__QCxOCLKufUVrIqIUhi1f9cw);
...
{nimErr_ = nimErrorFlag();
	...
	result.len = 0; result.p = NIM_NIL;
	dir = getString__vm_363(a__VUaG9afrXC2wfP1Tk69aG37Q, ((NI)0));
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		d = opendir(nimToCStringConv(dir));
		{
			if (!(d == ((DIR*) NIM_NIL))) goto LA6_;
			{
				...
				raiseOSError__stdZoserrors_70(T12_, dir);
				if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
			}
			LA10_: ;
		}
				...
				while (1) {
					{
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							y.len = 0; y.p = NIM_NIL;
							{
								...
								if (!((filter__1WWClm6rmWmt1eOK8Ty8ig &((NU8)1<<((NU)((kind))&7U)))!=0)) goto LA61_;
	...
	setResult__vm_260(a__VUaG9afrXC2wfP1Tk69aG37Q, result);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
	{
		eqdestroy___system_3540((&result));
...
{	result.len = 0; result.p = NIM_NIL;
	...
	{
		if (!(currException__system_3678 == ((Exception*) NIM_NIL))) goto LA4_;
		result = TM__qdmBYobaV9btoxwHZNavLQA_20;
	}
	goto LA2_;
	LA4_: ;
	{
		eqcopy___stdZassertions_16((&result), (*currException__system_3678).message);
	}
	LA2_: ;
	goto BeforeRet_;
	}BeforeRet_: ;
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T5_ = getCurrentExceptionMsg__system_6867();
...
{nimErr_ = nimErrorFlag();
	...
	LA6_: ;
	{
		...
		T10_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_3, ((NI)0));
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD_ = T10_;
		T11_ = (NIM_BOOL)0;
		T11_ = getBool__vm_315(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_3, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T17_ = getCurrentExceptionMsg__system_6867();
...
{nimErr_ = nimErrorFlag();
	...
	LA6_: ;
	{
		...
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		T10_.len = 0; T10_.p = NIM_NIL;
		T10_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_4, ((NI)0));
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD_ = T10_;
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T16_ = getCurrentExceptionMsg__system_6867();
...
{nimErr_ = nimErrorFlag();
	...
	T3_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_5, ((NI)0));
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T9_ = getCurrentExceptionMsg__system_6867();
...
{nimErr_ = nimErrorFlag();
	colonenvP_ = (tyObject_Env_scriptconfigdotnim_setupVM___pTZgnDtMl6vuf36DH1bMeA*) ClE_0;
	setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_6, (*colonenvP_).errorMsg1);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
static N_INLINE(void, setCurrentDir__stdZprivateZosdirs_468)(NimStringV2 newDir__9cJvNnUDpQyuE3XvzzjZXpw) {
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	T3_.len = 0; T3_.p = NIM_NIL;
	T3_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_7, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	colontmpD_ = T3_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	colontmpD_ = T3_;
	setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_8, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	{
		LA2_:;
	}
...
{nimErr_ = nimErrorFlag();
	...
	LA6_: ;
	{
		...
		T10_.len = 0; T10_.p = NIM_NIL;
		T10_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_9, ((NI)0));
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD_ = T10_;
		T11_.len = 0; T11_.p = NIM_NIL;
		T11_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_9, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD__2 = T11_;
...
{nimErr_ = nimErrorFlag();
	...
	LA6_: ;
	{
		...
		colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
		T10_.len = 0; T10_.p = NIM_NIL;
		T10_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_10, ((NI)0));
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD_ = T10_;
		T11_.len = 0; T11_.p = NIM_NIL;
		T11_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_10, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD__2 = T11_;
		moveDir__stdZprivateZosdirs_465(colontmpD_, colontmpD__2);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		{
			LA9_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	LA6_: ;
	{
		...
		colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
		T10_.len = 0; T10_.p = NIM_NIL;
		T10_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_11, ((NI)0));
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD_ = T10_;
		T11_.len = 0; T11_.p = NIM_NIL;
		T11_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_11, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD__2 = T11_;
...
{nimErr_ = nimErrorFlag();
	...
	LA6_: ;
	{
		...
		colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
		T10_.len = 0; T10_.p = NIM_NIL;
		T10_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_12, ((NI)0));
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD_ = T10_;
		T11_.len = 0; T11_.p = NIM_NIL;
		T11_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_12, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD__2 = T11_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	T3_.len = 0; T3_.p = NIM_NIL;
	T3_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_13, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	colontmpD_ = T3_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	setResult__vm_238(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_13, T5_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	{
		LA2_:;
	}
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			T11_.len = 0; T11_.p = NIM_NIL;
			T11_ = getCurrentExceptionMsg__system_6867();
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
	T3_.len = 0; T3_.p = NIM_NIL;
	T3_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_14, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	colontmpD_ = T3_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	colontmpD__2 = T4_;
	setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_14, colontmpD__2);
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	{
		LA2_:;
	}
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			T10_.len = 0; T10_.p = NIM_NIL;
			T10_ = getCurrentExceptionMsg__system_6867();
...
{nimErr_ = nimErrorFlag();
	...
	LA6_: ;
	{
		...
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		T9_.len = 0; T9_.p = NIM_NIL;
		T9_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_15, ((NI)0));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		colontmpD_ = T9_;
		T10_ = (NI)0;
		T10_ = nospexecCmd(colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		setResult__vm_238(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_15, ((NI64) (T10_)));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		eqdestroy___stdZassertions_13((&colontmpD_));
	}
	LA2_: ;
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T14_ = getCurrentExceptionMsg__system_6867();
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_16, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__2 = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_16, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__3 = getEnv__stdZenvvars_15(colontmpD_, colontmpD__2);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_16, colontmpD__3);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_17, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = (NIM_BOOL)0;
	T1_ = existsEnv__stdZenvvars_20(colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	setResult__vm_244(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_17, T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___stdZassertions_13((&colontmpD_));
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_18, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__2 = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_18, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_19, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_20, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = (NIM_BOOL)0;
	T1_ = nosdirExists(colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	setResult__vm_244(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_20, T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___stdZassertions_13((&colontmpD_));
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_21, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = (NIM_BOOL)0;
	T1_ = nosfileExists(colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	setResult__vm_244(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_21, T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___stdZassertions_13((&colontmpD_));
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	colonenvP_ = (tyObject_Env_scriptconfigdotnim_setupVM___pTZgnDtMl6vuf36DH1bMeA*) ClE_0;
	setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_22, (*(*colonenvP_).conf3).projectName);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_132)(tyObject_VmArgs__m5KtcByJU2AdS9bbHP7rUig* a__Mw3G9cZYFvO6ZS9bvYa2qGdw_23, void* ClE_0) {
...
{nimErr_ = nimErrorFlag();
	colonenvP_ = (tyObject_Env_scriptconfigdotnim_setupVM___pTZgnDtMl6vuf36DH1bMeA*) ClE_0;
	setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_23, (*(*colonenvP_).conf3).projectPath);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_134)(tyObject_VmArgs__m5KtcByJU2AdS9bbHP7rUig* a__Mw3G9cZYFvO6ZS9bvYa2qGdw_24, void* ClE_0) {
...
{nimErr_ = nimErrorFlag();
	colonenvP_ = (tyObject_Env_scriptconfigdotnim_setupVM___pTZgnDtMl6vuf36DH1bMeA*) ClE_0;
	setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_24, (*(*colonenvP_).conf3).projectFull);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_136)(tyObject_VmArgs__m5KtcByJU2AdS9bbHP7rUig* a__Mw3G9cZYFvO6ZS9bvYa2qGdw_25, void* ClE_0) {
...
{nimErr_ = nimErrorFlag();
	colonenvP_ = (tyObject_Env_scriptconfigdotnim_setupVM___pTZgnDtMl6vuf36DH1bMeA*) ClE_0;
	setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_25, (*colonenvP_).vthisDir4);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_138)(tyObject_VmArgs__m5KtcByJU2AdS9bbHP7rUig* a__Mw3G9cZYFvO6ZS9bvYa2qGdw_26, void* ClE_0) {
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_26, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__2 = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_26, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_27, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__2 = getConfigVar__options_4923((*colonenvP_).conf3, colontmpD_, TM__qdmBYobaV9btoxwHZNavLQA_92);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_27, colontmpD__2);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___stdZassertions_13((&colontmpD__2));
	eqdestroy___stdZassertions_13((&colontmpD_));
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	colonenvP_ = (tyObject_Env_scriptconfigdotnim_setupVM___pTZgnDtMl6vuf36DH1bMeA*) ClE_0;
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_28, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = (NIM_BOOL)0;
	T1_ = existsConfigVar__options_4919((*colonenvP_).conf3, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	setResult__vm_244(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_28, T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___stdZassertions_13((&colontmpD_));
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_29, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	T1_ = (NI64)0;
	T1_ = getInt__vm_281(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_30, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD_ = paramStr__stdZcmdline_53(((NI) (T1_)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_30, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___stdZassertions_13((&colontmpD_));
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	setResult__vm_238(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_31, ((NI64) (T1_)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, colonanonymous___scriptconfig_150)(tyObject_VmArgs__m5KtcByJU2AdS9bbHP7rUig* a__Mw3G9cZYFvO6ZS9bvYa2qGdw_32) {
...
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_32, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__2 = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_32, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = (NI)0;
	T1_ = nsuCmpIgnoreStyle(colontmpD_, colontmpD__2);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	setResult__vm_238(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_32, ((NI64) (T1_)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___stdZassertions_13((&colontmpD__2));
	eqdestroy___stdZassertions_13((&colontmpD_));
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_33, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__2 = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_33, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = (NI)0;
	T1_ = nsuCmpIgnoreCase(colontmpD_, colontmpD__2);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	setResult__vm_238(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_33, ((NI64) (T1_)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___stdZassertions_13((&colontmpD__2));
	eqdestroy___stdZassertions_13((&colontmpD_));
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_34, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	setCommandEarly__commands_856((*colonenvP_).conf3, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	arg = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_34, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	colonenvP_ = (tyObject_Env_scriptconfigdotnim_setupVM___pTZgnDtMl6vuf36DH1bMeA*) ClE_0;
	setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_35, (*(*colonenvP_).conf3).command);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_163)(tyObject_VmArgs__m5KtcByJU2AdS9bbHP7rUig* a__Mw3G9cZYFvO6ZS9bvYa2qGdw_36, void* ClE_0) {
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_36, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__2 = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_36, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_37, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__2 = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_37, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_38, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__2 = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_38, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_39, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__2 = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_39, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
appendString((&T2_), colontmpD__2);
	key = T2_;
	colontmpD__3 = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_39, ((NI)2));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_40, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___stdZassertions_13((&colontmpD_));
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	colonenvP_ = (tyObject_Env_scriptconfigdotnim_setupVM___pTZgnDtMl6vuf36DH1bMeA*) ClE_0;
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD_ = getString__vm_363(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_41, ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___stdZassertions_19((&(*colonenvP_).errorMsg1), TM__qdmBYobaV9btoxwHZNavLQA_133);
	{
		...
		LA5_: ;
		if (!T4_) goto LA6_;
		setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_42, TM__qdmBYobaV9btoxwHZNavLQA_134);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	goto LA2_;
	LA6_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD_ = T10_;
		setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_42, colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		{
			LA9_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___stdZassertions_19((&(*colonenvP_).errorMsg1), TM__qdmBYobaV9btoxwHZNavLQA_137);
	{
		...
		LA5_: ;
		if (!T4_) goto LA6_;
		setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_43, TM__qdmBYobaV9btoxwHZNavLQA_138);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	goto LA2_;
	LA6_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD_ = T10_;
		setResult__vm_251(a__Mw3G9cZYFvO6ZS9bvYa2qGdw_43, colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		{
			LA9_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	registerAdditionalOps__vm_13354(result);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T7_.Field0 = myOpen__vm_14052;
	T7_.Field1 = myProcess__vm_14057;
	T7_.Field2 = myClose__vm_14062;
