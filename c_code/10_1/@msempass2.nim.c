...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__4dLWN1ThnHVlyLAoECu6Fg).exc, ((NI)4));
	}
	LA4_: ;
	{
		NIM_BOOL T8_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__4dLWN1ThnHVlyLAoECu6Fg).tags, ((NI)4));
	}
	LA9_: ;
	{
		NIM_BOOL T13_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__4dLWN1ThnHVlyLAoECu6Fg).forbids, ((NI)4));
	}
	LA14_: ;
	{
		NIM_BOOL T18_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__4dLWN1ThnHVlyLAoECu6Fg).guards.g, ((NI)4));
	}
	LA29_: ;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		nimRawDispose((*dest__4dLWN1ThnHVlyLAoECu6Fg).config, ((NI)4));
	}
	LA34_: ;
	{
		NIM_BOOL T38_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__4dLWN1ThnHVlyLAoECu6Fg).graph, ((NI)4));
	}
	LA39_: ;
	{
		NIM_BOOL T43_;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__4dLWN1ThnHVlyLAoECu6Fg_2).exc, ((NI)4));
	}
	LA4_: ;
	{
		NIM_BOOL T8_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__4dLWN1ThnHVlyLAoECu6Fg_2).tags, ((NI)4));
	}
	LA9_: ;
	{
		NIM_BOOL T13_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__4dLWN1ThnHVlyLAoECu6Fg_2).forbids, ((NI)4));
	}
	LA14_: ;
	}BeforeRet_: ;
}
