...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___system_3546)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ* dest__zO0EVMFk0wx0QTRlbT3jtA, tySequence__sM4lkSb7zS6F7OVMvW9cffQ src__Y09cxl7g7eEiuqKyhAxj8Rg);
...
static N_INLINE(NIM_CHAR, X5BX5D___system_7037)(NimStringV2 s__PGsSrP2Hp9bHlVetHpoUPug, NI i__MpPA5N1VsAzqiuzycRdOAg);
...
{nimErr_ = nimErrorFlag();
	...
	LA13_: ;
	{
		...
		if (!(T22_)) goto LA23_;
		T24_ = (NIM_CHAR)0;
		T24_ = X5BX5D___system_7037(ident__YHf1XAuiepoLFmQIi1E7lw, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA25_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			T36_ = (NIM_BOOL)0;
			T37_ = (NIM_CHAR)0;
			T37_ = X5BX5D___system_7037(ident__YHf1XAuiepoLFmQIi1E7lw, ((NI)1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	(*result).symkind = ((NU8) ((*s__N2N3nhxmF6allE4GMeC4Vw).kind));
	{
		...
		eqsink___system_3546((&(*result).qualifiedPath), T6_);
		{
			NIM_BOOL T9_;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___sigmatch_7590)(tyObject_Env_sigmatchdotnim_matchUserTypeClass___PD9aW11HeUq9a1eqUZIZ9a0aQ* dest__29b6jWmrjhVE9bEpcc0XLoOA) {
	...
	LA9_: ;
	eqdestroy___system_3540((&(*dest__29b6jWmrjhVE9bEpcc0XLoOA).diagnostics4));
}
static N_INLINE(void, add__system_2712)(tyObject_CellSeq__sGle0igznE2T7vk4dBh5SQ* s__G58rBzp9arUs2Le3q9bajUHA, void** c__glbQoed0fMuhXSt1wQUc7w, TNimTypeV2* t__afUUWAFqIJFXIEkjClESEA) {
	void** colontmp_;
...
appendString((&T13_), TM__wjrA09aH0rT1R7zbrcCaROw_44);
	...
	collectDiagnostics = T75_;
	{
		...
		eqsink___system_3546((&(*colonenv_).diagnostics4), T81_);
		flags = 1024;
		colontmpD__9 = 0;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___system_3543((&(*dest__rylyKTyag1RZ9cZeRIysihg).diagnostics), (*src__9bz3GnJwg9aJehMPOifB9b9b4w).diagnostics);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___system_3540((&(*dest__JhF4Anapoxmo8ESikNKVhg).diagnostics));
	{
		NIM_BOOL T23_;
		T23_ = (NIM_BOOL)0;
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___system_3546((&(*c__RYoVP8Emis1l620CKz9cEKw_2).diagnostics), T26_);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___sem_2056)(tySequence__QlpmqBu4k7qSn9cgYGyYsWw* dest__JhF4Anapoxmo8ESikNKVhg) {
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			LA12_: ;
			eqdestroy___system_3540((&(*dest__JhF4Anapoxmo8ESikNKVhg).p->data[colontmp_].diagnostics));
			colontmp_ += ((NI)1);
		} LA2: ;
	}
