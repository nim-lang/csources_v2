...
N_LIB_PRIVATE N_NIMCALL(void, addFloatRoundtrip__system_4401)(NimStringV2* result__qvuWI64tfQT6kViLfCi1hg, NF x__UyPVzaCaJ9bo79aeR3Dk6SuA);
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		d = opendir(nimToCStringConv(path__SEgzpy5M9b29cEf9cNKzmGSEw));
		{
			if (!(d == ((DIR*) NIM_NIL))) goto LA5_;
			{
				...
				raiseOSError__stdZoserrors_70(T11_, path__SEgzpy5M9b29cEf9cNKzmGSEw);
				if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
			}
			LA9_: ;
		}
...
N_LIB_PRIVATE N_NIMCALL(tySequence__sM4lkSb7zS6F7OVMvW9cffQ, querySettingSeqImpl__vm_13286)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf__R1D2RukbmapWZ9aDLb232qQ, NI64 switch__dkUh9aTTuLOgUZ072GHSo9bA) {
	...
	{
		eqcopy___system_3543((&result), (*conf__R1D2RukbmapWZ9aDLb232qQ).commandArgs);
	}
	break;
...
appendString((&T44_), colontmpD_);
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)36) ... ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)39):
		{
			...
			T61_ = dollar___system_4392(src__eKVNJdhi9cJo8gPYaVUOv9bQ.floatVal);
			if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
...
appendString((&T1405_), colontmpD__155);
			...
			case ((tyEnum_TOpcode__g8HRIfzFsQsDBgE9cOvGknQ)152):
			{
				...
				T1713_ = (NI)0;
				{
					...
					T1716_ = (NIM_BOOL)0;
					T1717_ = (NIM_BOOL)0;
					T1717_ = eqeq___system_7514(aStrVal, ((NCSTRING) NIM_NIL));
					T1716_ = !(T1717_);
					if (!(T1716_)) goto LA1718_;
					T1719_ = (NIM_BOOL)0;
					T1719_ = eqeq___system_7514(bStrVal, ((NCSTRING) NIM_NIL));
					T1716_ = !(T1719_);
					LA1718_: ;
