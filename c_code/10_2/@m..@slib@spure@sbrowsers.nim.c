...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = contains__pureZstrutils_1809(s__TcZ0TXLod9bycA4cmbpUYSA, TM__CZNeKGdQ8AWxD1HSDIq5DQ_5);
	...
	LA6_: ;
	{
		...
		splitsX60gensym33_ = ((NI)-1);
		{
			while (1) {
				...
				T20_ = substr__system_7560(colontmp_, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI)1)));
