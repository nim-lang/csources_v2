...
N_LIB_PRIVATE N_NIMCALL(NI, nucruneLen)(NIM_CHAR* s__Wl3t9ampN1b2ZcWIIz2VokQ_2, NI s__Wl3t9ampN1b2ZcWIIz2VokQ_2Len_0) {
	...
	i = ((NI)0);
	{
		while (1) {
			...
			{
				if (!((NU64)(((NU) (((NU8)(s__Wl3t9ampN1b2ZcWIIz2VokQ_2[i]))))) <= (NU64)(((NU)127)))) goto LA5_;
				i += ((NI)1);
			}
			goto LA3_;
			LA5_: ;
			{
				if (!((NU)((NU64)(((NU) (((NU8)(s__Wl3t9ampN1b2ZcWIIz2VokQ_2[i]))))) >> (NU64)(((NI)5))) == ((NU)6))) goto LA8_;
				i += ((NI)2);
			}
			goto LA3_;
			LA8_: ;
			{
				if (!((NU)((NU64)(((NU) (((NU8)(s__Wl3t9ampN1b2ZcWIIz2VokQ_2[i]))))) >> (NU64)(((NI)4))) == ((NU)14))) goto LA11_;
				i += ((NI)3);
			}
			goto LA3_;
			LA11_: ;
			{
				if (!((NU)((NU64)(((NU) (((NU8)(s__Wl3t9ampN1b2ZcWIIz2VokQ_2[i]))))) >> (NU64)(((NI)3))) == ((NU)30))) goto LA14_;
				i += ((NI)4);
			}
			goto LA3_;
			LA14_: ;
			{
				if (!((NU)((NU64)(((NU) (((NU8)(s__Wl3t9ampN1b2ZcWIIz2VokQ_2[i]))))) >> (NU64)(((NI)2))) == ((NU)62))) goto LA17_;
				i += ((NI)5);
			}
			goto LA3_;
			LA17_: ;
			{
				if (!((NU)((NU64)(((NU) (((NU8)(s__Wl3t9ampN1b2ZcWIIz2VokQ_2[i]))))) >> (NU64)(((NI)1))) == ((NU)126))) goto LA20_;
				i += ((NI)6);
			}
			goto LA3_;
			LA20_: ;
...
N_LIB_PRIVATE N_NIMCALL(NI, runeLenAt__pureZunicode_94)(NIM_CHAR* s__HFZnBAlHMgqd0p30m9cTrZg, NI s__HFZnBAlHMgqd0p30m9cTrZgLen_0, NI i__4agZLR6ckeyJXQXPUJ6ShQ) {
	...
	result = (NI)0;
	{
		if (!((NU64)(((NU) (((NU8)(s__HFZnBAlHMgqd0p30m9cTrZg[i__4agZLR6ckeyJXQXPUJ6ShQ]))))) <= (NU64)(((NU)127)))) goto LA3_;
		result = ((NI)1);
	}
	goto LA1_;
	LA3_: ;
	{
		if (!((NU)((NU64)(((NU) (((NU8)(s__HFZnBAlHMgqd0p30m9cTrZg[i__4agZLR6ckeyJXQXPUJ6ShQ]))))) >> (NU64)(((NI)5))) == ((NU)6))) goto LA6_;
		result = ((NI)2);
	}
	goto LA1_;
	LA6_: ;
	{
		if (!((NU)((NU64)(((NU) (((NU8)(s__HFZnBAlHMgqd0p30m9cTrZg[i__4agZLR6ckeyJXQXPUJ6ShQ]))))) >> (NU64)(((NI)4))) == ((NU)14))) goto LA9_;
		result = ((NI)3);
	}
	goto LA1_;
	LA9_: ;
	{
		if (!((NU)((NU64)(((NU) (((NU8)(s__HFZnBAlHMgqd0p30m9cTrZg[i__4agZLR6ckeyJXQXPUJ6ShQ]))))) >> (NU64)(((NI)3))) == ((NU)30))) goto LA12_;
		result = ((NI)4);
	}
	goto LA1_;
	LA12_: ;
	{
		if (!((NU)((NU64)(((NU) (((NU8)(s__HFZnBAlHMgqd0p30m9cTrZg[i__4agZLR6ckeyJXQXPUJ6ShQ]))))) >> (NU64)(((NI)2))) == ((NU)62))) goto LA15_;
		result = ((NI)5);
	}
	goto LA1_;
	LA15_: ;
	{
		if (!((NU)((NU64)(((NU) (((NU8)(s__HFZnBAlHMgqd0p30m9cTrZg[i__4agZLR6ckeyJXQXPUJ6ShQ]))))) >> (NU64)(((NI)1))) == ((NU)126))) goto LA18_;
		result = ((NI)6);
	}
	goto LA1_;
	LA18_: ;
...
{	result = (NI)0;
	...
	L = s__BD9cZ4z0vPfebl0QUVLz1Xg_2Len_0;
	{
		while (1) {
			if (!(i < L)) goto LA2			;
			{
				if (!((NU64)(((NU) (((NU8)(s__BD9cZ4z0vPfebl0QUVLz1Xg_2[i]))))) <= (NU64)(((NU)127)))) goto LA5_;
				i += ((NI)1);
			}
			goto LA3_;
			LA5_: ;
			{
				if (!((NU)((NU64)(((NU) (((NU8)(s__BD9cZ4z0vPfebl0QUVLz1Xg_2[i]))))) >> (NU64)(((NI)5))) == ((NU)6))) goto LA8_;
				{
					if (!((NU64)(((NU) (((NU8)(s__BD9cZ4z0vPfebl0QUVLz1Xg_2[i]))))) < (NU64)(((NU)194)))) goto LA12_;
					result = i;
					goto BeforeRet_;
				}
				LA12_: ;
				{
					...
					T16_ = ((NI)(i + ((NI)1)) < L);
					if (!(T16_)) goto LA17_;
					T16_ = ((NU)((NU64)(((NU) (((NU8)(s__BD9cZ4z0vPfebl0QUVLz1Xg_2[(NI)(i + ((NI)1))]))))) >> (NU64)(((NI)6))) == ((NU)2));
					LA17_: ;
					if (!T16_) goto LA18_;
					i += ((NI)2);
				}
			...
			LA8_: ;
			{
				if (!((NU)((NU64)(((NU) (((NU8)(s__BD9cZ4z0vPfebl0QUVLz1Xg_2[i]))))) >> (NU64)(((NI)4))) == ((NU)14))) goto LA22_;
				{
					NIM_BOOL T26_;
					NIM_BOOL T27_;
					T26_ = (NIM_BOOL)0;
					...
					T27_ = ((NI)(i + ((NI)2)) < L);
					if (!(T27_)) goto LA28_;
					T27_ = ((NU)((NU64)(((NU) (((NU8)(s__BD9cZ4z0vPfebl0QUVLz1Xg_2[(NI)(i + ((NI)1))]))))) >> (NU64)(((NI)6))) == ((NU)2));
					LA28_: ;
					T26_ = T27_;
					if (!(T26_)) goto LA29_;
					T26_ = ((NU)((NU64)(((NU) (((NU8)(s__BD9cZ4z0vPfebl0QUVLz1Xg_2[(NI)(i + ((NI)2))]))))) >> (NU64)(((NI)6))) == ((NU)2));
					LA29_: ;
					if (!T26_) goto LA30_;
					i += ((NI)3);
				}
			...
			LA22_: ;
			{
				if (!((NU)((NU64)(((NU) (((NU8)(s__BD9cZ4z0vPfebl0QUVLz1Xg_2[i]))))) >> (NU64)(((NI)3))) == ((NU)30))) goto LA34_;
				{
					NIM_BOOL T38_;
					NIM_BOOL T39_;
					NIM_BOOL T40_;
					...
					T40_ = ((NI)(i + ((NI)3)) < L);
					if (!(T40_)) goto LA41_;
					T40_ = ((NU)((NU64)(((NU) (((NU8)(s__BD9cZ4z0vPfebl0QUVLz1Xg_2[(NI)(i + ((NI)1))]))))) >> (NU64)(((NI)6))) == ((NU)2));
					LA41_: ;
					T39_ = T40_;
					if (!(T39_)) goto LA42_;
					T39_ = ((NU)((NU64)(((NU) (((NU8)(s__BD9cZ4z0vPfebl0QUVLz1Xg_2[(NI)(i + ((NI)2))]))))) >> (NU64)(((NI)6))) == ((NU)2));
					LA42_: ;
					T38_ = T39_;
					if (!(T38_)) goto LA43_;
					T38_ = ((NU)((NU64)(((NU) (((NU8)(s__BD9cZ4z0vPfebl0QUVLz1Xg_2[(NI)(i + ((NI)3))]))))) >> (NU64)(((NI)6))) == ((NU)2));
					LA43_: ;
					if (!T38_) goto LA44_;
					i += ((NI)4);
				}
