...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, rawCreateDir__stdZprivateZosdirs_431)(NimStringV2 dir__TJIqyCkiIz7wPVhjQJN5hQ);
...
N_LIB_PRIVATE N_NIMCALL(void, rawRemoveDir__stdZprivateZosdirs_424)(NimStringV2 dir__yxIFfmjbIvgNIMUWQErk4Q);
...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	{
		...
		raiseOSError__stdZoserrors_70(T11_, dir__TJIqyCkiIz7wPVhjQJN5hQ);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA1_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	T1_ = (NIM_BOOL)0;
	T1_ = rawCreateDir__stdZprivateZosdirs_431(dir__vZZVUaIn1vd7TfHmCblGxA);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = !(T1_);
	{
		if (!result) goto LA4_;
				...
				res = ((NI)0);
				{
					while (1) {
						...
						i = res;
						{
							...
							T50_ = substr__system_7560(dir__Cqk1agZLZB9cLp7ktxH9bW9aw, ((NI)0), i);
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (!T3_) goto LA6_;
		T8_ = (NI32)0;
		T8_ = osLastError__stdZoserrors_73();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__stdZoserrors_70(T8_, dir__yxIFfmjbIvgNIMUWQErk4Q);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA6_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	{
		...
		d = opendir(nimToCStringConv(dir__6OuenANQUO79aeNGnwJzDPw));
		{
			if (!(d == ((DIR*) NIM_NIL))) goto LA5_;
			{
				...
				raiseOSError__stdZoserrors_70(T11_, dir__6OuenANQUO79aeNGnwJzDPw);
				if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
			}
			LA9_: ;
		}
	...
	rawRemoveDir__stdZprivateZosdirs_424(dir__6OuenANQUO79aeNGnwJzDPw);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, noscopyDir)(NimStringV2 source__pIkWRYTYKbeN9aA4wO3xdew, NimStringV2 dest__BsnoPLoqhXzS6yJKz1lKaw) {
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		d = opendir(nimToCStringConv(source__pIkWRYTYKbeN9aA4wO3xdew));
		{
			if (!(d == ((DIR*) NIM_NIL))) goto LA5_;
			{
				...
				T11_ = osLastError__stdZoserrors_73();
				if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
				raiseOSError__stdZoserrors_70(T11_, source__pIkWRYTYKbeN9aA4wO3xdew);
				if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
			}
			LA9_: ;
		}
