...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___stdZoserrors_33)(tyObject_OSError__PeQ9bR8XhClb9cp9cbW28aSyw** dest__wuYTzffCCHdeMcoF0ywV8Q);
...
N_LIB_PRIVATE N_NIMCALL(void, newSeq__system_3418)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ* s__JHX6dGKfrwZrkhFUhd74qw_2, NI len__WT25bUt2bu59aVKae2o1xsg_2);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getStackTrace__system_3633)(Exception* e__l21OTFrXhQyHeJikwA9bfaw);
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (T3_) goto LA4_;
		T5_ = (NIM_CHAR*)0;
		T5_ = X5BX5D___system_7088(dest__mlcrjR9afZOEzcsXiEnNpqA, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T3_ = !(((NU8)((*T5_)) == (NU8)(32)));
		LA4_: ;
		if (!T3_) goto LA6_;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___extccomp_2037)(tyObject_BuildCache__bsEp9cTzVeuA9a0MLpRaR1yg* dest__nfzVMVGLFFxpJEwFtE4HUg) {
	...
	eqdestroy___system_3540((&(*dest__nfzVMVGLFFxpJEwFtE4HUg).link));
	eqdestroy___stdZassertions_13((&(*dest__nfzVMVGLFFxpJEwFtE4HUg).linkcmd));
	eqdestroy___system_3540((&(*dest__nfzVMVGLFFxpJEwFtE4HUg).extraCmds));
	eqdestroy___system_3540((&(*dest__nfzVMVGLFFxpJEwFtE4HUg).configFiles));
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__6.len = 0; colontmpD__6.p = NIM_NIL;
	{
		...
		eqdestroy___stdZassertions_13((&colontmpD__5));
		eqdestroy___stdZassertions_13((&colontmpD__4));
		eqdestroy___system_3540((&colontmpD__3));
		eqdestroy___stdZassertions_13((&colontmpD__2));
...
appendString((&T13_), TM__pZmXgBT0YcBrnAO6VUvpNQ_213);
		...
		T14_ = execCmdEx__pureZosproc_1599(colontmpD_, 10, ((tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg*) NIM_NIL), TM__pZmXgBT0YcBrnAO6VUvpNQ_214, TM__pZmXgBT0YcBrnAO6VUvpNQ_215);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___extccomp_3008)(tyObject_Env_extccompdotnim_callCCompiler___BcZEqupvBAThTu8RE6k9aJA* dest__QxO9bxrcWL67plemD3zYiNA) {
	eqdestroy___system_3540((&(*dest__QxO9bxrcWL67plemD3zYiNA).prettyCmds1));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___extccomp_3103)(tyObject_Env_extccompdotnim_execCmdsInParallel___yHnd6tS72p8Z69arkozzppg* dest__iALS3oVUrULmHNsN9cgA2KA) {
	...
	LA4_: ;
	eqdestroy___system_3540((&(*dest__iALS3oVUrULmHNsN9cgA2KA).cmds2));
}
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___extccomp_1304)(NI idx__hPPV8Qk2X8n1tabG3wscxQ, tyObject_ProcessObj__2rGNQnv9bU4hanI2g3svReg* p__H4fGkersvHkGUV6xUjbNpg, void* ClE_0) {
...
{nimErr_ = nimErrorFlag();
	...
	eqcopy___system_3543((&(*colonenv_).cmds2), cmds__CGwDobpjZtbFtHH9bIVB9aMQ);
	colontmpD_ = 0;
...
goto LA22_;
							...
							}
							{
								...
								eqdestroy___stdZoserrors_33(&oseX60gensym67_);
...
goto LA56_;
				...
				}
				{
					...
					eqdestroy___stdZoserrors_33(&oseX60gensym76_);
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	newSeq__system_3418((&result), ((NI) (s__XiQvRWkRogP0UWEpi5iccwLen_0)));
	{
		NI i;
		NI colontmp_;
		NI i_2;
...
goto LA5_;
			...
			}
			{
				...
				eqdestroy___stdZoserrors_33(&oseX60gensym58_);
...
appendString((&T21_), TM__pZmXgBT0YcBrnAO6VUvpNQ_336);
	linkerArgs = T21_;
	args = substr__system_7572(cmd__9clorThsgzIMyUFcc4fDYtA, i);
	{
		NIM_BOOL T24_;
		NimStringV2 colontmpD_;
		T24_ = (NIM_BOOL)0;
	...
	colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
	T34_.len = 0; T34_.p = NIM_NIL;
	colontmpD__2 = substr__system_7560(cmd__9clorThsgzIMyUFcc4fDYtA, ((NI)0), last);
...
{nimErr_ = nimErrorFlag();
	...
	eqcopy___options_3378(&(*colonenv_).conf2, conf__0MoGCFHUYF3zToiFnvZiUA);
	{
		...
		eqdestroy___system_3540((&cmds));
		eqdestroy___stdZassertions_13((&script));
		eqdestroy___system_3540((&extraCmds));
...
appendString((&T81_), TM__pZmXgBT0YcBrnAO6VUvpNQ_329);
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA44_;
			eqsink___system_3546((&(*colonenv_).prettyCmds1), T104_);
			execCmdsInParallel__extccomp_1298((*colonenv_).conf2, cmds, prettyCb);
			if (NIM_UNLIKELY(*nimErr_)) goto LA44_;
			{
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	eqcopy___system_3543((&colontmpD_), linkFiles);
	...
	}
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqdestroy___system_3540((&colontmpD__8));
		eqdestroy___stdZassertions_13((&colontmpD__4));
		eqdestroy___stdZassertions_13((&colontmpD__3));
		eqdestroy___stdZassertions_13((&colontmpD__2));
		eqdestroy___stdZenvvars_85((&collectResult_2));
		eqdestroy___extccomp_2037((&bcache));
		eqdestroy___system_3540((&collectResult));
		eqdestroy___system_3540((&linkFiles));
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___extccomp_3265)(tyObject_Env_extccompdotnim_runJsonBuildInstructions___VGgYLDtRkrYcGQHO6dF5ag* dest__8D8MluX8O49cTuccFKY7yiw) {
	eqdestroy___system_3540((&(*dest__8D8MluX8O49cTuccFKY7yiw).prettyCmds1));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
			...
			*nimErr_ = NIM_FALSE;
			...
			e = getCurrentException();
			{
				...
				if (!T14_) goto LA15_;
				{
					...
					T21_.len = 0; T21_.p = NIM_NIL;
					T22_[0] = (*e).message;
					colontmpD__5 = getStackTrace__system_3633(e);
					T22_[1] = colontmpD__5;
...
appendString((&T21_), colontmpD__6);
			...
			LA15_: ;
			{
				...
				colontmpD__9.len = 0; colontmpD__9.p = NIM_NIL;
				T25_[0] = (*e).message;
				colontmpD__8 = getStackTrace__system_3633(e);
				T25_[1] = colontmpD__8;
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
				colontmpD__9 = T26_;
				quit__system_6996(colontmpD__9, ((NI)1));
				eqdestroy___stdZassertions_13((&colontmpD__9));
				eqdestroy___stdZassertions_13((&colontmpD__8));
			}
			LA12_: ;
