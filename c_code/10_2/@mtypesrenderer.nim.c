...
static N_INLINE(void, X5BX5Deq___system_7103)(NimStringV2* s__TAH9bB6Tl6ff56HRNZWVq6A, NI i__wRoo1scg3cVkNpqdGoxAHw, NIM_CHAR x__KTXLvEXmzFJji1pt74VsUw);
...
appendString((&result), colontmpD__5);
			...
			X5BX5Deq___system_7103((&result), ((NI)1), 41);
			if (NIM_UNLIKELY(*nimErr_)) goto LA53_;
			{
				LA53_:;
			}
...
appendString((&result), colontmpD__8);
		...
		X5BX5Deq___system_7103((&result), ((NI)1), 93);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
