...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, toLit__vm_13221)(tyEnum_PathComponent__x9aIl9aBWoeZzD6AxCnUUcPQ a);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, toLit__vm_13233)(NimStringV2 a);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, toLit__vm_13365)(NI a);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, toLit__vmconv_47)(NI64 a);
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, toLit__vmconv_67)(NI a);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, toLit__vm_13977)(tyTuple__UV3llMMYFckfui8YMBuUZA* a);
static const struct {
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	result = newIntNode__ast_4791(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)6), ((NI64) (a)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	result = newStrNode__ast_4881(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)20), a);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD_ = toLit__vm_13221(a.Field0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(result, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__2 = toLit__vm_13233(a.Field1);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	result = newTree__ast_3975(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)160), T1_, 0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD_ = toLit__vm_13233(a.Field0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(result, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__2 = toLit__vm_13365(a.Field1);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(result, colontmpD__2);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___ast_3454(&colontmpD__2);
		...
		ai = NIM_NIL;
		{
			...
			i_2 = ((NI)0);
			{
				while (1) {
					...
					i = i_2;
					eqcopy___ast_3457(&ai, (*a)._kind_6.sons.p->data[i]);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__2 = getIdent__idents_166((*c).cache, TM__UzBNg46CnNFODB6BJYbNuA_3);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__3 = lookupInRecord__astalgo_85(obj, colontmpD__2);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__4 = newSymNode__ast_4787(colontmpD__3, info);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(reti, colontmpD__4);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__5 = toLit__vmconv_47(a.seconds);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__6 = getIdent__idents_166((*c).cache, TM__UzBNg46CnNFODB6BJYbNuA_5);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__7 = lookupInRecord__astalgo_85(obj, colontmpD__6);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__8 = newSymNode__ast_4787(colontmpD__7, info);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(reti_2, colontmpD__8);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__9 = toLit__vmconv_67(a.nanosecond);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
