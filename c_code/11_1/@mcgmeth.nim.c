...
N_LIB_PRIVATE N_NIMCALL(tyEnum_MethodResult__mzqZ5KFgBLGzkX1JWKxmRw, sameMethodBucket__cgmeth_89)(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* a, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* b, NIM_BOOL multiMethods);
...
N_LIB_PRIVATE N_NIMCALL(void, attachDispatcher__cgmeth_192)(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* dispatcher);
...
N_LIB_PRIVATE N_NIMCALL(void, fixupDispatcher__cgmeth_244)(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* meth, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* disp, tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*, createDispatcher__cgmeth_210)(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s, tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyObject_IdGeneratorcolonObjectType___C1k2TcDRT9cU4DEatQIT09ag* idgen);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*, getDispatcher__cgmeth_42)(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s);
N_LIB_PRIVATE N_NIMCALL(void, failedAssertImpl__stdZassertions_224)(NimStringV2 msg);
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, genConv__cgmeth_13)(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* d, NIM_BOOL downcast, tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, relevantCol__cgmeth_333)(tySequence__UfuHwINLHlFJGRcvFZqKQQ methods, NI col);
N_LIB_PRIVATE N_NIMCALL(void, incl__pureZcollectionsZintsets_202)(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* s, NI key);
N_LIB_PRIVATE N_NIMCALL(void, sortBucket__cgmeth_381)(tySequence__UfuHwINLHlFJGRcvFZqKQQ* a, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* relevantCols);
N_LIB_PRIVATE N_NIMCALL(NI, cmpSignatures__cgmeth_353)(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* a, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* b, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* relevantCols);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, contains__astalgo_3655)(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* s, NI key);
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*, genDispatcher__cgmeth_396)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tySequence__UfuHwINLHlFJGRcvFZqKQQ methods, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* relevantCols);
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		NI T8_;
		T7_ = (NI)0;
		T7_ = len__ast_5071((*a).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T8_ = (NI)0;
		T8_ = len__ast_5071((*b).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA9_: ;
	{
		...
		i_2 = ((NI)1);
		{
			while (1) {
				...
				bb = NIM_NIL;
				i = i_2;
				eqcopy___ast_3546(&aa, (*(*a).typ).sons.p->data[i]);
				if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
				eqcopy___ast_3546(&bb, (*(*b).typ).sons.p->data[i]);
				if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
				{
					while (1) {
				...
				} LA15: ;
				{
					...
					T30_ = 0;
					T31_ = (NIM_BOOL)0;
					T31_ = sameType__types_1991((*(*a).typ).sons.p->data[i], (*(*b).typ).sons.p->data[i], T30_);
					if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
					if (!T31_) goto LA32_;
					{
						NIM_BOOL T36_;
				...
				LA32_: ;
				{
					...
					LA51_: ;
					{
						...
						if (!(T59_)) goto LA60_;
						T59_ = !(((((*a).flags | (*b).flags) &((NU64)1<<((NU)((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)2)))&63U)))!=0));
						LA60_: ;
						if (!T59_) goto LA61_;
	...
	}
	{
		if (!(result == ((tyEnum_MethodResult__mzqZ5KFgBLGzkX1JWKxmRw)2))) goto LA69_;
		{
			...
			T73_ = 0;
			T74_ = (NIM_BOOL)0;
			T74_ = sameTypeOrNil__types_2022((*(*a).typ).sons.p->data[((NI)0)], (*(*b).typ).sons.p->data[((NI)0)], T73_);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!!(T74_)) goto LA75_;
			{
				NIM_BOOL T79_;
				T79_ = (NIM_BOOL)0;
				T79_ = !(((*(*b).typ).sons.p->data[((NI)0)] == ((tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*) NIM_NIL)));
				if (!(T79_)) goto LA80_;
				T79_ = ((*(*(*b).typ).sons.p->data[((NI)0)]).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)6));
				LA80_: ;
				if (!T79_) goto LA81_;
				eqcopy___ast_3546(&(*(*b).typ).sons.p->data[((NI)0)], (*(*a).typ).sons.p->data[((NI)0)]);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			}
			goto LA77_;
			LA81_: ;
...
{nimErr_ = nimErrorFlag();
	{
		NI T3_;
		T3_ = (NI)0;
		T3_ = len__ast_3325((*s).ast);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!(((NI)8) < T3_)) goto LA4_;
		eqcopy___ast_3457(&(*(*s).ast)._kind_6.sons.p->data[((NI)8)], dispatcher);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA1_;
	LA4_: ;
	{
		setLen__ast_3741((&(*(*s).ast)._kind_6.sons), ((NI)9));
		{
			tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* T11_;
			if (!((*(*s).ast)._kind_6.sons.p->data[((NI)7)] == ((tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*) NIM_NIL))) goto LA9_;
			T11_ = NIM_NIL;
			T11_ = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)1), (*s).info);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			eqsink___ast_3460(&(*(*s).ast)._kind_6.sons.p->data[((NI)7)], T11_);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA9_: ;
		eqcopy___ast_3457(&(*(*s).ast)._kind_6.sons.p->data[((NI)8)], dispatcher);
...
{nimErr_ = nimErrorFlag();
	{
		...
		T4_ = (NIM_BOOL)0;
		T5_ = (NI)0;
		T5_ = len__ast_3325((*disp).ast);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T4_ = (((NI)7) < T5_);
		if (!(T4_)) goto LA6_;
		T7_ = (NI)0;
		T7_ = len__ast_3325((*meth).ast);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T4_ = (((NI)7) < T7_);
		LA6_: ;
		T3_ = T4_;
		if (!(T3_)) goto LA8_;
		T3_ = ((*(*(*disp).ast)._kind_6.sons.p->data[((NI)7)]).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)1));
		LA8_: ;
		if (!T3_) goto LA9_;
		T11_ = NIM_NIL;
		T11_ = copyTree__ast_5856((*(*meth).ast)._kind_6.sons.p->data[((NI)7)]);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqsink___ast_3460(&(*(*disp).ast)._kind_6.sons.p->data[((NI)7)], T11_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA9_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	copyTypeProps__modulegraphs_8372(g, ((NI) ((*idgen).module)), (*disp).typ, old);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
	...
	LA7_: ;
	T9_ = NIM_NIL;
	T9_ = copyTree__ast_5856((*s).ast);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqsink___ast_3460(&(*disp).ast, T9_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T10_ = NIM_NIL;
	T10_ = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)1), (*s).info);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	{
		if (!!(((*(*s).typ).sons.p->data[((NI)0)] == ((tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*) NIM_NIL)))) goto LA13_;
		{
			NI T17_;
			...
			T20_ = nextSymId__ast_3268(idgen);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			T21_ = NIM_NIL;
			T21_ = copySym__ast_5140((*(*(*s).ast)._kind_6.sons.p->data[((NI)7)])._kind_4.sym, T20_);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		...
		LA18_: ;
		{
			...
			colontmpD__3 = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)1), (*s).info);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	attachDispatcher__cgmeth_192(s, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = NIM_NIL;
	{
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				disp = NIM_NIL;
				i = i_2;
				eqcopy___ast_4063(&disp, (*g).methods.p->data[i].Field1);
				if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
				T7_ = (tyEnum_MethodResult__mzqZ5KFgBLGzkX1JWKxmRw)0;
				T7_ = sameMethodBucket__cgmeth_89(disp, s, (((*(*g).config).globalOptions &((NU64)1<<((NU)((((tyEnum_TGlobalOption__9bU4j0PZjdMiF7DRotXVQZw)44)))&63U)))!=0));
				if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
				switch (T7_) {
				case ((tyEnum_MethodResult__mzqZ5KFgBLGzkX1JWKxmRw)2):
				{
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
					add__renderer_74((&(*g).methods.p->data[i].Field0), colontmpD__2);
					attachDispatcher__cgmeth_192(s, (*(*disp).ast)._kind_6.sons.p->data[((NI)8)]);
					if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
					fixupDispatcher__cgmeth_244(s, disp, (*g).config);
					if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
					checkMethodEffects__sempass50_4997(g, disp, s);
					if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
					{
						NIM_BOOL T11_;
						T11_ = (NIM_BOOL)0;
						T11_ = ((1048580 & (*s).flags) == 1048576);
						if (!(T11_)) goto LA12_;
						T11_ = !(((*g).methods.p->data[i].Field0.p->data[((NI)0)] == s));
						LA12_: ;
						if (!T11_) goto LA13_;
						liMessage__msgs_1172((*g).config, (*s).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__iRY49cFF15N9aiVVO5nXtoDQ_4, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__iRY49cFF15N9aiVVO5nXtoDQ_5, NIM_FALSE);
						if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
					}
					LA13_: ;
					eqdestroy___ast_4060(&disp);
				...
				{
					{
						...
						eqcopy___ast_4063(&witness, (*g).methods.p->data[i].Field0.p->data[((NI)0)]);
						if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
					}
					LA19_: ;
				}
	...
	T24_ = NIM_NIL;
	T24_ = createDispatcher__cgmeth_210(s, g, idgen);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T23_.Field1 = T24_;
	add__cgmeth_305((&(*g).methods), T23_);
	{
		...
		colontmpD__3 = dollar___msgs_675((*g).config, (*witness).info);
		if (NIM_UNLIKELY(*nimErr_)) goto LA29_;
		T30_ = rawNewString((*(*s).name).s.len + colontmpD__3.len + 68);
appendString((&T30_), TM__iRY49cFF15N9aiVVO5nXtoDQ_10);
appendString((&T30_), (*(*s).name).s);
appendString((&T30_), TM__iRY49cFF15N9aiVVO5nXtoDQ_12);
appendString((&T30_), colontmpD__3);
		colontmpD__4 = T30_;
		liMessage__msgs_1172((*g).config, (*s).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__4, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__iRY49cFF15N9aiVVO5nXtoDQ_13, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA29_;
		{
			LA29_:;
		}
	...
	LA27_: ;
	{
		if (!!((((*s).flags &((NU64)1<<((NU)((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)20)))&63U)))!=0))) goto LA34_;
		liMessage__msgs_1172((*g).config, (*s).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)37), TM__iRY49cFF15N9aiVVO5nXtoDQ_14, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__iRY49cFF15N9aiVVO5nXtoDQ_15, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	goto LA25_;
	LA34_: ;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!(((NI)8) < T3_)) goto LA4_;
		eqcopy___ast_4063(&result, (*(*(*s).ast)._kind_6.sons.p->data[((NI)8)])._kind_4.sym);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
...
{nimErr_ = nimErrorFlag();
	...
	dest = NIM_NIL;
	source = NIM_NIL;
	dest = skipTypes__ast_4803(d, TM__iRY49cFF15N9aiVVO5nXtoDQ_18);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	source = skipTypes__ast_4803((*n).typ, TM__iRY49cFF15N9aiVVO5nXtoDQ_18);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NIM_BOOL T4_;
		NI diff;
		...
		LA10_: ;
		{
			...
			result = newNodeIT__ast_3970(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)67), (*n).info, d);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			add__ast_6233(result, n);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			{
				if (!downcast) goto LA17_;
				internalErrorImpl__msgs_1510(conf, (*n).info, TM__iRY49cFF15N9aiVVO5nXtoDQ_20, TM__iRY49cFF15N9aiVVO5nXtoDQ_21);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			}
			LA17_: ;
		}
		...
		LA13_: ;
		{
			...
			result = newNodeIT__ast_3970(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)66), (*n).info, d);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			add__ast_6233(result, n);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			{
				if (!!(downcast)) goto LA24_;
				internalErrorImpl__msgs_1510(conf, (*n).info, TM__iRY49cFF15N9aiVVO5nXtoDQ_23, TM__iRY49cFF15N9aiVVO5nXtoDQ_24);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			}
			LA24_: ;
		}
...
{nimErr_ = nimErrorFlag();
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		{
			...
			i_2 = ((NI)1);
			{
				while (1) {
					...
					i = i_2;
					T9_ = NIM_NIL;
					T9_ = genConv__cgmeth_13((*result)._kind_6.sons.p->data[i], (*(*disp).typ).sons.p->data[i], NIM_TRUE, conf);
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	LA4_: ;
	{
		...
		colontmpD_ = dollar___renderer_2511((*result)._kind_6.sons.p->data[((NI)0)]);
...
appendString((&T12_), TM__iRY49cFF15N9aiVVO5nXtoDQ_28);
		colontmpD__2 = T12_;
		liMessage__msgs_1172(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__iRY49cFF15N9aiVVO5nXtoDQ_29, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
		{
			LA11_:;
		}
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	t = NIM_NIL;
	t = skipTypes__ast_4803((*(*methods.p->data[((NI)0)]).typ).sons.p->data[col], TM__iRY49cFF15N9aiVVO5nXtoDQ_30);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		if (!((*t).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)17))) goto LA4_;
		{
			...
			res = ((NI)1);
			{
				while (1) {
					...
					t2 = NIM_NIL;
					i = res;
					t2 = skipTypes__ast_4803((*(*methods.p->data[i]).typ).sons.p->data[col], TM__iRY49cFF15N9aiVVO5nXtoDQ_30);
		...
		i = ((NI)1);
		{
			while (1) {
				...
				col = i;
				{
					...
					NI d;
					T6_ = (NIM_BOOL)0;
					T6_ = contains__astalgo_3655(relevantCols, col);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					if (!T6_) goto LA7_;
					aa = NIM_NIL;
					bb = NIM_NIL;
					aa = skipTypes__ast_4803((*(*a).typ).sons.p->data[col], TM__iRY49cFF15N9aiVVO5nXtoDQ_30);
					if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
					bb = skipTypes__ast_4803((*(*b).typ).sons.p->data[col], TM__iRY49cFF15N9aiVVO5nXtoDQ_30);
					if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
			...
			h = (NI)(h / ((NI)3));
			{
				...
				i_2 = h;
				{
					while (1) {
						...
						v = NIM_NIL;
						i = i_2;
						eqcopy___ast_4063(&v, (*a).p->data[i]);
						...
						j = i;
						{
							while (1) {
								NI T16_;
								T16_ = (NI)0;
								T16_ = cmpSignatures__cgmeth_353((*a).p->data[(NI)(j - h)], v, relevantCols);
								if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
								if (!(((NI)0) <= T16_)) goto LA15								;
								eqcopy___ast_4063(&(*a).p->data[j], (*a).p->data[(NI)(j - h)]);
								if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
								j = (NI)(j - h);
								{
									if (!(j < h)) goto LA19_;
						...
						eqsink___ast_4066(&(*a).p->data[j], v);
						if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
						v = 0;
						i_2 += ((NI)1);
						{
...
{nimErr_ = nimErrorFlag();
	...
	iss = NIM_NIL;
	boolType = NIM_NIL;
	eqcopy___ast_4063(&base, (*(*(*methods.p->data[((NI)0)]).ast)._kind_6.sons.p->data[((NI)8)])._kind_4.sym);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	ands = getSysMagic__magicsys_29(g, unknownLineInfo__lineinfos_338, TM__iRY49cFF15N9aiVVO5nXtoDQ_32, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)109));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	iss = getSysMagic__magicsys_29(g, unknownLineInfo__lineinfos_338, TM__iRY49cFF15N9aiVVO5nXtoDQ_34, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)15));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	boolType = getSysType__magicsys_60(g, unknownLineInfo__lineinfos_338, ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NI col;
		NI i;
		...
		i = ((NI)1);
		{
			while (1) {
				...
				col = i;
				{
					...
					T7_ = (NIM_BOOL)0;
					T7_ = contains__astalgo_3655(relevantCols, col);
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
					if (!T7_) goto LA8_;
					param = NIM_NIL;
					colontmpD_ = NIM_NIL;
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
					{
						...
						colontmpD__2 = getCompilerProc__magicsys_146(g, TM__iRY49cFF15N9aiVVO5nXtoDQ_37);
	...
	}
	{
		...
		res = ((NI)0);
		{
			while (1) {
				...
				ret = NIM_NIL;
				meth = res;
				eqcopy___ast_4063(&curr, methods.p->data[meth]);
					...
					i_2 = ((NI)1);
					{
						while (1) {
							...
							col_2 = i_2;
							{
								...
								T31_ = (NIM_BOOL)0;
								T31_ = contains__astalgo_3655(relevantCols, col_2);
								if (NIM_UNLIKELY(*nimErr_)) goto LA25_;
								if (!T31_) goto LA32_;
								isn = NIM_NIL;
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA25_;
				{
					...
					i_3 = ((NI)1);
					{
						while (1) {
							...
							colontmpD__12 = genConv__cgmeth_13(colontmpD__11, (*(*curr).typ).sons.p->data[col_3], NIM_FALSE, (*g).config);
							if (NIM_UNLIKELY(*nimErr_)) goto LA42_;
		...
		i = ((NI)0);
		{
			while (1) {
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
				{
					...
					col = (NI)0;
					colontmp__2 = (NI)0;
					colontmp__2 = len__ast_5071((*(*g).methods.p->data[bucket].Field0.p->data[((NI)0)]).typ);
					if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
					i_2 = ((NI)1);
					{
						while (1) {
							...
							col = i_2;
							{
								NIM_BOOL T11_;
								T11_ = (NIM_BOOL)0;
								T11_ = relevantCol__cgmeth_333((*g).methods.p->data[bucket].Field0, col);
								if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
								if (!T11_) goto LA12_;
							...
							LA12_: ;
							{
								if (!!((((*(*g).config).globalOptions &((NU64)1<<((NU)((((tyEnum_TGlobalOption__9bU4j0PZjdMiF7DRotXVQZw)44)))&63U)))!=0))) goto LA16_;
								goto LA6;
							}
							LA16_: ;
							i_2 += ((NI)1);
				...
				sortBucket__cgmeth_381((&(*g).methods.p->data[bucket].Field0), (&relevantCols));
				if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
				colontmpD_ = genDispatcher__cgmeth_396(g, (*g).methods.p->data[bucket].Field0, (&relevantCols));
				if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
