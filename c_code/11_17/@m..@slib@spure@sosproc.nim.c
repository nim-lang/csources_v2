...
typedef N_CLOSURE_PTR(void, TM__HZdw8BhppcTQo8DIK46LSg_46) (NI idx);
typedef N_CLOSURE_PTR(void, TM__HZdw8BhppcTQo8DIK46LSg_48) (NI idx, tyObject_ProcessObj__2rGNQnv9bU4hanI2g3svReg* p);
...
N_LIB_PRIVATE N_NIMCALL(void, startProcessFail__pureZosproc_808)(tyObject_StartProcessData__xgRnKnLIYRtnOkshMKhc9cA* data);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_FileStreamObj__9bEVSsOIpkY9cf5lCtaS39bPQ*, createStream__pureZosproc_961)(int* handle, tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg fileMode);
...
{nimErr_ = nimErrorFlag();
	{
		...
		(void)(T5_);
		{
			...
			startProcessFail__pureZosproc_808(data);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA9_: ;
		T11_ = (int)0;
	...
	(void)(T43_);
	{
		...
		exe = findExe__pureZos_100((*data).sysCommand, NIM_TRUE, ExeExts__pureZos_99, 1);
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		T5_ = NIM_NIL;
		T5_ = createStream__pureZosproc_961((&(*p).inHandle), ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		T5_ = NIM_NIL;
		T5_ = createStream__pureZosproc_961((&(*p).outHandle), ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)0));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	{
		...
		LA23_: ;
		{
			...
			T30_ = (NI)0;
			T30_ = percentpercent___system_850(timeout, ((NI)1000));
		...
		LA36_: ;
		{
			while (1) {
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA32_;
				{
					...
					{
						int status_2;
						if (!(sinfo.si_pid == (*p).id)) goto LA47_;
						status_2 = ((int)1);
						{
							pid_t T51_;
							NI32 T54_;
...
goto LA32_;
	...
	LA6_: ;
	T131_ = (int)0;
	T131_ = exitStatusLikeShell__pureZos_144((*p).exitStatus);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = ((NI) (T131_));
	}BeforeRet_: ;
	return result;
	...
	result = (NI)0;
	{
		...
		m = ((n <= cmdsLen_0) ? n : cmdsLen_0);
		{
			while (1) {
				...
				if (!(i < m)) goto LA7				;
				{
					if (!!((beforeRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_37.ClP_0 && beforeRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_37.ClE_0))) goto LA10_;
				...
				LA10_: ;
				T13_ = NIM_NIL;
				T13_ = nospstartProcess(cmds[i], TM__HZdw8BhppcTQo8DIK46LSg_39, T12_, 0, ((tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg*) NIM_NIL), (options | 4));
				if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
			...
			while (1) {
				if (!(((NI)0) < ecount)) goto LA15				;
				{
					...
					LA17_: ;
					{
						...
						{
							if (!!((afterRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_42.ClP_0 && afterRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_42.ClE_0))) goto LA62_;
						...
						if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
						{
							...
							{
								if (!!((beforeRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_37.ClP_0 && beforeRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_37.ClE_0))) goto LA70_;
								beforeRunEvent.ClE_0? beforeRunEvent.ClP_0(i, beforeRunEvent.ClE_0):((TM__HZdw8BhppcTQo8DIK46LSg_44)(beforeRunEvent.ClP_0))(i);
								if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
							}
							LA70_: ;
							T73_ = NIM_NIL;
							T73_ = nospstartProcess(cmds[i], TM__HZdw8BhppcTQo8DIK46LSg_45, T72_, 0, ((tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg*) NIM_NIL), (options | 4));
							if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
	...
	{
		{
			...
			res_4 = ((NI)0);
			{
				while (1) {
					...
					i_2 = res_4;
					{
						if (!!((beforeRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_37.ClP_0 && beforeRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_37.ClE_0))) goto LA84_;
						beforeRunEvent.ClE_0? beforeRunEvent.ClP_0(i_2, beforeRunEvent.ClE_0):((TM__HZdw8BhppcTQo8DIK46LSg_46)(beforeRunEvent.ClP_0))(i_2);
						if (NIM_UNLIKELY(*nimErr_)) goto LA81_;
					}
					LA84_: ;
					p = nospstartProcess(cmds[i_2], TM__HZdw8BhppcTQo8DIK46LSg_47, T86_, 0, ((tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg*) NIM_NIL), (options | 4));
					if (NIM_UNLIKELY(*nimErr_)) goto LA81_;
					T87_ = (NI)0;
					...
					{
						if (!!((afterRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_42.ClP_0 && afterRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_42.ClE_0))) goto LA90_;
						afterRunEvent.ClE_0? afterRunEvent.ClP_0(i_2, p, afterRunEvent.ClE_0):((TM__HZdw8BhppcTQo8DIK46LSg_48)(afterRunEvent.ClP_0))(i_2, p);
						if (NIM_UNLIKELY(*nimErr_)) goto LA81_;
					}
					LA90_: ;
					nospclose(p);
