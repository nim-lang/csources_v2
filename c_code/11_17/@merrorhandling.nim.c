...
{nimErr_ = nimErrorFlag();
	...
	wrongNode = NIM_NIL;
	eqcopy___ast_3457(&wrongNode, (*n__bZII00OMmd1TKrE4jJsvog)._kind_6.sons.p->data[((NI)0)]);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	switch (((tyEnum_ErrorKind__yJ5zZNcpFhIDTHa5QOoXew) ((*(*n__bZII00OMmd1TKrE4jJsvog)._kind_6.sons.p->data[((NI)1)])._kind_1.intVal))) {
	...
	{
		eqcopy___stdZassertions_16((&result), (*(*n__bZII00OMmd1TKrE4jJsvog)._kind_6.sons.p->data[((NI)2)])._kind_3.strVal);
	}
	break;
	...
	case ((tyEnum_ErrorKind__yJ5zZNcpFhIDTHa5QOoXew)4):
	{
		...
		eqcopy___ast_4063(&a, (*(*n__bZII00OMmd1TKrE4jJsvog)._kind_6.sons.p->data[((NI)2)])._kind_4.sym);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		eqcopy___ast_4063(&b, (*(*n__bZII00OMmd1TKrE4jJsvog)._kind_6.sons.p->data[((NI)3)])._kind_4.sym);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
...
appendString((&args), TM__PAgkFH59bCpZS6kyA7bT09ag_13);
		colontmpD_ = getProcHeader__types_223(config__ahA0KKt45yY3GMoa9a9bX6WA, a, ((tyEnum_TPreferedDesc__bf5goTo3KJxvaEQ7KVg4rQ)0), NIM_TRUE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		T20_[0] = colontmpD_;
		colontmpD__2 = getProcHeader__types_223(config__ahA0KKt45yY3GMoa9a9bX6WA, b, ((tyEnum_TPreferedDesc__bf5goTo3KJxvaEQ7KVg4rQ)0), NIM_TRUE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		T20_[1] = colontmpD__2;
		T20_[2] = args;
