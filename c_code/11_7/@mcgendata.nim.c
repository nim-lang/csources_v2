...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__00qz3spGXcNRS1xOaHfTZw).nimtvDeclared.head, ((NI)4));
	}
	LA19_: ;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___system_3516((&(*dest__qtq2ru8hgzvTt8Zo59cPl6w_2).finallySafePoints));
...
{nimErr_ = nimErrorFlag();
	...
	eqdestroy___cgendata_818((&(*dest__qtq2ru8hgzvTt8Zo59cPl6w).forwTypeCache.data));
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__qtq2ru8hgzvTt8Zo59cPl6w).declaredThings.head, ((NI)4));
	}
	LA16_: ;
	eqdestroy___pureZcollectionsZintsets_56((&(*dest__qtq2ru8hgzvTt8Zo59cPl6w).declaredThings.data));
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__qtq2ru8hgzvTt8Zo59cPl6w).declaredProtos.head, ((NI)4));
	}
	LA21_: ;
	eqdestroy___pureZcollectionsZintsets_56((&(*dest__qtq2ru8hgzvTt8Zo59cPl6w).declaredProtos.data));
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__qtq2ru8hgzvTt8Zo59cPl6w).alive.head, ((NI)4));
	}
	LA26_: ;
	eqdestroy___pureZcollectionsZintsets_56((&(*dest__qtq2ru8hgzvTt8Zo59cPl6w).alive.data));
	eqdestroy___system_3516((&(*dest__qtq2ru8hgzvTt8Zo59cPl6w).headerFiles));
	...
	eqdestroy___cgendata_818((&(*dest__qtq2ru8hgzvTt8Zo59cPl6w).typeInfoMarkerV2.data));
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__qtq2ru8hgzvTt8Zo59cPl6w).initProc, ((NI)4));
	}
	LA31_: ;
	{
		NIM_BOOL T35_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__qtq2ru8hgzvTt8Zo59cPl6w).preInitProc, ((NI)4));
	}
	LA36_: ;
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___system_3522((&(*result).finallySafePoints), T9_);
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__qtq2ru8hgzvTt8Zo59cPl6w_2), ((NI)4));
	}
	LA4_: ;
	}BeforeRet_: ;
}
