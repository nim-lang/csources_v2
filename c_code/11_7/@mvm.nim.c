...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___pureZosproc_1681)(tyTuple__XOVT24GHXwqiEj5GCsEGCA* dest);
...
static N_INLINE(NIM_BOOL, eqeq___system_7509)(NCSTRING x, NCSTRING y);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vm_14638)(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___vm_14647)(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw* dest, void* env);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vm_14662)(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw** dest);
...
static N_INLINE(NF, abs__system_4685)(NF x);
...
N_LIB_PRIVATE N_NIMCALL(tySequence__sM4lkSb7zS6F7OVMvW9cffQ, querySettingSeqImpl__vm_13271)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, NI64 switch_0) {
	...
	{
		eqcopy___system_3519((&result), (*conf).commandArgs);
	}
	break;
