...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vm_14638)(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw* dest__YbuwxgBbMPmnyoUys6f2Vg);
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___vm_14647)(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw* dest__6eNh5sAAKq2nxNkqmJypcA, void* env__qu9aTBl9bQUlbkdXYqEnrwHA);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vm_14662)(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw** dest__YbuwxgBbMPmnyoUys6f2Vg_2);
...
N_LIB_PRIVATE TNimTypeV2 NTIv2__MQ1AlqG1N9bgo6MqEx9b4njw_ = {.destructor = (void*)eqdestroy___vm_14638, .size = sizeof(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw), .align = (NI16) NIM_ALIGNOF(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw), .depth = 1, .display = TM__sQJeTKtOMm7ArbnaG0SDbQ_291, .traceImpl = (void*)eqtrace___vm_14647, .flags = 0};
static N_INLINE(void, nimSetMem__systemZmemory_7)(void* a__tZiCJHYy5dYyAh9cxwrrVhQ, int v__iM7JOvZxArJIvbhGyRZG6Q, NI size__ntsFNLS0mpvnjQFrZT7DCw) {
	void* T1_;
	T1_ = (void*)0;
				...
				while (1) {
					{
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							T75_.Field0 = k;
							T75_.Field1 = f;
							colontmpD_ = toLit__vm_13211(T75_);
							if (NIM_UNLIKELY(*nimErr_)) goto LA28_;
	...
	savedPC = ((NI)-1);
	{
		while (1) {
			...
			case ((tyEnum_TOpcode__g8HRIfzFsQsDBgE9cOvGknQ)0):
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				eqdestroy___vm_14662(&colonenv_);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				goto BeforeRet_;
			}
			break;
...
appendString((&T1405_), colontmpD__155);
			...
			case ((tyEnum_TOpcode__g8HRIfzFsQsDBgE9cOvGknQ)149):
			{
				...
				T1709_ = (NI)0;
				{
					...
					T1712_ = (NIM_BOOL)0;
					T1713_ = (NIM_BOOL)0;
					T1713_ = eqeq___system_7509(aStrVal, ((NCSTRING) NIM_NIL));
					T1712_ = !(T1713_);
					if (!(T1712_)) goto LA1714_;
					T1715_ = (NIM_BOOL)0;
					T1715_ = eqeq___system_7509(bStrVal, ((NCSTRING) NIM_NIL));
					T1712_ = !(T1715_);
					LA1714_: ;
