...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___pureZosproc_1681)(tyTuple__XOVT24GHXwqiEj5GCsEGCA* dest__qKc2jknF30aTLZ7Tc9cVb4A);
...
static N_INLINE(NIM_BOOL, eqeq___system_7509)(NCSTRING x__Z3lojyrZeeORXB9aFmHlS7w, NCSTRING y__SlnicWIZiUaUC9cl2PfooTA);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vm_14653)(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw* dest__YbuwxgBbMPmnyoUys6f2Vg);
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___vm_14662)(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw* dest__6eNh5sAAKq2nxNkqmJypcA, void* env__qu9aTBl9bQUlbkdXYqEnrwHA);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vm_14677)(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw** dest__YbuwxgBbMPmnyoUys6f2Vg_2);
...
static N_INLINE(NF, abs__system_4685)(NF x__clSHt9b19czdoEneCA58XG9ag);
...
N_LIB_PRIVATE TNimTypeV2 NTIv2__MQ1AlqG1N9bgo6MqEx9b4njw_ = {.destructor = (void*)eqdestroy___vm_14653, .size = sizeof(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw), .align = (NI16) NIM_ALIGNOF(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw), .depth = 1, .display = TM__sQJeTKtOMm7ArbnaG0SDbQ_291, .traceImpl = (void*)eqtrace___vm_14662, .flags = 0};
static N_INLINE(void, nimSetMem__systemZmemory_7)(void* a__tZiCJHYy5dYyAh9cxwrrVhQ, int v__iM7JOvZxArJIvbhGyRZG6Q, NI size__ntsFNLS0mpvnjQFrZT7DCw) {
	void* T1_;
	T1_ = (void*)0;
				...
				while (1) {
					{
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							T75_.Field0 = k;
							T75_.Field1 = f;
							colontmpD_ = toLit__vm_13226(T75_);
							if (NIM_UNLIKELY(*nimErr_)) goto LA28_;
...
N_LIB_PRIVATE N_NIMCALL(tySequence__sM4lkSb7zS6F7OVMvW9cffQ, querySettingSeqImpl__vm_13286)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf__R1D2RukbmapWZ9aDLb232qQ, NI64 switch__dkUh9aTTuLOgUZ072GHSo9bA) {
	...
	{
		eqcopy___system_3519((&result), (*conf__R1D2RukbmapWZ9aDLb232qQ).commandArgs);
	}
	break;
...
{nimErr_ = nimErrorFlag();
	...
	}
	{
		...
		eqdestroy___stdZassertions_13((&colontmpD__2));
		eqdestroy___stdZassertions_13((&colontmpD_));
		eqdestroy___pureZosproc_1681((&ret));
		*nimErr_ = oldNimErrFin1_;
	}
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__3 = execCmdEx__pureZosproc_1640(colontmpD__2, options, ((tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg*) NIM_NIL), TM__sQJeTKtOMm7ArbnaG0SDbQ_245, TM__sQJeTKtOMm7ArbnaG0SDbQ_246);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	}
	{
		...
		eqdestroy___ast_3454(&colontmpD__4);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqdestroy___pureZosproc_1681((&colontmpD__3));
		eqdestroy___stdZassertions_13((&colontmpD__2));
		eqdestroy___ast_3454(&colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		*nimErr_ = oldNimErrFin1_;
		...
		nimZeroMem((void*)(&xX60gensym2162_), sizeof(tyTuple__UV3llMMYFckfui8YMBuUZA));
		{
			...
			i = ((NI)0);
			{
				while (1) {
					...
					T5_ = (NIM_BOOL)0;
					T5_ = eqeq___system_7509(environ[i], ((NCSTRING) NIM_NIL));
					if (!!(T5_)) goto LA4					;
					...
					T6_.Field0 = substr__system_7543(kv, ((NI)0), (NI)(p - ((NI)1)));
					T6_.Field1 = substr__system_7555(kv, (NI)(p + ((NI)1)));
	...
	savedPC = ((NI)-1);
	{
		while (1) {
			...
			case ((tyEnum_TOpcode__g8HRIfzFsQsDBgE9cOvGknQ)0):
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				eqdestroy___vm_14677(&colonenv_);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				goto BeforeRet_;
			}
			break;
...
appendString((&T567_), colontmpD__86);
			...
			case ((tyEnum_TOpcode__g8HRIfzFsQsDBgE9cOvGknQ)41):
			{
				...
				LA659_: ;
				{
					...
					NF T663_;
					T662_ = (NF)0;
					T662_ = abs__system_4685(((NF)(resAsFloat) - (NF)(floatProd)));
					T663_ = (NF)0;
					T663_ = abs__system_4685(floatProd);
...
appendString((&T1405_), colontmpD__155);
			...
			case ((tyEnum_TOpcode__g8HRIfzFsQsDBgE9cOvGknQ)140):
			{
				...
				LA1602_: ;
				{
					...
					{
						eqdestroy___pureZosproc_1681((&colontmpD__157));
					}
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				}
				LA1598_: ;
			...
			case ((tyEnum_TOpcode__g8HRIfzFsQsDBgE9cOvGknQ)152):
			{
				...
				T1713_ = (NI)0;
				{
					...
					T1716_ = (NIM_BOOL)0;
					T1717_ = (NIM_BOOL)0;
					T1717_ = eqeq___system_7509(aStrVal, ((NCSTRING) NIM_NIL));
					T1716_ = !(T1717_);
					if (!(T1716_)) goto LA1718_;
					T1719_ = (NIM_BOOL)0;
					T1719_ = eqeq___system_7509(bStrVal, ((NCSTRING) NIM_NIL));
					T1716_ = !(T1719_);
					LA1718_: ;
