...
N_LIB_PRIVATE N_NIMCALL(int, WTERMSIG__posixZposix_861)(int s);
N_LIB_PRIVATE N_NIMCALL(int, WEXITSTATUS__posixZposix_851)(int s);
...
static N_INLINE(struct timespec, st_mtim__posixZposix_900)(struct stat s);
...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmpD__2 = substr__system_7562(path, ((NI)2));
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__2 = (int)0;
	{
		...
		int T6_;
		T3_ = (NIM_BOOL)0;
		T3_ = WIFSIGNALED__posixZposix_867(status);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		T6_ = (int)0;
		T6_ = WTERMSIG__posixZposix_861(status);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA4_: ;
	{
		colontmpD__2 = WEXITSTATUS__posixZposix_851(status);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		result = colontmpD__2;
	}
	LA1_: ;
