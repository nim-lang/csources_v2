...
typedef N_CLOSURE_PTR(void, TM__HZdw8BhppcTQo8DIK46LSg_53) (NI idx);
typedef N_CLOSURE_PTR(void, TM__HZdw8BhppcTQo8DIK46LSg_55) (NI idx);
typedef N_CLOSURE_PTR(void, TM__HZdw8BhppcTQo8DIK46LSg_57) (NI idx, tyObject_ProcessObj__2rGNQnv9bU4hanI2g3svReg* p);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_FileStreamObj__9bEVSsOIpkY9cf5lCtaS39bPQ*, createStream__pureZosproc_931)(int* handle, tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg fileMode);
...
N_LIB_PRIVATE N_NIMCALL(pid_t, si_pid__posixZposix_220)(siginfo_t info);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, WIFEXITED__posixZposix_858)(int s);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, WIFSIGNALED__posixZposix_867)(int s);
...
{nimErr_ = nimErrorFlag();
	...
	(void)(T109_);
	{
		...
		raiseOSError__stdZoserrors_82(res, (*data).sysCommand);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA112_: ;
	result = pid;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		T5_ = NIM_NIL;
		T5_ = createStream__pureZosproc_931((&(*p).inHandle), ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		T5_ = NIM_NIL;
		T5_ = createStream__pureZosproc_931((&(*p).outHandle), ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)0));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			...
			while (1) {
				...
				res = sigtimedwait((&nmask), (&sinfo), (&tmspec));
				{
					if (!(res == ((int)20))) goto LA43_;
					{
						...
						if (NIM_UNLIKELY(*nimErr_)) goto LA32_;
						if (!(T47_ == (*p).id)) goto LA48_;
						status_2 = ((int)1);
						{
							pid_t T52_;
							NI32 T55_;
							T52_ = (pid_t)0;
							T52_ = waitpid((*p).id, (&status_2), ((int)0));
...
goto LA32_;
	...
	LA6_: ;
	T132_ = (int)0;
	T132_ = exitStatusLikeShell__pureZos_144((*p).exitStatus);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = ((NI) (T132_));
	}BeforeRet_: ;
	return result;
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	T1_ = (NIM_BOOL)0;
	T1_ = WIFEXITED__posixZposix_858(status);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	if (T1_) goto LA2_;
	T1_ = WIFSIGNALED__posixZposix_867(status);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	LA2_: ;
	result = T1_;
	}BeforeRet_: ;
	...
	result = (NI)0;
	{
		...
		m = ((n <= cmdsLen_0) ? n : cmdsLen_0);
		{
			while (1) {
				...
				if (!(i < m)) goto LA7				;
				{
					if (!!((beforeRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_46.ClP_0 && beforeRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_46.ClE_0))) goto LA10_;
				...
				LA10_: ;
				T13_ = NIM_NIL;
				T13_ = nospstartProcess(cmds[i], TM__HZdw8BhppcTQo8DIK46LSg_48, T12_, 0, ((tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg*) NIM_NIL), (options | 4));
				if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
			...
			while (1) {
				if (!(((NI)0) < ecount)) goto LA15				;
				{
					...
					LA17_: ;
					{
						...
						{
							if (!!((afterRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_51.ClP_0 && afterRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_51.ClE_0))) goto LA62_;
							afterRunEvent.ClE_0? afterRunEvent.ClP_0(idxs.p->data[rexit], q.p->data[rexit], afterRunEvent.ClE_0):((TM__HZdw8BhppcTQo8DIK46LSg_52)(afterRunEvent.ClP_0))(idxs.p->data[rexit], q.p->data[rexit]);
							if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
						}
						LA62_: ;
						...
						if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
						{
							...
							{
								if (!!((beforeRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_46.ClP_0 && beforeRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_46.ClE_0))) goto LA70_;
								beforeRunEvent.ClE_0? beforeRunEvent.ClP_0(i, beforeRunEvent.ClE_0):((TM__HZdw8BhppcTQo8DIK46LSg_53)(beforeRunEvent.ClP_0))(i);
								if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
							}
							LA70_: ;
							T73_ = NIM_NIL;
							T73_ = nospstartProcess(cmds[i], TM__HZdw8BhppcTQo8DIK46LSg_54, T72_, 0, ((tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg*) NIM_NIL), (options | 4));
							if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
	...
	{
		{
			...
			res_4 = ((NI)0);
			{
				while (1) {
					...
					i_2 = res_4;
					{
						if (!!((beforeRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_46.ClP_0 && beforeRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_46.ClE_0))) goto LA84_;
						beforeRunEvent.ClE_0? beforeRunEvent.ClP_0(i_2, beforeRunEvent.ClE_0):((TM__HZdw8BhppcTQo8DIK46LSg_55)(beforeRunEvent.ClP_0))(i_2);
						if (NIM_UNLIKELY(*nimErr_)) goto LA81_;
					}
					LA84_: ;
					p = nospstartProcess(cmds[i_2], TM__HZdw8BhppcTQo8DIK46LSg_56, T86_, 0, ((tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg*) NIM_NIL), (options | 4));
					if (NIM_UNLIKELY(*nimErr_)) goto LA81_;
					T87_ = (NI)0;
					...
					{
						if (!!((afterRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_51.ClP_0 && afterRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_51.ClE_0))) goto LA90_;
						afterRunEvent.ClE_0? afterRunEvent.ClP_0(i_2, p, afterRunEvent.ClE_0):((TM__HZdw8BhppcTQo8DIK46LSg_57)(afterRunEvent.ClP_0))(i_2, p);
						if (NIM_UNLIKELY(*nimErr_)) goto LA81_;
					}
					LA90_: ;
					nospclose(p);
