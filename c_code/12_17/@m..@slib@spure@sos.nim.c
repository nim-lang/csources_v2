...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getApplHeuristic__pureZos_178)(void);
...
static N_INLINE(struct timespec, st_mtim__posixZposix_900)(struct stat s__5n02p7GNFaoMLTvk1QYXJA);
...
} TM__yu6cxgKBBXbNsTkT9cyMd4g_15 = { 4 | NIM_STRLIT_FLAG, "PATH" };
static const NimStringV2 TM__yu6cxgKBBXbNsTkT9cyMd4g_16 = {4, (NimStrPayload*)&TM__yu6cxgKBBXbNsTkT9cyMd4g_15};
static const NimStringV2 TM__yu6cxgKBBXbNsTkT9cyMd4g_17 = {0, (NimStrPayload*)&TM__yu6cxgKBBXbNsTkT9cyMd4g_11};
static const NimStringV2 TM__yu6cxgKBBXbNsTkT9cyMd4g_18 = {4, (NimStrPayload*)&TM__yu6cxgKBBXbNsTkT9cyMd4g_15};
...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmpD__2 = substr__system_7562(path__BQBSuWQbOavg6W9czhl9bOhg, ((NI)2));
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		if (!T3_) goto LA5_;
		{
			...
			colontmp_ = getEnv__stdZenvvars_15(TM__yu6cxgKBBXbNsTkT9cyMd4g_16, TM__yu6cxgKBBXbNsTkT9cyMd4g_17);
			...
			splitsX60gensym36_ = ((NI)-1);
			{
				while (1) {
					...
					T20_ = substr__system_7550(colontmp_, firstX60gensym36_, (NI)(lastX60gensym36_ - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		T5_ = getApplHeuristic__pureZos_178();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA9_: ;
	path = getEnv__stdZenvvars_15(TM__yu6cxgKBBXbNsTkT9cyMd4g_18, TM__yu6cxgKBBXbNsTkT9cyMd4g_19);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		splitsX60gensym33_ = ((NI)-1);
		{
			while (1) {
				...
				T32_ = substr__system_7550(path, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__2 = (int)0;
	{
		...
		int T6_;
		T3_ = (NIM_BOOL)0;
		T3_ = WIFSIGNALED__posixZposix_867(status__pU2PN2pUmXRydZtMya4HGg);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		T6_ = (int)0;
		T6_ = WTERMSIG__posixZposix_861(status__pU2PN2pUmXRydZtMya4HGg);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA4_: ;
	{
		colontmpD__2 = WEXITSTATUS__posixZposix_851(status__pU2PN2pUmXRydZtMya4HGg);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		result = colontmpD__2;
	}
	LA1_: ;
...
static N_INLINE(struct timespec, st_mtim__posixZposix_900)(struct stat s__5n02p7GNFaoMLTvk1QYXJA) {
	...
	result.tv_sec = s__5n02p7GNFaoMLTvk1QYXJA.st_mtime;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q, nosgetLastModificationTime)(NimStringV2 file__b9cmnPwFs9b9cRCDVCbwqVFwA) {
	tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q result;
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	T7_ = st_mtim__posixZposix_900(res);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = toTime__pureZos_27(T7_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
