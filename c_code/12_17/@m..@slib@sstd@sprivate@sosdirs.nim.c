...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, rawCreateDir__stdZprivateZosdirs_434)(NimStringV2 dir__TJIqyCkiIz7wPVhjQJN5hQ);
...
N_LIB_PRIVATE N_NIMCALL(void, rawRemoveDir__stdZprivateZosdirs_427)(NimStringV2 dir__yxIFfmjbIvgNIMUWQErk4Q);
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	T1_ = (NIM_BOOL)0;
	T1_ = rawCreateDir__stdZprivateZosdirs_434(dir__vZZVUaIn1vd7TfHmCblGxA);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = !(T1_);
	{
		if (!result) goto LA4_;
				...
				res = ((NI)0);
				{
					while (1) {
						...
						i = res;
						{
							...
							T50_ = substr__system_7550(dir__Cqk1agZLZB9cLp7ktxH9bW9aw, ((NI)0), i);
...
{nimErr_ = nimErrorFlag();
	...
	rawRemoveDir__stdZprivateZosdirs_427(dir__6OuenANQUO79aeNGnwJzDPw);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, noscopyDir)(NimStringV2 source__pIkWRYTYKbeN9aA4wO3xdew, NimStringV2 dest__BsnoPLoqhXzS6yJKz1lKaw) {
