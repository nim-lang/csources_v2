...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___system_3511((&(*dest__qtq2ru8hgzvTt8Zo59cPl6w_2).finallySafePoints));
...
{nimErr_ = nimErrorFlag();
	...
	eqdestroy___system_3511((&(*dest__qtq2ru8hgzvTt8Zo59cPl6w).headerFiles));
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___system_3517((&(*result).finallySafePoints), T9_);
