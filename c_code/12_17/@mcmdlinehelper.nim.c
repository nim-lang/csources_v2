...
{nimErr_ = nimErrorFlag();
	...
	LA10_: ;
	{
		...
		setFromProjectName__options_4992(conf, (*conf).projectName);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA1_;
	LA13_: ;
	{
		...
		T17_ = canonicalizePath__options_4988(conf, colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA16_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		liMessage__msgs_1172(conf, unknownLineInfo__lineinfos_338, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__RxBoA2E3fxrN6r2tToaOvg_21, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__RxBoA2E3fxrN6r2tToaOvg_22), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA36_: ;
