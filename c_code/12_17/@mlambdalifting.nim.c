...
{nimErr_ = nimErrorFlag();
	...
	xX60gensym51_ = owner;
	result = getOrDefault__lambdalifting_690((*c).ownerToType, (NI)((NI)((NU64)(((NI) ((*xX60gensym51_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym51_).Sup.itemId.item))));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		X5BX5Deq___lambdalifting_1046((&(*c).ownerToType), (NI)((NI)((NU64)(((NI) ((*xX60gensym56_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym56_).Sup.itemId.item))), colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		{
			LA5_:;
		}
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
		{
			...
			LA20_: ;
			{
				...
				T24_ = (NIM_BOOL)0;
				T24_ = containsOrIncl__astalgo_402((&(*c).processed), (NI)((NI)((NU64)(((NI) ((*xX60gensym85_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym85_).Sup.itemId.item))));
				if (NIM_UNLIKELY(*nimErr_)) goto LA15_;
				if (!!(T24_)) goto LA25_;
				body = NIM_NIL;
			...
			if (!(ow == owner)) goto LA34_;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
				{
					...
					xX60gensym87_ = NIM_NIL;
					{
						...
						T50_ = (NIM_BOOL)0;
						T50_ = containsOrIncl__astalgo_402((&(*c).capturedVars), (NI)((NI)((NU64)(((NI) ((*xX60gensym87_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym87_).Sup.itemId.item))));
						if (NIM_UNLIKELY(*nimErr_)) goto LA47_;
						if (!!(T50_)) goto LA51_;
						obj = NIM_NIL;
						colontmpD_ = NIM_NIL;
		...
		LA34_: ;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA75_;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA75_;
				T80_ = (NIM_BOOL)0;
				T80_ = containsOrIncl__astalgo_402((&(*c).capturedVars), (NI)((NI)((NU64)(((NI) ((*xX60gensym90_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym90_).Sup.itemId.item))));
				if (NIM_UNLIKELY(*nimErr_)) goto LA75_;
				T78_ = !(T80_);
				LA79_: ;
				if (!T78_) goto LA81_;
...
{nimErr_ = nimErrorFlag();
	...
	result = getOrDefault__lambdalifting_2653((*c).envVars, (NI)((NI)((NU64)(((NI) ((*xX60gensym111_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym111_).Sup.itemId.item))));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		envVarType = getOrDefault__lambdalifting_690((*d).ownerToType, (NI)((NI)((NU64)(((NI) ((*xX60gensym116_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym116_).Sup.itemId.item))));
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
		X5BX5Deq___lambdalifting_3113((&(*c).envVars), (NI)((NI)((NU64)(((NI) ((*xX60gensym119_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym119_).Sup.itemId.item))), colontmpD__3);
		if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
		{
			tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* v;
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
			X5BX5Deq___lambdalifting_3113((&(*c).unownedEnvVars), (NI)((NI)((NU64)(((NI) ((*xX60gensym133_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym133_).Sup.itemId.item))), T26_);
			if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
	...
	LA6_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA17_;
			{
				...
				T23_ = X5BX5D___lambdalifting_4342((&(*c).unownedEnvVars), (NI)((NI)((NU64)(((NI) ((*xX60gensym139_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym139_).Sup.itemId.item))));
				if (NIM_UNLIKELY(*nimErr_)) goto LA22_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
		{
			...
			T33_ = X5BX5D___lambdalifting_4342((&(*c).unownedEnvVars), (NI)((NI)((NU64)(((NI) ((*xX60gensym144_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym144_).Sup.itemId.item))));
			if (NIM_UNLIKELY(*nimErr_)) goto LA32_;
			...
			i_2 = ((NI)1);
			{
				while (1) {
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
					{
						...
						if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
						T42_ = (NIM_BOOL)0;
						T42_ = contains__astalgo_3655((&(*d).capturedVars), (NI)((NI)((NU64)(((NI) ((*xX60gensym150_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym150_).Sup.itemId.item))));
						if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
						if (!T42_) goto LA43_;
						fieldAccess = NIM_NIL;
						colontmpD__6 = NIM_NIL;
...
{nimErr_ = nimErrorFlag();
	{
		...
		unowned = X5BX5D___lambdalifting_4735((*c).unownedEnvVars, (NI)((NI)((NU64)(((NI) ((*xX60gensym159_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym159_).Sup.itemId.item))));
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		colontmpD__4 = NIM_NIL;
		{
			colontmpD__4 = skipConv__types_3839(env);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		T7_ = X5BX5D___lambdalifting_4342((&(*c).unownedEnvVars), (NI)((NI)((NU64)(((NI) ((*xX60gensym168_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym168_).Sup.itemId.item))));
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
		{
			...
			xX60gensym176_ = NIM_NIL;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
				T11_ = (NIM_BOOL)0;
				T11_ = containsOrIncl__astalgo_402((&(*c).processed), (NI)((NI)((NU64)(((NI) ((*xX60gensym176_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym176_).Sup.itemId.item))));
				if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
				if (!!(T11_)) goto LA12_;
				body = NIM_NIL;
				...
				{
					xX60gensym177_ = s;
					colontmpD_ = getOrDefault__lambdalifting_2653((*c).envVars, (NI)((NI)((NU64)(((NI) ((*xX60gensym177_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym177_).Sup.itemId.item))));
					if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
		...
		LA6_: ;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
			T36_ = (NIM_BOOL)0;
			T36_ = contains__astalgo_3655((&(*d).capturedVars), (NI)((NI)((NU64)(((NI) ((*xX60gensym179_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym179_).Sup.itemId.item))));
			if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
			if (!T36_) goto LA37_;
			{
	...
	{
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA62_;
			x = skipConv__types_3839((*n)._kind_6.sons.p->data[((NI)0)]);
			if (NIM_UNLIKELY(*nimErr_)) goto LA62_;
			{
