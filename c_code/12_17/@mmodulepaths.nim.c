...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)22):
	{
		...
		T5_ = pathSubs__options_5078(conf__1wFx1nxHoIUnNPJUblx19bA, (*n__XjmJ9ck5w8XBdsBZTsuVprw)._kind_3.strVal, colontmpD__2.Field0);
		if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
		result = T5_;
		{
			LA3_:;
...
appendString((&T12_), TM__GNhKqIyvrFjtq6zf1JX7qg_14);
appendString((&T12_), (*n__XjmJ9ck5w8XBdsBZTsuVprw)._kind_3.strVal);
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)29):
	{
		...
		T22_ = nsuReplaceStr(colontmpD__4, TM__GNhKqIyvrFjtq6zf1JX7qg_18, TM__GNhKqIyvrFjtq6zf1JX7qg_20);
		if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
		colontmpD__5 = T22_;
...
appendString((&result), modname);
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)30):
	{
		...
		T28_ = nsuReplaceStr(colontmpD__6, TM__GNhKqIyvrFjtq6zf1JX7qg_21, TM__GNhKqIyvrFjtq6zf1JX7qg_22);
		if (NIM_UNLIKELY(*nimErr_)) goto LA26_;
		result = T28_;
		{
			LA26_:;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)45):
	{
		...
		T34_ = nsuReplaceStr(colontmpD__7, TM__GNhKqIyvrFjtq6zf1JX7qg_27, TM__GNhKqIyvrFjtq6zf1JX7qg_28);
		if (NIM_UNLIKELY(*nimErr_)) goto LA32_;
		result = T34_;
		{
			LA32_:;
	...
	default:
	{
		...
		T43_ = nsuFormatSingleElem(TM__GNhKqIyvrFjtq6zf1JX7qg_30, T42_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA40_;
		colontmpD__8 = T43_;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = multiReplace__pureZstrutils_1861(path__MuoLQankwienicH1dlQ0DA, TM__GNhKqIyvrFjtq6zf1JX7qg_36, 5);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
