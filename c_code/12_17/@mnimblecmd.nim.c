...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T5_ = substr__system_7562(p__Kqv4F0bZMLYwGQlsJ69ai6w, (NI)(checksumSeparatorIndex + ((NI)1)));
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T16_ = substr__system_7550(p__Kqv4F0bZMLYwGQlsJ69ai6w, (NI)(versionSeparatorIndex + ((NI)1)), (NI)(checksumSeparatorIndex - ((NI)1)));
	...
	LA14_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			T22_ = substr__system_7550(p__Kqv4F0bZMLYwGQlsJ69ai6w, (NI)(versionSeparatorIndex + ((NI)1)), (NI)(checksumSeparatorIndex - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	...
	sVer2.len = 0; sVer2.p = NIM_NIL;
	{
		...
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		{
			...
			eqdestroy___system_3511((&sVer2));
			eqdestroy___system_3511((&sVer));
			goto BeforeRet_;
			{
				LA15_:;
			}
...
{nimErr_ = nimErrorFlag();
	...
	eqcopy___stdZassertions_16((&path), p__gEHj5AaO76UJiiaK51ke3Q);
	{
		...
		resX60gensym0_ = (NI)0;
		fX60gensym0_.gl_offs = ((int)0);
		fX60gensym0_.gl_pathc = ((int)0);
		...
		resX60gensym0_ = ((NI) (T3_));
		{
			if (!(resX60gensym0_ == ((NI)0))) goto LA7_;
			{
				...
				iX60gensym0_ = (NI32)0;
				colontmp__2 = (NI32)0;
				colontmp__2 = (NI32)(fX60gensym0_.gl_pathc - ((NI32)1));
				res = ((NI32)0);
				{
					while (1) {
	...
	resultX60gensym40_.len = 0; resultX60gensym40_.p = NIM_NIL;
	{
		...
		{
			eqdestroy___stdZassertions_13((&colontmpD__2));
			eqdestroy___system_3511((&nimbleLinkLines));
		}
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA21_: ;
	...
	{
		eqdestroy___system_3511((&resultX60gensym40_));
		eqdestroy___system_3511((&nimbleLinks));
