...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___options_3149)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* dest__jjXLqLv8SE2IeCJIJka0WQ) {
	...
	eqdestroy___system_3511((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).commandArgs));
	eqdestroy___stdZassertions_13((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).commandLine));
	eqdestroy___system_3511((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).extraCmds));
	eqdestroy___system_3511((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).implicitImports));
	eqdestroy___system_3511((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).implicitIncludes));
	...
	eqdestroy___system_3511((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).cLinkedLibs));
	eqdestroy___system_3511((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).externalToLink));
	eqdestroy___stdZassertions_13((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).linkOptionsCmd));
	eqdestroy___system_3511((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).compileOptionsCmd));
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		if (!(T3_)) goto LA4_;
		T5_ = (NIM_CHAR)0;
		T5_ = X5BX5D___system_7039(path__rDlV0AybldUJC43fBJPMOQ, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T3_ = ((NU8)(T5_) == (NU8)(47));
		LA4_: ;
		if (!T3_) goto LA6_;
		result = substr__system_7550(path__rDlV0AybldUJC43fBJPMOQ, ((NI)0), (NI)(path__rDlV0AybldUJC43fBJPMOQ.len - ((NI)2)));
	}
	goto LA1_;
	LA6_: ;
	{
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		if (!T4_) goto LA5_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		colontmpD_ = substr__system_7562(m, ((NI)4));
	...
	{
		{
			...
			stripped = substr__system_7562(m, ((NI)4));
			{
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		result = substr__system_7550(s__1ceeuiYOZLpou68rQyB42A, start, (NI)(ende - ((NI)1)));
	}
	goto LA7_;
	LA9_: ;
	{
		result = substr__system_7562(s__1ceeuiYOZLpou68rQyB42A, start);
	}
	LA7_: ;
	}BeforeRet_: ;
	return result;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___modulegraphs_9583)(tyObject_SuggestcolonObjectType___fw9a9cWgWYzM4zKmnq3DGNfQ* dest__KkxjkIXl3Vr9aVDMQp9aBXBA) {
	eqdestroy___system_3511((&(*dest__KkxjkIXl3Vr9aVDMQp9aBXBA).qualifiedPath));
