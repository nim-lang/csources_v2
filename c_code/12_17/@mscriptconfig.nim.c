...
static N_INLINE(NimStringV2, getCurrentExceptionMsg__system_6869)(void);
...
static N_INLINE(void, setCurrentDir__stdZprivateZosdirs_471)(NimStringV2 newDir__9cJvNnUDpQyuE3XvzzjZXpw);
...
N_LIB_PRIVATE N_NIMCALL(void, moveDir__stdZprivateZosdirs_468)(NimStringV2 source__D77IWrk8kTTXv5bgij9cFJQ, NimStringV2 dest__KLDvRS3yUtqspPGxZ9bPjZw);
...
{nimErr_ = nimErrorFlag();
	...
	{
		eqdestroy___system_3511((&result));
...
{	result.len = 0; result.p = NIM_NIL;
	...
	{
		if (!(currException__system_3649 == ((Exception*) NIM_NIL))) goto LA4_;
		result = TM__qdmBYobaV9btoxwHZNavLQA_20;
	}
	goto LA2_;
	LA4_: ;
	{
		eqcopy___stdZassertions_16((&result), (*currException__system_3649).message);
	}
	LA2_: ;
	goto BeforeRet_;
	}BeforeRet_: ;
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T5_ = getCurrentExceptionMsg__system_6869();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T17_ = getCurrentExceptionMsg__system_6869();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T16_ = getCurrentExceptionMsg__system_6869();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T9_ = getCurrentExceptionMsg__system_6869();
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	colontmpD_ = T3_;
	setCurrentDir__stdZprivateZosdirs_471(colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	{
		LA2_:;
	}
...
{nimErr_ = nimErrorFlag();
	...
	LA6_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD__2 = T11_;
		moveDir__stdZprivateZosdirs_468(colontmpD_, colontmpD__2);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		{
			LA9_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			T11_.len = 0; T11_.p = NIM_NIL;
			T11_ = getCurrentExceptionMsg__system_6869();
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			T10_.len = 0; T10_.p = NIM_NIL;
			T10_ = getCurrentExceptionMsg__system_6869();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T14_ = getCurrentExceptionMsg__system_6869();
...
{nimErr_ = nimErrorFlag();
	...
	nossplitFile(scriptName__GqaBmJdaPtxt3B2FXDJeBA, (&colontmpD_));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
