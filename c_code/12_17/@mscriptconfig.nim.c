...
static N_INLINE(void, setCurrentDir__stdZprivateZosdirs_471)(NimStringV2 newDir);
...
N_LIB_PRIVATE N_NIMCALL(void, moveDir__stdZprivateZosdirs_468)(NimStringV2 source, NimStringV2 dest);
				...
				while (1) {
					{
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							y.len = 0; y.p = NIM_NIL;
							{
								...
								if (!((filter &((NU8)1<<((NU)((kind))&7U)))!=0)) goto LA78_;
