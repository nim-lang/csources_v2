...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vmdef_1293)(tyObject_TCtx__b6xwcD9cMKdlvd6DZIf4rHg* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vmdef_952)(tyObject_PProccolonObjectType___ZvYI1A9bklY7Sm9c9adwVzF9cQ* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vmdef_964)(tySequence__IKjIhq49bzOoAeTg2ER8PSA* dest);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___vmdef_961)(tyObject_PProccolonObjectType___ZvYI1A9bklY7Sm9c9adwVzF9cQ* dest, void* env);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___vmdef_681)(tySequence__dJt9ak0PHeYYhnT7tdKLoOQ* dest, void* env);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___vmdef_973)(tySequence__IKjIhq49bzOoAeTg2ER8PSA* dest, void* env);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vmdef_1330)(tySequence__ar9bL3ZUZg9bNA9cQy9c1FZhPA* dest);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___pureZosproc_403)(tySequence__qwqHTkRvwhrRyENtudHQ7g* dest);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_7055)(NI* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___vmdef_1302)(tyObject_TCtx__b6xwcD9cMKdlvd6DZIf4rHg* dest, void* env);
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___vmdef_1517)(tySequence__L8fp6QCa2lczU05QM7SC9cg* dest, void* env);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vmdef_964)(tySequence__IKjIhq49bzOoAeTg2ER8PSA* dest) {
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyTuple__7Rb7b2MEe6OPFlPq1Xul2Q));
}
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vmdef_952)(tyObject_PProccolonObjectType___ZvYI1A9bklY7Sm9c9adwVzF9cQ* dest) {
	eqdestroy___vmdef_672((&(*dest).blocks));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
	...
	LA4_: ;
	eqdestroy___vmdef_964((&(*dest).regInfo));
}
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___vmdef_973)(tySequence__IKjIhq49bzOoAeTg2ER8PSA* dest, void* env) {
}
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___vmdef_961)(tyObject_PProccolonObjectType___ZvYI1A9bklY7Sm9c9adwVzF9cQ* dest, void* env) {
	eqtrace___vmdef_681((&(*dest).blocks), env);
	eqtrace___vmdef_973((&(*dest).regInfo), env);
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vmdef_1330)(tySequence__ar9bL3ZUZg9bNA9cQy9c1FZhPA* dest) {
	NI colontmp_;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	...
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyObject_TFullReg__TAKBj64um9cIhYRFcPXkxSQ));
}
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vmdef_1318)(tyObject_TStackFrame__N30BaqTxdO9aOeBDi8omH3g* dest) {
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	eqdestroy___vmdef_1330((&(*dest).slots));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T8_;
		T8_ = (NIM_BOOL)0;
		T8_ = nimDecRefIsLast((*dest).next);
		if (!T8_) goto LA9_;
		eqdestroy___vmdef_1318((*dest).next);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest).next, ((NI)8));
	}
	LA9_: ;
	eqdestroy___pureZosproc_403((&(*dest).safePoints));
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vmdef_1508)(tySequence__L8fp6QCa2lczU05QM7SC9cg* dest) {
	NI colontmp_;
...
{nimErr_ = nimErrorFlag();
	...
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyTuple__5ax60W9cMsa4brP9b9aNP9cF9aw));
}
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vmdef_1293)(tyObject_TCtx__b6xwcD9cMKdlvd6DZIf4rHg* dest) {
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	eqdestroy___vmdef_387((&(*dest).code));
	eqdestroy___vmdef_529((&(*dest).debug));
	{
		NIM_BOOL T8_;
		T8_ = (NIM_BOOL)0;
		T8_ = nimDecRefIsLast((*dest).globals);
		if (!T8_) goto LA9_;
		eqdestroy___ast_3466((*dest).globals);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest).globals, ((NI)8));
	}
	LA9_: ;
	{
		NIM_BOOL T13_;
		T13_ = (NIM_BOOL)0;
		T13_ = nimDecRefIsLast((*dest).constants);
		if (!T13_) goto LA14_;
		eqdestroy___ast_3466((*dest).constants);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest).constants, ((NI)8));
	}
	LA14_: ;
	eqdestroy___ast_3490((&(*dest).types));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T18_;
		T18_ = (NIM_BOOL)0;
		T18_ = nimDecRefIsLast((*dest).currentExceptionA);
		if (!T18_) goto LA19_;
		eqdestroy___ast_3466((*dest).currentExceptionA);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA19_: ;
	{
		NIM_BOOL T23_;
		T23_ = (NIM_BOOL)0;
		T23_ = nimDecRefIsLast((*dest).currentExceptionB);
		if (!T23_) goto LA24_;
		eqdestroy___ast_3466((*dest).currentExceptionB);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA24_: ;
	{
		NIM_BOOL T28_;
		T28_ = (NIM_BOOL)0;
		T28_ = nimDecRefIsLastCyclicStatic((*dest).prc, (&NTIv2__ZvYI1A9bklY7Sm9c9adwVzF9cQ_));
		if (!T28_) goto LA29_;
		eqdestroy___vmdef_952((*dest).prc);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA29_: ;
	{
		NIM_BOOL T33_;
		T33_ = (NIM_BOOL)0;
		T33_ = nimDecRefIsLast((*dest).module);
		if (!T33_) goto LA34_;
	...
	LA34_: ;
	{
		NIM_BOOL T38_;
		T38_ = (NIM_BOOL)0;
		T38_ = nimDecRefIsLast((*dest).callsite);
		if (!T38_) goto LA39_;
		eqdestroy___ast_3466((*dest).callsite);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest).callsite, ((NI)8));
	}
	LA39_: ;
	eqdestroy___vmdef_1110((&(*dest).callbacks));
	eqdestroy___stdZassertions_13((&(*dest).errorFlag));
	{
		NIM_BOOL T43_;
		T43_ = (NIM_BOOL)0;
		T43_ = nimDecRefIsLastCyclicStatic((*dest).cache, (&NTIv2__4yiDOEx3Y9aOTV1fsziBtCQ_));
		if (!T43_) goto LA44_;
	...
	LA44_: ;
	{
		NIM_BOOL T48_;
		T48_ = (NIM_BOOL)0;
		T48_ = nimDecRefIsLast((*dest).config);
		if (!T48_) goto LA49_;
	...
	LA54_: ;
	{
		NIM_BOOL T58_;
		T58_ = (NIM_BOOL)0;
		T58_ = nimDecRefIsLast((*dest).profiler.tos);
		if (!T58_) goto LA59_;
		eqdestroy___vmdef_1318((*dest).profiler.tos);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest).profiler.tos, ((NI)8));
	}
	LA59_: ;
	{
		NIM_BOOL T63_;
		T63_ = (NIM_BOOL)0;
		T63_ = nimDecRefIsLast((*dest).templInstCounter);
		if (!T63_) goto LA64_;
		eqdestroy___system_7055((*dest).templInstCounter);
		nimRawDispose((*dest).templInstCounter, ((NI)8));
	}
	LA64_: ;
	eqdestroy___vmdef_1508((&(*dest).vmstateDiff));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___vmdef_1652((&(*dest).procToCodePos.data));
	}BeforeRet_: ;
}
static N_INLINE(void, nimCopyMem)(void* dest, void* source, NI size) {
	void* T1_;
...
{nimErr_ = nimErrorFlag();
	...
	eqtrace___vmdef_538((&(*dest).debug), env);
	eqtrace___ast_3499((&(*dest).types), env);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	nimTraceRef(&(*dest).prc, (&NTIv2__ZvYI1A9bklY7Sm9c9adwVzF9cQ_), env);
	eqtrace___vmdef_1119((&(*dest).callbacks), env);
	nimTraceRef(&(*dest).cache, (&NTIv2__4yiDOEx3Y9aOTV1fsziBtCQ_), env);
	eqtrace___vmdef_1517((&(*dest).vmstateDiff), env);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqtrace___vmdef_1661((&(*dest).procToCodePos.data), env);
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__2 = (*(*g).config).maxLoopIterationsVM;
	...
	colontmpD__4 = 0;
	eqcopy___idents_266(&colontmpD__4, cache, NIM_TRUE);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*T1_).cache = colontmpD__4;
	colontmpD__5 = 0;
	eqcopy___options_3378(&colontmpD__5, (*g).config);
	(*T1_).config = colontmpD__5;
	colontmpD__6 = 0;
	eqcopy___modulegraphs_11315(&colontmpD__6, g);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*T1_).graph = colontmpD__6;
	colontmpD__7 = 0;
	eqcopy___ast_3247(&colontmpD__7, idgen, NIM_TRUE);
...
N_LIB_PRIVATE N_NIMCALL(NI, registerCallback__vmdef_1848)(tyObject_TCtx__b6xwcD9cMKdlvd6DZIf4rHg* c, NimStringV2 name, tyProc__mrbYLH5hYlbDOLEIrzz3iw callback) {
	...
	nimZeroMem((void*)(&colontmpD__2), sizeof(tyProc__mrbYLH5hYlbDOLEIrzz3iw));
	eqcopy___vmdef_1879((&colontmpD__2), callback, NIM_TRUE);
	T2_.Field1.ClE_0 = colontmpD__2.ClE_0;
	T2_.Field1.ClP_0 = colontmpD__2.ClP_0;
	add__vmdef_1856((&(*c).callbacks), (&T2_));
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	{
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			nimZeroMem((void*)(&(*(*dest).node)), sizeof(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q));
	...
	case ((tyEnum_TRegisterKind__znlwDPhiNog3BeyUXiSk5w)4):
	{
		(*dest).regAddr = src.regAddr;
	}
	break;
	case ((tyEnum_TRegisterKind__znlwDPhiNog3BeyUXiSk5w)5):
	{
		(*dest).nodeAddr = src.nodeAddr;
	}
	break;
	}
	}BeforeRet_: ;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	eqcopy___ast_4063(&(*c).module, module);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = NIM_NIL;
	...
	eqsink___vmdef_1093(&(*c).prc, T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*c).loopIterations = (*(*c).config).maxLoopIterationsVM;
	eqcopy___ast_3247(&(*c).Sup.idgen, idgen, NIM_TRUE);
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLastCyclicStatic((*dest), (&NTIv2__ZvYI1A9bklY7Sm9c9adwVzF9cQ_));
		if (!T3_) goto LA4_;
		eqdestroy___vmdef_952((*dest));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest), ((NI)8));
	}
	LA4_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___vmdef_849)(tyObject_TBlock__zeg89baIGf9bHM5Pdk3RxArQ* dest, tyObject_TBlock__zeg89baIGf9bHM5Pdk3RxArQ src) {
	...
	if ((*dest).fixups.p != src.fixups.p) {	eqdestroy___vmdef_686((&(*dest).fixups));
	}
...
{nimErr_ = nimErrorFlag();
	...
	colontmp_ = (*dest);
	nimZeroMem((void*)(&(*dest)), sizeof(tyObject_TFullReg__TAKBj64um9cIhYRFcPXkxSQ));
	(*dest).kind = src.kind;
	switch ((*dest).kind) {
	case ((tyEnum_TRegisterKind__znlwDPhiNog3BeyUXiSk5w)0):
	{
	...
	case ((tyEnum_TRegisterKind__znlwDPhiNog3BeyUXiSk5w)1):
	{
		...
		LA7_: ;
		{
			NIM_BOOL T11_;
			T11_ = (NIM_BOOL)0;
			T11_ = nimDecRefIsLast((*dest).node);
			if (!T11_) goto LA12_;
			eqdestroy___ast_3466((*dest).node);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			nimRawDispose((*dest).node, ((NI)8));
...
{nimErr_ = nimErrorFlag();
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLast((*dest).currentException);
		if (!T3_) goto LA4_;
		eqdestroy___ast_3466((*dest).currentException);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest).currentException, ((NI)8));
	}
	LA4_: ;
	}BeforeRet_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___vm_14300)(NI** dest, NI* src) {
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLast((*dest));
...
{nimErr_ = nimErrorFlag();
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			{
				if (!src.p->data[colontmp_].Field1) goto LA16_;
			...
			LA16_: ;
			{
				NIM_BOOL T20_;
				T20_ = (NIM_BOOL)0;
				T20_ = nimDecRefIsLast((*dest).p->data[colontmp_].Field1);
				if (!T20_) goto LA21_;
				eqdestroy___ast_3466((*dest).p->data[colontmp_].Field1);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				nimRawDispose((*dest).p->data[colontmp_].Field1, ((NI)8));
