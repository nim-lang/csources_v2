...
N_LIB_PRIVATE N_NIMCALL(tyTuple__kN8up2W6YKc5YA9avn5mV5w, getQuoteSymbol__packagesZdocutilsZrst_9963)(tyObject_RstParser__A8gCtAm9bQ0VhhTs05KbxKQ* p, NI idx);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___packagesZdocutilsZrst_12920)(tyObject_Env_rstdotnim_parseEnumList___bzbl1IBh9cCqMF9aO9bQ9bvTqQ** dest);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___packagesZdocutilsZrst_12990)(tyObject_Env_rstdotnim_checkHeadingHierarchy___crlV1WNGeShngwIuNh2Hdg* dest);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___packagesZdocutilsZrst_12999)(tyObject_Env_rstdotnim_checkHeadingHierarchy___crlV1WNGeShngwIuNh2Hdg* dest, void* env);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___packagesZdocutilsZrst_13020)(tyObject_Env_rstdotnim_checkHeadingHierarchy___crlV1WNGeShngwIuNh2Hdg** dest);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___packagesZdocutilsZrst_13140)(tyObject_Env_rstdotnim_parseMarkdownTable___ra0ZIZkbpb9b9aPCpQXhXYSw* dest);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___types_1903)(tySequence__8Np6tlClE5az1CyqZdN19bQ* dest);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___packagesZdocutilsZrst_13149)(tyObject_Env_rstdotnim_parseMarkdownTable___ra0ZIZkbpb9b9aPCpQXhXYSw* dest, void* env);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___packagesZdocutilsZrst_13179)(tyObject_Env_rstdotnim_parseMarkdownTable___ra0ZIZkbpb9b9aPCpQXhXYSw** dest);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___packagesZdocutilsZrst_13276)(tyObject_Env_rstdotnim_orderFootnotes___dSbgko9cUbNv6KjiW415IXQ* dest);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___packagesZdocutilsZrst_13285)(tyObject_Env_rstdotnim_orderFootnotes___dSbgko9cUbNv6KjiW415IXQ* dest, void* env);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___packagesZdocutilsZrst_13303)(tyObject_Env_rstdotnim_orderFootnotes___dSbgko9cUbNv6KjiW415IXQ** dest);
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			{
				{
					...
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					nimRawDispose((*dest).p->data[colontmp_]._kind_1.target, ((NI)4));
				}
				LA8_: ;
			}
			break;
			case ((tyEnum_AnchorRule__g9b7A1W7y7TqDINcOHWBCuA)1):
			{
				...
				eqdestroy___stdZenvvars_151((&(*dest).p->data[colontmp_]._kind_2.langSym.parameters));
...
{nimErr_ = nimErrorFlag();
	...
	eqdestroy___system_3514((&(*dest).filenames.idxToFilename));
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___packagesZdocutilsZrst_2804)(tySequence__KaZEC9alGb0qEnwuLoUB4EQ* dest, void* env) {
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			case ((tyEnum_AnchorRule__g9b7A1W7y7TqDINcOHWBCuA)1):
			{
				eqtrace___stdZenvvars_160((&(*dest).p->data[colontmp_]._kind_2.langSym.parameters), env);
			}
			break;
			}
			colontmp_ += ((NI)1);
...
{nimErr_ = nimErrorFlag();
	...
	write__stdZsyncio_248(f, TM__6mNpeIAN05DnDNzb9b3611A_84);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, defaultMsgHandler__packagesZdocutilsZrst_734)(NimStringV2 filename, NI line, NI col, tyEnum_MsgKind__j4Az8tPCEtMOVV8Ta9bk9auQ msgkind, NimStringV2 arg) {
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___packagesZdocutilsZrst_12528)(tyObject_RstFileTable__1rYTAF4X28SkQlz9cTtPDzQ* dest, tyObject_RstFileTable__1rYTAF4X28SkQlz9cTtPDzQ src) {
	...
	eqcopy___system_3517((&(*dest).idxToFilename), src.idxToFilename);
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___packagesZdocutilsZrst_12525)(tyObject_RstFileTable__1rYTAF4X28SkQlz9cTtPDzQ* dest) {
	...
	eqdestroy___system_3514((&(*dest).idxToFilename));
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___packagesZdocutilsZrst_5263)(tySequence__h3lxIYk9bDFo9a6O25fEkVTQ* dest) {
	NI colontmp_;
	colontmp_ = ((NI)0);
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	eqdestroy___pureZosproc_406((&(*dest).indentStack));
...
{nimErr_ = nimErrorFlag();
	...
	T1_.p->data[0] = ((NI)0);
	eqsink___pureZosproc_412((&(*p).indentStack), T1_);
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_AnchorRule__g9b7A1W7y7TqDINcOHWBCuA)0):
	{
		(*dest)._kind_1.anchorType = 0;
		{
			...
			nimRawDispose((*dest)._kind_1.target, ((NI)4));
		}
		LA5_: ;
	}
	break;
	case ((tyEnum_AnchorRule__g9b7A1W7y7TqDINcOHWBCuA)1):
	{
		...
		eqdestroy___stdZenvvars_151((&(*dest)._kind_2.langSym.parameters));
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			case ((tyEnum_AnchorRule__g9b7A1W7y7TqDINcOHWBCuA)1):
			{
				...
				eqcopy___stdZenvvars_154((&(*dest).p->data[colontmp_]._kind_2.langSym.parameters), src.p->data[colontmp_]._kind_2.langSym.parameters);
			...
			case ((tyEnum_AnchorRule__g9b7A1W7y7TqDINcOHWBCuA)1):
			{
				...
				eqdestroy___stdZenvvars_151((&colontmp__2._kind_2.langSym.parameters));
...
N_LIB_PRIVATE N_NIMCALL(void, popInd__packagesZdocutilsZrst_3445)(tyObject_RstParser__A8gCtAm9bQ0VhhTs05KbxKQ* p) {
	{
		...
		setLen__pureZosproc_313((&(*p).indentStack), ((NI) ((NI)(T6_ - ((NI)1)))));
	}
	LA4_: ;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isMarkdownCodeBlock__packagesZdocutilsZrst_9098)(tyObject_RstParser__A8gCtAm9bQ0VhhTs05KbxKQ* p, NI idx) {
				...
				{
					{
						...
						nimZeroMem((void*)(&colontmp_), sizeof(tyTuple__kN8up2W6YKc5YA9avn5mV5w));
						colontmp_ = getQuoteSymbol__packagesZdocutilsZrst_9963((&(*p)), (NI)((*p).idx + ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	...
	colontmp_ = getQuoteSymbol__packagesZdocutilsZrst_9963((&(*p)), (*p).idx);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	(*p).idx += quoteTokens;
	{
		while (1) {
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA4_;
			{
				...
				nimZeroMem((void*)(&_), sizeof(tyTuple__kN8up2W6YKc5YA9avn5mV5w));
				_ = getQuoteSymbol__packagesZdocutilsZrst_9963((&(*p)), (NI)((*p).idx + ((NI)1)));
				if (NIM_UNLIKELY(*nimErr_)) goto LA4_;
...
{nimErr_ = nimErrorFlag();
	...
	T2_.len = 0; T2_.p = NIM_NIL;
	T2_ = currFilename__packagesZdocutilsZrst_2443((*p).s);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD_ = nossplitFile(T2_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = slash___stdZprivateZospaths50_90(colontmpD_.Field0, filename);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NIM_BOOL T5_;
		NimStringV2 T8_;
		...
		T8_ = (*(*p).s).findFile.ClE_0? (*(*p).s).findFile.ClP_0(filename, (*(*p).s).findFile.ClE_0):((TM__6mNpeIAN05DnDNzb9b3611A_343)((*(*p).s).findFile.ClP_0))(filename);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				...
				res = colontmp_;
				{
					while (1) {
						...
						i = res;
						{
							...
							LA25_: ;
							if (!T18_) goto LA28_;
							setLen__stdZprivateZwin95setenv_51((&(*parensStack)), ((NI) (i)));
							result = NIM_TRUE;
							goto LA12;
						}
						LA28_: ;
...
{nimErr_ = nimErrorFlag();
	eqdestroy___packagesZdocutilsZrst_3468((&(*dest).p1.tok));
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest).p1.s, ((NI)4));
	}
	LA4_: ;
	eqdestroy___pureZosproc_406((&(*dest).p1.indentStack));
...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	eqcopy___pureZosproc_409((&(*dest).indentStack), (*src).indentStack);
	(*dest).line = (*src).line;
	(*dest).col = (*src).col;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	eqdestroy___types_1903((&(*dest).row1));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
	...
	LA14_: ;
	eqdestroy___pureZosproc_406((&(*dest).q4.indentStack));
	eqdestroy___packagesZdocutilsZrst_5263((&(*dest).q4.curAnchors));
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___packagesZdocutilsZrst_13149)(tyObject_Env_rstdotnim_parseMarkdownTable___ra0ZIZkbpb9b9aPCpQXhXYSw* dest, void* env) {
	eqtrace___types_1912((&(*dest).row1), env);
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_AnchorRule__g9b7A1W7y7TqDINcOHWBCuA)1):
	{
		...
		eqcopy___stdZenvvars_154((&(*dest)._kind_2.langSym.parameters), (*src)._kind_2.langSym.parameters);
	...
	case ((tyEnum_AnchorRule__g9b7A1W7y7TqDINcOHWBCuA)1):
	{
		...
		eqdestroy___stdZenvvars_151((&colontmp_._kind_2.langSym.parameters));
...
(*dest).tooltip.len = (*src).tooltip.len; (*dest).tooltip.p = (*src).tooltip.p;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest).target, ((NI)4));
	}
	LA4_: ;
...
N_LIB_PRIVATE N_NIMCALL(NI, cmp__packagesZdocutilsZrst_11935)(tyObject_LinkDef__gm014e5aOYcvs0zK8vQ9cXg* x, tyObject_LinkDef__gm014e5aOYcvs0zK8vQ9cXg* y) {
	NI result;
	result = (NI)0;
	result = cmp__system_7227((*x).priority, (*y).priority);
	{
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_RstNodeKind__DNoJcMFu9cjq4EGXsLl82CQ)74):
	{
		...
		LA8_: ;
		{
			...
			key = addNodes__packagesZdocutilsZrst_70(n);
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			e = getEnv__stdZenvvars_14(key, TM__6mNpeIAN05DnDNzb9b3611A_685);
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			{
				tyObject_RstNode__22EYjMYlm9cWcheQxrewdHQ* T16_;
