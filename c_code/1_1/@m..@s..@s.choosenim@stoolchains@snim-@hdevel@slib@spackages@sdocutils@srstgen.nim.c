...
N_LIB_PRIVATE N_NIMCALL(tyTuple__UV3llMMYFckfui8YMBuUZA, buildLinesHtmlTable__packagesZdocutilsZrstgen_8859)(tyObject_RstGenerator__3jlDCj6GoMg9aZfxlJYSfkA* d, tyObject_CodeBlockParams__sfxlxgvTVIvKgcvY2mQViA* params, NimStringV2 code, NimStringV2 idStr);
...
static N_INLINE(NimStringV2, pop__stdZprivateZosdirs_351)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ* s);
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		while (1) {
			...
			case ((tyEnum_TokenClass__9anxN1z0YaJHlUGz4GuizCA)2):
			{
				NimStringV2 colontmpD_;
				colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
				colontmpD_ = substr__system_7573(code, g.start, (NI)((NI)(g.length + g.start) - ((NI)1)));
...
appendString((&(*result)), colontmpD_);
			...
			default:
			{
				...
				colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
				colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
				colontmpD__2 = substr__system_7573(code, g.start, (NI)((NI)(g.length + g.start) - ((NI)1)));
...
appendString((&entry), TM__vYBWrr780p7faFzauVMtPg_58);
	{
		...
		insert__system_7246((&(*d).theIndex), entry, ((NI)0));
	}
	goto LA14_;
	LA16_: ;
	{
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		T8_ = (NIM_BOOL)0;
		T9_ = (NIM_CHAR*)0;
		T9_ = X5BX5D___system_7101((&(*n)._kind_2.labelFmt), ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T8_ = ((NU8)((*T9_)) == (NU8)(41));
		if (T8_) goto LA10_;
		T11_ = (NIM_CHAR*)0;
		T11_ = X5BX5D___system_7101((&(*n)._kind_2.labelFmt), ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T8_ = ((NU8)((*T11_)) == (NU8)(46));
		LA10_: ;
		if (!T8_) goto LA12_;
		...
		T14_ = (NIM_CHAR*)0;
		T14_ = X5BX5D___system_7101((&(*n)._kind_2.labelFmt), ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T15_.len = 0; T15_.p = NIM_NIL;
...
appendString((&T28_), TM__vYBWrr780p7faFzauVMtPg_568);
			...
			LA19_: ;
			_ = buildLinesHtmlTable__packagesZdocutilsZrstgen_8859(d, (&params), (*m)._kind_1.text, T18_);
...
{nimErr_ = nimErrorFlag();
	{
		...
		writeFile__stdZsyncio_610(outfile, (*g).theIndex);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = multiReplace__pureZstrutils_1861(text, TM__vYBWrr780p7faFzauVMtPg_671, 3);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
		...
		checkDir = NIM_FALSE;
		{
			while (1) {
				...
				d = pop__stdZprivateZosdirs_351((&stack));
				{
					...
					colontmp_.len = 0; colontmp_.p = NIM_NIL;
					T11_.len = 0; T11_.p = NIM_NIL;
					T11_ = slash___stdZprivateZospaths50_90(dir, d);
					if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
								...
								k_2 = ((tyEnum_PathComponent__x9aIl9aBWoeZzD6AxCnUUcPQ)0);
								{
									...
									LA49_: ;
									{
										...
										LA58_: ;
										{
											...
											T61_ = slash___stdZprivateZospaths50_90(dir, rel);
											if (NIM_UNLIKELY(*nimErr_)) goto LA30_;
