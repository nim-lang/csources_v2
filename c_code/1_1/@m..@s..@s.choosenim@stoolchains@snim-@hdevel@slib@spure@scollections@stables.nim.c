...
N_LIB_PRIVATE N_NIMCALL(tyObject_OrderedTable__ZZvSdVkA2s2sIyifu4cpkg, initOrderedTable__pureZjson_390)(NI initialSize) {
...
{nimErr_ = nimErrorFlag();
	nimZeroMem((void*)(&result), sizeof(tyObject_CountTable__chlLjy9bvnFM9b9bSZfiIkyGg));
	result = initCountTable__cgendata_478(keysLen_0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NimStringV2* key;
		NI i;
