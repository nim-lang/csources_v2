...
{nimErr_ = nimErrorFlag();
	...
	if (!(T2_)) goto LA3_;
	T4_ = (NIM_CHAR)0;
	T4_ = X5BX5D___system_7062(tail, ((NI)1));
	...
	if (!(T8_)) goto LA9_;
	T10_ = (NIM_CHAR*)0;
	T10_ = X5BX5D___system_7101(result, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	} LA2: ;
	{
		...
		T20_ = substr__system_7573(path, ((NI)0), T13_);
		eqsink___stdZassertions_19((&result.Field0), T20_);
		T21_.len = 0; T21_.p = NIM_NIL;
		T21_ = substr__system_7585(path, (NI)(sepPos + ((NI)1)));
			...
			while (1) {
				...
				i = res;
				{
					...
					if (!T7_) goto LA9_;
					{
						...
						T22_ = substr__system_7573(path, ((NI)0), T15_);
					...
					LA13_: ;
					{
						...
						T27_ = substr__system_7573(path, namePos, (NI)(dotPos - ((NI)1)));
						eqsink___stdZassertions_19((&result.Field1), T27_);
						T28_.len = 0; T28_.p = NIM_NIL;
						T28_ = substr__system_7585(path, dotPos);
					...
					LA25_: ;
					{
						...
						T30_ = substr__system_7585(path, namePos);
...
appendString((&T5_), colontmpD_);
	...
	LA3_: ;
	{
		...
		colontmpD__2 = substr__system_7573(filename, ((NI)0), (NI)(extPos - ((NI)1)));
