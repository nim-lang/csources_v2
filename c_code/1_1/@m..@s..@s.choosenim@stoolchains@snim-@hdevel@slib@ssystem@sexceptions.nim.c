...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_7641)(tyObject_IOError__N09bhl56nRkUaUsonzshECg* dest);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_7650)(tyObject_IOError__N09bhl56nRkUaUsonzshECg* dest, void* env);
