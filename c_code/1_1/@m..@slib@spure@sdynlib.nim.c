...
N_LIB_PRIVATE N_NIMCALL(void*, loadLib__pureZdynlib_3)(NimStringV2 path__J3zn0XyE25q4VFW9bpyTaDQ, NIM_BOOL globalSymbols__iXkzfmMai9bM5Ipdx9aHAOqg) {
	...
	result = (void*)0;
	T1_ = (HMODULE)0;
	T1_ = LoadLibraryA(nimToCStringConv(path__J3zn0XyE25q4VFW9bpyTaDQ));
	result = ((void*) (T1_));
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void*, symAddr__pureZdynlib_49)(void* lib__PU4tfyC5TtjtHQXiFKD6Cg, NCSTRING name__hLkkuYAjvFntu9adXWyX2uw) {
	...
	result = (void*)0;
	T1_ = (FARPROC)0;
	T1_ = GetProcAddress(((HMODULE) (lib__PU4tfyC5TtjtHQXiFKD6Cg)), name__hLkkuYAjvFntu9adXWyX2uw);
	result = ((void*) (T1_));
	return result;
}
static N_INLINE(void, nimCopyMem)(void* dest__HMDJtGX4ficduS9cTUiey0w, void* source__xDZEU1SRcEBuZ8mtbKQBhQ, NI size__9b8g0WMA1h1RvMwHOMW7yFA) {
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		prefix = substr__system_7573(s__9bbA9c8EYk8sqmZnb3ssoXdg, ((NI)0), (NI)(le - ((NI)1)));
		suffix = substr__system_7585(s__9bbA9c8EYk8sqmZnb3ssoXdg, (NI)(ri + ((NI)1)));
		{
			NimStringV2 middle;
			...
			colontmp_ = substr__system_7573(s__9bbA9c8EYk8sqmZnb3ssoXdg, (NI)(le + ((NI)1)), (NI)(ri - ((NI)1)));
			...
			splitsX60gensym33_ = ((NI)-1);
			{
				while (1) {
					...
					T21_ = substr__system_7573(colontmp_, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI)1)));
