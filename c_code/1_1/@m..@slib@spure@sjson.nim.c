...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___pureZstreams_844)(tyObject_FileStreamObj__9bEVSsOIpkY9cf5lCtaS39bPQ** dest__0PMdyEYBvd5YCiye8xqdOw_3);
...
{nimErr_ = nimErrorFlag();
	...
	result = rawNewString(((NI) ((NI)(s__Y5HeFpORH6vb7kJzRxP9cSw.len + (NI)((NI32)(s__Y5HeFpORH6vb7kJzRxP9cSw.len) >> (NU32)(((NI)3)))))));
...
{nimErr_ = nimErrorFlag();
	...
	(*T1_)._kind_6.fields = initOrderedTable__pureZjson_390(((NI)2));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = T1_;
	}BeforeRet_: ;
	return result;
