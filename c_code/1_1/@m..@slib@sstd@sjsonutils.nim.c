...
N_LIB_PRIVATE N_NIMCALL(void, formatValue__pureZterminal_446)(NimStringV2* result__cf3mpYwrFFZaaa4W7Luvag, NI value__36SFRD9a2n7PnEJokI6BTQw, NimStringV2 specifier__rKQhlkpwEmo7gb69cTyH5SA);
...
appendString((&fmtRes), TM__D9aPSI6l3gZsoFvdx9c3FKBg_39);
		formatValue__pureZterminal_446((&fmtRes), tupleSize, TM__D9aPSI6l3gZsoFvdx9c3FKBg_41);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	setLen__system_3400((&(*a__YgVnlAQCl5hJRf3h9aGL3zw_4)), ((NI) (T10_)));
	{
		tyObject_JsonNodeObj__df9bshXB7C9cTiWPIOtX3j1Q* val;
		tySequence__oLpBKXzW3hF9aCVMo5EymfQ colontmp_;
		NI i;
