...
typedef N_STDCALL_PTR(NI32, tyProc__5sqIMptsyAfPn3c9cPj4DOA) (NI16* pathName__7OM8jtJ9bW6j4ZjIaMA4hhg);
...
typedef N_STDCALL_PTR(NI32, tyProc__29cQilB9cqahn5yPQZH66TkA) (NI16* lpExistingFileName__HR9csYfuIq9cryPJL0zseWjw, NI16* lpNewFileName__NNWJcoCB9bsu1VkU4Yq3Egg, NI32 bFailIfExists__Kf6Dd0Yh7EI1dUdVajAl3g);
...
{nimErr_ = nimErrorFlag();
	...
	result = NIM_TRUE;
	f = newWideCString__stdZwidestrs_287(file__SkPQ5IAKGO9cnoeVcTqgQ3w);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NI16* T3_;
		NI32 T4_;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__stdZoserrors_86(T6_, file__J7TxM2NvlX9btMhQD9bZz39bA);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA4_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = tryMoveFSObject__stdZprivateZoscommon_61(source__PbhPTnLQrpW54wQ6Wx9cCwQ, dest__OatSPDCla4s5V9cfRdFrXig, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T3_)) goto LA4_;
		{
...
{nimErr_ = nimErrorFlag();
	...
	{
		if (!!((countBits32((7 & options__luhms5PVEQqqSFobm4FG3Q)) == ((NI)1)))) goto LA4_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		if (!(T8_)) goto LA9_;
		T10_ = (NIM_BOOL)0;
		T10_ = ((options__luhms5PVEQqqSFobm4FG3Q &((NU8)1<<((NU)((((tyEnum_CopyFlag__mhWURcDRsh0F1DeHBSFUVg)2)))&7U)))!=0);
		if (T10_) goto LA11_;
		T10_ = NIM_TRUE;
		LA11_: ;
		T8_ = T10_;
	...
	LA12_: ;
	s = newWideCString__stdZwidestrs_287(source__eoCVFNpLZVLXwyKu7SJhzg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	d = newWideCString__stdZwidestrs_287(dest__C3yHuHrfbm8qUZjgenJyMA);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NI16* T16_;
		NI16* T17_;
		...
		T23_.Field0 = source__eoCVFNpLZVLXwyKu7SJhzg;
		T23_.Field1 = dest__C3yHuHrfbm8qUZjgenJyMA;
