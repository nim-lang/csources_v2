...
{nimErr_ = nimErrorFlag();
	...
	{
		while (1) {
			if (!(i < ((NI32) (s__lH7jASsvvzyklN9aZBSoUtg.len)))) goto LA2			;
			{
				int w;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		(*f__jCZmwmLDt13jv0XqrjcAuQ) = ((FILE*) (p));
		{
			...
			if (!(T7_)) goto LA8_;
			T7_ = ((NU32)(((NU) (bufSize__zibzux2ygo9c1EC9aWjJNryA))) <= (NU32)(((NU)IL64(4294967295))));
			LA8_: ;
			if (!T7_) goto LA9_;
			T11_ = (int)0;
...
N_LIB_PRIVATE N_NIMCALL(NI64, rawFileSize__stdZsyncio_464)(FILE* file__z8NScx6qCbT9clvTbblGJUQ) {
	...
	int T2_;
	result = (NI64)0;
	oldPos = ftell(file__z8NScx6qCbT9clvTbblGJUQ);
	T1_ = (int)0;
	T1_ = fseek(file__z8NScx6qCbT9clvTbblGJUQ, IL64(0), ((int)2));
	(void)(T1_);
	result = ftell(file__z8NScx6qCbT9clvTbblGJUQ);
	T2_ = (int)0;
	T2_ = fseek(file__z8NScx6qCbT9clvTbblGJUQ, oldPos, ((int)0));
	(void)(T2_);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NI, readBuffer__stdZsyncio_156)(FILE* f__IaK5VtP9as9bSPQ9cTnuLHETg, void* buffer__SomluaAOHkLzDmuVjmZY9aw, NI len__zb5w85RBVolb2k0KJN4Gew) {
...
{nimErr_ = nimErrorFlag();
	{
		int T3_;
		T3_ = (int)0;
		T3_ = fseek(f__RNwIVhVTSuyZBP9bw79a84ZQ, pos__Im0hAGFOuJ4Zywebg9bWxlQ, ((int) (relativeTo__zMt2iSRBvoYB2pQn2kLjuw)));
		if (!!((T3_ == ((NI32)0)))) goto LA4_;
...
{nimErr_ = nimErrorFlag();
	result = (NI64)0;
	result = ftell(f__xLIQp4TfrWQlhrwP9bbGicA);
	{
