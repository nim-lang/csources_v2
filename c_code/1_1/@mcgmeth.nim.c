...
{nimErr_ = nimErrorFlag();
			...
			while (1) {
				...
				case ((tyEnum_MethodResult__mzqZ5KFgBLGzkX1JWKxmRw)2):
				{
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
					{
						...
						LA12_: ;
						if (!T11_) goto LA13_;
						liMessage__msgs_1159((*g).config, (*s).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__iRY49cFF15N9aiVVO5nXtoDQ_4, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__iRY49cFF15N9aiVVO5nXtoDQ_5, NIM_FALSE);
						if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
					}
					LA13_: ;
					eqdestroy___ast_4060(&disp);
	...
	add__cgmeth_305((&(*g).methods), T23_);
	{
		...
		colontmpD__3 = dollar___msgs_663((*g).config, (*witness).info);
...
appendString((&T30_), colontmpD__3);
		colontmpD__4 = T30_;
		liMessage__msgs_1159((*g).config, (*s).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__4, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__iRY49cFF15N9aiVVO5nXtoDQ_13, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA29_;
		{
			LA29_:;
		}
	...
	LA27_: ;
	{
		...
		liMessage__msgs_1159((*g).config, (*s).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)37), TM__iRY49cFF15N9aiVVO5nXtoDQ_14, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__iRY49cFF15N9aiVVO5nXtoDQ_15, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	goto LA25_;
	LA34_: ;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		LA10_: ;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			{
				...
				internalErrorImpl__msgs_1497(conf, (*n).info, TM__iRY49cFF15N9aiVVO5nXtoDQ_20, TM__iRY49cFF15N9aiVVO5nXtoDQ_21);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			}
			LA17_: ;
		}
		...
		LA13_: ;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			{
				...
				internalErrorImpl__msgs_1497(conf, (*n).info, TM__iRY49cFF15N9aiVVO5nXtoDQ_23, TM__iRY49cFF15N9aiVVO5nXtoDQ_24);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			}
			LA24_: ;
		}
...
appendString((&T12_), TM__iRY49cFF15N9aiVVO5nXtoDQ_28);
		colontmpD__2 = T12_;
		liMessage__msgs_1159(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__iRY49cFF15N9aiVVO5nXtoDQ_29, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
		{
			LA11_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	ands = getSysMagic__magicsys_29(g, unknownLineInfo__lineinfos_350, TM__iRY49cFF15N9aiVVO5nXtoDQ_32, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)109));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	iss = getSysMagic__magicsys_29(g, unknownLineInfo__lineinfos_350, TM__iRY49cFF15N9aiVVO5nXtoDQ_34, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)15));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	boolType = getSysType__magicsys_60(g, unknownLineInfo__lineinfos_350, ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NI col;
		NI i;
