...
{nimErr_ = nimErrorFlag();
		...
		i_2 = ((NI)1);
		{
			while (1) {
				...
				} LA15: ;
				{
					...
					T30_ = 0;
					T31_ = (NIM_BOOL)0;
					T31_ = sameType__types_1991((*(*a__qm33fSNYY0pFGAMhhJCB9bA).typ).sons.p->data[i], (*(*b__s9cUE0oTagSLmqzQxuBdOGA).typ).sons.p->data[i], T30_);
					if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
					if (!T31_) goto LA32_;
					{
						NIM_BOOL T36_;
				...
				LA32_: ;
				{
					...
					LA44_: ;
					if (!T41_) goto LA47_;
					diff = inheritanceDiff__types_2863(bb, aa);
					if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
					{
	...
	}
	{
		if (!(result == ((tyEnum_MethodResult__mzqZ5KFgBLGzkX1JWKxmRw)2))) goto LA69_;
		{
			...
			T73_ = 0;
			T74_ = (NIM_BOOL)0;
			T74_ = sameTypeOrNil__types_2022((*(*a__qm33fSNYY0pFGAMhhJCB9bA).typ).sons.p->data[((NI)0)], (*(*b__s9cUE0oTagSLmqzQxuBdOGA).typ).sons.p->data[((NI)0)], T73_);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!!(T74_)) goto LA75_;
			{
				NIM_BOOL T79_;
			...
			res = ((NI)1);
			{
				while (1) {
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
					{
						...
						T13_ = 0;
						T14_ = (NIM_BOOL)0;
						T14_ = sameType__types_1991(t2, t, T13_);
						if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
						if (!!(T14_)) goto LA15_;
						result = NIM_TRUE;
		...
		i = ((NI)1);
		{
			while (1) {
				...
				col = i;
				{
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
					d = inheritanceDiff__types_2863(aa, bb);
					if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
					{
						NIM_BOOL T12_;
						T12_ = (NIM_BOOL)0;
