...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___nim_143)(tyObject_NimProgcolonObjectType___nXKTiDb6u1p29b8d5CUkjYw** dest__jRAxyC3lbA9cfIfqjXB2uwQ) {
	{
		...
		nimRawDispose((*dest__jRAxyC3lbA9cfIfqjXB2uwQ), ((NI)4));
	}
	LA4_: ;
}
static N_INLINE(int, nimCmpMem)(void* a__Zh2oHxuk6tQEeHVzxXoGdQ, void* b__yL7DXeFLjAACMba9adhgSUg, NI size__QvIXSt5kyJ8mHUyukrF1bQ) {
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		liMessage__msgs_1159(conf__uAyzBxDxk7kaA21o33EV3Q, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__RxBoA2E3fxrN6r2tToaOvg_21, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), TM__RxBoA2E3fxrN6r2tToaOvg_22, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA36_: ;
