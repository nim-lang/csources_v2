...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__2 = T19_;
	T20_.len = 0; T20_.p = NIM_NIL;
	T20_ = pathSubs__options_5069(conf, p, colontmpD__2.Field0);
	if (NIM_UNLIKELY(*nimErr_)) goto LA17_;
	result = T20_;
	{
		LA17_:;
...
{nimErr_ = nimErrorFlag();
	...
	LA19_: ;
	{
		...
		T24_ = substr__system_7585(switch_0, (NI)(i + ((NI)1)));
	...
	LA22_: ;
	{
		...
		T28_ = substr__system_7585(switch_0, i);
...
{nimErr_ = nimErrorFlag();
	...
	LA35_: ;
	colontmpD__2 = substr__system_7585(arg, i);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		val.len = 0; val.p = NIM_NIL;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		key = substr__system_7573((*p).key, ((NI)0), (NI)(bracketLe - ((NI)1)));
		T6_.len = 0; T6_.p = NIM_NIL;
		colontmpD_ = substr__system_7585((*p).key, bracketLe);
