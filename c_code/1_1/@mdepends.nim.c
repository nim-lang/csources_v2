...
struct tySequence__29btfq9cDuCZmHsAEmuBeMOg_Content { NI cap; tyObject_FullId__3oA6EHvzCx1KvUf9cxJRXXw data[SEQ_DECL_SIZE];};
      ...
      N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___depends_150)(tyObject_TGen__es3PvTIVeP719bNgsD5fFew** dest__EfJrcFdv0DUdsNUsAzVobg);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___depends_163)(tyObject_TGen__es3PvTIVeP719bNgsD5fFew* dest__EfJrcFdv0DUdsNUsAzVobg_2);
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___depends_172)(tyObject_TGen__es3PvTIVeP719bNgsD5fFew* dest__Qs8zPUi69bqDDmF6dOHSDhQ, void* env__UHtbcmD5F8QFtC9ch1cDiuA);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___depends_213)(tyObject_BackendcolonObjectType___45kLepe9bud4dvwPA9ctgKAg* dest__MrMe7et5JUI36Ig4h1GO7w);
...
N_LIB_PRIVATE N_NIMCALL(void, addDependency__depends_104)(tyObject_TPassContext__9aUzdnrOgAbujYuO39brF9bbA* c__IlWxp8LiQItsFTQCh09a88g, tyObject_TGen__es3PvTIVeP719bNgsD5fFew* g__0ENgSKXNJZiPZ0wsZ11ghA, tyObject_BackendcolonObjectType___45kLepe9bud4dvwPA9ctgKAg* b__GRLqjkbAQUr9a9aw40wJ5TRA, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n__53QoMAI6DgP7D1uiiRUEaw);
...
N_LIB_PRIVATE N_NIMCALL(void, addDependencyAux__depends_22)(tyObject_BackendcolonObjectType___45kLepe9bud4dvwPA9ctgKAg* b__t2gwgv2CmTxgr9cXxqe9c6TA, NimStringV2 importing__9b9c8QlmCAUCeCQrUDcKuo2w, NimStringV2 imported__wfeWmPiiLYccGZsFPb130A);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___depends_200)(tyObject_BackendcolonObjectType___45kLepe9bud4dvwPA9ctgKAg** dest__EfJrcFdv0DUdsNUsAzVobg_3);
...
extern NIM_CONST tyArray__pq8mfSp9bT2PbH9bKmz9cdOdA stdlibDirs__options_5238;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___depends_150)(tyObject_TGen__es3PvTIVeP719bNgsD5fFew** dest__EfJrcFdv0DUdsNUsAzVobg) {
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLastCyclicDyn((*dest__EfJrcFdv0DUdsNUsAzVobg));
		if (!T3_) goto LA4_;
		nimDestroyAndDispose((*dest__EfJrcFdv0DUdsNUsAzVobg));
	}
	LA4_: ;
}
static N_INLINE(NIM_BOOL, nimDecRefIsLastCyclicStatic)(void* p__dJRKNN7Lwiejao9bBZyAiiw, TNimTypeV2* desc__VkzDY9cpkn7dPDxj5VeV7eA) {
...
{nimErr_ = nimErrorFlag();
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLastCyclicStatic((*dest__EfJrcFdv0DUdsNUsAzVobg_2).Sup.idgen, (&NTIv2__C1k2TcDRT9cU4DEatQIT09ag_));
		if (!T3_) goto LA4_;
		eqdestroy___ast_3232((*dest__EfJrcFdv0DUdsNUsAzVobg_2).Sup.idgen);
		nimRawDispose((*dest__EfJrcFdv0DUdsNUsAzVobg_2).Sup.idgen, ((NI)4));
	}
	LA4_: ;
	{
		NIM_BOOL T8_;
		T8_ = (NIM_BOOL)0;
		T8_ = nimDecRefIsLast((*dest__EfJrcFdv0DUdsNUsAzVobg_2).module);
		if (!T8_) goto LA9_;
		nimDestroyAndDispose((*dest__EfJrcFdv0DUdsNUsAzVobg_2).module);
	}
	LA9_: ;
	{
		NIM_BOOL T13_;
		T13_ = (NIM_BOOL)0;
		T13_ = nimDecRefIsLast((*dest__EfJrcFdv0DUdsNUsAzVobg_2).config);
		if (!T13_) goto LA14_;
		eqdestroy___options_3149((*dest__EfJrcFdv0DUdsNUsAzVobg_2).config);
		nimRawDispose((*dest__EfJrcFdv0DUdsNUsAzVobg_2).config, ((NI)8));
	}
	LA14_: ;
	{
		NIM_BOOL T18_;
		T18_ = (NIM_BOOL)0;
		T18_ = nimDecRefIsLast((*dest__EfJrcFdv0DUdsNUsAzVobg_2).graph);
		if (!T18_) goto LA19_;
		eqdestroy___modulegraphs_11047((*dest__EfJrcFdv0DUdsNUsAzVobg_2).graph);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__EfJrcFdv0DUdsNUsAzVobg_2).graph, ((NI)8));
	}
	LA19_: ;
	}BeforeRet_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___depends_172)(tyObject_TGen__es3PvTIVeP719bNgsD5fFew* dest__Qs8zPUi69bqDDmF6dOHSDhQ, void* env__UHtbcmD5F8QFtC9ch1cDiuA) {
	nimTraceRef(&(*dest__Qs8zPUi69bqDDmF6dOHSDhQ).Sup.idgen, (&NTIv2__C1k2TcDRT9cU4DEatQIT09ag_), env__UHtbcmD5F8QFtC9ch1cDiuA);
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___depends_213)(tyObject_BackendcolonObjectType___45kLepe9bud4dvwPA9ctgKAg* dest__MrMe7et5JUI36Ig4h1GO7w) {
	eqdestroy___stdZassertions_13((&(*dest__MrMe7et5JUI36Ig4h1GO7w).dotGraph));
}
static N_INLINE(void, nimMarkCyclic)(void* p__dsW7nRpkiWF7Y6P6ztAnVA) {
}
...
{nimErr_ = nimErrorFlag();
	...
	eqcopy___ast_4063(&(*g).module, module__Qi0hed6VB2JxiA0ZmbEyJA);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___options_3378(&(*g).config, (*graph__Zctui9bN3KiQQaIFZzyeb9cw).config);
	eqcopy___modulegraphs_11315(&(*g).graph, graph__Zctui9bN3KiQQaIFZzyeb9cw);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		tyObject_BackendcolonObjectType___45kLepe9bud4dvwPA9ctgKAg* T5_;
		if (!((*graph__Zctui9bN3KiQQaIFZzyeb9cw).backend == ((RootObj*) NIM_NIL))) goto LA3_;
		T5_ = NIM_NIL;
		...
		eqsink___ast_4617(&(*graph__Zctui9bN3KiQQaIFZzyeb9cw).backend, &T5_->Sup);
	}
	LA3_: ;
	blitTmp = g;
	nimMarkCyclic(g);
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		NimStringV2 sub;
		NI start;
		if (!isStdlib__S130YfP2lEd2Oa5aiYmEJA) goto LA3_;
		sub.len = 0; sub.p = NIM_NIL;
		sub = TM__T9abLwc1VuaTcNHPnsJcieg_9;
		start = nsuFindStr(s__F4EfZYTB7bScUy9anG4r2pQ, sub, ((NI)0), ((NI)-1));
		...
		LA8_: ;
		{
			...
			base = X5BX5D___pureZstrutils_1307(s__F4EfZYTB7bScUy9anG4r2pQ, T16_);
...
appendString((&T43_), base);
	...
	LA3_: ;
	{
		...
		sub_2 = getEnv__stdZenvvars_28(TM__T9abLwc1VuaTcNHPnsJcieg_20, TM__T9abLwc1VuaTcNHPnsJcieg_21);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
...
appendString((&sub_2), TM__T9abLwc1VuaTcNHPnsJcieg_25);
		...
		LA49_: ;
		start_2 = nsuFindStr(s__F4EfZYTB7bScUy9anG4r2pQ, sub_2, ((NI)0), ((NI)-1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			if (!(start_2 < ((NI)0))) goto LA56_;
			eqcopy___stdZassertions_16((&result), s__F4EfZYTB7bScUy9anG4r2pQ);
		}
		goto LA54_;
		LA56_: ;
		{
			...
			start_2 += sub_2.len;
			T59_ = (NI)0;
			T59_ = skipUntil__pureZparseutils_787(s__F4EfZYTB7bScUy9anG4r2pQ, 47, start_2);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			start_2 += T59_;
			start_2 += ((NI)1);
			T60_.len = 0; T60_.p = NIM_NIL;
			T61_ = dotdot___stdZenumutils_128(start_2, ((NI)1));
			colontmpD__2 = X5BX5D___pureZstrutils_1307(s__F4EfZYTB7bScUy9anG4r2pQ, T61_);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	T1_[0] = importing__9b9c8QlmCAUCeCQrUDcKuo2w;
	T1_[1] = imported__wfeWmPiiLYccGZsFPb130A;
	colontmpD_ = percent___depends_26(T1_, 2);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	prepareAdd((&(*b__t2gwgv2CmTxgr9cXxqe9c6TA).dotGraph), colontmpD_.len + 0);
appendString((&(*b__t2gwgv2CmTxgr9cXxqe9c6TA).dotGraph), colontmpD_);
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__4.len = 0; colontmpD__4.p = NIM_NIL;
	{
		...
		NimStringV2 T5_;
		if (!!(((*n__53QoMAI6DgP7D1uiiRUEaw).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3)))) goto LA3_;
		colontmpD__5.len = 0; colontmpD__5.p = NIM_NIL;
		colontmpD__6.len = 0; colontmpD__6.p = NIM_NIL;
		T5_.len = 0; T5_.p = NIM_NIL;
		colontmpD__5 = dollar___ast_192((*n__53QoMAI6DgP7D1uiiRUEaw).kind);
		T5_ = rawNewString(colontmpD__5.len + 37);
appendString((&T5_), TM__T9abLwc1VuaTcNHPnsJcieg_7);
appendString((&T5_), colontmpD__5);
		colontmpD__6 = T5_;
		failedAssertImpl__stdZassertions_224(colontmpD__6);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	T6_ = toProjPath__msgs_579((*g__0ENgSKXNJZiPZ0wsZ11ghA).config, ((NI32) ((*(*n__53QoMAI6DgP7D1uiiRUEaw)._kind_4.sym).position)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	path = nossplitFile(T6_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T7_.len = 0; T7_.p = NIM_NIL;
	T7_ = toProjPath__msgs_579((*g__0ENgSKXNJZiPZ0wsZ11ghA).config, ((NI32) ((*(*g__0ENgSKXNJZiPZ0wsZ11ghA).module).position)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	modulePath = nossplitFile(T7_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD_ = slash___stdZprivateZospaths50_90(modulePath.Field0, modulePath.Field1);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__2 = nativeToUnixPath__stdZprivateZglobs_77(colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T8_ = (NIM_BOOL)0;
	T8_ = belongsToStdlib__modulegraphs_14987((*g__0ENgSKXNJZiPZ0wsZ11ghA).graph, (*g__0ENgSKXNJZiPZ0wsZ11ghA).module);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	parent = toNimblePath__depends_31(colontmpD__2, T8_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__3 = slash___stdZprivateZospaths50_90(path.Field0, path.Field1);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__4 = nativeToUnixPath__stdZprivateZglobs_77(colontmpD__3);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T9_ = (NIM_BOOL)0;
	T9_ = belongsToStdlib__modulegraphs_14987((*g__0ENgSKXNJZiPZ0wsZ11ghA).graph, (*n__53QoMAI6DgP7D1uiiRUEaw)._kind_4.sym);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	child = toNimblePath__depends_31(colontmpD__4, T9_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	addDependencyAux__depends_22(b__GRLqjkbAQUr9a9aw40wJ5TRA, parent, child);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	eqdestroy___stdZprivateZosdirs_65((&modulePath));
	eqdestroy___stdZprivateZosdirs_65((&path));
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___depends_200)(tyObject_BackendcolonObjectType___45kLepe9bud4dvwPA9ctgKAg** dest__EfJrcFdv0DUdsNUsAzVobg_3) {
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLastCyclicDyn((*dest__EfJrcFdv0DUdsNUsAzVobg_3));
		if (!T3_) goto LA4_;
		nimDestroyAndDispose((*dest__EfJrcFdv0DUdsNUsAzVobg_3));
	}
	LA4_: ;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, addDotDependency__depends_125)(tyObject_TPassContext__9aUzdnrOgAbujYuO39brF9bbA* c__ASM9cics39bcTvwSOjsXO5mA, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n__xw6XTctHET1BOfQzL7SKoQ) {
...
{nimErr_ = nimErrorFlag();
	...
	eqcopy___ast_3457(&result, n__xw6XTctHET1BOfQzL7SKoQ);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD_ = 0;
	eqcopy___passes_121(&colontmpD_, c__ASM9cics39bcTvwSOjsXO5mA, NIM_TRUE);
	...
	switch ((*n__xw6XTctHET1BOfQzL7SKoQ).kind) {
	...
	{
		{
			...
			i = (NI)0;
			colontmp_ = (NI)0;
			colontmp_ = len__ast_3325(n__xw6XTctHET1BOfQzL7SKoQ);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			i_2 = ((NI)0);
			{
				while (1) {
					...
					i = i_2;
					addDependency__depends_104(c__ASM9cics39bcTvwSOjsXO5mA, g, b, (*n__xw6XTctHET1BOfQzL7SKoQ)._kind_6.sons.p->data[i]);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					i_2 += ((NI)1);
				} LA4: ;
			}
	...
	{
		addDependency__depends_104(c__ASM9cics39bcTvwSOjsXO5mA, g, b, (*n__xw6XTctHET1BOfQzL7SKoQ)._kind_6.sons.p->data[((NI)0)]);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	...
	{
		{
			...
			i_3 = (NI)0;
			colontmp__2 = (NI)0;
			colontmp__2 = len__ast_3325(n__xw6XTctHET1BOfQzL7SKoQ);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			i_4 = ((NI)0);
			{
				while (1) {
					...
					i_3 = i_4;
					colontmpD__3 = addDotDependency__depends_125(c__ASM9cics39bcTvwSOjsXO5mA, (*n__xw6XTctHET1BOfQzL7SKoQ)._kind_6.sons.p->data[i_3]);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					(void)(colontmpD__3);
					i_4 += ((NI)1);
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
	colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
	b = (*((tyObject_BackendcolonObjectType___45kLepe9bud4dvwPA9ctgKAg**) (&((*graph__Pnx4Iu403jr6J9cxTDN4htg).backend))));
	colontmpD_ = splitFile__pathutils_31(project__RkbnQYdkvcMWBKgd2EhayQ);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_[0] = colontmpD_.Field1;
	T2_[1] = (*b).dotGraph;
	colontmpD__2 = percent___depends_236(T2_, 2);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__3 = noschangeFileExt(project__RkbnQYdkvcMWBKgd2EhayQ, TM__T9abLwc1VuaTcNHPnsJcieg_29);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T3_ = (NIM_BOOL)0;
