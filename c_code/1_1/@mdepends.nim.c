...
appendString((&T43_), base);
	...
	LA3_: ;
	{
		...
		sub_2 = getEnv__stdZenvvars_14(TM__T9abLwc1VuaTcNHPnsJcieg_20, TM__T9abLwc1VuaTcNHPnsJcieg_21);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
...
appendString((&sub_2), TM__T9abLwc1VuaTcNHPnsJcieg_25);
		...
		LA56_: ;
		{
			...
			start_2 += sub_2.len;
			T59_ = (NI)0;
			T59_ = skipUntil__pureZparseutils_787(s, 47, start_2);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			start_2 += T59_;
			start_2 += ((NI)1);
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__4.len = 0; colontmpD__4.p = NIM_NIL;
	{
		...
		colontmpD__5 = dollar___ast_192((*n).kind);
...
appendString((&T5_), colontmpD__5);
	...
	T6_ = toProjPath__msgs_569((*g).config, ((NI32) ((*(*n)._kind_4.sym).position)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	path = nossplitFile(T6_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T7_.len = 0; T7_.p = NIM_NIL;
	T7_ = toProjPath__msgs_569((*g).config, ((NI32) ((*(*g).module).position)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T8_ = (NIM_BOOL)0;
	T8_ = belongsToStdlib__modulegraphs_14963((*g).graph, (*g).module);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T9_ = (NIM_BOOL)0;
	T9_ = belongsToStdlib__modulegraphs_14963((*g).graph, (*n)._kind_4.sym);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = splitFile__pathutils_31(project);
