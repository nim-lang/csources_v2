...
struct tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content { NI cap; NimStringV2 data[SEQ_DECL_SIZE];};
      ...
      N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___docgen50_40)(tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw** dest__CFVWEMWCviUZfTtslhNaZA);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___docgen50_53)(tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw* dest__CFVWEMWCviUZfTtslhNaZA_2);
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___docgen50_62)(tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw* dest__so0HmKMQGptH6r9cWq9agslQ, void* env__sgrG3wPKa52dtQffDHBFzw);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, shouldProcess__docgen50_15)(tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw* g__m9b0pRVPFGlbzKMz2xcbW9bg);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___docgen50_40)(tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw** dest__CFVWEMWCviUZfTtslhNaZA) {
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLastCyclicDyn((*dest__CFVWEMWCviUZfTtslhNaZA));
		if (!T3_) goto LA4_;
		nimDestroyAndDispose((*dest__CFVWEMWCviUZfTtslhNaZA));
	}
	LA4_: ;
}
static N_INLINE(NIM_BOOL, nimDecRefIsLastCyclicStatic)(void* p__dJRKNN7Lwiejao9bBZyAiiw, TNimTypeV2* desc__VkzDY9cpkn7dPDxj5VeV7eA) {
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___docgen50_53)(tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw* dest__CFVWEMWCviUZfTtslhNaZA_2) {
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLastCyclicStatic((*dest__CFVWEMWCviUZfTtslhNaZA_2).Sup.idgen, (&NTIv2__C1k2TcDRT9cU4DEatQIT09ag_));
		if (!T3_) goto LA4_;
		eqdestroy___ast_3232((*dest__CFVWEMWCviUZfTtslhNaZA_2).Sup.idgen);
		nimRawDispose((*dest__CFVWEMWCviUZfTtslhNaZA_2).Sup.idgen, ((NI)4));
	}
	LA4_: ;
	{
		NIM_BOOL T8_;
		T8_ = (NIM_BOOL)0;
		T8_ = nimDecRefIsLastCyclicDyn((*dest__CFVWEMWCviUZfTtslhNaZA_2).doc);
		if (!T8_) goto LA9_;
		nimDestroyAndDispose((*dest__CFVWEMWCviUZfTtslhNaZA_2).doc);
	}
	LA9_: ;
	{
		NIM_BOOL T13_;
		T13_ = (NIM_BOOL)0;
		T13_ = nimDecRefIsLast((*dest__CFVWEMWCviUZfTtslhNaZA_2).module);
		if (!T13_) goto LA14_;
		nimDestroyAndDispose((*dest__CFVWEMWCviUZfTtslhNaZA_2).module);
	}
	LA14_: ;
	{
		NIM_BOOL T18_;
		T18_ = (NIM_BOOL)0;
		T18_ = nimDecRefIsLast((*dest__CFVWEMWCviUZfTtslhNaZA_2).config);
		if (!T18_) goto LA19_;
		eqdestroy___options_3149((*dest__CFVWEMWCviUZfTtslhNaZA_2).config);
		nimRawDispose((*dest__CFVWEMWCviUZfTtslhNaZA_2).config, ((NI)8));
	}
	LA19_: ;
}
static N_INLINE(void, nimCopyMem)(void* dest__HMDJtGX4ficduS9cTUiey0w, void* source__xDZEU1SRcEBuZ8mtbKQBhQ, NI size__9b8g0WMA1h1RvMwHOMW7yFA) {
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___docgen50_62)(tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw* dest__so0HmKMQGptH6r9cWq9agslQ, void* env__sgrG3wPKa52dtQffDHBFzw) {
	nimTraceRef(&(*dest__so0HmKMQGptH6r9cWq9agslQ).Sup.idgen, (&NTIv2__C1k2TcDRT9cU4DEatQIT09ag_), env__sgrG3wPKa52dtQffDHBFzw);
	nimTraceRefDyn(&(*dest__so0HmKMQGptH6r9cWq9agslQ).doc, env__sgrG3wPKa52dtQffDHBFzw);
}
static N_INLINE(void, nimMarkCyclic)(void* p__dsW7nRpkiWF7Y6P6ztAnVA) {
}
...
{nimErr_ = nimErrorFlag();
	...
	eqcopy___ast_4063(&(*g).module, module__KEHl9c2YcOxvdVspzYcI6iQ);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqcopy___options_3378(&(*g).config, (*graph__Tbsqhv2ORi9cbvvIYYr1Xww).config);
	colontmpD_ = toFullPath__msgs_577((*graph__Tbsqhv2ORi9cbvvIYYr1Xww).config, ((NI32) ((*module__KEHl9c2YcOxvdVspzYcI6iQ).position)));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	d = newDocumentor__docgen_2018(colontmpD_, (*graph__Tbsqhv2ORi9cbvvIYYr1Xww).cache, (*graph__Tbsqhv2ORi9cbvvIYYr1Xww).config, TM__79a23b0wb0aeltMvLxl7OCw_4, module__KEHl9c2YcOxvdVspzYcI6iQ, NIM_FALSE, NIM_TRUE, NIM_TRUE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	T2_ = (NIM_BOOL)0;
	T3_ = (NIM_BOOL)0;
	T3_ = (((*(*(*g__m9b0pRVPFGlbzKMz2xcbW9bg).doc).conf).globalOptions &((NU64)1<<((NU)((((tyEnum_TGlobalOption__9bU4j0PZjdMiF7DRotXVQZw)34)))&63U)))!=0);
	if (!(T3_)) goto LA4_;
	T3_ = belongsToProjectPackage__packages_76((*(*g__m9b0pRVPFGlbzKMz2xcbW9bg).doc).conf, (*g__m9b0pRVPFGlbzKMz2xcbW9bg).module);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	LA4_: ;
	T2_ = T3_;
	if (T2_) goto LA5_;
	T2_ = (((*(*g__m9b0pRVPFGlbzKMz2xcbW9bg).module).flags &((NU64)1<<((NU)((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)14)))&63U)))!=0);
	LA5_: ;
	T1_ = T2_;
	if (T1_) goto LA6_;
	T1_ = ((*(*g__m9b0pRVPFGlbzKMz2xcbW9bg).config).projectMainIdx == (*(*g__m9b0pRVPFGlbzKMz2xcbW9bg).module).info.fileIndex);
	LA6_: ;
	result = T1_;
	}BeforeRet_: ;
	return result;
...
{nimErr_ = nimErrorFlag();
	...
	g = NIM_NIL;
	colontmpD_ = NIM_NIL;
	eqcopy___ast_3457(&result, n__fpDWJYA7VbCpOyrhaSn5uA);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD_ = 0;
	eqcopy___passes_121(&colontmpD_, c__XnIR06K704TPt9aSYmmbOVw, NIM_TRUE);
	g = (*((tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw**) (&(colontmpD_))));
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T4_) goto LA5_;
		generateDoc__docgen_9801((*g).doc, n__fpDWJYA7VbCpOyrhaSn5uA, n__fpDWJYA7VbCpOyrhaSn5uA, ((tyEnum_DocFlags__9aeIeuFZ7FUxqh7HN3G2uqA)0));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA5_: ;
	{
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = NIM_NIL;
	colontmpD_ = 0;
	eqcopy___passes_121(&colontmpD_, p__jWo67nLDx2qPAI5g01Sn0g, NIM_TRUE);
	g = (*((tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw**) (&(colontmpD_))));
...
{nimErr_ = nimErrorFlag();
	...
	g = (tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw*) nimNewObj(sizeof(tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw), NIM_ALIGNOF(tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw));
	(*g).Sup.Sup.m_type = (&NTIv2__Mq07cKWfeGN6ARjzPuLUKw_);
	eqcopy___ast_4063(&(*g).module, module__lY56dnmZUtuh6Q3hmGUZ3g);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqcopy___options_3378(&(*g).config, (*graph__r4mHk3Oggt8CwGwUK9aCY1Q).config);
	colontmpD_ = toFullPath__msgs_577((*graph__r4mHk3Oggt8CwGwUK9aCY1Q).config, ((NI32) ((*module__lY56dnmZUtuh6Q3hmGUZ3g).position)));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	d = newDocumentor__docgen_2018(colontmpD_, (*graph__r4mHk3Oggt8CwGwUK9aCY1Q).cache, (*graph__r4mHk3Oggt8CwGwUK9aCY1Q).config, TM__79a23b0wb0aeltMvLxl7OCw_6, module__lY56dnmZUtuh6Q3hmGUZ3g, NIM_FALSE, NIM_TRUE, NIM_TRUE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqsink___docgen_3310(&(*g).doc, d);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	d = 0;
...
{nimErr_ = nimErrorFlag();
	...
	g = NIM_NIL;
	colontmpD_ = NIM_NIL;
	eqcopy___ast_3457(&result, n__l1o74RNXxBYPxSU8saknSg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD_ = 0;
	eqcopy___passes_121(&colontmpD_, c__WxCGq1Tzh4JMC4BA6ORK3w, NIM_TRUE);
	g = (*((tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw**) (&(colontmpD_))));
	{
		NIM_BOOL T4_;
		T4_ = (NIM_BOOL)0;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T4_) goto LA5_;
		generateJson__docgen_11638((*g).doc, n__l1o74RNXxBYPxSU8saknSg, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA5_: ;
	{
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = NIM_NIL;
	colontmpD_ = 0;
	eqcopy___passes_121(&colontmpD_, p__9aiofj4BvXCDRxcssb9cDd8g, NIM_TRUE);
	g = (*((tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw**) (&(colontmpD_))));
	useWarning = !((((*(*g).module).flags &((NU64)1<<((NU)((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)14)))&63U)))!=0));
	groupedToc = NIM_TRUE;
	{
...
{nimErr_ = nimErrorFlag();
	...
	g = (tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw*) nimNewObj(sizeof(tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw), NIM_ALIGNOF(tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw));
	(*g).Sup.Sup.m_type = (&NTIv2__Mq07cKWfeGN6ARjzPuLUKw_);
	eqcopy___ast_4063(&(*g).module, module__Sje309ba7QhtymvJ9aF8qcJg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqcopy___options_3378(&(*g).config, (*graph__OXRapa5j7gELlIs9bmiUuWA).config);
	colontmpD_ = toFullPath__msgs_577((*graph__OXRapa5j7gELlIs9bmiUuWA).config, ((NI32) ((*module__Sje309ba7QhtymvJ9aF8qcJg).position)));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	d = newDocumentor__docgen_2018(colontmpD_, (*graph__OXRapa5j7gELlIs9bmiUuWA).cache, (*graph__OXRapa5j7gELlIs9bmiUuWA).config, TM__79a23b0wb0aeltMvLxl7OCw_8, module__Sje309ba7QhtymvJ9aF8qcJg, NIM_FALSE, NIM_TRUE, NIM_TRUE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqsink___docgen_3310(&(*g).doc, d);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	d = 0;
