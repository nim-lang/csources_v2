...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, evalTemplateArgs__evaltempl_197)(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n__D1ox5VZgLE2M1qmwLBTs9ag, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s__9aifUoRKxwXyr9cRrYWtYIpw, tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf__NQiixI09cu7KJUDtjZ9aAN9cw, NIM_BOOL fromHlo__mpvRcSbXGo0BJSv0KzZ5WA);
...
N_LIB_PRIVATE N_NIMCALL(void, evalTemplateAux__evaltempl_24)(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* templ__9c3LpWmLmc7Wfuc54MySkPw, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* actual__eONN82g4rgn3kmQsBL5SWA, tyObject_TemplCtx__7Jzi7qpo50OxGz9aF5HyeJQ* c__FsXUtG6n9ahP9cIYI024uwSA, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* result__2CGi9aGnDohCd9aNtoJRn9bxw);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, copyNode__evaltempl_19)(tyObject_TemplCtx__7Jzi7qpo50OxGz9aF5HyeJQ* ctx__nasfLlJzCECMosKsfRCu5g, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* a__pWbFPrYy2V9cWfSZGn86zOA, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* b__wf3j5H9cI0REIa9cluWdkMaQ);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, wrapInComesFrom__evaltempl_260)(tyObject_TLineInfo__7ZAGqjaN6WqWPlHP9cRagRg info__uXWHUcaG6fBGXntWudt3vA, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* sym__TSbwcznIxr4bgCaeLy5wrQ, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* res__sl2REfoTlo2jNoIznApLWg);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___evaltempl_322)(tyObject_TemplCtx__7Jzi7qpo50OxGz9aF5HyeJQ* dest__iGQM9bZWBokr0y4Bq8GfQww);
...
{nimErr_ = nimErrorFlag();
	...
	{
		if (!fromHlo__mpvRcSbXGo0BJSv0KzZ5WA) goto LA6_;
		colontmpD__3 = ((NI)0);
	...
	LA6_: ;
	{
		colontmpD__4 = len__ast_3325((*(*s__9aifUoRKxwXyr9cRrYWtYIpw).ast)._kind_6.sons.p->data[((NI)2)]);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		genericParams = colontmpD__4;
	}
	LA4_: ;
	T9_ = (NI)0;
	T9_ = len__ast_5071((*s__9aifUoRKxwXyr9cRrYWtYIpw).typ);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA12_: ;
	{
		...
		liMessage__msgs_1169(conf__NQiixI09cu7KJUDtjZ9aAN9cw, (*n__D1ox5VZgLE2M1qmwLBTs9ag).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__bDep2LgNruC0l9bDFCq6TlQ_7, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)2), TM__bDep2LgNruC0l9bDFCq6TlQ_8, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA16_: ;
	{
		...
		T24_ = renderTree__renderer_50(n__D1ox5VZgLE2M1qmwLBTs9ag, T23_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA22_;
		colontmpD__5 = nsuFormatSingleElem(TM__bDep2LgNruC0l9bDFCq6TlQ_10, T24_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA22_;
		liMessage__msgs_1169(conf__NQiixI09cu7KJUDtjZ9aAN9cw, (*n__D1ox5VZgLE2M1qmwLBTs9ag).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__5, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)2), TM__bDep2LgNruC0l9bDFCq6TlQ_11, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA22_;
		{
			LA22_:;
		}
	...
	LA20_: ;
	result = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)152), (*n__D1ox5VZgLE2M1qmwLBTs9ag).info);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NI i;
		NI res;
		...
		res = ((NI)1);
		{
			while (1) {
				...
				i = res;
				add__ast_6233(result, (*n__D1ox5VZgLE2M1qmwLBTs9ag)._kind_6.sons.p->data[i]);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				res += ((NI)1);
			} LA29: ;
		}
	}
	{
		...
		res_2 = colontmp_;
		{
			while (1) {
				...
				default_1 = NIM_NIL;
				i_2 = res_2;
				eqcopy___ast_3457(&default_1, (*(*(*(*(*s__9aifUoRKxwXyr9cRrYWtYIpw).typ).n)._kind_6.sons.p->data[i_2])._kind_4.sym).ast);
				if (NIM_UNLIKELY(*nimErr_)) goto LA33_;
				{
					...
					liMessage__msgs_1169(conf__NQiixI09cu7KJUDtjZ9aAN9cw, (*n__D1ox5VZgLE2M1qmwLBTs9ag).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__bDep2LgNruC0l9bDFCq6TlQ_12, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__bDep2LgNruC0l9bDFCq6TlQ_13, NIM_FALSE);
					if (NIM_UNLIKELY(*nimErr_)) goto LA40_;
					colontmpD__6 = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)1), (*n__D1ox5VZgLE2M1qmwLBTs9ag).info);
					if (NIM_UNLIKELY(*nimErr_)) goto LA40_;
	...
	}
	{
		...
		res_3 = ((NI)1);
		{
			while (1) {
				...
				i_3 = res_3;
				add__ast_6233(result, (*n__D1ox5VZgLE2M1qmwLBTs9ag)._kind_6.sons.p->data[(NI)(givenRegularParams + i_3)]);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				res_3 += ((NI)1);
			} LA51: ;
		}
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	result = copyNode__ast_5733(a__pWbFPrYy2V9cWfSZGn86zOA);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!(*ctx__nasfLlJzCECMosKsfRCu5g).instLines) goto LA3_;
		setInfoRecursive__ast_3918(result, (*b__wf3j5H9cI0REIa9cluWdkMaQ).info);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	}BeforeRet_: ;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	switch ((*templ__9c3LpWmLmc7Wfuc54MySkPw).kind) {
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3):
	{
		tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s;
		s = NIM_NIL;
		eqcopy___ast_4063(&s, (*templ__9c3LpWmLmc7Wfuc54MySkPw)._kind_4.sym);
		if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
		{
			...
			T5_ = T6_;
			if (T5_) goto LA8_;
			T5_ = ((*s).owner == (*c__FsXUtG6n9ahP9cIYI024uwSA).owner);
			LA8_: ;
			if (!T5_) goto LA9_;
			{
				NIM_BOOL T13_;
				...
				eqcopy___ast_3457(&xX60gensym0_, (*actual__eONN82g4rgn3kmQsBL5SWA)._kind_6.sons.p->data[(*s).position]);
						...
						yX60gensym0_ = NIM_NIL;
						{
							...
							i_2 = ((NI)0);
							{
								while (1) {
									...
									if (NIM_UNLIKELY(*nimErr_)) goto LA17_;
									add__ast_6233(result__2CGi9aGnDohCd9aNtoJRn9bxw, yX60gensym0_);
									if (NIM_UNLIKELY(*nimErr_)) goto LA17_;
									i_2 += ((NI)1);
								} LA25: ;
							}
				...
				LA20_: ;
				{
					...
					add__ast_6233(result__2CGi9aGnDohCd9aNtoJRn9bxw, colontmpD_);
					if (NIM_UNLIKELY(*nimErr_)) goto LA27_;
					{
						LA27_:;
					}
			...
			LA15_: ;
			{
				...
				eqcopy___ast_3457(&xX60gensym4_, (*actual__eONN82g4rgn3kmQsBL5SWA)._kind_6.sons.p->data[(NI)((NI)(T44_ + (*s).position) - ((NI)1))]);
				if (NIM_UNLIKELY(*nimErr_)) goto LA43_;
				{
						...
						yX60gensym4_ = NIM_NIL;
						{
							...
							i_4 = ((NI)0);
							{
								while (1) {
									...
									if (NIM_UNLIKELY(*nimErr_)) goto LA43_;
									add__ast_6233(result__2CGi9aGnDohCd9aNtoJRn9bxw, yX60gensym4_);
									if (NIM_UNLIKELY(*nimErr_)) goto LA43_;
									i_4 += ((NI)1);
								} LA52: ;
							}
				...
				LA47_: ;
				{
					...
					add__ast_6233(result__2CGi9aGnDohCd9aNtoJRn9bxw, colontmpD__2);
					if (NIM_UNLIKELY(*nimErr_)) goto LA54_;
					{
						LA54_:;
					}
			...
			LA41_: ;
			{
				...
				x = NIM_NIL;
				{
					...
					argX60gensym7_ = toFileLineCol__msgs_664(TM__bDep2LgNruC0l9bDFCq6TlQ_20);
					if (NIM_UNLIKELY(*nimErr_)) goto LA67_;
					internalErrorImpl__msgs_1507((*c__FsXUtG6n9ahP9cIYI024uwSA).config, unknownLineInfo__lineinfos_350, argX60gensym7_, TM__bDep2LgNruC0l9bDFCq6TlQ_20);
					if (NIM_UNLIKELY(*nimErr_)) goto LA67_;
					{
						LA67_:;
					}
				...
				LA65_: ;
				T70_ = NIM_NIL;
				T70_ = idTableGet__astalgo_65((*c__FsXUtG6n9ahP9cIYI024uwSA).mapping, (*((tyObject_TIdObj__jPSvrmNCWI4CL3MSWxUHJQ**) (&(s)))));
				if (NIM_UNLIKELY(*nimErr_)) goto LA60_;
				x = ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) (T70_));
				{
					...
					T75_ = nextSymId__ast_3268((*c__FsXUtG6n9ahP9cIYI024uwSA).idgen);
					if (NIM_UNLIKELY(*nimErr_)) goto LA60_;
					T76_ = NIM_NIL;
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA60_;
					idTablePut__astalgo_71((&(*c__FsXUtG6n9ahP9cIYI024uwSA).mapping), (*((tyObject_TIdObj__jPSvrmNCWI4CL3MSWxUHJQ**) (&(s)))), (*((RootObj**) (&(x)))));
					if (NIM_UNLIKELY(*nimErr_)) goto LA60_;
				}
				LA73_: ;
				{
					...
					colontmpD__3 = dollar___systemZdollars_3((*c__FsXUtG6n9ahP9cIYI024uwSA).instID);
					if (NIM_UNLIKELY(*nimErr_)) goto LA60_;
...
appendString((&T81_), colontmpD__3);
					colontmpD__4 = T81_;
					colontmpD__5 = getIdent__idents_166((*c__FsXUtG6n9ahP9cIYI024uwSA).ic, colontmpD__4);
					if (NIM_UNLIKELY(*nimErr_)) goto LA60_;
					{
						if (!(*c__FsXUtG6n9ahP9cIYI024uwSA).instLines) goto LA85_;
						colontmpD__6 = (*actual__eONN82g4rgn3kmQsBL5SWA).info;
						T82_ = colontmpD__6;
					}
					goto LA83_;
					LA85_: ;
					{
						colontmpD__7 = (*templ__9c3LpWmLmc7Wfuc54MySkPw).info;
						T82_ = colontmpD__7;
					}
					LA83_: ;
					colontmpD__8 = newIdentNode__ast_4780(colontmpD__5, T82_);
					if (NIM_UNLIKELY(*nimErr_)) goto LA60_;
					add__ast_6233(result__2CGi9aGnDohCd9aNtoJRn9bxw, colontmpD__8);
					if (NIM_UNLIKELY(*nimErr_)) goto LA60_;
				...
				LA79_: ;
				{
					...
					{
						if (!(*c__FsXUtG6n9ahP9cIYI024uwSA).instLines) goto LA92_;
						colontmpD__9 = (*actual__eONN82g4rgn3kmQsBL5SWA).info;
						T89_ = colontmpD__9;
					}
					goto LA90_;
					LA92_: ;
					{
						colontmpD__10 = (*templ__9c3LpWmLmc7Wfuc54MySkPw).info;
						T89_ = colontmpD__10;
					}
					LA90_: ;
					colontmpD__11 = newSymNode__ast_4787(x, T89_);
					if (NIM_UNLIKELY(*nimErr_)) goto LA60_;
					add__ast_6233(result__2CGi9aGnDohCd9aNtoJRn9bxw, colontmpD__11);
					if (NIM_UNLIKELY(*nimErr_)) goto LA60_;
		...
		LA9_: ;
		{
			...
			colontmpD__12 = copyNode__evaltempl_19((&(*c__FsXUtG6n9ahP9cIYI024uwSA)), templ__9c3LpWmLmc7Wfuc54MySkPw, actual__eONN82g4rgn3kmQsBL5SWA);
			if (NIM_UNLIKELY(*nimErr_)) goto LA98_;
			add__ast_6233(result__2CGi9aGnDohCd9aNtoJRn9bxw, colontmpD__12);
			if (NIM_UNLIKELY(*nimErr_)) goto LA98_;
			{
				LA98_:;
			}
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)4) ... ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)23):
	{
		...
		colontmpD__13 = copyNode__evaltempl_19((&(*c__FsXUtG6n9ahP9cIYI024uwSA)), templ__9c3LpWmLmc7Wfuc54MySkPw, actual__eONN82g4rgn3kmQsBL5SWA);
		if (NIM_UNLIKELY(*nimErr_)) goto LA104_;
		add__ast_6233(result__2CGi9aGnDohCd9aNtoJRn9bxw, colontmpD__13);
		if (NIM_UNLIKELY(*nimErr_)) goto LA104_;
		{
			LA104_:;
		}
	...
	{
		{
			...
			if (!(*c__FsXUtG6n9ahP9cIYI024uwSA).isDeclarative) goto LA110_;
			res = NIM_NIL;
			res = copyNode__evaltempl_19((&(*c__FsXUtG6n9ahP9cIYI024uwSA)), templ__9c3LpWmLmc7Wfuc54MySkPw, actual__eONN82g4rgn3kmQsBL5SWA);
			if (NIM_UNLIKELY(*nimErr_)) goto LA112_;
			{
				...
				i_5 = (NI)0;
				colontmp__3 = (NI)0;
				colontmp__3 = len__ast_3325(templ__9c3LpWmLmc7Wfuc54MySkPw);
				if (NIM_UNLIKELY(*nimErr_)) goto LA112_;
				i_6 = ((NI)0);
				{
					while (1) {
						...
						i_5 = i_6;
						evalTemplateAux__evaltempl_24((*templ__9c3LpWmLmc7Wfuc54MySkPw)._kind_6.sons.p->data[i_5], actual__eONN82g4rgn3kmQsBL5SWA, c__FsXUtG6n9ahP9cIYI024uwSA, res);
						if (NIM_UNLIKELY(*nimErr_)) goto LA112_;
						i_6 += ((NI)1);
					} LA115: ;
				}
			}
			add__ast_6233(result__2CGi9aGnDohCd9aNtoJRn9bxw, res);
			if (NIM_UNLIKELY(*nimErr_)) goto LA112_;
			{
				LA112_:;
			}
		...
		LA110_: ;
		{
			...
			colontmpD__14 = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)1), (*templ__9c3LpWmLmc7Wfuc54MySkPw).info);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			add__ast_6233(result__2CGi9aGnDohCd9aNtoJRn9bxw, colontmpD__14);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	default:
	{
		...
		isDeclarative = NIM_FALSE;
		{
			NIM_BOOL T122_;
			T122_ = (NIM_BOOL)0;
			T122_ = ((TM__bDep2LgNruC0l9bDFCq6TlQ_23[(NU)(((*templ__9c3LpWmLmc7Wfuc54MySkPw).kind))>>3] &(1U<<((NU)(((*templ__9c3LpWmLmc7Wfuc54MySkPw).kind))&7U)))!=0);
			if (!(T122_)) goto LA123_;
			T122_ = !((*c__FsXUtG6n9ahP9cIYI024uwSA).isDeclarative);
			LA123_: ;
			if (!T122_) goto LA124_;
			(*c__FsXUtG6n9ahP9cIYI024uwSA).isDeclarative = NIM_TRUE;
		...
		LA124_: ;
		{
			...
			T128_ = (NIM_BOOL)0;
			T129_ = (NIM_BOOL)0;
			T129_ = !((*c__FsXUtG6n9ahP9cIYI024uwSA).isDeclarative);
			if (!(T129_)) goto LA130_;
			T129_ = ((*templ__9c3LpWmLmc7Wfuc54MySkPw).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)27) || (*templ__9c3LpWmLmc7Wfuc54MySkPw).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)29) || (*templ__9c3LpWmLmc7Wfuc54MySkPw).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)30) || (*templ__9c3LpWmLmc7Wfuc54MySkPw).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)31) || (*templ__9c3LpWmLmc7Wfuc54MySkPw).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)26) || (*templ__9c3LpWmLmc7Wfuc54MySkPw).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)28) || (*templ__9c3LpWmLmc7Wfuc54MySkPw).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)32));
			LA130_: ;
			T128_ = T129_;
			if (!(T128_)) goto LA131_;
			T128_ = isRunnableExamples__ast_6127((*templ__9c3LpWmLmc7Wfuc54MySkPw)._kind_6.sons.p->data[((NI)0)]);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			LA131_: ;
		...
		LA132_: ;
		{
			...
			res_2 = NIM_NIL;
			res_2 = copyNode__evaltempl_19((&(*c__FsXUtG6n9ahP9cIYI024uwSA)), templ__9c3LpWmLmc7Wfuc54MySkPw, actual__eONN82g4rgn3kmQsBL5SWA);
			if (NIM_UNLIKELY(*nimErr_)) goto LA135_;
			{
				...
				i_7 = (NI)0;
				colontmp__4 = (NI)0;
				colontmp__4 = len__ast_3325(templ__9c3LpWmLmc7Wfuc54MySkPw);
				if (NIM_UNLIKELY(*nimErr_)) goto LA135_;
				i_8 = ((NI)0);
				{
					while (1) {
						...
						i_7 = i_8;
						evalTemplateAux__evaltempl_24((*templ__9c3LpWmLmc7Wfuc54MySkPw)._kind_6.sons.p->data[i_7], actual__eONN82g4rgn3kmQsBL5SWA, c__FsXUtG6n9ahP9cIYI024uwSA, res_2);
						if (NIM_UNLIKELY(*nimErr_)) goto LA135_;
						i_8 += ((NI)1);
					} LA138: ;
				}
			}
			add__ast_6233(result__2CGi9aGnDohCd9aNtoJRn9bxw, res_2);
			if (NIM_UNLIKELY(*nimErr_)) goto LA135_;
			{
				LA135_:;
			}
		...
		LA126_: ;
		{
			...
			(*c__FsXUtG6n9ahP9cIYI024uwSA).isDeclarative = NIM_FALSE;
		}
		LA143_: ;
	}
	break;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	eqcopy___ast_3457(&result, res__sl2REfoTlo2jNoIznApLWg);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*result).info = info__uXWHUcaG6fBGXntWudt3vA;
	{
		NIM_BOOL T3_;
		NI T5_;
		tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* colontmpD_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(*colontmpD_).info = info__uXWHUcaG6fBGXntWudt3vA;
		eqdestroy___ast_3454(&colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA6_: ;
...
{nimErr_ = nimErrorFlag();
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLast((*dest__iGQM9bZWBokr0y4Bq8GfQww).owner);
		if (!T3_) goto LA4_;
		nimDestroyAndDispose((*dest__iGQM9bZWBokr0y4Bq8GfQww).owner);
	}
	LA4_: ;
	{
		NIM_BOOL T8_;
		T8_ = (NIM_BOOL)0;
		T8_ = nimDecRefIsLast((*dest__iGQM9bZWBokr0y4Bq8GfQww).genSymOwner);
		if (!T8_) goto LA9_;
		nimDestroyAndDispose((*dest__iGQM9bZWBokr0y4Bq8GfQww).genSymOwner);
	}
	LA9_: ;
	eqdestroy___ast_4524((&(*dest__iGQM9bZWBokr0y4Bq8GfQww).mapping.data));
	{
		NIM_BOOL T13_;
		T13_ = (NIM_BOOL)0;
		T13_ = nimDecRefIsLast((*dest__iGQM9bZWBokr0y4Bq8GfQww).config);
		if (!T13_) goto LA14_;
		eqdestroy___options_3149((*dest__iGQM9bZWBokr0y4Bq8GfQww).config);
		nimRawDispose((*dest__iGQM9bZWBokr0y4Bq8GfQww).config, ((NI)8));
	}
	LA14_: ;
	{
		NIM_BOOL T18_;
		T18_ = (NIM_BOOL)0;
		T18_ = nimDecRefIsLastCyclicStatic((*dest__iGQM9bZWBokr0y4Bq8GfQww).ic, (&NTIv2__4yiDOEx3Y9aOTV1fsziBtCQ_));
		if (!T18_) goto LA19_;
		eqdestroy___idents_224((*dest__iGQM9bZWBokr0y4Bq8GfQww).ic);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__iGQM9bZWBokr0y4Bq8GfQww).ic, ((NI)4));
	}
	LA19_: ;
	{
		NIM_BOOL T23_;
		T23_ = (NIM_BOOL)0;
		T23_ = nimDecRefIsLastCyclicStatic((*dest__iGQM9bZWBokr0y4Bq8GfQww).idgen, (&NTIv2__C1k2TcDRT9cU4DEatQIT09ag_));
		if (!T23_) goto LA24_;
		eqdestroy___ast_3232((*dest__iGQM9bZWBokr0y4Bq8GfQww).idgen);
		nimRawDispose((*dest__iGQM9bZWBokr0y4Bq8GfQww).idgen, ((NI)4));
	}
	LA24_: ;
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	...
	body = NIM_NIL;
	(*conf__MKZaYzeJ1zniM9b4AnsDN3w).evalTemplateCounter += ((NI)1);
	{
		if (!(((NI)1000) < (*conf__MKZaYzeJ1zniM9b4AnsDN3w).evalTemplateCounter)) goto LA4_;
		liMessage__msgs_1169(conf__MKZaYzeJ1zniM9b4AnsDN3w, (*n__9ar3z0FUAYPHIFyOX9cUp9awQ).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__bDep2LgNruC0l9bDFCq6TlQ_3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)2), TM__bDep2LgNruC0l9bDFCq6TlQ_4, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		eqcopy___ast_3457(&result, n__9ar3z0FUAYPHIFyOX9cUp9awQ);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA4_: ;
	args = evalTemplateArgs__evaltempl_197(n__9ar3z0FUAYPHIFyOX9cUp9awQ, tmpl__MyuJIZCEIGEoiqml5nfw1w, conf__MKZaYzeJ1zniM9b4AnsDN3w, fromHlo__a0sNVrxkEqwAYS7KUw9bh9bQ);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqcopy___ast_4063(&ctx.owner, tmpl__MyuJIZCEIGEoiqml5nfw1w);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqcopy___ast_4063(&ctx.genSymOwner, genSymOwner__V6rL3bau1kkgKjlf1TQlEg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqcopy___options_3378(&ctx.config, conf__MKZaYzeJ1zniM9b4AnsDN3w);
	eqcopy___idents_266(&ctx.ic, ic__CTdyrdMdvjpimDZscsjwgg, NIM_TRUE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	initIdTable__ast_5200((&ctx.mapping));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	ctx.instID = (*instID__zyn69ahB3DLxn9bsaPf89cz9bA);
	eqcopy___ast_3247(&ctx.idgen, idgen__lhfG6G3eUNT2uF3Kj4vfUg, NIM_TRUE);
	eqcopy___ast_3457(&body, (*(*tmpl__MyuJIZCEIGEoiqml5nfw1w).ast)._kind_6.sons.p->data[((NI)6)]);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NIM_BOOL T8_;
		T8_ = (NIM_BOOL)0;
...
appendString((&T18_), colontmpD_);
			colontmpD__2 = T18_;
			liMessage__msgs_1169(conf__MKZaYzeJ1zniM9b4AnsDN3w, (*result).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__bDep2LgNruC0l9bDFCq6TlQ_26, NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA17_;
			{
				LA17_:;
			}
	...
	LA9_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		ctx.instLines = (((*tmpl__MyuJIZCEIGEoiqml5nfw1w).flags &((NU64)1<<((NU)((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)36)))&63U)))!=0);
		{
			if (!ctx.instLines) goto LA24_;
			setInfoRecursive__ast_3918(result, (*n__9ar3z0FUAYPHIFyOX9cUp9awQ).info);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		}
		LA24_: ;
		{
	...
	T29_ = NIM_NIL;
	T29_ = wrapInComesFrom__evaltempl_260((*n__9ar3z0FUAYPHIFyOX9cUp9awQ).info, tmpl__MyuJIZCEIGEoiqml5nfw1w, result);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqsink___ast_3460(&result, T29_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	(*conf__MKZaYzeJ1zniM9b4AnsDN3w).evalTemplateCounter -= ((NI)1);
	(*instID__zyn69ahB3DLxn9bsaPf89cz9bA) += ((NI)1);
	{
		LA1_:;
	}
	{
