...
N_LIB_PRIVATE N_NIMCALL(void, now__pureZtimes_1710)(tyObject_DateTime__d9cK9cyKZPJJxFXUmx8dSpPw* Result);
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (T3_) goto LA4_;
		T5_ = (NIM_CHAR*)0;
		T5_ = X5BX5D___system_7101(dest__mlcrjR9afZOEzcsXiEnNpqA, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T3_ = !(((NU8)((*T5_)) == (NU8)(32)));
		LA4_: ;
		if (!T3_) goto LA6_;
...
appendString((&T13_), compileCmd__0syEUs7jROZtM06IB1e3Fw);
		...
		LA10_: ;
		{
			...
			colontmpD__5 = nossplitFile(colontmpD__4);
			if (NIM_UNLIKELY(*nimErr_)) goto LA17_;
...
appendString((&T21_), TM__pZmXgBT0YcBrnAO6VUvpNQ_337);
	linkerArgs = T21_;
	args = substr__system_7585(cmd__9clorThsgzIMyUFcc4fDYtA, i);
	{
		NIM_BOOL T24_;
		NimStringV2 colontmpD_;
		T24_ = (NIM_BOOL)0;
	...
	colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
	T34_.len = 0; T34_.p = NIM_NIL;
	colontmpD__2 = substr__system_7573(cmd__9clorThsgzIMyUFcc4fDYtA, ((NI)0), last);
...
{nimErr_ = nimErrorFlag();
	...
	colontmp_ = nossplitFile(colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	_ = colontmp_.Field0;
											...
											while (1) {
												{
													...
													idxX60gensym10_ = (NI)((NI)(ffX60gensym10_.len - colontmp_.len) + dotPosX60gensym10_);
													{
														...
														colontmpD__9 = nossplitFile(colontmpD__8);
														if (NIM_UNLIKELY(*nimErr_)) goto LA87_;
...
appendString((&T21_), colontmpD__6);
			...
			LA15_: ;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
				colontmpD__9 = T26_;
				quit__system_7009(colontmpD__9, ((NI)1));
				eqdestroy___stdZassertions_13((&colontmpD__9));
				eqdestroy___stdZassertions_13((&colontmpD__8));
			}
			LA12_: ;
