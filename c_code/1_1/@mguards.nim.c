	...
	{
		{
			...
			if (!T10_) goto LA11_;
			colontmpD_ = NIM_NIL;
			colontmpD_ = skipConv__types_3830((*fact)._kind_6.sons.p->data[((NI)2)]);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		LA11_: ;
		{
			...
			colontmpD__2 = skipConv__types_3830((*fact)._kind_6.sons.p->data[((NI)1)]);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = (tyEnum_TImplication__laI8nMOYTJ5GihJVMgj11A)0;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		max = lastOrd__types_1504(((tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg*) NIM_NIL), (*x).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		{
...
{nimErr_ = nimErrorFlag();
	...
	LA6_: ;
	{
		...
		if (!T16_) goto LA20_;
		{
			...
			NIM_BOOL T25_;
			T24_ = lastOrd__types_1504(((tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg*) NIM_NIL), (*a).typ);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			T25_ = (NIM_BOOL)0;
			T25_ = lteq___int495056_745(T24_, (*b)._kind_1.intVal);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			if (!T25_) goto LA26_;
			result = ((tyEnum_TImplication__laI8nMOYTJ5GihJVMgj11A)2);
			eqdestroy___ast_3454(&y_2);
	...
	LA20_: ;
	{
		...
		if (!T30_) goto LA34_;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			T39_ = (NIM_BOOL)0;
			T39_ = lteq___int495056_752((*a)._kind_1.intVal, T38_);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			if (!T39_) goto LA40_;
			result = ((tyEnum_TImplication__laI8nMOYTJ5GihJVMgj11A)2);
			eqdestroy___ast_3454(&y_2);
...
{nimErr_ = nimErrorFlag();
	...
	T2_ = NIM_NIL;
	{
		...
		T7_ = lastOrd__types_1504(conf, typ);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
appendString((&T17_), colontmpD_);
						colontmpD__2 = T17_;
						liMessage__msgs_1159(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__lf9coCS0CxBb8QizHhZZpAA_9, NIM_FALSE);
						if (NIM_UNLIKELY(*nimErr_)) goto LA16_;
						{
							LA16_:;
						}
					...
					LA14_: ;
					{
						...
						liMessage__msgs_1159(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)46), colontmpD__3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__lf9coCS0CxBb8QizHhZZpAA_11, NIM_FALSE);
						if (NIM_UNLIKELY(*nimErr_)) goto LA22_;
						{
							LA22_:;
						}
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)119):
	{
		...
		colontmpD_ = NIM_NIL;
		{
			...
			NIM_BOOL T7_;
			T5_ = (NIM_BOOL)0;
			colontmpD_ = skipConv__types_3830((*n)._kind_6.sons.p->data[((NI)2)]);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
