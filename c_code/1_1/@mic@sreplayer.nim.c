				...
				while (1) {
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
					{
						...
						if (!(((NI)2) <= T9_)) goto LA10_;
						{
							...
							internalErrorImpl__msgs_1497((*g).config, unknownLineInfo__lineinfos_350, argX60gensym10_, TM__N5M6b9cz9aCakDdwShXiixyw_8);
							if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
							{
								LA18_:;
							}
...
break;
						...
						LA21_: ;
						{
							liMessage__msgs_1159((*g).config, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)109), (*(*n)._kind_6.sons.p->data[((NI)1)])._kind_3.strVal, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__N5M6b9cz9aCakDdwShXiixyw_36, NIM_FALSE);
							if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
						}
						goto LA35_;
						LA22_: ;
						{
							liMessage__msgs_1159((*g).config, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)77), (*(*n)._kind_6.sons.p->data[((NI)1)])._kind_3.strVal, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__N5M6b9cz9aCakDdwShXiixyw_37, NIM_FALSE);
							if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
						}
						goto LA35_;
						LA23_: ;
						{
							liMessage__msgs_1159((*g).config, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)18), (*(*n)._kind_6.sons.p->data[((NI)1)])._kind_3.strVal, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__N5M6b9cz9aCakDdwShXiixyw_38, NIM_FALSE);
							if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
						}
						goto LA35_;
						LA24_: ;
						{
							...
							colontmpD__6.len = 0; colontmpD__6.p = NIM_NIL;
							{
								...
								internalErrorImpl__msgs_1497((*g).config, unknownLineInfo__lineinfos_350, argX60gensym23_, TM__N5M6b9cz9aCakDdwShXiixyw_39);
								if (NIM_UNLIKELY(*nimErr_)) goto LA48_;
								{
									LA48_:;
								}
						...
						LA28_: ;
						{
							...
							colontmpD__7 = toFullPathConsiderDirty__msgs_610((*g).config, (*module).info.fileIndex);
						...
						LA30_: ;
						{
							...
							v = getOrDefault__vm_4279((*g).cacheCounters, destKey);
							if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
							X5BX5Deq___vm_4726((&(*g).cacheCounters), destKey, (NI64)(v + by));
							if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
						...
						LA31_: ;
						{
							...
							if (NIM_UNLIKELY(*nimErr_)) goto LA63_;
							{
								...
								T66_ = (NIM_BOOL)0;
								T66_ = contains__vm_8147((*g).cacheTables, destKey_2);
								if (NIM_UNLIKELY(*nimErr_)) goto LA63_;
								if (!!(T66_)) goto LA67_;
								nimZeroMem((void*)(&T69_), sizeof(tyObject_BTree__BxbTQohN8QrxN73DA9bcM9aQ));
								initBTree__vm_8413((&T69_));
								if (NIM_UNLIKELY(*nimErr_)) goto LA63_;
								X5BX5Deq___vm_8488((&(*g).cacheTables), destKey_2, T69_);
								if (NIM_UNLIKELY(*nimErr_)) goto LA63_;
							}
							LA67_: ;
							{
								...
								T72_ = X5BX5D___vm_9662((&(*g).cacheTables), destKey_2);
								if (NIM_UNLIKELY(*nimErr_)) goto LA63_;
								T73_ = (NIM_BOOL)0;
								...
								T76_ = X5BX5D___vm_9662((&(*g).cacheTables), destKey_2);
								if (NIM_UNLIKELY(*nimErr_)) goto LA63_;
...
appendString((&T79_), key);
								colontmpD__8 = T79_;
								internalErrorImpl__msgs_1497((*g).config, (*n).info, colontmpD__8, TM__N5M6b9cz9aCakDdwShXiixyw_42);
						...
						LA32_: ;
						{
							...
							if (NIM_UNLIKELY(*nimErr_)) goto LA85_;
							{
								...
								T88_ = (NIM_BOOL)0;
								T88_ = contains__vm_5914((*g).cacheSeqs, destKey_3);
								if (NIM_UNLIKELY(*nimErr_)) goto LA85_;
								if (!!(T88_)) goto LA89_;
								...
								if (NIM_UNLIKELY(*nimErr_)) goto LA85_;
								X5BX5Deq___vm_6215((&(*g).cacheSeqs), destKey_3, T92_);
								if (NIM_UNLIKELY(*nimErr_)) goto LA85_;
							}
							goto LA86_;
							LA89_: ;
							{
								{
									tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q** T108_;
									{
										...
										T97_ = X5BX5D___vm_7385((&(*g).cacheSeqs), destKey_3);
									...
									T108_ = X5BX5D___vm_7385((&(*g).cacheSeqs), destKey_3);
									if (NIM_UNLIKELY(*nimErr_)) goto LA85_;
						...
						LA33_: ;
						{
							...
							if (NIM_UNLIKELY(*nimErr_)) goto LA112_;
							{
								...
								T115_ = (NIM_BOOL)0;
								T115_ = contains__vm_5914((*g).cacheSeqs, destKey_4);
								if (NIM_UNLIKELY(*nimErr_)) goto LA112_;
								...
								if (NIM_UNLIKELY(*nimErr_)) goto LA112_;
								X5BX5Deq___vm_6215((&(*g).cacheSeqs), destKey_4, T119_);
								if (NIM_UNLIKELY(*nimErr_)) goto LA112_;
							}
							goto LA113_;
							LA116_: ;
							{
								...
								T121_ = X5BX5D___vm_7385((&(*g).cacheSeqs), destKey_4);
								if (NIM_UNLIKELY(*nimErr_)) goto LA112_;
						...
						{
							{
								...
								internalErrorImpl__msgs_1497((*g).config, unknownLineInfo__lineinfos_350, argX60gensym44_, TM__N5M6b9cz9aCakDdwShXiixyw_43);
								if (NIM_UNLIKELY(*nimErr_)) goto LA129_;
								{
									LA129_:;
								}
