...
N_LIB_PRIVATE N_NIMCALL(NI, parseBiggestUInt__pureZparseutils_842)(NimStringV2 s__3r3xnog9a5gvJEqQScHPalw, NU64* number__UVaDMBBT9cUGbGfw7lMnNWQ, NI start__5iVTWDd9aMm23UyrNcAvqrg);
...
N_LIB_PRIVATE N_NIMCALL(NI, parseBiggestInt__pureZparseutils_827)(NimStringV2 s__jXqB5Mys9bZU9azrXwgfLOjQ, NI64* number__9akdURYDgwp4tfenwe5w7og, NI start__9afTQ2RaT8cyU9cGdr6EoL8A);
...
{nimErr_ = nimErrorFlag();
	...
	LA9_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__gJe19aFDh2GPNTbY9c88A0Uw).cache, ((NI)4));
	}
	LA14_: ;
	{
		NIM_BOOL T18_;
...
{nimErr_ = nimErrorFlag();
	T1_ = (NI32)0;
	T1_ = fileInfoIdx__msgs_391(config__FfvGhne88m0ffceEH8qirg, filename__KYmv9bas3qMJGPfFUYvsblw);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	{
		...
		liMessage__msgs_1169((*L__lqyFoTHNBbdc79a8ZPWpWBQ).config, info__9cqKvwAWabqSbYgHR29b9aDnA, msg__jXk2drR0Hy7fJL3D6HK8Sw, arg__krVpVdUH5l6nNLKB3dV85g, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__U89bXmCxR9cj7Cd2NafLayNA_5, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA1_;
	LA3_: ;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	info = newLineInfo__msgs_406((*L__OA9c8ZFh5yYyftE85YDFvcA).fileIdx, (*L__OA9c8ZFh5yYyftE85YDFvcA).Sup.lineNumber, (NI)(pos__6cBBkVF9b7wKIYWltYSPfYg - (*L__OA9c8ZFh5yYyftE85YDFvcA).Sup.lineStart));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = newLineInfo__msgs_406((*L__8JTfznWS3TyDzkwuAShIdQ).fileIdx, (*L__8JTfznWS3TyDzkwuAShIdQ).Sup.lineNumber, T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	LA26_: ;
	{
		(*tok__lwSpCO9cdgJAvGWF9bsuqHMA).tokType = ((tyEnum_TokType__FBGVnQ0tiQKJV9co2BPPhQQ) ((NI)((*(*tok__lwSpCO9cdgJAvGWF9bsuqHMA).ident).id + ((NI)2))));
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA36_;
			liMessage__msgs_1169((*L__mZIZWye9c1nranxhC89aZWEg).config, T43_, msgX60gensym143_, mX60gensym143_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__U89bXmCxR9cj7Cd2NafLayNA_21, NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA36_;
			{
				LA36_:;
			}
...
{nimErr_ = nimErrorFlag();
	...
	case 48 ... 57:
	{
		(*xi__DkKhBCncXdBwnBmoTErfIg) = (NI)((NI)((NU32)((*xi__DkKhBCncXdBwnBmoTErfIg)) << (NU32)(((NI)4))) | (NI)(((NU8)((*L__lOWLDnTDX9cRPhNdAlSL5rQ).Sup.buf[(*L__lOWLDnTDX9cRPhNdAlSL5rQ).Sup.bufpos])) - ((NI)48)));
		(*L__lOWLDnTDX9cRPhNdAlSL5rQ).Sup.bufpos += ((NI)1);
	}
	break;
	case 97 ... 102:
	{
		(*xi__DkKhBCncXdBwnBmoTErfIg) = (NI)((NI)((NU32)((*xi__DkKhBCncXdBwnBmoTErfIg)) << (NU32)(((NI)4))) | (NI)((NI)(((NU8)((*L__lOWLDnTDX9cRPhNdAlSL5rQ).Sup.buf[(*L__lOWLDnTDX9cRPhNdAlSL5rQ).Sup.bufpos])) - ((NI)97)) + ((NI)10)));
		(*L__lOWLDnTDX9cRPhNdAlSL5rQ).Sup.bufpos += ((NI)1);
	}
	break;
	case 65 ... 70:
	{
		(*xi__DkKhBCncXdBwnBmoTErfIg) = (NI)((NI)((NU32)((*xi__DkKhBCncXdBwnBmoTErfIg)) << (NU32)(((NI)4))) | (NI)((NI)(((NU8)((*L__lOWLDnTDX9cRPhNdAlSL5rQ).Sup.buf[(*L__lOWLDnTDX9cRPhNdAlSL5rQ).Sup.bufpos])) - ((NI)65)) + ((NI)10)));
		(*L__lOWLDnTDX9cRPhNdAlSL5rQ).Sup.bufpos += ((NI)1);
	}
	break;
	case 34:
...
N_LIB_PRIVATE N_NIMCALL(void, addUnicodeCodePoint__lexer_993)(NimStringV2* s__evRemYznzqvP0Hd2Z7wllQ, NI i__WHcpV4WNWuGaH5AxIWqvSQ) {
	...
	LA3_: ;
	{
		...
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)0))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)6))) | ((NU)192))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
	...
	LA6_: ;
	{
		...
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)0))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)12))) | ((NU)224))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)1))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)6))) & ((NU)63)) | ((NU)128))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
	...
	LA9_: ;
	{
		...
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)0))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)18))) | ((NU)240))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)1))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)12))) & ((NU)63)) | ((NU)128))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)2))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)6))) & ((NU)63)) | ((NU)128))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
	...
	LA12_: ;
	{
		...
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)0))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)24))) | ((NU)248))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)1))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)18))) & ((NU)63)) | ((NU)128))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)2))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)12))) & ((NU)63)) | ((NU)128))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)3))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)6))) & ((NU)63)) | ((NU)128))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
	...
	LA15_: ;
	{
		...
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)0))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)30))) | ((NU)252))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)1))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)24))) & ((NU)63)) | ((NU)128))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)2))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)18))) & ((NU)63)) | ((NU)128))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)3))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)12))) & ((NU)63)) | ((NU)128))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
		(*s__evRemYznzqvP0Hd2Z7wllQ).p->data[(NI)(pos + ((NI)4))] = ((NIM_CHAR) (((NI) ((NU)((NU)((NU)((NU32)(i_2) >> (NU32)(((NI)6))) & ((NU)63)) | ((NU)128))))));
		nimPrepareStrMutationV2((&(*s__evRemYznzqvP0Hd2Z7wllQ)));
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__gJe19aFDh2GPNTbY9c88A0Uw_2).ident, ((NI)4));
	}
	LA4_: ;
...
{nimErr_ = nimErrorFlag();
	...
	startpos = (*L__PmJaVB5YtCxY2eHA5jiemw).Sup.bufpos;
	{
		...
		default:
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			internalErrorImpl__msgs_1507((*L__PmJaVB5YtCxY2eHA5jiemw).config, T21_, TM__U89bXmCxR9cj7Cd2NafLayNA_73, TM__U89bXmCxR9cj7Cd2NafLayNA_74);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		break;
		}
	...
	LA104_: ;
	{
		...
		pos = startpos;
		{
			...
			default:
			{
				...
				internalErrorImpl__msgs_1507((*L__PmJaVB5YtCxY2eHA5jiemw).config, T140_, TM__U89bXmCxR9cj7Cd2NafLayNA_110, TM__U89bXmCxR9cj7Cd2NafLayNA_111);
				if (NIM_UNLIKELY(*nimErr_)) goto LA110_;
			}
			break;
			}
			...
			default:
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA110_;
				internalErrorImpl__msgs_1507((*L__PmJaVB5YtCxY2eHA5jiemw).config, T203_, TM__U89bXmCxR9cj7Cd2NafLayNA_112, TM__U89bXmCxR9cj7Cd2NafLayNA_113);
				if (NIM_UNLIKELY(*nimErr_)) goto LA110_;
			}
			break;
			}
		...
		LA115_: ;
		{
			...
			case ((tyEnum_TokType__FBGVnQ0tiQKJV9co2BPPhQQ)74):
			{
				...
				len = (NI)0;
				T222_ = (NI)0;
				T222_ = parseBiggestUInt__pureZparseutils_842((*result__ZJ9aElC4pwklvIS3hrUVR2w).literal, (&iNumber), ((NI)0));
...
goto LA110_;
			...
			default:
			{
				...
				len_2 = (NI)0;
				T236_ = (NI)0;
				T236_ = parseBiggestInt__pureZparseutils_827((*result__ZJ9aElC4pwklvIS3hrUVR2w).literal, (&iNumber_2), ((NI)0));
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	info = newLineInfo__msgs_406((*L__hUQXgyq9af7ZLE6aFgo3Svw).fileIdx, (*tok__9bgq9bb55o7YdlIBdbc7ba6Q).line, (*tok__9bgq9bb55o7YdlIBdbc7ba6Q).col);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TokType__FBGVnQ0tiQKJV9co2BPPhQQ)110):
	{
		...
		relevantChar = (*(*tok__gKJURh611IYGidwMnIaFPw).ident).s.p->data[((NI)0)];
		{
			...
			if (!(T5_)) goto LA6_;
			T7_ = (NIM_CHAR*)0;
			T7_ = X5BX5D___system_7101((&(*(*tok__gKJURh611IYGidwMnIaFPw).ident).s), ((NI)1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			T5_ = ((NU8)((*T7_)) == (NU8)(62));
			LA6_: ;
			T4_ = T5_;
			if (!(T4_)) goto LA8_;
			T9_ = (NIM_CHAR*)0;
			T9_ = X5BX5D___system_7101((&(*(*tok__gKJURh611IYGidwMnIaFPw).ident).s), ((NI)2));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case 94:
		{
			...
			colontmpD__2 = (NI)0;
			{
				NIM_CHAR* T15_;
				T15_ = (NIM_CHAR*)0;
				T15_ = X5BX5D___system_7101((&(*(*tok__gKJURh611IYGidwMnIaFPw).ident).s), ((NI)1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case 92:
		{
			...
			colontmpD__4 = (NI)0;
			{
				NIM_CHAR* T22_;
				T22_ = (NIM_CHAR*)0;
				T22_ = X5BX5D___system_7101((&(*(*tok__gKJURh611IYGidwMnIaFPw).ident).s), ((NI)1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case 124:
		{
			...
			colontmpD__6 = (NI)0;
			{
				NIM_CHAR* T30_;
				T30_ = (NIM_CHAR*)0;
				T30_ = X5BX5D___system_7101((&(*(*tok__gKJURh611IYGidwMnIaFPw).ident).s), ((NI)1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case 38:
		{
			...
			colontmpD__8 = (NI)0;
			{
				NIM_CHAR* T37_;
				T37_ = (NIM_CHAR*)0;
				T37_ = X5BX5D___system_7101((&(*(*tok__gKJURh611IYGidwMnIaFPw).ident).s), ((NI)1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case 46:
		{
			...
			colontmpD__10 = (NI)0;
			{
				NIM_CHAR* T45_;
				T45_ = (NIM_CHAR*)0;
				T45_ = X5BX5D___system_7101((&(*(*tok__gKJURh611IYGidwMnIaFPw).ident).s), ((NI)1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		{
			{
				NIM_CHAR* T53_;
				T53_ = (NIM_CHAR*)0;
				T53_ = X5BX5D___system_7101((&(*(*tok__gKJURh611IYGidwMnIaFPw).ident).s), ((NI)1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		default:
		{
			...
			colontmpD__14 = (NI)0;
			{
				NIM_CHAR* T71_;
				T71_ = (NIM_CHAR*)0;
				T71_ = X5BX5D___system_7101((&(*(*tok__gKJURh611IYGidwMnIaFPw).ident).s), ((NI)1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
