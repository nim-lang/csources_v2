...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___lineinfos_1869)(tySequence__npXKLeClRo4ZDs6rPxQ9bRA* dest__ZLmQLHaTyL9cVOzqpgZbOZQ, tySequence__npXKLeClRo4ZDs6rPxQ9bRA src__d9ckWFVqH9b9b1Whxn9bPdhUYA);
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___lineinfos_2044)(tySequence__o8paxaScVM7VHajE9a8rbyw* dest__ZLmQLHaTyL9cVOzqpgZbOZQ_2, tySequence__o8paxaScVM7VHajE9a8rbyw src__d9ckWFVqH9b9b1Whxn9bPdhUYA_2);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___lineinfos_312)(tyObject_ERecoverableError__Y0JGml0RfydquAvx7nZiKw* dest__Ob0twAGKyaDwumxwuXebXQ);
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___lineinfos_321)(tyObject_ERecoverableError__Y0JGml0RfydquAvx7nZiKw* dest__bZ09c5uBuGwk5PHN5nHW3OA, void* env__0iOh8CMLjxirDKvlqrKNYA);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___msgs_472)(tyObject_ESuggestDone__e9cKYzSU0LE8Q9btWEBJvd9cQ* dest__Ob0twAGKyaDwumxwuXebXQ_2);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___msgs_481)(tyObject_ESuggestDone__e9cKYzSU0LE8Q9btWEBJvd9cQ* dest__bZ09c5uBuGwk5PHN5nHW3OA_2, void* env__0iOh8CMLjxirDKvlqrKNYA_2);
...
N_LIB_PRIVATE NIM_CONST tyObject_TLineInfo__7ZAGqjaN6WqWPlHP9cRagRg unknownLineInfo__lineinfos_350 = {((NU16)0), ((NI16)-1), ((NI32)-1)}
;
N_LIB_PRIVATE NIM_CONST tyArray__ZN1zO1GBLtAcKmgw4Qujww NotesVerbosity__lineinfos_235 = {{
...
N_LIB_PRIVATE TNimTypeV2 NTIv2__Y0JGml0RfydquAvx7nZiKw_ = {.destructor = (void*)eqdestroy___lineinfos_312, .size = sizeof(tyObject_ERecoverableError__Y0JGml0RfydquAvx7nZiKw), .align = (NI16) NIM_ALIGNOF(tyObject_ERecoverableError__Y0JGml0RfydquAvx7nZiKw), .depth = 4, .display = TM__eKG71Gy301SWgr9a6ccuVDg_312, .traceImpl = (void*)eqtrace___lineinfos_321, .flags = 0};
static NIM_CONST NU32 TM__eKG71Gy301SWgr9a6ccuVDg_313[5] = {3701606400, 1285336064, 3000110592, 3978211584, 4070100224};
N_LIB_PRIVATE TNimTypeV2 NTIv2__e9cKYzSU0LE8Q9btWEBJvd9cQ_ = {.destructor = (void*)eqdestroy___msgs_472, .size = sizeof(tyObject_ESuggestDone__e9cKYzSU0LE8Q9btWEBJvd9cQ), .align = (NI16) NIM_ALIGNOF(tyObject_ESuggestDone__e9cKYzSU0LE8Q9btWEBJvd9cQ), .depth = 4, .display = TM__eKG71Gy301SWgr9a6ccuVDg_313, .traceImpl = (void*)eqtrace___msgs_481, .flags = 0};
static N_INLINE(void, nimSetMem__systemZmemory_7)(void* a__tZiCJHYy5dYyAh9cxwrrVhQ, int v__iM7JOvZxArJIvbhGyRZG6Q, NI size__ntsFNLS0mpvnjQFrZT7DCw) {
	void* T1_;
	T1_ = (void*)0;
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___lineinfos_1869((&(*Result).msgContext), T1_);
	(*Result).lastError = unknownLineInfo__lineinfos_350;
	T2_ = initTable__lineinfos_396(((NI)32));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___lineinfos_2031((&(*Result).filenameToIndexTbl), T2_);
	...
	eqsink___lineinfos_2044((&(*Result).fileInfos), T3_);
	(*Result).errorOutputs = 3;
	X5BX5Deq___lineinfos_597((&(*Result).filenameToIndexTbl), TM__eKG71Gy301SWgr9a6ccuVDg_3, ((NI32)-1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(NimStringV2, dollar___lineinfos_124)(tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA e__9bsLO29bL2hwjloZVQDm59bWA) {
	...
	switch (e__9bsLO29bL2hwjloZVQDm59bWA) {
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___lineinfos_1919)(tyTuple__3N9c2HK9cpi9cfEKxHnvsLXkg* dest__2m9cwqCHI4DT2ALZgW0a3rQ, tyTuple__3N9c2HK9cpi9cfEKxHnvsLXkg src__awmE9cou6zcl7Q6pLYOluRw) {
	(*dest__2m9cwqCHI4DT2ALZgW0a3rQ).Field0.line = src__awmE9cou6zcl7Q6pLYOluRw.Field0.line;
	(*dest__2m9cwqCHI4DT2ALZgW0a3rQ).Field0.col = src__awmE9cou6zcl7Q6pLYOluRw.Field0.col;
	(*dest__2m9cwqCHI4DT2ALZgW0a3rQ).Field0.fileIndex = src__awmE9cou6zcl7Q6pLYOluRw.Field0.fileIndex;
	eqcopy___stdZassertions_16((&(*dest__2m9cwqCHI4DT2ALZgW0a3rQ).Field1), src__awmE9cou6zcl7Q6pLYOluRw.Field1);
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___lineinfos_1916)(tyTuple__3N9c2HK9cpi9cfEKxHnvsLXkg* dest__RsCUNkd1qXEVw9cseVs0Kzw) {
	eqdestroy___stdZassertions_13((&(*dest__RsCUNkd1qXEVw9cseVs0Kzw).Field1));
}
static N_INLINE(void, nimCopyMem)(void* dest__HMDJtGX4ficduS9cTUiey0w, void* source__xDZEU1SRcEBuZ8mtbKQBhQ, NI size__9b8g0WMA1h1RvMwHOMW7yFA) {
	void* T1_;
	T1_ = (void*)0;
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, createDocLink__lineinfos_6)(NimStringV2 urlSuffix__XeOU5M5m4mFMwn7hERMuVw) {
	...
	result = TM__eKG71Gy301SWgr9a6ccuVDg_309;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = (((NI)0) < urlSuffix__XeOU5M5m4mFMwn7hERMuVw.len);
		if (!(T3_)) goto LA4_;
		T3_ = ((NU8)(urlSuffix__XeOU5M5m4mFMwn7hERMuVw.p->data[((NI)0)]) == (NU8)(47));
		LA4_: ;
		if (!T3_) goto LA5_;
		prepareAdd((&result), urlSuffix__XeOU5M5m4mFMwn7hERMuVw.len + 0);
appendString((&result), urlSuffix__XeOU5M5m4mFMwn7hERMuVw);
	}
	goto LA1_;
	LA5_: ;
	{
		...
		T8_ = rawNewString(urlSuffix__XeOU5M5m4mFMwn7hERMuVw.len + 1);
appendString((&T8_), TM__eKG71Gy301SWgr9a6ccuVDg_311);
appendString((&T8_), urlSuffix__XeOU5M5m4mFMwn7hERMuVw);
		colontmpD_ = T8_;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___lineinfos_312)(tyObject_ERecoverableError__Y0JGml0RfydquAvx7nZiKw* dest__Ob0twAGKyaDwumxwuXebXQ) {
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLastCyclicDyn((*dest__Ob0twAGKyaDwumxwuXebXQ).Sup.Sup.Sup.parent);
		if (!T3_) goto LA4_;
		nimDestroyAndDispose((*dest__Ob0twAGKyaDwumxwuXebXQ).Sup.Sup.Sup.parent);
	}
	LA4_: ;
	eqdestroy___stdZassertions_13((&(*dest__Ob0twAGKyaDwumxwuXebXQ).Sup.Sup.Sup.message));
	eqdestroy___stdZassertions_55((&(*dest__Ob0twAGKyaDwumxwuXebXQ).Sup.Sup.Sup.trace));
	{
		NIM_BOOL T8_;
		T8_ = (NIM_BOOL)0;
		T8_ = nimDecRefIsLastCyclicDyn((*dest__Ob0twAGKyaDwumxwuXebXQ).Sup.Sup.Sup.up);
		if (!T8_) goto LA9_;
		nimDestroyAndDispose((*dest__Ob0twAGKyaDwumxwuXebXQ).Sup.Sup.Sup.up);
	}
	LA9_: ;
}
static N_INLINE(void, add__system_2686)(tyObject_CellSeq__sGle0igznE2T7vk4dBh5SQ* s__G58rBzp9arUs2Le3q9bajUHA, void** c__glbQoed0fMuhXSt1wQUc7w, TNimTypeV2* t__afUUWAFqIJFXIEkjClESEA) {
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___lineinfos_321)(tyObject_ERecoverableError__Y0JGml0RfydquAvx7nZiKw* dest__bZ09c5uBuGwk5PHN5nHW3OA, void* env__0iOh8CMLjxirDKvlqrKNYA) {
	nimTraceRefDyn(&(*dest__bZ09c5uBuGwk5PHN5nHW3OA).Sup.Sup.Sup.parent, env__0iOh8CMLjxirDKvlqrKNYA);
	eqtrace___stdZassertions_64((&(*dest__bZ09c5uBuGwk5PHN5nHW3OA).Sup.Sup.Sup.trace), env__0iOh8CMLjxirDKvlqrKNYA);
	nimTraceRefDyn(&(*dest__bZ09c5uBuGwk5PHN5nHW3OA).Sup.Sup.Sup.up, env__0iOh8CMLjxirDKvlqrKNYA);
}
...
{	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	eqcopy___stdZassertions_16((&colontmpD_), msg__sWSfvNrea9a9cz9c9bG7yoaQng);
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___lineinfos_1922)(tyTuple__3N9c2HK9cpi9cfEKxHnvsLXkg* dest__xrFaHy6v2mCC5jUqyo9blxg, tyTuple__3N9c2HK9cpi9cfEKxHnvsLXkg src__pqiPmTRyqj6diDM32R4DVw) {
	(*dest__xrFaHy6v2mCC5jUqyo9blxg).Field0.line = src__pqiPmTRyqj6diDM32R4DVw.Field0.line;
	(*dest__xrFaHy6v2mCC5jUqyo9blxg).Field0.col = src__pqiPmTRyqj6diDM32R4DVw.Field0.col;
	(*dest__xrFaHy6v2mCC5jUqyo9blxg).Field0.fileIndex = src__pqiPmTRyqj6diDM32R4DVw.Field0.fileIndex;
	if ((*dest__xrFaHy6v2mCC5jUqyo9blxg).Field1.p != src__pqiPmTRyqj6diDM32R4DVw.Field1.p) {	eqdestroy___stdZassertions_13((&(*dest__xrFaHy6v2mCC5jUqyo9blxg).Field1));
	}
(*dest__xrFaHy6v2mCC5jUqyo9blxg).Field1.len = src__pqiPmTRyqj6diDM32R4DVw.Field1.len; (*dest__xrFaHy6v2mCC5jUqyo9blxg).Field1.p = src__pqiPmTRyqj6diDM32R4DVw.Field1.p;
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___msgs_472)(tyObject_ESuggestDone__e9cKYzSU0LE8Q9btWEBJvd9cQ* dest__Ob0twAGKyaDwumxwuXebXQ_2) {
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLastCyclicDyn((*dest__Ob0twAGKyaDwumxwuXebXQ_2).Sup.Sup.Sup.parent);
		if (!T3_) goto LA4_;
		nimDestroyAndDispose((*dest__Ob0twAGKyaDwumxwuXebXQ_2).Sup.Sup.Sup.parent);
	}
	LA4_: ;
	eqdestroy___stdZassertions_13((&(*dest__Ob0twAGKyaDwumxwuXebXQ_2).Sup.Sup.Sup.message));
	eqdestroy___stdZassertions_55((&(*dest__Ob0twAGKyaDwumxwuXebXQ_2).Sup.Sup.Sup.trace));
	{
		NIM_BOOL T8_;
		T8_ = (NIM_BOOL)0;
		T8_ = nimDecRefIsLastCyclicDyn((*dest__Ob0twAGKyaDwumxwuXebXQ_2).Sup.Sup.Sup.up);
		if (!T8_) goto LA9_;
		nimDestroyAndDispose((*dest__Ob0twAGKyaDwumxwuXebXQ_2).Sup.Sup.Sup.up);
	}
	LA9_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___msgs_481)(tyObject_ESuggestDone__e9cKYzSU0LE8Q9btWEBJvd9cQ* dest__bZ09c5uBuGwk5PHN5nHW3OA_2, void* env__0iOh8CMLjxirDKvlqrKNYA_2) {
	nimTraceRefDyn(&(*dest__bZ09c5uBuGwk5PHN5nHW3OA_2).Sup.Sup.Sup.parent, env__0iOh8CMLjxirDKvlqrKNYA_2);
	eqtrace___stdZassertions_64((&(*dest__bZ09c5uBuGwk5PHN5nHW3OA_2).Sup.Sup.Sup.trace), env__0iOh8CMLjxirDKvlqrKNYA_2);
	nimTraceRefDyn(&(*dest__bZ09c5uBuGwk5PHN5nHW3OA_2).Sup.Sup.Sup.up, env__0iOh8CMLjxirDKvlqrKNYA_2);
}
...
{nimErr_ = nimErrorFlag();
	result = (NI)0;
	T1_.Field0 = ((NI) (i__H5nSCIxboGBYIGufhGZ3lQ.line));
	T1_.Field1 = ((NI) (i__H5nSCIxboGBYIGufhGZ3lQ.col));
	T1_.Field2 = ((NI) (i__H5nSCIxboGBYIGufhGZ3lQ.fileIndex));
	result = hash__lineinfos_280(T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
