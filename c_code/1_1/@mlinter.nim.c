...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		LA8_: ;
		liMessage__msgs_1159(conf, info, msgX60gensym15_, mX60gensym15_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__u5vWF9bq7M9bLavMQS4OjP4A_7, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	wanted = dollar___wordrecg_302(w);
	{
		...
		LA8_: ;
		liMessage__msgs_1159(conf, info, msgX60gensym19_, mX60gensym19_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__u5vWF9bq7M9bLavMQS4OjP4A_11, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	default:
	{
		...
		LA21_: ;
		{
			NIM_BOOL T24_;
			T24_ = (NIM_BOOL)0;
			T24_ = contains__stdZenvvars_33(((s).p) ? (s.p->data) : NIM_NIL, s.len, 95);
			if (!T24_) goto LA25_;
			nimAddCharV1((&result), s.p->data[i]);
		}
		goto LA17_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		LA8_: ;
		liMessage__msgs_1159(conf, info, msgX60gensym9_, mX60gensym9_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__u5vWF9bq7M9bLavMQS4OjP4A_58, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
