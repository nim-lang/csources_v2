...
{nimErr_ = nimErrorFlag();
	...
	line = sourceLine__msgs_1152(conf__LDCjIq3BHCtkNW9cB7IwSQw, info__AFn9brJpPNUPM6kXnj3BWGg);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		LA8_: ;
		liMessage__msgs_1169(conf__pjmimqrVj8GOgUrkEC8BAg, info__nLgBsNLODuSTAg5bP8zKdQ, msgX60gensym15_, mX60gensym15_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__u5vWF9bq7M9bLavMQS4OjP4A_7, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	wanted = dollar___wordrecg_302(w__1rOYXdDf9apHVtD3yoDv1ew);
	{
		...
		LA8_: ;
		liMessage__msgs_1169(conf__9cYvgz7BDfQHqMKXPT2j2cw, info__4K0EcRRe9an3R2WmLGhHT6w, msgX60gensym19_, mX60gensym19_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__u5vWF9bq7M9bLavMQS4OjP4A_11, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		LA8_: ;
		liMessage__msgs_1169(conf__9bg1Nqt2TDmgV53bo8B8TIA, info__39awJZwvHMTW5mvbIb58cNg, msgX60gensym9_, mX60gensym9_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__u5vWF9bq7M9bLavMQS4OjP4A_58, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
