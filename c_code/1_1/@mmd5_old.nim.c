...
static N_INLINE(void, writeBuffer__md5395old_274)(tyObject_MD5Context__vQ9bm9b34hOt1hUPHV0QEYsA* c, NI index, NU8* input, NI inputLen_0, NI inputIndex, NI len);
	...
	j = ((NI)0);
	{
		...
		res = ((NI)0);
		{
			while (1) {
				...
				i = res;
				dest[(i)- 0] = (NU32)((NU32)((NU32)(((NU32) (src[j])) | (NU32)((NU32)(((NU32) (src[(NI)(j + ((NI)1))]))) << (NU32)(((NI)8)))) | (NU32)((NU32)(((NU32) (src[(NI)(j + ((NI)2))]))) << (NU32)(((NI)16)))) | (NU32)((NU32)(((NU32) (src[(NI)(j + ((NI)3))]))) << (NU32)(((NI)24))));
				j += ((NI)4);
				res += ((NI)1);
			} LA3: ;
		}
...
{nimErr_ = nimErrorFlag();
	...
	(*c).count[(((NI)0))- 0] = (NU32)((NU32)((*c).count[(((NI)0))- 0]) + (NU32)((NU32)((NU32)(((NU32) (inputLen_0))) << (NU32)(((NI)3)))));
	{
		if (!((NU32)((*c).count[(((NI)0))- 0]) < (NU32)((NU32)((NU32)(((NU32) (inputLen_0))) << (NU32)(((NI)3)))))) goto LA3_;
		(*c).count[(((NI)1))- 0] = (NU32)((NU32)((*c).count[(((NI)1))- 0]) + (NU32)(((NU32)1)));
	}
	LA3_: ;
	(*c).count[(((NI)1))- 0] = (NU32)((NU32)((*c).count[(((NI)1))- 0]) + (NU32)((NU32)((NU32)(((NU32) (inputLen_0))) >> (NU32)(((NI)29)))));
	PartLen = (NI)(((NI)64) - Index);
	{
		NI i;
		if (!(PartLen <= inputLen_0)) goto LA7_;
		writeBuffer__md5395old_274(c, Index, input, inputLen_0, ((NI)0), PartLen);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		}
		{
			...
			writeBuffer__md5395old_274(c, ((NI)0), input, inputLen_0, i, (NI)(inputLen_0 - i));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA13_: ;
	}
	...
	LA7_: ;
	{
		...
		writeBuffer__md5395old_274(c, Index, input, inputLen_0, ((NI)0), inputLen_0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA5_;
	LA16_: ;
