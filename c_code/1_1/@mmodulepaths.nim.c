...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)22):
	{
		...
		T5_ = nossplitFile(T4_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
		colontmpD_ = T5_;
		T6_.len = 0; T6_.p = NIM_NIL;
		T6_ = pathSubs__options_5069(conf__1wFx1nxHoIUnNPJUblx19bA, (*n__XjmJ9ck5w8XBdsBZTsuVprw)._kind_3.strVal, colontmpD_.Field0);
		if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
		result = T6_;
		{
			LA3_:;
		...
		if (NIM_UNLIKELY(*nimErr_)) {
			...
			if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3978211584)) {
				...
				*nimErr_ = NIM_FALSE;
				...
				T13_ = rawNewString((*n__XjmJ9ck5w8XBdsBZTsuVprw)._kind_3.strVal.len + 14);
appendString((&T13_), TM__GNhKqIyvrFjtq6zf1JX7qg_15);
appendString((&T13_), (*n__XjmJ9ck5w8XBdsBZTsuVprw)._kind_3.strVal);
				colontmpD__2 = T13_;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)29):
	{
		...
		T20_ = getModuleName__modulepaths_10(conf__1wFx1nxHoIUnNPJUblx19bA, (*n__XjmJ9ck5w8XBdsBZTsuVprw)._kind_6.sons.p->data[((NI)2)]);
		if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
		modname = T20_;
		T21_.len = 0; T21_.p = NIM_NIL;
		T21_ = getModuleName__modulepaths_10(conf__1wFx1nxHoIUnNPJUblx19bA, n1);
		if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
		result = T21_;
		...
		T23_ = nsuReplaceStr(colontmpD__3, TM__GNhKqIyvrFjtq6zf1JX7qg_19, TM__GNhKqIyvrFjtq6zf1JX7qg_21);
		if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
		colontmpD__4 = T23_;
...
appendString((&result), modname);
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)30):
	{
		...
		T28_ = renderTree__renderer_50(n__XjmJ9ck5w8XBdsBZTsuVprw, 4);
		if (NIM_UNLIKELY(*nimErr_)) goto LA27_;
		colontmpD__5 = T28_;
		T29_.len = 0; T29_.p = NIM_NIL;
		T29_ = nsuReplaceStr(colontmpD__5, TM__GNhKqIyvrFjtq6zf1JX7qg_22, TM__GNhKqIyvrFjtq6zf1JX7qg_23);
		if (NIM_UNLIKELY(*nimErr_)) goto LA27_;
		result = T29_;
		{
			LA27_:;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)45):
	{
		...
		T34_ = renderTree__renderer_50(n__XjmJ9ck5w8XBdsBZTsuVprw, 4);
		if (NIM_UNLIKELY(*nimErr_)) goto LA33_;
		colontmpD__6 = T34_;
		T35_.len = 0; T35_.p = NIM_NIL;
		T35_ = nsuReplaceStr(colontmpD__6, TM__GNhKqIyvrFjtq6zf1JX7qg_28, TM__GNhKqIyvrFjtq6zf1JX7qg_29);
		if (NIM_UNLIKELY(*nimErr_)) goto LA33_;
		result = T35_;
		{
			LA33_:;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)78):
	{
		...
		T39_ = getModuleName__modulepaths_10(conf__1wFx1nxHoIUnNPJUblx19bA, (*n__XjmJ9ck5w8XBdsBZTsuVprw)._kind_6.sons.p->data[((NI)0)]);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		result = T39_;
	}
	break;
	default:
	{
		...
		T43_ = renderTree__renderer_50(n__XjmJ9ck5w8XBdsBZTsuVprw, T42_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA41_;
		T44_.len = 0; T44_.p = NIM_NIL;
		T44_ = nsuFormatSingleElem(TM__GNhKqIyvrFjtq6zf1JX7qg_31, T43_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA41_;
		colontmpD__7 = T44_;
