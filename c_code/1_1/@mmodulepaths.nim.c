...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = relativeTo__pathutils_152(path, (*conf).projectPath, 92);
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)22):
	{
		...
		T4_ = toFullPath__msgs_577(conf, (*n).info.fileIndex);
		...
		T6_ = pathSubs__options_5069(conf, (*n)._kind_3.strVal, colontmpD_.Field0);
		if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
		result = T6_;
		{
			LA3_:;
...
appendString((&T13_), (*n)._kind_3.strVal);
				colontmpD__2 = T13_;
				liMessage__msgs_1159(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__GNhKqIyvrFjtq6zf1JX7qg_16, NIM_FALSE);
...
appendString((&result), modname);
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)45):
	{
		...
		liMessage__msgs_1159(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)23), TM__GNhKqIyvrFjtq6zf1JX7qg_25, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__GNhKqIyvrFjtq6zf1JX7qg_26, NIM_FALSE);
	...
	default:
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA41_;
		colontmpD__7 = T44_;
		liMessage__msgs_1159(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__7, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__GNhKqIyvrFjtq6zf1JX7qg_32, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA41_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD_ = toFullPath__msgs_577(conf, (*n).info.fileIndex);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	fullPath = findModule__options_5399(conf, modulename, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NIM_BOOL T4_;
		T4_ = (NIM_BOOL)0;
...
appendString((&T18_), m);
			colontmpD__2 = T18_;
			liMessage__msgs_1159(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__GNhKqIyvrFjtq6zf1JX7qg_36, NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			{
				LA11_:;
			}
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = multiReplace__pureZstrutils_1861(path, TM__GNhKqIyvrFjtq6zf1JX7qg_37, 5);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
