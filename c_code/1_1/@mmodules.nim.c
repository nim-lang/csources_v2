...
{nimErr_ = nimErrorFlag();
	...
	filename = toFullPath__msgs_577((*graph).config, fileIdx);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_ = NIM_NIL;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	(*T2_).info = newLineInfo__msgs_396(fileIdx, ((NI)1), ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = T2_;
	{
		NIM_BOOL T5_;
...
appendString((&T9_), (*(*result).name).s);
		colontmpD__3 = T9_;
		liMessage__msgs_1159((*graph).config, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), TM__PSTsdGjzLcJhNmbZsJdP6w_4, NIM_FALSE);
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	T1_ = (NI32)0;
	T1_ = fileInfoIdx__msgs_391((*graph).config, filename);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		T6_ = (NI32)0;
		T6_ = fileInfoIdx__msgs_391((*graph).config, colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
...
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	{
		NIM_BOOL T4_;
		T4_ = (NIM_BOOL)0;
		T4_ = isEmpty__options_5384((*conf).projectFull);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T4_) goto LA5_;
		liMessage__msgs_1159(conf, gCmdLineInfo__msgs_419, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)1), TM__PSTsdGjzLcJhNmbZsJdP6w_15, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), TM__PSTsdGjzLcJhNmbZsJdP6w_16, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA5_: ;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T7_ = (NI32)0;
	T7_ = fileInfoIdx__msgs_391(conf, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
