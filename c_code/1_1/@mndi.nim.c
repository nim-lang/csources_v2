...
{nimErr_ = nimErrorFlag();
	T1_ = (NIM_BOOL)0;
	T1_ = isEmpty__options_5384(filename__FHh4801kX6ivdhc7ed1ynA);
...
{nimErr_ = nimErrorFlag();
	...
	write__stdZsyncio_248(f__KUEFoPum7MSbbeHUznCh4A, TM__9bjXlRg9ajY35u7ap75QbU6A_8);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, doWrite__ndi_14)(tyObject_NdiFile__9agcNDMZLEhF9btXu8YBZkwA* f__9bIKwEhGklKyM6hDLd9csM9ag, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s__6JlqNpuh9cUefPSPO1ekifQ, tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf__3149blR9crWg3TkTujYwW9buA) {
...
appendString((&(*f__9bIKwEhGklKyM6hDLd9csM9ag).buf), TM__9bjXlRg9ajY35u7ap75QbU6A_5);
	...
	write__stdZsyncio_452((*f__9bIKwEhGklKyM6hDLd9csM9ag).f, T2_, 2);
	...
	colontmpD_ = toFullPath__msgs_577(conf__3149blR9crWg3TkTujYwW9buA, (*s__6JlqNpuh9cUefPSPO1ekifQ).info.fileIndex);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T3_[1] = colontmpD_;
	T3_[2] = TM__9bjXlRg9ajY35u7ap75QbU6A_10;
	T3_[3] = (*f__9bIKwEhGklKyM6hDLd9csM9ag).buf;
	writeLine__msgs_447((*f__9bIKwEhGklKyM6hDLd9csM9ag).f, T3_, 4);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	{
		...
		T5_ = (FILE*)0;
		T5_ = open__stdZsyncio_559((*f__9b2ZHe25BpJYalN7T4bN4XQ).filename, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)1), ((NI)8000));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
appendString((&T10_), (*f__9b2ZHe25BpJYalN7T4bN4XQ).filename);
		...
		close__stdZsyncio_265((*f__9b2ZHe25BpJYalN7T4bN4XQ).f);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
