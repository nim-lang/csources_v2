...
{nimErr_ = nimErrorFlag();
	T1_ = (NIM_BOOL)0;
	T1_ = isEmpty__options_5384(filename);
...
{nimErr_ = nimErrorFlag();
	...
	write__stdZsyncio_248(f, TM__9bjXlRg9ajY35u7ap75QbU6A_8);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, doWrite__ndi_14)(tyObject_NdiFile__9agcNDMZLEhF9btXu8YBZkwA* f, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s, tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf) {
...
appendString((&(*f).buf), TM__9bjXlRg9ajY35u7ap75QbU6A_5);
	...
	write__stdZsyncio_452((*f).f, T2_, 2);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	writeRope__ropes_23((*f).f, (*s).loc.r);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T3_[0] = TM__9bjXlRg9ajY35u7ap75QbU6A_9;
	colontmpD_ = toFullPath__msgs_577(conf, (*s).info.fileIndex);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T3_[1] = colontmpD_;
	T3_[2] = TM__9bjXlRg9ajY35u7ap75QbU6A_10;
	T3_[3] = (*f).buf;
	writeLine__msgs_447((*f).f, T3_, 4);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	{
		...
		T5_ = (FILE*)0;
		T5_ = open__stdZsyncio_559((*f).filename, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)1), ((NI)8000));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(*f).f = T5_;
		{
			NimStringV2 colontmpD_;
