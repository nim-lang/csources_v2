...
extern tySequence__jPly7LEWA9bR7s5RNk1UriQ gFuns__stdZexitprocs_15;
static N_INLINE(void, nimSetMem__systemZmemory_7)(void* a__tZiCJHYy5dYyAh9cxwrrVhQ, int v__iM7JOvZxArJIvbhGyRZG6Q, NI size__ntsFNLS0mpvnjQFrZT7DCw) {
	void* T1_;
	T1_ = (void*)0;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = findExe__pureZos_95(TM__xOfksDa5lOpfO1acT4wYQg_27, NIM_TRUE, ExeExts__pureZos_94, 3);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NimStringV2 T5_;
		if (!(result.len == ((NI)0))) goto LA3_;
		T5_.len = 0; T5_.p = NIM_NIL;
		T5_ = findExe__pureZos_95(TM__xOfksDa5lOpfO1acT4wYQg_29, NIM_TRUE, ExeExts__pureZos_94, 3);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		if (!T32_) goto LA33_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		colontmpD_ = GC_getStatistics__system_6665();
		T36_[0] = colontmpD_;
		echoBinSafe(T36_, 1);
		{
			LA35_:;
...
appendString((&T74_), (*conf__vzx7iwMPDm1Uf9bxV2YL1UA).arguments);
		...
		case ((tyEnum_Command__b145RBTl7bacomLHdBguHg)20) ... ((tyEnum_Command__b145RBTl7bacomLHdBguHg)23):
		{
			...
			LA81_: ;
			colontmpD__8 = dollar___options_5270(output);
			if (NIM_UNLIKELY(*nimErr_)) goto LA78_;
			openDefaultBrowser__pureZbrowsers_15(colontmpD__8);
			if (NIM_UNLIKELY(*nimErr_)) goto LA78_;
			{
				LA78_:;
			}
...
N_LIB_PRIVATE void PreMainInner(void) {
	atmdotdotatslibatsstdatsexitprocsdotnim_Init000();
	atmdotdotatslibatsstdatssynciodotnim_Init000();
	atmdotdotatslibatswindowsatswinleandotnim_Init000();
}
...
N_LIB_PRIVATE void PreMain(void) {
	...
	atmdotdotatslibatsstdatssynciodotnim_DatInit000();
	atmdotdotatslibatswindowsatswinleandotnim_DatInit000();
	atmdotdotatslibatsstdatsprivateatswin_setenvdotnim_DatInit000();
	atmdotdotatslibatspureatsterminaldotnim_DatInit000();
	atmdotdotatslibatsstdatsprivateatswin_getsysteminfodotnim_DatInit000();
	(*inner)();
	#else
	atmdotdotatslibatssystemdotnim_Init000();
	atmdotdotatslibatsstdatssynciodotnim_DatInit000();
...
nimErr_ = nimErrorFlag();
	...
	eqdestroy___stdZexitprocs_31((&gFuns__stdZexitprocs_15));
	BeforeRet_: ;
	nimTestErrorFlag();
}
}
