...
appendString((&T27_), p__y75I2yYwWHrxXLOAlxJn6Q);
		colontmpD__3 = T27_;
		liMessage__msgs_1159(conf__y9aqkh9aykYivc6NmBJ9bi0pA, info__ztgkWGYbJ7LdR7eSlaGs0A, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__Xve3Bgye29aQqSXx0rQYUzw_17, NIM_FALSE);
...
{nimErr_ = nimErrorFlag();
	...
	LA52_: ;
	{
		...
		if (!!(T65_)) goto LA66_;
		liMessage__msgs_1159(conf__eRiC9aAtyASqyieqV0TXkpQ, info__d7DumG9cpw7zAgfrKC1afOQ, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)94), path, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__Xve3Bgye29aQqSXx0rQYUzw_23, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		blitTmp_2 = path;
		path.len = 0; path.p = NIM_NIL;
