...
N_LIB_PRIVATE N_NIMCALL(void, addPathRec__nimblecmd_2265)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, NimStringV2 dir, tyObject_TLineInfo__7ZAGqjaN6WqWPlHP9cRagRg info);
...
N_LIB_PRIVATE N_NIMCALL(void, addPackage__nimblecmd_233)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, tyObject_Table__d05ldtnZIkg8hVpY02dsdA* packages, NimStringV2 p, tyObject_TLineInfo__7ZAGqjaN6WqWPlHP9cRagRg info);
N_LIB_PRIVATE N_NIMCALL(tyTuple__7q7q3E6Oj24ZNVJb9aonhAg, getPathVersionChecksum__nimblecmd_197)(NimStringV2 p);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isValidVersion__nimblecmd_161)(NimStringV2 v);
N_LIB_PRIVATE N_NIMCALL(NimStringV2, newVersion__nimblecmd_130)(NimStringV2 ver);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, lt___nimblecmd_172)(NimStringV2 ver, NimStringV2 ver2);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isSpecial__nimblecmd_158)(NimStringV2 ver);
...
N_LIB_PRIVATE N_NIMCALL(tyTuple__UV3llMMYFckfui8YMBuUZA, getOrDefault__nimblecmd_308)(tyObject_Table__d05ldtnZIkg8hVpY02dsdA t, NimStringV2 key);
...
N_LIB_PRIVATE N_NIMCALL(void, addNimblePath__nimblecmd_2235)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, NimStringV2 p, tyObject_TLineInfo__7ZAGqjaN6WqWPlHP9cRagRg info);
...
static N_INLINE(NI, find__nimblecmd_2291)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ a, NimStringV2 item);
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				i = (&a[i_2]);
				{
					NIM_BOOL T6_;
					T6_ = (NIM_BOOL)0;
					T6_ = eqeq___nimblecmd_42((*i), item);
...
N_LIB_PRIVATE N_NIMCALL(void, addPath__nimblecmd_13)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, NimStringV2 path, tyObject_TLineInfo__7ZAGqjaN6WqWPlHP9cRagRg info) {
	{
		...
		insert__nimblecmd_52((&(*conf).searchPaths), colontmpD_, ((NI)0));
	}
	LA4_: ;
}
static N_INLINE(void, nimSetMem__systemZmemory_7)(void* a, int v, NI size) {
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T5_ = substr__system_7585(p, (NI)(checksumSeparatorIndex + ((NI)1)));
	...
	LA1_: ;
	versionSeparatorIndex = nsuRFindStr(p, TM__Xve3Bgye29aQqSXx0rQYUzw_7, ((NI)0), (NI)(checksumSeparatorIndex - ((NI)1)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NimStringV2 T16_;
		if (!!((versionSeparatorIndex == ((NI)-1)))) goto LA14_;
		T16_.len = 0; T16_.p = NIM_NIL;
		T16_ = substr__system_7573(p, (NI)(versionSeparatorIndex + ((NI)1)), (NI)(checksumSeparatorIndex - ((NI)1)));
	...
	LA14_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			T22_ = substr__system_7573(p, (NI)(versionSeparatorIndex + ((NI)1)), (NI)(checksumSeparatorIndex - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	...
	sVer2.len = 0; sVer2.p = NIM_NIL;
	{
		...
		NimStringV2 colontmpD_;
		T4_ = (NIM_BOOL)0;
		T4_ = isSpecial__nimblecmd_158(ver);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (T4_) goto LA5_;
		T4_ = isSpecial__nimblecmd_158(ver2);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		LA5_: ;
		if (!T4_) goto LA6_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		{
			...
			NimStringV2 colontmpD__2;
			T11_ = (NIM_BOOL)0;
			T11_ = isSpecial__nimblecmd_158(ver2);
		...
		LA13_: ;
		{
			...
			T20_ = (NIM_BOOL)0;
			T20_ = isSpecial__nimblecmd_158(ver2);
			if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
			if (!!(T20_)) goto LA21_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmp_ = getPathVersionChecksum__nimblecmd_197(p);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	checksum = colontmp_.Field2;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
		{
			...
			NIM_BOOL T12_;
			T10_ = (NIM_BOOL)0;
			colontmpD_ = getOrDefault__nimblecmd_308((*packages), name);
			if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
			...
			if (T10_) goto LA11_;
			T12_ = (NIM_BOOL)0;
			T12_ = hasKey__nimblecmd_786((*packages), name);
			if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
			T10_ = !(T12_);
			LA11_: ;
			if (!T10_) goto LA13_;
			{
				...
				X5BX5Deq___nimblecmd_839(packages, name, T20_);
				if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
			}
			goto LA15_;
			LA18_: ;
			{
				...
				X5BX5Deq___nimblecmd_839(packages, name, T22_);
				if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
			}
			LA15_: ;
		}
...
appendString((&T27_), p);
		colontmpD__3 = T27_;
		liMessage__msgs_1159(conf, info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__Xve3Bgye29aQqSXx0rQYUzw_17, NIM_FALSE);
...
{nimErr_ = nimErrorFlag();
	...
	eqcopy___stdZassertions_16((&path), p);
	{
		...
		colontmp_ = slash___stdZprivateZospaths50_90(p, TM__Xve3Bgye29aQqSXx0rQYUzw_21);
	...
	resultX60gensym40_.len = 0; resultX60gensym40_.p = NIM_NIL;
	{
		...
		nimbleLinkLines.p->data[((NI)1)].len = 0; nimbleLinkLines.p->data[((NI)1)].p = NIM_NIL;
		{
			...
			T60_ = slash___stdZprivateZospaths50_90(p, path);
			if (NIM_UNLIKELY(*nimErr_)) goto LA54_;
	...
	LA52_: ;
	{
		...
		NimStringV2 blitTmp_2;
		T65_ = (NIM_BOOL)0;
		T65_ = contains__nimblecmd_17((((*conf).searchPaths).p) ? ((*conf).searchPaths.p->data) : NIM_NIL, (*conf).searchPaths.len, path);
		if (!!(T65_)) goto LA66_;
		liMessage__msgs_1159(conf, info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)94), path, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__Xve3Bgye29aQqSXx0rQYUzw_23, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		blitTmp_2 = path;
		path.len = 0; path.p = NIM_NIL;
		insert__nimblecmd_52((&(*conf).lazyPaths), blitTmp_2, ((NI)0));
	}
	LA66_: ;
	{
		LA1_:;
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		colontmpD_ = slash___stdZprivateZospaths50_90(dir, TM__Xve3Bgye29aQqSXx0rQYUzw_3);
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
		{
			if (!(h == ((NI)-1))) goto LA10_;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
				raiseOSError__stdZoserrors_86(T16_, dir);
				if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
			}
			LA14_: ;
		}
				...
				while (1) {
					...
					k_2 = ((tyEnum_PathComponent__x9aIl9aBWoeZzD6AxCnUUcPQ)0);
					{
						...
						xx.len = 0; xx.p = NIM_NIL;
						{
							...
							LA44_: ;
							if (!T43_) goto LA45_;
							addPackage__nimblecmd_233(conf, (&packages), p, info);
							if (NIM_UNLIKELY(*nimErr_)) goto LA26_;
						}
						LA45_: ;
						{
...
appendString((&res_2), val.Field1);
							...
							LA82_: ;
							p_2 = res_2;
							addNimblePath__nimblecmd_2235(conf, p_2, info);
		...
		L = T2_;
		{
			while (1) {
				...
				i = (&a.p->data[i_2]);
				{
					NIM_BOOL T7_;
					T7_ = (NIM_BOOL)0;
					T7_ = eqeq___nimblecmd_42((*i), item);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					if (!T7_) goto LA8_;
					goto BeforeRet_;
				}
...
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	addPathRec__nimblecmd_2265(conf, path, info);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	addNimblePath__nimblecmd_2235(conf, path, info);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	i = find__nimblecmd_2291((*conf).nimblePaths, path);
	{
		if (!!((i == ((NI)-1)))) goto LA3_;
		delete__nimblecmd_2311((&(*conf).nimblePaths), ((NI) (i)));
	}
	LA3_: ;
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	eqcopy___stdZassertions_16((&colontmpD_), path);
	insert__nimblecmd_52((&(*conf).nimblePaths), colontmpD_, ((NI)0));
	}BeforeRet_: ;
}
