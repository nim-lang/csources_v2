...
{nimErr_ = nimErrorFlag();
	...
	line = sourceLine__msgs_1152(conf__m1Tw9bLDr11LOSuhzrSTqcQ, info__d5eAEE8aS9bigZYfmC8PrCQ);
	...
	last = (NI)((NI)(first + T18_) - ((NI)1));
	{
		...
		colontmpD__2 = substr__system_7573(line, ((NI)0), (NI)(first - ((NI)1)));
		colontmpD__3 = substr__system_7585(line, (NI)(last + ((NI)1)));
