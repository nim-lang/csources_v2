...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T4_ = (NIM_BOOL)0;
		T4_ = contains__stdZenvvars_33(((result).p) ? (result.p->data) : NIM_NIL, result.len, 36);
		if (!!(!(T4_))) goto LA5_;
...
{nimErr_ = nimErrorFlag();
	...
	docHackJs2 = interp__nimpaths_36(TM__m6t49a5Ns3blAkni6Qq1Nhw_7, nimr);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		colontmpD__2 = interp__nimpaths_36(TM__m6t49a5Ns3blAkni6Qq1Nhw_15, nimr);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
