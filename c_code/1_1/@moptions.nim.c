...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___lineinfos_1863)(tySequence__npXKLeClRo4ZDs6rPxQ9bRA* dest);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___lineinfos_526)(tySequence__7lEisrXlQEzwtUKW5pzRCw* dest);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___lineinfos_2038)(tySequence__o8paxaScVM7VHajE9a8rbyw* dest);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, removeTrailingDirSep__options_4991)(NimStringV2 path);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, nimcacheSuffix__options_5050)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, rawFindFile__options_5129)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, NimStringV2 f, NIM_BOOL suppressStdlib);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, rawFindFile2__options_5166)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, NimStringV2 f);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, canonDynlibName__options_5543)(NimStringV2 s);
...
N_LIB_PRIVATE N_NIMCALL(void, utc__pureZtimes_1704)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q t, tyObject_DateTime__d9cK9cyKZPJJxFXUmx8dSpPw* Result);
N_LIB_PRIVATE N_NIMCALL(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q, fromUnix__pureZtimes_1033)(NI64 unix_0);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___pureZtimes_1413)(tyObject_DateTime__d9cK9cyKZPJJxFXUmx8dSpPw* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___options_3149)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* dest) {
	...
	LA9_: ;
	eqdestroy___lineinfos_1863((&(*dest).m.msgContext));
	eqdestroy___lineinfos_526((&(*dest).m.filenameToIndexTbl.data));
	eqdestroy___lineinfos_2038((&(*dest).m.fileInfos));
	...
	eqdestroy___system_3514((&(*dest).commandArgs));
	eqdestroy___stdZassertions_13((&(*dest).commandLine));
	eqdestroy___system_3514((&(*dest).extraCmds));
	eqdestroy___system_3514((&(*dest).implicitImports));
	eqdestroy___system_3514((&(*dest).implicitIncludes));
	...
	eqdestroy___system_3514((&(*dest).cLinkedLibs));
	eqdestroy___system_3514((&(*dest).externalToLink));
	eqdestroy___stdZassertions_13((&(*dest).linkOptionsCmd));
	eqdestroy___system_3514((&(*dest).compileOptionsCmd));
...
N_LIB_PRIVATE N_NIMCALL(void, initConfigRefCommon__options_2484)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf) {
	...
	nimCopyMem((void*)(*conf).notes, (NIM_CONST void*)NotesVerbosity__lineinfos_235[(((NI)1))- 0], 12);
	nimCopyMem((void*)(*conf).mainPackageNotes, (NIM_CONST void*)NotesVerbosity__lineinfos_235[(((NI)1))- 0], 12);
}
		...
		if (!isTitle) goto LA4_;
		{
			...
			i = ((NI)0);
			{
				while (1) {
					...
					colontmpD_ = slash___stdZprivateZospaths50_90((*conf).libpath, dir);
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
	ret = getRelativePathFromConfigPath__options_5265(conf, file, NIM_TRUE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD_ = dollar___options_5270(file);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__2 = getNimbleFile__options_5021(conf, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		relPath = relativeTo__pathutils_152(file, dir, 92);
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
		{
			NIM_BOOL T10_;
			NIM_BOOL T11_;
	...
	LA5_: ;
	{
		...
		T24_ = relativeTo__pathutils_152(file, (*conf).projectPath, 92);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		if (!(T3_)) goto LA4_;
		T5_ = (NIM_CHAR)0;
		T5_ = X5BX5D___system_7062(path, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T3_ = ((NU8)(T5_) == (NU8)(92));
		LA4_: ;
		if (!T3_) goto LA6_;
		result = substr__system_7573(path, ((NI)0), (NI)(path.len - ((NI)2)));
	}
	goto LA1_;
	LA6_: ;
	{
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		NIM_BOOL T7_;
		T7_ = (NIM_BOOL)0;
		T7_ = isDefined__options_2481(conf, TM__ZKkDwQBiNCxtzosUAsGM2Q_121);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (T7_) goto LA8_;
...
{nimErr_ = nimErrorFlag();
	...
	LA5_: ;
	{
		...
		T10_.len = 0; T10_.p = NIM_NIL;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!T13_) goto LA14_;
			result = slash___pathutils_128((*conf).projectPath, TM__ZKkDwQBiNCxtzosUAsGM2Q_114);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA11_;
		LA14_: ;
		{
			result = slash___pathutils_128((*conf).outDir, TM__ZKkDwQBiNCxtzosUAsGM2Q_115);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA11_: ;
	}
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__3 = getNimcacheDir__options_5047(conf);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_[15] = colontmpD__3;
...
N_LIB_PRIVATE N_NIMCALL(void, disableNimblePath__options_4994)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf) {
...
N_LIB_PRIVATE N_NIMCALL(void, clearNimblePath__options_5008)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf) {
	setLen__options_2839((&(*conf).lazyPaths), ((NI)0));
	setLen__options_2839((&(*conf).nimblePaths), ((NI)0));
}
N_LIB_PRIVATE N_NIMCALL(NimStringV2, canonicalizePath__options_4979)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, NimStringV2 path) {
			...
			while (1) {
				...
				it = (&(*conf).searchPaths.p->data[i]);
				{
					...
					eqsink___stdZassertions_19((&result), T12_);
					{
						...
						if (!T15_) goto LA16_;
						T18_.len = 0; T18_.p = NIM_NIL;
						T18_ = canonicalizePath__options_4979(conf, result);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		L = T3_;
		{
			while (1) {
				...
				eqsink___stdZassertions_19((&result), T6_);
				{
					...
					T16_ = canonicalizePath__options_4979(conf, result);
					if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
...
{nimErr_ = nimErrorFlag();
	...
	path_2 = getNimbleFile__options_5021(conf, path);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		result = rawFindFile__options_5129(conf, f, suppressStdlib);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			NIM_BOOL T16_;
			NimStringV2 colontmpD__2;
			...
			T20_ = rawFindFile__options_5129(conf, colontmpD__2, suppressStdlib);
			if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
			eqsink___stdZassertions_19((&result), T20_);
			{
				...
				T26_ = rawFindFile2__options_5166(conf, f);
				if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
				eqsink___stdZassertions_19((&result), T26_);
				{
					...
					T33_ = rawFindFile2__options_5166(conf, colontmpD__3);
					if (NIM_UNLIKELY(*nimErr_)) goto LA32_;
	...
	LA1_: ;
	{
		...
		colontmpD__4 = getPackageName__options_5040(conf, result);
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	nimZeroMem((void*)(&colontmpD__2), sizeof(tyTuple__UV3llMMYFckfui8YMBuUZA));
	subdir = getNimcacheDir__options_5047(conf);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
				...
				*nimErr_ = NIM_FALSE;
				{
					NIM_BOOL T12_;
					T12_ = (NIM_BOOL)0;
					T12_ = isDefined__options_2481(conf, TM__ZKkDwQBiNCxtzosUAsGM2Q_137);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, toGeneratedFile__options_5113)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, NimStringV2 path, NimStringV2 ext) {
	NimStringV2 result;
	NimStringV2 colontmpD_;
	NimStringV2 colontmpD__2;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__4 = noschangeFileExt(colontmpD__3.Field1, ext);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, findModule__options_5399)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, NimStringV2 modulename, NimStringV2 currentModule) {
	NimStringV2 result;
	NimStringV2 m;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	m.len = 0; m.p = NIM_NIL;
	m = nosaddFileExt(modulename, TM__ZKkDwQBiNCxtzosUAsGM2Q_152);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NIM_BOOL T4_;
		NimStringV2 colontmpD_;
		...
		result = findFile__options_5379(conf, colontmpD_, NIM_TRUE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
		{
			LA7_:;
		}
	...
	LA5_: ;
	{
			...
			stripped = substr__system_7585(m, ((NI)4));
			{
				...
				i = ((NI)0);
				{
					while (1) {
						...
						colontmpD__2 = slash___stdZprivateZospaths50_90((*conf).libpath, candidate);
		...
		LA14_: ;
		{
			...
			colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
			eqcopy___stdZassertions_16((&colontmpD__3), currentModule);
		...
		LA11_: ;
		{
			...
			T43_ = findFile__options_5379(conf, m, NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	LA2_: ;
	{
		...
		colontmpD__5 = getPackageName__options_5040(conf, result);
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__2 = (NI)0;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nsuStartsWith(s, TM__ZKkDwQBiNCxtzosUAsGM2Q_157);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		colontmpD_ = ((NI)3);
		start = colontmpD_;
	...
	LA1_: ;
	ende = nsuFindCharSet(s, TM__ZKkDwQBiNCxtzosUAsGM2Q_158, ((NI)0), ((NI)-1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!(((NI)0) <= ende)) goto LA9_;
		result = substr__system_7573(s, start, (NI)(ende - ((NI)1)));
	}
	goto LA7_;
	LA9_: ;
	{
		result = substr__system_7585(s, start);
	}
	LA7_: ;
	}BeforeRet_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, inclDynlibOverride__options_5548)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, NimStringV2 lib) {
	NimStringV2 colontmpD_;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD_ = canonDynlibName__options_5543(lib);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	nstPut((*conf).dllOverrides, colontmpD_, TM__ZKkDwQBiNCxtzosUAsGM2Q_160);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___stdZassertions_13((&colontmpD_));
	}BeforeRet_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___modulegraphs_9583)(tyObject_SuggestcolonObjectType___fw9a9cWgWYzM4zKmnq3DGNfQ* dest) {
	eqdestroy___system_3514((&(*dest).qualifiedPath));
...
{nimErr_ = nimErrorFlag();
	...
	T3_ = canonicalizePath__options_4979(conf, projectName);
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	...
	LA9_: ;
	T16_.len = 0; T16_.p = NIM_NIL;
	T16_ = canonicalizePath__options_4979(conf, dir);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		eqsink___stdZassertions_19((&(*conf).libpath), T7_);
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			...
			NimStringV2 blitTmp;
			T10_ = (NIM_BOOL)0;
			colontmpD__3 = slash___stdZprivateZospaths50_90((*conf).libpath, TM__ZKkDwQBiNCxtzosUAsGM2Q_207);
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			T11_ = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, dollar___options_5574)(tyEnum_IdeCmd__qiJleSvN9cnmxSLkFbpwy9bg c) {
	NimStringV2 result;
	NimStringV2 T1_;
	result.len = 0; result.p = NIM_NIL;
	T1_.len = 0; T1_.p = NIM_NIL;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	T3_.len = 0; T3_.p = NIM_NIL;
	T3_ = getEnv__stdZenvvars_14(TM__ZKkDwQBiNCxtzosUAsGM2Q_268, TM__ZKkDwQBiNCxtzosUAsGM2Q_270);
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	colontmpD_ = T3_;
	T4_ = (NI)0;
...
{nimErr_ = nimErrorFlag();
	nimZeroMem((void*)(&result), sizeof(tyTuple__47w2DboNEPf69aPgubZdd7Q));
	{
		...
		b.len = 0; b.p = NIM_NIL;
		b = nsuSplitString(a, TM__ZKkDwQBiNCxtzosUAsGM2Q_276, ((NI)-1));
...
{nimErr_ = nimErrorFlag();
	nimZeroMem((void*)(&result), sizeof(tyTuple__47w2DboNEPf69aPgubZdd7Q));
	{
		...
		T3_ = (NIM_BOOL)0;
		T3_ = eqeq___options_4792((*conf).nimStdlibVersion, TM__ZKkDwQBiNCxtzosUAsGM2Q_271);
		if (!T3_) goto LA4_;
		s.len = 0; s.p = NIM_NIL;
		s = getOrDefault__pureZstrtabs_335((*conf).symbols, TM__ZKkDwQBiNCxtzosUAsGM2Q_273, TM__ZKkDwQBiNCxtzosUAsGM2Q_274);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
...
{nimErr_ = nimErrorFlag();
	...
	ret.len = 0; ret.p = NIM_NIL;
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	ret = canonicalImportAux__options_5516(conf, file);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
