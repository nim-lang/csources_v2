...
static N_INLINE(NIM_BOOL, stopCompile__modulegraphs_8531)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___llstream_68)(tyObject_TLLStream__f9cpUXDA3VY8pIlUfIovHaw** dest);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___passes_363)(tyObject_TPassContext__9aUzdnrOgAbujYuO39brF9bbA** dest);
...
N_LIB_PRIVATE N_NIMCALL(void, prepareConfigNotes__passes_252)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* graph, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* module);
...
N_LIB_PRIVATE N_NIMCALL(void, openPasses__passes_102)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyObject_TPassContext__9aUzdnrOgAbujYuO39brF9bbA** a, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* module, tyObject_IdGeneratorcolonObjectType___C1k2TcDRT9cU4DEatQIT09ag* idgen);
...
N_LIB_PRIVATE N_NIMCALL(void, processImplicits__passes_222)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* graph, tySequence__sM4lkSb7zS6F7OVMvW9cffQ implicits, tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ nodeKind, tyObject_TPassContext__9aUzdnrOgAbujYuO39brF9bbA** a, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* m);
...
N_LIB_PRIVATE N_NIMCALL(NI32, resolveMod__passes_213)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, NimStringV2 module, NimStringV2 relativeTo);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, processTopLevelStmt__passes_191)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* graph, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n, tyObject_TPassContext__9aUzdnrOgAbujYuO39brF9bbA** a);
...
N_LIB_PRIVATE N_NIMCALL(void, closePasses__passes_174)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* graph, tyObject_TPassContext__9aUzdnrOgAbujYuO39brF9bbA** a);
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	T1_ = (NIM_BOOL)0;
	T1_ = !(((*g).doStopCompile.ClP_0 == TM__bJkNie0SMVJdkbkyvVtTzg_3.ClP_0 && (*g).doStopCompile.ClE_0 == TM__bJkNie0SMVJdkbkyvVtTzg_3.ClE_0));
	if (!(T1_)) goto LA2_;
	T1_ = (*g).doStopCompile.ClE_0? (*g).doStopCompile.ClP_0((*g).doStopCompile.ClE_0):((TM__bJkNie0SMVJdkbkyvVtTzg_4)((*g).doStopCompile.ClP_0))();
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	LA2_: ;
	result = T1_;
	}BeforeRet_: ;
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			if (!(colontmp_ < ((NI)10))) goto LA2			;
			{
				NIM_BOOL T5_;
				T5_ = (NIM_BOOL)0;
				T5_ = nimDecRefIsLastCyclicDyn(dest[(colontmp_)- 0]);
				if (!T5_) goto LA6_;
...
{nimErr_ = nimErrorFlag();
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = belongsToProjectPackage__packages_76((*graph).config, module);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
	...
	{
		{
			...
			if (!(nimCmpMem((*(*graph).config).mainPackageNotes, T9_, 12)==0)) goto LA10_;
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				i = i_2;
				{
					...
					if (!!(((*g).passes.p->data[i].Field0 == 0))) goto LA7_;
					T9_ = NIM_NIL;
					T9_ = (*g).passes.p->data[i].Field0(g, module, idgen);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					eqsink___passes_125(&a[(i)- 0], T9_);
				}
				goto LA5_;
				LA7_: ;
				{
					eqsink___passes_125(&a[(i)- 0], ((tyObject_TPassContext__9aUzdnrOgAbujYuO39brF9bbA*) NIM_NIL));
				}
				LA5_: ;
				i_2 += ((NI)1);
			} LA4: ;
...
{nimErr_ = nimErrorFlag();
	...
	fullPath = findModule__options_5399(conf, module, relativeTo);
	...
	LA5_: ;
	{
		result = fileInfoIdx__msgs_391(conf, fullPath);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA2_: ;
	{
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				i = i_2;
				{
					...
					if (!!(((*graph).passes.p->data[i].Field1 == 0))) goto LA8_;
					T10_ = NIM_NIL;
					T10_ = (*graph).passes.p->data[i].Field1(a[(i)- 0], m);
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	relativeTo = toFullPath__msgs_577((*graph).config, (*m).info.fileIndex);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NimStringV2* module;
		NI i;
		...
		L = T3_;
		{
			while (1) {
				...
				module = (&implicits.p->data[i]);
				{
					...
					T8_ = (NI32)0;
					T8_ = resolveMod__passes_213((*graph).config, (*module), relativeTo);
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
					if (!!((((NI32) ((*m).position)) == T8_))) goto LA9_;
					importStmt = NIM_NIL;
					str = NIM_NIL;
					importStmt = newNodeI__ast_3949(nodeKind, (*m).info);
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
					{
						NIM_BOOL T14_;
						T14_ = (NIM_BOOL)0;
						T14_ = processTopLevelStmt__passes_191(graph, importStmt, a);
						if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
						if (!!(T14_)) goto LA15_;
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				i = i_2;
				{
					...
					if (!!(((*graph).passes.p->data[i].Field2 == 0))) goto LA7_;
					T9_ = NIM_NIL;
					T9_ = (*graph).passes.p->data[i].Field2(graph, a[(i)- 0], m);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	s = NIM_NIL;
	{
		NIM_BOOL T4_;
		T4_ = (NIM_BOOL)0;
		T4_ = stopCompile__modulegraphs_8531(graph);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T4_) goto LA5_;
		result = NIM_TRUE;
	...
	prepareConfigNotes__passes_252(graph, module);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	openPasses__passes_102(graph, a, module, idgen);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NimStringV2 filename;
		if (!(stream == ((tyObject_TLLStream__f9cpUXDA3VY8pIlUfIovHaw*) NIM_NIL))) goto LA9_;
		filename.len = 0; filename.p = NIM_NIL;
		filename = toFullPathConsiderDirty__msgs_610((*graph).config, fileIdx);
		if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
		{
			...
			liMessage__msgs_1159((*graph).config, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)4), filename, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), TM__bJkNie0SMVJdkbkyvVtTzg_5, NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			result = NIM_FALSE;
	...
	LA9_: ;
	{
		eqcopy___llstream_71(&s, stream, NIM_FALSE);
	}
	LA7_: ;
	{
		while (1) {
			openParser__syntaxes_199((&p), fileIdx, s, (*graph).cache, (*graph).config);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			{
				NIM_BOOL T23_;
				NIM_BOOL T24_;
				...
				T23_ = (NIM_BOOL)0;
				T24_ = (NIM_BOOL)0;
				T24_ = belongsToStdlib__modulegraphs_14963(graph, module);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				T23_ = !(T24_);
				if (T23_) goto LA25_;
				T26_ = (NIM_BOOL)0;
				T26_ = belongsToStdlib__modulegraphs_14963(graph, module);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				if (!(T26_)) goto LA27_;
				T26_ = eqStrings((*(*module).name).s, TM__bJkNie0SMVJdkbkyvVtTzg_8);
				LA27_: ;
				T23_ = T26_;
				LA25_: ;
				if (!T23_) goto LA28_;
				{
					if (!!(eqStrings((*(*module).name).s, TM__bJkNie0SMVJdkbkyvVtTzg_10))) goto LA32_;
					processImplicits__passes_222(graph, (*(*graph).config).implicitImports, ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)116), a, module);
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
					processImplicits__passes_222(graph, (*(*graph).config).implicitIncludes, ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)121), a, module);
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				}
				LA32_: ;
			}
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			{
				while (1) {
					...
					n = NIM_NIL;
					{
						NIM_BOOL T39_;
						T39_ = (NIM_BOOL)0;
						T39_ = stopCompile__modulegraphs_8531(graph);
					...
					LA44_: ;
					{
						...
						NIM_BOOL T72_;
						T48_ = (NIM_BOOL)0;
						T48_ = !((((*module).flags &((NU64)1<<((NU)((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)15)))&63U)))!=0));
						if (!(T48_)) goto LA49_;
						T50_ = (NIM_BOOL)0;
						T51_ = 0;
						T50_ = !(((1040 & (*module).flags) == T51_));
						if (T50_) goto LA52_;
						T50_ = (((*(*graph).config).features &((NU32)1<<((NU)((((tyEnum_Feature__k2wmsadbuVSPLgnQzpreqA)8)))&31U)))!=0);
						LA52_: ;
						T48_ = T50_;
						LA49_: ;
						if (!T48_) goto LA53_;
						...
						} LA56: ;
						{
							...
							T67_ = (NIM_BOOL)0;
							T67_ = (((*module).flags &((NU64)1<<((NU)((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)4)))&63U)))!=0);
							if (T67_) goto LA68_;
							T67_ = (((*(*graph).config).features &((NU32)1<<((NU)((((tyEnum_Feature__k2wmsadbuVSPLgnQzpreqA)8)))&31U)))!=0);
							LA68_: ;
							if (!T67_) goto LA69_;
							T71_ = NIM_NIL;
							T71_ = reorder__reorder_1341(graph, sl, module);
							if (NIM_UNLIKELY(*nimErr_)) goto LA55_;
						...
						LA69_: ;
						T72_ = (NIM_BOOL)0;
						T72_ = processTopLevelStmt__passes_191(graph, sl, a);
						if (NIM_UNLIKELY(*nimErr_)) goto LA55_;
						(void)(T72_);
					...
					LA53_: ;
					{
						...
						} LA79: ;
						{
							NIM_BOOL T92_;
							T92_ = (NIM_BOOL)0;
							T92_ = processTopLevelStmt__passes_191(graph, sl_2, a);
							if (NIM_UNLIKELY(*nimErr_)) goto LA78_;
							if (!!(T92_)) goto LA93_;
						...
						LA93_: ;
						{
							if (!!((rest == ((tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*) NIM_NIL)))) goto LA97_;
							{
								NIM_BOOL T101_;
								T101_ = (NIM_BOOL)0;
								T101_ = processTopLevelStmt__passes_191(graph, rest, a);
								if (NIM_UNLIKELY(*nimErr_)) goto LA78_;
					...
					{
						{
							NIM_BOOL T109_;
							T109_ = (NIM_BOOL)0;
							T109_ = processTopLevelStmt__passes_191(graph, n, a);
							if (NIM_UNLIKELY(*nimErr_)) goto LA36_;
	...
	closePasses__passes_174(graph, a);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		if (!!(((*(*graph).config).backend == ((tyEnum_TBackend__s27DA9b8P4ksjjsndcLjR2w)1) || (*(*graph).config).backend == ((tyEnum_TBackend__s27DA9b8P4ksjjsndcLjR2w)2) || (*(*graph).config).backend == ((tyEnum_TBackend__s27DA9b8P4ksjjsndcLjR2w)4)))) goto LA120_;
		closeRodFile__modulegraphs_11407(graph, module);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA120_: ;
	result = NIM_TRUE;
...
{nimErr_ = nimErrorFlag();
	nimZeroMem((void*)(&colontmpD_), sizeof(tyTuple__GicXS2CKoWgwFlNKz2d15w));
	{
		...
		internalErrorImpl__msgs_1497((*g).config, unknownLineInfo__lineinfos_350, argX60gensym1_, TM__bJkNie0SMVJdkbkyvVtTzg_17);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
