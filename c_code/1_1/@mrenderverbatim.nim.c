...
{nimErr_ = nimErrorFlag();
	...
	src = sourceLine__msgs_1152(conf__JU8GvAuARjFB4MhQf7JS7w, (*n__0w2geC2NTRB1HXVPghVphA).info);
...
{nimErr_ = nimErrorFlag();
	...
	indent2 = info.col;
	T7_ = (NI)0;
	T7_ = numLines__msgs_1141(conf__Kf9aKMNFG9cncSWaZJeMPU9ag, info.fileIndex);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	numLines = ((NU16) (T7_));
	...
	result = TM__Ut3DGYXxqjf6Sd7VfREQEw_10;
	{
		...
		res = ((NI) (first.line));
		{
			while (1) {
				...
				line = ((NU16) (res));
				info.line = line;
				src = sourceLine__msgs_1152(conf__Kf9aKMNFG9cncSWaZJeMPU9ag, info);
