...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T4_ = (NIM_BOOL)0;
		T4_ = eqeq___int495056_305(a, T3_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T4_)) goto LA5_;
		T7_ = minus___int495056_461(a);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	T1_ = (NIM_BOOL)0;
	T1_ = lteq___int495056_301((*s).a, value);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	if (!(T1_)) goto LA2_;
	T1_ = lteq___int495056_301(value, (*s).b);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	LA2_: ;
	result = T1_;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T2_ = lastOrd__types_1504(conf, (*n).typ);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)14):
	{
			...
			i_2 = ((NI)0);
			{
				while (1) {
					...
					i = i_2;
					{
						...
						internalErrorImpl__msgs_1497((*g).config, (*a).info, TM__IRrKIA9aNr9b6S9bSzM79cgt1g_16, TM__IRrKIA9aNr9b6S9bSzM79cgt1g_17);
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		liMessage__msgs_1159((*g).config, (*a).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_20, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		{
			LA5_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	{
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			T29_ = (NI64)0;
			T29_ = getSize__types_3546((*g).config, (*n).typ);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	case ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)38):
	{
		...
		T37_ = lengthOrd__types_1706((*g).config, (*a).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T38_ = NIM_NIL;
	...
	case ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)58):
	{
		...
		default:
		{
			internalErrorImpl__msgs_1497((*g).config, (*n).info, TM__IRrKIA9aNr9b6S9bSzM79cgt1g_5, TM__IRrKIA9aNr9b6S9bSzM79cgt1g_6);
			if (NIM_UNLIKELY(*nimErr_)) goto LA107_;
		}
		break;
		}
	...
	case ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)59):
	{
		...
		default:
		{
			internalErrorImpl__msgs_1497((*g).config, (*n).info, TM__IRrKIA9aNr9b6S9bSzM79cgt1g_9, TM__IRrKIA9aNr9b6S9bSzM79cgt1g_10);
			if (NIM_UNLIKELY(*nimErr_)) goto LA224_;
		}
		break;
		}
	...
	case ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)65):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T391_ = (NI64)0;
		T391_ = getSize__types_3546((*g).config, (*n).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	case ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)66):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T397_ = (NI64)0;
		T397_ = getSize__types_3546((*g).config, (*n).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	case ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)67):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T403_ = (NI64)0;
		T403_ = getSize__types_3546((*g).config, (*n).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	case ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)69):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T407_ = (NI64)0;
		T407_ = getSize__types_3546((*g).config, (*a).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T409_ = (NI64)0;
		T409_ = getSize__types_3546((*g).config, (*a).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	case ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)68):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T419_ = (NI64)0;
		T419_ = getSize__types_3546((*g).config, (*a).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T421_ = (NI64)0;
		T421_ = getSize__types_3546((*g).config, (*a).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T3_ = lt___int495056_297(value, T4_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (T3_) goto LA5_;
		T6_ = lastOrd__types_1504((*g).config, (*n).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T3_ = lt___int495056_297(T6_, value);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		LA5_: ;
		if (!T3_) goto LA7_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
...
appendString((&T10_), colontmpD__2);
		colontmpD__3 = T10_;
		liMessage__msgs_1159((*g).config, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_43, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		{
			LA9_:;
		}
...
appendString((&T43_), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_32);
					colontmpD_ = T43_;
					liMessage__msgs_1159((*g).config, (*s).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_33, NIM_FALSE);
...
appendString((&T57_), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_36);
					colontmpD__2 = T57_;
					liMessage__msgs_1159((*g).config, (*s).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_37, NIM_FALSE);
						...
						i_4 = ((NI)0);
						{
							while (1) {
								...
								if (NIM_UNLIKELY(*nimErr_)) goto LA87_;
								{
									...
									internalErrorImpl__msgs_1497((*g).config, unknownLineInfo__lineinfos_350, TM__IRrKIA9aNr9b6S9bSzM79cgt1g_45, TM__IRrKIA9aNr9b6S9bSzM79cgt1g_46);
									if (NIM_UNLIKELY(*nimErr_)) goto LA87_;
								}
								LA90_: ;
...
goto LA79_;
			...
			default:
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA116_;
				colontmpD__6 = T119_;
				liMessage__msgs_1159((*g).config, (*s).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__6, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_51, NIM_FALSE);
				if (NIM_UNLIKELY(*nimErr_)) goto LA116_;
				{
					LA116_:;
				}
			...
			if (NIM_UNLIKELY(*nimErr_)) {
				...
				if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3978211584)) {
					...
					*nimErr_ = NIM_FALSE;
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA125_;
					colontmpD__8 = T129_;
					liMessage__msgs_1159((*g).config, (*s).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__8, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_54, NIM_FALSE);
					if (NIM_UNLIKELY(*nimErr_)) goto LA125_;
					{
						LA125_:;
					}
	...
	result = ((tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*) NIM_NIL);
	{
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				LA34_: ;
				{
					internalErrorImpl__msgs_1497((*g).config, (*it).info, TM__IRrKIA9aNr9b6S9bSzM79cgt1g_56, TM__IRrKIA9aNr9b6S9bSzM79cgt1g_57);
					if (NIM_UNLIKELY(*nimErr_)) goto LA4_;
				}
				LA5_: ;
				i_2 += ((NI)1);
...
appendString((&T27_), colontmpD__4);
			colontmpD__5 = T27_;
			liMessage__msgs_1159((*g).config, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__5, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_86, NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA26_;
			{
				LA26_:;
			}
...
appendString((&T51_), colontmpD__10);
			colontmpD__11 = T51_;
			liMessage__msgs_1159((*g).config, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__11, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_90, NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA50_;
			{
				LA50_:;
			}
...
appendString((&T72_), colontmpD__16);
			colontmpD__17 = T72_;
			liMessage__msgs_1159((*g).config, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__17, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_94, NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA71_;
			{
				LA71_:;
			}
...
appendString((&T27_), (*(*field).name).s);
	colontmpD_ = T27_;
	liMessage__msgs_1159((*g).config, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_97, NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)26) ... ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)32):
	{
		...
		case ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)8):
		{
			...
			colontmpD__8 = NIM_NIL;
			{
				...
				if (!T93_) goto LA94_;
				T96_ = (NF)0;
				T96_ = firstFloat__types_1469((*(*n)._kind_6.sons.p->data[((NI)1)]).typ);
				if (NIM_UNLIKELY(*nimErr_)) goto LA88_;
				T97_ = NIM_NIL;
		...
		case ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)9):
		{
			...
			colontmpD__9 = NIM_NIL;
			{
				...
				colontmpD__10 = NIM_NIL;
				{
					...
					T118_ = (NF)0;
					T118_ = lastFloat__types_1627((*(*n)._kind_6.sons.p->data[((NI)1)]).typ);
					if (NIM_UNLIKELY(*nimErr_)) goto LA110_;
					T119_ = NIM_NIL;
				...
				LA116_: ;
				{
					...
					colontmpD__11 = T122_;
					T123_ = lastOrd__types_1504((*g).config, colontmpD__11);
					if (NIM_UNLIKELY(*nimErr_)) goto LA121_;
					T124_ = NIM_NIL;
		...
		case ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)38):
		{
			...
			T158_ = lengthOrd__types_1706((*g).config, (*(*n)._kind_6.sons.p->data[((NI)1)]).typ);
			if (NIM_UNLIKELY(*nimErr_)) goto LA85_;
			T159_ = NIM_NIL;
		...
		if (NIM_UNLIKELY(*nimErr_)) {
			...
			if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 4, 4086380032)) {
				*nimErr_ = NIM_FALSE;
				liMessage__msgs_1159((*g).config, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_68, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_69, NIM_FALSE);
				...
				*nimErr_ = NIM_FALSE;
				liMessage__msgs_1159((*g).config, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_71, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_72, NIM_FALSE);
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)70):
	{
		...
		LA314_: ;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA317_;
			colontmpD__15 = T321_;
			liMessage__msgs_1159((*g).config, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__15, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__IRrKIA9aNr9b6S9bSzM79cgt1g_75, NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA317_;
			{
				LA317_:;
			}
