...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		T19_ = (NI)0;
		T19_ = safeInheritanceDiff__types_3602(colontmpD__2, (*spec).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
		result = (T19_ <= ((NI)0));
...
{nimErr_ = nimErrorFlag();
	{
		...
		(*a).hasSideEffect = NIM_TRUE;
		{
			...
			T10_ = mgetOrPut__sempass50_1287((&(*(*a).c).sideEffects), (NI)((NI)((NU32)(((NI) ((*xX60gensym87_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym87_).Sup.itemId.item))), T9_);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		xX60gensym106_ = NIM_NIL;
		{
			...
			add__varpartitions_1477((&(*a).init), (NI)((NI)((NU32)(((NI) ((*xX60gensym104_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym104_).Sup.itemId.item))));
		...
		LA14_: ;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			T17_ = (NIM_BOOL)0;
			T17_ = contains__sigmatch_4656((((*a).init).p) ? ((*a).init.p->data) : NIM_NIL, (*a).init.len, (NI)((NI)((NU32)(((NI) ((*xX60gensym106_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym106_).Sup.itemId.item))));
			if (!!(T17_)) goto LA18_;
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA20_;
			add__varpartitions_1477((&(*a).init), (NI)((NI)((NU32)(((NI) ((*xX60gensym114_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym114_).Sup.itemId.item))));
			{
				LA20_:;
			}
			{
...
{nimErr_ = nimErrorFlag();
	...
	}
	{
		if (!!(((*e).typ == ((tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*) NIM_NIL)))) goto LA16_;
		{
			...
			if (T20_) goto LA21_;
			T22_ = (NIM_BOOL)0;
			T22_ = isDefectException__types_4295((*e).typ);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			T20_ = !(T22_);
			LA21_: ;
			if (!T20_) goto LA23_;
...
{nimErr_ = nimErrorFlag();
	{
		...
		(*a).hasSideEffect = NIM_TRUE;
		{
			...
			T22_ = mgetOrPut__sempass50_1287((&(*(*a).c).sideEffects), (NI)((NI)((NU32)(((NI) ((*xX60gensym231_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym231_).Sup.itemId.item))), T21_);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		T17_ = T18_;
		if (!(T17_)) goto LA20_;
		colontmpD_ = skipConv__types_3830(n);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		xX60gensym44_ = s;
		add__varpartitions_1477((&(*a).init), (NI)((NI)((NU32)(((NI) ((*xX60gensym44_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym44_).Sup.itemId.item))));
		{
			NI T39_;
			xX60gensym45_ = s;
			s = 0;
			T39_ = (NI)0;
			T39_ = getOrDefault__sempass50_486((*a).scopes, (NI)((NI)((NU32)(((NI) ((*xX60gensym45_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym45_).Sup.itemId.item))));
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
						...
						i_8 = ((NI)0);
						{
							while (1) {
								...
								j_2 = i_8;
								{
									...
									if (NIM_UNLIKELY(*nimErr_)) goto LA38_;
									add__varpartitions_1477((&(*tracked).init), (NI)((NI)((NU32)(((NI) ((*xX60gensym162_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym162_).Sup.itemId.item))));
...
{nimErr_ = nimErrorFlag();
	{
		...
		X5BX5Deq___importer_2418((&(*a).scopes), (NI)((NI)((NU32)(((NI) ((*xX60gensym37_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym37_).Sup.itemId.item))), colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3):
	{
		...
		s = (*n)._kind_4.sym;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			incl__pureZcollectionsZintsets_202((&(*tracked).escapingParams), (NI)((NI)((NU32)(((NI) ((*xX60gensym375_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym375_).Sup.itemId.item))));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	{
		result = isCharArrayPtr__types_4379((*n).typ, NIM_TRUE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)26) ... ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)32):
	{
		...
		LA6_: ;
		result = isCharArrayPtr__types_4379((*n).typ, T5_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	default:
	{
		result = isCharArrayPtr__types_4379((*n).typ, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	}
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			(*(*tracked).owner).flags |= ((NU64)1)<<(((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)42))) & 63);
			{
				...
				if (!(T10_)) goto LA12_;
				T13_ = 0;
				T10_ = sameType__types_1991((*n).typ, (*(*n)._kind_4.sym).typ, T13_);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				LA12_: ;
				if (!T10_) goto LA14_;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)60):
	{
		...
		LA345_: ;
		{
			...
			T353_ = isCharArrayPtr__types_4379((*(*n)._kind_6.sons.p->data[((NI)1)]).typ, NIM_TRUE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA337_;
			LA354_: ;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		xX60gensym55_ = u;
		T6_ = (NIM_BOOL)0;
		T6_ = containsOrIncl__astalgo_402(cycleCheck, (NI)((NI)((NU32)(((NI) ((*xX60gensym55_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym55_).Sup.itemId.item))));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T4_ = !(T6_);
		LA5_: ;
		if (!T4_) goto LA7_;
...
{nimErr_ = nimErrorFlag();
	xX60gensym68_ = NIM_NIL;
	{
		...
		xX60gensym68_ = s;
		T3_ = (NIM_BOOL)0;
		T3_ = hasKey__sempass50_723((*context).sideEffects, (NI)((NI)((NU32)(((NI) ((*xX60gensym68_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym68_).Sup.itemId.item))));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		{
			...
			T8_ = X5BX5D___sempass50_1056((&(*context).sideEffects), (NI)((NI)((NU32)(((NI) ((*xX60gensym71_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym71_).Sup.itemId.item))));
			if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
			...
			L = T9_;
			{
				while (1) {
					...
					u = &colontmp_.p->data[i].Field1;
					{
						...
						if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
						T17_ = (NIM_BOOL)0;
						T17_ = containsOrIncl__astalgo_402(cycleCheck, (NI)((NI)((NU32)(((NI) ((*xX60gensym75_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym75_).Sup.itemId.item))));
						if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
						T15_ = !(T17_);
						LA16_: ;
						if (!T15_) goto LA18_;
