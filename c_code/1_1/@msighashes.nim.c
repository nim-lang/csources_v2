...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)11):
	{
		...
		colontmpD__3 = NIM_NIL;
		{
			...
			normalizedType = skipGenericAlias__types_2396(t__YfE4kTTfoIi09aq0xTAmQyw);
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)14):
	{
		...
		LA89_: ;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			ampeq___sighashes_15(c__arefiq2jPsxLLQ9be2W3big, ((NI64) ((NI)((NI)((NU32)(((NI) ((*xX60gensym38_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym38_).Sup.itemId.item))))));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	indexX60gensym95_ = rawGet__sighashes_618((*graph__iLci27AfFaHOo4pR0byt2Q).symBodyHashes, (NI)((NI)((NU32)(((NI) ((*xX60gensym94_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym94_).Sup.itemId.item))), (&hcX60gensym95_));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	X5BX5Deq___sighashes_961((&(*graph__iLci27AfFaHOo4pR0byt2Q).symBodyHashes), (NI)((NI)((NU32)(((NI) ((*xX60gensym99_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym99_).Sup.itemId.item))), Result);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		X5BX5Deq___sighashes_961((&(*graph__iLci27AfFaHOo4pR0byt2Q).symBodyHashes), (NI)((NI)((NU32)(((NI) ((*xX60gensym113_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym113_).Sup.itemId.item))), Result);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		{
			LA9_:;
		}
