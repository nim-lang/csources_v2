...
static N_INLINE(NI, skipUntil__pureZparseutils_787)(NimStringV2 s, NIM_CHAR until, NI start);
...
static N_INLINE(NI, parseWhile__pureZparseutils_815)(NimStringV2 s, NimStringV2* token, tySet_tyChar__nmiMWKVIe46vacnhAFrQvw validChars, NI start);
...
static N_INLINE(NIM_BOOL, sameEnumTypes__types_2273)(tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* a, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* b);
...
static N_INLINE(NIM_BOOL, sameDistinctTypes__types_2269)(tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* a, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* b);
...
{nimErr_ = nimErrorFlag();
	...
	T2_ = sourceLine__msgs_1142(conf, info);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___stdZassertions_19((&(*colonenv_).line1), T2_);
	column = toColumn__msgs_651(info);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
	...
	LA13_: ;
	{
		...
		if (!(T22_)) goto LA23_;
		T24_ = (NIM_CHAR)0;
		T24_ = X5BX5D___system_7062(ident, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA25_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			T36_ = (NIM_BOOL)0;
			T37_ = (NIM_CHAR)0;
			T37_ = X5BX5D___system_7062(ident, ((NI)1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	(*result).symkind = ((NU8) ((*s).kind));
	{
		...
		LA11_: ;
		{
			...
			T27_ = contains__pureZtimes_2829(T29_, (*(*s).name).id);
			LA28_: ;
			if (!T27_) goto LA30_;
...
appendChar((&T32_), 96);
	...
	LA4_: ;
	{
		...
		T49_ = toFullPath__msgs_577((*g).config, (*(*(*s).ast)._kind_6.sons.p->data[((NI)0)]).info.fileIndex);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA47_: ;
	{
		...
		T58_ = toFullPath__msgs_577((*g).config, infox.fileIndex);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__2 = (tyEnum_TTypeRelation__lgkbomCWReQu9aEySIgDjeQ)0;
	{
		...
		colontmpD__6 = (tyEnum_TTypeRelation__lgkbomCWReQu9aEySIgDjeQ)0;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			if (!(T9_)) goto LA12_;
			T13_ = lastOrd__types_1504(((tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg*) NIM_NIL), a);
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			T14_ = lastOrd__types_1504(((tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg*) NIM_NIL), f);
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		...
		LA15_: ;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			if (!(T18_)) goto LA21_;
			T22_ = lastOrd__types_1504(((tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg*) NIM_NIL), a);
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			T23_ = lastOrd__types_1504(((tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg*) NIM_NIL), f);
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		...
		LA24_: ;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			T29_ = lastOrd__types_1504(((tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg*) NIM_NIL), f);
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			T32_ = lastOrd__types_1504(((tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg*) NIM_NIL), a);
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
	...
	LA4_: ;
	{
		...
		colontmpD__10 = (tyEnum_TTypeRelation__lgkbomCWReQu9aEySIgDjeQ)0;
		{
			...
			T42_ = (NIM_BOOL)0;
			T43_ = (NF)0;
			T43_ = firstFloat__types_1469(a);
			if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
			T44_ = (NF)0;
			T44_ = firstFloat__types_1469(f);
			if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
			T42_ = (T43_ == T44_);
			if (!(T42_)) goto LA45_;
			T46_ = (NF)0;
			T46_ = lastFloat__types_1627(a);
			if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
			T47_ = (NF)0;
			T47_ = lastFloat__types_1627(f);
			if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
			T42_ = (T46_ == T47_);
			LA45_: ;
			if (!T42_) goto LA48_;
		...
		LA48_: ;
		{
			...
			T51_ = (NIM_BOOL)0;
			T52_ = (NF)0;
			T52_ = firstFloat__types_1469(f);
			if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
			T53_ = (NF)0;
			T53_ = firstFloat__types_1469(a);
			if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
			T51_ = (T52_ <= T53_);
			if (!(T51_)) goto LA54_;
			T55_ = (NF)0;
			T55_ = lastFloat__types_1627(a);
			if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
			T56_ = (NF)0;
			T56_ = lastFloat__types_1627(f);
			if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
			T51_ = (T55_ <= T56_);
			LA54_: ;
			if (!T51_) goto LA57_;
		...
		LA57_: ;
		{
			...
			T60_ = (NIM_BOOL)0;
			T61_ = (NF)0;
			T61_ = firstFloat__types_1469(a);
			if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
			T62_ = (NF)0;
			T62_ = lastFloat__types_1627(f);
			if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
			T60_ = (T61_ <= T62_);
			if (!(T60_)) goto LA63_;
			T64_ = (NF)0;
			T64_ = firstFloat__types_1469(f);
			if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
			T65_ = (NF)0;
			T65_ = lastFloat__types_1627(a);
			if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
			T60_ = (T64_ <= T65_);
			LA63_: ;
			if (!T60_) goto LA66_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		k = (*ab).kind;
		nf = normalizeKind__types_1500((*(*c).graph).config, (*f).kind);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		na = normalizeKind__types_1500((*(*c).graph).config, k);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
		...
		LA24_: ;
		{
			...
			T29_ = targetSizeSignedToKind__types_1494((*(*c).graph).config);
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			T27_ = (nf == T29_);
			LA28_: ;
			if (!T27_) goto LA30_;
		...
		LA30_: ;
		{
			...
			T35_ = targetSizeUnsignedToKind__types_1497((*(*c).graph).config);
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			T33_ = (nf == T35_);
			LA34_: ;
			if (!T33_) goto LA36_;
		...
		LA36_: ;
		{
			...
			T41_ = targetSizeSignedToKind__types_1494((*(*c).graph).config);
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		...
		LA42_: ;
		{
			...
			T47_ = targetSizeUnsignedToKind__types_1497((*(*c).graph).config);
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		...
		LA53_: ;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			T57_ = lteq___int495056_745(T67_, (*(*(*a).n)._kind_6.sons.p->data[((NI)0)])._kind_1.intVal);
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			LA66_: ;
			T56_ = T57_;
			if (!(T56_)) goto LA68_;
			T69_ = lastOrd__types_1504(((tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg*) NIM_NIL), f);
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			T56_ = lteq___int495056_752((*(*(*a).n)._kind_6.sons.p->data[((NI)1)])._kind_1.intVal, T69_);
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			LA68_: ;
			if (!T56_) goto LA70_;
			result = ((tyEnum_TTypeRelation__lgkbomCWReQu9aEySIgDjeQ)1);
...
appendString((&T8_), TM__wjrA09aH0rT1R7zbrcCaROw_25);
	colontmpD_ = T8_;
	liMessage__msgs_1159(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__wjrA09aH0rT1R7zbrcCaROw_26, NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		expX60gensym230_ = NIM_NIL;
		{
			if (!((*upperBound).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)6))) goto LA9_;
			{
				tyObject_Int128__o11U6O9aAgrfFG9bStrwmHkg T13_;
				NIM_BOOL T14_;
				T13_ = lengthOrd__types_1706((*(*(*c).c).graph).config, concrete);
				if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
				T14_ = (NIM_BOOL)0;
		...
		upperBound = 0;
		T18_ = lengthOrd__types_1706((*(*(*c).c).graph).config, concrete);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
	...
	LA4_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA32_;
		T35_ = lengthOrd__types_1706((*(*(*c).c).graph).config, concrete);
		if (NIM_UNLIKELY(*nimErr_)) goto LA32_;
...
{nimErr_ = nimErrorFlag();
	...
	result = ((tyEnum_TTypeRelation__lgkbomCWReQu9aEySIgDjeQ)0);
	{
		...
		T3_ = 0;
		T4_ = (NIM_BOOL)0;
		T4_ = sameType__types_1991(f, a, T3_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T4_) goto LA5_;
		result = ((tyEnum_TTypeRelation__lgkbomCWReQu9aEySIgDjeQ)10);
	}
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		while (1) {
			...
			if (!(T4_)) goto LA5_;
			T6_ = (NIM_BOOL)0;
			T6_ = sameObjectTypes__types_2224(f, t);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			T4_ = !(T6_);
			LA5_: ;
			if (!T4_) goto LA3			;
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	result = sameObjectTypes__types_2224(a, b);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___sigmatch_7590)(tyObject_Env_sigmatchdotnim_matchUserTypeClass___PD9aW11HeUq9a1eqUZIZ9a0aQ* dest) {
	...
	LA9_: ;
	eqdestroy___system_3514((&(*dest).diagnostics4));
}
static N_INLINE(void, add__system_2686)(tyObject_CellSeq__sGle0igznE2T7vk4dBh5SQ* s, void** c, TNimTypeV2* t) {
	void** colontmp_;
...
appendString((&T13_), TM__wjrA09aH0rT1R7zbrcCaROw_44);
			colontmpD__3 = T13_;
			liMessage__msgs_1159((*(*(*m).c).graph).config, (*body).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__wjrA09aH0rT1R7zbrcCaROw_45, NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
			result = ((tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*) NIM_NIL);
			eqdestroy___stdZassertions_13((&colontmpD__3));
			eqdestroy___stdZassertions_13((&colontmpD__2));
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)14):
	{
		...
		colontmpD__15 = NIM_NIL;
		{
			...
			T152_ = sameEnumTypes__types_2273(f, a);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			LA153_: ;
		...
		LA154_: ;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			T157_ = (NIM_BOOL)0;
			T157_ = sameEnumTypes__types_2273(f, colontmpD__15);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)31):
	{
		...
		T206_ = targetSizeSignedToKind__types_1494((*(*(*c).c).graph).config);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)40):
	{
		...
		T212_ = targetSizeUnsignedToKind__types_1497((*(*(*c).c).graph).config);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			...
			{
				{
					...
					NIM_BOOL T322_;
					T320_ = lengthOrd__types_1706((*(*(*c).c).graph).config, fRange);
					if (NIM_UNLIKELY(*nimErr_)) goto LA275_;
					T321_ = lengthOrd__types_1706((*(*(*c).c).graph).config, aRange);
					if (NIM_UNLIKELY(*nimErr_)) goto LA275_;
					T322_ = (NIM_BOOL)0;
	...
	{
		{
			if (!((*a).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)17))) goto LA513_;
			{
				NIM_BOOL T517_;
				T517_ = (NIM_BOOL)0;
				T517_ = sameObjectTypes__types_2224(f, a);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)13):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		{
			if (!((*a).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)13))) goto LA531_;
			{
				NIM_BOOL T535_;
				T535_ = (NIM_BOOL)0;
				T535_ = sameDistinctTypes__types_2269(f, a);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				...
				i_11 = ((NI)1);
				{
					while (1) {
						...
						i_10 = i_11;
						{
							...
							internalErrorImpl__msgs_1497((*(*(*c).c).graph).config, unknownLineInfo__lineinfos_350, TM__wjrA09aH0rT1R7zbrcCaROw_35, TM__wjrA09aH0rT1R7zbrcCaROw_36);
							if (NIM_UNLIKELY(*nimErr_)) goto LA916_;
						}
						goto LA966_;
						LA968_: ;
					...
					i_13 = ((NI)1);
					{
						while (1) {
							...
							LA1011_: ;
							{
								...
								internalErrorImpl__msgs_1497((*(*(*c).c).graph).config, unknownLineInfo__lineinfos_350, TM__wjrA09aH0rT1R7zbrcCaROw_37, TM__wjrA09aH0rT1R7zbrcCaROw_38);
								if (NIM_UNLIKELY(*nimErr_)) goto LA1007_;
							}
							goto LA1009_;
							LA1014_: ;
				...
				LA1293_: ;
				{
					...
					LA1301_: ;
					{
						...
						colontmpD__82 = NIM_NIL;
						{
							...
							internalErrorImpl__msgs_1497((*(*(*c).c).graph).config, unknownLineInfo__lineinfos_350, argX60gensym469_, TM__wjrA09aH0rT1R7zbrcCaROw_58);
							if (NIM_UNLIKELY(*nimErr_)) goto LA1310_;
							{
								LA1310_:;
							}
...
appendString((&T1642_), colontmpD__107);
		...
		internalErrorImpl__msgs_1497((*(*(*c).c).graph).config, unknownLineInfo__lineinfos_350, colontmpD__108, TM__wjrA09aH0rT1R7zbrcCaROw_61);
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		internalErrorImpl__msgs_1497((*(*c).graph).config, (*arg).info, TM__wjrA09aH0rT1R7zbrcCaROw_65, TM__wjrA09aH0rT1R7zbrcCaROw_66);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T11_ = NIM_NIL;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = containsGenericType__types_3570(f);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		{
			tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* colontmpD_;
	...
	LA1_: ;
	{
		...
		internalErrorImpl__msgs_1497((*(*c).graph).config, (*arg).info, TM__wjrA09aH0rT1R7zbrcCaROw_70, TM__wjrA09aH0rT1R7zbrcCaROw_71);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA20_: ;
...
appendString((&T37_), TM__wjrA09aH0rT1R7zbrcCaROw_85);
							colontmpD__2 = T37_;
							liMessage__msgs_1159(conf, info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)23), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__wjrA09aH0rT1R7zbrcCaROw_86, NIM_FALSE);
							if (NIM_UNLIKELY(*nimErr_)) goto LA36_;
							eqdestroy___stdZassertions_13((&colontmpD__2));
...
appendString((&T42_), TM__wjrA09aH0rT1R7zbrcCaROw_88);
	colontmpD_ = T42_;
	liMessage__msgs_1159(conf, info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)23), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__wjrA09aH0rT1R7zbrcCaROw_89, NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
appendString((&T23_), TM__wjrA09aH0rT1R7zbrcCaROw_92);
							...
							T22_[0] = colontmpD__3;
							T22_[1] = (*(*s).name).s;
							colontmpD__4 = toFileLineCol__msgs_658(conf, (*(*s).ast).info);
							if (NIM_UNLIKELY(*nimErr_)) goto LA21_;
							T22_[2] = colontmpD__4;
							colontmpD__5 = nsuFormatOpenArray(TM__wjrA09aH0rT1R7zbrcCaROw_91, T22_, 3);
							if (NIM_UNLIKELY(*nimErr_)) goto LA21_;
							liMessage__msgs_1159(conf, info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__5, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__wjrA09aH0rT1R7zbrcCaROw_96, NIM_FALSE);
							if (NIM_UNLIKELY(*nimErr_)) goto LA21_;
	...
	T28_[1] = (*(*s).name).s;
	colontmpD_ = toFileLineCol__msgs_658(conf, (*(*s).ast).info);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T28_[2] = colontmpD_;
	colontmpD__2 = nsuFormatOpenArray(TM__wjrA09aH0rT1R7zbrcCaROw_97, T28_, 3);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	liMessage__msgs_1159(conf, info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__wjrA09aH0rT1R7zbrcCaROw_99, NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
		...
		i = ((NI)0);
		{
			while (1) {
				...
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				{
					...
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					T19_ = (NI)0;
					T19_ = getOrDefault__sigmatch_5960((*c).importModuleMap, (NI)((NI)((NU32)(((NI) ((*xX60gensym904_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym904_).Sup.itemId.item))), ((NI)(-2147483647 -1)));
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TTypeRelation__lgkbomCWReQu9aEySIgDjeQ)0):
	{
		...
		LA184_: ;
		{
			...
			colontmpD__8 = NIM_NIL;
			colontmpD__9 = NIM_NIL;
			liMessage__msgs_1159((*(*c).graph).config, (*argOrig).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)75), TM__wjrA09aH0rT1R7zbrcCaROw_75, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__wjrA09aH0rT1R7zbrcCaROw_76, NIM_FALSE);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___system_3517((&(*dest).diagnostics), (*src).diagnostics);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___system_3514((&(*dest).diagnostics));
	{
		NIM_BOOL T23_;
		T23_ = (NIM_BOOL)0;
	...
	LA5_: ;
	{
		...
		LA40_: ;
		{
			...
			if (!T43_) goto LA46_;
			{
				...
				internalErrorImpl__msgs_1497((*(*(*m).c).graph).config, (*arg).info, TM__wjrA09aH0rT1R7zbrcCaROw_101, TM__wjrA09aH0rT1R7zbrcCaROw_102);
				if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
			}
			LA50_: ;
			{
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___system_3520((&(*c).diagnostics), T26_);
		...
		while (1) {
			...
			LA26_: ;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				{
					...
					liMessage__msgs_1159((*(*c).graph).config, (*(*n)._kind_6.sons.p->data[a]).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__wjrA09aH0rT1R7zbrcCaROw_107, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__wjrA09aH0rT1R7zbrcCaROw_108, NIM_FALSE);
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				...
				{
					{
						...
						internalErrorImpl__msgs_1497((*(*c).graph).config, (*(*n)._kind_6.sons.p->data[a]).info, TM__wjrA09aH0rT1R7zbrcCaROw_111, TM__wjrA09aH0rT1R7zbrcCaROw_112);
						if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
						mergeShadowScope__lookups_1114(c);
						if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
						(*m).state = ((tyEnum_TCandidateState__8Fl0MIRwBeKUXc1wEPjTRQ)2);
					...
					LA220_: ;
					{
						...
						LA258_: ;
						{
							...
							if (NIM_UNLIKELY(*nimErr_)) goto LA261_;
							liMessage__msgs_1159((*(*c).graph).config, (*(*n)._kind_6.sons.p->data[a]).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__16, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__wjrA09aH0rT1R7zbrcCaROw_115, NIM_FALSE);
							if (NIM_UNLIKELY(*nimErr_)) goto LA261_;
							mergeShadowScope__lookups_1114(c);
							if (NIM_UNLIKELY(*nimErr_)) goto LA261_;
							(*m).state = ((tyEnum_TCandidateState__8Fl0MIRwBeKUXc1wEPjTRQ)2);
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = dollar___options_5574((*suggest).section);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	{
		{
			...
			L_2 = T21_;
			{
				while (1) {
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA24_;
					suggestWriteln__msgs_436(conf, colontmpD_);
					if (NIM_UNLIKELY(*nimErr_)) goto LA24_;
					i_2 += ((NI)1);
					{
						LA24_:;
...
{nimErr_ = nimErrorFlag();
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = exactEquals__msgs_1039((*(*(*c).graph).config).m.trackPos, (*n).info);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___sem_2056)(tySequence__QlpmqBu4k7qSn9cgYGyYsWw* dest) {
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			LA12_: ;
			eqdestroy___system_3514((&(*dest).p->data[colontmp_].diagnostics));
			colontmp_ += ((NI)1);
		} LA2: ;
	}
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
				{
					...
					LA21_: ;
					{
						...
						defaultValue = NIM_NIL;
						{
							...
							if (NIM_UNLIKELY(*nimErr_)) goto LA44_;
							liMessage__msgs_1159((*(*c).graph).config, (*(*m).call).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__6, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__wjrA09aH0rT1R7zbrcCaROw_134, NIM_FALSE);
							if (NIM_UNLIKELY(*nimErr_)) goto LA44_;
							{
								LA44_:;
							}
...
appendString((&T8_), TM__wjrA09aH0rT1R7zbrcCaROw_137);
		colontmpD_ = T8_;
		liMessage__msgs_1159((*(*c).graph).config, info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__wjrA09aH0rT1R7zbrcCaROw_138, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
...
appendString((&T33_), TM__wjrA09aH0rT1R7zbrcCaROw_140);
		colontmpD__2 = T33_;
		liMessage__msgs_1159((*(*c).graph).config, info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__wjrA09aH0rT1R7zbrcCaROw_141, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA32_;
		{
			LA32_:;
		}
...
{nimErr_ = nimErrorFlag();
	outputs.len = 0; outputs.p = NIM_NIL;
	{
		...
		if (T4_) goto LA5_;
		T4_ = !((((NI32) ((*(*c).module).position)) == (*(*(*c).graph).config).m.trackPos.fileIndex));
		LA5_: ;
		if (!T4_) goto LA6_;
		eqdestroy___modulegraphs_9569((&outputs));
		goto BeforeRet_;
						...
						if (NIM_UNLIKELY(*nimErr_)) goto LA23_;
						{
							while (1) {
								...
								pm = (tyEnum_PrefixMatch__pLG39bnDOrZac0FzWXgLG0w)0;
								{
									...
									if (NIM_UNLIKELY(*nimErr_)) goto LA23_;
									if (!T28_) goto LA29_;
									T31_ = newLineInfo__msgs_396((*(*(*c).graph).config).m.trackPos.fileIndex, ((NI)0), ((NI)-1));
									if (NIM_UNLIKELY(*nimErr_)) goto LA23_;
									T32_ = (NI)0;
							...
							if (NIM_UNLIKELY(*nimErr_)) goto LA50_;
							{
								while (1) {
									...
									pm_2 = (tyEnum_PrefixMatch__pLG39bnDOrZac0FzWXgLG0w)0;
									{
										...
										if (NIM_UNLIKELY(*nimErr_)) goto LA50_;
										if (!T57_) goto LA58_;
										T60_ = newLineInfo__msgs_396((*(*(*c).graph).config).m.trackPos.fileIndex, ((NI)0), ((NI)-1));
										if (NIM_UNLIKELY(*nimErr_)) goto LA50_;
										T61_ = (NI)0;
									...
									while (1) {
										...
										s_3 = &colontmp__3.p->data[i_2];
										{
											...
											pm_3 = (tyEnum_PrefixMatch__pLG39bnDOrZac0FzWXgLG0w)0;
											{
												...
												if (NIM_UNLIKELY(*nimErr_)) goto LA68_;
												if (!T82_) goto LA83_;
												T85_ = newLineInfo__msgs_396((*(*(*c).graph).config).m.trackPos.fileIndex, ((NI)0), ((NI)-1));
												if (NIM_UNLIKELY(*nimErr_)) goto LA68_;
												T86_ = (NI)0;
