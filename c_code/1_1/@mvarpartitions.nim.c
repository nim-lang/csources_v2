...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___varpartitions_211)(tySequence__qwqHTkRvwhrRyENtudHQ7g* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, registerParam__varpartitions_465)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n);
...
N_LIB_PRIVATE N_NIMCALL(void, registerResult__varpartitions_349)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___ast_3454)(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q** dest);
N_LIB_PRIVATE N_NIMCALL(void, computeLiveRanges__varpartitions_1930)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n);
...
N_LIB_PRIVATE N_NIMCALL(void, registerVariable__varpartitions_570)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n);
N_LIB_PRIVATE N_NIMCALL(NI, variableId__varpartitions_332)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* x);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___ast_4060)(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA** dest);
static N_INLINE(void, markAsReassigned__varpartitions_1919)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, NI vid);
static N_INLINE(NI, max__varpartitions_2003)(NI x, NI y);
...
N_LIB_PRIVATE N_NIMCALL(void, traverse__varpartitions_1739)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n);
N_LIB_PRIVATE N_NIMCALL(void, deps__varpartitions_1614)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* dest, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* src);
N_LIB_PRIVATE N_NIMCALL(void, borrowingAsgn__varpartitions_1536)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* dest, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* src);
...
N_LIB_PRIVATE N_NIMCALL(void, borrowFrom__varpartitions_1446)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* dest, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* src);
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, pathExpr__varpartitions_875)(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* node, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* owner);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, borrowFromConstExpr__varpartitions_840)(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, toString__varpartitions_1439)(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isConstSym__varpartitions_1424)(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s);
N_LIB_PRIVATE N_NIMCALL(void, allRoots__varpartitions_935)(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n, tySequence__YeE3Q6WHPvSBrNLQF9alkGA* result, NI level);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, containsPointer__varpartitions_1604)(tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* t);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, wrap__varpartitions_1607)(tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* t);
N_LIB_PRIVATE N_NIMCALL(void, potentialMutation__varpartitions_602)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* v, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s, NI level, tyObject_TLineInfo__7ZAGqjaN6WqWPlHP9cRagRg info);
N_LIB_PRIVATE N_NIMCALL(NI, root__varpartitions_581)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* v, NI start);
N_LIB_PRIVATE N_NIMCALL(void, add__varpartitions_664)(tySequence__qwqHTkRvwhrRyENtudHQ7g* x, NI value);
N_LIB_PRIVATE N_NIMCALL(void, connect__varpartitions_711)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* v, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* a, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* b, tyObject_TLineInfo__7ZAGqjaN6WqWPlHP9cRagRg info);
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___varpartitions_214)(tySequence__qwqHTkRvwhrRyENtudHQ7g* dest, tySequence__qwqHTkRvwhrRyENtudHQ7g src);
...
N_LIB_PRIVATE N_NIMCALL(void, destMightOwn__varpartitions_1121)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_VarIndex__gqlFfS5HP9cscNmlzNsazBA* dest, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___varpartitions_1311)(tySequence__YeE3Q6WHPvSBrNLQF9alkGA* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, noCursor__varpartitions_1407)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s);
N_LIB_PRIVATE N_NIMCALL(void, borrowingCall__varpartitions_1506)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* destType, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n, NI i);
N_LIB_PRIVATE N_NIMCALL(void, potentialMutationViaArg__varpartitions_1722)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* callee);
N_LIB_PRIVATE N_NIMCALL(void, pretendOwnsData__varpartitions_1415)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s);
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___pureZosproc_409)(tySequence__qwqHTkRvwhrRyENtudHQ7g* dest, tySequence__qwqHTkRvwhrRyENtudHQ7g src);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, dangerousMutation__varpartitions_2314)(tyObject_MutationInfo__09cglYawlQfhTDITHVV8vBw* g, tyObject_VarIndex__gqlFfS5HP9cscNmlzNsazBA* v);
static N_INLINE(NIM_BOOL, contains__varpartitions_2370)(tyObject_HSlice__EE5dzjqoOrHT6HJhIPXAvA s, NI value);
static N_INLINE(tyObject_HSlice__EE5dzjqoOrHT6HJhIPXAvA, dotdot___varpartitions_2346)(NI a, NI b);
N_LIB_PRIVATE N_NIMCALL(void, cannotBorrow__varpartitions_2389)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* config, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s, tyObject_MutationInfo__09cglYawlQfhTDITHVV8vBw* g);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___varpartitions_2137)(tySequence__MSDrKmAF4cj59cY74qFKQtQ* dest);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___varpartitions_2224)(tySequence__oPvbBQGfJLgF9axmfwR3PQA* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___varpartitions_199)(tyObject_MutationInfo__09cglYawlQfhTDITHVV8vBw* dest) {
	...
	LA4_: ;
	eqdestroy___varpartitions_211((&(*dest).mutations));
}
static N_INLINE(void, nimSetMem__systemZmemory_7)(void* a, int v, NI size) {
	void* T1_;
	T1_ = (void*)0;
...
{nimErr_ = nimErrorFlag();
	{
		...
		T3_ = (NIM_BOOL)0;
		T3_ = ((*(*n)._kind_4.sym).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)3));
		if (!(T3_)) goto LA4_;
		T3_ = !(((*(*(*n)._kind_4.sym).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)23) || (*(*(*n)._kind_4.sym).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)46)));
		LA4_: ;
		if (!T3_) goto LA5_;
		colontmpD_ = NIM_NIL;
		colontmpD__2 = (NI)0;
		...
		colontmpD__2 = (*c).abstractTime;
		T7_.aliveStart = colontmpD__2;
		colontmpD__3 = (*c).abstractTime;
		T7_.aliveEnd = colontmpD__3;
		add__varpartitions_356((&(*c).s), (&T7_));
		nimZeroMem((void*)(&T9_), sizeof(tyObject_MutationInfo__09cglYawlQfhTDITHVV8vBw));
		nimZeroMem((void*)(&T9_), sizeof(tyObject_MutationInfo__09cglYawlQfhTDITHVV8vBw));
		colontmpD__4 = 0;
		eqcopy___ast_4063(&colontmpD__4, (*n)._kind_4.sym);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		add__varpartitions_494((&(*c).graphs), (&T9_));
	}
	goto LA1_;
	LA5_: ;
	{
		...
		colontmpD__8 = 0;
		eqcopy___ast_4063(&colontmpD__8, (*n)._kind_4.sym);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T11_.sym = colontmpD__8;
		T11_.reassignedTo = ((NI)0);
		colontmpD__9 = (*c).abstractTime;
		T11_.aliveStart = colontmpD__9;
		colontmpD__10 = (*c).abstractTime;
		T11_.aliveEnd = colontmpD__10;
		add__varpartitions_356((&(*c).s), (&T11_));
	}
	LA1_: ;
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	{
		...
		add__varpartitions_356((&(*c).s), (&T5_));
	}
	LA3_: ;
	}BeforeRet_: ;
}
...
{	result = (NI)0;
	{
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				i = i_2;
				{
					if (!((*c).s.p->data[i].sym == x)) goto LA7_;
					result = i;
					goto BeforeRet_;
				}
				LA7_: ;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (!(T3_)) goto LA4_;
		T5_ = (NI)0;
		T5_ = variableId__varpartitions_332((&(*c)), (*n)._kind_4.sym);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T3_ = (T5_ < ((NI)0));
		LA4_: ;
		if (!T3_) goto LA6_;
		...
		add__varpartitions_356((&(*c).s), (&T8_));
	}
	LA6_: ;
	}BeforeRet_: ;
}
static N_INLINE(void, markAsReassigned__varpartitions_1919)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, NI vid) {
	(*c).s.p->data[vid].flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)2))) & 7);
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		...
		LA4_: ;
		if (!T3_) goto LA5_;
		(*c).s.p->data[vid].flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)3))) & 7);
	}
	LA5_: ;
}
static N_INLINE(NI, max__varpartitions_2003)(NI x, NI y) {
...
{nimErr_ = nimErrorFlag();
			...
			child = NIM_NIL;
			{
				...
				i_2 = ((NI)0);
				{
					while (1) {
						...
						if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
						computeLiveRanges__varpartitions_1930(c, last);
						if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
						{
							NIM_BOOL T10_;
							T10_ = (NIM_BOOL)0;
							...
							LA18_: ;
							{
								...
								i_4 = ((NI)0);
								{
									while (1) {
										...
										i_3 = i_4;
										registerVariable__varpartitions_570(c, (*child)._kind_6.sons.p->data[i_3]);
										if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
										i_4 += ((NI)1);
									} LA23: ;
								}
						...
						{
							{
								...
								i_6 = ((NI)0);
								{
									while (1) {
										...
										i_5 = i_6;
										registerVariable__varpartitions_570(c, (*child)._kind_6.sons.p->data[i_5]);
										if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
										i_6 += ((NI)1);
									} LA28: ;
								}
	...
	{
		computeLiveRanges__varpartitions_1930(c, (*n)._kind_6.sons.p->data[((NI)0)]);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		computeLiveRanges__varpartitions_1930(c, (*n)._kind_6.sons.p->data[((NI)1)]);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			NI vid;
			if (!((*(*n)._kind_6.sons.p->data[((NI)0)]).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3))) goto LA36_;
			vid = variableId__varpartitions_332((&(*c)), (*(*n)._kind_6.sons.p->data[((NI)0)])._kind_4.sym);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			{
				...
				xX60gensym181_ = NIM_NIL;
				{
					...
					T44_ = (NIM_BOOL)0;
					T44_ = ((*(*n)._kind_6.sons.p->data[((NI)1)]).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3));
					if (!(T44_)) goto LA45_;
					T46_ = (NIM_BOOL)0;
					T46_ = ((*c).s.p->data[vid].reassignedTo == ((NI)0));
					if (T46_) goto LA47_;
					xX60gensym181_ = (*(*n)._kind_6.sons.p->data[((NI)1)])._kind_4.sym;
					T46_ = ((*c).s.p->data[vid].reassignedTo == (NI)((NI)((NU32)(((NI) ((*xX60gensym181_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym181_).Sup.itemId.item))));
					LA47_: ;
					T44_ = T46_;
					LA45_: ;
					if (!T44_) goto LA48_;
					xX60gensym183_ = NIM_NIL;
					eqcopy___ast_4063(&xX60gensym183_, (*(*n)._kind_6.sons.p->data[((NI)1)])._kind_4.sym);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					(*c).s.p->data[vid].reassignedTo = (NI)((NI)((NU32)(((NI) ((*xX60gensym183_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym183_).Sup.itemId.item)));
				...
				LA48_: ;
				{
					markAsReassigned__varpartitions_1919(c, vid);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				}
				LA42_: ;
			}
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3):
	{
		(*c).abstractTime -= ((NI)1);
		{
			...
			id = variableId__varpartitions_332((&(*c)), (*n)._kind_4.sym);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			{
				if (!(((NI)0) <= id)) goto LA58_;
				(*c).s.p->data[id].aliveEnd = max__varpartitions_2003((*c).s.p->data[id].aliveEnd, (*c).abstractTime);
				{
					if (!((*(*n)._kind_4.sym).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)11))) goto LA62_;
					(*c).s.p->data[id].aliveStart = min__varpartitions_755((*c).s.p->data[id].aliveStart, (*c).abstractTime);
				}
				LA62_: ;
			}
			LA58_: ;
			...
			child_2 = NIM_NIL;
			{
				...
				i_8 = ((NI)0);
				{
					while (1) {
						...
						i_7 = i_8;
						eqcopy___ast_3457(&child_2, (*n)._kind_6.sons.p->data[i_7]);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						computeLiveRanges__varpartitions_1930(c, child_2);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						i_8 += ((NI)1);
					} LA69: ;
				}
		...
		LA70_: ;
		{
			...
			i_10 = ((NI)1);
			{
				while (1) {
					...
					it = NIM_NIL;
					i_9 = i_10;
					eqcopy___ast_3457(&it, (*n)._kind_6.sons.p->data[i_9]);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					{
						NIM_BOOL T80_;
						...
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						{
							...
							LA88_: ;
							if (!T86_) goto LA89_;
							vid_2 = variableId__varpartitions_332((&(*c)), (*it)._kind_4.sym);
							if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
							{
								if (!(((NI)0) <= vid_2)) goto LA93_;
								markAsReassigned__varpartitions_1919(c, vid_2);
								if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
							}
							LA93_: ;
						}
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)64):
	{
		...
		{
			NI vid_3;
			if (!((*(*n)._kind_6.sons.p->data[((NI)0)]).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3))) goto LA98_;
			vid_3 = variableId__varpartitions_332((&(*c)), (*(*n)._kind_6.sons.p->data[((NI)0)])._kind_4.sym);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			{
				if (!(((NI)0) <= vid_3)) goto LA102_;
				(*c).s.p->data[vid_3].flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)1))) & 7);
			}
			LA102_: ;
		}
		LA98_: ;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)91):
	{
		...
		colontmpD__3 = lastSon__ast_6268(n);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		computeLiveRanges__varpartitions_1930(c, colontmpD__3);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	{
		{
			...
			child_3 = NIM_NIL;
			{
				...
				i_11 = (NI)0;
				colontmp__6 = (NI)0;
				colontmp__6 = safeLen__ast_3318(n);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				i_12 = ((NI)0);
				{
					while (1) {
						...
						i_11 = i_12;
						eqcopy___ast_3457(&child_3, (*n)._kind_6.sons.p->data[i_11]);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						computeLiveRanges__varpartitions_1930(c, child_3);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						i_12 += ((NI)1);
					} LA109: ;
				}
			...
			child_4 = NIM_NIL;
			{
				...
				i_14 = ((NI)0);
				{
					while (1) {
						...
						i_13 = i_14;
						eqcopy___ast_3457(&child_4, (*n)._kind_6.sons.p->data[i_13]);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						computeLiveRanges__varpartitions_1930(c, child_4);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						i_14 += ((NI)1);
					} LA113: ;
				}
		...
		(*c).inLoop -= ((NI)1);
		{
			if (!((*n).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)96))) goto LA116_;
			computeLiveRanges__varpartitions_1930(c, (*n)._kind_6.sons.p->data[((NI)0)]);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA116_: ;
			...
			child_5 = NIM_NIL;
			{
				...
				i_16 = ((NI)0);
				{
					while (1) {
						...
						i_15 = i_16;
						eqcopy___ast_3457(&child_5, (*n)._kind_6.sons.p->data[i_15]);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						computeLiveRanges__varpartitions_1930(c, child_5);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						i_16 += ((NI)1);
					} LA122: ;
				}
			...
			child_6 = NIM_NIL;
			{
				...
				i_18 = ((NI)0);
				{
					while (1) {
						...
						i_17 = i_18;
						eqcopy___ast_3457(&child_6, (*n)._kind_6.sons.p->data[i_17]);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						computeLiveRanges__varpartitions_1930(c, child_6);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						i_18 += ((NI)1);
					} LA127: ;
				}
			...
			i_2 = colontmp_;
			{
				while (1) {
					...
					i = i_2;
					{
						NIM_BOOL T9_;
						T9_ = (NIM_BOOL)0;
						T9_ = borrowFromConstExpr__varpartitions_840((*n)._kind_6.sons.p->data[i]);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						if (!!(T9_)) goto LA10_;
						result = NIM_FALSE;
						goto BeforeRet_;
				...
				i_4 = ((NI)1);
				{
					while (1) {
						...
						i_3 = i_4;
						{
							NIM_BOOL T23_;
							T23_ = (NIM_BOOL)0;
							T23_ = borrowFromConstExpr__varpartitions_840((*n)._kind_6.sons.p->data[i_3]);
							if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
							if (!!(T23_)) goto LA24_;
							result = NIM_FALSE;
							goto BeforeRet_;
				...
				{
					{
						NIM_BOOL T13_;
						T13_ = (NIM_BOOL)0;
						T13_ = ((*(*n)._kind_4.sym).owner == owner);
						if (T13_) goto LA14_;
				...
				{
					{
						...
						T20_ = (NIM_BOOL)0;
						T20_ = ((*(*n)._kind_4.sym).owner == owner);
						if (T20_) goto LA21_;
						T22_ = 0;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		result = dollar___renderer_2511(n);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA1_: ;
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isConstSym__varpartitions_1424)(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s) {
	...
	result = (NIM_BOOL)0;
	T1_ = (NIM_BOOL)0;
	T1_ = ((*s).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)10) || (*s).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)9));
	if (T1_) goto LA2_;
	T3_ = (NIM_BOOL)0;
	T3_ = ((*s).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)3));
	if (!(T3_)) goto LA4_;
	T3_ = !(((*(*s).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)23) || (*(*s).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)46)));
	LA4_: ;
	T1_ = T3_;
	LA2_: ;
	result = T1_;
...
{nimErr_ = nimErrorFlag();
	s = NIM_NIL;
	s = pathExpr__varpartitions_875(src, (*c).owner);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		colontmpD_ = toString__varpartitions_1439(src);
...
appendString((&T7_), TM__4R4QZluAmhY3f04fEZJ3nA_8);
		colontmpD__2 = T7_;
		liMessage__msgs_1159((*(*c).g).config, (*src).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__4R4QZluAmhY3f04fEZJ3nA_9, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
	...
	LA4_: ;
	{
		...
		{
			if (!((*dest).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)11))) goto LA15_;
			{
				NIM_BOOL T19_;
				T19_ = (NIM_BOOL)0;
				...
				LA20_: ;
				if (!T19_) goto LA21_;
				liMessage__msgs_1159((*(*c).g).config, (*src).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__4R4QZluAmhY3f04fEZJ3nA_12, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__4R4QZluAmhY3f04fEZJ3nA_13, NIM_FALSE);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			}
			LA21_: ;
		}
		LA15_: ;
		vid = variableId__varpartitions_332((&(*c)), dest);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		{
			NI sourceIdx;
			if (!(((NI)0) <= vid)) goto LA25_;
			sourceIdx = variableId__varpartitions_332((&(*c)), (*s)._kind_4.sym);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			{
				...
				add__varpartitions_356((&(*c).s), (&T32_));
			}
			LA29_: ;
			add__varpartitions_1477((&(*c).s.p->data[vid].borrowsFrom), sourceIdx);
			{
				NIM_BOOL T35_;
				T35_ = (NIM_BOOL)0;
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				if (!T35_) goto LA36_;
				(*c).s.p->data[vid].flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)5))) & 7);
			}
			LA36_: ;
		}
		LA25_: ;
	...
	{
		NI vid_2;
		vid_2 = variableId__varpartitions_332((&(*c)), dest);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		{
			if (!(((NI)0) <= vid_2)) goto LA41_;
			(*c).s.p->data[vid_2].flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)5))) & 7);
		}
		LA41_: ;
	}
	LA2_: ;
...
{nimErr_ = nimErrorFlag();
	{
		if (!((*dest).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3))) goto LA3_;
		{
			tyEnum_ViewTypeKind__ALnennKArpbLOuC2lHSncQ T7_;
			T7_ = (tyEnum_ViewTypeKind__ALnennKArpbLOuC2lHSncQ)0;
			T7_ = directViewType__typeallowed_583((*dest).typ);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!!((T7_ == ((tyEnum_ViewTypeKind__ALnennKArpbLOuC2lHSncQ)0)))) goto LA8_;
			borrowFrom__varpartitions_1446(c, (*dest)._kind_4.sym, src);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA8_: ;
	}
	...
	LA3_: ;
	{
		...
		viewOrigin = NIM_NIL;
		viewOrigin = pathExpr__varpartitions_875(dest, (*c).owner);
		if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			directView = directViewType__typeallowed_583((*(*dest)._kind_6.sons.p->data[((NI)0)]).typ);
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			...
			viewSets |=((NU8)(1)<<(((originSymbolView))%(sizeof(NU8)*8)));
			{
				...
				vid = variableId__varpartitions_332((&(*c)), viewSym);
				if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
				{
					if (!(((NI)0) <= vid)) goto LA25_;
					(*c).s.p->data[vid].flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)4))) & 7);
				}
				LA25_: ;
			}
			goto LA18_;
...
{nimErr_ = nimErrorFlag();
	...
	{
		{
			...
			add__varpartitions_943((&(*result)), T6_);
		}
		LA4_: ;
	}
	break;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)65):
	{
		allRoots__varpartitions_935((*n)._kind_6.sons.p->data[((NI)0)], result, (NI)(level + ((NI)1)));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)42):
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)64):
	{
		allRoots__varpartitions_935((*n)._kind_6.sons.p->data[((NI)0)], result, level);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)33):
	...
	{
		{
			...
			allRoots__varpartitions_935(colontmpD__3, result, level);
			if (NIM_UNLIKELY(*nimErr_)) goto LA15_;
			{
				LA15_:;
			}
	...
	{
		{
			...
			i_2 = ((NI)1);
			{
				while (1) {
					...
					allRoots__varpartitions_935(colontmpD__4, result, level);
					if (NIM_UNLIKELY(*nimErr_)) goto LA22_;
					i_2 += ((NI)1);
					{
						LA22_:;
	...
	{
		{
			...
			i_4 = ((NI)0);
			{
				while (1) {
					...
					i_3 = i_4;
					colontmpD__5 = lastSon__ast_6268((*n)._kind_6.sons.p->data[i_3]);
					if (NIM_UNLIKELY(*nimErr_)) goto LA29_;
					allRoots__varpartitions_935(colontmpD__5, result, level);
					if (NIM_UNLIKELY(*nimErr_)) goto LA29_;
					i_4 += ((NI)1);
					{
						LA29_:;
	...
	{
		{
			...
			i_6 = ((NI)0);
			{
				while (1) {
					...
					i_5 = i_6;
					allRoots__varpartitions_935((*n)._kind_6.sons.p->data[i_5], result, (NI)(level - ((NI)1)));
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					i_6 += ((NI)1);
				} LA35: ;
			}
	...
	{
		{
			NIM_BOOL T39_;
			T39_ = (NIM_BOOL)0;
			T39_ = !(((*n).typ == ((tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*) NIM_NIL)));
			if (!(T39_)) goto LA40_;
			T39_ = ((*(*n).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)23) || (*(*n).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)47));
			LA40_: ;
			if (!T39_) goto LA41_;
			{
				NI T45_;
				T45_ = (NI)0;
				T45_ = len__ast_3325(n);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				if (!(((NI)1) < T45_)) goto LA46_;
				allRoots__varpartitions_935((*n)._kind_6.sons.p->data[((NI)1)], result, ((NI)1000));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			}
			LA46_: ;
		}
		...
		LA41_: ;
		{
			...
			case ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)0):
			{
				...
				typ = NIM_NIL;
				{
					if (!((*(*n)._kind_6.sons.p->data[((NI)0)]).typ == 0)) goto LA53_;
					eqdestroy___ast_3543(&typ);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					goto BeforeRet_;
				}
				LA53_: ;
				eqcopy___ast_3546(&typ, (*(*n)._kind_6.sons.p->data[((NI)0)]).typ);
				...
				LA57_: ;
				{
					...
					i_8 = ((NI)1);
					{
						while (1) {
							...
							it = NIM_NIL;
							i_7 = i_8;
							eqcopy___ast_3457(&it, (*n)._kind_6.sons.p->data[i_7]);
							if (NIM_UNLIKELY(*nimErr_)) goto LA68_;
							{
								...
								if (NIM_UNLIKELY(*nimErr_)) goto LA76_;
								{
									...
									LA84_: ;
									if (!T79_) goto LA85_;
									allRoots__varpartitions_935(it, result, ((NI)1000));
									if (NIM_UNLIKELY(*nimErr_)) goto LA76_;
								}
								LA85_: ;
								{
			...
			{
				allRoots__varpartitions_935((*n)._kind_6.sons.p->data[((NI)1)], result, (NI)(level + ((NI)1)));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			}
			break;
			default:
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, wrap__varpartitions_1607)(tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* t) {
	NIM_BOOL result;
	result = (NIM_BOOL)0;
	result = ((*t).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)22) || (*t).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)21));
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, containsPointer__varpartitions_1604)(tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* t) {
	NIM_BOOL result;
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	result = searchTypeFor__types_471(t, wrap__varpartitions_1607);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NI, root__varpartitions_581)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* v, NI start) {
	...
	{
		while (1) {
			if (!((*v).s.p->data[result].con.kind == ((tyEnum_VarIndexKind__6pCadyQZHCR6acdFnGn1Ig)1))) goto LA2			;
	...
	}
	{
		...
		it = start;
		{
			while (1) {
				...
				if (!((*v).s.p->data[it].con.kind == ((tyEnum_VarIndexKind__6pCadyQZHCR6acdFnGn1Ig)1))) goto LA8				;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	id = variableId__varpartitions_332((&(*v)), s);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		r = root__varpartitions_581(v, id);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			if (!((*s).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)3))) goto LA7_;
			...
			nimZeroMem((void*)(&colontmpD__5), sizeof(tySet_tyEnum_SubgraphFlag__ml3yXvPvj6hJ9cmVAkOXJFQ));
			{
				NIM_BOOL T11_;
				T11_ = (NIM_BOOL)0;
				T11_ = ((*s).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)3));
				if (!(T11_)) goto LA12_;
				T11_ = !(((*(*s).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)23) || (*(*s).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)46)));
				LA12_: ;
				if (!T11_) goto LA13_;
				colontmpD__3 = 3;
			...
			LA13_: ;
			{
				NIM_BOOL T16_;
				T16_ = (NIM_BOOL)0;
				T16_ = ((*(*s).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)23));
				if (!(T16_)) goto LA17_;
				T16_ = (level <= ((NI)1));
				LA17_: ;
				if (!T16_) goto LA18_;
		...
		case ((tyEnum_VarIndexKind__6pCadyQZHCR6acdFnGn1Ig)0):
		{
			...
			nimZeroMem((void*)(&T25_), sizeof(tyObject_MutationInfo__09cglYawlQfhTDITHVV8vBw));
			{
				...
				T28_ = (NIM_BOOL)0;
				T28_ = ((*s).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)3));
				if (!(T28_)) goto LA29_;
				T28_ = !(((*(*s).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)23) || (*(*s).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)46)));
				LA29_: ;
				if (!T28_) goto LA30_;
				eqcopy___ast_4063(&colontmpD__6, s);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			...
			colontmpD__11 = (*v).abstractTime;
			T25_.mutations.p->data[0] = colontmpD__11;
			add__varpartitions_494((&(*v).graphs), (&T25_));
		...
		case ((tyEnum_VarIndexKind__6pCadyQZHCR6acdFnGn1Ig)2):
		{
			...
			g = (&(*v).graphs.p->data[(*v).s.p->data[r].con.graphIndex]);
			{
				...
				if (!(T36_)) goto LA37_;
				T38_ = (NIM_BOOL)0;
				T38_ = ((*s).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)3));
				if (!(T38_)) goto LA39_;
				T38_ = !(((*(*s).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)23) || (*(*s).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)46)));
				LA39_: ;
				T36_ = T38_;
				LA37_: ;
				if (!T36_) goto LA40_;
				eqcopy___ast_4063(&(*g).param, s);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			}
			LA40_: ;
			{
				if (!((*g).maxMutation < (*v).abstractTime)) goto LA44_;
				(*g).mutatedHere = info;
				(*g).maxMutation = (*v).abstractTime;
			}
			LA44_: ;
			(*g).flags = ((*g).flags | flags);
			colontmpD__12 = (*v).abstractTime;
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___varpartitions_214)(tySequence__qwqHTkRvwhrRyENtudHQ7g* dest, tySequence__qwqHTkRvwhrRyENtudHQ7g src) {
	...
	NI colontmp_;
	T1_ = src.len;
	setLen__varpartitions_227((&(*dest)), T1_);
	colontmp_ = ((NI)0);
	{
		while (1) {
			NI T4_;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	aid = variableId__varpartitions_332((&(*v)), a);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
	...
	LA3_: ;
	bid = variableId__varpartitions_332((&(*v)), b);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
	...
	LA7_: ;
	ra = root__varpartitions_581(v, aid);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	rb = root__varpartitions_581(v, bid);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* param;
		tySet_tyEnum_SubgraphFlag__ml3yXvPvj6hJ9cmVAkOXJFQ colontmpD_;
		...
		param = ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL);
		{
			NIM_BOOL T15_;
			T15_ = (NIM_BOOL)0;
			T15_ = ((*a).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)3));
			if (!(T15_)) goto LA16_;
			T15_ = !(((*(*a).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)23) || (*(*a).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)46)));
			LA16_: ;
			if (!T15_) goto LA17_;
			eqcopy___ast_4063(&param, a);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA13_;
		LA17_: ;
		{
			NIM_BOOL T20_;
			T20_ = (NIM_BOOL)0;
			T20_ = ((*b).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)3));
			if (!(T20_)) goto LA21_;
			T20_ = !(((*(*b).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)23) || (*(*b).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)46)));
			LA21_: ;
			if (!T20_) goto LA22_;
			eqcopy___ast_4063(&param, b);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA13_;
		LA22_: ;
		...
		{
			if (!((*v).s.p->data[rb].con.kind == ((tyEnum_VarIndexKind__6pCadyQZHCR6acdFnGn1Ig)2))) goto LA31_;
		...
		case ((tyEnum_VarIndexKind__6pCadyQZHCR6acdFnGn1Ig)0):
		{
			...
			LA42_: ;
			add__varpartitions_494((&(*v).graphs), (&T41_));
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___varpartitions_1311)(tySequence__YeE3Q6WHPvSBrNLQF9alkGA* dest) {
	...
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyTuple__MYB87DFoxG1fGveKhpWHrg));
}
}
N_LIB_PRIVATE N_NIMCALL(void, destMightOwn__varpartitions_1121)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* c, tyObject_VarIndex__gqlFfS5HP9cscNmlzNsazBA* dest, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n) {
NIM_BOOL oldNimErrFin7_;
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)60):
	{
		destMightOwn__varpartitions_1121(c, dest, (*n)._kind_6.sons.p->data[((NI)1)]);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)92):
	...
	{
		{
			...
			i_2 = ((NI)0);
			{
				while (1) {
					...
					colontmpD_ = NIM_NIL;
					i = i_2;
					colontmpD_ = lastSon__ast_6268((*n)._kind_6.sons.p->data[i]);
					if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
					destMightOwn__varpartitions_1121(c, dest, colontmpD_);
					if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
					i_2 += ((NI)1);
					{
						LA7_:;
	...
	{
		{
			...
			i_4 = ((NI)1);
			{
				while (1) {
					...
					i_3 = i_4;
					colontmpD__2 = lastSon__ast_6268((*n)._kind_6.sons.p->data[i_3]);
					if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
					destMightOwn__varpartitions_1121(c, dest, colontmpD__2);
					if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
					i_4 += ((NI)1);
					{
						LA14_:;
	...
	{
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			destMightOwn__varpartitions_1121(c, dest, (*n)._kind_6.sons.p->data[(NI)(T23_ - ((NI)1))]);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA21_: ;
	}
	...
	{
		{
			...
			i_6 = ((NI)1);
			{
				while (1) {
					...
					i_5 = i_6;
					destMightOwn__varpartitions_1121(c, dest, (*n)._kind_6.sons.p->data[i_5]);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					i_6 += ((NI)1);
				} LA27: ;
			}
		}
		(*dest).flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)0))) & 7);
	}
	break;
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)38):
	{
		{
			...
			i_8 = ((NI)1);
			{
				while (1) {
					...
					i_7 = i_8;
					destMightOwn__varpartitions_1121(c, dest, (*n)._kind_6.sons.p->data[i_7]);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					i_8 += ((NI)1);
				} LA31: ;
			}
		}
		{
			...
			T34_ = 0;
			if (!!(((IL64(2147483664) & (*(*n).typ).flags) == T34_))) goto LA35_;
			(*dest).flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)0))) & 7);
		}
		LA35_: ;
	}
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)160):
	{
			...
			son = NIM_NIL;
			{
				...
				i_10 = ((NI)0);
				{
					while (1) {
						...
						i_9 = i_10;
						eqcopy___ast_3457(&son, (*n)._kind_6.sons.p->data[i_9]);
						if (NIM_UNLIKELY(*nimErr_)) goto LA40_;
						destMightOwn__varpartitions_1121(c, dest, son);
						if (NIM_UNLIKELY(*nimErr_)) goto LA40_;
						i_10 += ((NI)1);
					} LA43: ;
				}
		...
		(*c).inConstructor -= ((NI)1);
		{
			colontmpD__3 = skipTypes__ast_4803((*n).typ, TM__4R4QZluAmhY3f04fEZJ3nA_14);
			if (NIM_UNLIKELY(*nimErr_)) goto LA38_;
	...
	{
		{
			if (!((*(*n)._kind_4.sym).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)8) || (*(*n)._kind_4.sym).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)11) || (*(*n)._kind_4.sym).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)5) || (*(*n)._kind_4.sym).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)9) || (*(*n)._kind_4.sym).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)21) || (*(*n)._kind_4.sym).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)3))) goto LA55_;
			{
				...
				T59_ = 0;
				if (!!((((*(*n)._kind_4.sym).flags & 67108872) == T59_))) goto LA60_;
				(*dest).flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)0))) & 7);
			}
			goto LA57_;
			LA60_: ;
			{
				connect__varpartitions_711(c, (*dest).sym, (*n)._kind_4.sym, (*n).info);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				{
					if (!(((NI)0) < (*c).inConstructor)) goto LA65_;
					(*dest).flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)0))) & 7);
				}
				LA65_: ;
			}
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)64):
	{
		destMightOwn__varpartitions_1121(c, dest, (*n)._kind_6.sons.p->data[((NI)0)]);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)26) ... ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)32):
	{
		{
			if (!!(((*n).typ == ((tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*) NIM_NIL)))) goto LA71_;
			{
				tySet_tyEnum_TTypeFlag__wRa4s6r4s9cXJ9abWKsrci1Q T75_;
				T75_ = 0;
				if (!!(((IL64(2147483664) & (*(*n).typ).flags) == T75_))) goto LA76_;
				(*dest).flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)0))) & 7);
			}
			goto LA73_;
			LA76_: ;
			{
				...
				T79_ = (NIM_BOOL)0;
				T79_ = ((*(*n).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)47) || (*(*n).typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)23));
				if (!(T79_)) goto LA80_;
				T81_ = (NI)0;
				...
				allRoots__varpartitions_935((*n)._kind_6.sons.p->data[((NI)1)], (&roots), ((NI)1000));
				if (NIM_UNLIKELY(*nimErr_)) goto LA84_;
				{
					...
					L = T86_;
					{
						while (1) {
							if (!(i_11 < L)) goto LA88							;
							r = (&roots.p->data[i_11]);
							connect__varpartitions_711(c, (*dest).sym, (*r).Field0, (*(*n)._kind_6.sons.p->data[((NI)1)]).info);
							if (NIM_UNLIKELY(*nimErr_)) goto LA84_;
							i_11 += ((NI)1);
						} LA88: ;
					}
			...
			LA82_: ;
			{
				...
				{
					if (!((*(*n)._kind_6.sons.p->data[((NI)0)]).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3))) goto LA94_;
					colontmpD__4 = (*(*(*n)._kind_6.sons.p->data[((NI)0)])._kind_4.sym).magic;
					magic = colontmpD__4;
				}
				goto LA92_;
				LA94_: ;
						...
						i_13 = ((NI)1);
						{
							while (1) {
								...
								i_12 = i_13;
								{
									...
									colontmpD__6 = skipTypes__ast_4803((*(*n)._kind_6.sons.p->data[i_12]).typ, TM__4R4QZluAmhY3f04fEZJ3nA_15);
									if (NIM_UNLIKELY(*nimErr_)) goto LA104_;
									T107_ = 0;
									if (!!(((IL64(2147483664) & (*colontmpD__6).flags) == T107_))) goto LA108_;
									destMightOwn__varpartitions_1121(c, dest, (*n)._kind_6.sons.p->data[i_12]);
									if (NIM_UNLIKELY(*nimErr_)) goto LA104_;
								}
								LA108_: ;
								i_13 += ((NI)1);
	...
	default:
	{
		(*dest).flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)1))) & 7);
	}
	break;
	}
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	{
		if (!(((*c).goals &((NU8)1<<((NU)((((tyEnum_Goal__qFOer19bA9a6nDnUlP8XdnGg)1)))&7U)))!=0)) goto LA4_;
		borrowingAsgn__varpartitions_1536(c, dest, src);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA4_: ;
	allRoots__varpartitions_935(dest, (&targets), ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	allRoots__varpartitions_935(src, (&sources), ((NI)0));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	destIsComplex = containsPointer__varpartitions_1604((*dest).typ);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		L = T7_;
		{
			while (1) {
				...
				t = (&targets.p->data[i]);
				{
					NIM_BOOL T12_;
					T12_ = (NIM_BOOL)0;
					T12_ = !(((*dest).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3)));
					if (!(T12_)) goto LA13_;
					T12_ = ((*c).inNoSideEffectSection == ((NI)0));
					LA13_: ;
					if (!T12_) goto LA14_;
					potentialMutation__varpartitions_602(c, (*t).Field0, (*t).Field1, (*dest).info);
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				}
				LA14_: ;
				{
					if (!destIsComplex) goto LA18_;
					{
						...
						L_2 = T21_;
						{
							while (1) {
								...
								connect__varpartitions_711(c, (*t).Field0, (*s).Field0, (*dest).info);
								if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
								i_2 += ((NI)1);
							} LA23: ;
						}
	...
	}
	{
		...
		T26_ = (NIM_BOOL)0;
		T26_ = (((*c).goals &((NU8)1<<((NU)((((tyEnum_Goal__qFOer19bA9a6nDnUlP8XdnGg)2)))&7U)))!=0);
		if (!(T26_)) goto LA27_;
		T26_ = !(((*src).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)1)));
		LA27_: ;
		if (!T26_) goto LA28_;
		d = NIM_NIL;
		d = pathExpr__varpartitions_875(dest, (*c).owner);
		if (NIM_UNLIKELY(*nimErr_)) goto LA30_;
		{
			...
			LA34_: ;
			if (!T33_) goto LA35_;
			vid = variableId__varpartitions_332((&(*c)), (*d)._kind_4.sym);
			if (NIM_UNLIKELY(*nimErr_)) goto LA30_;
			{
				...
				T41_ = c;
				destMightOwn__varpartitions_1121(T41_, (&(*c).s.p->data[vid]), src);
				if (NIM_UNLIKELY(*nimErr_)) goto LA30_;
				{
					...
					L_3 = T43_;
					{
						while (1) {
							...
							LA49_: ;
							{
								...
								if (T52_) goto LA54_;
								T52_ = hasDisabledAsgn__modulegraphs_8359((*c).g, (*s_2).typ);
								if (NIM_UNLIKELY(*nimErr_)) goto LA46_;
								LA54_: ;
								if (!T52_) goto LA55_;
								(*c).s.p->data[vid].flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)1))) & 7);
							}
							goto LA47_;
							LA55_: ;
							{
								NI srcid;
								srcid = variableId__varpartitions_332((&(*c)), s_2);
								if (NIM_UNLIKELY(*nimErr_)) goto LA46_;
								{
									...
									xX60gensym136_ = NIM_NIL;
									{
										...
										if (!(T64_)) goto LA65_;
										T64_ = ((*c).s.p->data[srcid].aliveEnd < (*c).s.p->data[vid].aliveEnd);
										LA65_: ;
										if (!T64_) goto LA66_;
										(*c).s.p->data[vid].flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)1))) & 7);
									}
									...
									LA66_: ;
									{
										...
										T69_ = 0;
										if (!!(((6 & (*c).s.p->data[srcid].flags) == T69_))) goto LA70_;
										(*c).s.p->data[vid].flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)1))) & 7);
									}
									goto LA62_;
									LA70_: ;
									{
										NIM_BOOL T73_;
										T73_ = (NIM_BOOL)0;
										T73_ = !(((*c).s.p->data[srcid].reassignedTo == ((NI)0)));
										if (!(T73_)) goto LA74_;
										eqcopy___ast_4063(&xX60gensym136_, (*d)._kind_4.sym);
										if (NIM_UNLIKELY(*nimErr_)) goto LA46_;
										T73_ = !(((*c).s.p->data[srcid].reassignedTo == (NI)((NI)((NU32)(((NI) ((*xX60gensym136_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym136_).Sup.itemId.item)))));
										LA74_: ;
										if (!T73_) goto LA75_;
										(*c).s.p->data[vid].flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)1))) & 7);
									}
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	vid = variableId__varpartitions_332((&(*c)), s);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
...
{nimErr_ = nimErrorFlag();
	v = NIM_NIL;
	v = pathExpr__varpartitions_875((*n)._kind_6.sons.p->data[i], (*c).owner);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NIM_BOOL T4_;
		T4_ = (NIM_BOOL)0;
			...
			i_2 = colontmp_;
			{
				while (1) {
					...
					j = i_2;
					{
						...
						T13_ = getMagic__trees_144((*n)._kind_6.sons.p->data[j]);
						if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
						if (!(T13_ == ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)126))) goto LA14_;
						borrowFrom__varpartitions_1446(c, (*v)._kind_4.sym, (*n)._kind_6.sons.p->data[j]);
						if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
					}
					LA14_: ;
					i_2 += ((NI)1);
	...
	LA6_: ;
	{
		liMessage__msgs_1159((*(*c).g).config, (*(*n)._kind_6.sons.p->data[i]).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__4R4QZluAmhY3f04fEZJ3nA_17, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__4R4QZluAmhY3f04fEZJ3nA_18, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA2_: ;
	{
...
{nimErr_ = nimErrorFlag();
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = (((*c).goals &((NU8)1<<((NU)((((tyEnum_Goal__qFOer19bA9a6nDnUlP8XdnGg)0)))&7U)))!=0);
		if (!(T3_)) goto LA4_;
		T3_ = (((*callee).flags &((NU64)1<<((NU)((((tyEnum_TTypeFlag__wRa4s6r4s9cXJ9abWKsrci1Q)1)))&63U)))!=0);
		LA4_: ;
		if (!T3_) goto LA5_;
	}
	goto LA1_;
	LA5_: ;
	{
		...
		if (!(T8_)) goto LA9_;
		T8_ = containsPointer__varpartitions_1604((*n).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		LA9_: ;
		if (!T8_) goto LA10_;
		roots.len = 0; roots.p = NIM_NIL;
		allRoots__varpartitions_935(n, (&roots), ((NI)1000));
		if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
		{
			...
			L = T14_;
			{
				while (1) {
					if (!(i < L)) goto LA16					;
					r = (&roots.p->data[i]);
					potentialMutation__varpartitions_602(c, (*r).Field0, (*r).Field1, (*n).info);
					if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
					i += ((NI)1);
				} LA16: ;
			}
...
{nimErr_ = nimErrorFlag();
	...
	{
		if (!(((NI)0) <= vid)) goto LA3_;
		(*c).s.p->data[vid].flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)0))) & 7);
	}
	LA3_: ;
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
			...
			child = NIM_NIL;
			{
				...
				i_2 = ((NI)0);
				{
					while (1) {
						...
						last = lastSon__ast_6268(child);
						if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
						traverse__varpartitions_1739(c, last);
						if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
						{
							NIM_BOOL T10_;
							T10_ = (NIM_BOOL)0;
							...
							LA18_: ;
							{
								...
								i_4 = ((NI)0);
								{
									while (1) {
										if (!(i_4 < colontmp__2)) goto LA23										;
										i_3 = i_4;
										deps__varpartitions_1614(c, (*child)._kind_6.sons.p->data[i_3], (*last)._kind_6.sons.p->data[i_3]);
										if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
										i_4 += ((NI)1);
									} LA23: ;
								}
						...
						{
							{
								...
								i_6 = ((NI)0);
								{
									while (1) {
										if (!(i_6 < colontmp__3)) goto LA28										;
										i_5 = i_6;
										deps__varpartitions_1614(c, (*child)._kind_6.sons.p->data[i_5], last);
										if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
										i_6 += ((NI)1);
									} LA28: ;
								}
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)149):
	{
		traverse__varpartitions_1739(c, (*n)._kind_6.sons.p->data[((NI)0)]);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(*c).inAsgnSource += ((NI)1);
		traverse__varpartitions_1739(c, (*n)._kind_6.sons.p->data[((NI)1)]);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(*c).inAsgnSource -= ((NI)1);
		deps__varpartitions_1614(c, (*n)._kind_6.sons.p->data[((NI)0)], (*n)._kind_6.sons.p->data[((NI)1)]);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3):
			...
			child_2 = NIM_NIL;
			{
				...
				i_8 = ((NI)0);
				{
					while (1) {
						...
						eqcopy___ast_3457(&child_2, (*n)._kind_6.sons.p->data[i_7]);
						if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
						traverse__varpartitions_1739(c, child_2);
						if (NIM_UNLIKELY(*nimErr_)) goto LA39_;
						i_8 += ((NI)1);
					} LA42: ;
				}
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA53_;
					{
						...
						if (NIM_UNLIKELY(*nimErr_)) goto LA58_;
						{
							...
							if (NIM_UNLIKELY(*nimErr_)) goto LA66_;
							{
								...
								{
									if (!((*c).inNoSideEffectSection == ((NI)0))) goto LA73_;
									{
										tyTuple__MYB87DFoxG1fGveKhpWHrg* r;
										NI i_11;
										NI L_2;
										...
										L_2 = T76_;
										{
											while (1) {
												...
												r = (&roots.p->data[i_11]);
												potentialMutation__varpartitions_602(c, (*r).Field0, (*r).Field1, (*it).info);
												if (NIM_UNLIKELY(*nimErr_)) goto LA66_;
												i_11 += ((NI)1);
											} LA78: ;
										}
								...
								LA73_: ;
								{
									...
									L_3 = T80_;
									{
										while (1) {
											...
											noCursor__varpartitions_1407(c, (*r_2).Field0);
											if (NIM_UNLIKELY(*nimErr_)) goto LA66_;
											i_12 += ((NI)1);
										} LA82: ;
									}
								...
								{
									if (!(((*c).goals &((NU8)1<<((NU)((((tyEnum_Goal__qFOer19bA9a6nDnUlP8XdnGg)1)))&7U)))!=0)) goto LA85_;
									{
										NIM_BOOL T89_;
										...
										LA91_: ;
										if (!T89_) goto LA93_;
										borrowingCall__varpartitions_1506(c, (*paramType).sons.p->data[((NI)0)], n, i_9);
										if (NIM_UNLIKELY(*nimErr_)) goto LA66_;
									}
									LA93_: ;
								}
						...
						LA64_: ;
						{
							...
							potentialMutationViaArg__varpartitions_1722(c, (*n)._kind_6.sons.p->data[i_9], parameters);
							if (NIM_UNLIKELY(*nimErr_)) goto LA58_;
						}
						goto LA59_;
						LA98_: ;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)41):
	{
			...
			child_3 = NIM_NIL;
			{
				...
				i_14 = ((NI)0);
				{
					while (1) {
						...
						i_13 = i_14;
						eqcopy___ast_3457(&child_3, (*n)._kind_6.sons.p->data[i_13]);
						if (NIM_UNLIKELY(*nimErr_)) goto LA109_;
						traverse__varpartitions_1739(c, child_3);
						if (NIM_UNLIKELY(*nimErr_)) goto LA109_;
						i_14 += ((NI)1);
					} LA112: ;
				}
		...
		{
			if (!(((NI)0) < (*c).inAsgnSource)) goto LA117_;
			{
				NI i_15;
				NI colontmp__7;
				NI i_16;
				...
				i_16 = ((NI)0);
				{
					while (1) {
						...
						i_15 = i_16;
						{
							if (!((*(*n)._kind_6.sons.p->data[i_15]).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3))) goto LA124_;
							pretendOwnsData__varpartitions_1415(c, (*(*n)._kind_6.sons.p->data[i_15])._kind_4.sym);
							if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						}
						LA124_: ;
						i_16 += ((NI)1);
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)38):
	{
			...
			child_4 = NIM_NIL;
			{
				...
				i_18 = ((NI)0);
				{
					while (1) {
						...
						i_17 = i_18;
						eqcopy___ast_3457(&child_4, (*n)._kind_6.sons.p->data[i_17]);
						if (NIM_UNLIKELY(*nimErr_)) goto LA128_;
						traverse__varpartitions_1739(c, child_4);
						if (NIM_UNLIKELY(*nimErr_)) goto LA128_;
						i_18 += ((NI)1);
					} LA131: ;
				}
		...
		{
			if (!(((NI)0) < (*c).inAsgnSource)) goto LA136_;
			{
				NI i_19;
				NI colontmp__9;
				NI i_20;
				...
				i_20 = ((NI)1);
				{
					while (1) {
						...
						it_2 = NIM_NIL;
						i_19 = i_20;
						it_2 = skipColon__ast_6390((*n)._kind_6.sons.p->data[i_19]);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						{
							if (!((*it_2).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3))) goto LA143_;
							pretendOwnsData__varpartitions_1415(c, (*it_2)._kind_4.sym);
							if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						}
						LA143_: ;
						i_20 += ((NI)1);
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)91):
	{
		...
		colontmpD__3 = lastSon__ast_6268(n);
		if (NIM_UNLIKELY(*nimErr_)) goto LA146_;
		traverse__varpartitions_1739(c, colontmpD__3);
		if (NIM_UNLIKELY(*nimErr_)) goto LA146_;
		(*c).inNoSideEffectSection -= enforceNoSideEffects;
		{
			LA146_:;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)95):
	{
			...
			child_5 = NIM_NIL;
			{
				...
				i_24 = ((NI)0);
				{
					while (1) {
						...
						i_23 = i_24;
						eqcopy___ast_3457(&child_5, (*n)._kind_6.sons.p->data[i_23]);
						if (NIM_UNLIKELY(*nimErr_)) goto LA159_;
						traverse__varpartitions_1739(c, child_5);
						if (NIM_UNLIKELY(*nimErr_)) goto LA159_;
						i_24 += ((NI)1);
					} LA162: ;
				}
			...
			child_6 = NIM_NIL;
			{
				...
				i_26 = ((NI)0);
				{
					while (1) {
						...
						i_25 = i_26;
						eqcopy___ast_3457(&child_6, (*n)._kind_6.sons.p->data[i_25]);
						if (NIM_UNLIKELY(*nimErr_)) goto LA166_;
						traverse__varpartitions_1739(c, child_6);
						if (NIM_UNLIKELY(*nimErr_)) goto LA166_;
						i_26 += ((NI)1);
					} LA169: ;
				}
		...
		{
			if (!((*n).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)96))) goto LA174_;
			traverse__varpartitions_1739(c, (*n)._kind_6.sons.p->data[((NI)0)]);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA174_: ;
			...
			child_7 = NIM_NIL;
			{
				...
				i_28 = ((NI)0);
				{
					while (1) {
						...
						i_27 = i_28;
						eqcopy___ast_3457(&child_7, (*n)._kind_6.sons.p->data[i_27]);
						if (NIM_UNLIKELY(*nimErr_)) goto LA178_;
						traverse__varpartitions_1739(c, child_7);
						if (NIM_UNLIKELY(*nimErr_)) goto LA178_;
						i_28 += ((NI)1);
					} LA181: ;
				}
...
{nimErr_ = nimErrorFlag();
	...
	(*Result).goals = colontmpD__3;
	{
		...
		if (!!(((*s).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)6) || (*s).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)17)))) goto LA3_;
		params = NIM_NIL;
		...
		}
		{
			NI T10_;
			T10_ = (NI)0;
			T10_ = safeLen__ast_3318((*s).ast);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!(((NI)7) < T10_)) goto LA11_;
			registerResult__varpartitions_349(Result, (*(*s).ast)._kind_6.sons.p->data[((NI)7)]);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA11_: ;
	...
	LA3_: ;
	computeLiveRanges__varpartitions_1930(Result, n);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*Result).abstractTime = ((NI)0);
	traverse__varpartitions_1739(Result, n);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
static N_INLINE(NIM_BOOL, contains__varpartitions_2370)(tyObject_HSlice__EE5dzjqoOrHT6HJhIPXAvA s, NI value) {
			...
			L = T7_;
			{
				while (1) {
					...
					m = (&(*g).mutations.p->data[i]);
					{
						...
						NIM_BOOL T13_;
						colontmpD_ = (*v).aliveStart;
						colontmpD__2 = (*v).aliveEnd;
...
{nimErr_ = nimErrorFlag();
	...
	T2_ = rawNewString((*(*s).name).s.len + 59);
...
appendString((&T2_), TM__4R4QZluAmhY3f04fEZJ3nA_22);
	m = T2_;
	{
		...
		NimStringV2 colontmpD_;
		T5_ = (NIM_BOOL)0;
		T5_ = eqeq___msgs_1035((*g).mutatedHere, unknownLineInfo__lineinfos_350);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!!(T5_)) goto LA6_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		prepareAdd((&m), 1);
appendString((&m), TM__4R4QZluAmhY3f04fEZJ3nA_24);
		colontmpD_ = dollar___msgs_663(config, (*g).mutatedHere);
...
appendString((&m), TM__4R4QZluAmhY3f04fEZJ3nA_26);
	...
	LA6_: ;
	{
		...
		NimStringV2 colontmpD__2;
		T13_ = (NIM_BOOL)0;
		T13_ = eqeq___msgs_1035((*g).connectedVia, unknownLineInfo__lineinfos_350);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!!(T13_)) goto LA14_;
		colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
		prepareAdd((&m), 1);
appendString((&m), TM__4R4QZluAmhY3f04fEZJ3nA_27);
		colontmpD__2 = dollar___msgs_663(config, (*g).connectedVia);
...
appendString((&m), TM__4R4QZluAmhY3f04fEZJ3nA_29);
	...
	LA14_: ;
	liMessage__msgs_1159(config, (*s).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), m, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__4R4QZluAmhY3f04fEZJ3nA_30, NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	{
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				v = NIM_NIL;
				i = i_2;
				eqcopy___ast_4063(&v, (*par).s.p->data[i].sym);
				if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
				{
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
					{
						...
						constViolation = NIM_FALSE;
						{
							...
							b = (NI*)0;
							colontmp__2.len = 0; colontmp__2.p = NIM_NIL;
							eqcopy___pureZosproc_409((&colontmp__2), (*par).s.p->data[rid].borrowsFrom);
							i_3 = ((NI)0);
							...
							L = T19_;
							{
								while (1) {
									...
									sid = root__varpartitions_581(par, (*b));
									if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
									{
										if (!(((NI)0) <= sid)) goto LA24_;
										{
											NIM_BOOL T28_;
											T28_ = (NIM_BOOL)0;
											T28_ = ((*par).s.p->data[sid].con.kind == ((tyEnum_VarIndexKind__6pCadyQZHCR6acdFnGn1Ig)2));
											if (!(T28_)) goto LA29_;
											T28_ = dangerousMutation__varpartitions_2314((&(*par).graphs.p->data[(*par).s.p->data[sid].con.graphIndex]), (&(*par).s.p->data[i]));
											if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
											LA29_: ;
											if (!T28_) goto LA30_;
											cannotBorrow__varpartitions_2389(config, v, (&(*par).graphs.p->data[(*par).s.p->data[sid].con.graphIndex]));
											if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
										}
										LA30_: ;
										{
											...
											NimStringV2 T39_;
											T34_ = (NIM_BOOL)0;
											T34_ = !(((*(*par).s.p->data[sid].sym).kind == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)3)));
											if (!(T34_)) goto LA35_;
											T34_ = ((*par).s.p->data[sid].aliveEnd < (*par).s.p->data[rid].aliveEnd);
											LA35_: ;
											if (!T34_) goto LA36_;
											colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
											T39_.len = 0; T39_.p = NIM_NIL;
											T39_ = rawNewString((*(*v).name).s.len + (*(*(*par).s.p->data[sid].sym).name).s.len + 59);
appendString((&T39_), TM__4R4QZluAmhY3f04fEZJ3nA_32);
appendString((&T39_), (*(*v).name).s);
appendString((&T39_), TM__4R4QZluAmhY3f04fEZJ3nA_34);
appendString((&T39_), (*(*(*par).s.p->data[sid].sym).name).s);
appendString((&T39_), TM__4R4QZluAmhY3f04fEZJ3nA_36);
											colontmpD_ = T39_;
											liMessage__msgs_1159(config, (*v).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__4R4QZluAmhY3f04fEZJ3nA_37, NIM_FALSE);
											if (NIM_UNLIKELY(*nimErr_)) goto LA38_;
											{
												LA38_:;
											}
										...
										LA36_: ;
										{
											...
											NimStringV2 T49_;
											T44_ = (NIM_BOOL)0;
											T44_ = (((*par).s.p->data[rid].flags &((NU8)1<<((NU)((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)4)))&7U)))!=0);
											if (!(T44_)) goto LA45_;
											T44_ = isConstSym__varpartitions_1424((*par).s.p->data[sid].sym);
											if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
											LA45_: ;
											if (!T44_) goto LA46_;
											colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
											T49_.len = 0; T49_.p = NIM_NIL;
											T49_ = rawNewString((*(*v).name).s.len + (*(*(*par).s.p->data[sid].sym).name).s.len + 67);
appendString((&T49_), TM__4R4QZluAmhY3f04fEZJ3nA_38);
appendString((&T49_), (*(*v).name).s);
appendString((&T49_), TM__4R4QZluAmhY3f04fEZJ3nA_40);
appendString((&T49_), (*(*(*par).s.p->data[sid].sym).name).s);
appendString((&T49_), TM__4R4QZluAmhY3f04fEZJ3nA_42);
											colontmpD__2 = T49_;
											liMessage__msgs_1159(config, (*v).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__4R4QZluAmhY3f04fEZJ3nA_43, NIM_FALSE);
						...
						}
						{
							...
							NimStringV2 T61_;
							T56_ = (NIM_BOOL)0;
							T56_ = ((48 & (*par).s.p->data[rid].flags) == 48);
							if (!(T56_)) goto LA57_;
							T56_ = !(constViolation);
							LA57_: ;
							if (!T56_) goto LA58_;
...
appendString((&T61_), TM__4R4QZluAmhY3f04fEZJ3nA_46);
							colontmpD__3 = T61_;
							liMessage__msgs_1159(config, (*v).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__4R4QZluAmhY3f04fEZJ3nA_47, NIM_FALSE);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___varpartitions_2137)(tySequence__MSDrKmAF4cj59cY74qFKQtQ* dest) {
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			LA7_: ;
			eqdestroy___pureZosproc_406((&(*dest).p->data[colontmp_].borrowsFrom));
			colontmp_ += ((NI)1);
		} LA2: ;
	}
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyObject_VarIndex__gqlFfS5HP9cscNmlzNsazBA));
}
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___varpartitions_2224)(tySequence__oPvbBQGfJLgF9axmfwR3PQA* dest) {
	NI colontmp_;
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			if (!(colontmp_ < T3_)) goto LA2			;
			{
				NIM_BOOL T6_;
				T6_ = (NIM_BOOL)0;
				T6_ = nimDecRefIsLast((*dest).p->data[colontmp_].param);
				if (!T6_) goto LA7_;
				nimDestroyAndDispose((*dest).p->data[colontmp_].param);
			}
			LA7_: ;
			eqdestroy___varpartitions_211((&(*dest).p->data[colontmp_].mutations));
			colontmp_ += ((NI)1);
		} LA2: ;
	}
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyObject_MutationInfo__09cglYawlQfhTDITHVV8vBw));
}
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___varpartitions_2125)(tyObject_Partitions__8JEvj7xHrL5kIFiSTpKnZg* dest) {
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	eqdestroy___varpartitions_2137((&(*dest).s));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___varpartitions_2224((&(*dest).graphs));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___varpartitions_1317)(tySequence__YeE3Q6WHPvSBrNLQF9alkGA* dest, tySequence__YeE3Q6WHPvSBrNLQF9alkGA src) {
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	if ((*dest).p != src.p) {	eqdestroy___varpartitions_1311(dest);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
...
{nimErr_ = nimErrorFlag();
	...
	computeGraphPartitions__varpartitions_2092(s, n, g, 4, (&par));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NI i;
		NI colontmp_;
