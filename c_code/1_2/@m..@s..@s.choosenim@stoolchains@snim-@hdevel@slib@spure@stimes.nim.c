...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, format__pureZtimes_3621)(tyObject_DateTime__d9cK9cyKZPJJxFXUmx8dSpPw* dt, tyObject_TimeFormat__Nsh4TB3AD6ERMz3D74BTxA* f, tyObject_DateTimeLocale__uNv3Dc4hHpAREXnLVqGWZQ* loc);
static N_INLINE(void, nimAddCharV1)(NimStringV2* s, NIM_CHAR c);
N_LIB_PRIVATE N_NIMCALL(void, prepareAdd)(NimStringV2* s, NI addlen);
N_LIB_PRIVATE N_NIMCALL(void, formatPattern__pureZtimes_2396)(tyObject_DateTime__d9cK9cyKZPJJxFXUmx8dSpPw* dt, tyEnum_FormatPattern__asapJ9b4qGHESR0g3CfbCjQ pattern, NimStringV2* result, tyObject_DateTimeLocale__uNv3Dc4hHpAREXnLVqGWZQ* loc);
...
N_LIB_PRIVATE N_NIMCALL(void, zonedTimeFromTime__pureZtimes_1472)(tyObject_TimezonecolonObjectType___F8OvqlxXyGXRSiK9c1fCDVw* zone, tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q time, tyObject_ZonedTime__WigfH9apQAxJ69bBPh3wB8RQ* Result);
...
N_LIB_PRIVATE N_NIMCALL(void, utcTzInfo__pureZtimes_1683)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q time, tyObject_ZonedTime__WigfH9apQAxJ69bBPh3wB8RQ* Result);
...
N_LIB_PRIVATE N_NIMCALL(void, local__pureZtimes_1719)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q t, tyObject_DateTime__d9cK9cyKZPJJxFXUmx8dSpPw* Result);
N_LIB_PRIVATE N_NIMCALL(tyObject_TimezonecolonObjectType___F8OvqlxXyGXRSiK9c1fCDVw*, local__pureZtimes_1705)(void);
N_LIB_PRIVATE N_NIMCALL(void, localZonedTimeFromTime__pureZtimes_1656)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q time, tyObject_ZonedTime__WigfH9apQAxJ69bBPh3wB8RQ* Result);
...
N_LIB_PRIVATE N_NIMCALL(void, localZonedTimeFromAdjTime__pureZtimes_1661)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q adjTime, tyObject_ZonedTime__WigfH9apQAxJ69bBPh3wB8RQ* Result);
...
{nimErr_ = nimErrorFlag();
	...
	idx = ((NI)0);
	{
		while (1) {
			...
			default:
			{
				formatPattern__pureZtimes_2396(dt, ((tyEnum_FormatPattern__asapJ9b4qGHESR0g3CfbCjQ) ((*f).patterns.p->data[idx])), (&result), loc);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				idx += ((NI)1);
			}
			break;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = format__pureZtimes_3621(dt, (&f2__options_609), (&DefaultLocale__pureZtimes_1883));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	zonedTimeFromTime__pureZtimes_1472(zone, time, (&T1_));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	blitTmp = zone;
	nimMarkCyclic(zone);
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = format__pureZtimes_3621(dt, (&f2__options_617), (&DefaultLocale__pureZtimes_1883));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	a_2 = clamp__pureZtimes_1584(unix_0, (IL64(-9223372036854775807) - IL64(1)), IL64(9223372036854775807));
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = format__pureZtimes_3621(dt, (&f2__extccomp_1269), (&DefaultLocale__pureZtimes_1883));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
