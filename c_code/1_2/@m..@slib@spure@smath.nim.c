...
{	result = (tyEnum_FloatClass__pPga1yW9b8J9cwNnm9b1aPRnA)0;
	...
	LA21_: ;
	{
		NF T25_;
		T25_ = (NF)0;
		T25_ = abs__pureZmath_147(x__djC9ccvamPhkHKsdQDvt8dw);
...
N_LIB_PRIVATE N_NIMCALL(NI64, floorMod__pureZtimes_1077)(NI64 x__chjcqCqA9cIyasEBDqpRqVA, NI64 y__EERdGDVKtErIcsZiorwYwg) {
	NI64 result;
	result = (NI64)0;
	result = (NI64)(x__chjcqCqA9cIyasEBDqpRqVA % y__EERdGDVKtErIcsZiorwYwg);
	{
		NIM_BOOL T3_;
		NIM_BOOL T4_;
		NIM_BOOL T7_;
		...
		T4_ = (IL64(0) < result);
		if (!(T4_)) goto LA5_;
		T4_ = (y__EERdGDVKtErIcsZiorwYwg < IL64(0));
		LA5_: ;
		T3_ = T4_;
		if (T3_) goto LA6_;
		T7_ = (NIM_BOOL)0;
		T7_ = (result < IL64(0));
		if (!(T7_)) goto LA8_;
		T7_ = (IL64(0) < y__EERdGDVKtErIcsZiorwYwg);
		LA8_: ;
		T3_ = T7_;
		LA6_: ;
		if (!T3_) goto LA9_;
		result += y__EERdGDVKtErIcsZiorwYwg;
	}
	LA9_: ;
	return result;
}
