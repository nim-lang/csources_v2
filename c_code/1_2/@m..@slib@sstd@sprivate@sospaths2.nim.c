...
{nimErr_ = nimErrorFlag();
	...
	if (!(T2_)) goto LA3_;
	T4_ = (NIM_CHAR)0;
	T4_ = X5BX5D___system_7090(tail__1AjSMV084MnUUHJLP6MX5A, ((NI)1));
	...
	if (!(T8_)) goto LA9_;
	T10_ = (NIM_CHAR*)0;
	T10_ = X5BX5D___system_7129(result__Duce9bPtdY9cuV41HJK3P9bJQ, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	} LA2: ;
	{
		...
		T20_ = substr__system_7601(path__zbB2oo2FD6XhIdlH5Yed8g, ((NI)0), T13_);
		eqsink___stdZassertions_19((&(*Result).Field0), T20_);
		T21_.len = 0; T21_.p = NIM_NIL;
		T21_ = substr__system_7613(path__zbB2oo2FD6XhIdlH5Yed8g, (NI)(sepPos + ((NI)1)));
			...
			while (1) {
				...
				i = res;
				{
					...
					if (!T7_) goto LA9_;
					{
						...
						T22_ = substr__system_7601(path__mQs5USj7cYSjfdcRv9cqi0A, ((NI)0), T15_);
					...
					LA13_: ;
					{
						...
						T27_ = substr__system_7601(path__mQs5USj7cYSjfdcRv9cqi0A, namePos, (NI)(dotPos - ((NI)1)));
						eqsink___stdZassertions_19((&(*Result).Field1), T27_);
						T28_.len = 0; T28_.p = NIM_NIL;
						T28_ = substr__system_7613(path__mQs5USj7cYSjfdcRv9cqi0A, dotPos);
					...
					LA25_: ;
					{
						...
						T30_ = substr__system_7613(path__mQs5USj7cYSjfdcRv9cqi0A, namePos);
...
appendString((&T5_), colontmpD_);
	...
	LA3_: ;
	{
		...
		colontmpD__2 = substr__system_7601(filename__OD2NsXgx3ow22bCoVE9b19bA, ((NI)0), (NI)(extPos - ((NI)1)));
