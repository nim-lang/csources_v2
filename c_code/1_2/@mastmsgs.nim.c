...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_[0] = colontmpD_;
	colontmpD__2 = toFileLineCol__msgs_668(conf__1iJibMSLXKkizrdho3iqgA, (*sym__edW8eafB8o9bFHxcZhhVyEA).info);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_[1] = colontmpD__2;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		T8_ = toFileLineCol__msgs_668(conf__DgqDJwRi1SgInkSrQJfCzQ, (*disc__sKstq9cMIGclmyuDxbRXMxg).info);
...
appendString((&(*result__FaBAhXXoGnbytR8836I9auw_2)), colontmpD_);
	{
		...
		colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
		T8_.len = 0; T8_.p = NIM_NIL;
		colontmpD__2 = toFileLineCol__msgs_668(conf__1iJibMSLXKkizrdho3iqgA_2, (*(*typ_2).sym).info);
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
