...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3):
	{
		...
		x = getOrDefault__closureiters_1938((*c__Vd266j5dJSwty663xInU2g).tab, (NI)((NI)((NU64)(((NI) ((*xX60gensym314_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym314_).Sup.itemId.item))));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
								...
								res = ((NI)0);
								{
									while (1) {
										...
										v = res;
										{
											...
											if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
											X5BX5Deq___closureiters_2458((&(*c__Vd266j5dJSwty663xInU2g).tab), (NI)((NI)((NU64)(((NI) ((*xX60gensym323_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym323_).Sup.itemId.item))), colontmpD_);
											if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
			...
			while (1) {
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA24_;
				{
					...
					excHandlState = (*ctx__Z1SBZhHbVwqr9cArxabxDTg).exceptionTable.p->data[i_3];
					{
						...
						T36_ = (NI)0;
						T36_ = skipEmptyStates__closureiters_1523((&(*ctx__Z1SBZhHbVwqr9cArxabxDTg)), ((NI64)-(excHandlState)));
						if (NIM_UNLIKELY(*nimErr_)) goto LA31_;
						(*ctx__Z1SBZhHbVwqr9cArxabxDTg).exceptionTable.p->data[i_3] = ((NI64)-(T36_));
					}
					goto LA32_;
					LA34_: ;
					{
