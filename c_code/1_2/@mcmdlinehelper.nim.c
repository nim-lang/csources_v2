...
typedef N_CLOSURE_PTR(void, TM__RxBoA2E3fxrN6r2tToaOvg_11) (tyEnum_TCmdLinePass__7z2Tds19a2G5eslO9cP9apH4w pass, NimStringV2 cmd, tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* config);
...
typedef N_CLOSURE_PTR(void, TM__RxBoA2E3fxrN6r2tToaOvg_19) (tyEnum_TCmdLinePass__7z2Tds19a2G5eslO9cP9apH4w pass, NimStringV2 cmd, tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* config);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___nim_124)(tyObject_NimProgcolonObjectType___nXKTiDb6u1p29b8d5CUkjYw* dest);
static N_INLINE(NIM_BOOL, nimDecRefIsLastCyclicDyn)(void* p);
N_LIB_PRIVATE N_NIMCALL(void, nimDestroyAndDispose)(void* p);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___nim_133)(tyObject_NimProgcolonObjectType___nXKTiDb6u1p29b8d5CUkjYw* dest, void* env);
...
N_LIB_PRIVATE N_NIMCALL(void, addCmdPrefix__cmdlinehelper_16)(NimStringV2* result, tyEnum_CmdLineKind__XkdXq9atxjiuhkFFh0XYrSA kind) {
	...
	{
		prepareAdd((&(*result)), 2);
appendString((&(*result)), TM__RxBoA2E3fxrN6r2tToaOvg_3);
	}
	break;
	case ((tyEnum_CmdLineKind__XkdXq9atxjiuhkFFh0XYrSA)3):
	{
		prepareAdd((&(*result)), 1);
appendString((&(*result)), TM__RxBoA2E3fxrN6r2tToaOvg_5);
	}
	break;
...
{nimErr_ = nimErrorFlag();
	...
	defineSymbol__condsyms_4((*conf).symbols, name, TM__RxBoA2E3fxrN6r2tToaOvg_7);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
static N_INLINE(NI, minuspercent___system_790)(NI x, NI y) {
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___nim_143)(tyObject_NimProgcolonObjectType___nXKTiDb6u1p29b8d5CUkjYw** dest) {
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLastCyclicStatic((*dest), (&NTIv2__nXKTiDb6u1p29b8d5CUkjYw_));
		if (!T3_) goto LA4_;
		eqdestroy___nim_124((*dest));
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	(*self).processCmdLine.ClE_0? (*self).processCmdLine.ClP_0(((tyEnum_TCmdLinePass__7z2Tds19a2G5eslO9cP9apH4w)0), TM__RxBoA2E3fxrN6r2tToaOvg_10, conf, (*self).processCmdLine.ClE_0):((TM__RxBoA2E3fxrN6r2tToaOvg_11)((*self).processCmdLine.ClP_0))(((tyEnum_TCmdLinePass__7z2Tds19a2G5eslO9cP9apH4w)0), TM__RxBoA2E3fxrN6r2tToaOvg_10, conf);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		...
		if (!(T3_)) goto LA4_;
		T3_ = contains__stdZenumutils_49(TM__RxBoA2E3fxrN6r2tToaOvg_12, 2, (*conf).projectName);
		LA4_: ;
		if (!T3_) goto LA5_;
		handleCmdInput__commands_833(conf);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA1_;
	LA5_: ;
	{
		...
		if (!(T8_)) goto LA9_;
		T8_ = eqStrings((*conf).projectName, TM__RxBoA2E3fxrN6r2tToaOvg_13);
		LA9_: ;
		if (!T8_) goto LA10_;
	...
	LA10_: ;
	{
		if (!!(((*conf).projectName.len == 0))) goto LA13_;
		setFromProjectName__options_4983(conf, (*conf).projectName);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA1_;
	LA13_: ;
	{
		...
		T17_ = canonicalizePath__options_4979(conf, colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA16_;
		eqsink___stdZassertions_19((&(*conf).projectPath), T17_);
		{
			LA16_:;
		}
		{
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	{
		...
		setCmd__commands_853(conf, ((tyEnum_Command__b145RBTl7bacomLHdBguHg)11));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	{
		if (!((*conf).cmd == ((tyEnum_Command__b145RBTl7bacomLHdBguHg)12))) goto LA7_;
		(*conf).globalOptions |= ((NU64)1)<<(((((tyEnum_TGlobalOption__9bU4j0PZjdMiF7DRotXVQZw)2))) & 63);
	}
	LA7_: ;
	loadConfigs__nimconf_275(TM__RxBoA2E3fxrN6r2tToaOvg_15, cache, conf, (*graph).idgen);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NimStringV2 scriptFile;
		if (!!((*self).suggestMode)) goto LA11_;
		scriptFile.len = 0; scriptFile.p = NIM_NIL;
		scriptFile = noschangeFileExt((*conf).projectFull, TM__RxBoA2E3fxrN6r2tToaOvg_17);
		if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
			if (!(T16_)) goto LA17_;
			T16_ = eqeq___nimconf_454(scriptFile, (*conf).projectFull);
			if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
			LA17_: ;
			if (!T16_) goto LA18_;
			{
				if (!((*conf).cmd == ((tyEnum_Command__b145RBTl7bacomLHdBguHg)0))) goto LA22_;
				setCmd__commands_853(conf, ((tyEnum_Command__b145RBTl7bacomLHdBguHg)12));
				if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
			}
			LA22_: ;
			{
				if (!((*conf).cmd == ((tyEnum_Command__b145RBTl7bacomLHdBguHg)12))) goto LA26_;
				result = NIM_FALSE;
	...
	LA11_: ;
	{
		if (!!(((*conf).backend == ((tyEnum_TBackend__s27DA9b8P4ksjjsndcLjR2w)3)))) goto LA32_;
		initVars__extccomp_788(conf);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA32_: ;
	(*self).processCmdLine.ClE_0? (*self).processCmdLine.ClP_0(((tyEnum_TCmdLinePass__7z2Tds19a2G5eslO9cP9apH4w)1), TM__RxBoA2E3fxrN6r2tToaOvg_18, conf, (*self).processCmdLine.ClE_0):((TM__RxBoA2E3fxrN6r2tToaOvg_19)((*self).processCmdLine.ClP_0))(((tyEnum_TCmdLinePass__7z2Tds19a2G5eslO9cP9apH4w)1), TM__RxBoA2E3fxrN6r2tToaOvg_18, conf);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!((*conf).cmd == ((tyEnum_Command__b145RBTl7bacomLHdBguHg)0))) goto LA36_;
		liMessage__msgs_1159(conf, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__RxBoA2E3fxrN6r2tToaOvg_21, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__RxBoA2E3fxrN6r2tToaOvg_22), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA36_: ;
