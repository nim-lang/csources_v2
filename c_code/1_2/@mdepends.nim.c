...
appendString((&sub_2), TM__T9abLwc1VuaTcNHPnsJcieg_25);
		...
		LA56_: ;
		{
			...
			start_2 += sub_2.len;
			T59_ = (NI)0;
			T59_ = skipUntil__pureZparseutils_779(s__F4EfZYTB7bScUy9anG4r2pQ, 47, start_2);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			start_2 += T59_;
			start_2 += ((NI)1);
...
{nimErr_ = nimErrorFlag();
	...
	splitFile__pathutils_31(project__RkbnQYdkvcMWBKgd2EhayQ, (&colontmpD_));
