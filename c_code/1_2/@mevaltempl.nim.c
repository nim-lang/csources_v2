...
{nimErr_ = nimErrorFlag();
	...
	LA12_: ;
	{
		...
		liMessage__msgs_1159(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__bDep2LgNruC0l9bDFCq6TlQ_7, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)2), (&TM__bDep2LgNruC0l9bDFCq6TlQ_8), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA16_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA22_;
		liMessage__msgs_1159(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__5, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)2), (&TM__bDep2LgNruC0l9bDFCq6TlQ_11), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA22_;
		{
			LA22_:;
		}
		...
		res_2 = colontmp_;
		{
			while (1) {
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA33_;
				{
					...
					liMessage__msgs_1159(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__bDep2LgNruC0l9bDFCq6TlQ_12, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__bDep2LgNruC0l9bDFCq6TlQ_13), NIM_FALSE);
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
		{
			...
			LA41_: ;
			{
				...
				x = NIM_NIL;
				{
					...
					internalErrorImpl__msgs_1497((*c).config, unknownLineInfo__lineinfos_350, argX60gensym7_, (&TM__bDep2LgNruC0l9bDFCq6TlQ_20));
					if (NIM_UNLIKELY(*nimErr_)) goto LA67_;
					{
						LA67_:;
					}
...
{nimErr_ = nimErrorFlag();
	...
	(*conf).evalTemplateCounter += ((NI)1);
	{
		...
		liMessage__msgs_1159(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__bDep2LgNruC0l9bDFCq6TlQ_3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)2), (&TM__bDep2LgNruC0l9bDFCq6TlQ_4), NIM_FALSE);
...
appendString((&T18_), colontmpD_);
			colontmpD__2 = T18_;
			liMessage__msgs_1159(conf, (*result).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__bDep2LgNruC0l9bDFCq6TlQ_26), NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA17_;
			{
				LA17_:;
			}
