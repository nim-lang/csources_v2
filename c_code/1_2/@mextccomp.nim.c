...
typedef N_CLOSURE_PTR(NimStringV2, TM__pZmXgBT0YcBrnAO6VUvpNQ_331) (NimStringV2 x);
typedef N_CLOSURE_PTR(NimStringV2, TM__pZmXgBT0YcBrnAO6VUvpNQ_335) (NimStringV2 x, void* ClE_0);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___extccomp_3106)(tyObject_Env_extccompdotnim_execCmdsInParallel___yHnd6tS72p8Z69arkozzppg* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___extccomp_3130)(tyObject_Env_extccompdotnim_execCmdsInParallel___yHnd6tS72p8Z69arkozzppg** dest, tyObject_Env_extccompdotnim_execCmdsInParallel___yHnd6tS72p8Z69arkozzppg* src, NIM_BOOL cyclic);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___extccomp_3127)(tyObject_Env_extccompdotnim_execCmdsInParallel___yHnd6tS72p8Z69arkozzppg** dest);
...
static N_INLINE(NI, nanosecond__pureZtimes_1198)(tyObject_DateTime__d9cK9cyKZPJJxFXUmx8dSpPw* dt);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___extccomp_3272)(tyObject_Env_extccompdotnim_runJsonBuildInstructions___VGgYLDtRkrYcGQHO6dF5ag* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___extccomp_3296)(tyObject_Env_extccompdotnim_runJsonBuildInstructions___VGgYLDtRkrYcGQHO6dF5ag** dest, tyObject_Env_extccompdotnim_runJsonBuildInstructions___VGgYLDtRkrYcGQHO6dF5ag* src, NIM_BOOL cyclic);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___extccomp_3293)(tyObject_Env_extccompdotnim_runJsonBuildInstructions___VGgYLDtRkrYcGQHO6dF5ag** dest);
static const struct {
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = completeGeneratedFilePath__options_5118(conf, cfile, createSubDir);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (T3_) goto LA4_;
		T5_ = (NIM_CHAR*)0;
		T5_ = X5BX5D___system_7129(dest, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T3_ = !(((NU8)((*T5_)) == (NU8)(32)));
		LA4_: ;
		if (!T3_) goto LA6_;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		{
			if (!isCpp) goto LA8_;
			result = getEnv__stdZenvvars_14(TM__pZmXgBT0YcBrnAO6VUvpNQ_121, TM__pZmXgBT0YcBrnAO6VUvpNQ_122);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA6_;
		LA8_: ;
		{
			result = getEnv__stdZenvvars_14(TM__pZmXgBT0YcBrnAO6VUvpNQ_124, TM__pZmXgBT0YcBrnAO6VUvpNQ_125);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA6_: ;
	}
	...
	LA1_: ;
	{
		...
		liMessage__msgs_1159(conf, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__pZmXgBT0YcBrnAO6VUvpNQ_128), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA22_;
		{
			LA22_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	T1_.len = 0; T1_.p = NIM_NIL;
	{
		...
		result = getEnv__stdZenvvars_14(TM__pZmXgBT0YcBrnAO6VUvpNQ_153, TM__pZmXgBT0YcBrnAO6VUvpNQ_154);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA2_;
	LA4_: ;
	{
		result = getEnv__stdZenvvars_14(TM__pZmXgBT0YcBrnAO6VUvpNQ_156, TM__pZmXgBT0YcBrnAO6VUvpNQ_157);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA2_: ;
	}BeforeRet_: ;
...
appendString((&includeCmd), colontmpD__4);
	...
	T53_.len = 0; T53_.p = NIM_NIL;
	{
		...
		NimStringV2 T59_;
		T56_ = (NIM_BOOL)0;
		T56_ = isEmpty__options_5384((*cfile).obj);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T56_) goto LA57_;
...
appendString((&T91_), asmfile);
				colontmpD__23 = T91_;
				liMessage__msgs_1159(conf, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)110), colontmpD__23, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__pZmXgBT0YcBrnAO6VUvpNQ_164), NIM_FALSE);
...
appendString((&T102_), CC__extccomp_539[((*conf).cCompiler)- 1].Field0);
				colontmpD__24 = T102_;
				liMessage__msgs_1159(conf, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)110), colontmpD__24, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__pZmXgBT0YcBrnAO6VUvpNQ_167), NIM_FALSE);
...
{nimErr_ = nimErrorFlag();
	...
	write__stdZsyncio_248(f, TM__pZmXgBT0YcBrnAO6VUvpNQ_189);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, externalFileChanged__extccomp_1189)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, tyObject_Cfile__MtXNOrgFiCQ50Z86OxawlQ* cfile) {
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	hashFile = toGeneratedFile__options_5113(conf, colontmpD_, TM__pZmXgBT0YcBrnAO6VUvpNQ_82);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	(*conf).cCompiler = T1_;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		liMessage__msgs_1159(conf, info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__pZmXgBT0YcBrnAO6VUvpNQ_193), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___extccomp_2034)(tyObject_BuildCache__bsEp9cTzVeuA9a0MLpRaR1yg* dest) {
	...
	eqdestroy___stdZenvvars_151((&(*dest).compile));
	...
	eqdestroy___stdZenvvars_151((&(*dest).depfiles));
...
appendString((&T14_), filename);
		colontmpD__10 = T14_;
		liMessage__msgs_1159(conf, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__10, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__pZmXgBT0YcBrnAO6VUvpNQ_245), NIM_FALSE);
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		if (!T3_) goto LA4_;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
			T13_ = rawNewString(colontmpD__3.len + compileCmd.len + 2);
...
appendString((&T13_), compileCmd);
		...
		LA10_: ;
		{
			...
			colontmpD__4.len = 0; colontmpD__4.p = NIM_NIL;
			eqcopy___stdZassertions_16((&colontmpD__4), path);
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	liMessage__msgs_1159(conf, unknownLineInfo__lineinfos_350, msg, T2_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__pZmXgBT0YcBrnAO6VUvpNQ_263), NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	eqcopy___stdZassertions_16((&colontmpD_), objFile);
	nossplitFile(colontmpD_, (&colontmpD__2));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	newSeq__system_3392((&result), ((NI) (sLen_0)));
	{
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				T4_ = op.ClE_0? op.ClP_0(s[i], op.ClE_0):((TM__pZmXgBT0YcBrnAO6VUvpNQ_331)(op.ClP_0))(s[i]);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = nsuReplaceStr(curr, TM__pZmXgBT0YcBrnAO6VUvpNQ_332, TM__pZmXgBT0YcBrnAO6VUvpNQ_334);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		liMessage__msgs_1159(conf, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__pZmXgBT0YcBrnAO6VUvpNQ_339), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
...
appendString((&T12_), colontmpD_);
				colontmpD__2 = T12_;
				liMessage__msgs_1159(conf, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__pZmXgBT0YcBrnAO6VUvpNQ_267), NIM_FALSE);
				if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
				{
					LA11_:;
				}
...
appendString((&T18_), colontmpD__3);
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA17_;
				colontmpD__4 = T20_;
				liMessage__msgs_1159(conf, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__4, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__pZmXgBT0YcBrnAO6VUvpNQ_271), NIM_FALSE);
				if (NIM_UNLIKELY(*nimErr_)) goto LA17_;
				{
					LA17_:;
				}
...
appendString((&T21_), TM__pZmXgBT0YcBrnAO6VUvpNQ_337);
	linkerArgs = T21_;
	args = substr__system_7613(cmd, i);
	{
		NIM_BOOL T24_;
		NimStringV2 colontmpD_;
		T24_ = (NIM_BOOL)0;
	...
	colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
	T34_.len = 0; T34_.p = NIM_NIL;
	colontmpD__2 = substr__system_7601(cmd, ((NI)0), last);
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__2 = getNimcacheDir__options_5047(conf);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_.len = 0; T2_.p = NIM_NIL;
...
appendString((&T2_), name);
	colontmpD__3 = T2_;
	colontmpD__4 = nosaddFileExt(colontmpD__3, OS__platform_520[((*conf).target.targetOS)- 1].Field8);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
appendString((&T9_), filename);
		colontmpD__5 = T9_;
		liMessage__msgs_1159(conf, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__5, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__pZmXgBT0YcBrnAO6VUvpNQ_352), NIM_FALSE);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		eqsink___stdZenvvars_157((&bcache.depfiles), collectResult_3);
		collectResult_3.len = 0; collectResult_3.p = NIM_NIL;
		...
		{
			eqdestroy___stdZassertions_13((&colontmpD__14));
			eqdestroy___stdZenvvars_151((&collectResult_3));
		}
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA40_: ;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	writeFile__stdZsyncio_610((*conf).jsonBuildFile, colontmpD__10);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
	{
		...
		eqdestroy___stdZassertions_13((&colontmpD__3));
		eqdestroy___stdZassertions_13((&colontmpD__2));
		eqdestroy___stdZenvvars_151((&collectResult_2));
		eqdestroy___extccomp_2034((&bcache));
