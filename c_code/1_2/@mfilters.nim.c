...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	liMessage__msgs_1159(conf__N9bRmyh7iWHJeXdwhkNLONQ, (*n__Ui4dPZcz8KqNkZvgsB6wCA).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__Z829bJQuL5LjY0SVtwy0lEQ_4), NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	...
	line = rawNewString(((NI)80));
	{
		while (1) {
			...
			T4_ = (NIM_BOOL)0;
			T4_ = llStreamReadLine__llstream_236(stdin__OvigwQSYTXWGO3sPQzulyA, (&line));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			if (!T4_) goto LA3			;
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
			{
				...
				LA9_: ;
				if (!T8_) goto LA10_;
				llStreamWriteln__llstream_268(result, stripped);
				if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
			}
			goto LA6_;
			LA10_: ;
			{
				llStreamWriteln__llstream_268(result, line);
				if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
			}
			LA6_: ;
			{
	...
	llStreamClose__llstream_144(stdin__OvigwQSYTXWGO3sPQzulyA);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	...
	line = rawNewString(((NI)80));
	{
		while (1) {
			...
			NimStringV2 colontmpD_;
			T8_ = (NIM_BOOL)0;
			T8_ = llStreamReadLine__llstream_236(stdin__0M9alIculeUlhk14O1J5qlg, (&line));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			if (!T8_) goto LA7			;
			colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
			colontmpD_ = nsuReplaceStr(line, sub, by);
			if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
			llStreamWriteln__llstream_268(result, colontmpD_);
			if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
			{
				LA9_:;
			}
	...
	llStreamClose__llstream_144(stdin__0M9alIculeUlhk14O1J5qlg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
