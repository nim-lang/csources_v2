...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD_ = toFullPath__msgs_577(conf__rGrcp9cDlds9b2N8MizwVFBA, info__MZsuWbqX3oF9apEuka2XKqw.fileIndex);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
appendString((&T8_), colontmpD__3);
		colontmpD__4 = T8_;
		filename = toGeneratedFile__options_5113(conf__rGrcp9cDlds9b2N8MizwVFBA, colontmpD__4, TM__A04lj5tT6ly3Jo7R9ckk5iw_8);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		f = (FILE*)0;
		{
			NIM_BOOL T11_;
			...
			if (!(T11_)) goto LA12_;
			T11_ = open__stdZsyncio_528(&f, filename, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)0), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			LA12_: ;
			if (!T11_) goto LA13_;
			colontmp_.len = 0; colontmp_.p = NIM_NIL;
			colontmp_ = readAll__stdZsyncio_481(f);
		...
		readSuccessful = NIM_TRUE;
		{
			...
			writeFile__stdZsyncio_610(filename, result.Field0);
			if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
		}
		LA34_: ;
		{
				...
				*nimErr_ = NIM_FALSE;
				{
					...
					colontmpD__7 = getCurrentExceptionMsg__system_6920();
...
appendString((&T45_), colontmpD__7);
	...
	LA4_: ;
	{
		...
		{
			eqdestroy___pureZosproc_206(&p_2);
		}
		...
		if (NIM_UNLIKELY(*nimErr_)) {
			...
			if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 1335990016)||isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
				...
				*nimErr_ = NIM_FALSE;
				...
				colontmpD__10 = getCurrentExceptionMsg__system_6920();
