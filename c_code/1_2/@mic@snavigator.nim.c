...
struct tySequence__29btfq9cDuCZmHsAEmuBeMOg_Content { NI cap; tyObject_FullId__3oA6EHvzCx1KvUf9cxJRXXw data[SEQ_DECL_SIZE];};
      ...
      N_LIB_PRIVATE N_NIMCALL(void, nav__icZnavigator_327)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g);
...
N_LIB_PRIVATE N_NIMCALL(NI, searchForIncludeFile__icZnavigator_280)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, NimStringV2 fullPath);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___icZnavigator_369)(tyObject_NavContext__7sLg851om2TYW9bkYSG9btcg* dest);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_ItemId__RG5oiYa2xm9bBBKInuP3ECw, search__icZnavigator_61)(tyObject_NavContext__7sLg851om2TYW9bkYSG9btcg* c, tyObject_PackedTree__NQ7d1M9bD3cUZLhD9aRSVMRw tree);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, searchLocalSym__icZnavigator_25)(tyObject_NavContext__7sLg851om2TYW9bkYSG9btcg* c, tyObject_PackedSym__lJeIt8gwxYwQVC9aD43t8QA* s, tyObject_PackedLineInfo__wLj9aHuk4ZvBakrzOfuTRFg info);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isTracked__icZnavigator_19)(tyObject_PackedLineInfo__wLj9aHuk4ZvBakrzOfuTRFg current, tyObject_PackedLineInfo__wLj9aHuk4ZvBakrzOfuTRFg trackPos, NI tokenLen);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, searchForeignSym__icZnavigator_42)(tyObject_NavContext__7sLg851om2TYW9bkYSG9btcg* c, tyObject_ItemId__RG5oiYa2xm9bBBKInuP3ECw s, tyObject_PackedLineInfo__wLj9aHuk4ZvBakrzOfuTRFg info);
...
N_LIB_PRIVATE N_NIMCALL(void, list__icZnavigator_249)(tyObject_NavContext__7sLg851om2TYW9bkYSG9btcg* c, tyObject_PackedTree__NQ7d1M9bD3cUZLhD9aRSVMRw tree, tyObject_ItemId__RG5oiYa2xm9bBBKInuP3ECw sym);
N_LIB_PRIVATE N_NIMCALL(void, usage__icZnavigator_117)(tyObject_NavContext__7sLg851om2TYW9bkYSG9btcg* c, tyObject_PackedLineInfo__wLj9aHuk4ZvBakrzOfuTRFg info, NIM_BOOL isDecl);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isDecl__icZnavigator_104)(tyObject_PackedTree__NQ7d1M9bD3cUZLhD9aRSVMRw tree, NI n);
		...
		res = ((NI)0);
		{
			while (1) {
				...
				i = res;
				{
					...
					k = (NI)0;
					colontmp__2 = (NI)0;
					T6_ = ((*g).packed_0.p->data[i].fromDisk.includes.len-1);
					colontmp__2 = T6_;
					res_2 = ((NI)1);
					{
						while (1) {
							...
							k = res_2;
							{
								...
								NI T12_;
								T11_ = (NimStringV2*)0;
								T11_ = X5BX5D___icZic_7325((&(*g).packed_0.p->data[i].fromDisk.strings), (*g).packed_0.p->data[i].fromDisk.includes.p->data[k].Field0);
								if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
								T12_ = (NI)0;
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	eqdestroy___options_2683((&(*dest).alreadyEmitted.data));
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isTracked__icZnavigator_19)(tyObject_PackedLineInfo__wLj9aHuk4ZvBakrzOfuTRFg current, tyObject_PackedLineInfo__wLj9aHuk4ZvBakrzOfuTRFg trackPos, NI tokenLen) {
	NIM_BOOL result;
...
{nimErr_ = nimErrorFlag();
	...
	T3_ = (*c).trackPos;
	T4_ = (NimStringV2*)0;
	T4_ = X5BX5D___icZic_7325((&(*(*c).g).packed_0.p->data[(*c).thisModule].fromDisk.strings), (*s).name);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = isTracked__icZnavigator_19(info, T3_, (*T4_).len);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	LA2_: ;
	result = T1_;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	name = (*(*c).g).packed_0.p->data[s.module].fromDisk.syms.p->data[s.item].name;
	T1_ = (NIM_BOOL)0;
	T1_ = !((name == ((NU32)0)));
	if (!(T1_)) goto LA2_;
	T3_ = (*c).trackPos;
	T4_ = (NimStringV2*)0;
	T4_ = X5BX5D___icZic_7325((&(*(*c).g).packed_0.p->data[s.module].fromDisk.strings), name);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = isTracked__icZnavigator_19(info, T3_, (*T4_).len);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	LA2_: ;
	...
	nimZeroMem((void*)(&result), sizeof(tyObject_ItemId__RG5oiYa2xm9bBBKInuP3ECw));
	{
		...
		res = ((NI)0);
		{
			while (1) {
				if (!(res <= colontmp_)) goto LA4				;
				i = res;
				switch (tree.nodes.p->data[i].kind) {
				case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3):
				{
					NI32 item;
					item = tree.nodes.p->data[i].operand;
					{
						NIM_BOOL T8_;
						NI32 colontmpD_;
						T8_ = (NIM_BOOL)0;
						T8_ = searchLocalSym__icZnavigator_25(c, (&(*(*c).g).packed_0.p->data[(*c).thisModule].fromDisk.syms.p->data[item]), tree.nodes.p->data[i].info);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						if (!T8_) goto LA9_;
						colontmpD_ = (NI32)0;
						nimZeroMem((void*)(&result), sizeof(tyObject_ItemId__RG5oiYa2xm9bBBKInuP3ECw));
				...
				{
					{
						...
						T14_ = (NIM_BOOL)0;
						T14_ = (tree.nodes.p->data[i].info.line == (*c).trackPos.line);
						if (!(T14_)) goto LA15_;
						T14_ = (tree.nodes.p->data[i].info.file == (*c).trackPos.file);
						LA15_: ;
						if (!T14_) goto LA16_;
						T18_ = sons2__icZpacked95ast_675(tree, i);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						n1 = T18_.Field0;
						n2 = T18_.Field1;
						nimZeroMem((void*)(&pId), sizeof(tyObject_PackedItemId__ujcbfSfQQs6BRj9aXRwDsoA));
						pId.module = ((NU32) (tree.nodes.p->data[n1].operand));
						pId.item = tree.nodes.p->data[n2].operand;
						itemId = translateId__icZic_10587(pId, (*(*c).g).packed_0, ((NI) ((*c).thisModule)), (*(*c).g).config);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						{
							NIM_BOOL T21_;
							T21_ = (NIM_BOOL)0;
							T21_ = searchForeignSym__icZnavigator_42(c, itemId, tree.nodes.p->data[i].info);
							if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
							if (!T21_) goto LA22_;
							result = itemId;
							goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	T2_ = (NimStringV2*)0;
	T2_ = X5BX5D___icZic_7325((&(*(*c).g).packed_0.p->data[(*c).thisModule].fromDisk.strings), info.file);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqcopy___stdZassertions_16((&file), (*T2_));
	{
		NimStringV2 T7_;
		if (!((NU8)((*c).outputSep) == (NU8)(32))) goto LA5_;
...
appendString((&m), file);
	{
		if (!(((NI)0) < ((NI) (info.line)))) goto LA10_;
		prepareAdd((&m), 1);
appendString((&m), TM__zWk6TMNzqFZwK8K7WF5GPg_17);
		addInt__stdZprivateZdigitsutils_198((&m), ((NI) (info.line)));
		{
			if (!(((NI)0) < (NI)(((NI) (info.col)) + ((NI)1)))) goto LA14_;
			prepareAdd((&m), 2);
appendString((&m), TM__zWk6TMNzqFZwK8K7WF5GPg_19);
			addInt__stdZprivateZdigitsutils_198((&m), (NI)(((NI) (info.col)) + ((NI)1)));
		}
		LA14_: ;
		prepareAdd((&m), 1);
appendString((&m), TM__zWk6TMNzqFZwK8K7WF5GPg_21);
	...
	LA10_: ;
	{
		...
		T18_ = (NIM_BOOL)0;
		T18_ = containsOrIncl__icZnavigator_147((&(*c).alreadyEmitted), m);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!!(T18_)) goto LA19_;
...
appendChar((&T22_), (*c).outputSep);
appendString((&T22_), m);
		colontmpD__3 = T22_;
		T29_ = 0;
		msgWriteln__msgs_686((*(*c).g).config, colontmpD__3, T29_);
			...
			while (1) {
				...
				case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3):
				{
					...
					item = tree.nodes.p->data[i].operand;
					{
						...
						if (!T8_) goto LA10_;
						T12_ = (NI)0;
						T12_ = parentImpl__icZpacked95ast_605(tree, i);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						T13_ = (NIM_BOOL)0;
						T13_ = isDecl__icZnavigator_104(tree, T12_);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						usage__icZnavigator_117(c, tree.nodes.p->data[i].info, T13_);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					}
					LA10_: ;
				}
				...
				case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)162):
				{
					...
					tyObject_PackedItemId__ujcbfSfQQs6BRj9aXRwDsoA pId;
					tyObject_ItemId__RG5oiYa2xm9bBBKInuP3ECw itemId;
					T15_ = sons2__icZpacked95ast_675(tree, i);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					n1 = T15_.Field0;
					n2 = T15_.Field1;
					nimZeroMem((void*)(&pId), sizeof(tyObject_PackedItemId__ujcbfSfQQs6BRj9aXRwDsoA));
					...
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					{
						...
						if (!T18_) goto LA20_;
						T22_ = (NI)0;
						T22_ = parentImpl__icZpacked95ast_605(tree, i);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						T23_ = (NIM_BOOL)0;
						T23_ = isDecl__icZnavigator_104(tree, T22_);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						usage__icZnavigator_117(c, tree.nodes.p->data[i].info, T23_);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					}
					LA20_: ;
				}
...
{nimErr_ = nimErrorFlag();
	...
	fullPath = toFullPath__msgs_577((*g).config, unpacked.fileIndex);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		if (!((*g).packed_0.p->data[mid].status == ((tyEnum_ModuleStatus__QEyqxRJg9cMLyoEGTCNwluA)0))) goto LA4_;
		mid = searchForIncludeFile__icZnavigator_280(g, fullPath);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA4_: ;
	{
...
appendString((&T11_), fullPath);
		colontmpD__5 = T11_;
		liMessage__msgs_1159((*g).config, unpacked, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__5, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__zWk6TMNzqFZwK8K7WF5GPg_4), NIM_FALSE);
	...
	LA8_: ;
	fileId = getKeyId__icZnavigator_338((&(*g).packed_0.p->data[mid].fromDisk.strings), fullPath);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		if (!(fileId == ((NU32)0))) goto LA16_;
		internalErrorImpl__msgs_1497((*g).config, unpacked, TM__zWk6TMNzqFZwK8K7WF5GPg_7, (&TM__zWk6TMNzqFZwK8K7WF5GPg_8));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		eqdestroy___icZnavigator_369((&c));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqdestroy___stdZassertions_13((&fullPath));
	...
	c.trackPos.file = fileId;
	{
		NIM_BOOL T20_;
		T20_ = (NIM_BOOL)0;
		T20_ = isDefined__options_2481((*g).config, TM__zWk6TMNzqFZwK8K7WF5GPg_10);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T20_) goto LA21_;
		colontmpD__3 = 32;
	...
	LA18_: ;
	symId = search__icZnavigator_61((&c), (*g).packed_0.p->data[mid].fromDisk.topLevel);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NIM_BOOL T26_;
		T26_ = (NIM_BOOL)0;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T26_) goto LA27_;
		symId = search__icZnavigator_61((&c), (*g).packed_0.p->data[mid].fromDisk.bodies);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA27_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T31_) goto LA32_;
		liMessage__msgs_1159((*g).config, unpacked, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__zWk6TMNzqFZwK8K7WF5GPg_12, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__zWk6TMNzqFZwK8K7WF5GPg_13), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		eqdestroy___icZnavigator_369((&c));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqdestroy___stdZassertions_13((&fullPath));
	...
	LA32_: ;
	{
		...
		res = ((NI)0);
		{
			while (1) {
				...
				{
					c.thisModule = ((NI32) (i));
					list__icZnavigator_249((&c), (*g).packed_0.p->data[i].fromDisk.topLevel, symId);
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
					list__icZnavigator_249((&c), (*g).packed_0.p->data[i].fromDisk.bodies, symId);
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				}
				break;
				}
