...
appendString((&T11_), fullPath);
		colontmpD__5 = T11_;
		liMessage__msgs_1159((*g__QiJFSJU5boQwpUzKLsvLAw).config, unpacked, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__5, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__zWk6TMNzqFZwK8K7WF5GPg_4), NIM_FALSE);
