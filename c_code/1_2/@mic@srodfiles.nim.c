...
{nimErr_ = nimErrorFlag();
	nimZeroMem((void*)(&result), sizeof(tyObject_RodFile__XcLU0inTFUVuN75PWPV9cMA));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = open__stdZsyncio_528(&result.f, filename, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)0), ((NI)-1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T3_)) goto LA4_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = readBuffer__stdZsyncio_156((*f).f, ((void*) (x)), ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	lenPrefix = ((NI32)0);
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = readBuffer__stdZsyncio_156((*f).f, ((void*) ((&lenPrefix))), ((NI)4));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA8_: ;
	{
		...
		eqsink___stdZassertions_19((&(*s)), T11_);
		{
			if (!(((NI32)0) < lenPrefix)) goto LA14_;
			{
				NI T18_;
				T18_ = (NI)0;
				T18_ = readBuffer__stdZsyncio_156((*f).f, ((void*) ((&(*s).p->data[((NI)0)]))), ((NI) ((*s).len)));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = readBuffer__stdZsyncio_156((*f).f, ((void*) (x)), ((NI)8));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!((T7_ == ((NI)8)))) goto LA8_;
		setError__icZrodfiles_53(f, ((tyEnum_RodFileError__9apxYVvWfmXAkqFBYGC7cBQ)3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = readBuffer__stdZsyncio_156((*f).f, ((void*) (x)), ((NI)16));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = readBuffer__stdZsyncio_156((*f).f, ((void*) (x)), ((NI)4));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!((T7_ == ((NI)4)))) goto LA8_;
		setError__icZrodfiles_53(f, ((tyEnum_RodFileError__9apxYVvWfmXAkqFBYGC7cBQ)3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = readBuffer__stdZsyncio_156((*f).f, ((void*) (x)), ((NI)12));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = readBuffer__stdZsyncio_156((*f).f, ((void*) (x)), ((NI)28));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = readBuffer__stdZsyncio_156((*f).f, ((void*) (x)), ((NI)120));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = readBuffer__stdZsyncio_156((*f).f, ((void*) (x)), ((NI)2));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = readBuffer__stdZsyncio_156((*f).f, ((void*) (x)), ((NI)20));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = readBuffer__stdZsyncio_156((*f).f, ((void*) (x)), ((NI)24));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	nimZeroMem((void*)(&result), sizeof(tyObject_RodFile__XcLU0inTFUVuN75PWPV9cMA));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = open__stdZsyncio_528(&result.f, filename, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)1), ((NI)-1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T3_)) goto LA4_;
		setError__icZrodfiles_53((&result), ((tyEnum_RodFileError__9apxYVvWfmXAkqFBYGC7cBQ)2));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = writeBuffer__stdZsyncio_187((*f).f, ((void*) ((&x))), ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!((T7_ == ((NI)1)))) goto LA8_;
		setError__icZrodfiles_53(f, ((tyEnum_RodFileError__9apxYVvWfmXAkqFBYGC7cBQ)3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	lenPrefix = ((NI32) (s.len));
	{
		NI T11_;
		T11_ = (NI)0;
		T11_ = writeBuffer__stdZsyncio_187((*f).f, ((void*) ((&lenPrefix))), ((NI)4));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	{
		{
			if (!!((s.len == ((NI)0)))) goto LA17_;
			{
				NI T21_;
				T21_ = (NI)0;
				T21_ = writeBuffer__stdZsyncio_187((*f).f, ((void*) ((&s.p->data[((NI)0)]))), ((NI) (s.len)));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = writeBuffer__stdZsyncio_187((*f).f, ((void*) ((&x))), ((NI)8));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!((T7_ == ((NI)8)))) goto LA8_;
		setError__icZrodfiles_53(f, ((tyEnum_RodFileError__9apxYVvWfmXAkqFBYGC7cBQ)3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = writeBuffer__stdZsyncio_187((*f).f, ((void*) ((&x))), ((NI)16));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!((T7_ == ((NI)16)))) goto LA8_;
		setError__icZrodfiles_53(f, ((tyEnum_RodFileError__9apxYVvWfmXAkqFBYGC7cBQ)3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	lenPrefix = ((NI32) (T10_));
	{
		NI T13_;
		T13_ = (NI)0;
		T13_ = writeBuffer__stdZsyncio_187((*f).f, ((void*) ((&lenPrefix))), ((NI)4));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = writeBuffer__stdZsyncio_187((*f).f, ((void*) ((&x))), ((NI)4));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!((T7_ == ((NI)4)))) goto LA8_;
		setError__icZrodfiles_53(f, ((tyEnum_RodFileError__9apxYVvWfmXAkqFBYGC7cBQ)3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = writeBuffer__stdZsyncio_187((*f).f, ((void*) ((&x))), ((NI)12));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!((T7_ == ((NI)12)))) goto LA8_;
		setError__icZrodfiles_53(f, ((tyEnum_RodFileError__9apxYVvWfmXAkqFBYGC7cBQ)3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = writeBuffer__stdZsyncio_187((*f).f, ((void*) (x)), ((NI)28));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!((T7_ == ((NI)28)))) goto LA8_;
		setError__icZrodfiles_53(f, ((tyEnum_RodFileError__9apxYVvWfmXAkqFBYGC7cBQ)3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = writeBuffer__stdZsyncio_187((*f).f, ((void*) (x)), ((NI)120));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!((T7_ == ((NI)120)))) goto LA8_;
		setError__icZrodfiles_53(f, ((tyEnum_RodFileError__9apxYVvWfmXAkqFBYGC7cBQ)3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = writeBuffer__stdZsyncio_187((*f).f, ((void*) ((&x))), ((NI)2));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!((T7_ == ((NI)2)))) goto LA8_;
		setError__icZrodfiles_53(f, ((tyEnum_RodFileError__9apxYVvWfmXAkqFBYGC7cBQ)3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = writeBuffer__stdZsyncio_187((*f).f, ((void*) ((&x))), ((NI)20));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!((T7_ == ((NI)20)))) goto LA8_;
		setError__icZrodfiles_53(f, ((tyEnum_RodFileError__9apxYVvWfmXAkqFBYGC7cBQ)3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		NI T7_;
		T7_ = (NI)0;
		T7_ = writeBuffer__stdZsyncio_187((*f).f, ((void*) ((&x))), ((NI)24));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!((T7_ == ((NI)24)))) goto LA8_;
		setError__icZrodfiles_53(f, ((tyEnum_RodFileError__9apxYVvWfmXAkqFBYGC7cBQ)3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
