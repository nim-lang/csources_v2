...
{nimErr_ = nimErrorFlag();
	...
	LA9_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__Lhb9bT29cO9colfu9awEQRLNKg_2).uninit.head, ((NI)8));
	}
	LA14_: ;
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
		nn = skipConv__types_3839(n__wPDK5BstB9cIesDDYUSq3PA);
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
				...
				i_20 = ((NI)1);
				{
					while (1) {
						...
						i_19 = i_20;
						{
							...
							field = NIM_NIL;
							field = lookupFieldAgain__types_4363(t, (*(*(*n__K3JWBYvP9bRIdrTayLuAvuw)._kind_6.sons.p->data[i_19])._kind_6.sons.p->data[((NI)0)])._kind_4.sym);
