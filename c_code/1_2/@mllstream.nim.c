...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, readLineFromStdin__llstream_146)(NimStringV2 prompt, NimStringV2* line);
static N_INLINE(void, quit__system_7018)(NI errorcode);
N_LIB_PRIVATE N_NIMCALL(NI, countTriples__llstream_177)(NimStringV2 s);
static N_INLINE(NIM_BOOL, continueLine__llstream_169)(NimStringV2 line, NIM_BOOL inTripleString);
...
{nimErr_ = nimErrorFlag();
	...
	(*result).kind = ((tyEnum_TLLStreamKind__9cSQ7roMMT510UcuCxRX05w)2);
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = open__stdZsyncio_528(&(*result).f, filename, mode, ((NI)-1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T3_)) goto LA4_;
...
N_LIB_PRIVATE N_NIMCALL(NI, llStreamRead__llstream_218)(tyObject_TLLStream__f9cpUXDA3VY8pIlUfIovHaw* s, void* buf, NI bufLen) {
	NI result;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	result = (NI)0;
	...
	{
		result = readBuffer__stdZsyncio_156((*s).f, buf, ((NI) (bufLen)));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TLLStreamKind__9cSQ7roMMT510UcuCxRX05w)2):
	{
		result = readLine__stdZsyncio_310((*s).f, line);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TLLStreamKind__9cSQ7roMMT510UcuCxRX05w)3):
	{
		result = readLine__stdZsyncio_310(stdin, line);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	}
...
appendString((&(*s).s), data);
	...
	case ((tyEnum_TLLStreamKind__9cSQ7roMMT510UcuCxRX05w)2):
	{
		write__stdZsyncio_248((*s).f, data);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	}
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TLLStreamKind__9cSQ7roMMT510UcuCxRX05w)2):
	{
		...
		c = data;
		T4_ = (NI)0;
		T4_ = writeBuffer__stdZsyncio_187((*s).f, ((void*) ((&c))), ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(void)(T4_);
	}
	break;
...
N_LIB_PRIVATE N_NIMCALL(void, llStreamWriteln__llstream_268)(tyObject_TLLStream__f9cpUXDA3VY8pIlUfIovHaw* s, NimStringV2 data) {
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	llStreamWrite__llstream_260(s, data);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	llStreamWrite__llstream_260(s, TM__Q5pPHKW81rXwtH2v9bMQlZA_7);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___llstream_127)(tyProc__oi9b0z9awBBnvGw9arizvgdNw* dest, tyProc__oi9b0z9awBBnvGw9arizvgdNw src, NIM_BOOL cyclic) {
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TLLStream__f9cpUXDA3VY8pIlUfIovHaw*, llStreamOpenStdIn__llstream_117)(tyProc__oi9b0z9awBBnvGw9arizvgdNw r, tyProc__HzVCwACFYM9cx9aV62PdjtuA onPrompt) {
	...
	eqcopy___stdZexitprocs_247((&(*result).onPrompt), onPrompt, NIM_TRUE);
	return result;
}
static N_INLINE(void, quit__system_7018)(NI errorcode) {
	{
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	write__stdZsyncio_248(stdout, prompt);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = readLine__stdZsyncio_310(stdin, line);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
...
{nimErr_ = nimErrorFlag();
	...
	if (T5_) goto LA6_;
	T5_ = endsWith__llstream_150(line, TM__Q5pPHKW81rXwtH2v9bMQlZA_17);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	LA6_: ;
	T3_ = T5_;
	LA4_: ;
