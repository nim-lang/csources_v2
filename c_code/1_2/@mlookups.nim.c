	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		while (1) {
			...
			case ((tyEnum_ImportMode__LzfO42ojcBTf7f9ahbveBXw)1):
			{
				...
				colontmpD__2 = contains__astalgo_3655((&(*im)._mode_2.imported), (NI)((NI)((NU64)(((NI) ((*xX60gensym26_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym26_).Sup.itemId.item))));
				if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
			...
			}
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
				T12_ = (NIM_BOOL)0;
				T12_ = containsOrIncl__astalgo_402(marked, (NI)((NI)((NU64)(((NI) ((*xX60gensym28_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym28_).Sup.itemId.item))));
				if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
				T10_ = !(T12_);
				LA11_: ;
				if (!T10_) goto LA13_;
		...
		while (1) {
			...
			case ((tyEnum_ImportMode__LzfO42ojcBTf7f9ahbveBXw)0):
			{
				...
				xX60gensym29_ = NIM_NIL;
				{
					...
					T12_ = (NIM_BOOL)0;
					T12_ = containsOrIncl__astalgo_402(marked, (NI)((NI)((NU64)(((NI) ((*xX60gensym29_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym29_).Sup.itemId.item))));
					if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
					if (!!(T12_)) goto LA13_;
			...
			case ((tyEnum_ImportMode__LzfO42ojcBTf7f9ahbveBXw)1):
			{
				...
				xX60gensym32_ = NIM_NIL;
				{
					...
					T21_ = contains__astalgo_3655((&(*im)._mode_2.imported), (NI)((NI)((NU64)(((NI) ((*xX60gensym31_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym31_).Sup.itemId.item))));
					if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
					if (!(T21_)) goto LA22_;
					eqcopy___ast_4063(&xX60gensym32_, result);
					if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
					T23_ = (NIM_BOOL)0;
					T23_ = containsOrIncl__astalgo_402(marked, (NI)((NI)((NU64)(((NI) ((*xX60gensym32_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym32_).Sup.itemId.item))));
					if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
					T21_ = !(T23_);
					LA22_: ;
					if (!T21_) goto LA24_;
			...
			case ((tyEnum_ImportMode__LzfO42ojcBTf7f9ahbveBXw)2):
			{
				...
				xX60gensym34_ = NIM_NIL;
				{
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA29_;
					T35_ = (NIM_BOOL)0;
					T35_ = containsOrIncl__astalgo_402(marked, (NI)((NI)((NU64)(((NI) ((*xX60gensym34_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym34_).Sup.itemId.item))));
					if (NIM_UNLIKELY(*nimErr_)) goto LA29_;
					T32_ = !(T35_);
					LA34_: ;
					if (!T32_) goto LA36_;
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)57):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA71_;
		incl__pureZcollectionsZintsets_202((&(*o).marked), (NI)((NI)((NU64)(((NI) ((*xX60gensym185_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym185_).Sup.itemId.item))));
		if (NIM_UNLIKELY(*nimErr_)) goto LA71_;
		{
			LA71_:;
		}
	...
	{
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			incl__pureZcollectionsZintsets_202((&(*o).marked), (NI)((NI)((NU64)(((NI) ((*xX60gensym207_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym207_).Sup.itemId.item))));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			(*o).symChoiceIndex += ((NI)1);
		...
		LA60_: ;
		{
			...
			} LA66: ;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA65_;
				incl__pureZcollectionsZintsets_202((&(*o).marked), (NI)((NI)((NU64)(((NI) ((*xX60gensym214_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym214_).Sup.itemId.item))));
				if (NIM_UNLIKELY(*nimErr_)) goto LA65_;
	...
	{
		{
			...
			} LA90: ;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA89_;
				incl__pureZcollectionsZintsets_202((&(*o).marked), (NI)((NI)((NU64)(((NI) ((*xX60gensym221_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym221_).Sup.itemId.item))));
				if (NIM_UNLIKELY(*nimErr_)) goto LA89_;
