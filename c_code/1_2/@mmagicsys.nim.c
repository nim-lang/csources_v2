...
appendString((&T7_), name__rlYsbakSREJ8x79cV8t9bx6A);
		colontmpD__2 = T7_;
		liMessage__msgs_1159((*g__n9cayftO1CvE4yBhqRi6UVA).config, info__ONBbmCk2FcNgA1Inl5tQ9aA, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__G8Z4HuN1yiXApc3R3GXyPg_4), NIM_FALSE);
...
appendString((&T49_), colontmpD_);
			colontmpD__2 = T49_;
			internalErrorImpl__msgs_1497((*g__9by1VwZfxUFtq89c5DvdtzTw).config, unknownLineInfo__lineinfos_350, colontmpD__2, (&TM__G8Z4HuN1yiXApc3R3GXyPg_48));
...
appendString((&T64_), colontmpD__4);
			colontmpD__5 = T64_;
			internalErrorImpl__msgs_1497((*g__9by1VwZfxUFtq89c5DvdtzTw).config, unknownLineInfo__lineinfos_350, colontmpD__5, (&TM__G8Z4HuN1yiXApc3R3GXyPg_53));
...
appendString((&T72_), colontmpD__6);
		colontmpD__7 = T72_;
		internalErrorImpl__msgs_1497((*g__9by1VwZfxUFtq89c5DvdtzTw).config, unknownLineInfo__lineinfos_350, colontmpD__7, (&TM__G8Z4HuN1yiXApc3R3GXyPg_56));
...
appendString((&T23_), name__yqHyCwcnaDTTsWmp7xA9b9cg);
	colontmpD_ = T23_;
	liMessage__msgs_1159((*g__s4n12eg4I3gRW4oj5DGx1g).config, info__QA4kszPdXsZy8WtRQMXNpQ, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__G8Z4HuN1yiXApc3R3GXyPg_58), NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		colontmpD_ = dollar___msgs_663((*g__07DbJX04tsayJ9aWPESOv9aA).config, (*conflict).info);
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
		T8_ = rawNewString(colontmpD_.len + 51);
appendString((&T8_), TM__G8Z4HuN1yiXApc3R3GXyPg_60);
appendString((&T8_), colontmpD_);
		colontmpD__2 = T8_;
		liMessage__msgs_1159((*g__07DbJX04tsayJ9aWPESOv9aA).config, (*s__7kf9a8nqDyAfsxJ71K57Qsw).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__G8Z4HuN1yiXApc3R3GXyPg_61), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
		{
			LA7_:;
		}
...
appendString((&T11_), colontmpD_);
		colontmpD__2 = T11_;
		liMessage__msgs_1159((*g__6HYYmWSyIIpWua29bRPYUhw).config, info__rtO9bOxSWjw9b65Pnwa9aHCPg, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)2), (&TM__G8Z4HuN1yiXApc3R3GXyPg_73), NIM_FALSE);
