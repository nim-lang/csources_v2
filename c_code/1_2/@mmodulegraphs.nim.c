...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___modulegraphs_11059)(tySequence__gDGqa9bft4EIBGJXdPabojw* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___modulegraphs_1299)(tySequence__29btfq9cDuCZmHsAEmuBeMOg* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___modulegraphs_11108)(tySequence__6HN8Af9btfjdnDkSmkCapaA* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, initModuleGraphFields__modulegraphs_8859)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* result);
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___modulegraphs_11037)(tyObject_Operators__Ai9aW8j1mouo4Nz9bP29c2c5w* dest, tyObject_Operators__Ai9aW8j1mouo4Nz9bP29c2c5w* src);
N_LIB_PRIVATE N_NIMCALL(void, initOperators__modulegraphs_8856)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyObject_Operators__Ai9aW8j1mouo4Nz9bP29c2c5w* Result);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*, createMagic__modulegraphs_8546)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, NimStringV2 name, tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg m);
...
static N_INLINE(NI, dependsOn__modulegraphs_11421)(NI a, NI b);
...
N_LIB_PRIVATE N_NIMCALL(void, simulateCachedModule__modulegraphs_2884)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* moduleSym, tyObject_PackedModule__i9anwDwJxE2V9bIMoIqqe9chA* m);
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___modulegraphs_1302)(tySequence__29btfq9cDuCZmHsAEmuBeMOg* dest, tySequence__29btfq9cDuCZmHsAEmuBeMOg src);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*, resolveAttachedOp__modulegraphs_3294)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyObject_LazySym__Ryd9aJ9bcLvoLBu56Qo9bzm9aw* t);
...
N_LIB_PRIVATE N_NIMCALL(void, transitiveClosure__modulegraphs_12931)(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* g, NI n);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, contains__astalgo_3655)(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* s, NI key);
N_LIB_PRIVATE N_NIMCALL(void, markDirty__modulegraphs_13127)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, NI32 fileIdx);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, toBase64a__modulegraphs_2773)(NCSTRING s, NI len);
...
static N_INLINE(tyObject_PackedItemId__ujcbfSfQQs6BRj9aXRwDsoA, toPackedItemId__icZpacked95ast_790)(NI32 item);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*, resolveSym__modulegraphs_3209)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyObject_LazySym__Ryd9aJ9bcLvoLBu56Qo9bzm9aw* t);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___modulegraphs_8619)(tySequence__khRnfByqYV6qzEm71s9aoMA* dest) {
 ...
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyObject_LazySym__Ryd9aJ9bcLvoLBu56Qo9bzm9aw));
}
}
static N_INLINE(NIM_BOOL*, nimErrorFlag)(void) {
	NIM_BOOL* result;
...
{nimErr_ = nimErrorFlag();
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			T3_ = (*dest).len;
			if (!(colontmp_ < T3_)) goto LA2			;
			eqdestroy___icZic_867((&(*dest).p->data[colontmp_].filenames.data));
			eqdestroy___ast_3490((&(*dest).p->data[colontmp_].pendingTypes));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			eqdestroy___ast_4327((&(*dest).p->data[colontmp_].pendingSyms));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			{
				NIM_BOOL T6_;
				T6_ = (NIM_BOOL)0;
				T6_ = nimDecRefIsLast((*dest).p->data[colontmp_].typeMarker.head);
				if (!T6_) goto LA7_;
				eqdestroy___pureZcollectionsZintsets_36((*dest).p->data[colontmp_].typeMarker.head);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				nimRawDispose((*dest).p->data[colontmp_].typeMarker.head, ((NI)8));
			}
			LA7_: ;
			eqdestroy___pureZcollectionsZintsets_56((&(*dest).p->data[colontmp_].typeMarker.data));
			{
				NIM_BOOL T11_;
				T11_ = (NIM_BOOL)0;
				T11_ = nimDecRefIsLast((*dest).p->data[colontmp_].symMarker.head);
				if (!T11_) goto LA12_;
				eqdestroy___pureZcollectionsZintsets_36((*dest).p->data[colontmp_].symMarker.head);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				nimRawDispose((*dest).p->data[colontmp_].symMarker.head, ((NI)8));
			}
			LA12_: ;
			eqdestroy___pureZcollectionsZintsets_56((&(*dest).p->data[colontmp_].symMarker.data));
			{
				NIM_BOOL T16_;
				T16_ = (NIM_BOOL)0;
				T16_ = nimDecRefIsLast((*dest).p->data[colontmp_].config);
				if (!T16_) goto LA17_;
				eqdestroy___options_3149((*dest).p->data[colontmp_].config);
	...
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyObject_PackedEncoder__7mkdmVhEnEC4f7GEynWrbw));
}
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___modulegraphs_712)(tySequence__rbrgPpeV9be6C3GwbBbkmpA* dest) {
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			if (!(colontmp_ < T3_)) goto LA2			;
			{
				NIM_BOOL T6_;
				T6_ = (NIM_BOOL)0;
				T6_ = nimDecRefIsLast((*dest).p->data[colontmp_].typ);
				if (!T6_) goto LA7_;
	...
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyObject_LazyType__SN9c3fsi9b9ajltls5ZKIUiTA));
}
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___modulegraphs_1299)(tySequence__29btfq9cDuCZmHsAEmuBeMOg* dest) {
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyObject_FullId__3oA6EHvzCx1KvUf9cxJRXXw));
}
}
static N_INLINE(NIM_BOOL, nimDecRefIsLastCyclicStatic)(void* p, TNimTypeV2* desc) {
	NIM_BOOL result;
...
{nimErr_ = nimErrorFlag();
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			T3_ = (*dest).len;
			if (!(colontmp_ < T3_)) goto LA2			;
			eqdestroy___modulegraphs_1299((&(*dest).p->data[colontmp_].concreteTypes));
			{
				NIM_BOOL T6_;
				T6_ = (NIM_BOOL)0;
				T6_ = nimDecRefIsLastCyclicStatic((*dest).p->data[colontmp_].inst, (&NTIv2__8SLhhTGRSJj9a3g5KOHqwdQ_));
				if (!T6_) goto LA7_;
	...
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyObject_LazyInstantiation__9a6qqvxx8ZzdJrEGrAFijCA));
}
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___modulegraphs_2543)(tySequence__KBDwsdF2UrZmqdc6bU9bHbA* dest) {
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			if (!(colontmp_ < T3_)) goto LA2			;
			{
				NIM_BOOL T6_;
				T6_ = (NIM_BOOL)0;
				T6_ = nimDecRefIsLast((*dest).p->data[colontmp_].Field1.sym);
				if (!T6_) goto LA7_;
	...
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyTuple__pDyHME2vky9bxBYZlE7PoZg));
}
}
static N_INLINE(NIM_BOOL, nimDecRefIsLastCyclicDyn)(void* p) {
	NIM_BOOL result;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___modulegraphs_9274)(tySequence__XpdAmI9cDNdhUBFb3iaYfkw* dest) {
	...
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyObject_SymInfoPair__tdBivcU9bT8j1LrgpcSZ9a6w));
}
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___modulegraphs_9569)(tySequence__tffJ9cMZMd9ar9a5FqFq6EJ9bA* dest) {
	NI colontmp_;
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			if (!(colontmp_ < T3_)) goto LA2			;
			{
				NIM_BOOL T6_;
				T6_ = (NIM_BOOL)0;
				T6_ = nimDecRefIsLastCyclicStatic((*dest).p->data[colontmp_], (&NTIv2__fw9a9cWgWYzM4zKmnq3DGNfQ_));
				if (!T6_) goto LA7_;
				eqdestroy___modulegraphs_9583((*dest).p->data[colontmp_]);
	...
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyObject_SuggestcolonObjectType___fw9a9cWgWYzM4zKmnq3DGNfQ*));
}
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___modulegraphs_11108)(tySequence__6HN8Af9btfjdnDkSmkCapaA* dest) {
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyTuple__GicXS2CKoWgwFlNKz2d15w));
}
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___modulegraphs_11047)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* dest) {
	NI colontmp_;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	eqdestroy___modulegraphs_10670((&(*dest).ifaces));
	eqdestroy___modulegraphs_8438((&(*dest).packed_0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___modulegraphs_11059((&(*dest).encoders));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___modulegraphs_3626((&(*dest).typeInstCache.data));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___modulegraphs_4262((&(*dest).procInstCache.data));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmp_ = ((NI)0);
	{
		while (1) {
			if (!(colontmp_ < ((NI)5))) goto LA2			;
			eqdestroy___modulegraphs_4899((&(*dest).attachedOps[(colontmp_)- 0].data));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			colontmp_ += ((NI)1);
		} LA2: ;
	}
	eqdestroy___modulegraphs_6856((&(*dest).methodsPerType.data));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___modulegraphs_4899((&(*dest).enumToStringProcs.data));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___lineinfos_526((&(*dest).emittedTypeInfo.data));
	eqdestroy___ast_4327((&(*dest).packageSyms.data));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T5_;
		T5_ = (NIM_BOOL)0;
		T5_ = nimDecRefIsLast((*dest).deps.head);
		if (!T5_) goto LA6_;
		eqdestroy___pureZcollectionsZintsets_36((*dest).deps.head);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest).deps.head, ((NI)8));
	}
	LA6_: ;
	eqdestroy___pureZcollectionsZintsets_56((&(*dest).deps.data));
	eqdestroy___modulegraphs_8991((&(*dest).importDeps.data));
	eqdestroy___modulegraphs_9139((&(*dest).inclToMod.data));
	eqdestroy___icZic_10479((&(*dest).importStack));
	{
		NIM_BOOL T10_;
		T10_ = (NIM_BOOL)0;
		T10_ = nimDecRefIsLastCyclicDyn((*dest).backend);
		if (!T10_) goto LA11_;
	...
	LA11_: ;
	{
		NIM_BOOL T15_;
		T15_ = (NIM_BOOL)0;
		T15_ = nimDecRefIsLast((*dest).config);
		if (!T15_) goto LA16_;
	...
	LA16_: ;
	{
		NIM_BOOL T20_;
		T20_ = (NIM_BOOL)0;
		T20_ = nimDecRefIsLastCyclicStatic((*dest).cache, (&NTIv2__4yiDOEx3Y9aOTV1fsziBtCQ_));
		if (!T20_) goto LA21_;
	...
	LA21_: ;
	{
		NIM_BOOL T25_;
		T25_ = (NIM_BOOL)0;
		T25_ = nimDecRefIsLastCyclicDyn((*dest).vm);
		if (!T25_) goto LA26_;
	...
	LA26_: ;
	{
		NIM_BOOL T30_;
		T30_ = (NIM_BOOL)0;
		T30_ = nimDecRefIsLastCyclicDyn((*dest).doStopCompile.ClE_0);
		if (!T30_) goto LA31_;
	...
	LA31_: ;
	{
		NIM_BOOL T35_;
		T35_ = (NIM_BOOL)0;
		T35_ = nimDecRefIsLast((*dest).usageSym);
		if (!T35_) goto LA36_;
		nimDestroyAndDispose((*dest).usageSym);
	}
	LA36_: ;
	eqdestroy___ast_4327((&(*dest).owners));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___modulegraphs_9436((&(*dest).suggestSymbols.data));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___modulegraphs_9768((&(*dest).suggestErrors.data));
	eqdestroy___modulegraphs_10802((&(*dest).methods));
	{
		NIM_BOOL T40_;
		T40_ = (NIM_BOOL)0;
		T40_ = nimDecRefIsLast((*dest).systemModule);
		if (!T40_) goto LA41_;
	...
	colontmp__2 = ((NI)0);
	{
		while (1) {
			if (!(colontmp__2 < ((NI)65))) goto LA44			;
			{
				NIM_BOOL T47_;
				T47_ = (NIM_BOOL)0;
				T47_ = nimDecRefIsLast((*dest).sysTypes[(colontmp__2)- 0]);
				if (!T47_) goto LA48_;
	...
	eqdestroy___ast_4327((&(*dest).compilerprocs.data));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___ast_4327((&(*dest).exposed.data));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___ast_4327((&(*dest).packageTypes.data));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T52_;
		T52_ = (NIM_BOOL)0;
		T52_ = nimDecRefIsLast((*dest).emptyNode);
		if (!T52_) goto LA53_;
	...
	LA53_: ;
	eqdestroy___modulegraphs_10487((&(*dest).canonTypes.data));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___modulegraphs_10627((&(*dest).symBodyHashes.data));
	eqdestroy___modulegraphs_9934((&(*dest).cacheSeqs.data));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___modulegraphs_10094((&(*dest).cacheCounters.data));
	eqdestroy___modulegraphs_10328((&(*dest).cacheTables.data));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___modulegraphs_11108((&(*dest).passes));
	eqdestroy___ast_3723((&(*dest).globalDestructors));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T57_;
		T57_ = (NIM_BOOL)0;
		T57_ = nimDecRefIsLastCyclicStatic((*dest).idgen, (&NTIv2__C1k2TcDRT9cU4DEatQIT09ag_));
		if (!T57_) goto LA58_;
	...
	LA58_: ;
	{
		NIM_BOOL T62_;
		T62_ = (NIM_BOOL)0;
		T62_ = nimDecRefIsLast((*dest).operators.opNot);
		if (!T62_) goto LA63_;
	...
	LA63_: ;
	{
		NIM_BOOL T67_;
		T67_ = (NIM_BOOL)0;
		T67_ = nimDecRefIsLast((*dest).operators.opContains);
		if (!T67_) goto LA68_;
	...
	LA68_: ;
	{
		NIM_BOOL T72_;
		T72_ = (NIM_BOOL)0;
		T72_ = nimDecRefIsLast((*dest).operators.opLe);
		if (!T72_) goto LA73_;
	...
	LA73_: ;
	{
		NIM_BOOL T77_;
		T77_ = (NIM_BOOL)0;
		T77_ = nimDecRefIsLast((*dest).operators.opLt);
		if (!T77_) goto LA78_;
	...
	LA78_: ;
	{
		NIM_BOOL T82_;
		T82_ = (NIM_BOOL)0;
		T82_ = nimDecRefIsLast((*dest).operators.opAnd);
		if (!T82_) goto LA83_;
	...
	LA83_: ;
	{
		NIM_BOOL T87_;
		T87_ = (NIM_BOOL)0;
		T87_ = nimDecRefIsLast((*dest).operators.opOr);
		if (!T87_) goto LA88_;
	...
	LA88_: ;
	{
		NIM_BOOL T92_;
		T92_ = (NIM_BOOL)0;
		T92_ = nimDecRefIsLast((*dest).operators.opIsNil);
		if (!T92_) goto LA93_;
	...
	LA93_: ;
	{
		NIM_BOOL T97_;
		T97_ = (NIM_BOOL)0;
		T97_ = nimDecRefIsLast((*dest).operators.opEq);
		if (!T97_) goto LA98_;
	...
	LA98_: ;
	{
		NIM_BOOL T102_;
		T102_ = (NIM_BOOL)0;
		T102_ = nimDecRefIsLast((*dest).operators.opAdd);
	...
	LA103_: ;
	{
		NIM_BOOL T107_;
		T107_ = (NIM_BOOL)0;
		T107_ = nimDecRefIsLast((*dest).operators.opSub);
	...
	LA108_: ;
	{
		NIM_BOOL T112_;
		T112_ = (NIM_BOOL)0;
		T112_ = nimDecRefIsLast((*dest).operators.opMul);
	...
	LA113_: ;
	{
		NIM_BOOL T117_;
		T117_ = (NIM_BOOL)0;
		T117_ = nimDecRefIsLast((*dest).operators.opDiv);
	...
	LA118_: ;
	{
		NIM_BOOL T122_;
		T122_ = (NIM_BOOL)0;
		T122_ = nimDecRefIsLast((*dest).operators.opLen);
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (!T3_) goto LA4_;
		eqdestroy___modulegraphs_11047((*dest));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	colontmpD_ = NIM_NIL;
	colontmpD_ = getIdent__idents_166((*g).cache, name);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	result = createMagic__modulegraphs_8540(g, (*g).idgen, name, m);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	T1_ = NIM_NIL;
	T1_ = createMagic__modulegraphs_8546(g, TM__mff0c158N4EFFNgrs4pcEQ_3, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)71));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___ast_4066(&(*Result).opLe, T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T2_ = NIM_NIL;
	T2_ = createMagic__modulegraphs_8546(g, TM__mff0c158N4EFFNgrs4pcEQ_5, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)72));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___ast_4066(&(*Result).opLt, T2_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T3_ = NIM_NIL;
	T3_ = createMagic__modulegraphs_8546(g, TM__mff0c158N4EFFNgrs4pcEQ_7, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)109));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___ast_4066(&(*Result).opAnd, T3_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T4_ = NIM_NIL;
	T4_ = createMagic__modulegraphs_8546(g, TM__mff0c158N4EFFNgrs4pcEQ_9, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)110));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___ast_4066(&(*Result).opOr, T4_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T5_ = NIM_NIL;
	T5_ = createMagic__modulegraphs_8546(g, TM__mff0c158N4EFFNgrs4pcEQ_11, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)143));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___ast_4066(&(*Result).opIsNil, T5_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T6_ = NIM_NIL;
	T6_ = createMagic__modulegraphs_8546(g, TM__mff0c158N4EFFNgrs4pcEQ_13, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)70));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___ast_4066(&(*Result).opEq, T6_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T7_ = NIM_NIL;
	T7_ = createMagic__modulegraphs_8546(g, TM__mff0c158N4EFFNgrs4pcEQ_15, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)46));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___ast_4066(&(*Result).opAdd, T7_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T8_ = NIM_NIL;
	T8_ = createMagic__modulegraphs_8546(g, TM__mff0c158N4EFFNgrs4pcEQ_17, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)47));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___ast_4066(&(*Result).opSub, T8_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T9_ = NIM_NIL;
	T9_ = createMagic__modulegraphs_8546(g, TM__mff0c158N4EFFNgrs4pcEQ_19, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)48));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___ast_4066(&(*Result).opMul, T9_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T10_ = NIM_NIL;
	T10_ = createMagic__modulegraphs_8546(g, TM__mff0c158N4EFFNgrs4pcEQ_21, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)49));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___ast_4066(&(*Result).opDiv, T10_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T11_ = NIM_NIL;
	T11_ = createMagic__modulegraphs_8546(g, TM__mff0c158N4EFFNgrs4pcEQ_23, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)39));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___ast_4066(&(*Result).opLen, T11_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T12_ = NIM_NIL;
	T12_ = createMagic__modulegraphs_8546(g, TM__mff0c158N4EFFNgrs4pcEQ_25, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)96));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___ast_4066(&(*Result).opNot, T12_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T13_ = NIM_NIL;
	T13_ = createMagic__modulegraphs_8546(g, TM__mff0c158N4EFFNgrs4pcEQ_27, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)134));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	(*T1_).symId = ((NI32)0);
	(*T1_).typeId_0 = ((NI32)0);
	eqsink___ast_3251(&(*result).idgen, T1_);
	initStrTable__ast_5184((&(*result).packageSyms));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	nimZeroMem((void*)(&T2_), sizeof(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA));
	initIntSet__pureZcollectionsZintsets_389((&T2_));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___pureZcollectionsZintsets_187((&(*result).deps), (&T2_));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T3_ = initTable__modulegraphs_8861(((NI)32));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___modulegraphs_10663((&(*result).importDeps), T3_);
	...
	eqsink___modulegraphs_10676((&(*result).ifaces), T4_);
	...
	eqsink___icZic_10485((&(*result).importStack), T5_);
	T6_ = initTable__modulegraphs_9026(((NI)32));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___modulegraphs_10746((&(*result).inclToMod), T6_);
	...
	eqsink___ast_4333((&(*result).owners), T7_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T8_ = initTable__modulegraphs_9169(((NI)32));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___modulegraphs_10782((&(*result).suggestSymbols), T8_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T9_ = initTable__modulegraphs_9464(((NI)32));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___modulegraphs_10795((&(*result).suggestErrors), T9_);
	...
	eqsink___modulegraphs_10808((&(*result).methods), T10_);
	initStrTable__ast_5184((&(*result).compilerprocs));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	initStrTable__ast_5184((&(*result).exposed));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	initStrTable__ast_5184((&(*result).packageTypes));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T11_ = NIM_NIL;
	T11_ = newNode__ast_3934(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___ast_3460(&(*result).emptyNode, T11_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T12_ = initTable__modulegraphs_9800(((NI)32));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___modulegraphs_10972((&(*result).cacheSeqs), T12_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T13_ = initTable__modulegraphs_9964(((NI)32));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___modulegraphs_10985((&(*result).cacheCounters), T13_);
	T14_ = initTable__modulegraphs_10123(((NI)32));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___modulegraphs_10998((&(*result).cacheTables), T14_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T15_ = initTable__modulegraphs_10358(((NI)32));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___modulegraphs_11011((&(*result).canonTypes), T15_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T16_ = initTable__modulegraphs_10514(((NI)32));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___modulegraphs_11024((&(*result).symBodyHashes), T16_);
	nimZeroMem((void*)(&T17_), sizeof(tyObject_Operators__Ai9aW8j1mouo4Nz9bP29c2c5w));
	initOperators__modulegraphs_8856(result, (&T17_));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___modulegraphs_11037((&(*result).operators), (&T17_));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T18_ = initTable__lineinfos_396(((NI)32));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___lineinfos_2031((&(*result).emittedTypeInfo), T18_);
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	...
	result = T1_;
	eqcopy___options_3378(&(*result).config, config);
...
{nimErr_ = nimErrorFlag();
	{
		...
		T5_ = (NI)0;
		T5_ = dependsOn__modulegraphs_11421((*m).position, ((NI) (dep)));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		incl__pureZcollectionsZintsets_202((&(*g).deps), T5_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	T1_ = (NIM_BOOL)0;
	T1_ = hasKeyOrPut__modulegraphs_11470((&(*g).inclToMod), includeFile, module);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(void)(T1_);
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		if (!(((NI32)0) <= fileIdx)) goto LA3_;
		{
			NIM_BOOL T7_;
			T7_ = (NIM_BOOL)0;
			T7_ = isCachedModule__modulegraphs_2868(g, ((NI) (fileIdx)));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!T7_) goto LA8_;
			eqcopy___ast_4063(&result, (*g).packed_0.p->data[fileIdx].module);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA5_;
		LA8_: ;
		{
			...
			eqcopy___ast_4063(&result, (*g).ifaces.p->data[fileIdx].module);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA5_;
		LA12_: ;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		if (!((*(*g).config).symbolFiles == ((tyEnum_SymbolFilesOption__9b9bfTFCONAgeN19bdppgkkHQ)2) || (*(*g).config).symbolFiles == ((tyEnum_SymbolFilesOption__9b9bfTFCONAgeN19bdppgkkHQ)3) || (*(*g).config).symbolFiles == ((tyEnum_SymbolFilesOption__9b9bfTFCONAgeN19bdppgkkHQ)4))) goto LA3_;
		result = moduleFromRodFile__icZic_10430((&(*g).packed_0), (*g).config, (*g).cache, fileIdx, cachedModules);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	pkgSym = NIM_NIL;
	pkgSym = getPackage__packages_8((*graph).config, (*graph).cache, fileIdx);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = strTableGet__astalgo_3544((*graph).packageSyms, (*pkgSym).name);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		if (!(result == ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL))) goto LA4_;
		eqcopy___ast_4063(&result, pkgSym);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		strTableAdd__astalgo_3484((&(*graph).packageSyms), pkgSym);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA4_: ;
	{
...
{nimErr_ = nimErrorFlag();
	...
	if ((*dest).converters.p != (*src).converters.p) {	eqdestroy___modulegraphs_8619((&(*dest).converters));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
(*dest).converters.len = (*src).converters.len; (*dest).converters.p = (*src).converters.p;
	if ((*dest).patterns.p != (*src).patterns.p) {	eqdestroy___modulegraphs_8619((&(*dest).patterns));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
(*dest).patterns.len = (*src).patterns.len; (*dest).patterns.p = (*src).patterns.p;
	if ((*dest).pureEnums.p != (*src).pureEnums.p) {	eqdestroy___modulegraphs_8619((&(*dest).pureEnums));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
(*dest).pureEnums.len = (*src).pureEnums.len; (*dest).pureEnums.p = (*src).pureEnums.p;
	(*dest).interf.counter = (*src).interf.counter;
	if ((*dest).interf.data.p != (*src).interf.data.p) {	eqdestroy___ast_4327((&(*dest).interf.data));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
(*dest).interf.data.len = (*src).interf.data.len; (*dest).interf.data.p = (*src).interf.data.p;
	...
	if ((*dest).interfHidden.data.p != (*src).interfHidden.data.p) {	eqdestroy___ast_4327((&(*dest).interfHidden.data));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
(*dest).interfHidden.data.len = (*src).interfHidden.data.len; (*dest).interfHidden.data.p = (*src).interfHidden.data.p;
	if ((*dest).uniqueName.p != (*src).uniqueName.p) {	eqdestroy___stdZassertions_13((&(*dest).uniqueName));
	}
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	initStrTable__ast_5184((&(*g).ifaces.p->data[(*m).position].interf));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	initStrTable__ast_5184((&(*g).ifaces.p->data[(*m).position].interfHidden));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, registerModule__modulegraphs_8551)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* m) {
...
{nimErr_ = nimErrorFlag();
	colontmpD_ = NIM_NIL;
	{
		...
		setLen__modulegraphs_8572((&(*g).ifaces), ((NI) ((NI)((*m).position + ((NI)1)))));
	}
	LA4_: ;
	{
		NI T8_;
		...
		setLen__icZic_10170((&(*g).packed_0), ((NI) ((NI)((*m).position + ((NI)1)))));
	}
	LA9_: ;
	...
	T11_.uniqueName = uniqueModuleName__msgs_1578((*g).config, ((NI32) ((*m).position)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___modulegraphs_8613((&(*g).ifaces.p->data[(*m).position]), (&T11_));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	initStrTables__modulegraphs_2861(g, m);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		path = toFilenameOption__msgs_629(conf, fileIdx, (*conf).filenameOption);
		if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
		T9_ = (*graph).importStack.len;
		indent = nsuRepeatStr(TM__mff0c158N4EFFNgrs4pcEQ_31, ((NI) (T9_)));
		if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
		T10_.len = 0; T10_.p = NIM_NIL;
		{
			if (!!((fromModule == ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL)))) goto LA13_;
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___passes_125)(tyObject_TPassContext__9aUzdnrOgAbujYuO39brF9bbA** dest, tyObject_TPassContext__9aUzdnrOgAbujYuO39brF9bbA* src) {
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	colontmpD_ = NIM_NIL;
	colontmpD_ = getPackageSymbol__packages_18(sym);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = (NI)0;
	T1_ = getPackageId__packages_67(colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T2_ = (NI)0;
	T2_ = getPackageId__packages_67((*graph).systemModule);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = (T1_ == T2_);
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	simulateLoadedModule__icZic_10630((&(*g).packed_0), (*g).config, (*g).cache, moduleSym, m);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	{
		...
		NI mint;
		NimStringV2 T6_;
		if (!((*(*g).config).symbolFiles == ((tyEnum_SymbolFilesOption__9b9bfTFCONAgeN19bdppgkkHQ)2) || (*(*g).config).symbolFiles == ((tyEnum_SymbolFilesOption__9b9bfTFCONAgeN19bdppgkkHQ)3))) goto LA3_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
		mint = (*m).position;
		colontmpD_ = toFullPath__msgs_577((*g).config, ((NI32) (mint)));
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		colontmpD__2 = toRodFile__icZic_4270((*g).config, colontmpD_, TM__mff0c158N4EFFNgrs4pcEQ_41);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		T6_.len = 0; T6_.p = NIM_NIL;
		T6_ = colontmpD__2;
		saveRodFile__icZic_6185(T6_, (&(*g).encoders.p->data[mint]), (&(*g).packed_0.p->data[mint].fromDisk));
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		(*g).packed_0.p->data[mint].status = ((tyEnum_ModuleStatus__QEyqxRJg9cMLyoEGTCNwluA)5);
		{
			LA5_:;
		}
		{
	...
	{
		NI mint_2;
		if (!((*(*g).config).symbolFiles == ((tyEnum_SymbolFilesOption__9b9bfTFCONAgeN19bdppgkkHQ)4))) goto LA10_;
		mint_2 = (*m).position;
		simulateCachedModule__modulegraphs_2884(g, m, (&(*g).packed_0.p->data[mint_2].fromDisk));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(*g).packed_0.p->data[mint_2].status = ((tyEnum_ModuleStatus__QEyqxRJg9cMLyoEGTCNwluA)3);
	}
	goto LA1_;
	LA10_: ;
	LA1_: ;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	registerModule__modulegraphs_8551(g, (*g).packed_0.p->data[m].module);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	if ((*dest).p != src.p) {	eqdestroy___modulegraphs_712(dest);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___modulegraphs_715)(tySequence__rbrgPpeV9be6C3GwbBbkmpA* dest, tySequence__rbrgPpeV9be6C3GwbBbkmpA src) {
	...
	NI colontmp_;
	T1_ = src.len;
	setLen__modulegraphs_729((&(*dest)), T1_);
	colontmp_ = ((NI)0);
	{
		while (1) {
			NI T4_;
			...
			{
				if (!src.p->data[colontmp_].typ) goto LA7_;
			...
			LA7_: ;
			{
				NIM_BOOL T11_;
				T11_ = (NIM_BOOL)0;
				T11_ = nimDecRefIsLast((*dest).p->data[colontmp_].typ);
				if (!T11_) goto LA12_;
				nimDestroyAndDispose((*dest).p->data[colontmp_].typ);
			}
			LA12_: ;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	if ((*dest).p != src.p) {	eqdestroy___modulegraphs_1285(dest);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
(*dest).len = src.len; (*dest).p = src.p;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	if ((*dest).concreteTypes.p != (*src).concreteTypes.p) {	eqdestroy___modulegraphs_1299((&(*dest).concreteTypes));
	}
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___modulegraphs_1302)(tySequence__29btfq9cDuCZmHsAEmuBeMOg* dest, tySequence__29btfq9cDuCZmHsAEmuBeMOg src) {
	...
	NI colontmp_;
	T1_ = src.len;
	setLen__modulegraphs_1315((&(*dest)), T1_);
	colontmp_ = ((NI)0);
	{
		while (1) {
			NI T4_;
...
{nimErr_ = nimErrorFlag();
	T1_ = src.len;
	setLen__modulegraphs_1437((&(*dest)), T1_);
	colontmp_ = ((NI)0);
	{
		while (1) {
			NI T4_;
			...
			eqcopy___modulegraphs_1302((&(*dest).p->data[colontmp_].concreteTypes), src.p->data[colontmp_].concreteTypes);
			colontmp__2 = (*dest).p->data[colontmp_].inst;
			{
				if (!src.p->data[colontmp_].inst) goto LA7_;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	if ((*dest).p != src.p) {	eqdestroy___modulegraphs_2543(dest);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
(*dest).len = src.len; (*dest).p = src.p;
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___modulegraphs_2546)(tySequence__KBDwsdF2UrZmqdc6bU9bHbA* dest, tySequence__KBDwsdF2UrZmqdc6bU9bHbA src) {
	...
	NI colontmp_;
	T1_ = src.len;
	setLen__modulegraphs_2560((&(*dest)), T1_);
	colontmp_ = ((NI)0);
	{
		while (1) {
			NI T4_;
			...
			{
				if (!src.p->data[colontmp_].Field1.sym) goto LA7_;
			...
			LA7_: ;
			{
				NIM_BOOL T11_;
				T11_ = (NIM_BOOL)0;
				T11_ = nimDecRefIsLast((*dest).p->data[colontmp_].Field1.sym);
				if (!T11_) goto LA12_;
				nimDestroyAndDispose((*dest).p->data[colontmp_].Field1.sym);
			}
			LA12_: ;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	importHidden = (((*m).options &((NU32)1<<((NU)((((tyEnum_TOption__PrH9cMsvu5oCG0HODAZ3CAg)27)))&31U)))!=0);
	{
		NIM_BOOL T3_;
		...
		T3_ = (NIM_BOOL)0;
		T3_ = isCachedModule__modulegraphs_2880(g, m);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		T6_ = NIM_NIL;
		T6_ = (*g).config;
		T7_ = NIM_NIL;
		T7_ = (*g).cache;
		result = interfaceSymbol__icZic_11250(T6_, T7_, (&(*g).packed_0), ((NI32) ((*m).position)), name, importHidden);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA1_;
	LA4_: ;
	{
		...
		LA11_: ;
		result = strTableGet__astalgo_3544((*retX60gensym21_), name);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA1_: ;
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*, systemModuleSym__modulegraphs_3149)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyObject_TIdent__L29bfCasnfXpB7u88iPkwMA* name) {
	tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* result;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	result = someSym__modulegraphs_3137(g, (*g).systemModule, name);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T6_ = (*g).cache;
		T7_ = NIM_NIL;
		T7_ = loadSymFromId__icZic_10572(T5_, T6_, (&(*g).packed_0), (*t).id.module, (*t).id.packed_0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqsink___ast_4066(&result, T7_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqcopy___ast_4063(&(*t).sym, result);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		T3_ = (NIM_BOOL)0;
		T3_ = contains__modulegraphs_4639((*g).attachedOps[(op)- 0], (*t).Sup.itemId);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		T6_ = NIM_NIL;
		T6_ = g;
		T7_ = (tyObject_LazySym__Ryd9aJ9bcLvoLBu56Qo9bzm9aw*)0;
		T7_ = X5BX5D___modulegraphs_5088((&(*g).attachedOps[(op)- 0]), (*t).Sup.itemId);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	nimZeroMem((void*)(&T1_), sizeof(tyObject_LazySym__Ryd9aJ9bcLvoLBu56Qo9bzm9aw));
	colontmpD_ = 0;
	eqcopy___ast_4063(&colontmpD_, value);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_.sym = colontmpD_;
	X5BX5Deq___modulegraphs_5216((&(*g).attachedOps[(op)- 0]), (*t).Sup.itemId, T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isDirty__modulegraphs_14726)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* m) {
	...
	T1_ = (*g).suggestMode;
	if (!(T1_)) goto LA2_;
	T1_ = (((*m).flags &((NU64)1<<((NU)((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)11)))&63U)))!=0);
	LA2_: ;
	result = T1_;
	return result;
}
								...
								i_4 = ((NI)0);
								{
									while (1) {
										...
										j = i_4;
										{
											...
											if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
											T15_ = (NIM_BOOL)0;
											T15_ = contains__astalgo_3655((&(*g)), T14_);
											if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
											T12_ = !(T15_);
											LA13_: ;
											if (!T12_) goto LA16_;
											{
												...
												if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
												T20_ = contains__astalgo_3655((&(*g)), T21_);
												if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
												if (!(T20_)) goto LA22_;
												T23_ = (NI)0;
												T23_ = dependsOn__modulegraphs_11421(k, j);
												if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
												T20_ = contains__astalgo_3655((&(*g)), T23_);
												if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
												LA22_: ;
												if (!T20_) goto LA24_;
												T26_ = (NI)0;
												...
												if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
												incl__pureZcollectionsZintsets_202(g, T26_);
												if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
											}
											LA24_: ;
										}
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	if ((*dest).p != src.p) {	eqdestroy___modulegraphs_9274(dest);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
(*dest).len = src.len; (*dest).p = src.p;
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___modulegraphs_9575)(tySequence__tffJ9cMZMd9ar9a5FqFq6EJ9bA* dest, tySequence__tffJ9cMZMd9ar9a5FqFq6EJ9bA src) {
	if ((*dest).p != src.p) {	eqdestroy___modulegraphs_9569(dest);
	}
(*dest).len = src.len; (*dest).p = src.p;
}
N_LIB_PRIVATE N_NIMCALL(void, markDirty__modulegraphs_13127)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, NI32 fileIdx) {
...
{nimErr_ = nimErrorFlag();
	m = NIM_NIL;
	m = getModule__modulegraphs_11350(g, fileIdx);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!!((m == ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL)))) goto LA3_;
		del__modulegraphs_13175((&(*g).suggestSymbols), fileIdx);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		del__modulegraphs_13961((&(*g).suggestErrors), fileIdx);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	{
		...
		T5_ = (*g).ifaces.len;
		transitiveClosure__modulegraphs_12931((&(*g).deps), T5_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	{
		...
		res = ((NI32)0);
		{
			while (1) {
				...
				i = res;
				{
					...
					NIM_BOOL T13_;
					T12_ = (NI)0;
					T12_ = dependsOn__modulegraphs_11421(((NI) (i)), ((NI) (fileIdx)));
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					T13_ = (NIM_BOOL)0;
					T13_ = contains__astalgo_3655((&(*g).deps), T12_);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					if (!T13_) goto LA14_;
					markDirty__modulegraphs_13127(g, i);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				}
				LA14_: ;
				res += ((NI)1);
...
{nimErr_ = nimErrorFlag();
	id = (*module).position;
	{
		...
		T3_ = (*g).encoders.len;
		if (!(T3_ <= id)) goto LA4_;
		setLen__modulegraphs_2896((&(*g).encoders), ((NI) ((NI)(id + ((NI)1)))));
	}
	LA4_: ;
	initEncoder__icZic_2514((&(*g).encoders.p->data[id]), (&(*g).packed_0.p->data[id].fromDisk), module, (*g).config, (*g).startupPackedConfig);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*, resolveType__modulegraphs_3194)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyObject_LazyType__SN9c3fsi9b9ajltls5ZKIUiTA* t) {
	tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* result;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	eqcopy___ast_3546(&result, (*t).typ);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T3_;
		...
		if (!(T3_)) goto LA4_;
		T3_ = isCachedModule__modulegraphs_2868(g, (*t).id.module);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		LA4_: ;
		if (!T3_) goto LA5_;
		T7_ = NIM_NIL;
		...
		T8_ = (*g).cache;
		T9_ = NIM_NIL;
		T9_ = loadTypeFromId__icZic_10557(T7_, T8_, (&(*g).packed_0), (*t).id.module, (*t).id.packed_0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqsink___ast_3549(&result, T9_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqcopy___ast_3546(&(*t).typ, result);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA5_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T8_ = (*g).cache;
		T9_ = NIM_NIL;
		T9_ = loadSymFromId__icZic_10572(T7_, T8_, (&(*g).packed_0), (*t).id.module, (*t).id.packed_0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	T1_ = (NIM_BOOL)0;
	T1_ = isCachedModule__modulegraphs_2868(g, (*mi).modIndex);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*mi).fromRod = T1_;
	(*mi).importHidden = (((*m).options &((NU32)1<<((NU)((((tyEnum_TOption__PrH9cMsvu5oCG0HODAZ3CAg)27)))&31U)))!=0);
	{
		tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* T6_;
		tyObject_IdentCachecolonObjectType___4yiDOEx3Y9aOTV1fsziBtCQ* T7_;
		...
		T7_ = NIM_NIL;
		T7_ = (*g).cache;
		result = initRodIter__icZic_10660((&(*mi).rodIt), T6_, T7_, (&(*g).packed_0), ((NI32) ((*mi).modIndex)), name, (*mi).importHidden);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA2_;
	LA4_: ;
	{
		...
		LA11_: ;
		result = initIdentIter__astalgo_3586((&(*mi).ti), (*retX60gensym12_), name);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA2_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		result = nextRodIter__icZic_11144((&(*mi).rodIt), (&(*g).packed_0));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA1_;
	LA3_: ;
	{
		...
		LA8_: ;
		result = nextIdentIter__astalgo_3562((&(*mi).ti), (*retX60gensym13_));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA1_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (!T3_) goto LA4_;
		eqdestroy___idents_145((*dest).ti.name);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA4_: ;
	{
		...
		if (!T8_) goto LA9_;
		eqdestroy___options_3149((*dest).rodIt.decoder.config);
	...
	LA9_: ;
	{
		NIM_BOOL T13_;
		T13_ = (NIM_BOOL)0;
		T13_ = nimDecRefIsLastCyclicStatic((*dest).rodIt.decoder.cache, (&NTIv2__4yiDOEx3Y9aOTV1fsziBtCQ_));
		if (!T13_) goto LA14_;
		eqdestroy___idents_224((*dest).rodIt.decoder.cache);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest).rodIt.decoder.cache, ((NI)8));
	}
	LA14_: ;
	eqdestroy___icZic_3400((&(*dest).rodIt.values));
	}BeforeRet_: ;
}
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	strTableAdd__astalgo_3484((&(*g).ifaces.p->data[(*m).position].interf), s);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	strTableAdd__astalgo_3484((&(*g).ifaces.p->data[(*m).position].interfHidden), s);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
static N_INLINE(void, nimCopyMem)(void* dest, void* source, NI size) {
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = toBase64a__modulegraphs_2773(((NCSTRING) (u)), ((NI)16));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*, loadCompilerProc__modulegraphs_8402)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, NimStringV2 name) {
	tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* result;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	...
	LA3_: ;
	{
		...
		res = ((NI)0);
		{
			while (1) {
				...
				module = res;
				x = searchForCompilerproc__icZic_11342((&(*g).packed_0.p->data[module]), name);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				{
					...
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					T16_ = NIM_NIL;
					T16_ = loadSymFromId__icZic_10572(T13_, T14_, (&(*g).packed_0), module, T15_);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					eqsink___ast_4066(&result, T16_);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					{
						if (!!((result == ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL)))) goto LA19_;
						strTableAdd__astalgo_3484((&(*g).compilerprocs), result);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					}
					LA19_: ;
					goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, eqeq___modulegraphs_8488)(tyArray__qtqsWM5aXmcpMIVmvq3kAA a, tyArray__qtqsWM5aXmcpMIVmvq3kAA b) {
	NIM_BOOL result;
	result = (NIM_BOOL)0;
	result = equalMem__system_1727(((void*) (a)), ((void*) (b)), ((NI)16));
	return result;
}
...
{nimErr_ = nimErrorFlag();
	{
		if (!!(((*(*g).config).symbolFiles == ((tyEnum_SymbolFilesOption__9b9bfTFCONAgeN19bdppgkkHQ)0)))) goto LA3_;
		toPackedGeneratedProcDef__icZic_4018(value, (&(*g).encoders.p->data[module]), (&(*g).packed_0.p->data[module].fromDisk));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TInstantiation__8SLhhTGRSJj9a3g5KOHqwdQ*, resolveInst__modulegraphs_3224)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyObject_LazyInstantiation__9a6qqvxx8ZzdJrEGrAFijCA* t) {
	tyObject_TInstantiation__8SLhhTGRSJj9a3g5KOHqwdQ* result;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	eqcopy___modulegraphs_3273(&result, (*t).inst, NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T3_;
		...
		if (!(T3_)) goto LA4_;
		T3_ = isCachedModule__modulegraphs_2868(g, (*t).module);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		LA4_: ;
		if (!T3_) goto LA5_;
		T7_ = NIM_NIL;
		...
		T9_ = NIM_NIL;
		T9_ = (*g).cache;
		(*T7_).sym = loadSymFromId__icZic_10572(T8_, T9_, (&(*g).packed_0), (*t).sym.module, (*t).sym.packed_0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqsink___modulegraphs_3277(&result, T7_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T10_ = (*t).concreteTypes.len;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			res = ((NI)0);
			{
				while (1) {
					...
					T17_ = (*g).cache;
					T18_ = NIM_NIL;
					T18_ = loadTypeFromId__icZic_10557(T16_, T17_, (&(*g).packed_0), (*t).concreteTypes.p->data[i].module, (*t).concreteTypes.p->data[i].packed_0);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		eqcopy___modulegraphs_3273(&(*t).inst, result, NIM_TRUE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA5_: ;
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, addMethodToGeneric__modulegraphs_7173)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, NI module, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* t, NI col, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* m) {
	NI colontmpD_;
...
{nimErr_ = nimErrorFlag();
	...
	T2_ = mgetOrPut__modulegraphs_7209((&(*g).methodsPerType), (*t).Sup.itemId, T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	nimZeroMem((void*)(&T4_), sizeof(tyObject_LazySym__Ryd9aJ9bcLvoLBu56Qo9bzm9aw));
	colontmpD__2 = 0;
	eqcopy___ast_4063(&colontmpD__2, m);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, hasDisabledAsgn__modulegraphs_8359)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* t) {
	NIM_BOOL result;
	tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* op;
	NIM_BOOL T2_;
NIM_BOOL oldNimErrFin1_;
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	op = NIM_NIL;
	op = getAttachedOp__modulegraphs_4580(g, t, ((tyEnum_TTypeAttachedOp__ljjE0gT86OWTlfE9cOGtFgA)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_ = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(void, setToStringProc__modulegraphs_6489)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* t, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* value) {
	tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* colontmpD_;
	tyObject_LazySym__Ryd9aJ9bcLvoLBu56Qo9bzm9aw T1_;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_.sym = colontmpD_;
	X5BX5Deq___modulegraphs_5216((&(*g).enumToStringProcs), (*t).Sup.itemId, T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, loadPackedSym__modulegraphs_8466)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyObject_LazySym__Ryd9aJ9bcLvoLBu56Qo9bzm9aw* s) {
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	{
		tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* T5_;
		tyObject_IdentCachecolonObjectType___4yiDOEx3Y9aOTV1fsziBtCQ* T6_;
		tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* T7_;
		if (!((*s).sym == ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL))) goto LA3_;
		T5_ = NIM_NIL;
		T5_ = (*g).config;
		T6_ = NIM_NIL;
		T6_ = (*g).cache;
		T7_ = NIM_NIL;
		T7_ = loadSymFromId__icZic_10572(T5_, T6_, (&(*g).packed_0), (*s).id.module, (*s).id.packed_0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqsink___ast_4066(&(*s).sym, T7_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, rememberEmittedTypeInfo__modulegraphs_11369)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, NI32 m, NimStringV2 ti) {
	{
		...
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		eqcopy___stdZassertions_16((&colontmpD_), ti);
		add__stdZenumutils_69((&(*g).packed_0.p->data[m].fromDisk.emittedTypeInfo), colontmpD_);
	}
	LA3_: ;
}
...
{nimErr_ = nimErrorFlag();
	...
	T2_ = X5BX5D___modulegraphs_5088((&(*g).enumToStringProcs), (*t).Sup.itemId);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	initStrTable__ast_5184((&(*g).compilerprocs));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	clear__modulegraphs_315((&(*g).typeInstCache));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	clear__modulegraphs_889((&(*g).procInstCache));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
	...
	clear__modulegraphs_2147((&(*g).methodsPerType));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	clear__modulegraphs_1699((&(*g).enumToStringProcs));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
