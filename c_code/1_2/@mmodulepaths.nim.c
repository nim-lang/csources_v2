...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)22):
	{
		...
		T4_ = toFullPath__msgs_577(conf__1wFx1nxHoIUnNPJUblx19bA, (*n__XjmJ9ck5w8XBdsBZTsuVprw).info.fileIndex);
...
appendString((&T12_), (*n__XjmJ9ck5w8XBdsBZTsuVprw)._kind_3.strVal);
				colontmpD__2 = T12_;
				liMessage__msgs_1159(conf__1wFx1nxHoIUnNPJUblx19bA, (*n__XjmJ9ck5w8XBdsBZTsuVprw).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__GNhKqIyvrFjtq6zf1JX7qg_16), NIM_FALSE);
...
appendString((&result), modname);
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)45):
	{
		...
		liMessage__msgs_1159(conf__1wFx1nxHoIUnNPJUblx19bA, (*n__XjmJ9ck5w8XBdsBZTsuVprw).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)23), TM__GNhKqIyvrFjtq6zf1JX7qg_25, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__GNhKqIyvrFjtq6zf1JX7qg_26), NIM_FALSE);
	...
	default:
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA40_;
		colontmpD__7 = T43_;
		liMessage__msgs_1159(conf__1wFx1nxHoIUnNPJUblx19bA, (*n__XjmJ9ck5w8XBdsBZTsuVprw).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__7, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__GNhKqIyvrFjtq6zf1JX7qg_32), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA40_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD_ = toFullPath__msgs_577(conf__tamsf9axZpZRgHhpyPi7LHA, (*n__txnzfiFQ51y9aJIxt3SVtpQ).info.fileIndex);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
appendString((&T18_), m);
			colontmpD__2 = T18_;
			liMessage__msgs_1159(conf__tamsf9axZpZRgHhpyPi7LHA, (*n__txnzfiFQ51y9aJIxt3SVtpQ).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__GNhKqIyvrFjtq6zf1JX7qg_36), NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			{
				LA11_:;
			}
