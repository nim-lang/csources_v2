...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)22):
	{
		...
		T5_ = pathSubs__options_5069(conf, (*n)._kind_3.strVal, colontmpD_.Field0);
		if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
		result = T5_;
		{
			LA3_:;
		...
		if (NIM_UNLIKELY(*nimErr_)) {
			...
			if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3978211584)) {
				...
				*nimErr_ = NIM_FALSE;
				...
				T12_ = rawNewString((*n)._kind_3.strVal.len + 14);
...
appendString((&T12_), (*n)._kind_3.strVal);
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)29):
	{
		...
		T19_ = getModuleName__modulepaths_10(conf, (*n)._kind_6.sons.p->data[((NI)2)]);
		if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
		modname = T19_;
		T20_.len = 0; T20_.p = NIM_NIL;
		T20_ = getModuleName__modulepaths_10(conf, n1);
		if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
		result = T20_;
...
appendString((&result), modname);
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)30):
	{
		...
		T27_ = renderTree__renderer_50(n, 4);
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)45):
	{
		...
		T33_ = renderTree__renderer_50(n, 4);
		if (NIM_UNLIKELY(*nimErr_)) goto LA32_;
		colontmpD__6 = T33_;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)78):
	{
		...
		T38_ = getModuleName__modulepaths_10(conf, (*n)._kind_6.sons.p->data[((NI)0)]);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		result = T38_;
	}
	break;
	default:
	{
		...
		T42_ = renderTree__renderer_50(n, T41_);
