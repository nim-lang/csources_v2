...
struct tySequence__29btfq9cDuCZmHsAEmuBeMOg_Content { NI cap; tyObject_FullId__3oA6EHvzCx1KvUf9cxJRXXw data[SEQ_DECL_SIZE];};
      ...
      N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, includeModule__modules_1183)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* graph__S9ccRdPajxEBAH7QqhDCHBg, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s__WSZPyvmuf2F7qUdlMyXNaA, NI32 fileIdx__SIGrsyjmJfKPmshSFqdF7g);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*, importModule__modules_87)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* graph__T9cUxMVMgo2P5xZ5ZI9ahYUg, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s__4cetlEY7D5vthgcwyHeINA, NI32 fileIdx__9chU6psIEFR9bW74RzW4xqRA);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*, newModule__modules_29)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* graph__uNAkReq0oHr9bUMZ0apLbBg, NI32 fileIdx__oD3hFRf4EApOxM9cASvyDnA);
...
N_LIB_PRIVATE N_NIMCALL(void, partialInitModule__modules_23)(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* result__2Ahev2oXbWkjH1Lb4nZOFg, tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* graph__RZX0liCgOf9a2TqmnM9bx4FQ, NI32 fileIdx__F6G64SYslJr3Ym6TkT0k6w, NimStringV2 filename__xxbrCWokwfMslpUaTnKSWQ);
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	result = parseFile__syntaxes_227(fileIdx__SIGrsyjmJfKPmshSFqdF7g, (*graph__S9ccRdPajxEBAH7QqhDCHBg).cache, (*graph__S9ccRdPajxEBAH7QqhDCHBg).config);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	addDep__modulegraphs_11429(graph__S9ccRdPajxEBAH7QqhDCHBg, s__WSZPyvmuf2F7qUdlMyXNaA, fileIdx__SIGrsyjmJfKPmshSFqdF7g);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	addIncludeDep__modulegraphs_11440(graph__S9ccRdPajxEBAH7QqhDCHBg, ((NI32) ((*s__WSZPyvmuf2F7qUdlMyXNaA).position)), fileIdx__SIGrsyjmJfKPmshSFqdF7g);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	packSym = NIM_NIL;
	packSym = getPackage__modulegraphs_14978(graph__RZX0liCgOf9a2TqmnM9bx4FQ, fileIdx__F6G64SYslJr3Ym6TkT0k6w);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqsink___ast_4066(&(*result__2Ahev2oXbWkjH1Lb4nZOFg).owner, packSym);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	packSym = 0;
	(*result__2Ahev2oXbWkjH1Lb4nZOFg).position = ((NI) (fileIdx__F6G64SYslJr3Ym6TkT0k6w));
	{
		LA1_:;
	}
	{
...
{nimErr_ = nimErrorFlag();
	...
	filename = toFullPath__msgs_587((*graph__uNAkReq0oHr9bUMZ0apLbBg).config, fileIdx__oD3hFRf4EApOxM9cASvyDnA);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_ = NIM_NIL;
	...
	colontmpD_ = fileIdx__oD3hFRf4EApOxM9cASvyDnA;
	(*T2_).Sup.itemId.module = colontmpD_;
	(*T2_).Sup.itemId.item = ((NI32)0);
	splitFile__pathutils_31(filename, (&colontmpD__2));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	(*T2_).name = getIdent__idents_166((*graph__uNAkReq0oHr9bUMZ0apLbBg).cache, colontmpD__2.Field1);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	(*T2_).info = newLineInfo__msgs_406(fileIdx__oD3hFRf4EApOxM9cASvyDnA, ((NI)1), ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = T2_;
	{
		NIM_BOOL T5_;
...
appendString((&T9_), (*(*result).name).s);
		colontmpD__3 = T9_;
		liMessage__msgs_1169((*graph__uNAkReq0oHr9bUMZ0apLbBg).config, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__PSTsdGjzLcJhNmbZsJdP6w_4), NIM_FALSE);
	...
	LA6_: ;
	partialInitModule__modules_23(result, graph__uNAkReq0oHr9bUMZ0apLbBg, fileIdx__oD3hFRf4EApOxM9cASvyDnA, filename);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	registerModule__modulegraphs_8551(graph__uNAkReq0oHr9bUMZ0apLbBg, result);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	flags_2 = flags__sOFw2wu9bJHAXJ8w9bg1CfxQ;
	{
		if (!(fileIdx__a3gGYXVY0NtakjVtCPJ9bKw == (*(*graph__9bcjXAtWV8LUDw50psF7YWw).config).projectMainIdx2)) goto LA3_;
		flags_2 |= ((NU64)1)<<(((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)14))) & 63);
	}
	LA3_: ;
	result = getModule__modulegraphs_11350(graph__9bcjXAtWV8LUDw50psF7YWw, fileIdx__a3gGYXVY0NtakjVtCPJ9bKw);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		filename.len = 0; filename.p = NIM_NIL;
		T10_ = NIM_NIL;
		T10_ = moduleFromRodFile__modulegraphs_14915(graph__9bcjXAtWV8LUDw50psF7YWw, fileIdx__a3gGYXVY0NtakjVtCPJ9bKw, (&cachedModules));
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		eqsink___ast_4066(&result, T10_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		filename = toFullPath__msgs_587((*graph__9bcjXAtWV8LUDw50psF7YWw).config, fileIdx__a3gGYXVY0NtakjVtCPJ9bKw);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		{
			...
			colontmpD_ = NIM_NIL;
			T16_ = NIM_NIL;
			T16_ = newModule__modules_29(graph__9bcjXAtWV8LUDw50psF7YWw, fileIdx__a3gGYXVY0NtakjVtCPJ9bKw);
			if (NIM_UNLIKELY(*nimErr_)) goto LA15_;
			eqsink___ast_4066(&result, T16_);
			if (NIM_UNLIKELY(*nimErr_)) goto LA15_;
			(*result).flags = ((*result).flags | flags_2);
			registerModule__modulegraphs_8551(graph__9bcjXAtWV8LUDw50psF7YWw, result);
			if (NIM_UNLIKELY(*nimErr_)) goto LA15_;
			onProcessing__modulegraphs_14927(graph__9bcjXAtWV8LUDw50psF7YWw, fileIdx__a3gGYXVY0NtakjVtCPJ9bKw, TM__PSTsdGjzLcJhNmbZsJdP6w_7, fromModule__DElDd7cSSx20EPV9c7MO9bEQ);
			if (NIM_UNLIKELY(*nimErr_)) goto LA15_;
			{
				if (!((flags_2 &((NU64)1<<((NU)((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)14)))&63U)))!=0)) goto LA19_;
				{
					if (!(*(*graph__9bcjXAtWV8LUDw50psF7YWw).config).projectIsStdin) goto LA23_;
				...
				LA23_: ;
				{
					if (!(*(*graph__9bcjXAtWV8LUDw50psF7YWw).config).projectIsCmd) goto LA26_;
					sX60gensym4_ = llStreamOpen__llstream_31((*(*graph__9bcjXAtWV8LUDw50psF7YWw).config).cmdInput);
					if (NIM_UNLIKELY(*nimErr_)) goto LA15_;
				}
				goto LA21_;
				LA26_: ;
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA15_;
			T28_ = (NIM_BOOL)0;
			T28_ = processModule__passes_264(graph__9bcjXAtWV8LUDw50psF7YWw, result, colontmpD_, sX60gensym4_);
			if (NIM_UNLIKELY(*nimErr_)) goto LA15_;
			(void)(T28_);
			{
				LA15_:;
		...
		{
			{
				...
				eqcopy___ast_4063(&(*graph__9bcjXAtWV8LUDw50psF7YWw).systemModule, result);
				if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
			}
			LA34_: ;
			partialInitModule__modules_23(result, graph__9bcjXAtWV8LUDw50psF7YWw, fileIdx__a3gGYXVY0NtakjVtCPJ9bKw, filename);
			if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		}
		LA11_: ;
		{
			...
			L = T37_;
			{
				while (1) {
					...
					registerModuleById__modulegraphs_8853(graph__9bcjXAtWV8LUDw50psF7YWw, (*m));
					if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
					replayStateChanges__icZreplayer_16((*graph__9bcjXAtWV8LUDw50psF7YWw).packed_0.p->data[(*m)].module, graph__9bcjXAtWV8LUDw50psF7YWw);
					if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
					replayGenericCacheInformation__icZreplayer_1168(graph__9bcjXAtWV8LUDw50psF7YWw, ((NI) ((*m))));
					if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
					i += ((NI)1);
				} LA39: ;
			}
	...
	LA7_: ;
	{
		...
		NIM_BOOL T58_;
		T43_ = (NIM_BOOL)0;
		T43_ = isDirty__modulegraphs_14726(graph__9bcjXAtWV8LUDw50psF7YWw, result);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T43_) goto LA44_;
		sX60gensym7_ = NIM_NIL;
		colontmpD__2 = NIM_NIL;
		(*result).flags &= ~(((NU64)1) << (((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)11))) & 63));
		initStrTables__modulegraphs_2861(graph__9bcjXAtWV8LUDw50psF7YWw, result);
		if (NIM_UNLIKELY(*nimErr_)) goto LA46_;
		eqsink___ast_3460(&(*result).ast, ((tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*) NIM_NIL));
		if (NIM_UNLIKELY(*nimErr_)) goto LA46_;
		onProcessing__modulegraphs_14927(graph__9bcjXAtWV8LUDw50psF7YWw, fileIdx__a3gGYXVY0NtakjVtCPJ9bKw, TM__PSTsdGjzLcJhNmbZsJdP6w_9, fromModule__DElDd7cSSx20EPV9c7MO9bEQ);
		if (NIM_UNLIKELY(*nimErr_)) goto LA46_;
		{
			if (!((flags_2 &((NU64)1<<((NU)((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)14)))&63U)))!=0)) goto LA49_;
			{
				if (!(*(*graph__9bcjXAtWV8LUDw50psF7YWw).config).projectIsStdin) goto LA53_;
			...
			LA53_: ;
			{
				if (!(*(*graph__9bcjXAtWV8LUDw50psF7YWw).config).projectIsCmd) goto LA56_;
				sX60gensym7_ = llStreamOpen__llstream_31((*(*graph__9bcjXAtWV8LUDw50psF7YWw).config).cmdInput);
				if (NIM_UNLIKELY(*nimErr_)) goto LA46_;
			}
			goto LA51_;
			LA56_: ;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA46_;
		T58_ = (NIM_BOOL)0;
		T58_ = processModule__passes_264(graph__9bcjXAtWV8LUDw50psF7YWw, result, colontmpD__2, sX60gensym7_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA46_;
		(void)(T58_);
		markClientsDirty__modulegraphs_14734(graph__9bcjXAtWV8LUDw50psF7YWw, fileIdx__a3gGYXVY0NtakjVtCPJ9bKw);
		if (NIM_UNLIKELY(*nimErr_)) goto LA46_;
		{
			LA46_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	T1_ = 0;
	result = compileModule__modules_34(graph__T9cUxMVMgo2P5xZ5ZI9ahYUg, fileIdx__9chU6psIEFR9bW74RzW4xqRA, T1_, s__4cetlEY7D5vthgcwyHeINA);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	addDep__modulegraphs_11429(graph__T9cUxMVMgo2P5xZ5ZI9ahYUg, s__4cetlEY7D5vthgcwyHeINA, fileIdx__9chU6psIEFR9bW74RzW4xqRA);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T4_;
		NI32 colontmpD__3;
		...
		T4_ = (NIM_BOOL)0;
		T4_ = hcrOn__options_588((*graph__T9cUxMVMgo2P5xZ5ZI9ahYUg).config);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T4_) goto LA5_;
		colontmpD__3 = (NI32)0;
		...
		T8_ = mgetOrPut__modules_129((&(*graph__T9cUxMVMgo2P5xZ5ZI9ahYUg).importDeps), ((NI32) ((*s__4cetlEY7D5vthgcwyHeINA).position)), T7_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmpD__3 = fileIdx__9chU6psIEFR9bW74RzW4xqRA;
	...
	LA5_: ;
	{
		NIM_BOOL T11_;
		T11_ = (NIM_BOOL)0;
		T11_ = belongsToProjectPackage__packages_76((*graph__T9cUxMVMgo2P5xZ5ZI9ahYUg).config, s__4cetlEY7D5vthgcwyHeINA);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (T11_) goto LA12_;
		T11_ = isDefined__options_2481((*graph__T9cUxMVMgo2P5xZ5ZI9ahYUg).config, TM__PSTsdGjzLcJhNmbZsJdP6w_11);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		LA12_: ;
		if (!T11_) goto LA13_;
		nimCopyMem((void*)colontmpD_, (NIM_CONST void*)(*(*graph__T9cUxMVMgo2P5xZ5ZI9ahYUg).config).mainPackageNotes, 12);
		nimCopyMem((void*)(*(*graph__T9cUxMVMgo2P5xZ5ZI9ahYUg).config).notes, (NIM_CONST void*)colontmpD_, 12);
	}
	goto LA9_;
	LA13_: ;
	{
		nimCopyMem((void*)colontmpD__2, (NIM_CONST void*)(*(*graph__T9cUxMVMgo2P5xZ5ZI9ahYUg).config).foreignPackageNotes, 12);
		nimCopyMem((void*)(*(*graph__T9cUxMVMgo2P5xZ5ZI9ahYUg).config).notes, (NIM_CONST void*)colontmpD__2, 12);
	}
	LA9_: ;
	}BeforeRet_: ;
	return result;
...
N_LIB_PRIVATE N_NIMCALL(void, connectCallbacks__modules_1188)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* graph__QbUzMI3sq9cajBWdA1dmELA) {
	(*graph__QbUzMI3sq9cajBWdA1dmELA).includeFileCallback = includeModule__modules_1183;
	(*graph__QbUzMI3sq9cajBWdA1dmELA).importModuleCallback = importModule__modules_87;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*, makeModule__modules_1236)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* graph__ig9adQV6Z11QoifbVAzYnOw, NimStringV2 filename__NfF4nHzpG9c5HGWgmSWQ6pw) {
	tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* result;
	NI32 T1_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	T1_ = (NI32)0;
	T1_ = fileInfoIdx__msgs_391((*graph__ig9adQV6Z11QoifbVAzYnOw).config, filename__NfF4nHzpG9c5HGWgmSWQ6pw);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = newModule__modules_29(graph__ig9adQV6Z11QoifbVAzYnOw, T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	registerModule__modulegraphs_8551(graph__ig9adQV6Z11QoifbVAzYnOw, result);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	{
		...
		NI32 T6_;
		if (!((*graph__jPlxqNWpraFvNhqANbcYrw).systemModule == ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL))) goto LA3_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		colontmpD__2 = NIM_NIL;
		connectCallbacks__modules_1188(graph__jPlxqNWpraFvNhqANbcYrw);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		colontmpD_ = slash___pathutils_103((*(*graph__jPlxqNWpraFvNhqANbcYrw).config).libpath, TM__PSTsdGjzLcJhNmbZsJdP6w_13);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		T6_ = (NI32)0;
		T6_ = fileInfoIdx__msgs_391((*graph__jPlxqNWpraFvNhqANbcYrw).config, colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		(*(*graph__jPlxqNWpraFvNhqANbcYrw).config).m.systemFileIdx = T6_;
		colontmpD__2 = compileModule__modules_34(graph__jPlxqNWpraFvNhqANbcYrw, (*(*graph__jPlxqNWpraFvNhqANbcYrw).config).m.systemFileIdx, 32768, ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL));
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		(void)(colontmpD__2);
		{
			LA5_:;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	resetSysTypes__magicsys_99(g__tCr9cIyA0qEFnOydiPsEaDg);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
static N_INLINE(NIM_BOOL, isEmpty__options_5384)(NimStringV2 x__vqJZEJR2jov63eFmz1nVMA) {
...
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	{
		NIM_BOOL T4_;
		T4_ = (NIM_BOOL)0;
		T4_ = isEmpty__options_5384((*conf__9cf9cVT19az14UGPWI7V6emVw).projectFull);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T4_) goto LA5_;
		liMessage__msgs_1169(conf__9cf9cVT19az14UGPWI7V6emVw, gCmdLineInfo__msgs_429, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)1), TM__PSTsdGjzLcJhNmbZsJdP6w_15, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__PSTsdGjzLcJhNmbZsJdP6w_16), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA5_: ;
	colontmpD_ = nosaddFileExt((*conf__9cf9cVT19az14UGPWI7V6emVw).projectFull, TM__PSTsdGjzLcJhNmbZsJdP6w_18);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T7_ = (NI32)0;
	T7_ = fileInfoIdx__msgs_391(conf__9cf9cVT19az14UGPWI7V6emVw, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	(*conf__9cf9cVT19az14UGPWI7V6emVw).projectMainIdx = T7_;
	{
		LA1_:;
	}
	{
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__3 = (NI32)0;
	packSym = NIM_NIL;
	connectCallbacks__modules_1188(graph__F1ck9bCL44BGRdUWOhZP4XQ);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqcopy___options_3378(&conf, (*graph__F1ck9bCL44BGRdUWOhZP4XQ).config);
	wantMainModule__modules_1220(conf);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	configComplete__modulegraphs_14924(graph__F1ck9bCL44BGRdUWOhZP4XQ);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD_ = slash___pathutils_103((*conf).libpath, TM__PSTsdGjzLcJhNmbZsJdP6w_19);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	systemFileIdx = fileInfoIdx__msgs_391(conf, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		if (!(projectFileIdx__SYVCUSKoZUYUTsgKgMainQ == ((NI32)-1))) goto LA4_;
	...
	LA4_: ;
	{
		colontmpD__3 = projectFileIdx__SYVCUSKoZUYUTsgKgMainQ;
		projectFile = colontmpD__3;
	}
	LA2_: ;
	(*conf).projectMainIdx2 = projectFile;
	packSym = getPackage__modulegraphs_14978(graph__F1ck9bCL44BGRdUWOhZP4XQ, projectFile);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T7_ = (NI)0;
	T7_ = getPackageId__packages_67(packSym);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	(*(*graph__F1ck9bCL44BGRdUWOhZP4XQ).config).mainPackageId = T7_;
	add__icZic_10345((&(*graph__F1ck9bCL44BGRdUWOhZP4XQ).importStack), projectFile);
	{
		tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* colontmpD__4;
		if (!(projectFile == systemFileIdx)) goto LA10_;
		colontmpD__4 = NIM_NIL;
		colontmpD__4 = compileModule__modules_34(graph__F1ck9bCL44BGRdUWOhZP4XQ, projectFile, 49152, ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL));
	...
	LA10_: ;
	{
		...
		compileSystemModule__modules_1214(graph__F1ck9bCL44BGRdUWOhZP4XQ);
		if (NIM_UNLIKELY(*nimErr_)) goto LA16_;
		colontmpD__5 = compileModule__modules_34(graph__F1ck9bCL44BGRdUWOhZP4XQ, projectFile, 16384, ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL));
		if (NIM_UNLIKELY(*nimErr_)) goto LA16_;
		(void)(colontmpD__5);
		{
			LA16_:;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	result = makeModule__modules_1236(graph__9aBD83uzjWFb9aWYyBgZ41KQ, TM__PSTsdGjzLcJhNmbZsJdP6w_21);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
