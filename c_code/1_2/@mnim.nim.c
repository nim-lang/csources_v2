...
typedef struct {
N_NIMCALL_PTR(void, ClP_0) (tyEnum_TCmdLinePass__7z2Tds19a2G5eslO9cP9apH4w pass, NimStringV2 cmd, tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* config, void* ClE_0);
void* ClE_0;
...
typedef N_CLOSURE_PTR(void, TM__xOfksDa5lOpfO1acT4wYQg_11) (tyEnum_TCmdLinePass__7z2Tds19a2G5eslO9cP9apH4w pass, NimStringV2 cmd, tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* config, void* ClE_0);
...
N_LIB_PRIVATE N_NIMCALL(void, handleCmdLine__nim_42)(tyObject_IdentCachecolonObjectType___4yiDOEx3Y9aOTV1fsziBtCQ* cache, tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf);
N_LIB_PRIVATE N_NIMCALL(void*, nimNewObj)(NI size, NI alignment);
N_LIB_PRIVATE N_NIMCALL(void, processCmdLine__nim_17)(tyEnum_TCmdLinePass__7z2Tds19a2G5eslO9cP9apH4w pass, NimStringV2 cmd, tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* config);
...
N_LIB_PRIVATE N_NIMCALL(void, addCmdPrefix__cmdlinehelper_16)(NimStringV2* result, tyEnum_CmdLineKind__XkdXq9atxjiuhkFFh0XYrSA kind);
...
N_LIB_PRIVATE N_NIMCALL(void, initDefinesProg__cmdlinehelper_28)(tyObject_NimProgcolonObjectType___nXKTiDb6u1p29b8d5CUkjYw* self, tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, NimStringV2 name);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___nim_143)(tyObject_NimProgcolonObjectType___nXKTiDb6u1p29b8d5CUkjYw** dest);
N_LIB_PRIVATE N_NIMCALL(void, processCmdLineAndProjectPath__cmdlinehelper_32)(tyObject_NimProgcolonObjectType___nXKTiDb6u1p29b8d5CUkjYw* self, tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, loadConfigsAndProcessCmdLine__cmdlinehelper_43)(tyObject_NimProgcolonObjectType___nXKTiDb6u1p29b8d5CUkjYw* self, tyObject_IdentCachecolonObjectType___4yiDOEx3Y9aOTV1fsziBtCQ* cache, tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* graph);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getNimRunExe__nim_39)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf);
...
N_LIB_PRIVATE N_NIMCALL(void, atmdotdotatsdotdotatsdotchoosenimatstoolchainsatsnimminusathdevelatslibatsstdatssynciodotnim_DatInit000)(void);
N_LIB_PRIVATE N_NIMCALL(void, atmdotdotatsdotdotatsdotchoosenimatstoolchainsatsnimminusathdevelatslibatsstdatssynciodotnim_Init000)(void);
...
{nimErr_ = nimErrorFlag();
	...
	initOptParser__pureZparseopt_64(cmd, T2_, T3_, NIM_TRUE, (&p));
...
appendString((&(*config).commandLine), TM__xOfksDa5lOpfO1acT4wYQg_3);
				addCmdPrefix__cmdlinehelper_16((&(*config).commandLine), p.kind);
				if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
				colontmpD_ = nospquoteShell(p.key);
				if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
				prepareAdd((&(*config).commandLine), colontmpD_.len + 0);
appendString((&(*config).commandLine), colontmpD_);
				{
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
					prepareAdd((&(*config).commandLine), colontmpD__2.len + 0);
appendString((&(*config).commandLine), colontmpD__2);
				...
				LA11_: ;
				{
					...
					eqsink___stdZassertions_19((&p.key), TM__xOfksDa5lOpfO1acT4wYQg_5);
					{
						NIM_BOOL T19_;
						T19_ = (NIM_BOOL)0;
						T19_ = processArgument__commands_1592(pass, (&p), (&argsCount), config);
						if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
						if (!T19_) goto LA20_;
				...
				LA15_: ;
				{
					processSwitch__commands_1585(pass, (&p), config);
					if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
				}
				LA13_: ;
				{
			...
			case ((tyEnum_CmdLineKind__XkdXq9atxjiuhkFFh0XYrSA)1):
			{
				...
				prepareAdd((&(*config).commandLine), 1);
appendString((&(*config).commandLine), TM__xOfksDa5lOpfO1acT4wYQg_6);
				colontmpD__3 = nospquoteShell(p.key);
				if (NIM_UNLIKELY(*nimErr_)) goto LA26_;
				prepareAdd((&(*config).commandLine), colontmpD__3.len + 0);
appendString((&(*config).commandLine), colontmpD__3);
				{
					NIM_BOOL T29_;
					T29_ = (NIM_BOOL)0;
					T29_ = processArgument__commands_1592(pass, (&p), (&argsCount), config);
					if (NIM_UNLIKELY(*nimErr_)) goto LA26_;
					if (!T29_) goto LA30_;
	...
	{
		if (!(pass == ((tyEnum_TCmdLinePass__7z2Tds19a2G5eslO9cP9apH4w)1))) goto LA36_;
		{
			NIM_BOOL T40_;
			NIM_BOOL T41_;
			...
			T41_ = (NIM_BOOL)0;
			T42_ = 0;
			T41_ = ((8196 & (*config).globalOptions) == T42_);
			if (!(T41_)) goto LA43_;
			T41_ = (((NI)0) < (*config).arguments.len);
			LA43_: ;
			T40_ = T41_;
			if (!(T40_)) goto LA44_;
			T40_ = !(((*config).cmd == ((tyEnum_Command__b145RBTl7bacomLHdBguHg)7) || (*config).cmd == ((tyEnum_Command__b145RBTl7bacomLHdBguHg)12) || (*config).cmd == ((tyEnum_Command__b145RBTl7bacomLHdBguHg)6)));
			LA44_: ;
			if (!T40_) goto LA45_;
			liMessage__msgs_1159(config, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__xOfksDa5lOpfO1acT4wYQg_8, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__xOfksDa5lOpfO1acT4wYQg_9), NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		}
		LA45_: ;
	}
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = isDefined__options_2481(conf, TM__xOfksDa5lOpfO1acT4wYQg_15);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		{
			NIM_BOOL T8_;
			T8_ = (NIM_BOOL)0;
			T8_ = isDefined__options_2481(conf, TM__xOfksDa5lOpfO1acT4wYQg_17);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!T8_) goto LA9_;
		...
		LA9_: ;
		{
			NIM_BOOL T12_;
			T12_ = (NIM_BOOL)0;
			T12_ = isDefined__options_2481(conf, TM__xOfksDa5lOpfO1acT4wYQg_21);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!T12_) goto LA13_;
...
{nimErr_ = nimErrorFlag();
	...
	self = T2_;
	initDefinesProg__cmdlinehelper_28(self, conf, TM__xOfksDa5lOpfO1acT4wYQg_13);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NI T6_;
		T6_ = (NI)0;
		...
		writeCommandLineUsage__commands_174(conf);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NIM_BOOL T11_;
		T11_ = (NIM_BOOL)0;
		T11_ = loadConfigsAndProcessCmdLine__cmdlinehelper_43(self, cache, conf, graph);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!!(T11_)) goto LA12_;
		eqdestroy___modulegraphs_11312(&graph);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA12_: ;
	{
		...
		T16_ = (NIM_BOOL)0;
		T17_ = (NIM_BOOL)0;
		T17_ = ((*conf).cmd == ((tyEnum_Command__b145RBTl7bacomLHdBguHg)8));
		if (!(T17_)) goto LA18_;
		T17_ = !((((*conf).globalOptions &((NU64)1<<((NU)((((tyEnum_TGlobalOption__9bU4j0PZjdMiF7DRotXVQZw)2)))&63U)))!=0));
		LA18_: ;
		T16_ = T17_;
		if (!(T16_)) goto LA19_;
		T16_ = ((*conf).backend == ((tyEnum_TBackend__s27DA9b8P4ksjjsndcLjR2w)0));
		LA19_: ;
		if (!T16_) goto LA20_;
	...
	LA20_: ;
	{
		if (!((*conf).selectedGC == ((tyEnum_TGCMode__yL7PTPtUQsYlPsanXzkjrg)0))) goto LA24_;
		{
			if (!((*conf).backend == ((tyEnum_TBackend__s27DA9b8P4ksjjsndcLjR2w)1) || (*conf).backend == ((tyEnum_TBackend__s27DA9b8P4ksjjsndcLjR2w)2) || (*conf).backend == ((tyEnum_TBackend__s27DA9b8P4ksjjsndcLjR2w)4))) goto LA28_;
			initOrcDefines__commands_907(conf);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		}
		LA28_: ;
	}
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		T32_ = (NIM_BOOL)0;
		T32_ = hasHint__options_530(conf, ((tyEnum_TMsgKind__w451l0dg4CacKSKYxza9cvw)105));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T32_) goto LA33_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	...
	LA33_: ;
	{
		if (!!(((*conf).errorCounter == ((NI)0)))) goto LA41_;
		eqdestroy___modulegraphs_11312(&graph);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqdestroy___nim_143(&self);
		goto BeforeRet_;
	...
	{
		NimStringV2 output;
		if (!(((*conf).globalOptions &((NU64)1<<((NU)((((tyEnum_TGlobalOption__9bU4j0PZjdMiF7DRotXVQZw)13)))&63U)))!=0)) goto LA45_;
		output.len = 0; output.p = NIM_NIL;
		output = absOutFile__options_4942(conf);
		...
		case ((tyEnum_Command__b145RBTl7bacomLHdBguHg)7):
		{
			...
			colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
			colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
			nimRunExe = getNimRunExe__nim_39(conf);
			...
			{
				{
					...
					colontmpD__6 = dollar___options_138((*conf).backend);
...
appendString((&cmdPrefix), TM__xOfksDa5lOpfO1acT4wYQg_38);
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA49_;
			T74_ = rawNewString(cmdPrefix.len + colontmpD__2.len + (*conf).arguments.len + 1);
appendString((&T74_), cmdPrefix);
appendString((&T74_), colontmpD__2);
appendChar((&T74_), 32);
appendString((&T74_), (*conf).arguments);
			cmd = T74_;
			colontmpD__3 = nsuStrip(cmd, NIM_FALSE, NIM_TRUE, TM__xOfksDa5lOpfO1acT4wYQg_39);
			if (NIM_UNLIKELY(*nimErr_)) goto LA49_;
			execExternalProgram__extccomp_905(conf, colontmpD__3, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)99));
			if (NIM_UNLIKELY(*nimErr_)) goto LA49_;
			{
				LA49_:;
			}
		...
		case ((tyEnum_Command__b145RBTl7bacomLHdBguHg)20) ... ((tyEnum_Command__b145RBTl7bacomLHdBguHg)23):
		{
			...
			colontmpD__8.len = 0; colontmpD__8.p = NIM_NIL;
			{
				...
				if (!(((NI)0) < (*conf).arguments.len)) goto LA81_;
				colontmpD__9.len = 0; colontmpD__9.p = NIM_NIL;
				colontmpD__10.len = 0; colontmpD__10.p = NIM_NIL;
				colontmpD__9 = dollar___options_171((*conf).cmd);
				T84_[0] = colontmpD__9;
				colontmpD__10 = nsuFormatOpenArray(TM__xOfksDa5lOpfO1acT4wYQg_41, T84_, 1);
				if (NIM_UNLIKELY(*nimErr_)) goto LA83_;
				liMessage__msgs_1159(conf, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__10, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__xOfksDa5lOpfO1acT4wYQg_42), NIM_FALSE);
				if (NIM_UNLIKELY(*nimErr_)) goto LA83_;
				{
					LA83_:;
				}
		...
		default:
		{
			...
			colontmpD__11 = dollar___options_171((*conf).cmd);
			...
			liMessage__msgs_1159(conf, unknownLineInfo__lineinfos_350, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__12, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__xOfksDa5lOpfO1acT4wYQg_45), NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA90_;
			{
				LA90_:;
			}
...
N_LIB_PRIVATE void PreMainInner(void) {
	atmdotdotatsdotdotatsdotchoosenimatstoolchainsatsnimminusathdevelatslibatsstdatsexitprocsdotnim_Init000();
	atmdotdotatsdotdotatsdotchoosenimatstoolchainsatsnimminusathdevelatslibatsstdatssynciodotnim_Init000();
	atmdotdotatsdotdotatsdotchoosenimatstoolchainsatsnimminusathdevelatslibatswindowsatswinleandotnim_Init000();
}
...
N_LIB_PRIVATE void PreMain(void) {
	...
	inner = PreMainInner;
	atmdotdotatsdotdotatsdotchoosenimatstoolchainsatsnimminusathdevelatslibatssystemdotnim_Init000();
	atmdotdotatsdotdotatsdotchoosenimatstoolchainsatsnimminusathdevelatslibatsstdatssynciodotnim_DatInit000();
	atmdotdotatsdotdotatsdotchoosenimatstoolchainsatsnimminusathdevelatslibatswindowsatswinleandotnim_DatInit000();
	atmdotdotatsdotdotatsdotchoosenimatstoolchainsatsnimminusathdevelatslibatsstdatsprivateatswin_setenvdotnim_DatInit000();
	atmdotdotatsdotdotatsdotchoosenimatstoolchainsatsnimminusathdevelatslibatspureatsterminaldotnim_DatInit000();
	atmdotdotatsdotdotatsdotchoosenimatstoolchainsatsnimminusathdevelatslibatsstdatsprivateatswin_getsysteminfodotnim_DatInit000();
	(*inner)();
	#else
	atmdotdotatsdotdotatsdotchoosenimatstoolchainsatsnimminusathdevelatslibatssystemdotnim_Init000();
	atmdotdotatsdotdotatsdotchoosenimatstoolchainsatsnimminusathdevelatslibatsstdatssynciodotnim_DatInit000();
