...
N_LIB_PRIVATE N_NIMCALL(void, getPathVersionChecksum__nimblecmd_197)(NimStringV2 p, tyTuple__7q7q3E6Oj24ZNVJb9aonhAg* Result);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T5_ = substr__system_7613(p, (NI)(checksumSeparatorIndex + ((NI)1)));
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T16_ = substr__system_7601(p, (NI)(versionSeparatorIndex + ((NI)1)), (NI)(checksumSeparatorIndex - ((NI)1)));
	...
	LA14_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			T22_ = substr__system_7601(p, (NI)(versionSeparatorIndex + ((NI)1)), (NI)(checksumSeparatorIndex - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	...
	getPathVersionChecksum__nimblecmd_197(p, (&colontmp_));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	checksum = colontmp_.Field2;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
		{
			...
			NIM_BOOL T12_;
			T10_ = (NIM_BOOL)0;
			getOrDefault__nimblecmd_308((*packages), name, (&colontmpD_));
			if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
