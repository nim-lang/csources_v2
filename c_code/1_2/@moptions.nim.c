...
N_LIB_PRIVATE N_NIMCALL(void, utc__pureZtimes_1716)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q t, tyObject_DateTime__d9cK9cyKZPJJxFXUmx8dSpPw* Result);
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		if (!(T3_)) goto LA4_;
		T5_ = (NIM_CHAR)0;
		T5_ = X5BX5D___system_7090(path, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T3_ = ((NU8)(T5_) == (NU8)(92));
		LA4_: ;
		if (!T3_) goto LA6_;
		result = substr__system_7601(path, ((NI)0), (NI)(path.len - ((NI)2)));
	}
	goto LA1_;
	LA6_: ;
	{
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		result = substr__system_7601(s, start, (NI)(ende - ((NI)1)));
	}
	goto LA7_;
	LA9_: ;
	{
		result = substr__system_7613(s, start);
	}
	LA7_: ;
	}BeforeRet_: ;
	return result;
...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	T15_.len = 0; T15_.p = NIM_NIL;
	T15_ = canonicalizePath__options_4979(conf, dir);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
