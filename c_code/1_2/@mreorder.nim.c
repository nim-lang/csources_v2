	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			if (!(colontmp_ < T3_)) goto LA2			;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				nimRawDispose((*dest__MrnpaT5Fd9b8dCHKBSrnxew).p->data[colontmp_], ((NI)8));
			}
			LA7_: ;
			colontmp_ += ((NI)1);
		} LA2: ;
...
{nimErr_ = nimErrorFlag();
	...
	(*dest__pI1si9aIgpYceLL9c1K9biNvA).Field0.max = (*src__l9bIDissx9bpQz9cnDZaSIAqg).Field0.max;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__pI1si9aIgpYceLL9c1K9biNvA).Field0.head, ((NI)8));
	}
	LA4_: ;
...
(*dest__pI1si9aIgpYceLL9c1K9biNvA).Field0.data.len = (*src__l9bIDissx9bpQz9cnDZaSIAqg).Field0.data.len; (*dest__pI1si9aIgpYceLL9c1K9biNvA).Field0.data.p = (*src__l9bIDissx9bpQz9cnDZaSIAqg).Field0.data.p;
	...
	(*dest__pI1si9aIgpYceLL9c1K9biNvA).Field1.max = (*src__l9bIDissx9bpQz9cnDZaSIAqg).Field1.max;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__pI1si9aIgpYceLL9c1K9biNvA).Field1.head, ((NI)8));
	}
	LA9_: ;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__8u8UqdkO9b8iHyWSKZT9aGHw), ((NI)8));
	}
	LA4_: ;
	}BeforeRet_: ;
}
							...
							j = ((NI)0);
							{
								while (1) {
									if (!!((w == ((NU)0)))) goto LA21									;
									{
										...
										T26_ = (NI)0;
										T26_ = pluspercent___system_770((NI)((NU64)(i_3) << (NU64)(((NI)6))), j);
										a = (NI)((NI)((NU64)((*r).key) << (NU64)(((NI)9))) | T26_);
										{
											NIM_BOOL T29_;
											T29_ = (NIM_BOOL)0;
															...
															j_2 = ((NI)0);
															{
																while (1) {
																	if (!!((w == ((NU)0)))) goto LA72																	;
																	{
																		...
																		T77_ = (NI)0;
																		T77_ = pluspercent___system_770((NI)((NU64)(i_8) << (NU64)(((NI)6))), j_2);
																		d = (NI)((NI)((NU64)((*r).key) << (NU64)(((NI)9))) | T77_);
																		{
																			NIM_BOOL T80_;
...
N_LIB_PRIVATE N_NIMCALL(NI, colonanonymous___reorder_628)(tyObject_DepNcolonObjectType___e3eC0DKpMZNXV7n55sKrSw* xX60gensym51___E4ThMhy7ceFQgqCck1TCxw, tyObject_DepNcolonObjectType___e3eC0DKpMZNXV7n55sKrSw* yX60gensym51___xjI0S5OHJ5YgtKfmUC2N6A) {
	...
	bX60gensym51_ = (*it).id;
	result = cmp__system_7255(aX60gensym51_, bX60gensym51_);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, haveSameKind__reorder_543)(tySequence__8QRZaV9bKw9abKv9anJ280svg dns__hrW3T6H09cdwWTnAIbH6QIw) {
	NIM_BOOL result;
