...
N_LIB_PRIVATE N_NIMCALL(tyEnum_FloatClass__pPga1yW9b8J9cwNnm9b1aPRnA, classify__pureZmath_144)(NF x__djC9ccvamPhkHKsdQDvt8dw);
...
{nimErr_ = nimErrorFlag();
	...
	T1_ = classify__pureZmath_144(f__9cm74ob3QyjHMeQPLvUvc0g);
	...
	default:
	{
		addFloatRoundtrip__system_4377((&result), f__9cm74ob3QyjHMeQPLvUvc0g);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		prepareAdd((&result), 0);
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	T1_ = (tyEnum_FloatClass__pPga1yW9b8J9cwNnm9b1aPRnA)0;
	T1_ = classify__pureZmath_144(((NF) (f__9cm74ob3QyjHMeQPLvUvc0g)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	switch (T1_) {
	case ((tyEnum_FloatClass__pPga1yW9b8J9cwNnm9b1aPRnA)4):
	{
