...
appendString((&T58_), frmt);
			...
			} LA59: ;
			{
				...
				colontmpD__5 = substr__system_7601(frmt, start, (NI)(i - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	...
	rtotal += s.len;
	{
		while (1) {
			...
			if (!(spos < s.len)) goto LA2			;
			{
				...
				bpos = ((NI)0);
				blen = readBuffer__stdZsyncio_156(f, ((void*) ((&buf[(((NI)0))- 0]))), ((NI)1024));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				btotal += blen;
				{
	...
	T16_ = (NIM_BOOL)0;
	T17_ = (NI)0;
	T17_ = readBuffer__stdZsyncio_156(f, ((void*) ((&buf[(((NI)0))- 0]))), ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T16_ = (T17_ == ((NI)0));
	if (!(T16_)) goto LA18_;
	T16_ = (btotal == rtotal);
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	f = (FILE*)0;
	result = open__stdZsyncio_528(&f, filename, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)0), ((NI)-1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!result) goto LA3_;
