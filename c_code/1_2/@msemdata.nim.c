...
{nimErr_ = nimErrorFlag();
	...
	liMessage__msgs_1159(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)3), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)2), (&TM__6kkF5shvTYOHG9cWBoBNLPQ_4), NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = renderTree__renderer_50(n, 4);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	liMessage__msgs_1159(conf, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)3), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__6kkF5shvTYOHG9cWBoBNLPQ_6), NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		internalErrorImpl__msgs_1497((*(*c).graph).config, unknownLineInfo__lineinfos_350, TM__6kkF5shvTYOHG9cWBoBNLPQ_8, (&TM__6kkF5shvTYOHG9cWBoBNLPQ_9));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA1_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	default:
	{
		internalErrorImpl__msgs_1497((*(*c).graph).config, (*result).info, TM__6kkF5shvTYOHG9cWBoBNLPQ_13, (&TM__6kkF5shvTYOHG9cWBoBNLPQ_14));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	}
...
{nimErr_ = nimErrorFlag();
	...
	(*typedesc).flags |= ((NU64)1)<<(((((tyEnum_TTypeFlag__wRa4s6r4s9cXJ9abWKsrci1Q)38))) & 63);
	{
		...
		internalErrorImpl__msgs_1497((*(*c).graph).config, unknownLineInfo__lineinfos_350, argX60gensym89_, (&TM__6kkF5shvTYOHG9cWBoBNLPQ_21));
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
