...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		T19_ = (NI)0;
		T19_ = safeInheritanceDiff__types_3611(colontmpD__2, (*spec__DjtMCt7X9bu5fMLi2amFfng).typ);
		if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
		result = (T19_ <= ((NI)0));
...
{nimErr_ = nimErrorFlag();
	...
	LA44_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__4dLWN1ThnHVlyLAoECu6Fg).escapingParams.head, ((NI)8));
	}
	LA49_: ;
...
{nimErr_ = nimErrorFlag();
	{
		...
		(*a__scBBltz7Q9akItFKuONHWdA).hasSideEffect = NIM_TRUE;
		{
			...
			T10_ = mgetOrPut__sempass50_1287((&(*(*a__scBBltz7Q9akItFKuONHWdA).c).sideEffects), (NI)((NI)((NU64)(((NI) ((*xX60gensym87_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym87_).Sup.itemId.item))), T9_);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		xX60gensym106_ = NIM_NIL;
		{
			...
			add__varpartitions_1477((&(*a__fSNZ5ZCj3bKUbeq9aF3AiRg).init), (NI)((NI)((NU64)(((NI) ((*xX60gensym104_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym104_).Sup.itemId.item))));
		...
		LA14_: ;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			T17_ = (NIM_BOOL)0;
			T17_ = contains__sigmatch_4656((((*a__fSNZ5ZCj3bKUbeq9aF3AiRg).init).p) ? ((*a__fSNZ5ZCj3bKUbeq9aF3AiRg).init.p->data) : NIM_NIL, (*a__fSNZ5ZCj3bKUbeq9aF3AiRg).init.len, (NI)((NI)((NU64)(((NI) ((*xX60gensym106_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym106_).Sup.itemId.item))));
			if (!!(T17_)) goto LA18_;
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA20_;
			add__varpartitions_1477((&(*a__fSNZ5ZCj3bKUbeq9aF3AiRg).init), (NI)((NI)((NU64)(((NI) ((*xX60gensym114_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym114_).Sup.itemId.item))));
			{
				LA20_:;
			}
			{
...
{nimErr_ = nimErrorFlag();
	...
	}
	{
		if (!!(((*e__OZ0CtBe4LDrsuIMt1yjVTQ).typ == ((tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*) NIM_NIL)))) goto LA16_;
		{
			...
			if (T20_) goto LA21_;
			T22_ = (NIM_BOOL)0;
			T22_ = isDefectException__types_4304((*e__OZ0CtBe4LDrsuIMt1yjVTQ).typ);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			T20_ = !(T22_);
			LA21_: ;
			if (!T20_) goto LA23_;
...
{nimErr_ = nimErrorFlag();
	{
		...
		(*a__scBBltz7Q9akItFKuONHWdA_2).hasSideEffect = NIM_TRUE;
		{
			...
			T22_ = mgetOrPut__sempass50_1287((&(*(*a__scBBltz7Q9akItFKuONHWdA_2).c).sideEffects), (NI)((NI)((NU64)(((NI) ((*xX60gensym231_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym231_).Sup.itemId.item))), T21_);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	n_2 = NIM_NIL;
	paramType_2 = NIM_NIL;
	n_2 = skipConv__types_3839(n__nxLfm9aNnlR9aC6fzC0yhBww);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NIM_BOOL T4_;
		tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* colontmpD_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		T17_ = T18_;
		if (!(T17_)) goto LA20_;
		colontmpD_ = skipConv__types_3839(n__f2cZ4tlL9aefg9bKB8lNcOFA);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA30_;
		s = skipConv__types_3839(n__f2cZ4tlL9aefg9bKB8lNcOFA);
		if (NIM_UNLIKELY(*nimErr_)) goto LA30_;
		{
			NIM_BOOL T40_;
			T40_ = (NIM_BOOL)0;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		xX60gensym44_ = s;
		add__varpartitions_1477((&(*a__wSjDnsIpnyA3c3g9bNfVoKA).init), (NI)((NI)((NU64)(((NI) ((*xX60gensym44_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym44_).Sup.itemId.item))));
		{
			NI T39_;
			xX60gensym45_ = s;
			s = 0;
			T39_ = (NI)0;
			T39_ = getOrDefault__sempass50_486((*a__wSjDnsIpnyA3c3g9bNfVoKA).scopes, (NI)((NI)((NU64)(((NI) ((*xX60gensym45_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym45_).Sup.itemId.item))));
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
						...
						i_8 = ((NI)0);
						{
							while (1) {
								...
								j_2 = i_8;
								{
									...
									if (NIM_UNLIKELY(*nimErr_)) goto LA38_;
									add__varpartitions_1477((&(*tracked__QxBd3zJti9czYJKBLtrh2SQ).init), (NI)((NI)((NU64)(((NI) ((*xX60gensym162_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym162_).Sup.itemId.item))));
...
{nimErr_ = nimErrorFlag();
	{
		...
		X5BX5Deq___importer_2418((&(*a__4Q1HG49am9bon9cqcLr1e0ovg).scopes), (NI)((NI)((NU64)(((NI) ((*xX60gensym37_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym37_).Sup.itemId.item))), colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3):
	{
		...
		s = (*n__VpeOou5BlN1tVfXLx6TEdA)._kind_4.sym;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			incl__pureZcollectionsZintsets_202((&(*tracked__2wvc19c720rMaxdzzQTXnug).escapingParams), (NI)((NI)((NU64)(((NI) ((*xX60gensym375_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym375_).Sup.itemId.item))));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	{
		result = isCharArrayPtr__types_4388((*n__duwNFg2xOMLtsYeSbZ2MGg).typ, NIM_TRUE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)26) ... ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)32):
	{
		...
		LA6_: ;
		result = isCharArrayPtr__types_4388((*n__duwNFg2xOMLtsYeSbZ2MGg).typ, T5_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	default:
	{
		result = isCharArrayPtr__types_4388((*n__duwNFg2xOMLtsYeSbZ2MGg).typ, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	}
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			(*(*tracked__RWzrmaCvD3C4pdsNusW3WQ).owner).flags |= ((NU64)1)<<(((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)42))) & 63);
			{
				...
				if (!(T10_)) goto LA12_;
				T13_ = 0;
				T10_ = sameType__types_2000((*n__oFGPncBWcp4n6sTHcrbHjA).typ, (*(*n__oFGPncBWcp4n6sTHcrbHjA)._kind_4.sym).typ, T13_);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				LA12_: ;
				if (!T10_) goto LA14_;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)60):
	{
		...
		LA345_: ;
		{
			...
			T353_ = isCharArrayPtr__types_4388((*(*n__oFGPncBWcp4n6sTHcrbHjA)._kind_6.sons.p->data[((NI)1)]).typ, NIM_TRUE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA337_;
			LA354_: ;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		xX60gensym55_ = u;
		T6_ = (NIM_BOOL)0;
		T6_ = containsOrIncl__astalgo_402(cycleCheck__B8D9b276Iwz9bMjbzFjYZ6aw, (NI)((NI)((NU64)(((NI) ((*xX60gensym55_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym55_).Sup.itemId.item))));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T4_ = !(T6_);
		LA5_: ;
		if (!T4_) goto LA7_;
...
{nimErr_ = nimErrorFlag();
	xX60gensym68_ = NIM_NIL;
	{
		...
		T3_ = (NIM_BOOL)0;
		T3_ = hasKey__sempass50_723((*context__Ar5BZsz6tZS37C5HpekCCg).sideEffects, (NI)((NI)((NU64)(((NI) ((*xX60gensym68_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym68_).Sup.itemId.item))));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		{
			...
			T8_ = X5BX5D___sempass50_1056((&(*context__Ar5BZsz6tZS37C5HpekCCg).sideEffects), (NI)((NI)((NU64)(((NI) ((*xX60gensym71_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym71_).Sup.itemId.item))));
			if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
			...
			L = T9_;
			{
				while (1) {
					...
					u = &colontmp_.p->data[i].Field1;
					{
						...
						if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
						T17_ = (NIM_BOOL)0;
						T17_ = containsOrIncl__astalgo_402(cycleCheck__ACEgdO8hp5lJ47tt9aqaK7Q, (NI)((NI)((NU64)(((NI) ((*xX60gensym75_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym75_).Sup.itemId.item))));
						if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
						T15_ = !(T17_);
						LA16_: ;
						if (!T15_) goto LA18_;
