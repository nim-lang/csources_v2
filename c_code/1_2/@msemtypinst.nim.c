					...
					while (1) {
						...
						if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
						{
							...
							LA29_: ;
							{
								NIM_BOOL T33_;
								T33_ = (NIM_BOOL)0;
								T33_ = sameFlags__types_2411(inst, key);
								if (NIM_UNLIKELY(*nimErr_)) goto LA20_;
								if (!!(T33_)) goto LA34_;
								eqdestroy___ast_3543(&xX60gensym16_);
								if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
									...
									res = ((NI)1);
									{
										while (1) {
											...
											j = res;
											{
												NIM_BOOL T43_;
												T43_ = (NIM_BOOL)0;
												T43_ = compareTypes__types_2855((*inst).sons.p->data[j], (*key).sons.p->data[j], ((tyEnum_TDistinctCompare__H0D0zbMLh4bchAD4N9bLm5A)0), 136);
												if (NIM_UNLIKELY(*nimErr_)) goto LA20_;
												if (!!(T43_)) goto LA44_;
												goto LA36;
											}
...
{nimErr_ = nimErrorFlag();
	...
	LA6_: ;
	{
		...
		if (!(T14_)) goto LA15_;
		T14_ = sameFlags__types_2411(result, t);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		LA15_: ;
		if (!T14_) goto LA16_;
	...
	}
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		{
			...
			if (!(T46_)) goto LA47_;
			T46_ = sameFlags__types_2411(result, t);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			LA47_: ;
			if (!T46_) goto LA48_;
			eqdestroy___ast_3543(&newbody);
	...
	{
		{
			...
			T117_ = (NIM_BOOL)0;
			T117_ = containsGenericType__types_3579(t);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA9_: ;
	{
		...
		T12_ = (NIM_BOOL)0;
		T13_ = (NI64)0;
		T13_ = computeSize__types_3536(conf, t);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T12_ = (T13_ == IL64(-2));
		if (T12_) goto LA14_;
