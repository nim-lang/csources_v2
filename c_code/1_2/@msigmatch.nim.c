...
static N_INLINE(NIM_BOOL, contains__pureZtimes_2841)(tyObject_HSlice__EE5dzjqoOrHT6HJhIPXAvA s__zoSsA7SNfQaAjh9bFKlWKow, NI value__VvpCLi7UbqENyMu2MzDIFg);
...
{nimErr_ = nimErrorFlag();
	...
	LA13_: ;
	{
		...
		if (!(T22_)) goto LA23_;
		T24_ = (NIM_CHAR)0;
		T24_ = X5BX5D___system_7090(ident__YHf1XAuiepoLFmQIi1E7lw, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA25_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			T36_ = (NIM_BOOL)0;
			T37_ = (NIM_CHAR)0;
			T37_ = X5BX5D___system_7090(ident__YHf1XAuiepoLFmQIi1E7lw, ((NI)1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	(*result).symkind = ((NU8) ((*s__N2N3nhxmF6allE4GMeC4Vw).kind));
	{
		...
		LA11_: ;
		{
			...
			T27_ = contains__pureZtimes_2841(T29_, (*(*s__N2N3nhxmF6allE4GMeC4Vw).name).id);
			LA28_: ;
			if (!T27_) goto LA30_;
