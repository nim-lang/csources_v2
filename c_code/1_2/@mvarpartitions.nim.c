		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			{
				...
				xX60gensym181_ = NIM_NIL;
				{
					...
					T46_ = ((*c).s.p->data[vid].reassignedTo == (NI)((NI)((NU64)(((NI) ((*xX60gensym181_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym181_).Sup.itemId.item))));
					LA47_: ;
					T44_ = T46_;
					LA45_: ;
					if (!T44_) goto LA48_;
					...
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					(*c).s.p->data[vid].reassignedTo = (NI)((NI)((NU64)(((NI) ((*xX60gensym183_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym183_).Sup.itemId.item)));
							...
							LA55_: ;
							{
								...
								if (NIM_UNLIKELY(*nimErr_)) goto LA46_;
								{
									...
									LA70_: ;
									{
										...
										if (NIM_UNLIKELY(*nimErr_)) goto LA46_;
										T73_ = !(((*c).s.p->data[srcid].reassignedTo == (NI)((NI)((NU64)(((NI) ((*xX60gensym136_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym136_).Sup.itemId.item)))));
										LA74_: ;
										if (!T73_) goto LA75_;
										(*c).s.p->data[vid].flags |= ((NU8)1)<<(((((tyEnum_VarFlag__uK6mVwFqk3i7KhNEz6AYBQ)1))) & 7);
									}
