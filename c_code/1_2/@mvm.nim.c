...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___pureZtimes_2319)(tySequence__6H5Oh5UUvVCLiakt9aTwtUQ* dest__bRX489aArlz5FM13lck9bq5Q);
...
N_LIB_PRIVATE N_NIMCALL(NF, cpuTime__pureZtimes_4324)(void);
...
N_LIB_PRIVATE N_NIMCALL(NI64, getAlign__types_3551)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf__4xqZ3jQWhErA59bUneYHpKg, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* typ__v9ceP4lUk23IYIDaQeZOmyg);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___pureZtimes_2319((&bytes));
			...
			nimZeroMem((void*)(&ai), sizeof(tyTuple__UV3llMMYFckfui8YMBuUZA));
			{
				...
				LA9_: ;
				{
					while (1) {
						...
						T14_.Field0 = substr__system_7601(kvX60gensym8_, ((NI)0), (NI)(pX60gensym8_ - ((NI)1)));
						T14_.Field1 = substr__system_7613(kvX60gensym8_, (NI)(pX60gensym8_ + ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__YbuwxgBbMPmnyoUys6f2Vg).tos2, ((NI)8));
	}
	LA9_: ;
...
static N_INLINE(NIM_BOOL, lteqpercent___system_1047)(NI x__iaAkA6each9ctoBel6MBPcw, NI y__vNzXEOBEdWZoQ54adxNLpg) {
	NIM_BOOL result;
	result = (NIM_BOOL)0;
	result = ((NU64)(((NU) (x__iaAkA6each9ctoBel6MBPcw))) <= (NU64)(((NU) (y__vNzXEOBEdWZoQ54adxNLpg))));
	return result;
}
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___vm_3816)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf__rVlzE9bRtzdpXjOeAwO2dcw, tyObject_TLineInfo__7ZAGqjaN6WqWPlHP9cRagRg info__mywt6i7nFWrEjvZy3sg9aoQ, tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA msg__7amgpqbQnMbSxcKDTE8xew, NimStringV2 arg__yJwEUlAHJmiDsnEbBB5INg, void* ClE_0) {
	tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw* colonenvP_;
	...
	LA3_: ;
	{
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)31) ... ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)35):
		{
			...
			}
			{
				...
				T104_ = lastOrd__types_1509((*c__9cvt9bwE7vk5QId5PlateZfw).config, desttyp_2);
				if (NIM_UNLIKELY(*nimErr_)) goto LA95_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)40) ... ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)44):
		{
			...
			default:
			{
				...
				NI64 destDist;
				NU64 value;
				srcSize = getSize__types_3555((*c__9cvt9bwE7vk5QId5PlateZfw).config, styp_2);
				if (NIM_UNLIKELY(*nimErr_)) goto LA111_;
				destSize = getSize__types_3555((*c__9cvt9bwE7vk5QId5PlateZfw).config, desttyp_2);
				if (NIM_UNLIKELY(*nimErr_)) goto LA111_;
...
appendString((&T1405_), colontmpD__155);
			...
			case ((tyEnum_TOpcode__g8HRIfzFsQsDBgE9cOvGknQ)152):
			{
				...
				T1713_ = (NI)0;
				{
					...
					T1716_ = (NIM_BOOL)0;
					T1717_ = (NIM_BOOL)0;
					T1717_ = eqeq___system_7567(aStrVal, ((NCSTRING) NIM_NIL));
					T1716_ = !(T1717_);
					if (!(T1716_)) goto LA1718_;
					T1719_ = (NIM_BOOL)0;
					T1719_ = eqeq___system_7567(bStrVal, ((NCSTRING) NIM_NIL));
					T1716_ = !(T1719_);
					LA1718_: ;
					if (!T1716_) goto LA1720_;
					T1722_ = (NI)0;
					T1722_ = cmpIgnoreStyle__idents_18(aStrVal, bStrVal, ((NI)IL64(9223372036854775807)));
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
