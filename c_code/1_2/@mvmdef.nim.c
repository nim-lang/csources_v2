...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_7106)(NI* dest);
...
{nimErr_ = nimErrorFlag();
	...
	LA9_: ;
	eqdestroy___pureZosproc_406((&(*dest).safePoints));
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vmdef_1508)(tySequence__L8fp6QCa2lczU05QM7SC9cg* dest) {
	NI colontmp_;
...
{nimErr_ = nimErrorFlag();
	...
	LA59_: ;
	{
		...
		if (!T63_) goto LA64_;
		eqdestroy___system_7106((*dest).templInstCounter);
