...
static N_INLINE(void, pluseq___pureZstrutils_2366)(NF* x__w9cJMWoLfD4qVFX3BaNTNNA, NF y__T0DPHSb9bMjaHM2hVl359cQw);
...
{nimErr_ = nimErrorFlag();
	tos = NIM_NIL;
	data = NIM_NIL;
	tLeave = cpuTime__pureZtimes_4324();
	...
	eqcopy___options_811(&data, (*(*(*c__1cRpTNm9cmMrP4zab9aFPw4Q).config).vmProfileData).data, NIM_FALSE);
	{
		while (1) {
			if (!!((tos == ((tyObject_TStackFrame__N30BaqTxdO9aOeBDi8omH3g*) NIM_NIL)))) goto LA3			;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				pluseq___pureZstrutils_2366((&(*T14_).time), ((NF)(tLeave) - (NF)((*prof__cFy6cZ0zE0F5LTQI3DCXyA).tEnter)));
				{
	...
	echoBinSafe(TM__Ai9anooT0gIYA9c9b30PXqgdQ_2, 1);
	{
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
				colontmpD__5 = toFileLineCol__msgs_658(conf__d9cwZEpnHek6SpLZwAX9cUGw, flMax);
				if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
