...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___pureZosproc_1686)(tyTuple__XOVT24GHXwqiEj5GCsEGCA* dest, tyTuple__XOVT24GHXwqiEj5GCsEGCA src);
...
N_LIB_PRIVATE N_NIMCALL(void, shrink__pureZosproc_1152)(tySequence__lBgZ7a89beZGYPl8PiANMTA* x, NI newLen);
...
N_LIB_PRIVATE N_NIMCALL(void, reset__cgendata_582)(tyTuple__XOVT24GHXwqiEj5GCsEGCA* obj) {
	...
	eqsink___pureZosproc_1686((&(*obj)), T1_);
}
N_LIB_PRIVATE N_NIMCALL(void, shrink__cgendata_488)(tySequence__jwzrUFjG9akTIJTBBFvvqxw* x, NI newLen) {
	{
		NI i;
		...
		(*xu).len = ((NI) (newlen));
		{
			...
			i_2 = oldLen;
			{
				while (1) {
					...
					eqsink___pureZosproc_1686((&(*(*xu).p).data[i]), T22_);
					i_2 += ((NI)1);
				} LA21: ;
			}
		}
...
N_LIB_PRIVATE N_NIMCALL(void, setLen__pureZosproc_1144)(tySequence__lBgZ7a89beZGYPl8PiANMTA* s, NI newlen) {
{	{
		NI T3_;
		T3_ = (*s).len;
		if (!(((NI) (newlen)) < T3_)) goto LA4_;
		shrink__pureZosproc_1152(s, newlen);
	}
	goto LA1_;
	LA4_: ;
	{
