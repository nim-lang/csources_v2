...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___passaux_15)(tyObject_VerboseRefcolonObjectType___jdEM1UyoXNBmCWqb429cJ1w* dest__7apOgM9aKSDq0fCM5Xtmkcg);
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___passaux_24)(tyObject_VerboseRefcolonObjectType___jdEM1UyoXNBmCWqb429cJ1w* dest__9aWM7O3VlEtjyj6EWfgmf0Q, void* env__M8Tr8DAdHhNvmh3A259b4Gw);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___passaux_15)(tyObject_VerboseRefcolonObjectType___jdEM1UyoXNBmCWqb429cJ1w* dest__7apOgM9aKSDq0fCM5Xtmkcg) {
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLastCyclicStatic((*dest__7apOgM9aKSDq0fCM5Xtmkcg).Sup.idgen, (&NTIv2__C1k2TcDRT9cU4DEatQIT09ag_));
		if (!T3_) goto LA4_;
		eqdestroy___ast_3232((*dest__7apOgM9aKSDq0fCM5Xtmkcg).Sup.idgen);
		nimRawDispose((*dest__7apOgM9aKSDq0fCM5Xtmkcg).Sup.idgen, ((NI)4));
	}
	LA4_: ;
	{
		NIM_BOOL T8_;
		T8_ = (NIM_BOOL)0;
		T8_ = nimDecRefIsLast((*dest__7apOgM9aKSDq0fCM5Xtmkcg).config);
		if (!T8_) goto LA9_;
		eqdestroy___options_3149((*dest__7apOgM9aKSDq0fCM5Xtmkcg).config);
		nimRawDispose((*dest__7apOgM9aKSDq0fCM5Xtmkcg).config, ((NI)4));
	}
	LA9_: ;
}
static N_INLINE(void, nimCopyMem)(void* dest__HMDJtGX4ficduS9cTUiey0w, void* source__xDZEU1SRcEBuZ8mtbKQBhQ, NI size__9b8g0WMA1h1RvMwHOMW7yFA) {
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___passaux_24)(tyObject_VerboseRefcolonObjectType___jdEM1UyoXNBmCWqb429cJ1w* dest__9aWM7O3VlEtjyj6EWfgmf0Q, void* env__M8Tr8DAdHhNvmh3A259b4Gw) {
	nimTraceRef(&(*dest__9aWM7O3VlEtjyj6EWfgmf0Q).Sup.idgen, (&NTIv2__C1k2TcDRT9cU4DEatQIT09ag_), env__M8Tr8DAdHhNvmh3A259b4Gw);
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TPassContext__9aUzdnrOgAbujYuO39brF9bbA*, verboseOpen__passaux_10)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* graph__mvMMyYhGyFY0QC9ajQfWAWA, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s__fL36BMxVx7hhT2W4p0BJxw, tyObject_IdGeneratorcolonObjectType___C1k2TcDRT9cU4DEatQIT09ag* idgen__PmjIacJlI105Xsv9cIB1X2Q) {
	...
	colontmpD_ = 0;
	eqcopy___options_3378(&colontmpD_, (*graph__mvMMyYhGyFY0QC9ajQfWAWA).config);
	(*T1_).config = colontmpD_;
	colontmpD__2 = 0;
	eqcopy___ast_3247(&colontmpD__2, idgen__PmjIacJlI105Xsv9cIB1X2Q, NIM_TRUE);
...
{nimErr_ = nimErrorFlag();
	...
	eqcopy___ast_3457(&result, n__hDLP08LPeEQoOKHdJG7wpA);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	v = ((tyObject_VerboseRefcolonObjectType___jdEM1UyoXNBmCWqb429cJ1w*) (context__dYi4dmbK71k1HQ0AqkmikA));
	colontmpD_ = dollar___passaux_67((*(*v).Sup.idgen));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	liMessage__msgs_1182((*v).config, (*n__hDLP08LPeEQoOKHdJG7wpA).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)90), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__OZDSE3KfNFmKaXLs9csGf8A_3, NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
