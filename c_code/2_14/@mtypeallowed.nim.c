...
{nimErr_ = nimErrorFlag();
	...
	xX60gensym89_ = NIM_NIL;
	{
		...
		T4_ = (NIM_BOOL)0;
		T4_ = containsOrIncl__astalgo_402(marker, (NI)((NI)((NU64)(((NI) ((*xX60gensym89_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym89_).Sup.itemId.item))));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T4_) goto LA5_;
		result = ((tyEnum_ViewTypeKind__ALnennKArpbLOuC2lHSncQ)0);
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T8_ = (NIM_BOOL)0;
		T8_ = containsOrIncl__astalgo_402(marker, (NI)((NI)((NU64)(((NI) ((*xX60gensym6_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym6_).Sup.itemId.item))));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T8_) goto LA9_;
		eqsink___ast_3549(&result, ((tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*) NIM_NIL));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
