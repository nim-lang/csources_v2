...
static N_INLINE(NIM_CHAR, X5BX5D___system_7003)(NimStringV2 s, NI i);
...
{nimErr_ = nimErrorFlag();
	...
	LA13_: ;
	{
		...
		if (!(T22_)) goto LA23_;
		T24_ = (NIM_CHAR)0;
		T24_ = X5BX5D___system_7003(ident, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA25_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			T36_ = (NIM_BOOL)0;
			T37_ = (NIM_CHAR)0;
			T37_ = X5BX5D___system_7003(ident, ((NI)1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___sigmatch_7590)(tyObject_Env_sigmatchdotnim_matchUserTypeClass___PD9aW11HeUq9a1eqUZIZ9a0aQ* dest) {
	...
	LA9_: ;
	eqdestroy___system_3516((&(*dest).diagnostics4));
}
static N_INLINE(void, add__system_2688)(tyObject_CellSeq__sGle0igznE2T7vk4dBh5SQ* s, void** c, TNimTypeV2* t) {
	void** colontmp_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___system_3519((&(*dest).diagnostics), (*src).diagnostics);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___system_3516((&(*dest).diagnostics));
	{
		NIM_BOOL T23_;
		T23_ = (NIM_BOOL)0;
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___system_3522((&(*c).diagnostics), T26_);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___sem_2056)(tySequence__QlpmqBu4k7qSn9cgYGyYsWw* dest) {
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			LA12_: ;
			eqdestroy___system_3516((&(*dest).p->data[colontmp_].diagnostics));
			colontmp_ += ((NI)1);
		} LA2: ;
	}
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
