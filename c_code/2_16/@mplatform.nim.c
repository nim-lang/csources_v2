...
static const struct {
  NI cap; NIM_CHAR data[5+1];
} TM__E1mVdicHuIr4qL2Kg2EGXQ_63 = { 5 | NIM_STRLIT_FLAG, "linux" };
static const NimStringV2 TM__E1mVdicHuIr4qL2Kg2EGXQ_64 = {5, (NimStrPayload*)&TM__E1mVdicHuIr4qL2Kg2EGXQ_63};
static const struct {
  NI cap; NIM_CHAR data[4+1];
