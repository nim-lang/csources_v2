...
struct tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content { NI cap; NimStringV2 data[SEQ_DECL_SIZE];};
      ...
      N_LIB_PRIVATE N_NIMCALL(NimStringV2, differs__linter_158)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf__LDCjIq3BHCtkNW9cB7IwSQw, tyObject_TLineInfo__7ZAGqjaN6WqWPlHP9cRagRg info__AFn9brJpPNUPM6kXnj3BWGg, NimStringV2 newName__stq4lK6GX1V4ymN7Ei2AoQ);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, differ__linter_96)(NimStringV2 line__Mz0dqQ0y4w3tOOj7Ppdu9bg, NI a__x8iRpr5ewua9a5ygvigKt9ag, NI b__7UnDzXZYJmaKYbqPMrcuwg, NimStringV2 x__AvB6q5QJNUCaq9bnf01JPIA);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, substrEq__linter_102)(NimStringV2 s__KENhj9apKV5NS8TQz7SZuzA, NI pos__FVNWIXMvtAqfN7lnSRv9bug, NI last__WUKR9c9bK3PqoL8ibYEnSB1A, NimStringV2 substr__k9ckLP58Sr0GsRYQA5Msnsw);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, beautifyName__linter_34)(NimStringV2 s__M8dUNXM1bKE9cCf3jNmof9bg, tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ k__8jvZkeFW49cBAmeBP3VYvFQ);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, eqtilde___linter_26)(NimStringV2 s__wGlY8Y9b2OIDyldMvcBazCg, NimStringV2* a__BNPyIPMYeKfSXooDIKgPeg, NI a__BNPyIPMYeKfSXooDIKgPegLen_0);
...
N_LIB_PRIVATE N_NIMCALL(NI, identLen__linter_13)(NimStringV2 line__8IsyPxBZWoh55Tlgvqp9b9aw, NI start__kNhdIkLuEbq9b7A9a5pMVk9cQ) {
	...
	result = (NI)0;
	{
		while (1) {
			NIM_BOOL T3_;
			T3_ = (NIM_BOOL)0;
			T3_ = ((NI)(start__kNhdIkLuEbq9b7A9a5pMVk9cQ + result) < line__8IsyPxBZWoh55Tlgvqp9b9aw.len);
			if (!(T3_)) goto LA4_;
			T3_ = (((NU8)(line__8IsyPxBZWoh55Tlgvqp9b9aw.p->data[(NI)(start__kNhdIkLuEbq9b7A9a5pMVk9cQ + result)])) >= ((NU8)(97)) && ((NU8)(line__8IsyPxBZWoh55Tlgvqp9b9aw.p->data[(NI)(start__kNhdIkLuEbq9b7A9a5pMVk9cQ + result)])) <= ((NU8)(122)) || ((NU8)(line__8IsyPxBZWoh55Tlgvqp9b9aw.p->data[(NI)(start__kNhdIkLuEbq9b7A9a5pMVk9cQ + result)])) >= ((NU8)(65)) && ((NU8)(line__8IsyPxBZWoh55Tlgvqp9b9aw.p->data[(NI)(start__kNhdIkLuEbq9b7A9a5pMVk9cQ + result)])) <= ((NU8)(90)) || ((NU8)(line__8IsyPxBZWoh55Tlgvqp9b9aw.p->data[(NI)(start__kNhdIkLuEbq9b7A9a5pMVk9cQ + result)])) >= ((NU8)(48)) && ((NU8)(line__8IsyPxBZWoh55Tlgvqp9b9aw.p->data[(NI)(start__kNhdIkLuEbq9b7A9a5pMVk9cQ + result)])) <= ((NU8)(57)) || ((NU8)(line__8IsyPxBZWoh55Tlgvqp9b9aw.p->data[(NI)(start__kNhdIkLuEbq9b7A9a5pMVk9cQ + result)])) >= ((NU8)(128)) && ((NU8)(line__8IsyPxBZWoh55Tlgvqp9b9aw.p->data[(NI)(start__kNhdIkLuEbq9b7A9a5pMVk9cQ + result)])) <= ((NU8)(255)) || ((NU8)(line__8IsyPxBZWoh55Tlgvqp9b9aw.p->data[(NI)(start__kNhdIkLuEbq9b7A9a5pMVk9cQ + result)])) == ((NU8)(95)));
			LA4_: ;
			if (!T3_) goto LA2			;
			result += ((NI)1);
		} LA2: ;
...
{	result = (NIM_BOOL)0;
	result = NIM_TRUE;
	{
		...
		i = (NI)0;
		colontmp_ = (NI)0;
		colontmp_ = substr__k9ckLP58Sr0GsRYQA5Msnsw.len;
		i_2 = ((NI)0);
		{
			while (1) {
				...
				i = i_2;
				{
					NIM_BOOL T6_;
					T6_ = (NIM_BOOL)0;
					T6_ = (last__WUKR9c9bK3PqoL8ibYEnSB1A < (NI)(pos__FVNWIXMvtAqfN7lnSRv9bug + i));
					if (T6_) goto LA7_;
					T6_ = !(((NU8)(s__KENhj9apKV5NS8TQz7SZuzA.p->data[(NI)(pos__FVNWIXMvtAqfN7lnSRv9bug + i)]) == (NU8)(substr__k9ckLP58Sr0GsRYQA5Msnsw.p->data[i])));
					LA7_: ;
					if (!T6_) goto LA8_;
					result = NIM_FALSE;
					goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	result = TM__u5vWF9bq7M9bLavMQS4OjP4A_3;
	{
		...
		T3_ = (NIM_BOOL)0;
		T3_ = substrEq__linter_102(line__Mz0dqQ0y4w3tOOj7Ppdu9bg, a__x8iRpr5ewua9a5ygvigKt9ag, b__7UnDzXZYJmaKYbqPMrcuwg, x__AvB6q5QJNUCaq9bnf01JPIA);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T3_)) goto LA4_;
		y.len = 0; y.p = NIM_NIL;
		colontmpD_ = (NI)0;
		colontmpD__2 = (NI)0;
		colontmpD_ = a__x8iRpr5ewua9a5ygvigKt9ag;
		colontmpD__2 = b__7UnDzXZYJmaKYbqPMrcuwg;
		T6_ = dotdot___stdZstrbasics_49(colontmpD_, colontmpD__2);
		y = X5BX5D___pureZstrutils_1279(line__Mz0dqQ0y4w3tOOj7Ppdu9bg, T6_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			NI T9_;
			T9_ = (NI)0;
			T9_ = nsuCmpIgnoreStyle(y, x__AvB6q5QJNUCaq9bnf01JPIA);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	line = sourceLine__msgs_1155(conf__LDCjIq3BHCtkNW9cB7IwSQw, info__AFn9brJpPNUPM6kXnj3BWGg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	first = ((((NI) (info__AFn9brJpPNUPM6kXnj3BWGg.col)) <= line.len) ? ((NI) (info__AFn9brJpPNUPM6kXnj3BWGg.col)) : line.len);
	{
	...
	result = differ__linter_96(line, first, last, newName__stq4lK6GX1V4ymN7Ei2AoQ);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	...
	newName = (*(*s__FeNW4fNke3Hrk9bJqoVGv8Q).name).s;
	badName = differs__linter_158(conf__pjmimqrVj8GOgUrkEC8BAg, info__nLgBsNLODuSTAg5bP8zKdQ, newName);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		addDeclaredLoc__astmsgs_17((&dupResult), conf__pjmimqrVj8GOgUrkEC8BAg, s__FeNW4fNke3Hrk9bJqoVGv8Q);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		T7_[2] = dupResult;
		mX60gensym15_ = nsuFormatOpenArray(TM__u5vWF9bq7M9bLavMQS4OjP4A_5, T7_, 3);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			if (!(((*conf__pjmimqrVj8GOgUrkEC8BAg).globalOptions &((NU64)1<<((NU)((((tyEnum_TGlobalOption__9bU4j0PZjdMiF7DRotXVQZw)16)))&63U)))!=0)) goto LA10_;
		...
		LA8_: ;
		liMessage__msgs_1172(conf__pjmimqrVj8GOgUrkEC8BAg, info__nLgBsNLODuSTAg5bP8zKdQ, msgX60gensym15_, mX60gensym15_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__u5vWF9bq7M9bLavMQS4OjP4A_7), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	wanted = dollar___wordrecg_302(w__1rOYXdDf9apHVtD3yoDv1ew);
	{
		...
		if (!!(eqStrings(pragmaName__pwumHvFQlnObSvQKhxtHaA, wanted))) goto LA4_;
		mX60gensym19_.len = 0; mX60gensym19_.p = NIM_NIL;
		colontmpD_ = (tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)0;
		colontmpD__2 = (tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)0;
		T7_[0] = pragmaName__pwumHvFQlnObSvQKhxtHaA;
		T7_[1] = wanted;
		T7_[2] = TM__u5vWF9bq7M9bLavMQS4OjP4A_10;
		mX60gensym19_ = nsuFormatOpenArray(TM__u5vWF9bq7M9bLavMQS4OjP4A_9, T7_, 3);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			if (!(((*conf__9cYvgz7BDfQHqMKXPT2j2cw).globalOptions &((NU64)1<<((NU)((((tyEnum_TGlobalOption__9bU4j0PZjdMiF7DRotXVQZw)16)))&63U)))!=0)) goto LA10_;
			colontmpD_ = ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17);
		...
		LA8_: ;
		liMessage__msgs_1172(conf__9cYvgz7BDfQHqMKXPT2j2cw, info__4K0EcRRe9an3R2WmLGhHT6w, msgX60gensym19_, mX60gensym19_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__u5vWF9bq7M9bLavMQS4OjP4A_11), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	{
		...
		{
			while (1) {
				if (!(i < a__BNPyIPMYeKfSXooDIKgPegLen_0)) goto LA3				;
				x = (&a__BNPyIPMYeKfSXooDIKgPeg[i]);
				{
					NIM_BOOL T6_;
					T6_ = (NIM_BOOL)0;
					T6_ = nsuStartsWith(s__wGlY8Y9b2OIDyldMvcBazCg, (*x));
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					if (!T6_) goto LA7_;
					result = NIM_TRUE;
					goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	allUpper = allCharsInSet__pureZstrutils_1495(s__M8dUNXM1bKE9cCf3jNmof9bg, TM__u5vWF9bq7M9bLavMQS4OjP4A_12);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = allUpper;
		if (!(T3_)) goto LA4_;
		T3_ = (k__8jvZkeFW49cBAmeBP3VYvFQ == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)10) || k__8jvZkeFW49cBAmeBP3VYvFQ == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)20) || k__8jvZkeFW49cBAmeBP3VYvFQ == ((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)7));
		LA4_: ;
		if (!T3_) goto LA5_;
		eqcopy___stdZassertions_16((&result), s__M8dUNXM1bKE9cCf3jNmof9bg);
		goto BeforeRet_;
	}
	LA5_: ;
	result = rawNewString(((NI) (s__M8dUNXM1bKE9cCf3jNmof9bg.len)));
	i = ((NI)0);
	switch (k__8jvZkeFW49cBAmeBP3VYvFQ) {
	...
	{
		{
			NIM_BOOL T10_;
			T10_ = (NIM_BOOL)0;
			T10_ = eqtilde___linter_26(s__M8dUNXM1bKE9cCf3jNmof9bg, TM__u5vWF9bq7M9bLavMQS4OjP4A_13, 42);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!T10_) goto LA11_;
			nimAddCharV1((&result), s__M8dUNXM1bKE9cCf3jNmof9bg.p->data[i]);
		}
		goto LA8_;
		LA11_: ;
		{
			NIM_CHAR T14_;
			T14_ = (NIM_CHAR)0;
			T14_ = nsuToUpperAsciiChar(s__M8dUNXM1bKE9cCf3jNmof9bg.p->data[i]);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	{
		nimAddCharV1((&result), s__M8dUNXM1bKE9cCf3jNmof9bg.p->data[((NI)0)]);
	}
	break;
	default:
	{
		{
			NIM_BOOL T19_;
			T19_ = (NIM_BOOL)0;
			T19_ = (s__M8dUNXM1bKE9cCf3jNmof9bg.len == ((NI)1));
			if (!(T19_)) goto LA20_;
			T19_ = ((NU8)(s__M8dUNXM1bKE9cCf3jNmof9bg.p->data[((NI)0)]) == (NU8)(76));
			LA20_: ;
			if (!T19_) goto LA21_;
		...
		LA21_: ;
		{
			NIM_BOOL T24_;
			T24_ = (NIM_BOOL)0;
			T24_ = contains__stdZprivateZospaths50_364(((s__M8dUNXM1bKE9cCf3jNmof9bg).p) ? (s__M8dUNXM1bKE9cCf3jNmof9bg.p->data) : NIM_NIL, s__M8dUNXM1bKE9cCf3jNmof9bg.len, 95);
			if (!T24_) goto LA25_;
			nimAddCharV1((&result), s__M8dUNXM1bKE9cCf3jNmof9bg.p->data[i]);
		}
		goto LA17_;
		LA25_: ;
		{
			NIM_CHAR T28_;
			T28_ = (NIM_CHAR)0;
			T28_ = nsuToLowerAsciiChar(s__M8dUNXM1bKE9cCf3jNmof9bg.p->data[((NI)0)]);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	{
		while (1) {
			if (!(i < s__M8dUNXM1bKE9cCf3jNmof9bg.len)) goto LA30			;
			{
				if (!((NU8)(s__M8dUNXM1bKE9cCf3jNmof9bg.p->data[i]) == (NU8)(95))) goto LA33_;
				{
					if (!(s__M8dUNXM1bKE9cCf3jNmof9bg.len <= (NI)(i + ((NI)1)))) goto LA37_;
				}
				goto LA35_;
				LA37_: ;
				{
					...
					T40_ = (((NI)0) < i);
					if (!(T40_)) goto LA41_;
					T40_ = (((NU8)(s__M8dUNXM1bKE9cCf3jNmof9bg.p->data[(NI)(i - ((NI)1))])) >= ((NU8)(65)) && ((NU8)(s__M8dUNXM1bKE9cCf3jNmof9bg.p->data[(NI)(i - ((NI)1))])) <= ((NU8)(90)));
					LA41_: ;
					if (!T40_) goto LA42_;
				...
				LA42_: ;
				{
					...
					i += ((NI)1);
					T45_ = (NIM_CHAR)0;
					T45_ = nsuToUpperAsciiChar(s__M8dUNXM1bKE9cCf3jNmof9bg.p->data[i]);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			...
			LA33_: ;
			{
				...
				T49_ = (NIM_CHAR)0;
				T49_ = nsuToLowerAsciiChar(s__M8dUNXM1bKE9cCf3jNmof9bg.p->data[i]);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(void, nep1CheckDefImpl__linter_132)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf__9bg1Nqt2TDmgV53bo8B8TIA, tyObject_TLineInfo__7ZAGqjaN6WqWPlHP9cRagRg info__39awJZwvHMTW5mvbIb58cNg, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* s__rqbLRplWSSfjZH37AEadYA, tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ k__daQmdgARmKETmkXx3dk2xw) {
	NimStringV2 beau;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	beau.len = 0; beau.p = NIM_NIL;
	beau = beautifyName__linter_34((*(*s__rqbLRplWSSfjZH37AEadYA).name).s, k__daQmdgARmKETmkXx3dk2xw);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		if (!!(eqStrings((*(*s__rqbLRplWSSfjZH37AEadYA).name).s, beau))) goto LA4_;
		mX60gensym9_.len = 0; mX60gensym9_.p = NIM_NIL;
		colontmpD_ = (tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)0;
		colontmpD__2 = (tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)0;
		T7_[0] = (*(*s__rqbLRplWSSfjZH37AEadYA).name).s;
		T7_[1] = beau;
		T7_[2] = TM__u5vWF9bq7M9bLavMQS4OjP4A_57;
		mX60gensym9_ = nsuFormatOpenArray(TM__u5vWF9bq7M9bLavMQS4OjP4A_56, T7_, 3);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			if (!(((*conf__9bg1Nqt2TDmgV53bo8B8TIA).globalOptions &((NU64)1<<((NU)((((tyEnum_TGlobalOption__9bU4j0PZjdMiF7DRotXVQZw)16)))&63U)))!=0)) goto LA10_;
			colontmpD_ = ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17);
		...
		LA8_: ;
		liMessage__msgs_1172(conf__9bg1Nqt2TDmgV53bo8B8TIA, info__39awJZwvHMTW5mvbIb58cNg, msgX60gensym9_, mX60gensym9_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__u5vWF9bq7M9bLavMQS4OjP4A_58), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
