...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getApplAux__pureZos_178)(NimStringV2 procPath__PBsB0Te0vnVFC1NhTz0jlg);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getApplHeuristic__pureZos_182)(void);
...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmpD__2 = substr__system_7548(path__BQBSuWQbOavg6W9czhl9bOhg, ((NI)2));
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getApplAux__pureZos_178)(NimStringV2 procPath__PBsB0Te0vnVFC1NhTz0jlg) {
	...
	len = readlink(nimToCStringConv(procPath__PBsB0Te0vnVFC1NhTz0jlg), nimToCStringConv(result), ((NI)1024));
	{
		NimStringV2 T5_;
		if (!(((NI)1024) < len)) goto LA3_;
		T5_.len = 0; T5_.p = NIM_NIL;
		T5_ = mnewString(((NI) ((NI)(len + ((NI)1)))));
		eqsink___stdZassertions_19((&result), T5_);
		len = readlink(nimToCStringConv(procPath__PBsB0Te0vnVFC1NhTz0jlg), nimToCStringConv(result), len);
	}
	LA3_: ;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		if (!T3_) goto LA5_;
		{
			...
			colontmp_ = getEnv__stdZenvvars_15(TM__yu6cxgKBBXbNsTkT9cyMd4g_18, TM__yu6cxgKBBXbNsTkT9cyMd4g_19);
			...
			splitsX60gensym36_ = ((NI)-1);
			{
				while (1) {
					...
					T20_ = substr__system_7536(colontmp_, firstX60gensym36_, (NI)(lastX60gensym36_ - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = getApplAux__pureZos_178(TM__yu6cxgKBBXbNsTkT9cyMd4g_16);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NimStringV2 T5_;
		if (!(result.len == ((NI)0))) goto LA3_;
		T5_.len = 0; T5_.p = NIM_NIL;
		T5_ = getApplHeuristic__pureZos_182();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqsink___stdZassertions_19((&result), T5_);
	}
	LA3_: ;
...
{nimErr_ = nimErrorFlag();
	...
	LA9_: ;
	path = getEnv__stdZenvvars_15(TM__yu6cxgKBBXbNsTkT9cyMd4g_20, TM__yu6cxgKBBXbNsTkT9cyMd4g_21);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		splitsX60gensym33_ = ((NI)-1);
		{
			while (1) {
				...
				T32_ = substr__system_7536(path, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__2 = (int)0;
	{
		...
		int T6_;
		T3_ = (NIM_BOOL)0;
		T3_ = WIFSIGNALED__posixZposix_1064(status__pU2PN2pUmXRydZtMya4HGg);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		T6_ = (int)0;
		T6_ = WTERMSIG__posixZposix_1055(status__pU2PN2pUmXRydZtMya4HGg);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA4_: ;
	{
		colontmpD__2 = WEXITSTATUS__posixZposix_1048(status__pU2PN2pUmXRydZtMya4HGg);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		result = colontmpD__2;
	}
	LA1_: ;
