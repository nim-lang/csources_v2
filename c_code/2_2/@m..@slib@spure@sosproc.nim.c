...
N_LIB_PRIVATE N_NIMCALL(tyObject_FileStreamObj__9bEVSsOIpkY9cf5lCtaS39bPQ*, createStream__pureZosproc_960)(int* handle, tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg fileMode);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, open__stdZsyncio_440)(FILE** f, int filehandle, tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg mode);
...
{nimErr_ = nimErrorFlag();
	...
	f = (FILE*)0;
	{
		...
		NI32 T6_;
		T3_ = (NIM_BOOL)0;
		T3_ = open__stdZsyncio_440(&f, (*handle), fileMode);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T3_)) goto LA4_;
		T6_ = (NI32)0;
		T6_ = osLastError__stdZoserrors_85();
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		T5_ = NIM_NIL;
		T5_ = createStream__pureZosproc_960((&(*p).inHandle), ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		T5_ = NIM_NIL;
		T5_ = createStream__pureZosproc_960((&(*p).outHandle), ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)0));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	T1_ = (NIM_BOOL)0;
	T1_ = WIFEXITED__posixZposix_1061(status);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	if (T1_) goto LA2_;
	T1_ = WIFSIGNALED__posixZposix_1064(status);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	LA2_: ;
	result = T1_;
	}BeforeRet_: ;
