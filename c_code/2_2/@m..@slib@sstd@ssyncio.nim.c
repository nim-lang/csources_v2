...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, modeIsDir__stdZsyncio_388)(mode_t m__1OWewsBsQDWE9b5x0Km5wgA);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, modeIsDir__stdZsyncio_388)(mode_t m__1OWewsBsQDWE9b5x0Km5wgA) {
	NIM_BOOL result;
	result = (NIM_BOOL)0;
	result = ((NI32)(m__1OWewsBsQDWE9b5x0Km5wgA & ((NI32)61440)) == ((NI32)16384));
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, close__stdZsyncio_242)(FILE* f__CEDjtcBHJC7q5ThfPqiUSQ) {
	{
...
{nimErr_ = nimErrorFlag();
	...
	p = fopen(nimToCStringConv(filename__Pf9bBf8k7d9b5DaEF1XeGdbQ), FormatOpen__stdZsyncio_382[(mode__7zsiDlzniTpJK1bQl48ucw)- 0]);
	{
		...
		f2 = ((FILE*) (p));
		{
			...
			T7_ = (((NI32)0) <= T9_);
			if (!(T7_)) goto LA10_;
			T7_ = modeIsDir__stdZsyncio_388(res.st_mode);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			LA10_: ;
			if (!T7_) goto LA11_;
		...
		(*f__jCZmwmLDt13jv0XqrjcAuQ) = ((FILE*) (p));
		{
			...
			if (!(T15_)) goto LA16_;
			T15_ = ((NU64)(((NU) (bufSize__zibzux2ygo9c1EC9aWjJNryA))) <= (NU64)(((NU)-1)));
			LA16_: ;
			if (!T15_) goto LA17_;
			T19_ = (int)0;
...
{nimErr_ = nimErrorFlag();
	result = (FILE*)0;
	{
		...
		NimStringV2 T7_;
		T3_ = (NIM_BOOL)0;
		T3_ = open__stdZsyncio_406(&result, filename__xRu8AEnl3jH9bNwPGLAIHtw, mode__x22y0JMpzDcf8HkpInwvjQ, bufSize__ETQ34IA823uFBVhI9ajVvhg);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T3_)) goto LA4_;
		T6_ = NIM_NIL;
				...
				while (1) {
					{
						...
						T10_ = (NIM_BOOL)0;
						T10_ = eqeq___system_7502(T9_, ((NCSTRING) NIM_NIL));
						fgetsSuccess = !(T10_);
						{
...
{nimErr_ = nimErrorFlag();
	...
	f = ((FILE*) NIM_NIL);
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = open__stdZsyncio_406(&f, filename__onKgAV9c1VBubD1m2zVFX6w, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)0), ((NI)-1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
...
{nimErr_ = nimErrorFlag();
	f = ((FILE*) NIM_NIL);
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = open__stdZsyncio_406(&f, filename__BWqrnwPRoDT2HTe3sAl9cXQ, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)1), ((NI)-1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
...
{nimErr_ = nimErrorFlag();
	...
	f = ((FILE*) NIM_NIL);
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = open__stdZsyncio_406(&f, filename__dxmG43SiHNphUNSZlh2xuA, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)0), ((NI)-1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		result = newSeq__stdZsyncio_512(n__e49bZTZLbOKYyO1FwMDqVPA);
		{
			NI i;
			NI colontmp_;
			NI res;
