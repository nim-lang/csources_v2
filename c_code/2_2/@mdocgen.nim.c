...
N_LIB_PRIVATE N_NIMCALL(void, writeFile__stdZsyncio_485)(NimStringV2 filename, NimStringV2 content);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, open__stdZsyncio_406)(FILE** f, NimStringV2 filename, tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg mode, NI bufSize);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, readFile__stdZsyncio_480)(NimStringV2 filename);
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD_ = substr__system_7548(rstText, ((NI)2));
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
		writeFile__stdZsyncio_485((*d).Sup.destFile, content);
		if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	{
		...
		f = (FILE*)0;
		{
			...
			NimStringV2 colontmpD__7;
			T17_ = (NIM_BOOL)0;
			T17_ = open__stdZsyncio_406(&f, (*d).Sup.destFile, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)1), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
			if (!T17_) goto LA18_;
			colontmpD__7.len = 0; colontmpD__7.p = NIM_NIL;
