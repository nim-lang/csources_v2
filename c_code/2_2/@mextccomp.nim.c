...
{nimErr_ = nimErrorFlag();
	...
	f = (FILE*)0;
	{
		...
		NIM_BOOL T12_;
		T8_ = (NIM_BOOL)0;
		T8_ = open__stdZsyncio_406(&f, hashFile, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)0), ((NI)-1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T8_) goto LA9_;
		colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
	...
	LA6_: ;
	{
		if (!result) goto LA18_;
		{
			...
			T22_ = (NIM_BOOL)0;
			T22_ = open__stdZsyncio_406(&f, hashFile, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)1), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			if (!T22_) goto LA23_;
			colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		T34_.len = 0; T34_.p = NIM_NIL;
		{
			...
			iX60gensym159_ = ((NI)0);
			T36_ = colontmp_.len;
			resultX60gensym159_ = newSeq__stdZsyncio_512(((NI) (T36_)));
			{
				NimStringV2* it;
				NI i;
				NI L;
...
appendString((&T13_), TM__pZmXgBT0YcBrnAO6VUvpNQ_213);
		...
		T14_ = execCmdEx__pureZosproc_1639(colontmpD_, 10, ((tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg*) NIM_NIL), TM__pZmXgBT0YcBrnAO6VUvpNQ_214, TM__pZmXgBT0YcBrnAO6VUvpNQ_215);
...
appendString((&T21_), TM__pZmXgBT0YcBrnAO6VUvpNQ_336);
	...
	args = substr__system_7548(cmd__9clorThsgzIMyUFcc4fDYtA, i);
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA28_;
		writeFile__stdZsyncio_485(linkerArgs, colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA28_;
		{
			LA28_:;
		}
	...
	LA26_: ;
	{
		writeFile__stdZsyncio_485(linkerArgs, args);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA22_: ;
	colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
...
appendString((&T81_), TM__pZmXgBT0YcBrnAO6VUvpNQ_329);
									...
									resX60gensym5_ = ((NI) (T82_));
									{
										if (!(resX60gensym5_ == ((NI)0))) goto LA86_;
										{
											...
											iX60gensym5_ = (NU64)0;
											colontmp__2 = (NU64)0;
											colontmp__2 = ((NU64) ((NU)((NU64)(fX60gensym5_.gl_pathc) - (NU64)(((NU)1)))));
											res = 0ULL;
											{
												while (1) {
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__10.len = 0; colontmpD__10.p = NIM_NIL;
	collectResult = newSeq__stdZsyncio_512(((NI)0));
	{
		NimStringV2* it;
		NI i;
		NI L;
	...
	bcache.cmdInput = colontmpD__7;
	{
		...
		iX60gensym116_ = ((NI)0);
		T31_ = colontmp_.len;
		resultX60gensym116_ = newSeq__stdZsyncio_512(((NI) (T31_)));
		{
			NimStringV2* it_5;
			NI i_5;
			NI L_4;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	writeFile__stdZsyncio_485((*conf__zR7V7DCLgi1YqWU0nl7VBA).jsonBuildFile, colontmpD__10);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
