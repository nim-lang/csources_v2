...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T5_ = substr__system_7548(p__Kqv4F0bZMLYwGQlsJ69ai6w, (NI)(checksumSeparatorIndex + ((NI)1)));
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T16_ = substr__system_7536(p__Kqv4F0bZMLYwGQlsJ69ai6w, (NI)(versionSeparatorIndex + ((NI)1)), (NI)(checksumSeparatorIndex - ((NI)1)));
	...
	LA14_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			T22_ = substr__system_7536(p__Kqv4F0bZMLYwGQlsJ69ai6w, (NI)(versionSeparatorIndex + ((NI)1)), (NI)(checksumSeparatorIndex - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	...
	eqcopy___stdZassertions_16((&path), p__gEHj5AaO76UJiiaK51ke3Q);
	{
		...
		resX60gensym0_ = (NI)0;
		fX60gensym0_.gl_offs = ((size_t)0);
		fX60gensym0_.gl_pathc = ((size_t)0);
		...
		resX60gensym0_ = ((NI) (T3_));
		{
			if (!(resX60gensym0_ == ((NI)0))) goto LA7_;
			{
				...
				iX60gensym0_ = (NU64)0;
				colontmp__2 = (NU64)0;
				colontmp__2 = ((NU64) ((NU)((NU64)(fX60gensym0_.gl_pathc) - (NU64)(((NU)1)))));
				res = 0ULL;
				{
					while (1) {
						NimStringV2 pathX60gensym0_;
						if (!((NU64)(res) <= (NU64)(colontmp__2))) goto LA11						;
	...
	resultX60gensym40_.len = 0; resultX60gensym40_.p = NIM_NIL;
	{
		...
		colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
		colontmpD__2 = readFile__stdZsyncio_480(nimbleLinks.p->data[((NI)0)]);
		if (NIM_UNLIKELY(*nimErr_)) goto LA23_;
