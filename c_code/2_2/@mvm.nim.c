...
N_LIB_PRIVATE N_NIMCALL(tySequence__sM4lkSb7zS6F7OVMvW9cffQ, readLines__stdZsyncio_503)(NimStringV2 filename, NI n);
...
static N_INLINE(NIM_BOOL, eqeq___system_7502)(NCSTRING x, NCSTRING y);
