...
N_LIB_PRIVATE N_NIMCALL(tySequence__sM4lkSb7zS6F7OVMvW9cffQ, readLines__stdZsyncio_503)(NimStringV2 filename__dxmG43SiHNphUNSZlh2xuA, NI n__e49bZTZLbOKYyO1FwMDqVPA);
...
static N_INLINE(NIM_BOOL, eqeq___system_7502)(NCSTRING x__Z3lojyrZeeORXB9aFmHlS7w, NCSTRING y__SlnicWIZiUaUC9cl2PfooTA);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	writeFile__stdZsyncio_485(colontmpD_, colontmpD__2);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__2 = readFile__stdZsyncio_480(colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__2 = readLines__stdZsyncio_503(colontmpD_, ((NI) (T2_)));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		...
		nimZeroMem((void*)(&xX60gensym2162_), sizeof(tyTuple__UV3llMMYFckfui8YMBuUZA));
		{
			...
			i = ((NI)0);
			{
				while (1) {
					...
					T5_ = (NIM_BOOL)0;
					T5_ = eqeq___system_7502(environ[i], ((NCSTRING) NIM_NIL));
					if (!!(T5_)) goto LA4					;
					...
					T6_.Field0 = substr__system_7536(kv, ((NI)0), (NI)(p - ((NI)1)));
					T6_.Field1 = substr__system_7548(kv, (NI)(p + ((NI)1)));
...
appendString((&T1405_), colontmpD__155);
			...
			case ((tyEnum_TOpcode__g8HRIfzFsQsDBgE9cOvGknQ)152):
			{
				...
				T1713_ = (NI)0;
				{
					...
					T1716_ = (NIM_BOOL)0;
					T1717_ = (NIM_BOOL)0;
					T1717_ = eqeq___system_7502(aStrVal, ((NCSTRING) NIM_NIL));
					T1716_ = !(T1717_);
					if (!(T1716_)) goto LA1718_;
					T1719_ = (NIM_BOOL)0;
					T1719_ = eqeq___system_7502(bStrVal, ((NCSTRING) NIM_NIL));
					T1716_ = !(T1719_);
					LA1718_: ;
