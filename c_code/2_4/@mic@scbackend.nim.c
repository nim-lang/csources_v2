...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = toFullPath__msgs_589(config__VWONLk5OGrN6IlIg7E7jug, ((NI32) (position__dqSzU0aQVLlNCABUqmBRLQ)));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	s.len = 0; s.p = NIM_NIL;
	colontmpD_ = toFullPath__msgs_589(config__JT1B9crLgjDySgZpI5tWKzg, ((NI32) (position__qYFZv9cBkircnm9bykwYKk8A)));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	filename = toFullPath__msgs_589(config__kzfZnnpxbw7Pdp511amvWw, ((NI32) ((*m__kDqzyeJItamrtJEIQvCScA).position)));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
