...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)11):
	{
		...
		colontmpD__3 = NIM_NIL;
		{
			...
			normalizedType = skipGenericAlias__types_2405(t);
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)14):
	{
		...
		LA89_: ;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			ampeq___sighashes_15(c, ((NI64) ((NI)((NI)((NU64)(((NI) ((*xX60gensym38_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym38_).Sup.itemId.item))))));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	hcX60gensym95_ = (NI)0;
	xX60gensym94_ = sym;
	indexX60gensym95_ = rawGet__sighashes_618((*graph).symBodyHashes, (NI)((NI)((NU64)(((NI) ((*xX60gensym94_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym94_).Sup.itemId.item))), (&hcX60gensym95_));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	xX60gensym99_ = sym;
	X5BX5Deq___sighashes_961((&(*graph).symBodyHashes), (NI)((NI)((NU64)(((NI) ((*xX60gensym99_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym99_).Sup.itemId.item))), Result);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		xX60gensym113_ = sym;
		X5BX5Deq___sighashes_961((&(*graph).symBodyHashes), (NI)((NI)((NU64)(((NI) ((*xX60gensym113_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym113_).Sup.itemId.item))), Result);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		{
			LA9_:;
		}
