...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___pureZosproc_1128)(tySequence__lBgZ7a89beZGYPl8PiANMTA* dest);
				...
				res = colontmp_;
				{
					while (1) {
						...
						i = res;
						{
							...
							LA25_: ;
							if (!T18_) goto LA28_;
							setLen__pureZosproc_1144((&(*parensStack)), ((NI) (i)));
							result = NIM_TRUE;
							goto LA12;
						}
						LA28_: ;
...
N_LIB_PRIVATE N_NIMCALL(NI, cmp__packagesZdocutilsZrst_11935)(tyObject_LinkDef__gm014e5aOYcvs0zK8vQ9cXg* x, tyObject_LinkDef__gm014e5aOYcvs0zK8vQ9cXg* y) {
	NI result;
	result = (NI)0;
	result = cmp__system_7197((*x).priority, (*y).priority);
	{
