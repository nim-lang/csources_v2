...
N_LIB_PRIVATE N_NIMCALL(void, insert__system_7216)(NimStringV2* x__DTZwpb30WvakZMi5tEExoQ, NimStringV2 item__VUggGQTl1GoZ0K4LU9atYlQ, NI i__8So7DQmPSR4oP2wLOLmgBA);
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		while (1) {
			...
			case ((tyEnum_TokenClass__9anxN1z0YaJHlUGz4GuizCA)2):
			{
				NimStringV2 colontmpD_;
				colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
				colontmpD_ = substr__system_7543(code__x9ctk3rvB3AvzILnPer5q5Q, g.start, (NI)((NI)(g.length + g.start) - ((NI)1)));
...
appendString((&(*result__2ZBGAR9c5v6HQJkmDlQBXbA)), colontmpD_);
			...
			default:
			{
				...
				colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
				colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
				colontmpD__2 = substr__system_7543(code__x9ctk3rvB3AvzILnPer5q5Q, g.start, (NI)((NI)(g.length + g.start) - ((NI)1)));
...
appendString((&entry), TM__vYBWrr780p7faFzauVMtPg_58);
	{
		...
		insert__system_7216((&(*d__jAnE9c8yRCyjtfvtjzacT9bQ).theIndex), entry, ((NI)0));
	}
	goto LA14_;
	LA16_: ;
	{
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		T8_ = (NIM_BOOL)0;
		T9_ = (NIM_CHAR*)0;
		T9_ = X5BX5D___system_7071((&(*n__I7Ht9a6tIsLn0IxjajzVShw)._kind_2.labelFmt), ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T8_ = ((NU8)((*T9_)) == (NU8)(41));
		if (T8_) goto LA10_;
		T11_ = (NIM_CHAR*)0;
		T11_ = X5BX5D___system_7071((&(*n__I7Ht9a6tIsLn0IxjajzVShw)._kind_2.labelFmt), ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T8_ = ((NU8)((*T11_)) == (NU8)(46));
		LA10_: ;
		if (!T8_) goto LA12_;
		...
		T14_ = (NIM_CHAR*)0;
		T14_ = X5BX5D___system_7071((&(*n__I7Ht9a6tIsLn0IxjajzVShw)._kind_2.labelFmt), ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T15_.len = 0; T15_.p = NIM_NIL;
													...
													res = rawNewString(((NI)80));
													{
														while (1) {
															...
															line = res;
															{
																...
																T119_ = substr__system_7543(line, ((NI)0), (NI)(s_2 - ((NI)1)));
																eqsink___stdZassertions_19((&fileEntries.p->data[f].keyword), T119_);
																T120_.len = 0; T120_.p = NIM_NIL;
																T120_ = substr__system_7555(line, (NI)(s_2 + ((NI)1)));
