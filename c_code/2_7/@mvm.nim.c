...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___pureZosproc_1680)(tyTuple__XOVT24GHXwqiEj5GCsEGCA* dest__qKc2jknF30aTLZ7Tc9cVb4A);
...
{nimErr_ = nimErrorFlag();
	...
	}
	{
		...
		eqdestroy___stdZassertions_13((&colontmpD__2));
		eqdestroy___stdZassertions_13((&colontmpD_));
		eqdestroy___pureZosproc_1680((&ret));
		*nimErr_ = oldNimErrFin1_;
	}
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__3 = execCmdEx__pureZosproc_1639(colontmpD__2, options, ((tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg*) NIM_NIL), TM__sQJeTKtOMm7ArbnaG0SDbQ_245, TM__sQJeTKtOMm7ArbnaG0SDbQ_246);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	}
	{
		...
		eqdestroy___ast_3454(&colontmpD__4);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqdestroy___pureZosproc_1680((&colontmpD__3));
		eqdestroy___stdZassertions_13((&colontmpD__2));
		eqdestroy___ast_3454(&colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		*nimErr_ = oldNimErrFin1_;
...
appendString((&T1405_), colontmpD__155);
			...
			case ((tyEnum_TOpcode__g8HRIfzFsQsDBgE9cOvGknQ)140):
			{
				...
				LA1602_: ;
				{
					...
					{
						eqdestroy___pureZosproc_1680((&colontmpD__157));
					}
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				}
				LA1598_: ;
