...
{nimErr_ = nimErrorFlag();
	...
	LA59_: ;
	{
		...
		if (!T63_) goto LA64_;
		eqdestroy___system_7048((*dest__VQ85TLVw12pNMG1LNNBjfA).templInstCounter);
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___vm_14312)(NI** dest__LGEyaFZVtSrspSN1k9aw9c9cw, NI* src__x1ephwfXhYmxxbH3Jg6haQ) {
	...
	LA3_: ;
	{
		...
		if (!T7_) goto LA8_;
		eqdestroy___system_7048((*dest__LGEyaFZVtSrspSN1k9aw9c9cw));
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___vm_14315)(NI** dest__88MElZFVKRCv9cRpA7sjGGA, NI* src__Upmd683sHwv0rlRHs1y9aRA) {
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLast((*dest__88MElZFVKRCv9cRpA7sjGGA));
		if (!T3_) goto LA4_;
		eqdestroy___system_7048((*dest__88MElZFVKRCv9cRpA7sjGGA));
		nimRawDispose((*dest__88MElZFVKRCv9cRpA7sjGGA), ((NI)4));
	}
	LA4_: ;
	(*dest__88MElZFVKRCv9cRpA7sjGGA) = src__Upmd683sHwv0rlRHs1y9aRA;
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vm_14309)(NI** dest__v57B4660kmxuF5BPlZ9b7oA) {
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLast((*dest__v57B4660kmxuF5BPlZ9b7oA));
		if (!T3_) goto LA4_;
		eqdestroy___system_7048((*dest__v57B4660kmxuF5BPlZ9b7oA));
