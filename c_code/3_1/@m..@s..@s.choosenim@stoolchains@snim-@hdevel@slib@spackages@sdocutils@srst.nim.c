...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___stdZenvvars_107)(tySequence__4eQHGndY6XBYpFOH09apV8Q* dest, void* env);
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___stdZenvvars_101)(tySequence__4eQHGndY6XBYpFOH09apV8Q* dest, tySequence__4eQHGndY6XBYpFOH09apV8Q src);
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			case ((tyEnum_AnchorRule__g9b7A1W7y7TqDINcOHWBCuA)1):
			{
				...
				eqdestroy___stdZenvvars_98((&(*dest).p->data[colontmp_]._kind_2.langSym.parameters));
...
{nimErr_ = nimErrorFlag();
	...
	eqdestroy___system_3516((&(*dest).filenames.idxToFilename));
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___packagesZdocutilsZrst_2804)(tySequence__KaZEC9alGb0qEnwuLoUB4EQ* dest, void* env) {
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			case ((tyEnum_AnchorRule__g9b7A1W7y7TqDINcOHWBCuA)1):
			{
				eqtrace___stdZenvvars_107((&(*dest).p->data[colontmp_]._kind_2.langSym.parameters), env);
			}
			break;
			}
			colontmp_ += ((NI)1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___packagesZdocutilsZrst_12528)(tyObject_RstFileTable__1rYTAF4X28SkQlz9cTtPDzQ* dest, tyObject_RstFileTable__1rYTAF4X28SkQlz9cTtPDzQ src) {
	...
	eqcopy___system_3519((&(*dest).idxToFilename), src.idxToFilename);
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___packagesZdocutilsZrst_12525)(tyObject_RstFileTable__1rYTAF4X28SkQlz9cTtPDzQ* dest) {
	...
	eqdestroy___system_3516((&(*dest).idxToFilename));
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___packagesZdocutilsZrst_5263)(tySequence__h3lxIYk9bDFo9a6O25fEkVTQ* dest) {
	NI colontmp_;
	colontmp_ = ((NI)0);
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_AnchorRule__g9b7A1W7y7TqDINcOHWBCuA)1):
	{
		...
		eqdestroy___stdZenvvars_98((&(*dest)._kind_2.langSym.parameters));
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			case ((tyEnum_AnchorRule__g9b7A1W7y7TqDINcOHWBCuA)1):
			{
				...
				eqcopy___stdZenvvars_101((&(*dest).p->data[colontmp_]._kind_2.langSym.parameters), src.p->data[colontmp_]._kind_2.langSym.parameters);
				...
				res = colontmp_;
				{
					while (1) {
						...
						i = res;
						{
							...
							LA25_: ;
							if (!T18_) goto LA28_;
							setLen__pureZosproc_1118((&(*parensStack)), ((NI) (i)));
							result = NIM_TRUE;
							goto LA12;
						}
						LA28_: ;
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_AnchorRule__g9b7A1W7y7TqDINcOHWBCuA)1):
	{
		...
		eqcopy___stdZenvvars_101((&(*dest)._kind_2.langSym.parameters), (*src)._kind_2.langSym.parameters);
...
N_LIB_PRIVATE N_NIMCALL(NI, cmp__packagesZdocutilsZrst_11935)(tyObject_LinkDef__gm014e5aOYcvs0zK8vQ9cXg* x, tyObject_LinkDef__gm014e5aOYcvs0zK8vQ9cXg* y) {
	NI result;
	result = (NI)0;
	result = cmp__system_7178((*x).priority, (*y).priority);
	{
