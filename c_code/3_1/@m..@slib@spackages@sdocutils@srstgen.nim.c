...
N_LIB_PRIVATE N_NIMCALL(void, insert__system_7197)(NimStringV2* x__DTZwpb30WvakZMi5tEExoQ, NimStringV2 item__VUggGQTl1GoZ0K4LU9atYlQ, NI i__8So7DQmPSR4oP2wLOLmgBA);
...
static N_INLINE(NimStringV2, pop__stdZprivateZosdirs_399)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ* s__dqv9aRwjnxs49cmtMVamMPNw_2);
N_LIB_PRIVATE N_NIMCALL(void, shrink__system_3398)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ* x__c3LPB9cI6CRmypw4Xw7dI9ag_6, NI newLen__z9axmEZwQfCqmWiagCNbWog_6);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, multiReplace__pureZstrutils_1868)(NimStringV2 s__gehbjPq1HBgp0CrTj0htPw, tyTuple__UV3llMMYFckfui8YMBuUZA* replacements__lnA6ZAXC2Qg9cPSVjf5tCyg, NI replacements__lnA6ZAXC2Qg9cPSVjf5tCygLen_0);
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		while (1) {
			...
			case ((tyEnum_TokenClass__9anxN1z0YaJHlUGz4GuizCA)2):
			{
				NimStringV2 colontmpD_;
				colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
				colontmpD_ = substr__system_7524(code__x9ctk3rvB3AvzILnPer5q5Q, g.start, (NI)((NI)(g.length + g.start) - ((NI)1)));
...
appendString((&(*result__2ZBGAR9c5v6HQJkmDlQBXbA)), colontmpD_);
			...
			default:
			{
				...
				colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
				colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
				colontmpD__2 = substr__system_7524(code__x9ctk3rvB3AvzILnPer5q5Q, g.start, (NI)((NI)(g.length + g.start) - ((NI)1)));
...
appendString((&entry), TM__vYBWrr780p7faFzauVMtPg_58);
	{
		...
		insert__system_7197((&(*d__jAnE9c8yRCyjtfvtjzacT9bQ).theIndex), entry, ((NI)0));
	}
	goto LA14_;
	LA16_: ;
	{
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		T8_ = (NIM_BOOL)0;
		T9_ = (NIM_CHAR*)0;
		T9_ = X5BX5D___system_7052((&(*n__I7Ht9a6tIsLn0IxjajzVShw)._kind_2.labelFmt), ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T8_ = ((NU8)((*T9_)) == (NU8)(41));
		if (T8_) goto LA10_;
		T11_ = (NIM_CHAR*)0;
		T11_ = X5BX5D___system_7052((&(*n__I7Ht9a6tIsLn0IxjajzVShw)._kind_2.labelFmt), ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T8_ = ((NU8)((*T11_)) == (NU8)(46));
		LA10_: ;
		if (!T8_) goto LA12_;
		...
		T14_ = (NIM_CHAR*)0;
		T14_ = X5BX5D___system_7052((&(*n__I7Ht9a6tIsLn0IxjajzVShw)._kind_2.labelFmt), ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T15_.len = 0; T15_.p = NIM_NIL;
...
static N_INLINE(NimStringV2, pop__stdZprivateZosdirs_399)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ* s__dqv9aRwjnxs49cmtMVamMPNw_2) {
	...
	shrink__system_3398(s__dqv9aRwjnxs49cmtMVamMPNw_2, ((NI) (L)));
	return result;
}
static N_INLINE(NimStringV2, slash___stdZprivateZospaths50_91)(NimStringV2 head__FvXxZomX43yHXHeHusSc7w, NimStringV2 tail__im27oCs80zvzy6b39b3bJTg) {
	NimStringV2 result;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = multiReplace__pureZstrutils_1868(text__1KYsVXvI9cpBhWjP0QZe69ag, TM__vYBWrr780p7faFzauVMtPg_672, 3);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___system_3522((&(*Result).Field0), T1_);
									...
									y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
									{
										...
										LA88_: ;
										{
											...
											LA97_: ;
											{
												...
												T100_ = slash___stdZprivateZospaths50_91(dir__cBp8odv2bxuJHbQpeE9cjJw, rel);
												if (NIM_UNLIKELY(*nimErr_)) goto LA37_;
												...
												setLen__packagesZdocutilsZrstgen_2469((&fileEntries), ((NI)0));
												{
													...
													res = rawNewString(((NI)80));
													{
														while (1) {
															NIM_BOOL T113_;
															T113_ = (NIM_BOOL)0;
															T113_ = readLine__stdZsyncio_265(f_2, (&res));
															...
															line = res;
															{
																...
																T119_ = substr__system_7524(line, ((NI)0), (NI)(s_2 - ((NI)1)));
																eqsink___stdZassertions_19((&fileEntries.p->data[f].keyword), T119_);
																T120_.len = 0; T120_.p = NIM_NIL;
																T120_ = substr__system_7536(line, (NI)(s_2 + ((NI)1)));
																...
																LA125_: ;
																{
																	...
																	eqdestroy___system_3516((&extraCols));
																}
																goto LA127_;
																LA130_: ;
																{
...
appendString((&result), colontmpD__2);
	eqdestroy___stdZassertions_13((&colontmpD__2));
	eqdestroy___stdZassertions_13((&colontmpD_));
	eqdestroy___system_3516((&chunks));
