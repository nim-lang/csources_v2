...
N_LIB_PRIVATE N_NIMCALL(tyObject_ZonedTime__WigfH9apQAxJ69bBPh3wB8RQ, zonedTimeFromTime__pureZtimes_1479)(tyObject_TimezonecolonObjectType___F8OvqlxXyGXRSiK9c1fCDVw* zone, tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q time);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_ZonedTime__WigfH9apQAxJ69bBPh3wB8RQ, utcTzInfo__pureZtimes_1660)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q time);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_ZonedTime__WigfH9apQAxJ69bBPh3wB8RQ, localZonedTimeFromTime__pureZtimes_1633)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q time);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_ZonedTime__WigfH9apQAxJ69bBPh3wB8RQ, localZonedTimeFromAdjTime__pureZtimes_1638)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q adjTime);
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	T1_ = zonedTimeFromTime__pureZtimes_1479(zone, time);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	blitTmp = zone;
	nimMarkCyclic(zone);
...
{nimErr_ = nimErrorFlag();
	...
	T1_ = (NI64)0;
	T1_ = clamp__pureZtimes_1585(unix_0, IL64(-2147483648), IL64(2147483647));
	a = ((long) (T1_));
	tmPtr = localtime((&a));
	{
		struct tm tm;
