...
N_LIB_PRIVATE N_NIMCALL(void, utc__pureZtimes_1693)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q t__zZPmP60IMoFvRYU4VNvHQw, tyObject_DateTime__d9cK9cyKZPJJxFXUmx8dSpPw* Result);
N_LIB_PRIVATE N_NIMCALL(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q, fromUnix__pureZtimes_1023)(NI64 unix__e9b0JTwPaEjvkW9bV9c1pdoxA);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___options_3149)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* dest__jjXLqLv8SE2IeCJIJka0WQ) {
	...
	eqdestroy___system_3516((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).commandArgs));
	eqdestroy___stdZassertions_13((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).commandLine));
	eqdestroy___system_3516((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).extraCmds));
	eqdestroy___system_3516((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).implicitImports));
	eqdestroy___system_3516((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).implicitIncludes));
	...
	eqdestroy___system_3516((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).cLinkedLibs));
	eqdestroy___system_3516((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).externalToLink));
	eqdestroy___stdZassertions_13((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).linkOptionsCmd));
	eqdestroy___system_3516((&(*dest__jjXLqLv8SE2IeCJIJka0WQ).compileOptionsCmd));
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		if (!(T3_)) goto LA4_;
		T5_ = (NIM_CHAR)0;
		T5_ = X5BX5D___system_7013(path__rDlV0AybldUJC43fBJPMOQ, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T3_ = ((NU8)(T5_) == (NU8)(47));
		LA4_: ;
		if (!T3_) goto LA6_;
		result = substr__system_7524(path__rDlV0AybldUJC43fBJPMOQ, ((NI)0), (NI)(path__rDlV0AybldUJC43fBJPMOQ.len - ((NI)2)));
	}
	goto LA1_;
	LA6_: ;
	{
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		result = substr__system_7524(s__1ceeuiYOZLpou68rQyB42A, start, (NI)(ende - ((NI)1)));
	}
	goto LA7_;
	LA9_: ;
	{
		result = substr__system_7536(s__1ceeuiYOZLpou68rQyB42A, start);
	}
	LA7_: ;
	}BeforeRet_: ;
	return result;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___modulegraphs_9583)(tyObject_SuggestcolonObjectType___fw9a9cWgWYzM4zKmnq3DGNfQ* dest__KkxjkIXl3Vr9aVDMQp9aBXBA) {
	eqdestroy___system_3516((&(*dest__KkxjkIXl3Vr9aVDMQp9aBXBA).qualifiedPath));
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	T5_ = fromUnix__pureZtimes_1023(((NI64) (T4_)));
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	utc__pureZtimes_1693(T5_, Result);
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	{
		LA2_:;
	}
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3978211584)) {
			...
			*nimErr_ = NIM_FALSE;
			T11_ = getTime__pureZtimes_1089();
			if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
			utc__pureZtimes_1693(T11_, Result);
			if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
			popCurrentException();
			LA9_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___pureZtimes_1420((&colontmpD_));
	}BeforeRet_: ;
	return result;
}
