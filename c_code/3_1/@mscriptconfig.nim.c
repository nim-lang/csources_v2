...
static N_INLINE(NimStringV2, getCurrentExceptionMsg__system_6843)(void);
...
N_LIB_PRIVATE N_NIMCALL(NI64, toUnix__pureZtimes_1038)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q t__oNZbLy6y2BFghd7QANf19ag);
...
{nimErr_ = nimErrorFlag();
	...
	{
		eqdestroy___system_3516((&result));
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T5_ = getCurrentExceptionMsg__system_6843();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T17_ = getCurrentExceptionMsg__system_6843();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T16_ = getCurrentExceptionMsg__system_6843();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T9_ = getCurrentExceptionMsg__system_6843();
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	T5_ = (NI64)0;
	T5_ = toUnix__pureZtimes_1038(T4_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			T11_.len = 0; T11_.p = NIM_NIL;
			T11_ = getCurrentExceptionMsg__system_6843();
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			T10_.len = 0; T10_.p = NIM_NIL;
			T10_ = getCurrentExceptionMsg__system_6843();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T14_ = getCurrentExceptionMsg__system_6843();
...
{nimErr_ = nimErrorFlag();
	...
	LA6_: ;
	{
		...
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		T10_.len = 0; T10_.p = NIM_NIL;
		T10_ = readLine__stdZsyncio_301(__stdinp);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD_ = T10_;
...
{nimErr_ = nimErrorFlag();
	...
	LA6_: ;
	{
		...
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		T10_.len = 0; T10_.p = NIM_NIL;
		T10_ = readAll__stdZsyncio_363(__stdinp);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD_ = T10_;
