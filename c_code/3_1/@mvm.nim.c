...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vm_14374)(tyObject_Env_vmopsdotnim_registerAdditionalOps___LxXp7D69cWfYw9aWrWTPm9aEw* dest__9b4vKDO4LWGpjH0OUZMgLlA);
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___vm_14383)(tyObject_Env_vmopsdotnim_registerAdditionalOps___LxXp7D69cWfYw9aWrWTPm9aEw* dest__OQ6rlHVJgzqtddF9aeaMqeg, void* env__fzUe6xZ9cutrkdqgHf9avy0g);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vm_14392)(tyObject_Env_vmopsdotnim_registerAdditionalOps___LxXp7D69cWfYw9aWrWTPm9aEw** dest__9b4vKDO4LWGpjH0OUZMgLlA_2);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vm_14628)(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw* dest__YbuwxgBbMPmnyoUys6f2Vg);
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___vm_14637)(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw* dest__6eNh5sAAKq2nxNkqmJypcA, void* env__qu9aTBl9bQUlbkdXYqEnrwHA);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vm_14652)(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw** dest__YbuwxgBbMPmnyoUys6f2Vg_2);
...
N_LIB_PRIVATE TNimTypeV2 NTIv2__LxXp7D69cWfYw9aWrWTPm9aEw_ = {.destructor = (void*)eqdestroy___vm_14374, .size = sizeof(tyObject_Env_vmopsdotnim_registerAdditionalOps___LxXp7D69cWfYw9aWrWTPm9aEw), .align = (NI16) NIM_ALIGNOF(tyObject_Env_vmopsdotnim_registerAdditionalOps___LxXp7D69cWfYw9aWrWTPm9aEw), .depth = 1, .display = TM__sQJeTKtOMm7ArbnaG0SDbQ_9, .traceImpl = (void*)eqtrace___vm_14383, .flags = 0};
static NIM_CONST NU32 TM__sQJeTKtOMm7ArbnaG0SDbQ_291[2] = {3701606400, 222336512};
N_LIB_PRIVATE TNimTypeV2 NTIv2__MQ1AlqG1N9bgo6MqEx9b4njw_ = {.destructor = (void*)eqdestroy___vm_14628, .size = sizeof(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw), .align = (NI16) NIM_ALIGNOF(tyObject_Env_vmdotnim_rawExecute___MQ1AlqG1N9bgo6MqEx9b4njw), .depth = 1, .display = TM__sQJeTKtOMm7ArbnaG0SDbQ_291, .traceImpl = (void*)eqtrace___vm_14637, .flags = 0};
static N_INLINE(void, nimSetMem__systemZmemory_7)(void* a__tZiCJHYy5dYyAh9cxwrrVhQ, int v__iM7JOvZxArJIvbhGyRZG6Q, NI size__ntsFNLS0mpvnjQFrZT7DCw) {
	void* T1_;
	T1_ = (void*)0;
...
{nimErr_ = nimErrorFlag();
	...
	eqdestroy___ast_3454(&colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___stdZenvvars_98((&resultX60gensym2144_));
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___vm_13993)(tyObject_VmArgs__m5KtcByJU2AdS9bbHP7rUig* a__ontuFbgzZoxWzRQBe29bDWA_20, void* ClE_0) {
	tyObject_Env_vmopsdotnim_registerAdditionalOps___LxXp7D69cWfYw9aWrWTPm9aEw* colonenvP_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___vm_14392(&colonenv_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, setupGlobalCtx__vm_14018)(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* module__AAKg9bcU1bs0L8gnnCfmnhw, tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* graph__WNnSv109bBM39b8Y9c4AiPQqw, tyObject_IdGeneratorcolonObjectType___C1k2TcDRT9cU4DEatQIT09ag* idgen__QkWnNMVYZYvuDTG9cFfoYbA) {
	...
	savedPC = ((NI)-1);
	{
		while (1) {
			...
			case ((tyEnum_TOpcode__g8HRIfzFsQsDBgE9cOvGknQ)0):
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				eqdestroy___vm_14652(&colonenv_);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				goto BeforeRet_;
			}
			break;
