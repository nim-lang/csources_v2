...
{nimErr_ = nimErrorFlag();
	...
	filename = toFullPath__msgs_589((*graph__uNAkReq0oHr9bUMZ0apLbBg).config, fileIdx__oD3hFRf4EApOxM9cASvyDnA);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_ = NIM_NIL;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	(*T2_).info = newLineInfo__msgs_408(fileIdx__oD3hFRf4EApOxM9cASvyDnA, ((NI)1), ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = T2_;
	{
		NIM_BOOL T5_;
...
appendString((&T9_), (*(*result).name).s);
		colontmpD__3 = T9_;
		liMessage__msgs_1172((*graph__uNAkReq0oHr9bUMZ0apLbBg).config, unknownLineInfo__lineinfos_338, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__PSTsdGjzLcJhNmbZsJdP6w_4), NIM_FALSE);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		filename = toFullPath__msgs_589((*graph__9bcjXAtWV8LUDw50psF7YWw).config, fileIdx__a3gGYXVY0NtakjVtCPJ9bKw);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		{
...
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T4_) goto LA5_;
		liMessage__msgs_1172(conf__9cf9cVT19az14UGPWI7V6emVw, gCmdLineInfo__msgs_431, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)1), TM__PSTsdGjzLcJhNmbZsJdP6w_15, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__PSTsdGjzLcJhNmbZsJdP6w_16), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA5_: ;
