...
appendString((&(*config__c2l2mlnF69bH9brbTPUieDHg).commandLine), colontmpD__3);
	...
	} LA4: ;
	{
		if (!(pass__W7RvG3WMGUw4749coIooD9bA == ((tyEnum_TCmdLinePass__7z2Tds19a2G5eslO9cP9apH4w)1))) goto LA36_;
		{
			...
			LA44_: ;
			if (!T40_) goto LA45_;
			liMessage__msgs_1172(config__c2l2mlnF69bH9brbTPUieDHg, unknownLineInfo__lineinfos_338, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__xOfksDa5lOpfO1acT4wYQg_8, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__xOfksDa5lOpfO1acT4wYQg_9), NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		}
		LA45_: ;
	}
...
appendString((&T74_), (*conf__vzx7iwMPDm1Uf9bxV2YL1UA).arguments);
		...
		case ((tyEnum_Command__b145RBTl7bacomLHdBguHg)20) ... ((tyEnum_Command__b145RBTl7bacomLHdBguHg)23):
		{
			...
			colontmpD__8.len = 0; colontmpD__8.p = NIM_NIL;
			{
				...
				liMessage__msgs_1172(conf__vzx7iwMPDm1Uf9bxV2YL1UA, unknownLineInfo__lineinfos_338, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__10, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__xOfksDa5lOpfO1acT4wYQg_42), NIM_FALSE);
				if (NIM_UNLIKELY(*nimErr_)) goto LA83_;
				{
					LA83_:;
				}
		...
		default:
		{
			...
			liMessage__msgs_1172(conf__vzx7iwMPDm1Uf9bxV2YL1UA, unknownLineInfo__lineinfos_338, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__12, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__xOfksDa5lOpfO1acT4wYQg_45), NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA90_;
			{
				LA90_:;
			}
...
nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	msgQuit__msgs_468(((NI8) ((((NI)0) < (*conf__nim_167).errorCounter))));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
