...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		if (!(T3_)) goto LA4_;
		T5_ = (NIM_CHAR)0;
		T5_ = X5BX5D___system_7044(path__rDlV0AybldUJC43fBJPMOQ, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T3_ = ((NU8)(T5_) == (NU8)(47));
		LA4_: ;
		if (!T3_) goto LA6_;
		result = substr__system_7555(path__rDlV0AybldUJC43fBJPMOQ, ((NI)0), (NI)(path__rDlV0AybldUJC43fBJPMOQ.len - ((NI)2)));
	}
	goto LA1_;
	LA6_: ;
	{
...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nossplitFile((*conf__ZMaE7u9b1MVVmuEbN07b27A).projectName, (&colontmpD__2));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
appendString((&T21_), subdir);
	...
	LA4_: ;
	nossplitPath(f__0zCCeaS7SL116sbMt9b5USA, (&colontmpD_));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nossplitPath(path__MvaYPBAn2DL8ZsLHx7CdfQ, (&colontmpD__2));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		if (!T4_) goto LA5_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		colontmpD_ = substr__system_7567(m, ((NI)4));
	...
	{
		{
			...
			stripped = substr__system_7567(m, ((NI)4));
			{
		...
		LA14_: ;
		{
			...
			nimZeroMem((void*)(&colontmpD__3), sizeof(tyTuple__7q7q3E6Oj24ZNVJb9aonhAg));
			nossplitFile(currentModule__AO4QC9aIaWNqGPoK26Asodw, (&colontmpD__3));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		result = substr__system_7555(s__1ceeuiYOZLpou68rQyB42A, start, (NI)(ende - ((NI)1)));
	}
	goto LA7_;
	LA9_: ;
	{
		result = substr__system_7567(s__1ceeuiYOZLpou68rQyB42A, start);
	}
	LA7_: ;
	}BeforeRet_: ;
	return result;
...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	T15_.len = 0; T15_.p = NIM_NIL;
	T15_ = canonicalizePath__options_4988(conf__ufOPoT9b8KW9acKlUWNhFvyw, dir);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
