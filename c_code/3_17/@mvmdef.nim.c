...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__VQ85TLVw12pNMG1LNNBjfA_2).next, ((NI)8));
	}
	LA9_: ;
...
{nimErr_ = nimErrorFlag();
	...
	LA24_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__VQ85TLVw12pNMG1LNNBjfA).prc, ((NI)8));
	}
	LA29_: ;
	{
		NIM_BOOL T33_;
	...
	eqdestroy___stdZassertions_13((&(*dest__VQ85TLVw12pNMG1LNNBjfA).errorFlag));
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__VQ85TLVw12pNMG1LNNBjfA).cache, ((NI)8));
	}
	LA44_: ;
	{
		NIM_BOOL T48_;
	...
	LA54_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__VQ85TLVw12pNMG1LNNBjfA).profiler.tos, ((NI)8));
	}
	LA59_: ;
	{
		NIM_BOOL T63_;
		...
		if (!T63_) goto LA64_;
		eqdestroy___system_7060((*dest__VQ85TLVw12pNMG1LNNBjfA).templInstCounter);
		nimRawDispose((*dest__VQ85TLVw12pNMG1LNNBjfA).templInstCounter, ((NI)8));
	}
	LA64_: ;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__d9bVKOxasxVL7CiPMPCozSw_2), ((NI)8));
	}
	LA8_: ;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__VQ85TLVw12pNMG1LNNBjfA), ((NI)8));
	}
	LA4_: ;
	}BeforeRet_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___vm_14300)(NI** dest__LGEyaFZVtSrspSN1k9aw9c9cw, NI* src__x1ephwfXhYmxxbH3Jg6haQ) {
	...
	LA3_: ;
	{
		...
		if (!T7_) goto LA8_;
		eqdestroy___system_7060((*dest__LGEyaFZVtSrspSN1k9aw9c9cw));
		nimRawDispose((*dest__LGEyaFZVtSrspSN1k9aw9c9cw), ((NI)8));
	}
	LA8_: ;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__lD9cJ030aOEE73bmE9b5RoFg_2), ((NI)8));
	}
	LA4_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___vm_14303)(NI** dest__88MElZFVKRCv9cRpA7sjGGA, NI* src__Upmd683sHwv0rlRHs1y9aRA) {
	{
		...
		if (!T3_) goto LA4_;
		eqdestroy___system_7060((*dest__88MElZFVKRCv9cRpA7sjGGA));
		nimRawDispose((*dest__88MElZFVKRCv9cRpA7sjGGA), ((NI)8));
	}
	LA4_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___vm_14297)(NI** dest__v57B4660kmxuF5BPlZ9b7oA) {
	{
		...
		if (!T3_) goto LA4_;
		eqdestroy___system_7060((*dest__v57B4660kmxuF5BPlZ9b7oA));
		nimRawDispose((*dest__v57B4660kmxuF5BPlZ9b7oA), ((NI)8));
	}
	LA4_: ;
}
