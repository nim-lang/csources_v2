		...
		while (1) {
			...
			LA16_: ;
			{
				...
				LA30_: ;
				{
					...
					LA45_: ;
					colontmpD_ = substr__system_7536(x__HhJ3EvK0Pc3JWVNbj9boH1A, b.Field0, b.Field1);
...
appendString((&(*result__rUHqnSyl9c0bChyYf3nrLkQ)), colontmpD_);
			...
			LA49_: ;
			{
				...
				LA58_: ;
				colontmpD__2 = substr__system_7536(x__HhJ3EvK0Pc3JWVNbj9boH1A, b.Field0, b.Field1);
