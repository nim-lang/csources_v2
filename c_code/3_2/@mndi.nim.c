...
appendString((&(*f__9bIKwEhGklKyM6hDLd9csM9ag).buf), TM__9bjXlRg9ajY35u7ap75QbU6A_5);
	...
	write__stdZsyncio_334((*f__9bIKwEhGklKyM6hDLd9csM9ag).f, T2_, 2);
...
{nimErr_ = nimErrorFlag();
	{
		...
		T5_ = (FILE*)0;
		T5_ = open__stdZsyncio_449((*f__9b2ZHe25BpJYalN7T4bN4XQ).filename, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)1), ((NI)8000));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
appendString((&T10_), (*f__9b2ZHe25BpJYalN7T4bN4XQ).filename);
		...
		close__stdZsyncio_243((*f__9b2ZHe25BpJYalN7T4bN4XQ).f);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
