...
{nimErr_ = nimErrorFlag();
	...
	owner = NIM_NIL;
	counter = ((NI)0);
	tupleType = newTypeS__semdata_2347(((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)18), c__IrGM3SvOxP9cr6oBR9bn6YTQ);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = newNodeIT__ast_3970(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)160), (*n__Yo2WLz4xwkrlaNmOY1kssg).info, tupleType);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_ = NIM_NIL;
	T2_ = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)138), (*n__Yo2WLz4xwkrlaNmOY1kssg).info);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqsink___ast_3460(&(*tupleType).n, T2_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	owner = getCurrOwner__semdata_325(c__IrGM3SvOxP9cr6oBR9bn6YTQ);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		scope = NIM_NIL;
		{
			...
			s = NIM_NIL;
			current = NIM_NIL;
			eqcopy___lookups_82(&current, (*c__IrGM3SvOxP9cr6oBR9bn6YTQ).currentScope);
			if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
			{
				while (1) {
					...
					s = current;
					{
						if (!(s == (*c__IrGM3SvOxP9cr6oBR9bn6YTQ).topLevelScope)) goto LA10_;
							...
							while (1) {
								...
								it = s_2;
								{
									...
									if (!T17_) goto LA19_;
									{
										...
										T25_ = nextSymId__ast_3268((*c__IrGM3SvOxP9cr6oBR9bn6YTQ).Sup.idgen);
										if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
										T26_ = 0;
										field = newSym__ast_4028(((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)19), (*it).name, T25_, owner, (*n__Yo2WLz4xwkrlaNmOY1kssg).info, T26_);
										if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
										T27_ = NIM_NIL;
										...
										if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
										addSonSkipIntLit__magicsys_137(tupleType, (*field).typ, (*c__IrGM3SvOxP9cr6oBR9bn6YTQ).Sup.idgen);
										if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
