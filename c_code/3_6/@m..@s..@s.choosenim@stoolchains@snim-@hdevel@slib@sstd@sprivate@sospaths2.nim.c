...
static N_INLINE(NIM_CHAR, X5BX5D___system_7015)(NimStringV2 s, NI i);
...
{nimErr_ = nimErrorFlag();
	...
	if (!(T2_)) goto LA3_;
	T4_ = (NIM_CHAR)0;
	T4_ = X5BX5D___system_7015(tail, ((NI)1));
	...
	if (!(T8_)) goto LA9_;
	T10_ = (NIM_CHAR*)0;
	T10_ = X5BX5D___system_7054(result, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(void, nossplitPath)(NimStringV2 path, tyTuple__UV3llMMYFckfui8YMBuUZA* Result) {
	...
	} LA1: ;
	{
		...
		T19_ = substr__system_7526(path, ((NI)0), T12_);
		eqsink___stdZassertions_19((&(*Result).Field0), T19_);
		T20_.len = 0; T20_.p = NIM_NIL;
		T20_ = substr__system_7538(path, (NI)(sepPos + ((NI)1)));
			...
			while (1) {
				...
				i = res;
				{
					...
					if (!T6_) goto LA8_;
					{
						...
						T21_ = substr__system_7526(path, ((NI)0), T14_);
					...
					LA12_: ;
					{
						...
						T26_ = substr__system_7526(path, namePos, (NI)(dotPos - ((NI)1)));
						eqsink___stdZassertions_19((&(*Result).Field1), T26_);
						T27_.len = 0; T27_.p = NIM_NIL;
						T27_ = substr__system_7538(path, dotPos);
					...
					LA24_: ;
					{
						...
						T29_ = substr__system_7538(path, namePos);
...
appendString((&T5_), colontmpD_);
	...
	LA3_: ;
	{
		...
		colontmpD__2 = substr__system_7526(filename, ((NI)0), (NI)(extPos - ((NI)1)));
