...
{nimErr_ = nimErrorFlag();
	...
	result = initTime__pureZtimes_1016(((NI64) (ts__19cpx3HDvAj5RDxP2P2xd2g.tv_sec)), ((NI) (ts__19cpx3HDvAj5RDxP2P2xd2g.tv_nsec)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	result = toTime__pureZos_27(res.st_mtimespec);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
