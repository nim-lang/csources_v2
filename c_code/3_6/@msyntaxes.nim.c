...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		LA11_: ;
		{
			...
			colontmpD_ = substr__system_7538(line, i);
...
appendString((&T12_), colontmpD_);
		colontmpD__2 = T12_;
		liMessage__msgs_1182(conf__iS6ClgbDagceUQ9coPsLsGw, (*n__ZIik7pyBLLdxjZtQfM24jA).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__xy1U79cq9cILOyMzz14OxC9cQ_19), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
		{
			LA11_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	}
	{
		if (!!((f == ((tyEnum_FilterKind__t9bIe7ZGeUa2Zu5efx1vWJA)0)))) goto LA9_;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			if (!T13_) goto LA14_;
			liMessage__msgs_1182((*p__yteBjD7tjnz9a0X1ZoR2f4g).lex.config, unknownLineInfo__lineinfos_338, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)91), TM__xy1U79cq9cILOyMzz14OxC9cQ_21, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__xy1U79cq9cILOyMzz14OxC9cQ_22), NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			T16_ = 0;
			msgWriteln__msgs_708((*p__yteBjD7tjnz9a0X1ZoR2f4g).lex.config, (*result).s, T16_);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			liMessage__msgs_1182((*p__yteBjD7tjnz9a0X1ZoR2f4g).lex.config, unknownLineInfo__lineinfos_338, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)92), TM__xy1U79cq9cILOyMzz14OxC9cQ_23, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__xy1U79cq9cILOyMzz14OxC9cQ_24), NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		}
		LA14_: ;
	}
...
{nimErr_ = nimErrorFlag();
	...
	pipe = NIM_NIL;
	s = NIM_NIL;
	filename = toFullPathConsiderDirty__msgs_632(config__P07OrqWdJqH0KGGhg8SMyw, fileIdx__gxR0piqmOZvEYNQdTgkiGA);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	filename.len = 0; filename.p = NIM_NIL;
	colontmpD_ = NIM_NIL;
	filename = toFullPathConsiderDirty__msgs_632(config__xyughmDkaRnDh6Wk9bRQl8g, fileIdx__O2Qvojil9bjj0r5VTfqbl1Q);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	f = (FILE*)0;
	{
		NIM_BOOL T4_;
...
appendString((&T8_), filename);
		colontmpD__2 = T8_;
		liMessage__msgs_1182(config__xyughmDkaRnDh6Wk9bRQl8g, unknownLineInfo__lineinfos_338, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__xy1U79cq9cILOyMzz14OxC9cQ_5), NIM_FALSE);
