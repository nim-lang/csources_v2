...
static N_INLINE(struct timespec, st_mtim__posixZposix_1045)(struct stat s__5n02p7GNFaoMLTvk1QYXJA);
...
static const NimStringV2 TM__yu6cxgKBBXbNsTkT9cyMd4g_22 = {4, (NimStrPayload*)&TM__yu6cxgKBBXbNsTkT9cyMd4g_19};
...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmpD__2 = substr__system_7547(path__BQBSuWQbOavg6W9czhl9bOhg, ((NI)2));
		...
		if (!T3_) goto LA5_;
		{
			...
			splitsX60gensym36_ = ((NI)-1);
			{
				while (1) {
					...
					T20_ = substr__system_7535(colontmp_, firstX60gensym36_, (NI)(lastX60gensym36_ - ((NI)1)));
...
appendString((&T1_), TM__yu6cxgKBBXbNsTkT9cyMd4g_18);
	colontmpD__2 = T1_;
	result = getApplAux__pureZos_178(colontmpD__2);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NimStringV2 T7_;
		if (!(result.len == ((NI)0))) goto LA5_;
		T7_.len = 0; T7_.p = NIM_NIL;
		T7_ = getApplHeuristic__pureZos_182();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		splitsX60gensym33_ = ((NI)-1);
		{
			while (1) {
				...
				T32_ = substr__system_7535(path, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	T7_ = st_mtim__posixZposix_1045(res);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
