...
{nimErr_ = nimErrorFlag();
	...
	LA6_: ;
	{
		...
		T10_ = (NIM_BOOL)0;
		T10_ = containsOrIncl__astalgo_402(marker__lqr1WHO9byWJne3ZkAtdPMw, (NI)((NI)((NU32)(((NI) ((*xX60gensym7_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym7_).Sup.itemId.item))));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T10_) goto LA11_;
		eqdestroy___ast_3543(&xX60gensym7_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA11_: ;
	{
		...
		T15_ = 0;
		T16_ = (NIM_BOOL)0;
		T16_ = compareTypes__types_2846(a__zuWw9ayeEUA9cy7Q410CIHmw, b__nhXsVjU4YLKGyv48qiIrCw, ((tyEnum_TDistinctCompare__H0D0zbMLh4bchAD4N9bLm5A)1), T15_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T16_) goto LA17_;
