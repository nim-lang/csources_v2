...
{nimErr_ = nimErrorFlag();
	...
	eqdestroy___cgendata_1240((&(*dest__00qz3spGXcNRS1xOaHfTZw).typeInfoMarkerV2.data));
	{
		...
		nimRawDispose((*dest__00qz3spGXcNRS1xOaHfTZw).config, ((NI)4));
	}
	LA9_: ;
	{
		NIM_BOOL T13_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__00qz3spGXcNRS1xOaHfTZw).graph, ((NI)4));
	}
	LA14_: ;
	...
	colontmp_ = ((NI)0);
	{
		while (1) {
			...
			if (!(colontmp_ < T3_)) goto LA2			;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				nimRawDispose((*dest__NEUgGDrk8tOzaV9bUxFM6Kg).p->data[colontmp_].Field0, ((NI)4));
			}
			LA7_: ;
			colontmp_ += ((NI)1);
		} LA2: ;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__q4rp9chxznEVZfii39c5q7Vw).Field0, ((NI)4));
	}
	LA4_: ;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__9aapGPEiFueGyDRfNJ5TqUw).Field0, ((NI)4));
	}
	LA8_: ;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__NEUgGDrk8tOzaV9bUxFM6Kg).Field0, ((NI)4));
	}
	LA4_: ;
	}BeforeRet_: ;
}
