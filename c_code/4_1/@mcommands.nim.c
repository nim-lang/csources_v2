...
{nimErr_ = nimErrorFlag();
	...
	LA19_: ;
	{
		...
		T24_.len = 0; T24_.p = NIM_NIL;
		T24_ = substr__system_7547(switch_0, (NI)(i + ((NI)1)));
	...
	LA22_: ;
	{
		...
		T28_ = substr__system_7547(switch_0, i);
...
{nimErr_ = nimErrorFlag();
	...
	LA35_: ;
	colontmpD__2 = substr__system_7547(arg, i);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		val.len = 0; val.p = NIM_NIL;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		key = substr__system_7535((*p).key, ((NI)0), (NI)(bracketLe - ((NI)1)));
		T6_.len = 0; T6_.p = NIM_NIL;
		colontmpD_ = substr__system_7547((*p).key, bracketLe);
