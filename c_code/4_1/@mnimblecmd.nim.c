...
N_LIB_PRIVATE N_NIMCALL(tyTuple__7q7q3E6Oj24ZNVJb9aonhAg, getPathVersionChecksum__nimblecmd_196)(NimStringV2 p);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T5_ = substr__system_7547(p, (NI)(checksumSeparatorIndex + ((NI)1)));
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T16_ = substr__system_7535(p, (NI)(versionSeparatorIndex + ((NI)1)), (NI)(checksumSeparatorIndex - ((NI)1)));
	...
	LA14_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			T22_ = substr__system_7535(p, (NI)(versionSeparatorIndex + ((NI)1)), (NI)(checksumSeparatorIndex - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	...
	colontmp_ = getPathVersionChecksum__nimblecmd_196(p);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	checksum = colontmp_.Field2;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
		{
			...
			NIM_BOOL T12_;
			T10_ = (NIM_BOOL)0;
			colontmpD_ = getOrDefault__nimblecmd_307((*packages), name);
			if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
