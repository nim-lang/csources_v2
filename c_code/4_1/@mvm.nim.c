...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___pureZosproc_1663)(tyTuple__XOVT24GHXwqiEj5GCsEGCA* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, addFloatRoundtrip__system_4400)(NimStringV2* result, NF x);
...
static N_INLINE(NIM_BOOL, eqeq___system_7501)(NCSTRING x, NCSTRING y);
...
N_LIB_PRIVATE N_NIMCALL(tySequence__sM4lkSb7zS6F7OVMvW9cffQ, querySettingSeqImpl__vm_13271)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, NI64 switch_0) {
	...
	{
		eqcopy___system_3542((&result), (*conf).commandArgs);
	}
	break;
...
appendString((&T44_), colontmpD_);
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)36) ... ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)39):
		{
			...
			T61_ = dollar___system_4391(src.floatVal);
			if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
