...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmpD__2 = substr__system_7559(path__BQBSuWQbOavg6W9czhl9bOhg, ((NI)2));
		...
		if (!T3_) goto LA5_;
		{
			...
			splitsX60gensym36_ = ((NI)-1);
			{
				while (1) {
					...
					T20_ = substr__system_7547(colontmp_, firstX60gensym36_, (NI)(lastX60gensym36_ - ((NI)1)));
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		splitsX60gensym33_ = ((NI)-1);
		{
			while (1) {
				...
				T32_ = substr__system_7547(path, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI)1)));
