...
N_LIB_PRIVATE N_NIMCALL(NU32, physicalSignificand__stdZprivateZschubfach_35)(tyObject_Single__d6NidTbsj2ZAh9ao1GJW9aXQ this__YrMQ0k9b15dmKtzvlMFq3EQ) {
	NU32 result;
{	result = (NU32)0;
	result = (NU32)(this__YrMQ0k9b15dmKtzvlMFq3EQ.bits & ((NU32)8388607));
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_Single__d6NidTbsj2ZAh9ao1GJW9aXQ, constructSingle__stdZprivateZschubfach_32)(NF32 value__a0nUWKcftQhfnAecHwHWZg) {
	...
	LOC1.source = value__a0nUWKcftQhfnAecHwHWZg;
...
N_LIB_PRIVATE N_NIMCALL(NU32, physicalExponent__stdZprivateZschubfach_38)(tyObject_Single__d6NidTbsj2ZAh9ao1GJW9aXQ this__NlXrfYmhMy572LpLMvb9apA) {
	NU32 result;
{	result = (NU32)0;
	result = (NU32)((NU32)((NU32)(this__NlXrfYmhMy572LpLMvb9apA.bits & ((NU32)2139095040))) >> (NU32)(((NI32)23)));
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NI, signBit__stdZprivateZschubfach_57)(tyObject_Single__d6NidTbsj2ZAh9ao1GJW9aXQ this__DkbUNqMkfTw8eim05KdHOw) {
	NI result;
{	result = (NI)0;
	result = ((NI) (!(((NU32)(this__DkbUNqMkfTw8eim05KdHOw.bits & ((NU32)IL64(2147483648))) == ((NU32)0)))));
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
