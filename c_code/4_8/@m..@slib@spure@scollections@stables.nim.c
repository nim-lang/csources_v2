...
static N_INLINE(NI, rawGet__vm_4300)(tyObject_Table__NttoEzoiq5CiphZe81oadg t, NimStringV2 key, NI* hc);
static N_INLINE(NIM_BOOL, mustRehash__vm_4935)(tyObject_Table__NttoEzoiq5CiphZe81oadg t);
N_LIB_PRIVATE N_NIMCALL(void, enlarge__vm_5124)(tyObject_Table__NttoEzoiq5CiphZe81oadg* t);
N_LIB_PRIVATE N_NIMCALL(void, rawInsert__vm_5440)(tyObject_Table__NttoEzoiq5CiphZe81oadg* t, tySequence__squ9b9bUH4OLHf6cEMrt6hVA* data, NimStringV2 key, NI64 val, NI hc, NI h);
static N_INLINE(NI, rawGetKnownHC__vm_5609)(tyObject_Table__NttoEzoiq5CiphZe81oadg t, NimStringV2 key, NI hc);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, hasKey__vm_8165)(tyObject_Table__hsjU9cxnK6dA4IxNq3j9bV6w t, NimStringV2 key);
static N_INLINE(NI, rawGet__vm_8172)(tyObject_Table__hsjU9cxnK6dA4IxNq3j9bV6w t, NimStringV2 key, NI* hc);
...
static N_INLINE(NIM_BOOL, mustRehash__vm_8697)(tyObject_Table__hsjU9cxnK6dA4IxNq3j9bV6w t);
N_LIB_PRIVATE N_NIMCALL(void, enlarge__vm_8886)(tyObject_Table__hsjU9cxnK6dA4IxNq3j9bV6w* t);
N_LIB_PRIVATE N_NIMCALL(void, rawInsert__vm_9202)(tyObject_Table__hsjU9cxnK6dA4IxNq3j9bV6w* t, tySequence__Xm7Y9aXOt1l5gnWmHgnoqUA* data, NimStringV2 key, tyObject_BTree__BxbTQohN8QrxN73DA9bcM9aQ val, NI hc, NI h);
static N_INLINE(NI, rawGetKnownHC__vm_9371)(tyObject_Table__hsjU9cxnK6dA4IxNq3j9bV6w t, NimStringV2 key, NI hc);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, hasKey__vm_5932)(tyObject_Table__fkVbis6Wl9armQNEPm21CLQ t, NimStringV2 key);
static N_INLINE(NI, rawGet__vm_5939)(tyObject_Table__fkVbis6Wl9armQNEPm21CLQ t, NimStringV2 key, NI* hc);
...
static N_INLINE(NIM_BOOL, mustRehash__vm_6424)(tyObject_Table__fkVbis6Wl9armQNEPm21CLQ t);
N_LIB_PRIVATE N_NIMCALL(void, enlarge__vm_6613)(tyObject_Table__fkVbis6Wl9armQNEPm21CLQ* t);
N_LIB_PRIVATE N_NIMCALL(void, rawInsert__vm_6925)(tyObject_Table__fkVbis6Wl9armQNEPm21CLQ* t, tySequence__UQG43DVXYWx86AitV5pL8g* data, NimStringV2 key, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* val, NI hc, NI h);
static N_INLINE(NI, rawGetKnownHC__vm_7094)(tyObject_Table__fkVbis6Wl9armQNEPm21CLQ t, NimStringV2 key, NI hc);
...
N_LIB_PRIVATE N_NIMCALL(tyTuple__UV3llMMYFckfui8YMBuUZA, getOrDefault__nimblecmd_307)(tyObject_Table__d05ldtnZIkg8hVpY02dsdA t, NimStringV2 key) {
...
{nimErr_ = nimErrorFlag();
	...
	indexX60gensym1811_ = rawGet__vm_4300(t, key, (&hcX60gensym1811_));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		res = ((NI)0);
		{
			while (1) {
				...
				eh = n.p->data[i].Field0;
				{
					...
					T18_ = n.p->data[i].Field2;
					n.p->data[i].Field2 = 0;
					rawInsert__vm_5440(T17_, (&(*t).data), colontmpD_, T18_, eh, j);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					eqdestroy___stdZassertions_13((&colontmpD_));
				}
				LA10_: ;
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	hc = (NI)0;
	index = rawGet__vm_4300((*t), key, (&hc));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!(((NI)0) <= index)) goto LA8_;
		(*t).data.p->data[index].Field2 = val;
	...
	LA8_: ;
	{
		...
		LA14_: ;
		{
			NIM_BOOL T18_;
			T18_ = (NIM_BOOL)0;
			T18_ = mustRehash__vm_4935((*t));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!T18_) goto LA19_;
			enlarge__vm_5124(t);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			index = rawGetKnownHC__vm_5609((*t), key, hc);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA19_: ;
		index = (NI)(((NI)-1) - index);
		...
		T21_ = t;
		rawInsert__vm_5440(T21_, (&(*t).data), key, val, hc, index);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(*t).counter += ((NI)1);
	}
	LA6_: ;
...
{nimErr_ = nimErrorFlag();
	eqcopy___stdZassertions_16((&(*data).p->data[h].Field1), key);
	eqsink___vm_8455((&(*data).p->data[h].Field2), val);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*data).p->data[h].Field0 = hc;
	}BeforeRet_: ;
}
		...
		res = ((NI)0);
		{
			while (1) {
				...
				eh = n.p->data[i].Field0;
				{
					...
					rawInsert__vm_9202(T17_, (&(*t).data), colontmpD_, T18_, eh, j);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					eqdestroy___stdZassertions_13((&colontmpD_));
				}
				LA10_: ;
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	hc = (NI)0;
	index = rawGet__vm_8172((*t), key, (&hc));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!(((NI)0) <= index)) goto LA8_;
		eqsink___vm_8455((&(*t).data.p->data[index].Field2), val);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA6_;
	LA8_: ;
	{
		...
		LA14_: ;
		{
			NIM_BOOL T18_;
			T18_ = (NIM_BOOL)0;
			T18_ = mustRehash__vm_8697((*t));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!T18_) goto LA19_;
			enlarge__vm_8886(t);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			index = rawGetKnownHC__vm_9371((*t), key, hc);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA19_: ;
		index = (NI)(((NI)-1) - index);
		...
		rawInsert__vm_9202(T21_, (&(*t).data), key, blitTmp, hc, index);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(*t).counter += ((NI)1);
	}
	LA6_: ;
...
{nimErr_ = nimErrorFlag();
	...
	hcX60gensym22_ = (NI)0;
	indexX60gensym22_ = rawGet__vm_8172((*t), key, (&hcX60gensym22_));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!(((NI)0) <= indexX60gensym22_)) goto LA3_;
		result = (&(*t).data.p->data[indexX60gensym22_].Field2);
		...
		res = ((NI)0);
		{
			while (1) {
				...
				eh = n.p->data[i].Field0;
				{
					...
					T18_ = n.p->data[i].Field2;
					n.p->data[i].Field2 = 0;
					rawInsert__vm_6925(T17_, (&(*t).data), colontmpD_, T18_, eh, j);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					eqdestroy___stdZassertions_13((&colontmpD_));
				}
				LA10_: ;
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	hc = (NI)0;
	index = rawGet__vm_5939((*t), key, (&hc));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!(((NI)0) <= index)) goto LA8_;
	...
	LA8_: ;
	{
		...
		LA14_: ;
		{
			NIM_BOOL T18_;
			T18_ = (NIM_BOOL)0;
			T18_ = mustRehash__vm_6424((*t));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!T18_) goto LA19_;
			enlarge__vm_6613(t);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			index = rawGetKnownHC__vm_7094((*t), key, hc);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA19_: ;
		index = (NI)(((NI)-1) - index);
		...
		T21_ = t;
		blitTmp = val;
		rawInsert__vm_6925(T21_, (&(*t).data), key, blitTmp, hc, index);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(*t).counter += ((NI)1);
	}
	LA6_: ;
...
{nimErr_ = nimErrorFlag();
	...
	hcX60gensym22_ = (NI)0;
	indexX60gensym22_ = rawGet__vm_5939((*t), key, (&hcX60gensym22_));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!(((NI)0) <= indexX60gensym22_)) goto LA3_;
		result = &(*t).data.p->data[indexX60gensym22_].Field2;
						...
						while (1) {
							...
							(*t).data.p->data[index].Field1 = 0;
							{
								while (1) {
									...
									LA22_: ;
									T24_ = (NI)0;
									T24_ = hash__pureZhashes_297((*t).data.p->data[index].Field0);
									if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
							...
							eqsink___pureZosproc_1669((&(*t).data.p->data[jX60gensym179_]), T39_);
						}
					}
				} LA14: ;
			}
