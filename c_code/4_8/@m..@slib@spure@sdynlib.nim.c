...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		prefix = substr__system_7525(s__9bbA9c8EYk8sqmZnb3ssoXdg, ((NI)0), (NI)(le - ((NI)1)));
		suffix = substr__system_7537(s__9bbA9c8EYk8sqmZnb3ssoXdg, (NI)(ri + ((NI)1)));
		{
			NimStringV2 middle;
			...
			colontmp_ = substr__system_7525(s__9bbA9c8EYk8sqmZnb3ssoXdg, (NI)(le + ((NI)1)), (NI)(ri - ((NI)1)));
