...
appendString((&(*config__c2l2mlnF69bH9brbTPUieDHg).commandLine), colontmpD__2);
				...
				LA11_: ;
				{
					...
					eqsink___stdZassertions_19((&p.key), TM__xOfksDa5lOpfO1acT4wYQg_5);
					{
						NIM_BOOL T19_;
						T19_ = (NIM_BOOL)0;
						T19_ = processArgument__commands_1592(pass__W7RvG3WMGUw4749coIooD9bA, (&p), (&argsCount), config__c2l2mlnF69bH9brbTPUieDHg);
						if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
						if (!T19_) goto LA20_;
				...
				LA15_: ;
				{
					processSwitch__commands_1585(pass__W7RvG3WMGUw4749coIooD9bA, (&p), config__c2l2mlnF69bH9brbTPUieDHg);
					if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
				}
				LA13_: ;
				{
...
appendString((&(*config__c2l2mlnF69bH9brbTPUieDHg).commandLine), colontmpD__3);
				{
					NIM_BOOL T29_;
					T29_ = (NIM_BOOL)0;
					T29_ = processArgument__commands_1592(pass__W7RvG3WMGUw4749coIooD9bA, (&p), (&argsCount), config__c2l2mlnF69bH9brbTPUieDHg);
					if (NIM_UNLIKELY(*nimErr_)) goto LA26_;
					if (!T29_) goto LA30_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		if (!T32_) goto LA33_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		colontmpD_ = GC_getStatistics__system_6613();
		T36_[0] = colontmpD_;
		echoBinSafe(T36_, 1);
		{
			LA35_:;
