...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T5_ = substr__system_7537(p__Kqv4F0bZMLYwGQlsJ69ai6w, (NI)(checksumSeparatorIndex + ((NI)1)));
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T16_ = substr__system_7525(p__Kqv4F0bZMLYwGQlsJ69ai6w, (NI)(versionSeparatorIndex + ((NI)1)), (NI)(checksumSeparatorIndex - ((NI)1)));
	...
	LA14_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			T22_ = substr__system_7525(p__Kqv4F0bZMLYwGQlsJ69ai6w, (NI)(versionSeparatorIndex + ((NI)1)), (NI)(checksumSeparatorIndex - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	...
	sVer2.len = 0; sVer2.p = NIM_NIL;
	{
		...
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		{
			...
			eqdestroy___system_3539((&sVer2));
			eqdestroy___system_3539((&sVer));
			goto BeforeRet_;
			{
				LA15_:;
			}
...
{nimErr_ = nimErrorFlag();
	...
	resultX60gensym40_.len = 0; resultX60gensym40_.p = NIM_NIL;
	{
		...
		{
			eqdestroy___stdZassertions_13((&colontmpD__2));
			eqdestroy___system_3539((&nimbleLinkLines));
		}
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA21_: ;
	...
	{
		eqdestroy___system_3539((&resultX60gensym40_));
		eqdestroy___system_3539((&nimbleLinks));
