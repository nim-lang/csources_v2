		...
		while (1) {
			if (!(i < f.len)) goto LA2			;
			{
				...
				case 123:
				{
					...
					colontmpD_ = substr__system_7537(f, (NI)(i + ((NI)2)), (NI)(j - ((NI)1)));
...
appendString((&result), colontmpD__2);
				...
				case 95:
				{
					...
					colontmpD__3 = substr__system_7537(f, (NI)(i + ((NI)1)), (NI)(j_2 - ((NI)1)));
