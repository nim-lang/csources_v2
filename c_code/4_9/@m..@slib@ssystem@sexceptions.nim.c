...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_7605)(tyObject_IOError__N09bhl56nRkUaUsonzshECg* dest);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_7614)(tyObject_IOError__N09bhl56nRkUaUsonzshECg* dest, void* env);
