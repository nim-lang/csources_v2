...
{nimErr_ = nimErrorFlag();
	...
	LA19_: ;
	{
		...
		T24_.len = 0; T24_.p = NIM_NIL;
		T24_ = substr__system_7549(switch_0, (NI)(i + ((NI)1)));
	...
	LA22_: ;
	{
		...
		T28_ = substr__system_7549(switch_0, i);
...
{nimErr_ = nimErrorFlag();
	...
	LA35_: ;
	colontmpD__2 = substr__system_7549(arg, i);
...
appendString((&T283_), f.Field2);
	...
	LA16_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		{
			NIM_BOOL T315_;
			T315_ = (NIM_BOOL)0;
			T315_ = contains__pureZstrutils_1813(arg, TM__aFkIL74T1q8RouIu9auwZ3g_455);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
appendString((&T612_), arg);
	...
	LA115_: ;
	{
		...
		LA742_: ;
		{
			...
			T746_ = parseEnum__commands_1370(arg);
	...
	LA116_: ;
	{
		...
		T752_ = parseEnum__commands_1423(arg);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		val.len = 0; val.p = NIM_NIL;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		key = substr__system_7537((*p).key, ((NI)0), (NI)(bracketLe - ((NI)1)));
		T6_.len = 0; T6_.p = NIM_NIL;
		colontmpD_ = substr__system_7549((*p).key, bracketLe);
