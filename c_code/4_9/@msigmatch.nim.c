...
static N_INLINE(NIM_CHAR, X5BX5D___system_7038)(NimStringV2 s__PGsSrP2Hp9bHlVetHpoUPug, NI i__MpPA5N1VsAzqiuzycRdOAg);
...
{nimErr_ = nimErrorFlag();
	...
	LA13_: ;
	{
		...
		if (!(T22_)) goto LA23_;
		T24_ = (NIM_CHAR)0;
		T24_ = X5BX5D___system_7038(ident__YHf1XAuiepoLFmQIi1E7lw, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	LA25_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			T36_ = (NIM_BOOL)0;
			T37_ = (NIM_CHAR)0;
			T37_ = X5BX5D___system_7038(ident__YHf1XAuiepoLFmQIi1E7lw, ((NI)1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
