...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___system_3530((&(*dest__qtq2ru8hgzvTt8Zo59cPl6w_2).finallySafePoints));
...
{nimErr_ = nimErrorFlag();
	...
	eqdestroy___system_3530((&(*dest__qtq2ru8hgzvTt8Zo59cPl6w).headerFiles));
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___system_3536((&(*result).finallySafePoints), T9_);
