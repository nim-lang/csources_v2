...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___docgen50_53)(tyObject_TGen__Mq07cKWfeGN6ARjzPuLUKw* dest__CFVWEMWCviUZfTtslhNaZA_2) {
	...
	LA14_: ;
	{
		...
		nimRawDispose((*dest__CFVWEMWCviUZfTtslhNaZA_2).config, ((NI)4));
	}
	LA19_: ;
}
static N_INLINE(void, nimCopyMem)(void* dest__HMDJtGX4ficduS9cTUiey0w, void* source__xDZEU1SRcEBuZ8mtbKQBhQ, NI size__9b8g0WMA1h1RvMwHOMW7yFA) {
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = toFullPath__msgs_589((*graph__Tbsqhv2ORi9cbvvIYYr1Xww).config, ((NI32) ((*module__KEHl9c2YcOxvdVspzYcI6iQ).position)));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = toFullPath__msgs_589((*graph__r4mHk3Oggt8CwGwUK9aCY1Q).config, ((NI32) ((*module__lY56dnmZUtuh6Q3hmGUZ3g).position)));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = toFullPath__msgs_589((*graph__OXRapa5j7gELlIs9bmiUuWA).config, ((NI32) ((*module__Sje309ba7QhtymvJ9aF8qcJg).position)));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
