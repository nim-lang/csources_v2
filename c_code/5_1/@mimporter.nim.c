...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__EjRjHajYFwXL1LgYrGD0hw).ret2.Field0, ((NI)4));
	}
	LA9_: ;
	{
		NIM_BOOL T13_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__EjRjHajYFwXL1LgYrGD0hw).n3, ((NI)4));
	}
	LA14_: ;
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__uC0ByZTZ6ap9aMH9bWoEzFnQ).Field0, ((NI)4));
	}
	LA8_: ;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__EjRjHajYFwXL1LgYrGD0hw_3).Field0, ((NI)4));
	}
	LA4_: ;
	}BeforeRet_: ;
}
