...
struct tySequence__29btfq9cDuCZmHsAEmuBeMOg_Content { NI cap; tyObject_FullId__3oA6EHvzCx1KvUf9cxJRXXw data[SEQ_DECL_SIZE];};
      ...
      static N_INLINE(NIM_BOOL, isSelf__concepts_39)(tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* t);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, conceptMatchNode__concepts_141)(tyObject_TContext__QUPFyDhhyyn3RQbxNbH7xg* c, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n, tyObject_MatchCon__9cm4B1dHDiEyN4ajXXa6jSw* m);
static N_INLINE(NI, len__ast_3325)(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, matchSyms__concepts_634)(tyObject_TContext__QUPFyDhhyyn3RQbxNbH7xg* c, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n, tySet_tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ kinds, tyObject_MatchCon__9cm4B1dHDiEyN4ajXXa6jSw* m);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, matchSym__concepts_567)(tyObject_TContext__QUPFyDhhyyn3RQbxNbH7xg* c, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* candidate, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n, tyObject_MatchCon__9cm4B1dHDiEyN4ajXXa6jSw* m);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, matchType__concepts_145)(tyObject_TContext__QUPFyDhhyyn3RQbxNbH7xg* c, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* f, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* a, tyObject_MatchCon__9cm4B1dHDiEyN4ajXXa6jSw* m);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*, existingBinding__concepts_124)(tyObject_MatchCon__9cm4B1dHDiEyN4ajXXa6jSw* m, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* key);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, matchReturnType__concepts_557)(tyObject_TContext__QUPFyDhhyyn3RQbxNbH7xg* c, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* f, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* a, tyObject_MatchCon__9cm4B1dHDiEyN4ajXXa6jSw* m);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___concepts_795)(tyObject_MatchCon__9cm4B1dHDiEyN4ajXXa6jSw* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, declareSelf__concepts_14)(tyObject_TContext__QUPFyDhhyyn3RQbxNbH7xg* c, tyObject_TLineInfo__7ZAGqjaN6WqWPlHP9cRagRg info);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, semConceptDecl__concepts_62)(tyObject_TContext__QUPFyDhhyyn3RQbxNbH7xg* c, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n);
...
static N_INLINE(NIM_BOOL, isSelf__concepts_39)(tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* t) {
	...
	result = (NIM_BOOL)0;
	T1_ = (NIM_BOOL)0;
	T1_ = ((*t).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)8));
	if (!(T1_)) goto LA2_;
	T1_ = (((*t).flags &((NU64)1<<((NU)((((tyEnum_TTypeFlag__wRa4s6r4s9cXJ9abWKsrci1Q)23)))&63U)))!=0);
	LA2_: ;
	result = T1_;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		NIM_BOOL T5_;
		T3_ = (NIM_BOOL)0;
		T3_ = ((*typ).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)8));
		if (!(T3_)) goto LA4_;
		T5_ = (NIM_BOOL)0;
		T5_ = isSelf__concepts_39(typ);
	...
	LA6_: ;
	{
		result = newTypeS__semdata_2347(((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)8), c);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(*result).flags |= ((NU64)1)<<(((((tyEnum_TTypeFlag__wRa4s6r4s9cXJ9abWKsrci1Q)38))) & 63);
		addSonSkipIntLit__magicsys_137(result, typ, (*c).Sup.idgen);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA1_: ;
	}BeforeRet_: ;
	...
	result = NIM_NIL;
	{
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				i = i_2;
				{
					if (!((*m).inferred.p->data[i].Field0 == key)) goto LA7_;
					eqcopy___ast_3546(&result, (*m).inferred.p->data[i].Field1);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					goto BeforeRet_;
				}
				LA7_: ;
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)4):
	{
		...
		colontmpD_ = NIM_NIL;
		colontmpD_ = lastSon__ast_4811(f);
		if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
		result = matchType__concepts_145(c, colontmpD_, a, m);
		if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
		{
			LA2_:;
		}
	...
	{
		{
			NIM_BOOL T8_;
			T8_ = (NIM_BOOL)0;
			T8_ = isSelf__concepts_39(f);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!T8_) goto LA9_;
			result = matchType__concepts_145(c, a, (*m).potentialImplementation, m);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA6_;
		LA9_: ;
		{
			{
				...
				NI T17_;
				T14_ = (NIM_BOOL)0;
				T14_ = ((*a).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)8));
				if (!(T14_)) goto LA15_;
				T16_ = (NI)0;
				T16_ = len__ast_5071(f);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				T17_ = (NI)0;
				T17_ = len__ast_5071(a);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				T14_ = (T16_ == T17_);
				LA15_: ;
				if (!T14_) goto LA18_;
					...
					i_2 = ((NI)0);
					{
						while (1) {
							...
							i = i_2;
							{
								NIM_BOOL T25_;
								T25_ = (NIM_BOOL)0;
								T25_ = matchType__concepts_145(c, (*f).sons.p->data[i], (*a).sons.p->data[i], m);
								if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
								if (!!(T25_)) goto LA26_;
								result = NIM_FALSE;
								goto BeforeRet_;
	...
	{
		{
			NIM_BOOL T31_;
			T31_ = (NIM_BOOL)0;
			T31_ = ((*a).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)11));
			if (!(T31_)) goto LA32_;
			T31_ = ((*(*a).sons.p->data[((NI)0)]).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)10));
			LA32_: ;
			if (!T31_) goto LA33_;
			{
				NIM_BOOL T37_;
				...
				T37_ = (NIM_BOOL)0;
				T38_ = 0;
				T37_ = sameType__types_1991((*f).sons.p->data[((NI)0)], (*a).sons.p->data[((NI)0)], T38_);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				if (!(T37_)) goto LA39_;
				T40_ = (NI)0;
				T40_ = len__ast_5071(f);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				T41_ = (NI)0;
				T41_ = len__ast_5071(a);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					...
					i_4 = ((NI)1);
					{
						while (1) {
							...
							i_3 = i_4;
							{
								NIM_BOOL T49_;
								T49_ = (NIM_BOOL)0;
								T49_ = matchType__concepts_145(c, (*f).sons.p->data[i_3], (*a).sons.p->data[i_3], m);
								if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
								if (!!(T49_)) goto LA50_;
								result = NIM_FALSE;
								goto BeforeRet_;
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)12):
	{
		...
		ak = NIM_NIL;
		ak = skipTypes__ast_4803(a, TM__aQsd3Co9cjvf9b9cASJtnlgVw_2);
		...
		LA59_: ;
		{
			...
			old = existingBinding__concepts_124((&(*m)), f);
			if (NIM_UNLIKELY(*nimErr_)) goto LA62_;
			{
				if (!(old == ((tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*) NIM_NIL))) goto LA65_;
				{
					...
					T69_ = (NIM_BOOL)0;
					T70_ = (NI)0;
					T70_ = len__ast_5071(f);
					if (NIM_UNLIKELY(*nimErr_)) goto LA62_;
					T69_ = (((NI)0) < T70_);
					if (!(T69_)) goto LA71_;
					T69_ = !(((*(*f).sons.p->data[((NI)0)]).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)0)));
					LA71_: ;
					if (!T69_) goto LA72_;
					T74_ = (*m).inferred.len;
					oldLen = T74_;
					result = matchType__concepts_145(c, (*f).sons.p->data[((NI)0)], a, m);
					if (NIM_UNLIKELY(*nimErr_)) goto LA62_;
					setLen__concepts_225((&(*m).inferred), ((NI) (oldLen)));
					{
						...
						colontmpD__2 = 0;
						eqcopy___ast_3546(&colontmpD__2, f);
						if (NIM_UNLIKELY(*nimErr_)) goto LA62_;
						T79_.Field0 = colontmpD__2;
						blitTmp = ak;
						ak = 0;
						T79_.Field1 = blitTmp;
						add__concepts_338((&(*m).inferred), T79_);
					}
					LA77_: ;
				}
				goto LA67_;
				LA72_: ;
				{
					...
					T81_ = (NIM_BOOL)0;
					T81_ = ((*m).magic == ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)5));
					if (!(T81_)) goto LA82_;
					...
					colontmpD__3 = 0;
					eqcopy___ast_3546(&colontmpD__3, f);
					if (NIM_UNLIKELY(*nimErr_)) goto LA62_;
					...
					if (NIM_UNLIKELY(*nimErr_)) goto LA62_;
					T85_.Field1 = T86_;
					add__concepts_338((&(*m).inferred), T85_);
					result = NIM_TRUE;
				}
				goto LA67_;
				LA83_: ;
				{
					...
					colontmpD__4 = 0;
					eqcopy___ast_3546(&colontmpD__4, f);
					if (NIM_UNLIKELY(*nimErr_)) goto LA62_;
					T88_.Field0 = colontmpD__4;
					blitTmp_2 = ak;
					ak = 0;
					T88_.Field1 = blitTmp_2;
					add__concepts_338((&(*m).inferred), T88_);
					result = NIM_TRUE;
				}
				LA67_: ;
			}
			...
			LA65_: ;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA62_;
				T90_ = (NIM_BOOL)0;
				T90_ = containsOrIncl__astalgo_402((&(*m).marker), (NI)((NI)((NU32)(((NI) ((*xX60gensym32_).Sup.itemId.module))) << (NU32)(((NI)20))) + ((NI) ((*xX60gensym32_).Sup.itemId.item))));
				if (NIM_UNLIKELY(*nimErr_)) goto LA62_;
				if (!!(T90_)) goto LA91_;
				result = matchType__concepts_145(c, old, ak, m);
				if (NIM_UNLIKELY(*nimErr_)) goto LA62_;
				{
					NIM_BOOL T95_;
					T95_ = (NIM_BOOL)0;
					T95_ = ((*m).magic == ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)6));
					if (!(T95_)) goto LA96_;
	...
	{
		{
			if (!((*a).kind == (*f).kind)) goto LA106_;
			result = matchType__concepts_145(c, (*f).sons.p->data[((NI)0)], (*a).sons.p->data[((NI)0)], m);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA104_;
		LA106_: ;
		{
			if (!((*m).magic == ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)6))) goto LA109_;
			result = matchType__concepts_145(c, (*f).sons.p->data[((NI)0)], a, m);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA104_;
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)13):
	{
		...
		T113_ = 0;
		result = sameType__types_1991(f, a, T113_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)63):
	{
		...
		colontmpD__5 = skipTypes__ast_4803(a, TM__aQsd3Co9cjvf9b9cASJtnlgVw_3);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		result = ((*colontmpD__5).kind == (*f).kind);
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)31) ... ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)44):
	{
		...
		NI T123_;
		ak_2 = NIM_NIL;
		ak_2 = skipTypes__ast_4803(a, TM__aQsd3Co9cjvf9b9cASJtnlgVw_3);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T116_ = (NIM_BOOL)0;
		T117_ = (NIM_BOOL)0;
		T117_ = ((*ak_2).kind == (*f).kind);
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)62):
	{
		...
		T127_ = (*m).inferred.len;
		oldLen_2 = T127_;
		eqcopy___ast_3546(&oldPotentialImplementation, (*m).potentialImplementation);
		if (NIM_UNLIKELY(*nimErr_)) goto LA126_;
		eqcopy___ast_3546(&(*m).potentialImplementation, a);
		if (NIM_UNLIKELY(*nimErr_)) goto LA126_;
		colontmpD__6 = lastSon__ast_6268((*f).n);
		if (NIM_UNLIKELY(*nimErr_)) goto LA126_;
		result = conceptMatchNode__concepts_141(c, colontmpD__6, m);
		if (NIM_UNLIKELY(*nimErr_)) goto LA126_;
		eqsink___ast_3549(&(*m).potentialImplementation, oldPotentialImplementation);
		if (NIM_UNLIKELY(*nimErr_)) goto LA126_;
		oldPotentialImplementation = 0;
		{
			if (!!(result)) goto LA130_;
			setLen__concepts_225((&(*m).inferred), ((NI) (oldLen_2)));
		}
		LA130_: ;
		{
			LA126_:;
  ...
  T138_[T136_] = TM__aQsd3Co9cjvf9b9cASJtnlgVw_3[T136_] & ~ T137_[T136_];
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA135_;
		{
			...
			NI T144_;
			T141_ = (NIM_BOOL)0;
			T141_ = ((*ak_3).kind == (*f).kind);
			if (!(T141_)) goto LA142_;
			T143_ = (NI)0;
			T143_ = len__ast_5071(f);
			if (NIM_UNLIKELY(*nimErr_)) goto LA135_;
			T144_ = (NI)0;
				...
				i_6 = ((NI)0);
				{
					while (1) {
						...
						i_5 = i_6;
						{
							NIM_BOOL T152_;
							T152_ = (NIM_BOOL)0;
							T152_ = matchType__concepts_145(c, (*f).sons.p->data[i_5], (*ak_3).sons.p->data[i_5], m);
							if (NIM_UNLIKELY(*nimErr_)) goto LA135_;
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)57):
	{
		NI oldLen_3;
		NI T158_;
		T158_ = (*m).inferred.len;
		oldLen_3 = T158_;
		{
			NI covered;
			NI T174_;
			if (!((*a).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)57))) goto LA161_;
			covered = ((NI)0);
			{
				NI i_7;
				NI colontmp__4;
						...
						i_7 = i_8;
						{
							...
							i_9 = ((NI)0);
							{
								while (1) {
									...
									j = i_9;
									T169_ = (*m).inferred.len;
									oldLenB = T169_;
									r = matchType__concepts_145(c, (*f).sons.p->data[i_7], (*a).sons.p->data[j], m);
									if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
									{
										if (!r) goto LA172_;
										covered += ((NI)1);
									...
									LA172_: ;
									setLen__concepts_225((&(*m).inferred), ((NI) (oldLenB)));
									i_9 += ((NI)1);
								} LA168: ;
							}
						} LA166: ;
			...
			T174_ = (NI)0;
			T174_ = len__ast_5071(a);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			result = (T174_ <= covered);
			{
				if (!!(result)) goto LA177_;
				setLen__concepts_225((&(*m).inferred), ((NI) (oldLen_3)));
			}
			LA177_: ;
		}
		goto LA159_;
		...
		{
			{
				...
				i_11 = ((NI)0);
				{
					while (1) {
						...
						i_10 = i_11;
						result = matchType__concepts_145(c, (*f).sons.p->data[i_10], a, m);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						{
	...
	{
		{
			if (!((*a).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)58))) goto LA190_;
			result = matchType__concepts_145(c, (*f).sons.p->data[((NI)0)], (*a).sons.p->data[((NI)0)], m);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA188_;
		LA190_: ;
		{
			...
			NI T193_;
			NIM_BOOL T194_;
			T193_ = (*m).inferred.len;
			oldLen_4 = T193_;
			T194_ = (NIM_BOOL)0;
			T194_ = matchType__concepts_145(c, (*f).sons.p->data[((NI)0)], a, m);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			result = !(T194_);
			setLen__concepts_225((&(*m).inferred), ((NI) (oldLen_4)));
		}
		LA188_: ;
	}
	break;
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)15):
	{
		NIM_BOOL T197_;
		T197_ = (NIM_BOOL)0;
		T197_ = isOrdinalType__types_300(a, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (T197_) goto LA198_;
		T197_ = ((*a).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)12));
		LA198_: ;
		result = T197_;
	}
	break;
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = isEmptyType__ast_6215(f);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		result = isEmptyType__ast_6215(a);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA1_;
	LA4_: ;
	{
		if (!(a == ((tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*) NIM_NIL))) goto LA7_;
		result = NIM_FALSE;
	}
	goto LA1_;
	LA7_: ;
	{
		result = matchType__concepts_145(c, f, a, m);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA1_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	T2_ = (*m).inferred.len;
	oldLen = T2_;
	eqcopy___ast_3457(&can, (*(*candidate).typ).n);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqcopy___ast_3457(&con, (*(*(*(*n)._kind_6.sons.p->data[((NI)0)])._kind_4.sym).typ).n);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NI T5_;
		NI T6_;
		...
		i_2 = ((NI)1);
		{
			while (1) {
				...
				i = i_2;
				{
					NIM_BOOL T16_;
					T16_ = (NIM_BOOL)0;
					T16_ = matchType__concepts_145(c, (*(*con)._kind_6.sons.p->data[i]).typ, (*(*can)._kind_6.sons.p->data[i]).typ, m);
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
					if (!!(T16_)) goto LA17_;
					setLen__concepts_225((&(*m).inferred), ((NI) (oldLen)));
					result = NIM_FALSE;
	...
	}
	{
		NIM_BOOL T21_;
		T21_ = (NIM_BOOL)0;
		T21_ = matchReturnType__concepts_557(c, (*(*(*(*n)._kind_6.sons.p->data[((NI)0)])._kind_4.sym).typ).sons.p->data[((NI)0)], (*(*candidate).typ).sons.p->data[((NI)0)], m);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!!(T21_)) goto LA22_;
		setLen__concepts_225((&(*m).inferred), ((NI) (oldLen)));
		result = NIM_FALSE;
...
{nimErr_ = nimErrorFlag();
	...
	candidates = searchInScopesFilterBy__lookups_476(c, (*(*(*n)._kind_6.sons.p->data[((NI)0)])._kind_4.sym).name, kinds);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		L = T3_;
		{
			while (1) {
				...
				(*m).magic = (*(*candidate)).magic;
				{
					NIM_BOOL T8_;
					T8_ = (NIM_BOOL)0;
					T8_ = matchSym__concepts_567(c, (*candidate), n, m);
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
					if (!T8_) goto LA9_;
					result = NIM_TRUE;
...
{nimErr_ = nimErrorFlag();
			...
			i_2 = ((NI)0);
			{
				while (1) {
					...
					i = i_2;
					{
						NIM_BOOL T7_;
						T7_ = (NIM_BOOL)0;
						T7_ = conceptMatchNode__concepts_141(c, (*n)._kind_6.sons.p->data[i], m);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						if (!!(T7_)) goto LA8_;
						result = NIM_FALSE;
						goto BeforeRet_;
	...
	{
		result = matchSyms__concepts_634(c, n, 487424, m);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)83):
	{
		result = matchSyms__concepts_634(c, n, 262144, m);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)82):
	{
		result = matchSyms__concepts_634(c, n, 131072, m);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)81):
	{
		result = matchSyms__concepts_634(c, n, 65536, m);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)80):
	{
		result = matchSyms__concepts_634(c, n, 16384, m);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)84):
	{
		result = matchSyms__concepts_634(c, n, 32768, m);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	default:
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	eqdestroy___concepts_745((&(*dest).inferred));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLast((*dest).marker.head);
		if (!T3_) goto LA4_;
		eqdestroy___pureZcollectionsZintsets_36((*dest).marker.head);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest).marker.head, ((NI)4));
	}
	LA4_: ;
	eqdestroy___pureZcollectionsZintsets_56((&(*dest).marker.data));
	{
		NIM_BOOL T8_;
		T8_ = (NIM_BOOL)0;
		T8_ = nimDecRefIsLast((*dest).potentialImplementation);
		if (!T8_) goto LA9_;
		nimDestroyAndDispose((*dest).potentialImplementation);
	}
	LA9_: ;
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = 0;
	eqcopy___ast_3546(&colontmpD_, arg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	m.potentialImplementation = colontmpD_;
	colontmpD__2 = lastSon__ast_6268((*concpt).n);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = conceptMatchNode__concepts_141(c, colontmpD__2, (&m));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		if (!result) goto LA4_;
		{
				...
				while (1) {
					...
					b = &m.inferred.p->data[i].Field1;
					{
						...
						} LA15: ;
						{
							...
							idTablePut__astalgo_71(bindings, &(*a)->Sup, (*((RootObj**) (&(dest)))));
							if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
						}
						LA26_: ;
						{
					...
					LA12_: ;
					{
						idTablePut__astalgo_71(bindings, &(*a)->Sup, &(*b)->Sup.Sup);
						if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
					}
					LA10_: ;
					i += ((NI)1);
		...
		idTablePut__astalgo_71(bindings, &concpt->Sup, &arg->Sup.Sup);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		{
			NIM_BOOL T33_;
			NIM_BOOL T34_;
			...
			T33_ = (NIM_BOOL)0;
			T34_ = (NIM_BOOL)0;
			T34_ = !((invocation == ((tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*) NIM_NIL)));
			if (!(T34_)) goto LA35_;
			T34_ = ((*arg).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)11));
			LA35_: ;
			T33_ = T34_;
			if (!(T33_)) goto LA36_;
			T37_ = (NI)0;
			T37_ = len__ast_5071(invocation);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			T38_ = (NI)0;
			T38_ = len__ast_5071(arg);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			...
			if (!T33_) goto LA39_;
			{
				...
				i_2 = (NI)0;
				colontmp_ = (NI)0;
				colontmp_ = len__ast_5071(invocation);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				i_3 = ((NI)1);
				{
					while (1) {
						...
						i_2 = i_3;
						idTablePut__astalgo_71(bindings, (*((tyObject_TIdObj__jPSvrmNCWI4CL3MSWxUHJQ**) (&((*invocation).sons.p->data[i_2])))), (*((RootObj**) (&((*arg).sons.p->data[i_2])))));
						if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
						i_3 += ((NI)1);
					} LA43: ;
				}
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = NIM_NIL;
	colontmpD__2 = NIM_NIL;
	ow = getCurrOwner__semdata_325(c);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD_ = getIdent__idents_166((*c).cache, TM__aQsd3Co9cjvf9b9cASJtnlgVw_5);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_ = nextSymId__ast_3268((*c).Sup.idgen);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T3_ = 0;
	s = newSym__ast_4028(((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)7), colontmpD_, T2_, ow, info, T3_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T4_ = nextTypeId__ast_3291((*c).Sup.idgen);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T5_ = NIM_NIL;
...
{nimErr_ = nimErrorFlag();
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			i_2 = ((NI)0);
			{
				while (1) {
					...
					i = i_2;
					T5_ = NIM_NIL;
					T5_ = semConceptDecl__concepts_62(c, (*n)._kind_6.sons.p->data[i]);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)159):
	{
		result = (*c).semExpr(c, n, 128, ((tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*) NIM_NIL));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)136):
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
			...
			i_4 = ((NI)0);
			{
				while (1) {
					...
					i_3 = i_4;
					eqcopy___ast_3457(&(*result)._kind_6.sons.p->data[i_3], (*n)._kind_6.sons.p->data[i_3]);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					i_4 += ((NI)1);
				} LA11: ;
			}
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T14_ = NIM_NIL;
		T14_ = semConceptDecl__concepts_62(c, (*n)._kind_6.sons.p->data[(NI)(T13_ - ((NI)1))]);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	default:
	{
		...
		T19_ = 0;
		colontmpD_ = renderTree__renderer_50(n, T19_);
...
appendString((&T18_), colontmpD_);
		colontmpD__2 = T18_;
		liMessage__msgs_1172((*(*c).graph).config, (*n).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__aQsd3Co9cjvf9b9cASJtnlgVw_8, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA17_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, semConceptDeclaration__concepts_98)(tyObject_TContext__QUPFyDhhyyn3RQbxNbH7xg* c, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n) {
	tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* result;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	declareSelf__concepts_14(c, (*n).info);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = semConceptDecl__concepts_62(c, n);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
