...
{nimErr_ = nimErrorFlag();
	...
	LA10_: ;
	{
		...
		setFromProjectName__options_4992(conf__cGIZsKolCreHptDfZ5F2BA, (*conf__cGIZsKolCreHptDfZ5F2BA).projectName);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA1_;
	LA13_: ;
	{
		...
		T17_ = canonicalizePath__options_4988(conf__cGIZsKolCreHptDfZ5F2BA, colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA16_;
