...
{nimErr_ = nimErrorFlag();
	...
	filename = toFullPath__msgs_599((*graph__uNAkReq0oHr9bUMZ0apLbBg).config, fileIdx__oD3hFRf4EApOxM9cASvyDnA);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_ = NIM_NIL;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	(*T2_).info = newLineInfo__msgs_418(fileIdx__oD3hFRf4EApOxM9cASvyDnA, ((NI)1), ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = T2_;
	{
		NIM_BOOL T5_;
...
appendString((&T9_), (*(*result).name).s);
		colontmpD__3 = T9_;
		liMessage__msgs_1182((*graph__uNAkReq0oHr9bUMZ0apLbBg).config, unknownLineInfo__lineinfos_338, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__PSTsdGjzLcJhNmbZsJdP6w_4), NIM_FALSE);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		filename = toFullPath__msgs_599((*graph__9bcjXAtWV8LUDw50psF7YWw).config, fileIdx__a3gGYXVY0NtakjVtCPJ9bKw);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA15_;
			{
				if (!((flags_2 &((NU64)1<<((NU)((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)14)))&63U)))!=0)) goto LA19_;
				{
					...
					sX60gensym4_ = llStreamOpen__llstream_95(__stdinp);
					if (NIM_UNLIKELY(*nimErr_)) goto LA15_;
				}
				goto LA21_;
				LA23_: ;
	...
	LA7_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA46_;
		{
			if (!((flags_2 &((NU64)1<<((NU)((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)14)))&63U)))!=0)) goto LA49_;
			{
				...
				sX60gensym7_ = llStreamOpen__llstream_95(__stdinp);
				if (NIM_UNLIKELY(*nimErr_)) goto LA46_;
			}
			goto LA51_;
			LA53_: ;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	T1_ = (NI32)0;
	T1_ = fileInfoIdx__msgs_403((*graph__ig9adQV6Z11QoifbVAzYnOw).config, filename__NfF4nHzpG9c5HGWgmSWQ6pw);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		T6_ = (NI32)0;
		T6_ = fileInfoIdx__msgs_403((*graph__jPlxqNWpraFvNhqANbcYrw).config, colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
...
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	{
		NIM_BOOL T4_;
		T4_ = (NIM_BOOL)0;
		T4_ = isEmpty__options_5393((*conf__9cf9cVT19az14UGPWI7V6emVw).projectFull);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T4_) goto LA5_;
		liMessage__msgs_1182(conf__9cf9cVT19az14UGPWI7V6emVw, gCmdLineInfo__msgs_441, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)1), TM__PSTsdGjzLcJhNmbZsJdP6w_15, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), (&TM__PSTsdGjzLcJhNmbZsJdP6w_16), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA5_: ;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T7_ = (NI32)0;
	T7_ = fileInfoIdx__msgs_403(conf__9cf9cVT19az14UGPWI7V6emVw, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
