		...
		nimZeroMem((void*)(&xX60gensym2162_), sizeof(tyTuple__UV3llMMYFckfui8YMBuUZA));
		{
			...
			i = ((NI)0);
			{
				while (1) {
					...
					T5_ = (NIM_BOOL)0;
					T5_ = eqeq___system_7494(environ[i], ((NCSTRING) NIM_NIL));
					if (!!(T5_)) goto LA4					;
					...
					T6_.Field0 = substr__system_7528(kv, ((NI)0), (NI)(p - ((NI)1)));
					T6_.Field1 = substr__system_7540(kv, (NI)(p + ((NI)1)));
...
appendString((&T1405_), colontmpD__155);
			...
			case ((tyEnum_TOpcode__g8HRIfzFsQsDBgE9cOvGknQ)152):
			{
				...
				T1713_ = (NI)0;
				{
					...
					T1716_ = (NIM_BOOL)0;
					T1717_ = (NIM_BOOL)0;
					T1717_ = eqeq___system_7494(aStrVal, ((NCSTRING) NIM_NIL));
					T1716_ = !(T1717_);
					if (!(T1716_)) goto LA1718_;
					T1719_ = (NIM_BOOL)0;
					T1719_ = eqeq___system_7494(bStrVal, ((NCSTRING) NIM_NIL));
					T1716_ = !(T1719_);
					LA1718_: ;
