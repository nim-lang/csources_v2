...
{nimErr_ = nimErrorFlag();
	...
	pkgIdent = NIM_NIL;
	filename = toFullPath__msgs_599(conf__E7GmAQhWacHns1tLR7mbew, fileIdx__wmV9bc9bisrti6zY2OeBcz9aQ);
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	info = newLineInfo__msgs_418(fileIdx__wmV9bc9bisrti6zY2OeBcz9aQ, ((NI)1), ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
