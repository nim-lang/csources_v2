...
static const struct {
  NI cap; NIM_CHAR data[7+1];
} TM__E1mVdicHuIr4qL2Kg2EGXQ_63 = { 7 | NIM_STRLIT_FLAG, "freebsd" };
...
static const NimStringV2 TM__E1mVdicHuIr4qL2Kg2EGXQ_93 = {11, (NimStrPayload*)&TM__E1mVdicHuIr4qL2Kg2EGXQ_70};
