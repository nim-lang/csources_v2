...
static N_INLINE(NIM_CHAR*, X5BX5D___system_7097)(NimStringV2* s, NI i);
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (T3_) goto LA4_;
		T5_ = (NIM_CHAR*)0;
		T5_ = X5BX5D___system_7097(dest, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T3_ = !(((NU8)((*T5_)) == (NU8)(32)));
		LA4_: ;
		if (!T3_) goto LA6_;
...
appendString((&T21_), TM__pZmXgBT0YcBrnAO6VUvpNQ_336);
	linkerArgs = T21_;
	args = substr__system_7581(cmd, i);
	{
		NIM_BOOL T24_;
		NimStringV2 colontmpD_;
		T24_ = (NIM_BOOL)0;
	...
	colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
	T34_.len = 0; T34_.p = NIM_NIL;
	colontmpD__2 = substr__system_7569(cmd, ((NI)0), last);
