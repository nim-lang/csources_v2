...
{nimErr_ = nimErrorFlag();
	{
		...
		if (T3_) goto LA4_;
		T5_ = (NIM_CHAR*)0;
		T5_ = X5BX5D___system_7097(dest__mlcrjR9afZOEzcsXiEnNpqA, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T3_ = !(((NU8)((*T5_)) == (NU8)(32)));
		LA4_: ;
		if (!T3_) goto LA6_;
...
appendString((&T21_), TM__pZmXgBT0YcBrnAO6VUvpNQ_336);
	linkerArgs = T21_;
	args = substr__system_7581(cmd__9clorThsgzIMyUFcc4fDYtA, i);
	{
		NIM_BOOL T24_;
		NimStringV2 colontmpD_;
		T24_ = (NIM_BOOL)0;
	...
	colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
	T34_.len = 0; T34_.p = NIM_NIL;
	colontmpD__2 = substr__system_7569(cmd__9clorThsgzIMyUFcc4fDYtA, ((NI)0), last);
...
appendString((&T21_), colontmpD__6);
			...
			LA15_: ;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
				colontmpD__9 = T26_;
				quit__system_7005(colontmpD__9, ((NI)1));
				eqdestroy___stdZassertions_13((&colontmpD__9));
				eqdestroy___stdZassertions_13((&colontmpD__8));
			}
			LA12_: ;
