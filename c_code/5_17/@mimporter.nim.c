...
{nimErr_ = nimErrorFlag();
	...
	X5BX5Deq___importer_2418((&(*c).importModuleMap), (NI)((NI)((NU64)(((NI) ((*xX60gensym100_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym100_).Sup.itemId.item))), (NI)((NI)((NU64)(((NI) ((*xX60gensym101_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym101_).Sup.itemId.item))));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	...
	xX60gensym136_ = m;
	T1_ = (NI*)0;
	T1_ = X5BX5D___importer_3873((&(*c).importModuleMap), (NI)((NI)((NU64)(((NI) ((*xX60gensym136_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym136_).Sup.itemId.item))));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	realModuleId = (*T1_);
	{
...
{nimErr_ = nimErrorFlag();
	...
	xX60gensym15_ = s;
	incl__pureZcollectionsZintsets_202(importSet, (NI)((NI)((NU64)(((NI) ((*xX60gensym15_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym15_).Sup.itemId.item))));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
