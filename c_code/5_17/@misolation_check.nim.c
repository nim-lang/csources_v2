...
{nimErr_ = nimErrorFlag();
	...
	xX60gensym7_ = NIM_NIL;
	{
		...
		T4_ = (NIM_BOOL)0;
		T4_ = containsOrIncl__astalgo_402(marker__GfJwNl9bt3A9bXcKSAhotxng, (NI)((NI)((NU64)(((NI) ((*xX60gensym7_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym7_).Sup.itemId.item))));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T4_) goto LA5_;
		result = NIM_FALSE;
	...
	LA9_: ;
	{
		...
		T13_ = 0;
		T14_ = (NIM_BOOL)0;
		T14_ = compareTypes__types_2855(arg__30E9bPeH0YMi729bKAMKrK4w_2, ret__kwgx23DdDZ2YyehNlxzvPA_2, ((tyEnum_TDistinctCompare__H0D0zbMLh4bchAD4N9bLm5A)1), T13_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T14_) goto LA15_;
		result = NIM_TRUE;
		eqdestroy___ast_3543(&xX60gensym7_);
