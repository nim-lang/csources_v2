...
appendString((&(*config).commandLine), colontmpD__2);
				...
				LA11_: ;
				{
					...
					eqsink___stdZassertions_19((&p.key), TM__xOfksDa5lOpfO1acT4wYQg_5);
					{
						NIM_BOOL T19_;
						T19_ = (NIM_BOOL)0;
						T19_ = processArgument__commands_1605(pass, (&p), (&argsCount), config);
						if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
						if (!T19_) goto LA20_;
				...
				LA15_: ;
				{
					processSwitch__commands_1598(pass, (&p), config);
					if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
				}
				LA13_: ;
				{
...
appendString((&(*config).commandLine), colontmpD__3);
				{
					NIM_BOOL T29_;
					T29_ = (NIM_BOOL)0;
					T29_ = processArgument__commands_1605(pass, (&p), (&argsCount), config);
					if (NIM_UNLIKELY(*nimErr_)) goto LA26_;
					if (!T29_) goto LA30_;
