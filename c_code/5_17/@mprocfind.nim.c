...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*, searchForProcAux__procfind_49)(tyObject_TContext__QUPFyDhhyyn3RQbxNbH7xg* c__g8CQifqRodYV6x8XxkJ1nA, tyObject_TScope__UGPjl9bmDNGJVWv0GAkg6Cw* scope__TVXTCBv9aeEDWgDNjGUSRag, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* fn__K7J9arb9afnxumxKmW9ciBcPw);
...
{nimErr_ = nimErrorFlag();
	...
	result = initIdentIter__astalgo_3586((&it), (*scope__TVXTCBv9aeEDWgDNjGUSRag).symbols, (*fn__K7J9arb9afnxumxKmW9ciBcPw).name);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		while (1) {
			...
			if (!!((result == ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL)))) goto LA3			;
			{
				...
				if (!((*result).kind == (*fn__K7J9arb9afnxumxKmW9ciBcPw).kind)) goto LA6_;
				T8_ = (tyEnum_TParamsEquality__WFKEjDRKHaTVsIql5wef3A)0;
				T8_ = equalParams__types_97((*(*result).typ).n, (*(*fn__K7J9arb9afnxumxKmW9ciBcPw).typ).n);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				switch (T8_) {
				...
				{
					{
						...
						if (!(T12_)) goto LA13_;
						T12_ = (((*fn__K7J9arb9afnxumxKmW9ciBcPw).flags &((NU64)1<<((NU)((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)1)))&63U)))!=0);
						LA13_: ;
						if (!T12_) goto LA14_;
						message.len = 0; message.p = NIM_NIL;
						colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
						colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
						colontmpD_ = getProcHeader__types_223((*(*c__g8CQifqRodYV6x8XxkJ1nA).graph).config, result, ((tyEnum_TPreferedDesc__bf5goTo3KJxvaEQ7KVg4rQ)0), NIM_FALSE);
						if (NIM_UNLIKELY(*nimErr_)) goto LA16_;
						T17_[0] = colontmpD_;
						colontmpD__2 = dollar___msgs_685((*(*c__g8CQifqRodYV6x8XxkJ1nA).graph).config, (*result).info);
						if (NIM_UNLIKELY(*nimErr_)) goto LA16_;
						T17_[1] = colontmpD__2;
						message = nsuFormatOpenArray(TM__MALTqiRBncWEHKctMxWZIA_3, T17_, 2);
						if (NIM_UNLIKELY(*nimErr_)) goto LA16_;
						liMessage__msgs_1182((*(*c__g8CQifqRodYV6x8XxkJ1nA).graph).config, (*fn__K7J9arb9afnxumxKmW9ciBcPw).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), message, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__MALTqiRBncWEHKctMxWZIA_4), NIM_FALSE);
						if (NIM_UNLIKELY(*nimErr_)) goto LA16_;
						{
							LA16_:;
						}
				...
				case ((tyEnum_TParamsEquality__WFKEjDRKHaTVsIql5wef3A)2):
				{
					...
					colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
					eqcopy___stdZassertions_16((&colontmpD__3), (*(*fn__K7J9arb9afnxumxKmW9ciBcPw).name).s);
					colontmpD__4 = nsuFormatSingleElem(TM__MALTqiRBncWEHKctMxWZIA_7, colontmpD__3);
					if (NIM_UNLIKELY(*nimErr_)) goto LA21_;
					liMessage__msgs_1182((*(*c__g8CQifqRodYV6x8XxkJ1nA).graph).config, (*fn__K7J9arb9afnxumxKmW9ciBcPw).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__4, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__MALTqiRBncWEHKctMxWZIA_8), NIM_FALSE);
					if (NIM_UNLIKELY(*nimErr_)) goto LA21_;
			...
			LA6_: ;
			T25_ = NIM_NIL;
			T25_ = nextIdentIter__astalgo_3562((&it), (*scope__TVXTCBv9aeEDWgDNjGUSRag).symbols);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
N_LIB_PRIVATE N_NIMCALL(void, searchForProc__procfind_73)(tyObject_TContext__QUPFyDhhyyn3RQbxNbH7xg* c__L6f7nB79c5lfTKkXa5mYzcQ, tyObject_TScope__UGPjl9bmDNGJVWv0GAkg6Cw* scope__VtdBPEjJHpAuzKnbRzn9bPw, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* fn__zbXS7bhbVjhcM75iOloYYw, tyTuple__9a4RKkDc9aTY5miJHCPSqE3g* Result) {
...
{nimErr_ = nimErrorFlag();
	...
	scope_2 = NIM_NIL;
	eqcopy___lookups_82(&scope_2, scope__VtdBPEjJHpAuzKnbRzn9bPw);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_ = NIM_NIL;
	T2_ = searchForProcAux__procfind_49(c__L6f7nB79c5lfTKkXa5mYzcQ, scope_2, fn__zbXS7bhbVjhcM75iOloYYw);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		while (1) {
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			T7_ = NIM_NIL;
			T7_ = searchForProcAux__procfind_49(c__L6f7nB79c5lfTKkXa5mYzcQ, scope_2, fn__zbXS7bhbVjhcM75iOloYYw);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
