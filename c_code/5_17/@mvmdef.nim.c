...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_7074)(NI* dest);
...
{nimErr_ = nimErrorFlag();
	...
	LA59_: ;
	{
		...
		if (!T63_) goto LA64_;
		eqdestroy___system_7074((*dest).templInstCounter);
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___vm_14288)(NI** dest, NI* src) {
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLast((*dest));
