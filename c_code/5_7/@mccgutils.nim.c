...
{nimErr_ = nimErrorFlag();
	...
	T1_ = (NI64)0;
	T1_ = getSize__types_3546(conf__ywDgD9bVl4jg1iQxqLyAJpg, typ__v9bejLPgkKHOafPTA9cTt0xA);
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)17):
	{
		...
		LA14_: ;
		{
			...
			if (T17_) goto LA18_;
			T19_ = (NI64)0;
			T19_ = getSize__types_3546(conf__waEtoC9a79cJiIhSFHfoS03A, pt);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)18):
	{
		...
		T29_ = (NIM_BOOL)0;
		T30_ = (NI64)0;
		T30_ = getSize__types_3546(conf__waEtoC9a79cJiIhSFHfoS03A, pt);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
