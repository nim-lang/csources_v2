...
{nimErr_ = nimErrorFlag();
	...
	fullPath = findModule__options_5408(conf, module, relativeTo);
...
{nimErr_ = nimErrorFlag();
	...
	relativeTo = toFullPath__msgs_589((*graph).config, (*m).info.fileIndex);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NimStringV2* module;
		NI i;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		filename = toFullPathConsiderDirty__msgs_622((*graph).config, fileIdx);
		if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
		{
			...
			liMessage__msgs_1172((*graph).config, unknownLineInfo__lineinfos_338, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)4), filename, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)1), TM__bJkNie0SMVJdkbkyvVtTzg_5, NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			result = NIM_FALSE;
...
{nimErr_ = nimErrorFlag();
	nimZeroMem((void*)(&colontmpD_), sizeof(tyTuple__GicXS2CKoWgwFlNKz2d15w));
	{
		...
		internalErrorImpl__msgs_1510((*g).config, unknownLineInfo__lineinfos_338, argX60gensym1_, TM__bJkNie0SMVJdkbkyvVtTzg_17);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
