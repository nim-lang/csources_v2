...
static N_INLINE(NimStringV2, getCurrentExceptionMsg__system_6876)(void);
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T5_ = getCurrentExceptionMsg__system_6876();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T17_ = getCurrentExceptionMsg__system_6876();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T16_ = getCurrentExceptionMsg__system_6876();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T9_ = getCurrentExceptionMsg__system_6876();
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			T11_.len = 0; T11_.p = NIM_NIL;
			T11_ = getCurrentExceptionMsg__system_6876();
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			T10_.len = 0; T10_.p = NIM_NIL;
			T10_ = getCurrentExceptionMsg__system_6876();
	...
	if (NIM_UNLIKELY(*nimErr_)) {
		...
		if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
			...
			*nimErr_ = NIM_FALSE;
			...
			T14_ = getCurrentExceptionMsg__system_6876();
