...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___pureZosproc_1647)(tyTuple__XOVT24GHXwqiEj5GCsEGCA* dest__qKc2jknF30aTLZ7Tc9cVb4A);
...
N_LIB_PRIVATE N_NIMCALL(void, addFloatRoundtrip__system_4391)(NimStringV2* result__qvuWI64tfQT6kViLfCi1hg, NF x__UyPVzaCaJ9bo79aeR3Dk6SuA);
...
static N_INLINE(NIM_BOOL, eqeq___system_7523)(NCSTRING x__Z3lojyrZeeORXB9aFmHlS7w, NCSTRING y__SlnicWIZiUaUC9cl2PfooTA);
...
N_LIB_PRIVATE N_NIMCALL(tySequence__sM4lkSb7zS6F7OVMvW9cffQ, querySettingSeqImpl__vm_13274)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf__R1D2RukbmapWZ9aDLb232qQ, NI64 switch__dkUh9aTTuLOgUZ072GHSo9bA) {
	...
	{
		eqcopy___system_3533((&result), (*conf__R1D2RukbmapWZ9aDLb232qQ).commandArgs);
	}
	break;
		...
		nimZeroMem((void*)(&xX60gensym2162_), sizeof(tyTuple__UV3llMMYFckfui8YMBuUZA));
		{
			...
			i = ((NI)0);
			{
				while (1) {
					...
					T5_ = (NIM_BOOL)0;
					T5_ = eqeq___system_7523(environ[i], ((NCSTRING) NIM_NIL));
					if (!!(T5_)) goto LA4					;
					...
					T6_.Field0 = substr__system_7557(kv, ((NI)0), (NI)(p - ((NI)1)));
					T6_.Field1 = substr__system_7569(kv, (NI)(p + ((NI)1)));
...
appendString((&T44_), colontmpD_);
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)36) ... ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)39):
		{
			...
			T61_ = dollar___system_4382(src__eKVNJdhi9cJo8gPYaVUOv9bQ.floatVal);
			if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
...
appendString((&T567_), colontmpD__86);
			...
			case ((tyEnum_TOpcode__g8HRIfzFsQsDBgE9cOvGknQ)41):
			{
				...
				LA659_: ;
				{
					...
					NF T663_;
					T662_ = (NF)0;
					T662_ = abs__system_4699(((NF)(resAsFloat) - (NF)(floatProd)));
					T663_ = (NF)0;
					T663_ = abs__system_4699(floatProd);
...
appendString((&T1405_), colontmpD__155);
			...
			case ((tyEnum_TOpcode__g8HRIfzFsQsDBgE9cOvGknQ)152):
			{
				...
				T1713_ = (NI)0;
				{
					...
					T1716_ = (NIM_BOOL)0;
					T1717_ = (NIM_BOOL)0;
					T1717_ = eqeq___system_7523(aStrVal, ((NCSTRING) NIM_NIL));
					T1716_ = !(T1717_);
					if (!(T1716_)) goto LA1718_;
					T1719_ = (NIM_BOOL)0;
					T1719_ = eqeq___system_7523(bStrVal, ((NCSTRING) NIM_NIL));
					T1716_ = !(T1719_);
					LA1718_: ;
