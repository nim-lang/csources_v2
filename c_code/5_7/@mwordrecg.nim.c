...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = nsuNormalize(s__qINv9bDtOLcdcNdqZCV2cQg);
...
break;
	...
	LA37_: ;
	{
		colontmpD__38 = default__p31KFJlibshSDE7XAJu87g;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = nsuNormalize(s__qINv9bDtOLcdcNdqZCV2cQg_2);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	switch (hashString(colontmpD_) & 63) {
	case 1: 
...
break;
	...
	LA60_: ;
	{
		colontmpD__61 = default__p31KFJlibshSDE7XAJu87g_2;
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, dollar___wordrecg_302)(tyEnum_TSpecialWord__hTGV9ad79bZJfqtldnYLJ8AA e__SBH9bTuVc09brCJoksMKgjyA) {
	...
	switch (e__SBH9bTuVc09brCJoksMKgjyA) {
