...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__stdZoserrors_82(T6_, file__J7TxM2NvlX9btMhQD9bZz39bA);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA4_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	LA17_: ;
	{
		...
		s = (FILE*)0;
		{
			...
			NI32 T28_;
			T25_ = (NIM_BOOL)0;
			T25_ = open__stdZsyncio_403(&s, source__eoCVFNpLZVLXwyKu7SJhzg, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)0), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!!(T25_)) goto LA26_;
			T28_ = (NI32)0;
			T28_ = osLastError__stdZoserrors_85();
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			raiseOSError__stdZoserrors_82(T28_, source__eoCVFNpLZVLXwyKu7SJhzg);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA26_: ;
		{
			...
			NI32 T34_;
			T31_ = (NIM_BOOL)0;
			T31_ = open__stdZsyncio_403(&d, dest__C3yHuHrfbm8qUZjgenJyMA, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)1), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!!(T31_)) goto LA32_;
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			raiseOSError__stdZoserrors_82(T34_, dest__C3yHuHrfbm8qUZjgenJyMA);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA32_: ;
			...
			while (1) {
				...
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				{
					...
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					{
						...
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						raiseOSError__stdZoserrors_82(T45_, dest__C3yHuHrfbm8qUZjgenJyMA);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					}
					LA43_: ;
				}
...
{nimErr_ = nimErrorFlag();
	...
	LA35_: ;
	{
		...
		if (!T39_) goto LA41_;
		{
			...
			T45_ = (int)0;
			T45_ = lchmod(nimToCStringConv(filename__AbxScOR5bFOJC9aDcW4AtpQ), ((mode_t) (p)));
			if (!!((T45_ == ((NI32)0)))) goto LA46_;
			colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
			T49_ = (NI32)0;
			T49_ = osLastError__stdZoserrors_85();
			if (NIM_UNLIKELY(*nimErr_)) goto LA48_;
			T50_.Field0 = filename__AbxScOR5bFOJC9aDcW4AtpQ;
			T50_.Field1 = permissions__xkP9bVS9abLKHyQ9aqcjEfk4g;
	...
	{
		{
			...
			T56_ = (int)0;
			T56_ = chmod(nimToCStringConv(filename__AbxScOR5bFOJC9aDcW4AtpQ), ((mode_t) (p)));
			if (!!((T56_ == ((NI32)0)))) goto LA57_;
			colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
			T60_ = (NI32)0;
			T60_ = osLastError__stdZoserrors_85();
			if (NIM_UNLIKELY(*nimErr_)) goto LA59_;
			T61_.Field0 = filename__AbxScOR5bFOJC9aDcW4AtpQ;
			T61_.Field1 = permissions__xkP9bVS9abLKHyQ9aqcjEfk4g;
...
{nimErr_ = nimErrorFlag();
	...
	nimZeroMem((void*)(&a), sizeof(struct stat));
	{
		...
		T6_ = osLastError__stdZoserrors_85();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__stdZoserrors_82(T6_, filename__dWTHPlpwFwY9csM33S0AvUg);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA4_: ;
	result = 0;
