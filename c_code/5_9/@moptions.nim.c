...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		if (!(T3_)) goto LA4_;
		T5_ = (NIM_CHAR)0;
		T5_ = X5BX5D___system_7029(path__rDlV0AybldUJC43fBJPMOQ, ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T3_ = ((NU8)(T5_) == (NU8)(47));
		LA4_: ;
		if (!T3_) goto LA6_;
		result = substr__system_7540(path__rDlV0AybldUJC43fBJPMOQ, ((NI)0), (NI)(path__rDlV0AybldUJC43fBJPMOQ.len - ((NI)2)));
	}
	goto LA1_;
	LA6_: ;
	{
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		if (!T4_) goto LA5_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		colontmpD_ = substr__system_7552(m, ((NI)4));
	...
	{
		{
			...
			stripped = substr__system_7552(m, ((NI)4));
			{
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		result = substr__system_7540(s__1ceeuiYOZLpou68rQyB42A, start, (NI)(ende - ((NI)1)));
	}
	goto LA7_;
	LA9_: ;
	{
		result = substr__system_7552(s__1ceeuiYOZLpou68rQyB42A, start);
	}
	LA7_: ;
	}BeforeRet_: ;
	return result;
