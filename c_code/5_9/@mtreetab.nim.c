...
{nimErr_ = nimErrorFlag();
	...
	{
		{
			NIM_BOOL T11_;
			T11_ = (NIM_BOOL)0;
			T11_ = ((IL64(-9223372036854775807) - IL64(1)) <= (*n__ODIYefRFMfxTZ2hoqGQhTw)._kind_1.intVal);
			if (!(T11_)) goto LA12_;
			T11_ = ((*n__ODIYefRFMfxTZ2hoqGQhTw)._kind_1.intVal <= IL64(9223372036854775807));
			LA12_: ;
			if (!T11_) goto LA13_;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)20) ... ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)22):
	{
		NI T24_;
		T24_ = (NI)0;
		T24_ = hash__pureZhashes_297((*n__ODIYefRFMfxTZ2hoqGQhTw)._kind_3.strVal);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		}
		{
			...
			T37_ = 0;
			result = sameTypeOrNil__types_2031((*a__9aKCOFq3z4sumaeCEcoISfA).typ, (*b__ulOHibVlUWdP7gbq4i7jCw).typ, T37_);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA35_: ;
	}
