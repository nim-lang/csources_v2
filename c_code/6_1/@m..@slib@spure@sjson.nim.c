...
static N_INLINE(void, addFloat__system_4370)(NimStringV2* result__kg9ckGeMYmxP6xOB2cp9cTFQ, NF x__B8zNOqPb3ZgWjcFTDSO77w);
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	addFloatRoundtrip__system_4375(result__kg9ckGeMYmxP6xOB2cp9cTFQ, x__B8zNOqPb3ZgWjcFTDSO77w);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, toUgly__pureZjson_4743)(NimStringV2* result__t76HmYMk3WTz8qqFffWEbQ, tyObject_JsonNodeObj__df9bshXB7C9cTiWPIOtX3j1Q* node__G8YY13gDSfD5ONhDuqSA6g) {
...
appendString((&(*result__t76HmYMk3WTz8qqFffWEbQ)), (*node__G8YY13gDSfD5ONhDuqSA6g)._kind_1.str);
	...
	case ((tyEnum_JsonNodeKind__RUngo7nCHe6O8aBGIcrhtg)3):
	{
		addFloat__system_4370(result__t76HmYMk3WTz8qqFffWEbQ, (*node__G8YY13gDSfD5ONhDuqSA6g)._kind_3.fnum);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_JsonNodeKind__RUngo7nCHe6O8aBGIcrhtg)1):
...
appendString((&(*result__WpC9amMKKgepd9cYJK70H74A)), TM__9b9bytt1stv9cZ8uqII7HFgew_76);
	...
	case ((tyEnum_JsonNodeKind__RUngo7nCHe6O8aBGIcrhtg)3):
	{
		...
		LA43_: ;
		addFloat__system_4370(result__WpC9amMKKgepd9cYJK70H74A, (*node__4nVhkKjFngmv5gIj0wOEOQ)._kind_3.fnum);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_JsonNodeKind__RUngo7nCHe6O8aBGIcrhtg)1):
