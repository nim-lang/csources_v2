...
{nimErr_ = nimErrorFlag();
	...
	LA9_: ;
	{
		...
		nimRawDispose((*dest__EfJrcFdv0DUdsNUsAzVobg_2).config, ((NI)4));
	}
	LA14_: ;
	{
		NIM_BOOL T18_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__EfJrcFdv0DUdsNUsAzVobg_2).graph, ((NI)4));
	}
	LA19_: ;
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__6.len = 0; colontmpD__6.p = NIM_NIL;
	{
		...
		colontmpD__7 = dollar___ast_192((*n__53QoMAI6DgP7D1uiiRUEaw).kind);
...
appendString((&T5_), colontmpD__7);
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T6_ = (NIM_BOOL)0;
	T6_ = belongsToStdlib__modulegraphs_14987((*g__0ENgSKXNJZiPZ0wsZ11ghA).graph, (*g__0ENgSKXNJZiPZ0wsZ11ghA).module);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T7_ = (NIM_BOOL)0;
	T7_ = belongsToStdlib__modulegraphs_14987((*g__0ENgSKXNJZiPZ0wsZ11ghA).graph, (*n__53QoMAI6DgP7D1uiiRUEaw)._kind_4.sym);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	eqdestroy___stdZassertions_13((&colontmpD__2));
	eqdestroy___pureZos_244((&modulePath));
	eqdestroy___stdZassertions_13((&colontmpD_));
	eqdestroy___pureZos_244((&path));
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___depends_200)(tyObject_BackendcolonObjectType___45kLepe9bud4dvwPA9ctgKAg** dest__EfJrcFdv0DUdsNUsAzVobg_3) {
	{
