...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)22):
	{
		...
		T4_ = toFullPath__msgs_599(conf__1wFx1nxHoIUnNPJUblx19bA, (*n__XjmJ9ck5w8XBdsBZTsuVprw).info.fileIndex);
...
appendString((&T13_), (*n__XjmJ9ck5w8XBdsBZTsuVprw)._kind_3.strVal);
				colontmpD__3 = T13_;
				liMessage__msgs_1182(conf__1wFx1nxHoIUnNPJUblx19bA, (*n__XjmJ9ck5w8XBdsBZTsuVprw).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__GNhKqIyvrFjtq6zf1JX7qg_15, NIM_FALSE);
...
appendString((&result), modname);
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)45):
	{
		...
		liMessage__msgs_1182(conf__1wFx1nxHoIUnNPJUblx19bA, (*n__XjmJ9ck5w8XBdsBZTsuVprw).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)23), TM__GNhKqIyvrFjtq6zf1JX7qg_24, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__GNhKqIyvrFjtq6zf1JX7qg_25, NIM_FALSE);
	...
	default:
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA41_;
		colontmpD__8 = T44_;
		liMessage__msgs_1182(conf__1wFx1nxHoIUnNPJUblx19bA, (*n__XjmJ9ck5w8XBdsBZTsuVprw).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__8, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__GNhKqIyvrFjtq6zf1JX7qg_31, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA41_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD_ = toFullPath__msgs_599(conf__tamsf9axZpZRgHhpyPi7LHA, (*n__txnzfiFQ51y9aJIxt3SVtpQ).info.fileIndex);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
appendString((&T18_), m);
			colontmpD__2 = T18_;
			liMessage__msgs_1182(conf__tamsf9axZpZRgHhpyPi7LHA, (*n__txnzfiFQ51y9aJIxt3SVtpQ).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__GNhKqIyvrFjtq6zf1JX7qg_35, NIM_FALSE);
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			{
				LA11_:;
			}
