...
{nimErr_ = nimErrorFlag();
	...
	{
		{
			...
			if (!T31_) goto LA33_;
			{
				...
				T37_ = (NIM_BOOL)0;
				T38_ = 0;
				T37_ = sameType__types_2000((*f).sons.p->data[((NI)0)], (*a).sons.p->data[((NI)0)], T38_);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				if (!(T37_)) goto LA39_;
				T40_ = (NI)0;
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)12):
	{
		...
		LA59_: ;
		{
			...
			LA65_: ;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA62_;
				T90_ = (NIM_BOOL)0;
				T90_ = containsOrIncl__astalgo_402((&(*m).marker), (NI)((NI)((NU64)(((NI) ((*xX60gensym32_).Sup.itemId.module))) << (NU64)(((NI)24))) + ((NI) ((*xX60gensym32_).Sup.itemId.item))));
				if (NIM_UNLIKELY(*nimErr_)) goto LA62_;
				if (!!(T90_)) goto LA91_;
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)13):
	{
		...
		T113_ = 0;
		result = sameType__types_2000(f, a, T113_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
