...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*, genEnumToStrProc__enumtostr_7)(tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* t__fknTQxQ4c5C0cboAxuEipA, tyObject_TLineInfo__7ZAGqjaN6WqWPlHP9cRagRg info__evYNm03UF9ap23S0C8ygj4Q, tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g__F3xXaVFDM09c0apn1ARG9aFQ, tyObject_IdGeneratorcolonObjectType___C1k2TcDRT9cU4DEatQIT09ag* idgen__SVTTQNmfZ3sdK9aozpYJayg) {
...
{nimErr_ = nimErrorFlag();
	...
	n = NIM_NIL;
	colontmpD_ = getIdent__idents_166((*g__F3xXaVFDM09c0apn1ARG9aFQ).cache, TM__4HR9b46RdRlu2Ass0WPVCAw_3);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_ = nextSymId__ast_3268(idgen__SVTTQNmfZ3sdK9aozpYJayg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T3_ = 0;
	result = newSym__ast_4028(((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)12), colontmpD_, T2_, (*t__fknTQxQ4c5C0cboAxuEipA).owner, info__evYNm03UF9ap23S0C8ygj4Q, T3_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__2 = getIdent__idents_166((*g__F3xXaVFDM09c0apn1ARG9aFQ).cache, TM__4HR9b46RdRlu2Ass0WPVCAw_5);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T4_ = nextSymId__ast_3268(idgen__SVTTQNmfZ3sdK9aozpYJayg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T5_ = 0;
	dest = newSym__ast_4028(((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)3), colontmpD__2, T4_, result, info__evYNm03UF9ap23S0C8ygj4Q, T5_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqcopy___ast_3546(&(*dest).typ, t__fknTQxQ4c5C0cboAxuEipA);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__3 = getIdent__idents_166((*g__F3xXaVFDM09c0apn1ARG9aFQ).cache, TM__4HR9b46RdRlu2Ass0WPVCAw_7);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T6_ = nextSymId__ast_3268(idgen__SVTTQNmfZ3sdK9aozpYJayg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T7_ = 0;
	res = newSym__ast_4028(((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)11), colontmpD__3, T6_, result, info__evYNm03UF9ap23S0C8ygj4Q, T7_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T8_ = NIM_NIL;
	T8_ = getSysType__magicsys_60(g__F3xXaVFDM09c0apn1ARG9aFQ, info__evYNm03UF9ap23S0C8ygj4Q, ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)28));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqsink___ast_3549(&(*res).typ, T8_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T9_ = nextTypeId__ast_3291(idgen__SVTTQNmfZ3sdK9aozpYJayg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T10_ = NIM_NIL;
	T10_ = newType__ast_4969(((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)25), T9_, (*t__fknTQxQ4c5C0cboAxuEipA).owner);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqsink___ast_3549(&(*result).typ, T10_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T11_ = NIM_NIL;
	T11_ = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)76), info__evYNm03UF9ap23S0C8ygj4Q);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqsink___ast_3460(&(*(*result).typ).n, T11_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	rawAddSon__ast_5669((*result).typ, (*res).typ, NIM_TRUE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__4 = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)152), info__evYNm03UF9ap23S0C8ygj4Q);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	add__ast_6233((*(*result).typ).n, colontmpD__4);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	addParam__ast_6518((*result).typ, dest);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	body = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)115), info__evYNm03UF9ap23S0C8ygj4Q);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	caseStmt = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)97), info__evYNm03UF9ap23S0C8ygj4Q);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		i = (NI)0;
		colontmp_ = (NI)0;
		colontmp_ = len__ast_3325((*t__fknTQxQ4c5C0cboAxuEipA).n);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		i_2 = ((NI)0);
		{
			while (1) {
				...
				i = i_2;
				eqcopy___ast_4063(&field, (*(*(*t__fknTQxQ4c5C0cboAxuEipA).n)._kind_6.sons.p->data[i])._kind_4.sym);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				...
				colontmpD__6 = newIntTypeNode__ast_4848(((NI64) ((*field).position)), t__fknTQxQ4c5C0cboAxuEipA);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				T21_[0] = colontmpD__6;
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				T23_[0] = colontmpD__7;
				colontmpD__8 = newStrNode__ast_4885(val, info__evYNm03UF9ap23S0C8ygj4Q);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				T23_[1] = colontmpD__8;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	n = newNodeI__ast_3953(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)79), info__evYNm03UF9ap23S0C8ygj4Q, ((NI)8));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NI i_3;
		NI colontmp__2;
		...
		i_4 = ((NI)0);
		{
			while (1) {
				...
				i_3 = i_4;
				T27_ = NIM_NIL;
				T27_ = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)1), info__evYNm03UF9ap23S0C8ygj4Q);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
