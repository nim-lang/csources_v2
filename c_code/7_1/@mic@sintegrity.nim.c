...
N_LIB_PRIVATE N_NIMCALL(void, checkModule__icZintegrity_789)(tyObject_CheckedContext__j646oLlGVRWZyd5wzo62Ww* c__Svizn6yfFuwJpEpL7rzzZw, tyObject_PackedModule__i9anwDwJxE2V9bIMoIqqe9chA* m__dzXNISgtKhnsKfvWWzBasg);
N_LIB_PRIVATE N_NIMCALL(void, checkLocalSym__icZintegrity_644)(tyObject_CheckedContext__j646oLlGVRWZyd5wzo62Ww* c__tpGEIIyTTdBkUaJGHU8HtQ, NI32 item__sAPrJHwSD3K0zzwTfgwnZQ);
...
N_LIB_PRIVATE N_NIMCALL(void, checkSym__icZintegrity_623)(tyObject_CheckedContext__j646oLlGVRWZyd5wzo62Ww* c__MVlK9ccxukTb0hAA68L2Sxg, tyObject_PackedSym__lJeIt8gwxYwQVC9aD43t8QA* s__IKjxirXE1SoTsskEtyrYkQ);
N_LIB_PRIVATE N_NIMCALL(void, checkType__icZintegrity_19)(tyObject_CheckedContext__j646oLlGVRWZyd5wzo62Ww* c__gid4JDNEy7eQ9cko3q2WGCw, tyObject_PackedItemId__ujcbfSfQQs6BRj9aXRwDsoA typeId__mR09clQh9aNCEsygtl05JACQ);
...
N_LIB_PRIVATE N_NIMCALL(void, checkTypeObj__icZintegrity_29)(tyObject_CheckedContext__j646oLlGVRWZyd5wzo62Ww* c__u25tNJxmcTo0h0foe0Vhbw, tyObject_PackedType__KhxjjuiksMoB49bARLu38lQ* typ__DePEiBTd4KUzE4h79aKhg9aw);
N_LIB_PRIVATE N_NIMCALL(void, checkNode__icZintegrity_25)(tyObject_CheckedContext__j646oLlGVRWZyd5wzo62Ww* c__rcsJ164GF3k8j0dDGyTJTw, tyObject_PackedTree__NQ7d1M9bD3cUZLhD9aRSVMRw tree__JpcKSs2EE9a4toFqE0rzlIw, NI n__TVkfP8au9bPVOp3vPSC9bu7Q);
...
N_LIB_PRIVATE N_NIMCALL(void, checkForeignSym__icZintegrity_22)(tyObject_CheckedContext__j646oLlGVRWZyd5wzo62Ww* c__HgvrulriN7wWjqdKyd9bh4g, tyObject_PackedItemId__ujcbfSfQQs6BRj9aXRwDsoA symId__ZnttDIiYfzDYfvajhbohPw);
...
N_LIB_PRIVATE N_NIMCALL(void, checkTree__icZintegrity_740)(tyObject_CheckedContext__j646oLlGVRWZyd5wzo62Ww* c__FzuEe29bdJnC2leGnF7Kqmw, tyObject_PackedTree__NQ7d1M9bD3cUZLhD9aRSVMRw t__w9cOFdM8hflqB9cqlUWnH9afA);
...
N_LIB_PRIVATE N_NIMCALL(void, checkLocalSymIds__icZintegrity_744)(tyObject_CheckedContext__j646oLlGVRWZyd5wzo62Ww* c__1S6XRANRn7n62AQFKD6oqA, tyObject_PackedModule__i9anwDwJxE2V9bIMoIqqe9chA* m__EE17h3StW9cnKa5pEcBcJmA, tySequence__48JTohSgTy339bRxHzUD8KA symIds__QsXs9czGakYC9crCkTZ7RPrw);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___icZintegrity_840)(tyObject_CheckedContext__j646oLlGVRWZyd5wzo62Ww* dest__4osvJjQRVmwdku9cf3RtFyg);
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	itemId = translateId__icZic_10587(symId__ZnttDIiYfzDYfvajhbohPw, (*(*c__HgvrulriN7wWjqdKyd9bh4g).g).packed_0, ((NI) ((*c__HgvrulriN7wWjqdKyd9bh4g).thisModule)), (*(*c__HgvrulriN7wWjqdKyd9bh4g).g).config);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T3_;
		NI32 oldThisModule;
		T3_ = (NIM_BOOL)0;
		T3_ = containsOrIncl__icZintegrity_63((&(*c__HgvrulriN7wWjqdKyd9bh4g).checkedSyms), itemId);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T3_)) goto LA4_;
		oldThisModule = (*c__HgvrulriN7wWjqdKyd9bh4g).thisModule;
		(*c__HgvrulriN7wWjqdKyd9bh4g).thisModule = itemId.module;
		checkSym__icZintegrity_623(c__HgvrulriN7wWjqdKyd9bh4g, (&(*(*c__HgvrulriN7wWjqdKyd9bh4g).g).packed_0.p->data[itemId.module].fromDisk.syms.p->data[itemId.item]));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(*c__HgvrulriN7wWjqdKyd9bh4g).thisModule = oldThisModule;
	}
	LA4_: ;
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	{
		...
		T3_ = X5BX5D___icZpacked95ast_452((&tree__JpcKSs2EE9a4toFqE0rzlIw), n__TVkfP8au9bPVOp3vPSC9bu7Q);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T4_ = (NIM_BOOL)0;
		T4_ = eqeq___icZic_7879((*T3_).typeId_0, nilItemId__icZpacked95ast_15);
		if (!!(T4_)) goto LA5_;
		T7_ = (tyObject_PackedNode__4DO5SncX6BltUGwnK9bpl3Q*)0;
		T7_ = X5BX5D___icZpacked95ast_452((&tree__JpcKSs2EE9a4toFqE0rzlIw), n__TVkfP8au9bPVOp3vPSC9bu7Q);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		checkType__icZintegrity_19(c__rcsJ164GF3k8j0dDGyTJTw, (*T7_).typeId_0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA5_: ;
	switch (tree__JpcKSs2EE9a4toFqE0rzlIw.nodes.p->data[n__TVkfP8au9bPVOp3vPSC9bu7Q].kind) {
	...
	{
		checkLocalSym__icZintegrity_644(c__rcsJ164GF3k8j0dDGyTJTw, tree__JpcKSs2EE9a4toFqE0rzlIw.nodes.p->data[n__TVkfP8au9bPVOp3vPSC9bu7Q].operand);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)162):
	{
		...
		T15_ = sons2__icZpacked95ast_675(tree__JpcKSs2EE9a4toFqE0rzlIw, n__TVkfP8au9bPVOp3vPSC9bu7Q);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		n1 = T15_.Field0;
		n2 = T15_.Field1;
		nimZeroMem((void*)(&T16_), sizeof(tyObject_PackedItemId__ujcbfSfQQs6BRj9aXRwDsoA));
		T16_.module = ((NU32) (tree__JpcKSs2EE9a4toFqE0rzlIw.nodes.p->data[n1].operand));
		T16_.item = tree__JpcKSs2EE9a4toFqE0rzlIw.nodes.p->data[n2].operand;
		checkForeignSym__icZintegrity_22(c__rcsJ164GF3k8j0dDGyTJTw, T16_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	default:
	{
		{
			...
			NI32 last;
			n0 = (NI)0;
			pos = n__TVkfP8au9bPVOp3vPSC9bu7Q;
			last = (NI32)(((NI32) (pos)) + tree__JpcKSs2EE9a4toFqE0rzlIw.nodes.p->data[pos].operand);
			pos += ((NI)1);
			{
				while (1) {
					if (!(((NI32) (pos)) < last)) goto LA20					;
					n0 = pos;
					checkNode__icZintegrity_25(c__rcsJ164GF3k8j0dDGyTJTw, tree__JpcKSs2EE9a4toFqE0rzlIw, n0);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					nextChild__icZpacked95ast_468(tree__JpcKSs2EE9a4toFqE0rzlIw, (&pos));
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				} LA20: ;
			}
		}
...
{nimErr_ = nimErrorFlag();
	{
		...
		i = ((NI)0);
		T2_ = (*typ__DePEiBTd4KUzE4h79aKhg9aw).types.len;
		L = T2_;
		{
			while (1) {
				if (!(i < L)) goto LA4				;
				child = (&(*typ__DePEiBTd4KUzE4h79aKhg9aw).types.p->data[i]);
				checkType__icZintegrity_19(c__u25tNJxmcTo0h0foe0Vhbw, (*child));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				i += ((NI)1);
			} LA4: ;
		}
	...
	{
		if (!!(((*typ__DePEiBTd4KUzE4h79aKhg9aw).n == ((NI32)-1)))) goto LA7_;
		checkNode__icZintegrity_25(c__u25tNJxmcTo0h0foe0Vhbw, (*(*c__u25tNJxmcTo0h0foe0Vhbw).g).packed_0.p->data[(*c__u25tNJxmcTo0h0foe0Vhbw).thisModule].fromDisk.bodies, ((NI) ((*typ__DePEiBTd4KUzE4h79aKhg9aw).n)));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA7_: ;
	{
		NIM_BOOL T11_;
		T11_ = (NIM_BOOL)0;
		T11_ = eqeq___icZic_7879((*typ__DePEiBTd4KUzE4h79aKhg9aw).sym, nilItemId__icZpacked95ast_15);
		if (!!(T11_)) goto LA12_;
		checkForeignSym__icZintegrity_22(c__u25tNJxmcTo0h0foe0Vhbw, (*typ__DePEiBTd4KUzE4h79aKhg9aw).sym);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA12_: ;
	{
		NIM_BOOL T16_;
		T16_ = (NIM_BOOL)0;
		T16_ = eqeq___icZic_7879((*typ__DePEiBTd4KUzE4h79aKhg9aw).owner, nilItemId__icZpacked95ast_15);
		if (!!(T16_)) goto LA17_;
		checkForeignSym__icZintegrity_22(c__u25tNJxmcTo0h0foe0Vhbw, (*typ__DePEiBTd4KUzE4h79aKhg9aw).owner);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA17_: ;
	checkType__icZintegrity_19(c__u25tNJxmcTo0h0foe0Vhbw, (*typ__DePEiBTd4KUzE4h79aKhg9aw).typeInst);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, checkType__icZintegrity_19)(tyObject_CheckedContext__j646oLlGVRWZyd5wzo62Ww* c__gid4JDNEy7eQ9cko3q2WGCw, tyObject_PackedItemId__ujcbfSfQQs6BRj9aXRwDsoA typeId__mR09clQh9aNCEsygtl05JACQ) {
...
{nimErr_ = nimErrorFlag();
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = eqeq___icZic_7879(typeId__mR09clQh9aNCEsygtl05JACQ, nilItemId__icZpacked95ast_15);
		if (!T3_) goto LA4_;
		goto BeforeRet_;
	}
	LA4_: ;
	itemId = translateId__icZic_10587(typeId__mR09clQh9aNCEsygtl05JACQ, (*(*c__gid4JDNEy7eQ9cko3q2WGCw).g).packed_0, ((NI) ((*c__gid4JDNEy7eQ9cko3q2WGCw).thisModule)), (*(*c__gid4JDNEy7eQ9cko3q2WGCw).g).config);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T8_;
		NI32 oldThisModule;
		T8_ = (NIM_BOOL)0;
		T8_ = containsOrIncl__icZintegrity_63((&(*c__gid4JDNEy7eQ9cko3q2WGCw).checkedTypes), itemId);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T8_)) goto LA9_;
		oldThisModule = (*c__gid4JDNEy7eQ9cko3q2WGCw).thisModule;
		(*c__gid4JDNEy7eQ9cko3q2WGCw).thisModule = itemId.module;
		checkTypeObj__icZintegrity_29(c__gid4JDNEy7eQ9cko3q2WGCw, (&(*(*c__gid4JDNEy7eQ9cko3q2WGCw).g).packed_0.p->data[itemId.module].fromDisk.types.p->data[itemId.item]));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(*c__gid4JDNEy7eQ9cko3q2WGCw).thisModule = oldThisModule;
	}
	LA9_: ;
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	{
		if (!!(((*s__IKjxirXE1SoTsskEtyrYkQ).name == ((NU32)0)))) goto LA3_;
	}
	LA3_: ;
	checkType__icZintegrity_19(c__MVlK9ccxukTb0hAA68L2Sxg, (*s__IKjxirXE1SoTsskEtyrYkQ).typ);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!!(((*s__IKjxirXE1SoTsskEtyrYkQ).ast == ((NI32)-1)))) goto LA7_;
		checkNode__icZintegrity_25(c__MVlK9ccxukTb0hAA68L2Sxg, (*(*c__MVlK9ccxukTb0hAA68L2Sxg).g).packed_0.p->data[(*c__MVlK9ccxukTb0hAA68L2Sxg).thisModule].fromDisk.bodies, ((NI) ((*s__IKjxirXE1SoTsskEtyrYkQ).ast)));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA7_: ;
	{
		NIM_BOOL T11_;
		T11_ = (NIM_BOOL)0;
		T11_ = eqeq___icZic_7879((*s__IKjxirXE1SoTsskEtyrYkQ).owner, nilItemId__icZpacked95ast_15);
		if (!!(T11_)) goto LA12_;
		checkForeignSym__icZintegrity_22(c__MVlK9ccxukTb0hAA68L2Sxg, (*s__IKjxirXE1SoTsskEtyrYkQ).owner);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA12_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	itemId.module = (*c__tpGEIIyTTdBkUaJGHU8HtQ).thisModule;
	itemId.item = item__sAPrJHwSD3K0zzwTfgwnZQ;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = containsOrIncl__icZintegrity_63((&(*c__tpGEIIyTTdBkUaJGHU8HtQ).checkedSyms), itemId);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T3_)) goto LA4_;
		checkSym__icZintegrity_623(c__tpGEIIyTTdBkUaJGHU8HtQ, (&(*(*c__tpGEIIyTTdBkUaJGHU8HtQ).g).packed_0.p->data[(*c__tpGEIIyTTdBkUaJGHU8HtQ).thisModule].fromDisk.syms.p->data[item__sAPrJHwSD3K0zzwTfgwnZQ]));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA4_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	{
		...
		p_2 = ((NI)0);
		{
			while (1) {
				...
				NI s;
				T4_ = (NI)0;
				T4_ = len__icZpacked95ast_446(t__w9cOFdM8hflqB9cqlUWnH9afA);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				if (!(p_2 < T4_)) goto LA3				;
				p = p_2;
				checkNode__icZintegrity_25(c__FzuEe29bdJnC2leGnF7Kqmw, t__w9cOFdM8hflqB9cqlUWnH9afA, p);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				s = span__icZpacked95ast_671(t__w9cOFdM8hflqB9cqlUWnH9afA, p_2);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				p_2 += s;
			} LA3: ;
		}
...
N_LIB_PRIVATE N_NIMCALL(void, checkLocalSymIds__icZintegrity_744)(tyObject_CheckedContext__j646oLlGVRWZyd5wzo62Ww* c__1S6XRANRn7n62AQFKD6oqA, tyObject_PackedModule__i9anwDwJxE2V9bIMoIqqe9chA* m__EE17h3StW9cnKa5pEcBcJmA, tySequence__48JTohSgTy339bRxHzUD8KA symIds__QsXs9czGakYC9crCkTZ7RPrw) {
	{
		...
		symId = (NI32*)0;
		i = ((NI)0);
		T2_ = symIds__QsXs9czGakYC9crCkTZ7RPrw.len;
		L = T2_;
		{
			while (1) {
				if (!(i < L)) goto LA4				;
				symId = (&symIds__QsXs9czGakYC9crCkTZ7RPrw.p->data[i]);
				i += ((NI)1);
			} LA4: ;
		}
	}
...
{nimErr_ = nimErrorFlag();
	{
		...
		i = (NI)0;
		colontmp_ = (NI)0;
		T2_ = ((*m__dzXNISgtKhnsKfvWWzBasg).syms.len-1);
		colontmp_ = T2_;
		res = ((NI)0);
		{
			while (1) {
				...
				i = res;
				checkLocalSym__icZintegrity_644(c__Svizn6yfFuwJpEpL7rzzZw, ((NI32) (i)));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				res += ((NI)1);
			} LA4: ;
		}
	}
	checkTree__icZintegrity_740(c__Svizn6yfFuwJpEpL7rzzZw, (*m__dzXNISgtKhnsKfvWWzBasg).toReplay);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	checkTree__icZintegrity_740(c__Svizn6yfFuwJpEpL7rzzZw, (*m__dzXNISgtKhnsKfvWWzBasg).topLevel);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		i_2 = ((NI)0);
		T6_ = (*m__dzXNISgtKhnsKfvWWzBasg).exports.len;
		L = T6_;
		{
			while (1) {
				if (!(i_2 < L)) goto LA8				;
				e = (&(*m__dzXNISgtKhnsKfvWWzBasg).exports.p->data[i_2]);
				i_2 += ((NI)1);
			} LA8: ;
		}
	}
	{
		...
		i_3 = ((NI)0);
		T10_ = (*m__dzXNISgtKhnsKfvWWzBasg).compilerProcs.len;
		L_2 = T10_;
		{
			while (1) {
				if (!(i_3 < L_2)) goto LA12				;
				e_2 = (&(*m__dzXNISgtKhnsKfvWWzBasg).compilerProcs.p->data[i_3]);
				i_3 += ((NI)1);
			} LA12: ;
		}
	}
	checkLocalSymIds__icZintegrity_744(c__Svizn6yfFuwJpEpL7rzzZw, m__dzXNISgtKhnsKfvWWzBasg, (*m__dzXNISgtKhnsKfvWWzBasg).converters);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	checkLocalSymIds__icZintegrity_744(c__Svizn6yfFuwJpEpL7rzzZw, m__dzXNISgtKhnsKfvWWzBasg, (*m__dzXNISgtKhnsKfvWWzBasg).methods);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	checkLocalSymIds__icZintegrity_744(c__Svizn6yfFuwJpEpL7rzzZw, m__dzXNISgtKhnsKfvWWzBasg, (*m__dzXNISgtKhnsKfvWWzBasg).trmacros);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	checkLocalSymIds__icZintegrity_744(c__Svizn6yfFuwJpEpL7rzzZw, m__dzXNISgtKhnsKfvWWzBasg, (*m__dzXNISgtKhnsKfvWWzBasg).pureEnums);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
static N_INLINE(NI, minuspercent___system_790)(NI x__nhqJNug5PDvy9ah8vc6uJ5Q, NI y__LJLJ0MGnpTb2U2nvMvG6MQ) {
...
{nimErr_ = nimErrorFlag();
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nimDecRefIsLast((*dest__4osvJjQRVmwdku9cf3RtFyg).g);
		if (!T3_) goto LA4_;
		eqdestroy___modulegraphs_11047((*dest__4osvJjQRVmwdku9cf3RtFyg).g);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__4osvJjQRVmwdku9cf3RtFyg).g, ((NI)4));
	}
	LA4_: ;
	eqdestroy___icZintegrity_284((&(*dest__4osvJjQRVmwdku9cf3RtFyg).checkedSyms.data));
	eqdestroy___icZintegrity_284((&(*dest__4osvJjQRVmwdku9cf3RtFyg).checkedTypes.data));
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	...
	nimZeroMem((void*)(&c), sizeof(tyObject_CheckedContext__j646oLlGVRWZyd5wzo62Ww));
	colontmpD_ = 0;
	eqcopy___modulegraphs_11315(&colontmpD_, g__nGEarMzsFfSiUyduJ7b9asw);
	...
	c.g = colontmpD_;
	{
		...
		i = (NI)0;
		colontmp_ = (NI)0;
		T3_ = ((*g__nGEarMzsFfSiUyduJ7b9asw).packed_0.len-1);
		colontmp_ = T3_;
		res = ((NI)0);
		{
			while (1) {
				...
				i = res;
				switch ((*g__nGEarMzsFfSiUyduJ7b9asw).packed_0.p->data[i].status) {
				...
				{
					c.thisModule = ((NI32) (i));
					checkModule__icZintegrity_789((&c), (&(*g__nGEarMzsFfSiUyduJ7b9asw).packed_0.p->data[i].fromDisk));
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				}
				break;
				}
