...
{nimErr_ = nimErrorFlag();
	...
	src = sourceLine__msgs_1155(conf__JU8GvAuARjFB4MhQf7JS7w, (*n__0w2geC2NTRB1HXVPghVphA).info);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___renderverbatim_187)(tyObject_LineData__NxlQoo9aW70epjBbzwE7cKw* dest__orv9abJW1T9al79as7Fwj9b5KA) {
	{
		...
		nimRawDispose((*dest__orv9abJW1T9al79as7Fwj9b5KA).conf, ((NI)4));
	}
	LA4_: ;
...
{nimErr_ = nimErrorFlag();
	...
	indent2 = info.col;
	T7_ = (NI)0;
	T7_ = numLines__msgs_1144(conf__Kf9aKMNFG9cncSWaZJeMPU9ag, info.fileIndex);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	numLines = ((NU16) (T7_));
	...
	result = TM__Ut3DGYXxqjf6Sd7VfREQEw_10;
	{
		...
		res = ((NI) (first.line));
		{
			while (1) {
				...
				line = ((NU16) (res));
				info.line = line;
				src = sourceLine__msgs_1155(conf__Kf9aKMNFG9cncSWaZJeMPU9ag, info);
