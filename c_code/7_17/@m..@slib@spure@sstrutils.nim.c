	...
	LA3_: ;
	{
		...
		i = ((NI)0);
		{
			while (1) {
				...
				LA14_: ;
				colontmpD__2 = substr__system_7553(s__fVPG9aK6nrUodzscp5atnSA, i, (NI)(j - ((NI)1)));
...
appendString((&result), by__NHoY8qgsyDMWbmQwZJjmnA);
		...
		colontmpD_ = substr__system_7565(s__fVPG9aK6nrUodzscp5atnSA, i);
	...
	LA6_: ;
	{
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				LA27_: ;
				colontmpD__4 = substr__system_7553(s__fVPG9aK6nrUodzscp5atnSA, i_2, (NI)(j_2 - ((NI)1)));
...
appendString((&result), by__NHoY8qgsyDMWbmQwZJjmnA);
		...
		colontmpD__3 = substr__system_7565(s__fVPG9aK6nrUodzscp5atnSA, i_2);
...
appendString((&(*s__j9blsBybxDg4F4BfDbXqWUg)), a__aHA87WRa9b7U0R3jd9byYsJQ[idx_2]);
					...
					LA55_: ;
					{
						...
						colontmpD__5 = substr__system_7553(formatstr__g5SKfA0s2KWpTq9bHqxySgA, (NI)(i + ((NI)2)), (NI)(j_2 - ((NI)1)));
...
appendString((&(*s__j9blsBybxDg4F4BfDbXqWUg)), a__aHA87WRa9b7U0R3jd9byYsJQ[(NI)(x + ((NI)1))]);
				...
				case 95:
				{
					...
					colontmpD__6 = substr__system_7553(formatstr__g5SKfA0s2KWpTq9bHqxySgA, (NI)(i + ((NI)1)), (NI)(j_3 - ((NI)1)));
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		splitsX60gensym33_ = maxsplit__Xbsp61bGAfla8XxH9bJ4hvQ;
		{
			while (1) {
				...
				T13_ = substr__system_7553(s__Yl3WOGWJsjqlf9czJQb9aTTg, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI)1)));
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		eolpos = ((NI)0);
		{
			while (1) {
				...
				T32_ = substr__system_7553(s__gpNB6mbntnp06kkoTKrykg, first, T26_);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, nsuStrip)(NimStringV2 s__LMRkefVUeSzLJvzD9a3ttPw, NIM_BOOL leading__2DWJBSJUiE0E7onD9an2WOQ, NIM_BOOL trailing__Z9b5JRdAtKKfzgVB7xKT8Ag, tySet_tyChar__nmiMWKVIe46vacnhAFrQvw chars__PcCRn9bqhdqvtgubAWU3Cuw) {
	...
	LA11_: ;
	result = substr__system_7553(s__LMRkefVUeSzLJvzD9a3ttPw, first, last);
	return result;
}
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		splitsX60gensym40_ = maxsplit__Xbsp61bGAfla8XxH9bJ4hvQ;
		{
			while (1) {
				...
				T18_ = substr__system_7553(s__Yl3WOGWJsjqlf9czJQb9aTTg, firstX60gensym40_, (NI)(lastX60gensym40_ - ((NI)1)));
	...
	i = ((NI)0);
	{
		...
		eolpos = ((NI)0);
		{
			while (1) {
				...
				T33_ = substr__system_7553(s__9au5wdRArlBWQ6k9cQ35SBpQ, first, T27_);
	...
	result = ((NI)IL64(9223372036854775807));
	{
		...
		eolpos = ((NI)0);
		{
			while (1) {
				...
				LA27_: ;
				T32_.len = 0; T32_.p = NIM_NIL;
				T32_ = substr__system_7553(s__iA3XfImphZGa89a30NNC1lw, first, T26_);
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmpD_ = substr__system_7565(s__1uT1L3E8tmh9aIicjCcqQLQ, ((NI)1));
