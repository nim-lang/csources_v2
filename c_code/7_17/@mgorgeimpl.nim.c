...
appendString((&T8_), colontmpD__3);
		...
		f = (FILE*)0;
		{
			...
			if (!(T11_)) goto LA12_;
			T11_ = open__stdZsyncio_403(&f, filename, ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)0), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			LA12_: ;
			if (!T11_) goto LA13_;
		...
		readSuccessful = NIM_TRUE;
		{
			...
			writeFile__stdZsyncio_482(filename, result.Field0);
			if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
		}
		LA34_: ;
		{
				...
				*nimErr_ = NIM_FALSE;
				{
					...
					colontmpD__7 = getCurrentExceptionMsg__system_6872();
		...
		if (NIM_UNLIKELY(*nimErr_)) {
			...
			if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 1335990016)||isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 3829286656)) {
				...
				*nimErr_ = NIM_FALSE;
				...
				colontmpD__10 = getCurrentExceptionMsg__system_6872();
