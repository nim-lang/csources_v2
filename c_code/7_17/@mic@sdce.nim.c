	...
	{
		{
			...
			last = (NI)(pos + ((NI) (tree__Rheovf7YcF6P3PiQbzMGvg.nodes.p->data[pos].operand)));
			pos += ((NI)1);
			{
				while (1) {
	...
	{
		{
			...
			last_2 = (NI)(pos_2 + ((NI) (tree__Rheovf7YcF6P3PiQbzMGvg.nodes.p->data[pos_2].operand)));
			pos_2 += ((NI)1);
			{
				while (1) {
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimRawDispose((*dest__dRMGNvlq9bvgrnD8v9aB9aG3Q).decoder.cache, ((NI)8));
	}
	LA9_: ;
