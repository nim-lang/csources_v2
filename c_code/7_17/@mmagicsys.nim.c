...
N_LIB_PRIVATE N_NIMCALL(tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*, newSysType__magicsys_11)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g, tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ kind, NI size);
...
{nimErr_ = nimErrorFlag();
	...
	result = systemModuleSym__modulegraphs_3149(g, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
...
appendString((&T7_), name);
		colontmpD__2 = T7_;
		liMessage__msgs_1172((*g).config, info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__G8Z4HuN1yiXApc3R3GXyPg_4), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		colontmpD__3 = getIdent__idents_166((*g).cache, name);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		T8_ = nextSymId__ast_3268((*g).idgen);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		T9_ = 0;
		T10_ = NIM_NIL;
		T10_ = newSym__ast_4028(((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)0), colontmpD__3, T8_, (*g).systemModule, (*(*g).systemModule).info, T9_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		eqsink___ast_4066(&result, T10_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		T11_ = nextTypeId__ast_3291((*g).idgen);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		T12_ = NIM_NIL;
		T12_ = newType__ast_4969(((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)50), T11_, (*g).systemModule);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	colontmpD_ = NIM_NIL;
	colontmpD_ = getSysSym__magicsys_16(g, info, name);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	s = NIM_NIL;
	colontmpD_ = NIM_NIL;
	s = skipIntLit__magicsys_125(son, id);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD_ = 0;
	eqcopy___ast_3546(&colontmpD_, s);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_5673((&(*father).sons), colontmpD_);
	propagateToOwner__ast_5600(father, s, NIM_TRUE);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	T1_ = nextTypeId__ast_3291((*g).idgen);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = newType__ast_4969(kind, T1_, (*g).systemModule);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	eqcopy___ast_3546(&result, (*g).sysTypes[(kind)- 0]);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)63):
		{
			...
			T6_ = NIM_NIL;
			T6_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_7);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)31):
		{
			...
			T8_ = NIM_NIL;
			T8_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_9);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)32):
		{
			...
			T10_ = NIM_NIL;
			T10_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_11);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)33):
		{
			tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* T12_;
			T12_ = NIM_NIL;
			T12_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_13);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)34):
		{
			...
			T14_ = NIM_NIL;
			T14_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_15);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)35):
		{
			...
			T16_ = NIM_NIL;
			T16_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_17);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)40):
		{
			...
			T18_ = NIM_NIL;
			T18_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_19);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)41):
		{
			...
			T20_ = NIM_NIL;
			T20_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_21);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)42):
		{
			...
			T22_ = NIM_NIL;
			T22_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_23);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)43):
		{
			...
			T24_ = NIM_NIL;
			T24_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_25);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)44):
		{
			...
			T26_ = NIM_NIL;
			T26_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_27);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)36):
		{
			...
			T28_ = NIM_NIL;
			T28_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_29);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)37):
		{
			...
			T30_ = NIM_NIL;
			T30_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_31);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)38):
		{
			...
			T32_ = NIM_NIL;
			T32_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_33);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)39):
		{
			...
			T34_ = NIM_NIL;
			T34_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_35);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)1):
		{
			...
			T36_ = NIM_NIL;
			T36_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_37);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)2):
		{
			...
			T38_ = NIM_NIL;
			T38_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_39);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)28):
		{
			...
			T40_ = NIM_NIL;
			T40_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_41);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)29):
		{
			...
			T42_ = NIM_NIL;
			T42_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_43);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)26):
		{
			...
			T44_ = NIM_NIL;
			T44_ = sysTypeFromName__magicsys_55(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_45);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)5):
		{
			...
			T46_ = NIM_NIL;
			T46_ = newSysType__magicsys_11(g, ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)5), (*(*g).config).target.ptrSize);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		default:
		{
			...
			colontmpD_ = dollar___ast_341(kind);
			T49_ = rawNewString(colontmpD_.len + 22);
appendString((&T49_), TM__G8Z4HuN1yiXApc3R3GXyPg_47);
appendString((&T49_), colontmpD_);
			colontmpD__2 = T49_;
			internalErrorImpl__msgs_1510((*g).config, unknownLineInfo__lineinfos_338, colontmpD__2, (&TM__G8Z4HuN1yiXApc3R3GXyPg_48));
		...
		eqcopy___ast_3546(&(*g).sysTypes[(kind)- 0], result);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	{
		if (!!(((*result).kind == kind))) goto LA54_;
		{
			NIM_BOOL T58_;
			T58_ = (NIM_BOOL)0;
			T58_ = (kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)38));
			if (!(T58_)) goto LA59_;
		...
		LA60_: ;
		{
			...
			colontmpD__3 = dollar___ast_341(kind);
...
appendString((&T64_), colontmpD__4);
			colontmpD__5 = T64_;
			internalErrorImpl__msgs_1510((*g).config, unknownLineInfo__lineinfos_338, colontmpD__5, (&TM__G8Z4HuN1yiXApc3R3GXyPg_53));
	...
	LA54_: ;
	{
		...
		colontmpD__6 = dollar___ast_341(kind);
		T72_ = rawNewString(colontmpD__6.len + 16);
appendString((&T72_), TM__G8Z4HuN1yiXApc3R3GXyPg_55);
appendString((&T72_), colontmpD__6);
		colontmpD__7 = T72_;
		internalErrorImpl__msgs_1510((*g).config, unknownLineInfo__lineinfos_338, colontmpD__7, (&TM__G8Z4HuN1yiXApc3R3GXyPg_56));
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	ident = NIM_NIL;
	ident = getIdent__idents_166((*g).cache, name);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = strTableGet__astalgo_3544((*g).compilerprocs, ident);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* T6_;
		if (!(result == ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL))) goto LA4_;
		T6_ = NIM_NIL;
		T6_ = loadCompilerProc__modulegraphs_8402(g, name);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	eqcopy___ast_3546(&result, (*g).sysTypes[(((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)31))- 0]);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	id = NIM_NIL;
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	id = getIdent__idents_166((*g).cache, name);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		r_2 = NIM_NIL;
		r_2 = initModuleIter__modulegraphs_3032((&mi), g, (*g).systemModule, id);
		if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
		{
			while (1) {
				...
				LA8_: ;
				T16_ = NIM_NIL;
				T16_ = nextModuleIter__modulegraphs_3063((&mi), g);
				if (NIM_UNLIKELY(*nimErr_)) goto LA3_;
	...
	T23_ = rawNewString(name.len + 21);
appendString((&T23_), TM__G8Z4HuN1yiXApc3R3GXyPg_57);
appendString((&T23_), name);
	colontmpD_ = T23_;
	liMessage__msgs_1172((*g).config, info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__G8Z4HuN1yiXApc3R3GXyPg_58), NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T24_ = nextSymId__ast_3268((*g).idgen);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T25_ = 0;
	T26_ = NIM_NIL;
	T26_ = newSym__ast_4028(((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)0), id, T24_, (*g).systemModule, (*(*g).systemModule).info, T25_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqsink___ast_4066(&result, T26_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T27_ = nextTypeId__ast_3291((*g).idgen);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T28_ = NIM_NIL;
	T28_ = newType__ast_4969(((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)50), T27_, (*g).systemModule);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	strTableAdd__astalgo_3484((&(*g).compilerprocs), s);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	conflict = NIM_NIL;
	conflict = strTableGet__astalgo_3544((*g).exposed, (*s).name);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		if (!(conflict == ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL))) goto LA4_;
		strTableAdd__astalgo_3484((&(*g).exposed), s);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	goto LA2_;
	LA4_: ;
	{
		...
		colontmpD_ = dollar___msgs_675((*g).config, (*conflict).info);
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
		T8_ = rawNewString(colontmpD_.len + 51);
appendString((&T8_), TM__G8Z4HuN1yiXApc3R3GXyPg_60);
appendString((&T8_), colontmpD_);
		colontmpD__2 = T8_;
		liMessage__msgs_1172((*g).config, (*s).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__G8Z4HuN1yiXApc3R3GXyPg_61), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
		{
			LA7_:;
		}
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	eqsink___ast_4066(&(*g).systemModule, ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	initStrTable__ast_5184((&(*g).compilerprocs));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	initStrTable__ast_5184((&(*g).exposed));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		res = ((NI)0);
		{
			while (1) {
				...
				eqsink___ast_3549(&(*g).sysTypes[(i)- 0], ((tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*) NIM_NIL));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				res += ((NI)1);
			} LA3: ;
		}
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)44):
	{
		result = getSysMagic__magicsys_29(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_63, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)70));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)14):
	{
		result = getSysMagic__magicsys_29(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_64, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)78));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)1):
	{
		result = getSysMagic__magicsys_29(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_65, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)84));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)26):
	{
		result = getSysMagic__magicsys_29(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_66, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)87));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)28):
	{
		result = getSysMagic__magicsys_29(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_67, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)116));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)2):
	{
		result = getSysMagic__magicsys_29(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_68, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)81));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)19):
	{
		result = getSysMagic__magicsys_29(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_69, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)119));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)25):
	{
		result = getSysMagic__magicsys_29(g, info, TM__G8Z4HuN1yiXApc3R3GXyPg_70, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)92));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	default:
...
appendString((&T11_), colontmpD_);
		colontmpD__2 = T11_;
		liMessage__msgs_1172((*g).config, info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD__2, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)2), (&TM__G8Z4HuN1yiXApc3R3GXyPg_73), NIM_FALSE);
