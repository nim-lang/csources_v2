	...
	LA3_: ;
	{
		...
		i = ((NI)0);
		{
			while (1) {
				...
				LA14_: ;
				colontmpD__2 = substr__system_7534(s, i, (NI)(j - ((NI)1)));
...
appendString((&result), by);
		...
		colontmpD_ = substr__system_7546(s, i);
	...
	LA6_: ;
	{
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				LA27_: ;
				colontmpD__4 = substr__system_7534(s, i_2, (NI)(j_2 - ((NI)1)));
...
appendString((&result), by);
		...
		colontmpD__3 = substr__system_7546(s, i_2);
...
appendString((&(*s)), a[idx_2]);
					...
					LA55_: ;
					{
						...
						colontmpD__5 = substr__system_7534(formatstr, (NI)(i + ((NI)2)), (NI)(j_2 - ((NI)1)));
...
appendString((&(*s)), a[(NI)(x + ((NI)1))]);
				...
				case 95:
				{
					...
					colontmpD__6 = substr__system_7534(formatstr, (NI)(i + ((NI)1)), (NI)(j_3 - ((NI)1)));
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		splitsX60gensym33_ = maxsplit;
		{
			while (1) {
				...
				T13_ = substr__system_7534(s, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI)1)));
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		eolpos = ((NI)0);
		{
			while (1) {
				...
				T32_ = substr__system_7534(s, first, T26_);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, nsuStrip)(NimStringV2 s, NIM_BOOL leading, NIM_BOOL trailing, tySet_tyChar__nmiMWKVIe46vacnhAFrQvw chars) {
	...
	LA11_: ;
	result = substr__system_7534(s, first, last);
	return result;
}
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		splitsX60gensym40_ = maxsplit;
		{
			while (1) {
				...
				T18_ = substr__system_7534(s, firstX60gensym40_, (NI)(lastX60gensym40_ - ((NI)1)));
	...
	i = ((NI)0);
	{
		...
		eolpos = ((NI)0);
		{
			while (1) {
				...
				T33_ = substr__system_7534(s, first, T27_);
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmpD_ = substr__system_7546(s, ((NI)1));
