...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmpD__2 = substr__system_7546(path__BQBSuWQbOavg6W9czhl9bOhg, ((NI)2));
	...
	LA24_: ;
	{
		...
		splitsX60gensym36_ = ((NI)-1);
		{
			while (1) {
				...
				T40_ = substr__system_7534(colontmp__2, firstX60gensym36_, (NI)(lastX60gensym36_ - ((NI)1)));
		...
		if (!T3_) goto LA5_;
		{
			...
			splitsX60gensym36_ = ((NI)-1);
			{
				while (1) {
					...
					T20_ = substr__system_7534(colontmp_, firstX60gensym36_, (NI)(lastX60gensym36_ - ((NI)1)));
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		splitsX60gensym33_ = ((NI)-1);
		{
			while (1) {
				...
				T32_ = substr__system_7534(path, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI)1)));
...
{nimErr_ = nimErrorFlag();
	...
	result = initTime__pureZtimes_1013(ts__19cpx3HDvAj5RDxP2P2xd2g.tv_sec, ((NI) (ts__19cpx3HDvAj5RDxP2P2xd2g.tv_nsec)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
