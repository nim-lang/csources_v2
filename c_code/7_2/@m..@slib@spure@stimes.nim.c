...
N_LIB_PRIVATE N_NIMCALL(void, zonedTimeFromTime__pureZtimes_1471)(tyObject_TimezonecolonObjectType___F8OvqlxXyGXRSiK9c1fCDVw* zone__SUVdLtWyeUYkkG3NwO2jrw, tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q time__DY9cutUkv7GGMzgDufIsZjw, tyObject_ZonedTime__WigfH9apQAxJ69bBPh3wB8RQ* Result);
...
N_LIB_PRIVATE N_NIMCALL(void, utcTzInfo__pureZtimes_1652)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q time__dhFVggVV4X1k49bQrVEwLJQ, tyObject_ZonedTime__WigfH9apQAxJ69bBPh3wB8RQ* Result);
...
N_LIB_PRIVATE N_NIMCALL(void, localZonedTimeFromTime__pureZtimes_1625)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q time__s7RQHB8z7XzPnAZyWqI7nQ, tyObject_ZonedTime__WigfH9apQAxJ69bBPh3wB8RQ* Result);
...
N_LIB_PRIVATE N_NIMCALL(void, localZonedTimeFromAdjTime__pureZtimes_1630)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q adjTime__x5yxPYjOXAbmRqESs1D7XQ, tyObject_ZonedTime__WigfH9apQAxJ69bBPh3wB8RQ* Result);
...
{nimErr_ = nimErrorFlag();
	...
	(void)(T1_);
	result = initTime__pureZtimes_1013(ts.tv_sec, ((NI) (ts.tv_nsec)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	zonedTimeFromTime__pureZtimes_1471(zone__WQCTglDK0z15Mt89cyS4UxQ, time__hav15uI9cIr3rvDDdgL0kGw, (&T1_));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(NF, epochTime__pureZtimes_4284)(void) {
	...
	(void)(T1_);
	T2_ = (NF)0;
	T2_ = toBiggestFloat__system_1675(ts.tv_sec);
	T3_ = (NF)0;
...
{nimErr_ = nimErrorFlag();
	...
	a = clamp__pureZtimes_1577(unix__qjF380ZRSMouZd9bl7xGNAg, (IL64(-9223372036854775807) - IL64(1)), IL64(9223372036854775807));
	tmPtr = localtime((&a));
	{
		struct tm tm;
		NI colontmp_;
		...
		tm = (*tmPtr);
		T5_ = (NI64)0;
		T5_ = toAdjUnix__pureZtimes_1545(tm);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
