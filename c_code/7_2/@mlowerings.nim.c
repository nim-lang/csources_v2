...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, indirectAccess__lowerings_499)(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* a__Rku4SqJA8woycmqNW4a9apA, tyObject_ItemId__RG5oiYa2xm9bBBKInuP3ECw b__ryfIjsnM8B4iLeOxXF9bnrg, tyObject_TLineInfo__7ZAGqjaN6WqWPlHP9cRagRg info__7MeB8plB62z09avD9chm9cEBw);
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*, lookupInRecord__lowerings_377)(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n__nJfVgCWW8o5M7XXDvU9ajVg, tyObject_ItemId__RG5oiYa2xm9bBBKInuP3ECw id__Kz35xZqMvZyxDbr4x2J09cg);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, newTupleAccessRaw__lowerings_195)(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* tup__Kuxq9ccpdFOIchawNt2uksA, NI i__v5FKFsUJG1SfdM4T7G3QfQ);
...
{nimErr_ = nimErrorFlag();
	...
	T2_ = nextTypeId__ast_3291(idgen__AIC2ymKINpVx1vSq4avzVg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = newType__ast_4969(((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)17), T2_, owner__EoNS73oRifVzP8yndpp9bPg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		if (!final__UU8JRD9am2e5cbcjnGKS8Zg) goto LA5_;
	...
	LA5_: ;
	{
		...
		colontmpD__5 = getCompilerProc__magicsys_146(g__WSJIu0Yq9cntMGuHcDbsOPw, TM__zjz9atstw9cXOaiL5PksbOQQ_3);
	...
	LA3_: ;
	T11_ = NIM_NIL;
	T11_ = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)138), info__a9cAJU3ZwMSQE3WRaZKu9aIQ);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	T13_.len = 0; T13_.p = NIM_NIL;
	{
		...
		NimStringV2 T20_;
		T16_ = (NIM_BOOL)0;
		T16_ = (info__a9cAJU3ZwMSQE3WRaZKu9aIQ.fileIndex < ((NI32)0));
		if (T16_) goto LA17_;
		T16_ = ((*g__WSJIu0Yq9cntMGuHcDbsOPw).config == ((tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg*) NIM_NIL));
		LA17_: ;
		if (!T16_) goto LA18_;
		T20_.len = 0; T20_.p = NIM_NIL;
		{
			if (!(info__a9cAJU3ZwMSQE3WRaZKu9aIQ.fileIndex == ((NI32)-3))) goto LA23_;
	...
	LA18_: ;
	{
		eqcopy___stdZassertions_16((&colontmpD__2), (*(*g__WSJIu0Yq9cntMGuHcDbsOPw).config).m.fileInfos.p->data[info__a9cAJU3ZwMSQE3WRaZKu9aIQ.fileIndex].shortName);
		T13_ = colontmpD__2;
	}
	LA14_: ;
	T12_ = rawNewString(T13_.len + (*(*owner__EoNS73oRifVzP8yndpp9bPg).name).s.len + 5);
appendString((&T12_), TM__zjz9atstw9cXOaiL5PksbOQQ_5);
appendString((&T12_), T13_);
appendString((&T12_), TM__zjz9atstw9cXOaiL5PksbOQQ_11);
appendString((&T12_), (*(*owner__EoNS73oRifVzP8yndpp9bPg).name).s);
	colontmpD__3 = T12_;
	colontmpD__4 = getIdent__idents_166((*g__WSJIu0Yq9cntMGuHcDbsOPw).cache, colontmpD__3);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T27_ = nextSymId__ast_3268(idgen__AIC2ymKINpVx1vSq4avzVg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	s = newSym__ast_4028(((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)7), colontmpD__4, T27_, owner__EoNS73oRifVzP8yndpp9bPg, info__a9cAJU3ZwMSQE3WRaZKu9aIQ, (*owner__EoNS73oRifVzP8yndpp9bPg).options);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	colontmpD_ = NIM_NIL;
	T1_ = (NI)0;
	T1_ = len__ast_3325((*obj__f529bmXMbP9a2rwlLS3f9a0Cg).n);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*field__BlmgFTZKGxFbPnwH9caivig).position = T1_;
	colontmpD_ = newSymNode__ast_4784(field__BlmgFTZKGxFbPnwH9caivig);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233((*obj__f529bmXMbP9a2rwlLS3f9a0Cg).n, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	propagateToOwner__ast_5600(obj__f529bmXMbP9a2rwlLS3f9a0Cg, (*field__BlmgFTZKGxFbPnwH9caivig).typ, NIM_TRUE);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	T2_ = (NI)0;
	T2_ = len__ast_3325((*obj__KgZ9baJGsBZ3yJW4Oe7Zh1A).n);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD_ = dollar___systemZdollars_3(T2_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = rawNewString((*(*s__hVcYonsWYM8Cbq3etIv65A).name).s.len + colontmpD_.len + 0);
appendString((&T1_), (*(*s__hVcYonsWYM8Cbq3etIv65A).name).s);
appendString((&T1_), colontmpD_);
	colontmpD__2 = T1_;
	colontmpD__3 = getIdent__idents_166(cache__gRjyk4Vu9bQh9cHW9axN7HlZA, colontmpD__2);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T3_ = nextSymId__ast_3268(idgen__INpm3eMahCDqjAGL2sljjQ);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	field = newSym__ast_4028(((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)19), colontmpD__3, T3_, (*s__hVcYonsWYM8Cbq3etIv65A).owner, (*s__hVcYonsWYM8Cbq3etIv65A).info, (*s__hVcYonsWYM8Cbq3etIv65A).options);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	nimZeroMem((void*)(&T4_), sizeof(tyObject_ItemId__RG5oiYa2xm9bBBKInuP3ECw));
	colontmpD__4 = (*s__hVcYonsWYM8Cbq3etIv65A).Sup.itemId.module;
	T4_.module = colontmpD__4;
	T4_.item = ((NI32)-((*s__hVcYonsWYM8Cbq3etIv65A).Sup.itemId.item));
	(*field).Sup.itemId = T4_;
	t = skipIntLit__magicsys_125((*s__hVcYonsWYM8Cbq3etIv65A).typ, idgen__INpm3eMahCDqjAGL2sljjQ);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___ast_3546(&(*field).typ, t);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	propagateToOwner__ast_5600(obj__KgZ9baJGsBZ3yJW4Oe7Zh1A, t, NIM_TRUE);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T5_ = (NI)0;
	T5_ = len__ast_3325((*obj__KgZ9baJGsBZ3yJW4Oe7Zh1A).n);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*field).position = T5_;
	(*field).flags = ((*s__hVcYonsWYM8Cbq3etIv65A).flags & IL64(2199023271936));
	colontmpD__5 = newSymNode__ast_4784(field);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233((*obj__KgZ9baJGsBZ3yJW4Oe7Zh1A).n, colontmpD__5);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = field;
...
{nimErr_ = nimErrorFlag();
	vpart = NIM_NIL;
	vpart = newNodeI__ast_3953(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)35), (*v__LV69a4n9ausML13haf2X8PQQ).info, ((NI)3));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___ast_3457(&(*vpart)._kind_6.sons.p->data[((NI)0)], v__LV69a4n9ausML13haf2X8PQQ);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = NIM_NIL;
	T1_ = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)1), (*v__LV69a4n9ausML13haf2X8PQQ).info);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(father__ZkIIHEnh83ihGaK3M8yyCQ, vpart);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	result = newNodeI__ast_3953(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)73), (*le__9bwEcpaugIKDd1gEg9bAVjFg).info, ((NI)2));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___ast_3457(&(*result)._kind_6.sons.p->data[((NI)0)], le__9bwEcpaugIKDd1gEg9bAVjFg);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___ast_3457(&(*result)._kind_6.sons.p->data[((NI)1)], ri__x7IYGeMyzJMTgT9aP5UTo5g);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___ast_3460(&(*vpart)._kind_6.sons.p->data[((NI)1)], T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___ast_3457(&(*vpart)._kind_6.sons.p->data[((NI)2)], value__usF2x9cYTSmzDMrxpbCpT0Q);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(father__ZkIIHEnh83ihGaK3M8yyCQ, vpart);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___ast_3454(&vpart);
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	result = newIntNode__ast_4791(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)6), value__o8cJrXNdee8csoi0B4KizA);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = NIM_NIL;
	T1_ = getSysType__magicsys_60(g__w5L2Xm4aXxWyD9cwLPdZCsg, info__8vJj2ZjBpdwNFH6lA0I9bTQ, ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)31));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = NIM_NIL;
	{
		...
		NI64 T9_;
		colontmpD_ = skipTypes__ast_4803((*n__9byeYcctJ9az9czTe9boJsvtnA).typ, TM__zjz9atstw9cXOaiL5PksbOQQ_12);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!((*colontmpD_).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)16))) goto LA4_;
		colontmpD__2 = NIM_NIL;
		colontmpD__2 = skipTypes__ast_4803((*n__9byeYcctJ9az9czTe9boJsvtnA).typ, TM__zjz9atstw9cXOaiL5PksbOQQ_12);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		T7_ = lastOrd__types_1509((*g__2E9bZG29bZvbYz00Z46h2LfQ).config, colontmpD__2);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		T8_ = plus___int495056_806(T7_, IL64(1));
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		T9_ = (NI64)0;
		T9_ = toInt64__int495056_77(T8_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		result = newIntLit__lowerings_702(g__2E9bZG29bZvbYz00Z46h2LfQ, (*n__9byeYcctJ9az9czTe9boJsvtnA).info, T9_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
	...
	LA4_: ;
	{
		...
		colontmpD__3 = NIM_NIL;
		result = newNodeI__ast_3953(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)27), (*n__9byeYcctJ9az9czTe9boJsvtnA).info, ((NI)2));
		if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
		T14_ = NIM_NIL;
		T14_ = getSysType__magicsys_60(g__2E9bZG29bZvbYz00Z46h2LfQ, (*n__9byeYcctJ9az9czTe9boJsvtnA).info, ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)31));
		if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
		eqsink___ast_3549(&(*result).typ, T14_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
		colontmpD__3 = getSysMagic__magicsys_29(g__2E9bZG29bZvbYz00Z46h2LfQ, (*n__9byeYcctJ9az9czTe9boJsvtnA).info, TM__zjz9atstw9cXOaiL5PksbOQQ_14, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)39));
		if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
		T15_ = NIM_NIL;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
		eqcopy___ast_3457(&(*result)._kind_6.sons.p->data[((NI)1)], n__9byeYcctJ9az9czTe9boJsvtnA);
		if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
		{
			LA13_:;
		}
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	colontmpD_ = NIM_NIL;
	colontmpD_ = skipTypes__ast_4803((*n__wyrawVgGY23b9c18dhkkPrg).typ, TM__zjz9atstw9cXOaiL5PksbOQQ_15);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = newNodeIT__ast_3970(k__9cNo41rj9bjaJL03pi0r6QLA, (*n__wyrawVgGY23b9c18dhkkPrg).info, (*colontmpD_).sons.p->data[((NI)0)]);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(result, n__wyrawVgGY23b9c18dhkkPrg);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___ast_3543(&colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	sym = NIM_NIL;
	result = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)27), info__rOHQnxFL9c2ICh6e4Gvh1Iw);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	sym = getCompilerProc__magicsys_146(g__6LSdgD9bGJC2emExcuwt1hA, name__w0lahTp9bSn9azHv9bCHbgXgw);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NimStringV2 colontmpD_;
		NimStringV2 T7_;
		...
		T7_ = rawNewString(name__w0lahTp9bSn9azHv9bCHbgXgw.len + 21);
appendString((&T7_), TM__zjz9atstw9cXOaiL5PksbOQQ_17);
appendString((&T7_), name__w0lahTp9bSn9azHv9bCHbgXgw);
		colontmpD_ = T7_;
		liMessage__msgs_1172((*g__6LSdgD9bGJC2emExcuwt1hA).config, info__rOHQnxFL9c2ICh6e4Gvh1Iw, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), (&TM__zjz9atstw9cXOaiL5PksbOQQ_18), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
	...
	LA4_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		{
			if (!!((arg1__5hh9bMZ1hB9cPuc4x5c9aFFLQ == ((tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*) NIM_NIL)))) goto LA13_;
			add__ast_6233(result, arg1__5hh9bMZ1hB9cPuc4x5c9aFFLQ);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		}
		LA13_: ;
		{
			if (!!((arg2__HLaZHBpOmC79a7eqUmu0gng == ((tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*) NIM_NIL)))) goto LA17_;
			add__ast_6233(result, arg2__HLaZHBpOmC79a7eqUmu0gng);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		}
		LA17_: ;
		{
			if (!!((arg3__JLNKQXDFUfk0Fz69aHd2gcA == ((tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*) NIM_NIL)))) goto LA21_;
			add__ast_6233(result, arg3__JLNKQXDFUfk0Fz69aHd2gcA);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		}
		LA21_: ;
		{
			if (!!((optionalArgs__hVCNtBd9cBzHnvffQa5BnCA == ((tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*) NIM_NIL)))) goto LA25_;
			{
				NI i;
				NI colontmp_;
				NI T28_;
				...
				colontmp_ = (NI)0;
				T28_ = (NI)0;
				T28_ = len__ast_3325(optionalArgs__hVCNtBd9cBzHnvffQa5BnCA);
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				...
				i_2 = ((NI)1);
				{
					while (1) {
						...
						i = i_2;
						add__ast_6233(result, (*optionalArgs__hVCNtBd9cBzHnvffQa5BnCA)._kind_6.sons.p->data[i]);
						if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
						i_2 += ((NI)1);
					} LA30: ;
				}
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	result = newNodeI__ast_3953(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)63), (*n__FhY6jcHzJHuPYwtUKDtrRQ).info, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___ast_3457(&(*result)._kind_6.sons.p->data[((NI)0)], n__FhY6jcHzJHuPYwtUKDtrRQ);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = nextTypeId__ast_3291(idgen__kdR6ZldYVo1kG4EOXyKl3A);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T2_ = NIM_NIL;
	T2_ = newType__ast_4969(typeKind__Ppz4j08lL2HpbeUmlCl8Zw, T1_, (*(*n__FhY6jcHzJHuPYwtUKDtrRQ).typ).owner);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqsink___ast_3549(&(*result).typ, T2_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	rawAddSon__ast_5669((*result).typ, (*n__FhY6jcHzJHuPYwtUKDtrRQ).typ, NIM_TRUE);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	switch ((*n__nJfVgCWW8o5M7XXDvU9ajVg).kind) {
	...
	{
		{
			...
			i = (NI)0;
			colontmp_ = (NI)0;
			colontmp_ = len__ast_3325(n__nJfVgCWW8o5M7XXDvU9ajVg);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			i_2 = ((NI)0);
			{
				while (1) {
					...
					i = i_2;
					T5_ = NIM_NIL;
					T5_ = lookupInRecord__lowerings_377((*n__nJfVgCWW8o5M7XXDvU9ajVg)._kind_6.sons.p->data[i], id__Kz35xZqMvZyxDbr4x2J09cg);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)139):
	{
		...
		{
			if (!!(((*(*n__nJfVgCWW8o5M7XXDvU9ajVg)._kind_6.sons.p->data[((NI)0)]).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3)))) goto LA13_;
			goto BeforeRet_;
		}
		LA13_: ;
		T15_ = NIM_NIL;
		T15_ = lookupInRecord__lowerings_377((*n__nJfVgCWW8o5M7XXDvU9ajVg)._kind_6.sons.p->data[((NI)0)], id__Kz35xZqMvZyxDbr4x2J09cg);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		LA18_: ;
		{
			...
			i_3 = (NI)0;
			colontmp__2 = (NI)0;
			colontmp__2 = len__ast_3325(n__nJfVgCWW8o5M7XXDvU9ajVg);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			i_4 = ((NI)1);
			{
				while (1) {
					...
					i_3 = i_4;
					switch ((*(*n__nJfVgCWW8o5M7XXDvU9ajVg)._kind_6.sons.p->data[i_3]).kind) {
					...
					case ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)88):
					{
						...
						colontmpD_ = NIM_NIL;
						colontmpD_ = lastSon__ast_6268((*n__nJfVgCWW8o5M7XXDvU9ajVg)._kind_6.sons.p->data[i_3]);
						if (NIM_UNLIKELY(*nimErr_)) goto LA24_;
						T25_ = NIM_NIL;
						T25_ = lookupInRecord__lowerings_377(colontmpD_, id__Kz35xZqMvZyxDbr4x2J09cg);
						if (NIM_UNLIKELY(*nimErr_)) goto LA24_;
	...
	{
		{
			NIM_BOOL T36_;
			T36_ = (NIM_BOOL)0;
			T36_ = ((*(*n__nJfVgCWW8o5M7XXDvU9ajVg)._kind_4.sym).Sup.itemId.module == id__Kz35xZqMvZyxDbr4x2J09cg.module);
			if (!(T36_)) goto LA37_;
			T36_ = ((*(*n__nJfVgCWW8o5M7XXDvU9ajVg)._kind_4.sym).Sup.itemId.item == ((NI32)-((id__Kz35xZqMvZyxDbr4x2J09cg.item > 0? (id__Kz35xZqMvZyxDbr4x2J09cg.item) : -(id__Kz35xZqMvZyxDbr4x2J09cg.item)))));
			LA37_: ;
			if (!T36_) goto LA38_;
			eqcopy___ast_4063(&result, (*n__nJfVgCWW8o5M7XXDvU9ajVg)._kind_4.sym);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA38_: ;
	}
...
{nimErr_ = nimErrorFlag();
	...
	field = NIM_NIL;
	colontmpD__2 = NIM_NIL;
	deref = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)65), info__7MeB8plB62z09avD9chm9cEBw);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD_ = skipTypes__ast_4803((*a__Rku4SqJA8woycmqNW4a9apA).typ, TM__zjz9atstw9cXOaiL5PksbOQQ_15);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		while (1) {
			...
			T4_ = NIM_NIL;
			T4_ = lookupInRecord__lowerings_377((*t).n, b__ryfIjsnM8B4iLeOxXF9bnrg);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	add__ast_6233(deref, a__Rku4SqJA8woycmqNW4a9apA);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)45), info__7MeB8plB62z09avD9chm9cEBw);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	result = indirectAccess__lowerings_499(a__Rku4SqJA8woycmqNW4a9apA, (*b__ryfIjsnM8B4iLeOxXF9bnrg).Sup.itemId, info__7MeB8plB62z09avD9chm9cEBw);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = NIM_NIL;
	colontmpD__2 = NIM_NIL;
	deref = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)65), info__bb5rvUdwzIBk39ajv24Y9b9aw);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD_ = skipTypes__ast_4803((*a__tPRd4FJq3mJfHUkm7yec2w).typ, TM__zjz9atstw9cXOaiL5PksbOQQ_15);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___ast_3546(&(*deref).typ, (*colontmpD_).sons.p->data[((NI)0)]);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(deref, a__tPRd4FJq3mJfHUkm7yec2w);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)45), info__bb5rvUdwzIBk39ajv24Y9b9aw);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(result, deref);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__2 = newSymNode__ast_4784(field__NnunwZl4y7OJ1uCR9aedmTw);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(result, colontmpD__2);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___ast_3546(&(*result).typ, (*field__NnunwZl4y7OJ1uCR9aedmTw).typ);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___ast_3454(&colontmpD__2);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___ast_3543(&colontmpD_);
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	result = lookupInRecord__lowerings_377((*obj__9cvZigmv4K46KeNjsTo8RKA).n, (*s__LoFiWLdBdjR9bU5d2179cUrA).Sup.itemId);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* field;
		NimStringV2 colontmpD_;
		...
		T6_ = (NI)0;
		T6_ = len__ast_3325((*obj__9cvZigmv4K46KeNjsTo8RKA).n);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmpD_ = dollar___systemZdollars_3(T6_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T5_ = rawNewString((*(*s__LoFiWLdBdjR9bU5d2179cUrA).name).s.len + colontmpD_.len + 0);
appendString((&T5_), (*(*s__LoFiWLdBdjR9bU5d2179cUrA).name).s);
appendString((&T5_), colontmpD_);
		colontmpD__2 = T5_;
		colontmpD__3 = getIdent__idents_166(cache__DD9anQLteHW8lwpgTsIzjYw, colontmpD__2);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T7_ = nextSymId__ast_3268(idgen__k9cQUfPNP75DNzRoa17pi0g);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		field = newSym__ast_4028(((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)19), colontmpD__3, T7_, (*s__LoFiWLdBdjR9bU5d2179cUrA).owner, (*s__LoFiWLdBdjR9bU5d2179cUrA).info, (*s__LoFiWLdBdjR9bU5d2179cUrA).options);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimZeroMem((void*)(&T8_), sizeof(tyObject_ItemId__RG5oiYa2xm9bBBKInuP3ECw));
		colontmpD__4 = (*s__LoFiWLdBdjR9bU5d2179cUrA).Sup.itemId.module;
		T8_.module = colontmpD__4;
		T8_.item = ((NI32)-((*s__LoFiWLdBdjR9bU5d2179cUrA).Sup.itemId.item));
		(*field).Sup.itemId = T8_;
		t = skipIntLit__magicsys_125((*s__LoFiWLdBdjR9bU5d2179cUrA).typ, idgen__k9cQUfPNP75DNzRoa17pi0g);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqcopy___ast_3546(&(*field).typ, t);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		propagateToOwner__ast_5600(obj__9cvZigmv4K46KeNjsTo8RKA, t, NIM_TRUE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T9_ = (NI)0;
		T9_ = len__ast_3325((*obj__9cvZigmv4K46KeNjsTo8RKA).n);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(*field).position = T9_;
		colontmpD__5 = newSymNode__ast_4784(field);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		add__ast_6233((*obj__9cvZigmv4K46KeNjsTo8RKA).n, colontmpD__5);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	t_2 = NIM_NIL;
	eqcopy___ast_3546(&t_2, t__Jzv9aWTBf0wftV9aNQ8LIw3A);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		while (1) {
			tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* T4_;
			tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* T13_;
			T4_ = NIM_NIL;
			T4_ = lookupInRecord__lowerings_377((*t_2).n, (*v__1aetT2SSfUG3TrKkauZx4w).Sup.itemId);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		if (!((*tup__MCuKYt3vbYTrqfpwFaFpEg).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)64))) goto LA3_;
		colontmpD_ = NIM_NIL;
		colontmpD__2 = NIM_NIL;
		colontmpD__3 = NIM_NIL;
		lit = NIM_NIL;
		colontmpD__4 = NIM_NIL;
		colontmpD_ = skipTypes__ast_4803((*tup__MCuKYt3vbYTrqfpwFaFpEg).typ, TM__zjz9atstw9cXOaiL5PksbOQQ_21);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		result = newNodeIT__ast_3970(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)64), (*tup__MCuKYt3vbYTrqfpwFaFpEg).info, colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		colontmpD__2 = skipTypes__ast_4803((*tup__MCuKYt3vbYTrqfpwFaFpEg).typ, TM__zjz9atstw9cXOaiL5PksbOQQ_21);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		colontmpD__3 = newNodeIT__ast_3970(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)42), (*tup__MCuKYt3vbYTrqfpwFaFpEg).info, (*colontmpD__2).sons.p->data[i__Pmr46iS8sUQZ8OJYeEozsA]);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		add__ast_6233(result, colontmpD__3);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		add__ast_6233((*result)._kind_6.sons.p->data[((NI)0)], (*tup__MCuKYt3vbYTrqfpwFaFpEg)._kind_6.sons.p->data[((NI)0)]);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		colontmpD__4 = getSysType__magicsys_60(g__MjfgtvVVHc6yJHoEcolS8A, (*tup__MCuKYt3vbYTrqfpwFaFpEg).info, ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)31));
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		lit = newNodeIT__ast_3970(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)6), (*tup__MCuKYt3vbYTrqfpwFaFpEg).info, colontmpD__4);
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		(*lit)._kind_1.intVal = ((NI64) (i__Pmr46iS8sUQZ8OJYeEozsA));
	...
	LA3_: ;
	{
		...
		colontmpD__5 = skipTypes__ast_4803((*tup__MCuKYt3vbYTrqfpwFaFpEg).typ, TM__zjz9atstw9cXOaiL5PksbOQQ_15);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		result = newNodeIT__ast_3970(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)42), (*tup__MCuKYt3vbYTrqfpwFaFpEg).info, (*colontmpD__5).sons.p->data[i__Pmr46iS8sUQZ8OJYeEozsA]);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD__6 = copyTree__ast_5856(tup__MCuKYt3vbYTrqfpwFaFpEg);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		add__ast_6233(result, colontmpD__6);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		colontmpD__7 = getSysType__magicsys_60(g__MjfgtvVVHc6yJHoEcolS8A, (*tup__MCuKYt3vbYTrqfpwFaFpEg).info, ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)31));
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		lit_2 = newNodeIT__ast_3970(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)6), (*tup__MCuKYt3vbYTrqfpwFaFpEg).info, colontmpD__7);
		if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
		(*lit_2)._kind_1.intVal = ((NI64) (i__Pmr46iS8sUQZ8OJYeEozsA));
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	result = newNodeI__ast_3953(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)74), (*le__lRVkxI9b09apWXU9cvb3HVNkg).info, ((NI)2));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___ast_3457(&(*result)._kind_6.sons.p->data[((NI)0)], le__lRVkxI9b09apWXU9cvb3HVNkg);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___ast_3457(&(*result)._kind_6.sons.p->data[((NI)1)], ri__iW2dCkgkJ9bl5KFEzdnkzkg);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__2 = NIM_NIL;
	colontmpD__3 = NIM_NIL;
	result = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)115), (*n__E0oWRPrAB9byFS5HITYi9bDQ).info);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD_ = getIdent__idents_166((*g__0kmO0I8DdIH5hqPiru9bcew).cache, TM__zjz9atstw9cXOaiL5PksbOQQ_23);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = nextSymId__ast_3268(idgen__0HNQ3qt5E7vEutKjzq9cw0g);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	temp = newSym__ast_4028(((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)8), colontmpD_, T1_, owner__4nZSehG22xRi3yKGMtpqeg, (*n__E0oWRPrAB9byFS5HITYi9bDQ).info, (*owner__4nZSehG22xRi3yKGMtpqeg).options);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___ast_3546(&(*temp).typ, (*(*n__E0oWRPrAB9byFS5HITYi9bDQ)._kind_6.sons.p->data[((NI)1)]).typ);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	v = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)99), (*n__E0oWRPrAB9byFS5HITYi9bDQ).info);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqcopy___ast_3457(&(*vpart)._kind_6.sons.p->data[((NI)2)], (*n__E0oWRPrAB9byFS5HITYi9bDQ)._kind_6.sons.p->data[((NI)1)]);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(v, vpart);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(result, v);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__2 = newFastAsgnStmt__lowerings_94((*n__E0oWRPrAB9byFS5HITYi9bDQ)._kind_6.sons.p->data[((NI)1)], (*n__E0oWRPrAB9byFS5HITYi9bDQ)._kind_6.sons.p->data[((NI)2)]);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(result, colontmpD__2);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__3 = newFastAsgnStmt__lowerings_94((*n__E0oWRPrAB9byFS5HITYi9bDQ)._kind_6.sons.p->data[((NI)2)], tempAsNode);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(result, colontmpD__3);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	eqdestroy___ast_3454(&colontmpD__3);
...
{nimErr_ = nimErrorFlag();
	...
	tempAsNode = NIM_NIL;
	v = NIM_NIL;
	value = lastSon__ast_6268(n__I6UIck9brCHS8rLdMqcDWpQ);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)115), (*n__I6UIck9brCHS8rLdMqcDWpQ).info);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	LA4_: ;
	{
		...
		temp = NIM_NIL;
		colontmpD_ = NIM_NIL;
		colontmpD_ = getIdent__idents_166((*g__t9ayBGjmfPAozbXNF9aC53Pg).cache, TM__zjz9atstw9cXOaiL5PksbOQQ_24);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T7_ = nextSymId__ast_3268(idgen__RTMLLAaSOgpVnL29aXTLO2A);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		temp = newSym__ast_4028(((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)5), colontmpD_, T7_, owner__DkEyZJir3TvrPp2wnYHEGg, (*value).info, (*(*g__t9ayBGjmfPAozbXNF9aC53Pg).config).options);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T8_ = NIM_NIL;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		colontmp_ = (NI)0;
		T14_ = (NI)0;
		T14_ = len__ast_3325(n__I6UIck9brCHS8rLdMqcDWpQ);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				val = NIM_NIL;
				i = i_2;
				val = newTupleAccess__lowerings_20(g__t9ayBGjmfPAozbXNF9aC53Pg, tempAsNode, i);
				if (NIM_UNLIKELY(*nimErr_)) goto LA17_;
				{
					if (!((*(*n__I6UIck9brCHS8rLdMqcDWpQ)._kind_6.sons.p->data[i]).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)3))) goto LA20_;
					addVar__lowerings_76(v, (*n__I6UIck9brCHS8rLdMqcDWpQ)._kind_6.sons.p->data[i], val);
					if (NIM_UNLIKELY(*nimErr_)) goto LA17_;
				}
				goto LA18_;
				LA20_: ;
				{
					tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* colontmpD__2;
					colontmpD__2 = NIM_NIL;
					colontmpD__2 = newAsgnStmt__lowerings_88((*n__I6UIck9brCHS8rLdMqcDWpQ)._kind_6.sons.p->data[i], val);
					if (NIM_UNLIKELY(*nimErr_)) goto LA17_;
					add__ast_6233(result, colontmpD__2);
					if (NIM_UNLIKELY(*nimErr_)) goto LA17_;
					eqdestroy___ast_3454(&colontmpD__2);
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = NIM_NIL;
	lit = NIM_NIL;
	result = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)42), (*tup__Kuxq9ccpdFOIchawNt2uksA).info);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD_ = copyTree__ast_5856(tup__Kuxq9ccpdFOIchawNt2uksA);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	add__ast_6233(result, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	lit = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)6), (*tup__Kuxq9ccpdFOIchawNt2uksA).info);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	(*lit)._kind_1.intVal = ((NI64) (i__v5FKFsUJG1SfdM4T7G3QfQ));
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, lowerTupleUnpackingForAsgn__lowerings_212)(tyObject_ModuleGraphcolonObjectType___g2oCqJbiuGsLLrs8RBMKXg* g__sMkaB14iIUf7k6DqG6L2Ag, tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n__3lVHVGROYAiJCE5VCakEMw, tyObject_IdGeneratorcolonObjectType___C1k2TcDRT9cU4DEatQIT09ag* idgen__KfOEYQMb624ElfXFl4apUw, tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* owner__ED8fg9boIF84F7t3x9aMrrGg) {
	tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* result;
	tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* value;
	tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* temp;
	tyObject_TIdent__L29bfCasnfXpB7u88iPkwMA* colontmpD_;
...
{nimErr_ = nimErrorFlag();
	...
	vpart = NIM_NIL;
	lhs = NIM_NIL;
	value = lastSon__ast_6268(n__3lVHVGROYAiJCE5VCakEMw);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)115), (*n__3lVHVGROYAiJCE5VCakEMw).info);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD_ = getIdent__idents_166((*g__sMkaB14iIUf7k6DqG6L2Ag).cache, TM__zjz9atstw9cXOaiL5PksbOQQ_25);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_ = nextSymId__ast_3268(idgen__KfOEYQMb624ElfXFl4apUw);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	temp = newSym__ast_4028(((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)5), colontmpD_, T2_, owner__ED8fg9boIF84F7t3x9aMrrGg, (*value).info, (*owner__ED8fg9boIF84F7t3x9aMrrGg).options);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	add__ast_6233(result, v);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqcopy___ast_3457(&lhs, (*n__3lVHVGROYAiJCE5VCakEMw)._kind_6.sons.p->data[((NI)0)]);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NI i;
		NI colontmp_;
...
{nimErr_ = nimErrorFlag();
	...
	T1_[0] = body__mDiBVL9bHEcvRnNr7IULrgg;
	nimZeroMem((void*)T2_, sizeof(tyArray__ITlg8UhAbnS7vsiPAhcspQ));
	T2_[0] = final__bFsvCMxKnGnqotBLV35Bag;
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = NIM_NIL;
	colontmpD__2 = NIM_NIL;
	result = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)45), (*obj__RVrxWyQnKS1PZz52v0NvlQ).info);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	field = lookupInRecord__lowerings_377((*(*obj__RVrxWyQnKS1PZz52v0NvlQ).typ).n, (*b__mvFdmvxjBpdgzdKKuNu5DA).Sup.itemId);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD_ = newSymNode__ast_4784(obj__RVrxWyQnKS1PZz52v0NvlQ);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__ast_6233(result, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmpD__2 = newSymNode__ast_4784(field);
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = NIM_NIL;
	colontmpD__2 = NIM_NIL;
	result = newNodeI__ast_3953(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)74), (*le__9aMl8HWiRWuWh7PhY6ZS9aPg).info, ((NI)2));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqcopy___ast_3457(&(*result)._kind_6.sons.p->data[((NI)0)], le__9aMl8HWiRWuWh7PhY6ZS9aPg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T2_ = NIM_NIL;
	T2_ = newNodeIT__ast_3970(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)27), (*ri__avBs7o2qy5vM8sTh0KvR4A).info, (*ri__avBs7o2qy5vM8sTh0KvR4A).typ);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqsink___ast_3460(&(*result)._kind_6.sons.p->data[((NI)1)], T2_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD_ = getSysMagic__magicsys_29(g__cV8CVCt3oFGtyPIbnv8uYA, (*ri__avBs7o2qy5vM8sTh0KvR4A).info, TM__zjz9atstw9cXOaiL5PksbOQQ_27, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)149));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmpD__2 = newSymNode__ast_4784(colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	add__ast_6233((*result)._kind_6.sons.p->data[((NI)1)], colontmpD__2);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	add__ast_6233((*result)._kind_6.sons.p->data[((NI)1)], ri__avBs7o2qy5vM8sTh0KvR4A);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = NIM_NIL;
	{
		...
		tyObject_Int128__o11U6O9aAgrfFG9bStrwmHkg T7_;
		NI64 T8_;
		colontmpD_ = skipTypes__ast_4803((*n__IY1bKPaQQk9bxVeqQ5b6UCg).typ, TM__zjz9atstw9cXOaiL5PksbOQQ_12);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!((*colontmpD_).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)16))) goto LA4_;
		colontmpD__2 = NIM_NIL;
		colontmpD__2 = skipTypes__ast_4803((*n__IY1bKPaQQk9bxVeqQ5b6UCg).typ, TM__zjz9atstw9cXOaiL5PksbOQQ_12);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		T7_ = lastOrd__types_1509((*g__FUtT6SO3MfiOFlVe9a1f1sQ).config, colontmpD__2);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		T8_ = (NI64)0;
		T8_ = toInt64__int495056_77(T7_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		result = newIntLit__lowerings_702(g__FUtT6SO3MfiOFlVe9a1f1sQ, (*n__IY1bKPaQQk9bxVeqQ5b6UCg).info, T8_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
	...
	LA4_: ;
	{
		...
		colontmpD__3 = NIM_NIL;
		result = newNodeI__ast_3953(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)27), (*n__IY1bKPaQQk9bxVeqQ5b6UCg).info, ((NI)2));
		if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
		T13_ = NIM_NIL;
		T13_ = getSysType__magicsys_60(g__FUtT6SO3MfiOFlVe9a1f1sQ, (*n__IY1bKPaQQk9bxVeqQ5b6UCg).info, ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)31));
		if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
		eqsink___ast_3549(&(*result).typ, T13_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
		colontmpD__3 = getSysMagic__magicsys_29(g__FUtT6SO3MfiOFlVe9a1f1sQ, (*n__IY1bKPaQQk9bxVeqQ5b6UCg).info, TM__zjz9atstw9cXOaiL5PksbOQQ_29, ((tyEnum_TMagic__mTDI9bmjHUNrwgx3GHm4Krg)9));
		if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
		T14_ = NIM_NIL;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
		eqcopy___ast_3457(&(*result)._kind_6.sons.p->data[((NI)1)], n__IY1bKPaQQk9bxVeqQ5b6UCg);
		if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
		{
			LA12_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	t = skipTypes__ast_4803((*deref).typ, TM__zjz9atstw9cXOaiL5PksbOQQ_15);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	bb = getIdent__idents_166(cache__NUAuXn9c5ELSMAgKEdQ4MVQ, b__ryfIjsnM8B4iLeOxXF9bnrg);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		while (1) {
			tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA* T4_;
