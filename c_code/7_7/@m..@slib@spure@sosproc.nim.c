...
static N_INLINE(NIM_BOOL, eqeq___system_7507)(NCSTRING x, NCSTRING y);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_FileStreamObj__9bEVSsOIpkY9cf5lCtaS39bPQ*, createStream__pureZosproc_939)(int* handle, tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg fileMode);
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		T5_ = NIM_NIL;
		T5_ = createStream__pureZosproc_939((&(*p).inHandle), ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		T5_ = NIM_NIL;
		T5_ = createStream__pureZosproc_939((&(*p).outHandle), ((tyEnum_FileMode__4sJyy9aOSN8X63XdWXl5iDg)0));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___pureZosproc_1659)(tyTuple__XOVT24GHXwqiEj5GCsEGCA* dest) {
