...
{nimErr_ = nimErrorFlag();
	...
	if (!(T2_)) goto LA3_;
	T4_ = (NIM_CHAR)0;
	T4_ = X5BX5D___system_7030(tail__1AjSMV084MnUUHJLP6MX5A, ((NI)1));
	...
	if (!(T8_)) goto LA9_;
	T10_ = (NIM_CHAR*)0;
	T10_ = X5BX5D___system_7069(result__Duce9bPtdY9cuV41HJK3P9bJQ, ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(tyTuple__UV3llMMYFckfui8YMBuUZA, nossplitPath)(NimStringV2 path__zbB2oo2FD6XhIdlH5Yed8g) {
	...
	} LA1: ;
	{
		...
		T19_ = substr__system_7541(path__zbB2oo2FD6XhIdlH5Yed8g, ((NI)0), T12_);
		eqsink___stdZassertions_19((&result.Field0), T19_);
		T20_.len = 0; T20_.p = NIM_NIL;
		T20_ = substr__system_7553(path__zbB2oo2FD6XhIdlH5Yed8g, (NI)(sepPos + ((NI)1)));
			...
			while (1) {
				...
				i = res;
				{
					...
					if (!T6_) goto LA8_;
					{
						...
						T21_ = substr__system_7541(path__mQs5USj7cYSjfdcRv9cqi0A, ((NI)0), T14_);
					...
					LA12_: ;
					{
						...
						T26_ = substr__system_7541(path__mQs5USj7cYSjfdcRv9cqi0A, namePos, (NI)(dotPos - ((NI)1)));
						eqsink___stdZassertions_19((&result.Field1), T26_);
						T27_.len = 0; T27_.p = NIM_NIL;
						T27_ = substr__system_7553(path__mQs5USj7cYSjfdcRv9cqi0A, dotPos);
					...
					LA24_: ;
					{
						...
						T29_ = substr__system_7553(path__mQs5USj7cYSjfdcRv9cqi0A, namePos);
		...
		while (1) {
			{
				...
				T6_ = (NIM_BOOL)0;
				T6_ = eqeq___system_7507(T5_, ((NCSTRING) NIM_NIL));
				if (!!(T6_)) goto LA7_;
				T9_ = (size_t)0;
		...
		while (1) {
			{
				if (!(bb.Field0 <= bb.Field1)) goto LA48_;
				{
					...
					if (!(T52_)) goto LA53_;
					T54_ = (NIM_CHAR*)0;
					T54_ = X5BX5D___system_7069((&result), ((NI)1));
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		...
		while (1) {
			{
				if (!(ff.Field0 <= ff.Field1)) goto LA66_;
				{
					...
					if (!(T70_)) goto LA71_;
					T72_ = (NIM_CHAR*)0;
					T72_ = X5BX5D___system_7069((&result), ((NI)1));
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T5_ = substr__system_7541(result, ((NI)0), sepPos);
	...
	LA3_: ;
	{
		...
		if (T7_) goto LA12_;
		T13_ = (NIM_CHAR*)0;
		T13_ = X5BX5D___system_7069((&result), ((NI)1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
appendString((&T5_), colontmpD_);
	...
	LA3_: ;
	{
		...
		colontmpD__2 = substr__system_7541(filename__OD2NsXgx3ow22bCoVE9b19bA, ((NI)0), (NI)(extPos - ((NI)1)));
