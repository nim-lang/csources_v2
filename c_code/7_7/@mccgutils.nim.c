...
N_LIB_PRIVATE N_NIMCALL(tyEnum_TCTypeKind__b9bUCVDtdiRYFTXNuYasNAQ, mapSetType__ccgutils_141)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA* typ);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q*, getPragmaStmt__ccgutils_12)(tyObject_TNode__1pEudI6ZemBfsBxMjg4u5Q* n, tyEnum_TSpecialWord__hTGV9ad79bZJfqtldnYLJ8AA w);
...
{nimErr_ = nimErrorFlag();
	...
	T1_ = (NI64)0;
	T1_ = getSize__types_3546(conf, typ);
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	pt = NIM_NIL;
	pt = skipTypes__ast_4803((*s).typ, TM__3d9b9bGbX6KaaiNN5NPQfYWQ_2);
	...
	{
		{
			NIM_BOOL T12_;
			T12_ = (NIM_BOOL)0;
			T12_ = !(((*(*s).typ).sym == ((tyObject_TSym__9cob5UPXvLCxy8mslvxEYzA*) NIM_NIL)));
			if (!(T12_)) goto LA13_;
			T12_ = (((*(*(*s).typ).sym).flags &((NU64)1<<((NU)((((tyEnum_TSymFlag__TAs9cOBd13PVhEf42OX9cOdg)4)))&63U)))!=0);
			LA13_: ;
			if (!T12_) goto LA14_;
			result = NIM_TRUE;
		}
		...
		LA14_: ;
		{
			...
			NI64 T19_;
			T17_ = (NIM_BOOL)0;
			T17_ = (((*s).options &((NU32)1<<((NU)((((tyEnum_TOption__PrH9cMsvu5oCG0HODAZ3CAg)20)))&31U)))!=0);
			if (T17_) goto LA18_;
			T19_ = (NI64)0;
			T19_ = getSize__types_3546(conf, pt);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			T17_ = (((NI64) ((NI)((*conf).target.floatSize * ((NI)3)))) < T19_);
			LA18_: ;
			if (!T17_) goto LA20_;
			result = NIM_TRUE;
		}
	...
	case ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)18):
	{
		...
		T29_ = (NIM_BOOL)0;
		T30_ = (NI64)0;
		T30_ = getSize__types_3546(conf, pt);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		T29_ = (((NI64) ((NI)((*conf).target.floatSize * ((NI)3)))) < T30_);
		if (T29_) goto LA31_;
		T29_ = (((*s).options &((NU32)1<<((NU)((((tyEnum_TOption__PrH9cMsvu5oCG0HODAZ3CAg)20)))&31U)))!=0);
		LA31_: ;
		result = T29_;
	}
	break;
	...
	}
	{
		...
		T35_ = (NIM_BOOL)0;
		T36_ = (NIM_BOOL)0;
		T36_ = ((*s).position == ((NI)0));
		if (!(T36_)) goto LA37_;
		T36_ = !((retType == ((tyObject_TType__qs8ld9cHTjcxh7xYsvWduXA*) NIM_NIL)));
		LA37_: ;
		T35_ = T36_;
		if (!(T35_)) goto LA38_;
		T35_ = ((*retType).kind == ((tyEnum_TTypeKind__cu4lI59aFp7m9cDkg2Nfr7ZQ)47));
		LA38_: ;
		if (!T35_) goto LA39_;
		T41_ = (NIM_BOOL)0;
		...
		T45_ = mapSetType__ccgutils_141(conf, pt);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				...
				{
					{
						...
						T14_ = (((NI)0) < i);
						if (!(T14_)) goto LA15_;
						T14_ = (i < (NI)(name.len - ((NI)1)));
						LA15_: ;
						T13_ = T14_;
						if (!(T13_)) goto LA16_;
						T13_ = (((NU8)(name.p->data[(NI)(i + ((NI)1))])) >= ((NU8)(48)) && ((NU8)(name.p->data[(NI)(i + ((NI)1))])) <= ((NU8)(57)));
						LA16_: ;
						if (!T13_) goto LA17_;
					}
					goto LA11_;
	...
	{
		{
			...
			i_2 = ((NI)0);
			{
				while (1) {
					...
					i = i_2;
					T5_ = NIM_NIL;
					T5_ = getPragmaStmt__ccgutils_12((*n)._kind_6.sons.p->data[i], w);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			...
			i_4 = ((NI)0);
			{
				while (1) {
					...
					i_3 = i_4;
					{
						...
						T16_ = whichPragma__trees_251((*n)._kind_6.sons.p->data[i_3]);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						if (!(T16_ == w)) goto LA17_;
						eqcopy___ast_3457(&result, (*n)._kind_6.sons.p->data[i_3]);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						goto BeforeRet_;
					}
					LA17_: ;
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	colontmpD_ = NIM_NIL;
	colontmpD_ = getPragmaStmt__ccgutils_12(n, w);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(NI64, hashString__ccgutils_51)(tyObject_ConfigRefcolonObjectType___2BjaRtGfBjUbX51p9a4g9a9cg* conf, NimStringV2 s) {
	...
	{
		NU64 b;
		if (!(CPU__platform_720[((*conf).target.targetCPU)- 1].Field4 == ((NI)64))) goto LA3_;
		b = 0ULL;
		{
			NI i;
			NI colontmp_;
