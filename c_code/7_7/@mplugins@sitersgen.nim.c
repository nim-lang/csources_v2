...
{nimErr_ = nimErrorFlag();
	...
	result = newNodeI__ast_3949(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)115), (*n__5CkZnt2AKBCddQxSFJ9anjw).info);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqcopy___ast_3457(&iter, (*n__5CkZnt2AKBCddQxSFJ9anjw)._kind_6.sons.p->data[((NI)1)]);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NIM_BOOL T4_;
		T4_ = (NIM_BOOL)0;
		...
		LA5_: ;
		if (!T4_) goto LA6_;
		liMessage__msgs_1172((*(*c__IA1ZyJbJw9bo1LXhIZdYsMw).graph).config, (*iter).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__NVXktvZtnGMW9aYeuy1EKPw_3, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__NVXktvZtnGMW9aYeuy1EKPw_4, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	LA6_: ;
	{
		if (!((*(*n__5CkZnt2AKBCddQxSFJ9anjw)._kind_6.sons.p->data[((NI)2)]).typ == 0)) goto LA10_;
		liMessage__msgs_1172((*(*c__IA1ZyJbJw9bo1LXhIZdYsMw).graph).config, (*(*n__5CkZnt2AKBCddQxSFJ9anjw)._kind_6.sons.p->data[((NI)2)]).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__NVXktvZtnGMW9aYeuy1EKPw_7, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__NVXktvZtnGMW9aYeuy1EKPw_8, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		eqdestroy___ast_3454(&colontmpD__5);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqdestroy___ast_3454(&orig);
	...
	LA10_: ;
	{
		if (!!(((*(*n__5CkZnt2AKBCddQxSFJ9anjw)._kind_6.sons.p->data[((NI)3)]).kind == ((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)2)))) goto LA14_;
		liMessage__msgs_1172((*(*c__IA1ZyJbJw9bo1LXhIZdYsMw).graph).config, (*(*n__5CkZnt2AKBCddQxSFJ9anjw)._kind_6.sons.p->data[((NI)3)]).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__NVXktvZtnGMW9aYeuy1EKPw_10, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__NVXktvZtnGMW9aYeuy1EKPw_11, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		eqdestroy___ast_3454(&colontmpD__5);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqdestroy___ast_3454(&orig);
	...
	LA14_: ;
	t = skipTypes__ast_4803((*(*n__5CkZnt2AKBCddQxSFJ9anjw)._kind_6.sons.p->data[((NI)2)]).typ, TM__NVXktvZtnGMW9aYeuy1EKPw_12);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		NIM_BOOL T18_;
		T18_ = (NIM_BOOL)0;
		...
		LA19_: ;
		if (!T18_) goto LA20_;
		liMessage__msgs_1172((*(*c__IA1ZyJbJw9bo1LXhIZdYsMw).graph).config, (*(*n__5CkZnt2AKBCddQxSFJ9anjw)._kind_6.sons.p->data[((NI)2)]).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), TM__NVXktvZtnGMW9aYeuy1EKPw_14, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__NVXktvZtnGMW9aYeuy1EKPw_15, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		eqdestroy___ast_3454(&colontmpD__5);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqdestroy___ast_3454(&orig);
	...
	LA20_: ;
	colontmpD__2 = getBody__modulegraphs_14894((*c__IA1ZyJbJw9bo1LXhIZdYsMw).graph, (*iter)._kind_4.sym);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	body = liftIterToProc__lambdalifting_5371((*c__IA1ZyJbJw9bo1LXhIZdYsMw).graph, (*iter)._kind_4.sym, colontmpD__2, t, (*c__IA1ZyJbJw9bo1LXhIZdYsMw).Sup.idgen);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T22_ = nextSymId__ast_3268((*c__IA1ZyJbJw9bo1LXhIZdYsMw).Sup.idgen);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T23_ = 0;
	prc = newSym__ast_4028(((tyEnum_TSymKind__EmlFK9c4sdJy7UDy5lm8yQQ)12), (*(*n__5CkZnt2AKBCddQxSFJ9anjw)._kind_6.sons.p->data[((NI)3)])._kind_5.ident, T22_, (*(*iter)._kind_4.sym).owner, (*(*iter)._kind_4.sym).info, T23_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T24_ = nextTypeId__ast_3291((*c__IA1ZyJbJw9bo1LXhIZdYsMw).Sup.idgen);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T25_ = NIM_NIL;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T26_ = NIM_NIL;
	T26_ = newProcNode__ast_4889(((tyEnum_TNodeKind__ySM4MdHjvuRpNcphR1xnyQ)79), (*n__5CkZnt2AKBCddQxSFJ9anjw).info, body, (*orig)._kind_6.sons.p->data[((NI)3)], colontmpD__5, (*(*c__IA1ZyJbJw9bo1LXhIZdYsMw).graph).emptyNode, (*(*c__IA1ZyJbJw9bo1LXhIZdYsMw).graph).emptyNode, (*orig)._kind_6.sons.p->data[((NI)4)], (*(*c__IA1ZyJbJw9bo1LXhIZdYsMw).graph).emptyNode);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqsink___ast_3460(&(*prc).ast, T26_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	add__ast_6233((*prc).ast, (*(*(*iter)._kind_4.sym).ast)._kind_6.sons.p->data[((NI)7)]);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	addInterfaceDecl__lookups_1086(c__IA1ZyJbJw9bo1LXhIZdYsMw, prc);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
