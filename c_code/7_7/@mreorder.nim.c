								...
								while (1) {
									...
									if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
									{
										if (!!((f == ((NI32)-1)))) goto LA20_;
										{
											...
											T28_ = toMsgFilename__msgs_653((*graph__6PpluPtLRwyZOHlyrlsOBA).config, f);
											if (NIM_UNLIKELY(*nimErr_)) goto LA27_;
											colontmpD_ = nsuFormatSingleElem(TM__k9axqyY7R0TmDVutx9brQukQ_6, T28_);
											if (NIM_UNLIKELY(*nimErr_)) goto LA27_;
											liMessage__msgs_1172((*graph__6PpluPtLRwyZOHlyrlsOBA).config, (*a).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__k9axqyY7R0TmDVutx9brQukQ_7, NIM_FALSE);
											if (NIM_UNLIKELY(*nimErr_)) goto LA27_;
											{
												LA27_:;
											}
			...
			while (1) {
				...
				LA8_: ;
				{
					...
					LA17_: ;
					{
						...
						liMessage__msgs_1172(conf__K4l8iQYDhBtWTQNh9c0qzTg, (*(*cs.p->data[((NI)0)]).pnode).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)77), wmsg, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__k9axqyY7R0TmDVutx9brQukQ_16, NIM_FALSE);
						if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
						i_3 = ((NI)0);
						{
							while (1) {
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	mpath = toFullPath__msgs_589((*graph__DXQ7PURc3zDCWt7I9cB9aWqA).config, ((NI32) ((*module__y9alpbpuH9cUJgHg2R7ZZI7A).position)));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
