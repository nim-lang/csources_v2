...
N_LIB_PRIVATE N_NIMCALL(void, shrink__reorder_78)(tySequence__8QRZaV9bKw9abKv9anJ280svg* x__c3LPB9cI6CRmypw4Xw7dI9ag_42, NI newLen__z9axmEZwQfCqmWiagCNbWog_42);
								...
								while (1) {
									...
									if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
									{
										if (!!((f == ((NI32)-1)))) goto LA20_;
										{
											...
											T28_ = toMsgFilename__msgs_663((*graph__6PpluPtLRwyZOHlyrlsOBA).config, f);
											if (NIM_UNLIKELY(*nimErr_)) goto LA27_;
											colontmpD_ = nsuFormatSingleElem(TM__k9axqyY7R0TmDVutx9brQukQ_6, T28_);
											if (NIM_UNLIKELY(*nimErr_)) goto LA27_;
											liMessage__msgs_1182((*graph__6PpluPtLRwyZOHlyrlsOBA).config, (*a).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)17), colontmpD_, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__k9axqyY7R0TmDVutx9brQukQ_7, NIM_FALSE);
											if (NIM_UNLIKELY(*nimErr_)) goto LA27_;
											{
												LA27_:;
											}
...
N_LIB_PRIVATE N_NIMCALL(NI, colonanonymous___reorder_628)(tyObject_DepNcolonObjectType___e3eC0DKpMZNXV7n55sKrSw* xX60gensym51___E4ThMhy7ceFQgqCck1TCxw, tyObject_DepNcolonObjectType___e3eC0DKpMZNXV7n55sKrSw* yX60gensym51___xjI0S5OHJ5YgtKfmUC2N6A) {
	...
	bX60gensym51_ = (*it).id;
	result = cmp__system_7195(aX60gensym51_, bX60gensym51_);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, haveSameKind__reorder_543)(tySequence__8QRZaV9bKw9abKv9anJ280svg dns__hrW3T6H09cdwWTnAIbH6QIw) {
	NIM_BOOL result;
			...
			while (1) {
				...
				LA8_: ;
				{
					...
					LA17_: ;
					{
						...
						liMessage__msgs_1182(conf__K4l8iQYDhBtWTQNh9c0qzTg, (*(*cs.p->data[((NI)0)]).pnode).info, ((tyEnum_TMsgKind__9b1zBSEXe8I2R9aa2h3NYf9cA)77), wmsg, ((tyEnum_TErrorHandling__NXH4RLc649bsDWofENjZIqw)0), TM__k9axqyY7R0TmDVutx9brQukQ_16, NIM_FALSE);
						if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
						i_3 = ((NI)0);
						{
							while (1) {
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	mpath = toFullPath__msgs_599((*graph__DXQ7PURc3zDCWt7I9cB9aWqA).config, ((NI32) ((*module__y9alpbpuH9cUJgHg2R7ZZI7A).position)));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
