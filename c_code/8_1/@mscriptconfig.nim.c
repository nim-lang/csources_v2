...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = newCtx__vmdef_361((*colonenv_).module5, cache__9bfUyz89aj33JBCQqJ5j5EGg, (*colonenv_).graph2, idgen__C9a1ato0oPcxj2sCK8soECg);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*result).mode = ((tyEnum_TEvalMode__bzKsByQdtJOXOcqlXsimIg)0);
	registerAdditionalOps__vm_13327(result);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	T7_.Field0 = myOpen__vm_14025;
	T7_.Field1 = myProcess__vm_14030;
	T7_.Field2 = myClose__vm_14035;
