...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		prefix = substr__system_7534(s__9bbA9c8EYk8sqmZnb3ssoXdg, ((NI)0), (NI)(le - ((NI)1)));
		suffix = substr__system_7546(s__9bbA9c8EYk8sqmZnb3ssoXdg, (NI)(ri + ((NI)1)));
		{
			NimStringV2 middle;
			...
			colontmp_ = substr__system_7534(s__9bbA9c8EYk8sqmZnb3ssoXdg, (NI)(le + ((NI)1)), (NI)(ri - ((NI)1)));
			...
			splitsX60gensym33_ = ((NI)-1);
			{
				while (1) {
					...
					T21_ = substr__system_7534(colontmp_, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI)1)));
