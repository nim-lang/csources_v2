...
{nimErr_ = nimErrorFlag();
	...
	LA19_: ;
	{
		...
		T24_.len = 0; T24_.p = NIM_NIL;
		T24_ = substr__system_7546(switch__5L0g6AXpRkKOkSBu17JeFw, (NI)(i + ((NI)1)));
	...
	LA22_: ;
	{
		...
		T28_ = substr__system_7546(switch__5L0g6AXpRkKOkSBu17JeFw, i);
...
{nimErr_ = nimErrorFlag();
	...
	LA35_: ;
	colontmpD__2 = substr__system_7546(arg__Bjb2ns57e8ABwp4pEEbLTw, i);
...
appendString((&T283_), f.Field2);
	...
	LA16_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		{
			NIM_BOOL T315_;
			T315_ = (NIM_BOOL)0;
			T315_ = contains__pureZstrutils_1820(arg__taD9bmHJWsV7KlmDCXwRYdA, TM__aFkIL74T1q8RouIu9auwZ3g_455);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	LA77_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		{
			...
			}
			{
				...
				eqdestroy___system_3514((&colontmpD__27));
	...
	LA78_: ;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		{
			...
			}
			{
				...
				eqdestroy___system_3514((&colontmpD__29));
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		val.len = 0; val.p = NIM_NIL;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		key = substr__system_7534((*p__smbktGL0apWTpb6qZncYRg).key, ((NI)0), (NI)(bracketLe - ((NI)1)));
		T6_.len = 0; T6_.p = NIM_NIL;
		colontmpD_ = substr__system_7546((*p__smbktGL0apWTpb6qZncYRg).key, bracketLe);
