...
{nimErr_ = nimErrorFlag();
	...
	LA6_: ;
	{
		...
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		T9_.len = 0; T9_.p = NIM_NIL;
		T9_ = getString__vm_351(a, ((NI)0));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		colontmpD_ = T9_;
		T10_ = (NI)0;
		T10_ = nospexecCmd(colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		setResult__vm_226(a, ((NI64) (T10_)));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		eqdestroy___stdZassertions_13((&colontmpD_));
	}
	LA2_: ;
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___stdZassertions_19((&(*colonenvP_).errorMsg1), TM__qdmBYobaV9btoxwHZNavLQA_133);
	{
		...
		LA5_: ;
		if (!T4_) goto LA6_;
		setResult__vm_239(a, TM__qdmBYobaV9btoxwHZNavLQA_134);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	goto LA2_;
	LA6_: ;
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___stdZassertions_19((&(*colonenvP_).errorMsg1), TM__qdmBYobaV9btoxwHZNavLQA_137);
	{
		...
		LA5_: ;
		if (!T4_) goto LA6_;
		setResult__vm_239(a, TM__qdmBYobaV9btoxwHZNavLQA_138);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	goto LA2_;
	LA6_: ;
