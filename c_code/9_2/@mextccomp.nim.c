...
N_LIB_PRIVATE N_NIMCALL(void, newSeq__system_3408)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ* s__JHX6dGKfrwZrkhFUhd74qw_2, NI len__WT25bUt2bu59aVKae2o1xsg_2);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getStackTrace__system_3623)(Exception* e__l21OTFrXhQyHeJikwA9bfaw);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___extccomp_2037)(tyObject_BuildCache__bsEp9cTzVeuA9a0MLpRaR1yg* dest__nfzVMVGLFFxpJEwFtE4HUg) {
	...
	eqdestroy___system_3530((&(*dest__nfzVMVGLFFxpJEwFtE4HUg).link));
	eqdestroy___stdZassertions_13((&(*dest__nfzVMVGLFFxpJEwFtE4HUg).linkcmd));
	eqdestroy___system_3530((&(*dest__nfzVMVGLFFxpJEwFtE4HUg).extraCmds));
	eqdestroy___system_3530((&(*dest__nfzVMVGLFFxpJEwFtE4HUg).configFiles));
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___extccomp_3008)(tyObject_Env_extccompdotnim_callCCompiler___BcZEqupvBAThTu8RE6k9aJA* dest__QxO9bxrcWL67plemD3zYiNA) {
	eqdestroy___system_3530((&(*dest__QxO9bxrcWL67plemD3zYiNA).prettyCmds1));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___extccomp_3103)(tyObject_Env_extccompdotnim_execCmdsInParallel___yHnd6tS72p8Z69arkozzppg* dest__iALS3oVUrULmHNsN9cgA2KA) {
	...
	LA4_: ;
	eqdestroy___system_3530((&(*dest__iALS3oVUrULmHNsN9cgA2KA).cmds2));
}
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___extccomp_1304)(NI idx__hPPV8Qk2X8n1tabG3wscxQ, tyObject_ProcessObj__2rGNQnv9bU4hanI2g3svReg* p__H4fGkersvHkGUV6xUjbNpg, void* ClE_0) {
...
{nimErr_ = nimErrorFlag();
	...
	eqcopy___system_3533((&(*colonenv_).cmds2), cmds__CGwDobpjZtbFtHH9bIVB9aMQ);
	colontmpD_ = 0;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	newSeq__system_3408((&result), ((NI) (s__XiQvRWkRogP0UWEpi5iccwLen_0)));
	{
		NI i;
		NI colontmp_;
		NI i_2;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___extccomp_3265)(tyObject_Env_extccompdotnim_runJsonBuildInstructions___VGgYLDtRkrYcGQHO6dF5ag* dest__8D8MluX8O49cTuccFKY7yiw) {
	eqdestroy___system_3530((&(*dest__8D8MluX8O49cTuccFKY7yiw).prettyCmds1));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
